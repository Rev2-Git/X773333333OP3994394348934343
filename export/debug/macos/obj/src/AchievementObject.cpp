...
HXLINE( 109)		HX_VARI( int,id) = ::Achievements_obj::getAchievementIndex(name);
HXLINE( 110)		HX_VARI(  ::flixel::FlxSprite,achievementBG) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,60,50,null())->makeGraphic(420,120,-16777216,null(),null());
HXLINE( 111)		{
...
HXDLIN( 113)		HX_VARI(  ::flixel::FlxSprite,achievementIcon1) = achievementIcon->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE( 114)		{
...
HXDLIN( 119)		HX_VARI(  ::flixel::text::FlxText,achievementName1) =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,achievementName,(achievementIcon1->y + 16),280,( (::String)(::Achievements_obj::achievementsStuff->__get(id)->__GetItem(0)) ),16,null());
...
HXLINE( 123)		HX_VARI(  ::flixel::text::FlxText,achievementText) =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,achievementName1->x,(achievementName1->y + 32),280,( (::String)(::Achievements_obj::achievementsStuff->__get(id)->__GetItem(1)) ),16,null());
...
HXLINE( 132)		HX_VARI( ::Array< ::Dynamic>,cam) = ::flixel::FlxCamera_obj::_defaultCameras;
