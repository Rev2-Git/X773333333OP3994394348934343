...
HXLINE(  34)
HXLINE(  35)		::flixel::FlxG_obj::log->advanced(((HX_("Completed achievement \"",bc,88,62,0c) + name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
