...
HXDLIN(  35)		HX_VARI_NAME(  ::flixel::FlxSprite,menuBG1,"menuBG") = menuBG->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXDLIN(  38)				menuBG1->set_x(((( (Float)(_hx_tmp1) ) - menuBG1->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  38)				menuBG1->set_y(((( (Float)(_hx_tmp3) ) - menuBG1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  46)				_g = (_g + 1);
HXDLIN(  46)				HX_VARI( int,i) = (_g - 1);
HXLINE(  47)				bool _hx_tmp4;
HXDLIN(  47)				if (( (bool)(::Achievements_obj::achievementsStuff->__get(i)->__GetItem(3)) )) {
HXLINE(  47)					_hx_tmp4 = ::Achievements_obj::achievementsMap->exists(( (::String)(::Achievements_obj::achievementsStuff->__get(i)->__GetItem(2)) ));
            				}
            				else {
...
HXLINE(  53)				_g2 = (_g2 + 1);
HXDLIN(  53)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE(  54)				HX_VARI( ::String,achieveName) = ( (::String)(::Achievements_obj::achievementsStuff->__get(this->achievementIndex->__get(i1))->__GetItem(2)) );
HXLINE(  55)				::String optionText;
HXDLIN(  55)				if (::Achievements_obj::isAchievementUnlocked(achieveName)) {
HXLINE(  55)					optionText = ( (::String)(::Achievements_obj::achievementsStuff->__get(this->achievementIndex->__get(i1))->__GetItem(0)) );
            				}
            				else {
HXLINE(  55)					optionText = HX_("?",3f,00,00,00);
            				}
HXDLIN(  55)				HX_VARI_NAME(  ::Alphabet,optionText1,"optionText") =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(280) ),( (Float)(300) ),optionText,false);
HXLINE(  56)				optionText1->isMenuItem = true;
HXLINE(  57)				optionText1->targetY = (i1 - ::AchievementsMenuState_obj::curSelected);
HXLINE(  58)				optionText1->snapToPosition();
HXLINE(  59)				this->grpOptions->add(optionText1).StaticCast<  ::Alphabet >();
HXLINE(  61)				HX_VARI(  ::AttachedAchievement,icon) =  ::AttachedAchievement_obj::__alloc( HX_CTX ,(optionText1->x - ( (Float)(105) )),optionText1->y,achieveName);
...
HXLINE(  68)		 ::flixel::text::FlxText _hx_tmp5 = this->descText;
HXDLIN(  68)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(  68)		::String _hx_tmp6;
HXDLIN(  68)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(  68)			_hx_tmp6 = file;
            		}
            		else {
HXLINE(  68)			_hx_tmp6 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  68)		_hx_tmp5->setFormat(_hx_tmp6,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  69)		{
...
HXLINE( 100)		HX_VARI( int,bullShit) = 0;
HXLINE( 102)		{
HXLINE( 102)			int _g = 0;
HXDLIN( 102)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 102)			while((_g < _g1->length)){
HXLINE( 102)				HX_VARI(  ::Alphabet,item) = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 102)				_g = (_g + 1);
...
HXDLIN( 112)				HX_VARI( int,i) = (_g2 - 1);
