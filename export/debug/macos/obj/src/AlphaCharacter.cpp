...
HXLINE( 333)		HX_VARI(  ::Dynamic,curLetter) = ::AlphaCharacter_obj::allLetters->get(HX_("?",3f,00,00,00));
HXLINE( 334)		HX_VARI( ::String,lowercase) = character.toLowerCase();
...
HXLINE( 337)		HX_VARI( ::String,suffix) = HX_("",00,00,00,00);
HXLINE( 338)		if (!(bold)) {
...
HXLINE( 360)				_hx_tmp1 = ::hx::IsNotNull( curLetter->__Field(HX_("offsetsBold",25,77,5c,68),::hx::paccDynamic) );
            			}
            			else {
...
HXLINE( 367)		HX_VARI( ::String,alphaAnim) = lowercase;
HXLINE( 368)		bool _hx_tmp2;
HXDLIN( 368)		if (::hx::IsNotNull( curLetter )) {
HXLINE( 368)			_hx_tmp2 = ::hx::IsNotNull( curLetter->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic) );
            		}
            		else {
...
HXLINE( 370)		HX_VARI( ::String,anim) = (alphaAnim + suffix);
...
HXLINE( 391)
HXLINE( 392)		HX_VARI( ::String,lastAnim) = null();
...
bool AlphaCharacter_obj::isTypeAlphabet(::String c){
            	...
            	HX_STACK_ARG(c,"c")
HXLINE( 385)
HXLINE( 386)		HX_VARI( int,ascii) = c.cca(0);
