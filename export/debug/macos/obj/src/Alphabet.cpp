...
HXDLIN(  74)			HX_VARI(  ::AlphaCharacter,letter) = _g1->__get(_g).StaticCast<  ::AlphaCharacter >();
HXDLIN(  74)			_g = (_g + 1);
HXLINE(  76)			HX_VARI( Float,newOffset) = ( (Float)(0) );
...
void Alphabet_obj::clearLetters(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 104)
HXLINE( 105)		HX_VARI( int,i) = this->letters->length;
HXLINE( 106)		while((i > 0)){
HXLINE( 108)			i = (i - 1);
HXLINE( 109)			HX_VARI(  ::AlphaCharacter,letter) = this->letters->__get(i).StaticCast<  ::AlphaCharacter >();
...
HXLINE( 126)				HX_VARI(  ::AlphaCharacter,letter) = _g1->__get(_g).StaticCast<  ::AlphaCharacter >();
HXDLIN( 126)				_g = (_g + 1);
HXLINE( 128)				if (::hx::IsNotNull( letter )) {
HXLINE( 130)					letter->updateHitbox();
HXLINE( 132)					HX_VARI( Float,ratio) = (value / letter->spawnScale->x);
...
HXLINE( 145)				HX_VARI(  ::AlphaCharacter,letter) = _g1->__get(_g).StaticCast<  ::AlphaCharacter >();
HXDLIN( 145)				_g = (_g + 1);
HXLINE( 147)				if (::hx::IsNotNull( letter )) {
HXLINE( 149)					letter->updateHitbox();
HXLINE( 150)					letter->updateLetterOffset();
HXLINE( 151)					HX_VARI( Float,ratio) = (value / letter->spawnScale->y);
...
HXLINE( 163)			HX_VARI( Float,lerpVal) = ::Math_obj::max(( (Float)(0) ),::Math_obj::min(( (Float)(1) ),(elapsed * ((Float)9.6))));
...
HXLINE( 167)				Float a1 = this->y;
HXDLIN( 167)				this->set_y((a1 + (lerpVal * ((((( (Float)(this->targetY) ) * ((Float)1.3)) * this->distancePerItem->y) + this->startPosition->y) - a1))));
            			}
            		}
...
void Alphabet_obj::createLetters(::String newText){
            	...
            	HX_STACK_ARG(newText,"newText")
HXLINE( 186)
HXLINE( 187)		HX_VARI( int,consecutiveSpaces) = 0;
HXLINE( 189)		HX_VARI( Float,xPos) = ( (Float)(0) );
HXLINE( 190)		HX_VARI( ::Array< Float >,rowData) = ::Array_obj< Float >::__new(0);
HXLINE( 191)		this->rows = 0;
HXLINE( 192)		{
HXLINE( 192)			int _g = 0;
HXDLIN( 192)			::Array< ::String > _g1 = newText.split(HX_("",00,00,00,00));
HXDLIN( 192)			while((_g < _g1->length)){
HXLINE( 192)				HX_VARI( ::String,character) = _g1->__get(_g);
HXDLIN( 192)				_g = (_g + 1);
HXLINE( 195)				if ((character != HX_("\n",0a,00,00,00))) {
HXLINE( 197)					HX_VAR( bool,spaceChar);
...
HXLINE( 200)					HX_VARI( bool,isAlphabet) = ::AlphaCharacter_obj::isTypeAlphabet(character.toLowerCase());
...
HXLINE( 206)								_hx_tmp1 = (xPos >= (( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.65)));
            							}
            							else {
...
HXLINE( 214)						HX_VARI(  ::AlphaCharacter,letter) =  ::AlphaCharacter_obj::__alloc( HX_CTX ,xPos,((( (Float)(this->rows) ) * ::Alphabet_obj::Y_PER_ROW) * this->scaleY),character,this->bold,::hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 219)						HX_VARI( Float,off) = ( (Float)(0) );
...
HXLINE( 235)				HX_VARI_NAME(  ::AlphaCharacter,letter1,"letter") = _g3->__get(_g2).StaticCast<  ::AlphaCharacter >();
HXDLIN( 235)				_g2 = (_g2 + 1);
HXLINE( 237)				{
HXLINE( 237)					 ::flixel::math::FlxBasePoint this2 = letter1->spawnPos;
HXDLIN( 237)					Float y = letter1->y;
HXDLIN( 237)					this2->set_x(letter1->x);
HXDLIN( 237)					this2->set_y(y);
            				}
HXLINE( 238)				{
HXLINE( 238)					 ::flixel::math::FlxBasePoint this3 = letter1->spawnScale;
HXDLIN( 238)					Float y1 = this->scaleY;
HXDLIN( 238)					this3->set_x(this->scaleX);
HXDLIN( 238)					this3->set_y(y1);
            				}
HXLINE( 239)				letter1->rowWidth = rowData->__get(letter1->row);
            			}
            		}
