...
HXDLIN( 276)		HX_VARI(  ::Dynamic,init) = ::hx::ClassOf< ::lime::app::Application >();
            	}
...
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin'",6d,d3,c2,da));
...
HXLINE( 109)		HX_VARI(  ::openfl::display::Preloader,preloader) =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::flixel::_hx_system::FlxPreloader_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 122)				HX_VARI(  ::lime::utils::AssetLibrary,library) = _g3->__get(_g2).StaticCast<  ::lime::utils::AssetLibrary >();
...
HXDLIN( 160)					HX_VARI(  ::Dynamic,e) = _g;
