...
HXDLIN(  27)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(file,library1);
HXDLIN(  27)				this->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
            			}
            		}
