...
void BGSprite_obj::__construct(::String image,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y, ::Dynamic __o_scrollX, ::Dynamic __o_scrollY,::Array< ::String > animArray, ::Dynamic __o_loop){
            	...
            	HX_STACK_ARG(animArray,"animArray")
...
HXLINE(  14)					_g = (_g + 1);
HXDLIN(  14)					HX_VARI( int,i) = (_g - 1);
HXLINE(  15)					HX_VARI( ::String,anim) = animArray->__get(i);
...
HXLINE(  24)				::String library1 = null();
HXDLIN(  24)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(image,library1);
HXDLIN(  24)				this->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
            			}
...
void BGSprite_obj::dance( ::Dynamic __o_forceplay){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(forceplay,"forceplay")
HXLINE(  33)
