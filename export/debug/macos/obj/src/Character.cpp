...
void Character_obj::__construct(Float x,Float y,::String __o_character, ::Dynamic __o_isPlayer){
            	...
            	HX_STACK_ARG(isPlayer,"isPlayer")
HXLINE(  47)
...
HXLINE(  94)		HX_VARI( ::String,library) = null();
HXLINE(  95)		{
HXLINE(  95)			::String _g = this->curCharacter;
HXLINE(  99)			{
HXLINE( 100)				HX_VARI( ::String,characterPath) = ((HX_("characters/",45,3c,bf,be) + this->curCharacter) + HX_(".json",56,f1,d6,c2));
HXLINE( 103)				HX_VARI( ::String,path) = ::Paths_obj::modFolders(characterPath);
...
HXLINE( 114)					::String file1 = ((HX_("characters/",45,3c,bf,be) + ::Character_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN( 114)					if (::hx::IsNull( file1 )) {
HXLINE( 114)						file1 = HX_("",00,00,00,00);
            					}
HXDLIN( 114)					path = (HX_("assets/",4c,2a,dc,36) + file1);
            				}
HXLINE( 118)				HX_VARI( ::String,rawJson) = ::sys::io::File_obj::getContent(path);
HXLINE( 123)				HX_VARI(  ::Dynamic,json) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 124)				HX_VARI( ::String,spriteType) = HX_("sparrow",0c,3c,ac,9b);
HXLINE( 129)				HX_VARI( ::String,modTxtToFind) = ::Paths_obj::modFolders(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_(".txt",02,3f,c0,1e))) ));
HXLINE( 130)				HX_VARI( ::String,txtToFind) = ::Paths_obj::getPath(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_(".txt",02,3f,c0,1e))) ),HX_("TEXT",ad,94,ba,37),null());
...
HXLINE( 144)				HX_VARI( ::String,modAnimToFind) = ::Paths_obj::modFolders(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_("/Animation.json",61,fc,54,44))) ));
HXLINE( 145)				HX_VARI( ::String,animToFind) = ::Paths_obj::getPath(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_("/Animation.json",61,fc,54,44))) ),HX_("TEXT",ad,94,ba,37),null());
...
HXDLIN( 161)					 ::Dynamic _hx_tmp4;
HXDLIN( 161)					if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 161)						_hx_tmp4 = imageLoaded;
            					}
            					else {
HXLINE( 161)						 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(key,library1);
HXDLIN( 161)						_hx_tmp4 = returnAsset;
            					}
HXDLIN( 161)					::String _hx_tmp5;
HXDLIN( 161)					if (txtExists) {
HXLINE( 161)						_hx_tmp5 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))));
            					}
            					else {
HXLINE( 161)						_hx_tmp5 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library1);
            					}
HXDLIN( 161)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp4,_hx_tmp5));
HXDLIN( 161)					goto _hx_goto_0;
            				}
            				if (  (_hx_switch_0==HX_("sparrow",0c,3c,ac,9b)) ){
HXLINE( 164)					::String key1 = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXDLIN( 164)					::String library2 = null();
HXDLIN( 164)					 ::flixel::graphics::FlxGraphic imageLoaded1 = ::Paths_obj::returnGraphic(key1,null());
HXDLIN( 164)					bool xmlExists = false;
HXDLIN( 164)					if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 164)						xmlExists = true;
            					}
HXDLIN( 164)					 ::Dynamic _hx_tmp6;
HXDLIN( 164)					if (::hx::IsNotNull( imageLoaded1 )) {
HXLINE( 164)						_hx_tmp6 = imageLoaded1;
            					}
            					else {
HXLINE( 164)						 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(key1,library2);
HXDLIN( 164)						_hx_tmp6 = returnAsset1;
            					}
HXDLIN( 164)					::String _hx_tmp7;
HXDLIN( 164)					if (xmlExists) {
HXLINE( 164)						_hx_tmp7 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e))));
            					}
            					else {
HXLINE( 164)						_hx_tmp7 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2);
            					}
HXDLIN( 164)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp6,_hx_tmp7));
...
HXLINE( 173)					Float _hx_tmp8 = this->get_width();
HXDLIN( 173)					this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp8 * this->jsonScale)),null());
...
HXLINE( 188)				bool _hx_tmp9;
HXDLIN( 188)				if (::hx::IsNotNull( json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic) )) {
HXLINE( 188)					_hx_tmp9 = (( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) )->length > 2);
            				}
            				else {
...
HXLINE( 195)					_hx_tmp10 = (this->animationsArray->length > 0);
            				}
            				else {
...
HXLINE( 196)						HX_VARI(  ::Dynamic,anim) = _g2->__get(_g1);
HXDLIN( 196)						_g1 = (_g1 + 1);
HXLINE( 197)						HX_VARI( ::String,animAnim) = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic))) );
HXLINE( 198)						HX_VARI( ::String,animName) = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic))) );
HXLINE( 199)						HX_VARI( int,animFps) = ( (int)(anim->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) );
HXLINE( 200)						HX_VARI( bool,animLoop) = ( (bool)(anim->__Field(HX_("loop",64,a6,b7,47),::hx::paccDynamic)) );
HXLINE( 201)						HX_VARI( ::Array< int >,animIndices) = ( (::Array< int >)(anim->__Field(HX_("indices",27,47,54,e3),::hx::paccDynamic)) );
HXLINE( 202)						bool _hx_tmp11;
HXDLIN( 202)						if (::hx::IsNotNull( animIndices )) {
HXLINE( 202)							_hx_tmp11 = (animIndices->length > 0);
            						}
            						else {
...
HXLINE( 208)						bool _hx_tmp12;
HXDLIN( 208)						if (::hx::IsNotNull( anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) )) {
HXLINE( 208)							_hx_tmp12 = (( (::Array< int >)(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic)) )->length > 1);
            						}
            						else {
HXLINE( 208)							_hx_tmp12 = false;
            						}
HXDLIN( 208)						if (_hx_tmp12) {
...
HXLINE( 219)		bool _hx_tmp13;
HXDLIN( 219)		bool _hx_tmp14;
HXDLIN( 219)		bool _hx_tmp15;
HXDLIN( 219)		if (!(this->animOffsets->exists(HX_("singLEFTmiss",d2,2f,9c,b6)))) {
HXLINE( 219)			_hx_tmp15 = this->animOffsets->exists(HX_("singDOWNmiss",ad,e9,88,e4));
            		}
            		else {
HXLINE( 219)			_hx_tmp15 = true;
            		}
HXDLIN( 219)		if (!(_hx_tmp15)) {
HXLINE( 219)			_hx_tmp14 = this->animOffsets->exists(HX_("singUPmiss",66,22,08,8a));
            		}
            		else {
HXLINE( 219)			_hx_tmp14 = true;
            		}
HXDLIN( 219)		if (!(_hx_tmp14)) {
HXLINE( 219)			_hx_tmp13 = this->animOffsets->exists(HX_("singRIGHTmiss",89,cc,65,e3));
            		}
            		else {
HXLINE( 219)			_hx_tmp13 = true;
            		}
HXDLIN( 219)		if (_hx_tmp13) {
...
HXLINE( 263)				 ::Character _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 263)				_hx_tmp1->heyTimer = (_hx_tmp1->heyTimer - (elapsed * ::PlayState_obj::instance->playbackRate));
HXLINE( 264)				if ((this->heyTimer <= 0)) {
HXLINE( 266)					bool _hx_tmp2;
HXDLIN( 266)					bool _hx_tmp3;
HXDLIN( 266)					if (this->specialAnim) {
HXLINE( 266)						_hx_tmp3 = (this->animation->_curAnim->name == HX_("hey",dc,42,4f,00));
            					}
            					else {
HXLINE( 266)						_hx_tmp3 = false;
            					}
HXDLIN( 266)					if (!(_hx_tmp3)) {
HXLINE( 266)						_hx_tmp2 = (this->animation->_curAnim->name == HX_("cheer",8d,9a,b6,45));
            					}
            					else {
...
HXLINE( 273)					_hx_tmp4 = this->animation->_curAnim->finished;
            				}
            				else {
...
HXLINE( 282)					_hx_tmp5 = ::hx::IsGreater( ::Conductor_obj::songPosition,this->animationNotes->__get(0)->__GetItem(0) );
            				}
            				else {
HXLINE( 282)					_hx_tmp5 = false;
            				}
HXDLIN( 282)				if (_hx_tmp5) {
HXLINE( 284)					HX_VARI( int,noteData) = 1;
...
HXLINE( 298)					 ::Character _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 298)					_hx_tmp6->holdTimer = (_hx_tmp6->holdTimer + elapsed);
            				}
HXLINE( 301)				Float _hx_tmp7;
HXDLIN( 301)				if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music )) {
HXLINE( 301)					_hx_tmp7 = ::flixel::FlxG_obj::sound->music->_pitch;
            				}
            				else {
HXLINE( 301)					_hx_tmp7 = ( (Float)(1) );
            				}
HXDLIN( 301)				if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * (((Float)0.0011) / _hx_tmp7)) * this->singDuration))) {
...
HXLINE( 308)				_hx_tmp8 = ::hx::IsNotNull( this->animation->_animations->get((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30))) );
            			}
            			else {
...
HXLINE( 345)		HX_VARI( ::cpp::VirtualArray,daOffset) = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
...
HXLINE( 351)			 ::flixel::math::FlxBasePoint this2 = this->offset;
HXDLIN( 351)			this2->set_x(( (Float)(0) ));
HXDLIN( 351)			this2->set_y(( (Float)(0) ));
            		}
...
HXDLIN( 373)		HX_VARI( ::Array< ::Dynamic>,noteData) = ( (::Array< ::Dynamic>)(::Song_obj::loadFromJson(HX_("picospeaker",ba,c2,19,7e),hideChars->split(path1)->join(HX_("",00,00,00,00)).toLowerCase())->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)) );
HXLINE( 374)		{
HXLINE( 374)			int _g = 0;
HXDLIN( 374)			while((_g < noteData->length)){
HXLINE( 374)				HX_VARI(  ::Dynamic,section) = noteData->__get(_g);
HXDLIN( 374)				_g = (_g + 1);
HXLINE( 375)				{
...
HXLINE( 375)						HX_VARI(  ::Dynamic,songNotes) = _g2->__get(_g1);
...
void Character_obj::recalculateDanceIdle(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 390)
HXLINE( 391)		HX_VARI( bool,lastDanceIdle) = this->danceIdle;
...
HXDLIN( 396)			this->danceEveryNumBeats = _hx_tmp1;
            		}
            		else {
HXLINE( 398)			if ((lastDanceIdle != this->danceIdle)) {
HXLINE( 400)				HX_VARI( Float,calc) = ( (Float)(this->danceEveryNumBeats) );
