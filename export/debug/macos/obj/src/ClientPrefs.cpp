...
::String ClientPrefs_obj::baseGameUI;

::String ClientPrefs_obj::ratingCams;
...
HXLINE( 108)		::flixel::FlxG_obj::save->data->__SetField(HX_("framerate",8d,e5,4b,4e),::ClientPrefs_obj::framerate,::hx::paccDynamic);
HXLINE( 111)		::flixel::FlxG_obj::save->data->__SetField(HX_("camZooms",71,f3,cd,90),::ClientPrefs_obj::camZooms,::hx::paccDynamic);
HXLINE( 112)		::flixel::FlxG_obj::save->data->__SetField(HX_("noteOffset",25,a5,53,fe),::ClientPrefs_obj::noteOffset,::hx::paccDynamic);
HXLINE( 113)		::flixel::FlxG_obj::save->data->__SetField(HX_("hideHud",15,b9,3c,b7),::ClientPrefs_obj::hideHud,::hx::paccDynamic);
HXLINE( 114)		::flixel::FlxG_obj::save->data->__SetField(HX_("arrowHSV",c2,f4,b4,fd),::ClientPrefs_obj::arrowHSV,::hx::paccDynamic);
HXLINE( 115)		::flixel::FlxG_obj::save->data->__SetField(HX_("ghostTapping",c6,6a,da,10),::ClientPrefs_obj::ghostTapping,::hx::paccDynamic);
HXLINE( 116)		::flixel::FlxG_obj::save->data->__SetField(HX_("timeBarType",a0,5d,bb,01),::ClientPrefs_obj::timeBarType,::hx::paccDynamic);
HXLINE( 117)		::flixel::FlxG_obj::save->data->__SetField(HX_("scoreZoom",85,53,bc,e0),::ClientPrefs_obj::scoreZoom,::hx::paccDynamic);
HXLINE( 118)		::flixel::FlxG_obj::save->data->__SetField(HX_("noReset",ce,cd,cb,b9),::ClientPrefs_obj::noReset,::hx::paccDynamic);
HXLINE( 119)		::flixel::FlxG_obj::save->data->__SetField(HX_("healthBarAlpha",47,c9,a0,80),::ClientPrefs_obj::healthBarAlpha,::hx::paccDynamic);
HXLINE( 120)		::flixel::FlxG_obj::save->data->__SetField(HX_("comboOffset",81,62,09,89),::ClientPrefs_obj::comboOffset,::hx::paccDynamic);
HXLINE( 121)		::flixel::FlxG_obj::save->data->__SetField(HX_("achievementsMap",d8,6f,d5,91),::Achievements_obj::achievementsMap,::hx::paccDynamic);
HXLINE( 122)		::flixel::FlxG_obj::save->data->__SetField(HX_("henchmenDeath",f4,76,2a,dd),::Achievements_obj::henchmenDeath,::hx::paccDynamic);
HXLINE( 123)		::flixel::FlxG_obj::save->data->__SetField(HX_("baseGameUI",b7,dd,29,29),::ClientPrefs_obj::baseGameUI,::hx::paccDynamic);
HXLINE( 124)		::flixel::FlxG_obj::save->data->__SetField(HX_("ratingCams",41,4c,e6,fd),::ClientPrefs_obj::ratingCams,::hx::paccDynamic);
HXLINE( 126)		::flixel::FlxG_obj::save->data->__SetField(HX_("ratingOffset",90,b3,eb,a5),::ClientPrefs_obj::ratingOffset,::hx::paccDynamic);
HXLINE( 127)		::flixel::FlxG_obj::save->data->__SetField(HX_("sickWindow",4e,b7,93,ed),::ClientPrefs_obj::sickWindow,::hx::paccDynamic);
HXLINE( 128)		::flixel::FlxG_obj::save->data->__SetField(HX_("goodWindow",0d,a9,05,67),::ClientPrefs_obj::goodWindow,::hx::paccDynamic);
HXLINE( 129)		::flixel::FlxG_obj::save->data->__SetField(HX_("badWindow",95,db,0a,32),::ClientPrefs_obj::badWindow,::hx::paccDynamic);
HXLINE( 130)		::flixel::FlxG_obj::save->data->__SetField(HX_("safeFrames",d3,18,18,62),::ClientPrefs_obj::safeFrames,::hx::paccDynamic);
HXLINE( 131)		::flixel::FlxG_obj::save->data->__SetField(HX_("gameplaySettings",e9,91,4c,17),::ClientPrefs_obj::gameplaySettings,::hx::paccDynamic);
HXLINE( 132)		::flixel::FlxG_obj::save->data->__SetField(HX_("controllerMode",1f,16,a7,29),::ClientPrefs_obj::controllerMode,::hx::paccDynamic);
HXLINE( 133)		::flixel::FlxG_obj::save->data->__SetField(HX_("hitsoundVolume",96,34,9b,8f),::ClientPrefs_obj::hitsoundVolume,::hx::paccDynamic);
HXLINE( 134)		::flixel::FlxG_obj::save->data->__SetField(HX_("pauseMusic",cf,6d,d3,e5),::ClientPrefs_obj::pauseMusic,::hx::paccDynamic);
...
HXLINE( 140)		HX_VARI(  ::flixel::util::FlxSave,save) =  ::flixel::util::FlxSave_obj::__alloc( HX_CTX );
HXLINE( 141)		save->bind(HX_("controls_v2",65,e4,a2,26),::CoolUtil_obj::getSavePath(null()));
...
HXLINE( 144)		::flixel::FlxG_obj::log->advanced(HX_("Settings saved!",37,01,d5,e3),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            	}
...
HXLINE( 178)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("framerate",8d,e5,4b,4e),::hx::paccDynamic) )) {
HXLINE( 179)			::ClientPrefs_obj::framerate = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("framerate",8d,e5,4b,4e),::hx::paccDynamic)) );
HXLINE( 180)			if ((::ClientPrefs_obj::framerate > ::flixel::FlxG_obj::drawFramerate)) {
HXLINE( 181)				::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
HXLINE( 182)				::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
            			}
            			else {
HXLINE( 184)				::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
HXLINE( 185)				::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
            			}
            		}
...
HXLINE( 249)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("ratingCams",41,4c,e6,fd),::hx::paccDynamic) )) {
HXLINE( 250)			::ClientPrefs_obj::ratingCams = ( (::String)(::flixel::FlxG_obj::save->data->__Field(HX_("ratingCams",41,4c,e6,fd),::hx::paccDynamic)) );
            		}
HXLINE( 252)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("baseGameUI",b7,dd,29,29),::hx::paccDynamic) )) {
HXLINE( 253)			::ClientPrefs_obj::baseGameUI = ( (::String)(::flixel::FlxG_obj::save->data->__Field(HX_("baseGameUI",b7,dd,29,29),::hx::paccDynamic)) );
            		}
HXLINE( 255)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("gameplaySettings",e9,91,4c,17),::hx::paccDynamic) )) {
HXLINE( 257)			HX_VARI(  ::haxe::ds::StringMap,savedMap) = ( ( ::haxe::ds::StringMap)(::flixel::FlxG_obj::save->data->__Field(HX_("gameplaySettings",e9,91,4c,17),::hx::paccDynamic)) );
HXLINE( 258)			{
...
HXDLIN( 258)					 ::Dynamic _g_value = ::haxe::IMap_obj::get(_g_map,key);
HXDLIN( 258)					::String _g_key = key;
HXDLIN( 258)					HX_VARI( ::String,name) = _g_key;
HXDLIN( 258)					HX_VARI(  ::Dynamic,value) = _g_value;
...
HXLINE( 280)		HX_VARI(  ::flixel::util::FlxSave,save) =  ::flixel::util::FlxSave_obj::__alloc( HX_CTX );
HXLINE( 281)		save->bind(HX_("controls_v2",65,e4,a2,26),::CoolUtil_obj::getSavePath(null()));
...
HXLINE( 283)			HX_VARI(  ::haxe::ds::StringMap,loadedControls) = ( ( ::haxe::ds::StringMap)(save->data->__Field(HX_("customControls",47,63,49,5a),::hx::paccDynamic)) );
HXLINE( 284)			{
HXLINE( 284)				::Dynamic map1 = loadedControls;
HXDLIN( 284)				::Dynamic _g_map1 = map1;
HXDLIN( 284)				 ::Dynamic _g_keys1 = ::haxe::IMap_obj::keys(map1);
HXDLIN( 284)				while(( (bool)(_g_keys1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 284)					::String key1 = ( (::String)(_g_keys1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 284)					::Array< int > _g_value1 = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map1,key1)) );
HXDLIN( 284)					::String _g_key1 = key1;
HXDLIN( 284)					HX_VARI( ::String,control) = _g_key1;
HXDLIN( 284)					HX_VARI( ::Array< int >,keys) = _g_value1;
...
::Array< int > ClientPrefs_obj::copyKey(::Array< int > arrayToCopy){
            	...
            	HX_STACK_ARG(arrayToCopy,"arrayToCopy")
HXLINE( 305)
HXLINE( 306)		HX_VARI( ::Array< int >,copiedArray) = arrayToCopy->copy();
HXLINE( 307)		HX_VARI( int,i) = 0;
HXLINE( 308)		HX_VARI( int,len) = copiedArray->length;
...
bool ClientPrefs_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"baseGameUI") ) { outValue = ( baseGameUI ); return true; }
		if (HX_FIELD_EQ(inName,"ratingCams") ) { outValue = ( ratingCams ); return true; }
...
bool ClientPrefs_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"baseGameUI") ) { baseGameUI=ioValue.Cast< ::String >(); return true; }
		if (HX_FIELD_EQ(inName,"ratingCams") ) { ratingCams=ioValue.Cast< ::String >(); return true; }
...
static ::hx::StaticInfo ClientPrefs_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsString,(void *) &ClientPrefs_obj::baseGameUI,HX_("baseGameUI",b7,dd,29,29)},
	{::hx::fsString,(void *) &ClientPrefs_obj::ratingCams,HX_("ratingCams",41,4c,e6,fd)},
...
static void ClientPrefs_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(ClientPrefs_obj::baseGameUI,"baseGameUI");
	HX_MARK_MEMBER_NAME(ClientPrefs_obj::ratingCams,"ratingCams");
...
static void ClientPrefs_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(ClientPrefs_obj::baseGameUI,"baseGameUI");
	HX_VISIT_MEMBER_NAME(ClientPrefs_obj::ratingCams,"ratingCams");
...
static ::String ClientPrefs_obj_sStaticFields[] = {
	...
	HX_("baseGameUI",b7,dd,29,29),
	HX_("ratingCams",41,4c,e6,fd),
...
HXDLIN(  36)		baseGameUI = HX_("Friday Night Funkin",7a,b7,3d,fb);
            	}
{
            	HX_STACKFRAME(&_hx_pos_1453641688f31b8d_37_boot)
HXDLIN(  37)		ratingCams = HX_("World",32,06,92,61);
            	}
{
