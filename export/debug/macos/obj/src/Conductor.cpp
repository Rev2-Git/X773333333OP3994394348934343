...
::Array< ::Dynamic> Conductor_obj::bpmChangeMap;
 ...
 ::Rating Conductor_obj::judgeNote( ::Note note,::hx::Null< Float >  __o_diff){
            	...
            	HX_STACK_ARG(diff,"diff")
HXLINE(  37)
HXLINE(  38)		HX_VARI( ::Array< ::Dynamic>,data) = ::PlayState_obj::instance->ratingsData;
HXLINE(  39)		{
HXLINE(  39)			int _g = 0;
...
HXLINE(  49)
HXLINE(  50)		HX_VARI(  ::Dynamic,lastChange) = ::Conductor_obj::getBPMFromSeconds(time);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Conductor_obj,getCrotchetAtTime,return )
 ...
 ::Dynamic Conductor_obj::getBPMFromSeconds(Float time){
            	...
            	HX_STACK_ARG(time,"time")
HXLINE(  54)
HXLINE(  55)		HX_VARI(  ::Dynamic,lastChange) =  ::Dynamic(::hx::Anon_obj::Create(4)
...
HXLINE(  70)
HXLINE(  71)		HX_VARI(  ::Dynamic,lastChange) =  ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("stepTime",79,75,25,a0),0)
            			->setFixed(1,HX_("stepCrochet",48,d7,ff,e6),::Conductor_obj::stepCrochet)
            			->setFixed(2,HX_("bpm",df,be,4a,00),::Conductor_obj::bpm)
            			->setFixed(3,HX_("songTime",82,2a,d5,3a),( (Float)(0) )));
...
Float Conductor_obj::beatToSeconds(Float beat){
            	...
            	HX_STACK_ARG(beat,"beat")
HXLINE(  86)
HXLINE(  87)		HX_VARI( Float,step) = (beat * ( (Float)(4) ));
HXLINE(  88)		HX_VARI(  ::Dynamic,lastChange) = ::Conductor_obj::getBPMFromStep(step);
...
Float Conductor_obj::getStep(Float time){
            	...
            	HX_STACK_ARG(time,"time")
HXLINE(  92)
HXLINE(  93)		HX_VARI(  ::Dynamic,lastChange) = ::Conductor_obj::getBPMFromSeconds(time);
...
Float Conductor_obj::getStepRounded(Float time){
            	...
            	HX_STACK_ARG(time,"time")
HXLINE(  97)
HXLINE(  98)		HX_VARI(  ::Dynamic,lastChange) = ::Conductor_obj::getBPMFromSeconds(time);
...
HXLINE( 114)		HX_VARI( Float,curBPM) = ( (Float)(song->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) );
HXLINE( 115)		HX_VARI( int,totalSteps) = 0;
HXLINE( 116)		HX_VARI( Float,totalPos) = ( (Float)(0) );
HXLINE( 117)		{
HXLINE( 117)			int _g = 0;
HXDLIN( 117)			int _g1 = ( (::Array< ::Dynamic>)(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)) )->length;
HXDLIN( 117)			while((_g < _g1)){
HXLINE( 117)				_g = (_g + 1);
HXDLIN( 117)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 122)					HX_VARI(  ::Dynamic,event) =  ::Dynamic(::hx::Anon_obj::Create(4)
...
HXLINE( 131)				HX_VARI( int,deltaSteps) = ::Math_obj::round((( (Float)(::Conductor_obj::getSectionBeats(song,i)) ) * ( (Float)(4) )));
...
HXLINE( 135)		 ::Dynamic _hx_tmp1 = ::haxe::Log_obj::trace;
HXDLIN( 135)		::String _hx_tmp2 = (HX_("new BPM map BUDDY ",ff,cc,e3,2e) + ::Std_obj::string(::Conductor_obj::bpmChangeMap));
HXDLIN( 135)		_hx_tmp1(_hx_tmp2,::hx::SourceInfo(HX_("source/Conductor.hx",4b,4e,2d,f0),135,HX_("Conductor",c7,77,a1,7b),HX_("mapBPMChanges",a0,c9,ba,4a)));
            	}
...
HXLINE( 139)
HXLINE( 140)		HX_VARI(  ::Dynamic,val) = null();
