...
HXLINE(  30)
HXLINE(  32)		HX_VARI( Float,m) = ::Math_obj::fround((f * snap));
...
HXLINE(  41)		HX_VARI( ::String,fileSuffix) = ::CoolUtil_obj::difficulties->__get(( (int)(num) ));
...
HXLINE(  63)
HXLINE(  64)		HX_VARI( ::Array< ::String >,daList) = ::Array_obj< ::String >::__new(0);
...
HXLINE(  79)
HXLINE(  80)		HX_VARI( ::Array< ::String >,daList) = ::Array_obj< ::String >::__new(0);
...
HXLINE(  90)
HXLINE(  91)		HX_VARI(  ::haxe::ds::IntMap,countByColor) =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  92)		{
HXLINE(  92)			int _g = 0;
HXDLIN(  92)			int _g1 = sprite->frameWidth;
HXDLIN(  92)			while((_g < _g1)){
HXLINE(  92)				_g = (_g + 1);
HXDLIN(  92)				HX_VARI( int,col) = (_g - 1);
HXLINE(  93)				{
HXLINE(  93)					int _g2 = 0;
HXDLIN(  93)					int _g3 = sprite->frameHeight;
HXDLIN(  93)					while((_g2 < _g3)){
HXLINE(  93)						_g2 = (_g2 + 1);
HXDLIN(  93)						HX_VARI( int,row) = (_g2 - 1);
HXLINE(  94)						HX_VARI( int,colorOfThisPixel) = sprite->get_pixels()->getPixel32(col,row);
...
HXLINE( 104)		HX_VARI( int,maxCount) = 0;
HXLINE( 105)		HX_VARI( int,maxKey) = 0;
HXLINE( 106)		countByColor->set(-16777216,0);
HXLINE( 107)		{
HXLINE( 107)			HX_VARI(  ::Dynamic,key) = countByColor->keys();
HXDLIN( 107)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 107)				HX_VARI_NAME( int,key1,"key") = ( (int)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
::Array< int > CoolUtil_obj::numberArray(int max, ::Dynamic __o_min){
            	...
            	HX_STACK_ARG(min,"min")
HXLINE( 117)
HXLINE( 118)		HX_VARI( ::Array< int >,dumbArray) = ::Array_obj< int >::__new(0);
HXLINE( 119)		{
HXLINE( 119)			int _g = ( (int)(min) );
HXDLIN( 119)			int _g1 = max;
HXDLIN( 119)			while((_g < _g1)){
HXLINE( 119)				_g = (_g + 1);
HXDLIN( 119)				HX_VARI( int,i) = (_g - 1);
