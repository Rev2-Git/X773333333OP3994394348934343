...
void CustomFadeTransition_obj::__construct(Float duration,bool isTransIn){
            	...
            	HX_STACK_ARG(isTransIn,"isTransIn")
HXLINE(  17)
...
HXLINE(  29)		HX_VARI( Float,zoom) = ::Math_obj::max(((Float)0.05),::Math_obj::min(( (Float)(1) ),::flixel::FlxG_obj::camera->zoom));
HXLINE(  30)		HX_VARI( int,width) = ::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) / zoom));
HXLINE(  31)		HX_VARI( int,height) = ::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::height) ) / zoom));
...
HXLINE(  44)			 ::flixel::FlxSprite _hx_tmp1 = this->transGradient;
HXDLIN(  44)			Float _hx_tmp2 = this->transBlack->y;
HXDLIN(  44)			_hx_tmp1->set_y((_hx_tmp2 - this->transBlack->get_height()));
HXLINE(  45)			 ::flixel::FlxSprite _hx_tmp3 = this->transGradient;
HXDLIN(  45)			Float _hx_tmp4 = (this->transGradient->get_height() + 50);
HXDLIN(  45)			::flixel::tweens::FlxTween_obj::tween(_hx_tmp3, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE(  51)			 ::flixel::FlxSprite _hx_tmp5 = this->transGradient;
HXDLIN(  51)			_hx_tmp5->set_y(-(this->transGradient->get_height()));
HXLINE(  52)			 ::flixel::FlxSprite _hx_tmp6 = this->transBlack;
HXDLIN(  52)			Float _hx_tmp7 = this->transGradient->y;
HXDLIN(  52)			_hx_tmp6->set_y(((_hx_tmp7 - this->transBlack->get_height()) + 50));
HXLINE(  53)			 ::flixel::FlxSprite _hx_tmp8 = this->transGradient;
HXDLIN(  53)			Float _hx_tmp9 = (this->transGradient->get_height() + 50);
HXDLIN(  53)			this->leTween = ::flixel::tweens::FlxTween_obj::tween(_hx_tmp8, ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("y",79,00,00,00),_hx_tmp9)),duration, ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::linear_dyn())
...
HXLINE(  73)			 ::flixel::FlxSprite _hx_tmp2 = this->transBlack;
HXDLIN(  73)			Float _hx_tmp3 = this->transGradient->y;
HXDLIN(  73)			_hx_tmp2->set_y((_hx_tmp3 - this->transBlack->get_height()));
            		}
HXLINE(  75)		this->super::update(elapsed);
HXLINE(  76)		if (this->isTransIn) {
HXLINE(  77)			 ::flixel::FlxSprite _hx_tmp4 = this->transBlack;
HXDLIN(  77)			Float _hx_tmp5 = this->transGradient->y;
HXDLIN(  77)			_hx_tmp4->set_y((_hx_tmp5 + this->transGradient->get_height()));
            		}
            		else {
HXLINE(  79)			 ::flixel::FlxSprite _hx_tmp6 = this->transBlack;
HXDLIN(  79)			Float _hx_tmp7 = this->transGradient->y;
HXDLIN(  79)			_hx_tmp6->set_y((_hx_tmp7 - this->transBlack->get_height()));
            		}
            	}
