...
HXLINE(  62)					HX_VARI(  ::flixel::FlxSprite,spr) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  62)					_g = (_g + 1);
HXLINE(  64)					spr->kill();
...
HXLINE(  74)				_hx_tmp2 = ::hx::IsLessEq( this->timedEvents->__get(0)->__GetItem(0),this->cutsceneTime );
            			}
            			else {
