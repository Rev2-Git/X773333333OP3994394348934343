...
HXLINE(  61)				_gthis->bgFade->set_alpha(((Float)0.7));
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(talkingRight,"talkingRight")
            	HX_STACK_ARG(dialogueList,"dialogueList")
HXLINE(  15)
...
HXLINE(  48)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN(  48)			::String library1 = null();
HXDLIN(  48)			 ::openfl::media::Sound file1 = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("LunchboxScary",57,33,01,24),library1);
HXDLIN(  48)			_hx_tmp1->playMusic(file1,0,null(),null());
HXLINE(  49)			{
HXLINE(  49)				 ::flixel::_hx_system::FlxSound _this1 = ::flixel::FlxG_obj::sound->music;
HXDLIN(  49)				 ::Dynamic onComplete1 = null();
HXDLIN(  49)				if (::hx::IsNull( _this1->_channel )) {
HXLINE(  49)					_this1->play(null(),null(),null());
            				}
HXDLIN(  49)				if (::hx::IsNotNull( _this1->fadeTween )) {
HXLINE(  49)					_this1->fadeTween->cancel();
            				}
HXDLIN(  49)				_this1->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),((Float)0.8),1, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete1)),_this1->volumeTween_dyn());
            			}
HXLINE(  47)			goto _hx_goto_0;
            		}
            		_hx_goto_0:;
HXLINE(  52)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-200,-200,null());
HXDLIN(  52)		int _hx_tmp3 = ::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)1.3)));
HXDLIN(  52)		this->bgFade = _hx_tmp2->makeGraphic(_hx_tmp3,::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::height) ) * ((Float)1.3))),-4988968,null(),null());
HXLINE(  53)		{
...
HXLINE(  66)		HX_VARI( bool,hasDialog) = false;
...
HXLINE(  76)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp4 = ::flixel::FlxG_obj::sound;
HXDLIN(  76)			_hx_tmp4->play(::Paths_obj::sound(HX_("ANGRY_TEXT_BOX",57,5c,5c,19),null()),null(),null(),null(),null(),null());
HXLINE(  78)			 ::flixel::FlxSprite _hx_tmp5 = this->box;
...
HXDLIN(  78)			 ::Dynamic _hx_tmp6;
HXDLIN(  78)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE(  78)				_hx_tmp6 = imageLoaded;
            			}
            			else {
HXLINE(  78)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("weeb/pixelUI/dialogueBox-senpaiMad",61,55,ee,84),library2);
HXDLIN(  78)				_hx_tmp6 = returnAsset;
            			}
HXDLIN(  78)			::String _hx_tmp7;
HXDLIN(  78)			if (xmlExists) {
HXLINE(  78)				_hx_tmp7 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-senpaiMad",61,55,ee,84)) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE(  78)				_hx_tmp7 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-senpaiMad",61,55,ee,84)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2);
            			}
HXDLIN(  78)			_hx_tmp5->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp6,_hx_tmp7));
...
HXLINE(  71)			 ::flixel::FlxSprite _hx_tmp8 = this->box;
HXDLIN(  71)			::String library3 = null();
HXDLIN(  71)			 ::flixel::graphics::FlxGraphic imageLoaded1 = ::Paths_obj::returnGraphic(HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da),null());
HXDLIN(  71)			bool xmlExists1 = false;
...
HXLINE(  71)				xmlExists1 = true;
            			}
HXDLIN(  71)			 ::Dynamic _hx_tmp9;
HXDLIN(  71)			if (::hx::IsNotNull( imageLoaded1 )) {
HXLINE(  71)				_hx_tmp9 = imageLoaded1;
            			}
            			else {
HXLINE(  71)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da),library3);
HXDLIN(  71)				_hx_tmp9 = returnAsset1;
            			}
HXDLIN(  71)			::String _hx_tmp10;
HXDLIN(  71)			if (xmlExists1) {
HXLINE(  71)				_hx_tmp10 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da)) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE(  71)				_hx_tmp10 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library3);
            			}
HXDLIN(  71)			_hx_tmp8->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp9,_hx_tmp10));
...
HXLINE(  84)			 ::flixel::FlxSprite _hx_tmp11 = this->box;
HXDLIN(  84)			::String library4 = null();
HXDLIN(  84)			 ::flixel::graphics::FlxGraphic imageLoaded2 = ::Paths_obj::returnGraphic(HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc),null());
HXDLIN(  84)			bool xmlExists2 = false;
...
HXLINE(  84)				xmlExists2 = true;
            			}
HXDLIN(  84)			 ::Dynamic _hx_tmp12;
HXDLIN(  84)			if (::hx::IsNotNull( imageLoaded2 )) {
HXLINE(  84)				_hx_tmp12 = imageLoaded2;
            			}
            			else {
HXLINE(  84)				 ::flixel::graphics::FlxGraphic returnAsset2 = ::Paths_obj::returnGraphic(HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc),library4);
HXDLIN(  84)				_hx_tmp12 = returnAsset2;
            			}
HXDLIN(  84)			::String _hx_tmp13;
HXDLIN(  84)			if (xmlExists2) {
HXLINE(  84)				_hx_tmp13 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc)) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE(  84)				_hx_tmp13 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library4);
            			}
HXDLIN(  84)			_hx_tmp11->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp12,_hx_tmp13));
...
HXDLIN(  88)			::String library5 = null();
HXDLIN(  88)			 ::flixel::graphics::FlxGraphic returnAsset3 = ::Paths_obj::returnGraphic(HX_("weeb/spiritFaceForward",93,1c,29,2a),library5);
HXDLIN(  88)			HX_VARI(  ::flixel::FlxSprite,face1) = face->loadGraphic(returnAsset3,null(),null(),null(),null(),null());
...
HXLINE(  99)		 ::flixel::FlxSprite _hx_tmp14 = this->portraitLeft;
HXDLIN(  99)		::String library6 = null();
HXDLIN(  99)		 ::flixel::graphics::FlxGraphic imageLoaded3 = ::Paths_obj::returnGraphic(HX_("weeb/senpaiPortrait",9b,ed,4f,6d),null());
HXDLIN(  99)		bool xmlExists3 = false;
...
HXLINE(  99)			xmlExists3 = true;
            		}
HXDLIN(  99)		 ::Dynamic _hx_tmp15;
HXDLIN(  99)		if (::hx::IsNotNull( imageLoaded3 )) {
HXLINE(  99)			_hx_tmp15 = imageLoaded3;
            		}
            		else {
HXLINE(  99)			 ::flixel::graphics::FlxGraphic returnAsset4 = ::Paths_obj::returnGraphic(HX_("weeb/senpaiPortrait",9b,ed,4f,6d),library6);
HXDLIN(  99)			_hx_tmp15 = returnAsset4;
            		}
HXDLIN(  99)		::String _hx_tmp16;
HXDLIN(  99)		if (xmlExists3) {
HXLINE(  99)			_hx_tmp16 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  99)			_hx_tmp16 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library6);
            		}
HXDLIN(  99)		_hx_tmp14->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp15,_hx_tmp16));
...
HXLINE( 101)		 ::flixel::FlxSprite _hx_tmp17 = this->portraitLeft;
HXDLIN( 101)		Float _hx_tmp18 = this->portraitLeft->get_width();
HXDLIN( 101)		_hx_tmp17->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp18 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
...
HXLINE( 108)		 ::flixel::FlxSprite _hx_tmp19 = this->portraitRight;
HXDLIN( 108)		::String library7 = null();
HXDLIN( 108)		 ::flixel::graphics::FlxGraphic imageLoaded4 = ::Paths_obj::returnGraphic(HX_("weeb/bfPortrait",23,ea,7a,a3),null());
HXDLIN( 108)		bool xmlExists4 = false;
...
HXLINE( 108)			xmlExists4 = true;
            		}
HXDLIN( 108)		 ::Dynamic _hx_tmp20;
HXDLIN( 108)		if (::hx::IsNotNull( imageLoaded4 )) {
HXLINE( 108)			_hx_tmp20 = imageLoaded4;
            		}
            		else {
HXLINE( 108)			 ::flixel::graphics::FlxGraphic returnAsset5 = ::Paths_obj::returnGraphic(HX_("weeb/bfPortrait",23,ea,7a,a3),library7);
HXDLIN( 108)			_hx_tmp20 = returnAsset5;
            		}
HXDLIN( 108)		::String _hx_tmp21;
HXDLIN( 108)		if (xmlExists4) {
HXLINE( 108)			_hx_tmp21 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE( 108)			_hx_tmp21 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library7);
            		}
HXDLIN( 108)		_hx_tmp19->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp20,_hx_tmp21));
...
HXLINE( 110)		 ::flixel::FlxSprite _hx_tmp22 = this->portraitRight;
HXDLIN( 110)		Float _hx_tmp23 = this->portraitRight->get_width();
HXDLIN( 110)		_hx_tmp22->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp23 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
...
HXLINE( 117)		 ::flixel::FlxSprite _hx_tmp24 = this->box;
HXDLIN( 117)		Float _hx_tmp25 = this->box->get_width();
HXDLIN( 117)		_hx_tmp24->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp25 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 118)		this->box->updateHitbox();
HXLINE( 119)		this->add(this->box);
HXLINE( 121)		{
HXLINE( 121)			 ::flixel::FlxSprite _this2 = this->box;
HXDLIN( 121)			int axes = 1;
HXDLIN( 121)			bool _hx_tmp26;
HXDLIN( 121)			if ((axes != 1)) {
HXLINE( 121)				_hx_tmp26 = (axes == 17);
            			}
            			else {
HXLINE( 121)				_hx_tmp26 = true;
            			}
HXDLIN( 121)			if (_hx_tmp26) {
HXLINE( 121)				int _hx_tmp27 = ::flixel::FlxG_obj::width;
HXDLIN( 121)				_this2->set_x(((( (Float)(_hx_tmp27) ) - _this2->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 121)			bool _hx_tmp28;
HXDLIN( 121)			if ((axes != 16)) {
HXLINE( 121)				_hx_tmp28 = (axes == 17);
            			}
            			else {
HXLINE( 121)				_hx_tmp28 = true;
            			}
HXDLIN( 121)			if (_hx_tmp28) {
HXLINE( 121)				int _hx_tmp29 = ::flixel::FlxG_obj::height;
HXDLIN( 121)				_this2->set_y(((( (Float)(_hx_tmp29) ) - _this2->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 122)		{
HXLINE( 122)			 ::flixel::FlxSprite _this3 = this->portraitLeft;
HXDLIN( 122)			int axes1 = 1;
HXDLIN( 122)			bool _hx_tmp30;
HXDLIN( 122)			if ((axes1 != 1)) {
HXLINE( 122)				_hx_tmp30 = (axes1 == 17);
            			}
            			else {
HXLINE( 122)				_hx_tmp30 = true;
            			}
HXDLIN( 122)			if (_hx_tmp30) {
HXLINE( 122)				int _hx_tmp31 = ::flixel::FlxG_obj::width;
HXDLIN( 122)				_this3->set_x(((( (Float)(_hx_tmp31) ) - _this3->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 122)			bool _hx_tmp32;
HXDLIN( 122)			if ((axes1 != 16)) {
HXLINE( 122)				_hx_tmp32 = (axes1 == 17);
            			}
            			else {
HXLINE( 122)				_hx_tmp32 = true;
            			}
HXDLIN( 122)			if (_hx_tmp32) {
HXLINE( 122)				int _hx_tmp33 = ::flixel::FlxG_obj::height;
HXDLIN( 122)				_this3->set_y(((( (Float)(_hx_tmp33) ) - _this3->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 124)		 ::flixel::FlxSprite _hx_tmp34 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,1042,590,null());
HXDLIN( 124)		::String library8 = null();
HXDLIN( 124)		 ::flixel::graphics::FlxGraphic returnAsset6 = ::Paths_obj::returnGraphic(HX_("weeb/pixelUI/hand_textbox",67,1b,cd,60),library8);
HXDLIN( 124)		this->handSelect = _hx_tmp34->loadGraphic(returnAsset6,null(),null(),null(),null(),null());
HXLINE( 125)		 ::flixel::FlxSprite _hx_tmp35 = this->handSelect;
HXDLIN( 125)		Float _hx_tmp36 = this->handSelect->get_width();
HXDLIN( 125)		_hx_tmp35->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp36 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 126)		this->handSelect->updateHitbox();
HXLINE( 127)		this->handSelect->set_visible(false);
HXLINE( 128)		this->add(this->handSelect);
HXLINE( 131)		bool _hx_tmp37 = !(talkingRight);
...
HXLINE( 144)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp38 = ::flixel::FlxG_obj::sound;
HXDLIN( 144)		 ::flixel::_hx_system::FlxSound _hx_tmp39 = _hx_tmp38->load(::Paths_obj::sound(HX_("pixelText",53,7a,83,06),null()),((Float)0.6),null(),null(),null(),null(),null(),null(),null());
HXDLIN( 144)		this->swagDialogue->sounds = ::Array_obj< ::Dynamic>::__new(1)->init(0,_hx_tmp39);
...
HXLINE( 175)			_hx_tmp1 = !(this->dialogueStarted);
            		}
            		else {
...
HXLINE( 185)					_hx_tmp2 = ::hx::IsNotNull( this->dialogueList->__get(0) );
            				}
            				else {
...
HXLINE( 190)						 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN( 190)						_hx_tmp3->play(::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
...
HXLINE( 192)							_hx_tmp4 = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c));
            						}
            						else {
...
HXLINE( 217)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp5 = ::flixel::FlxG_obj::sound;
HXDLIN( 217)					_hx_tmp5->play(::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
            				}
            			}
            			else {
HXLINE( 220)				if (this->dialogueStarted) {
HXLINE( 222)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp6 = ::flixel::FlxG_obj::sound;
HXDLIN( 222)					_hx_tmp6->play(::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
...
void DialogueBox_obj::cleanDialog(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 276)
HXLINE( 277)		HX_VARI( ::Array< ::String >,splitName) = this->dialogueList->__get(0).split(HX_(":",3a,00,00,00));
