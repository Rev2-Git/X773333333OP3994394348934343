...
HXDLIN( 193)			_hx_tmp1->playMusic(file,0,null(),null());
HXLINE( 194)			{
...
HXLINE( 197)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-500,-500,null());
HXDLIN( 197)		this->bgFade = _hx_tmp2->makeGraphic((::flixel::FlxG_obj::width * 2),(::flixel::FlxG_obj::height * 2),-1,null(),null());
HXLINE( 198)		{
...
HXLINE( 207)		 ::flixel::FlxSprite _hx_tmp3 = this->box;
HXDLIN( 207)		::String library1 = null();
...
HXDLIN( 207)		 ::Dynamic _hx_tmp4;
HXDLIN( 207)		if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 207)			_hx_tmp4 = imageLoaded;
            		}
            		else {
HXLINE( 207)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("speech_bubble",49,db,97,da),library1);
HXDLIN( 207)			_hx_tmp4 = returnAsset;
            		}
HXDLIN( 207)		::String _hx_tmp5;
HXDLIN( 207)		if (xmlExists) {
HXLINE( 207)			_hx_tmp5 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE( 207)			_hx_tmp5 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1);
            		}
HXDLIN( 207)		_hx_tmp3->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp4,_hx_tmp5));
HXLINE( 208)		{
...
HXLINE( 220)		 ::flixel::FlxSprite _hx_tmp6 = this->box;
HXDLIN( 220)		_hx_tmp6->setGraphicSize(::Std_obj::_hx_int((this->box->get_width() * ((Float)0.9))),null());
...
void DialogueBoxPsych_obj::spawnCharacters(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 239)
HXLINE( 241)		HX_VARI(  ::haxe::ds::StringMap,charsMap) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 245)		{
HXLINE( 245)			int _g = 0;
...
HXLINE( 245)				_g = (_g + 1);
HXDLIN( 245)				HX_VARI( int,i) = (_g - 1);
HXLINE( 246)				if (::hx::IsNotNull(  ::Dynamic(this->dialogueList->__Field(HX_("dialogue",18,2d,94,a7),::hx::paccDynamic))->__GetItem(i) )) {
HXLINE( 247)					HX_VARI( ::String,charToAdd) = ( (::String)( ::Dynamic(this->dialogueList->__Field(HX_("dialogue",18,2d,94,a7),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("portrait",5b,21,af,b8),::hx::paccDynamic)) );
...
HXLINE( 254)		{
HXLINE( 254)			HX_VARI(  ::Dynamic,individualChar) = charsMap->keys();
HXDLIN( 254)			while(( (bool)(individualChar->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 254)				HX_VARI_NAME( ::String,individualChar1,"individualChar") = ( (::String)(individualChar->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 255)				HX_VARI( Float,x) = ::DialogueBoxPsych_obj::LEFT_CHAR_X;
HXLINE( 256)				HX_VARI( Float,y) = ::DialogueBoxPsych_obj::DEFAULT_CHAR_Y;
HXLINE( 257)				HX_VARI_NAME(  ::DialogueCharacter,_hx_char,"char") =  ::DialogueCharacter_obj::__alloc( HX_CTX ,(x + this->offsetPos),y,individualChar1);
HXLINE( 258)				Float _hx_tmp1 = _hx_char->get_width();
HXDLIN( 258)				_hx_char->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp1 * ::DialogueCharacter_obj::DEFAULT_SCALE) * ( (Float)(_hx_char->jsonFile->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic)) ))),null());
...
HXLINE( 264)				HX_VARI( bool,saveY) = false;
...
HXDLIN( 280)				if (saveY) {
HXLINE( 280)					_hx_tmp2 = y;
            				}
            				else {
HXLINE( 280)					_hx_tmp2 = x;
            				}
HXDLIN( 280)				_hx_char->startingPos = _hx_tmp2;
...
HXLINE( 314)								_g = (_g + 1);
HXDLIN( 314)								HX_VARI( int,i) = (_g - 1);
HXLINE( 315)								HX_VARI( ::Array< ::String >,checkArray) = ::Array_obj< ::String >::fromData( _hx_array_data_c9b73088_17,2);
HXLINE( 316)								HX_VARI( ::String,animName) = this->box->animation->_curAnim->name;
HXLINE( 317)								{
HXLINE( 317)									int _g2 = 0;
HXDLIN( 317)									int _g3 = checkArray->length;
HXDLIN( 317)									while((_g2 < _g3)){
HXLINE( 317)										_g2 = (_g2 + 1);
HXDLIN( 317)										HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN( 337)				 ::openfl::media::Sound _hx_tmp2 = ::Paths_obj::sound(this->closeSound,null());
HXDLIN( 337)				_hx_tmp1->play(_hx_tmp2,this->closeVolume,null(),null(),null(),null());
            			}
            			else {
HXLINE( 338)				if (this->daText->finishedText) {
HXLINE( 339)					HX_VARI_NAME(  ::DialogueCharacter,_hx_char,"char") = this->arrayCharacters->__get(this->lastCharacter).StaticCast<  ::DialogueCharacter >();
HXLINE( 340)					bool _hx_tmp3;
HXDLIN( 340)					bool _hx_tmp4;
HXDLIN( 340)					bool _hx_tmp5;
HXDLIN( 340)					if (::hx::IsNotNull( _hx_char )) {
HXLINE( 340)						_hx_tmp5 = ::hx::IsNotNull( _hx_char->animation->_curAnim );
            					}
            					else {
HXLINE( 340)						_hx_tmp5 = false;
            					}
HXDLIN( 340)					if (_hx_tmp5) {
HXLINE( 340)						_hx_tmp4 = _hx_char->animationIsLoop();
            					}
            					else {
HXLINE( 340)						_hx_tmp4 = false;
            					}
HXDLIN( 340)					if (_hx_tmp4) {
HXLINE( 340)						_hx_tmp3 = _hx_char->animation->get_finished();
            					}
            					else {
...
HXLINE( 344)					HX_VARI_NAME(  ::DialogueCharacter,char1,"char") = this->arrayCharacters->__get(this->lastCharacter).StaticCast<  ::DialogueCharacter >();
HXLINE( 345)					bool _hx_tmp6;
HXDLIN( 345)					bool _hx_tmp7;
HXDLIN( 345)					if (::hx::IsNotNull( char1 )) {
HXLINE( 345)						_hx_tmp7 = ::hx::IsNotNull( char1->animation->_curAnim );
            					}
            					else {
HXLINE( 345)						_hx_tmp7 = false;
            					}
HXDLIN( 345)					if (_hx_tmp7) {
HXLINE( 345)						_hx_tmp6 = char1->animation->get_finished();
            					}
            					else {
HXLINE( 345)						_hx_tmp6 = false;
            					}
HXDLIN( 345)					if (_hx_tmp6) {
HXLINE( 346)						char1->animation->_curAnim->restart();
            					}
            				}
            			}
...
HXDLIN( 351)					int _g5 = this->textBoxTypes->length;
HXDLIN( 351)					while((_g4 < _g5)){
HXLINE( 351)						_g4 = (_g4 + 1);
HXDLIN( 351)						HX_VARI_NAME( int,i1,"i") = (_g4 - 1);
HXLINE( 352)						HX_VARI_NAME( ::Array< ::String >,checkArray1,"checkArray") = ::Array_obj< ::String >::fromData( _hx_array_data_c9b73088_18,2);
HXLINE( 353)						HX_VARI_NAME( ::String,animName1,"animName") = this->box->animation->_curAnim->name;
HXLINE( 354)						{
HXLINE( 354)							int _g6 = 0;
HXDLIN( 354)							int _g7 = checkArray1->length;
HXDLIN( 354)							while((_g6 < _g7)){
HXLINE( 354)								_g6 = (_g6 + 1);
HXDLIN( 354)								HX_VARI_NAME( int,j1,"j") = (_g6 - 1);
HXLINE( 355)								bool _hx_tmp8;
HXDLIN( 355)								if ((animName1 != (checkArray1->__get(j1) + this->textBoxTypes->__get(i1)))) {
HXLINE( 355)									_hx_tmp8 = (animName1 == ((checkArray1->__get(j1) + this->textBoxTypes->__get(i1)) + HX_("Open",ea,2f,8d,34)));
            								}
            								else {
HXLINE( 355)									_hx_tmp8 = true;
            								}
HXDLIN( 355)								if (_hx_tmp8) {
HXLINE( 356)									this->box->animation->play((checkArray1->__get(j1) + this->textBoxTypes->__get(i1)),true,null(),null());
            								}
            							}
            						}
            					}
...
HXLINE( 363)				_hx_tmp9 = (this->arrayCharacters->length > 0);
            			}
            			else {
HXLINE( 363)				_hx_tmp9 = false;
            			}
HXDLIN( 363)			if (_hx_tmp9) {
HXLINE( 364)				int _g8 = 0;
HXDLIN( 364)				int _g9 = this->arrayCharacters->length;
HXDLIN( 364)				while((_g8 < _g9)){
HXLINE( 364)					_g8 = (_g8 + 1);
HXDLIN( 364)					HX_VARI_NAME( int,i2,"i") = (_g8 - 1);
HXLINE( 365)					HX_VARI_NAME(  ::DialogueCharacter,char2,"char") = this->arrayCharacters->__get(i2).StaticCast<  ::DialogueCharacter >();
HXLINE( 366)					if (::hx::IsNotNull( char2 )) {
HXLINE( 367)						if ((i2 != this->lastCharacter)) {
HXLINE( 368)							::String _hx_switch_0 = ( (::String)(char2->jsonFile->__Field(HX_("dialogue_pos",ad,3b,6d,1a),::hx::paccDynamic)) );
            							if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 373)								char2->set_y((char2->y + (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 374)								if ((char2->y > (char2->startingPos + ::flixel::FlxG_obj::height))) {
HXLINE( 374)									char2->set_y((char2->startingPos + ::flixel::FlxG_obj::height));
            								}
HXLINE( 372)								goto _hx_goto_11;
            							}
            							if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE( 370)								char2->set_x((char2->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 371)								if ((char2->x < (char2->startingPos + this->offsetPos))) {
HXLINE( 371)									char2->set_x((char2->startingPos + this->offsetPos));
            								}
HXLINE( 369)								goto _hx_goto_11;
            							}
            							if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 376)								char2->set_x((char2->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 377)								if ((char2->x > (char2->startingPos - this->offsetPos))) {
HXLINE( 377)									char2->set_x((char2->startingPos - this->offsetPos));
            								}
HXLINE( 375)								goto _hx_goto_11;
            							}
            							_hx_goto_11:;
HXLINE( 379)							char2->set_alpha((char2->alpha - (( (Float)(3) ) * elapsed)));
HXLINE( 380)							if ((char2->alpha < ((Float)0.00001))) {
HXLINE( 380)								char2->set_alpha(((Float)0.00001));
            							}
            						}
            						else {
HXLINE( 382)							::String _hx_switch_1 = ( (::String)(char2->jsonFile->__Field(HX_("dialogue_pos",ad,3b,6d,1a),::hx::paccDynamic)) );
            							if (  (_hx_switch_1==HX_("center",d5,25,db,05)) ){
HXLINE( 387)								char2->set_y((char2->y - (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 388)								if ((char2->y < char2->startingPos)) {
HXLINE( 388)									char2->set_y(char2->startingPos);
            								}
HXLINE( 386)								goto _hx_goto_12;
            							}
            							if (  (_hx_switch_1==HX_("left",07,08,b0,47)) ){
HXLINE( 384)								char2->set_x((char2->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 385)								if ((char2->x > char2->startingPos)) {
HXLINE( 385)									char2->set_x(char2->startingPos);
            								}
HXLINE( 383)								goto _hx_goto_12;
            							}
            							if (  (_hx_switch_1==HX_("right",dc,0b,64,e9)) ){
HXLINE( 390)								char2->set_x((char2->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 391)								if ((char2->x < char2->startingPos)) {
HXLINE( 391)									char2->set_x(char2->startingPos);
            								}
HXLINE( 389)								goto _hx_goto_12;
            							}
            							_hx_goto_12:;
HXLINE( 393)							char2->set_alpha((char2->alpha + (( (Float)(3) ) * elapsed)));
HXLINE( 394)							if ((char2->alpha > 1)) {
HXLINE( 394)								char2->set_alpha(( (Float)(1) ));
            							}
            						}
            					}
            				}
...
HXLINE( 400)				_hx_tmp10 = (this->box->animation->_curAnim->curFrame <= 0);
            			}
            			else {
...
HXLINE( 408)				 ::flixel::FlxSprite fh1 = this->bgFade;
HXDLIN( 408)				fh1->set_alpha((fh1->alpha - (((Float)0.5) * elapsed)));
...
HXLINE( 417)			{
HXLINE( 417)				int _g10 = 0;
HXDLIN( 417)				int _g11 = this->arrayCharacters->length;
HXDLIN( 417)				while((_g10 < _g11)){
HXLINE( 417)					_g10 = (_g10 + 1);
HXDLIN( 417)					HX_VARI_NAME( int,i3,"i") = (_g10 - 1);
HXLINE( 418)					HX_VARI(  ::DialogueCharacter,leChar) = this->arrayCharacters->__get(i3).StaticCast<  ::DialogueCharacter >();
HXLINE( 419)					if (::hx::IsNotNull( leChar )) {
HXLINE( 420)						::String _hx_switch_2 = ( (::String)(this->arrayCharacters->__get(i3).StaticCast<  ::DialogueCharacter >()->jsonFile->__Field(HX_("dialogue_pos",ad,3b,6d,1a),::hx::paccDynamic)) );
...
HXLINE( 432)			bool _hx_tmp11;
HXDLIN( 432)			if (::hx::IsNull( this->box )) {
HXLINE( 432)				_hx_tmp11 = ::hx::IsNull( this->bgFade );
            			}
            			else {
HXLINE( 432)				_hx_tmp11 = false;
            			}
HXDLIN( 432)			if (_hx_tmp11) {
HXLINE( 433)				{
HXLINE( 433)					int _g12 = 0;
HXDLIN( 433)					int _g13 = this->arrayCharacters->length;
HXDLIN( 433)					while((_g12 < _g13)){
HXLINE( 433)						_g12 = (_g12 + 1);
HXDLIN( 433)						HX_VARI_NAME( int,i4,"i") = (_g12 - 1);
HXLINE( 434)						HX_VARI_NAME(  ::DialogueCharacter,leChar1,"leChar") = this->arrayCharacters->__get(0).StaticCast<  ::DialogueCharacter >();
HXLINE( 435)						if (::hx::IsNotNull( leChar1 )) {
HXLINE( 436)							this->arrayCharacters->remove(leChar1);
HXLINE( 437)							leChar1->kill();
HXLINE( 438)							this->remove(leChar1,null());
HXLINE( 439)							leChar1->destroy();
            						}
            					}
            				}
...
void DialogueBoxPsych_obj::startNextDialog(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 452)
HXLINE( 453)		HX_VARI(  ::Dynamic,curDialogue) = null();
HXLINE( 454)		do {
...
HXLINE( 462)		HX_VARI( ::String,animName) = ( (::String)(curDialogue->__Field(HX_("boxState",06,60,2a,ff),::hx::paccDynamic)) );
HXLINE( 463)		HX_VARI( ::String,boxType) = this->textBoxTypes->__get(0);
HXLINE( 464)		{
HXLINE( 464)			int _g = 0;
HXDLIN( 464)			int _g1 = this->textBoxTypes->length;
HXDLIN( 464)			while((_g < _g1)){
HXLINE( 464)				_g = (_g + 1);
HXDLIN( 464)				HX_VARI( int,i) = (_g - 1);
HXLINE( 465)				if ((this->textBoxTypes->__get(i) == animName)) {
HXLINE( 466)					boxType = animName;
            				}
            			}
            		}
HXLINE( 470)		HX_VARI( int,character) = 0;
...
HXDLIN( 472)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 473)				if (::hx::IsEq( this->arrayCharacters->__get(i1).StaticCast<  ::DialogueCharacter >()->curCharacter,curDialogue->__Field(HX_("portrait",5b,21,af,b8),::hx::paccDynamic) )) {
HXLINE( 474)					character = i1;
HXLINE( 475)					goto _hx_goto_21;
            				}
            			}
            			_hx_goto_21:;
            		}
HXLINE( 478)		HX_VARI( ::String,centerPrefix) = HX_("",00,00,00,00);
HXLINE( 479)		HX_VARI( ::String,lePosition) = ( (::String)(this->arrayCharacters->__get(character).StaticCast<  ::DialogueCharacter >()->jsonFile->__Field(HX_("dialogue_pos",ad,3b,6d,1a),::hx::paccDynamic)) );
...
HXLINE( 500)		HX_VARI_NAME(  ::DialogueCharacter,_hx_char,"char") = this->arrayCharacters->__get(character).StaticCast<  ::DialogueCharacter >();
...
HXLINE( 504)				HX_VARI( Float,rate) = (( (Float)(24) ) - (((( (Float)(curDialogue->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) ) - ((Float)0.05)) / ( (Float)(5) )) * ( (Float)(480) )));
...
HXLINE( 533)				 ::flixel::math::FlxBasePoint this2 = box->offset;
HXDLIN( 533)				this2->set_x(( (Float)(50) ));
HXDLIN( 533)				this2->set_y(( (Float)(30) ));
            			}
            			else {
HXLINE( 535)				 ::flixel::math::FlxBasePoint this3 = box->offset;
HXDLIN( 535)				this3->set_x(( (Float)(10) ));
HXDLIN( 535)				this3->set_y(( (Float)(0) ));
            			}
            		}
