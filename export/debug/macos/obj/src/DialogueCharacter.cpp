...
void DialogueCharacter_obj::reloadCharacterJson(::String character){
            	...
            	HX_STACK_ARG(character,"character")
HXLINE(  90)
HXLINE(  91)		HX_VARI( ::String,characterPath) = ((HX_("images/dialogue/",c0,b0,32,12) + character) + HX_(".json",56,f1,d6,c2));
HXLINE(  92)		HX_VARI( ::String,rawJson) = null();
HXLINE(  95)		HX_VARI( ::String,path) = ::Paths_obj::modFolders(characterPath);
...
HXLINE( 101)			::String file1 = ((HX_("images/dialogue/",c0,b0,32,12) + ::DialogueCharacter_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN( 101)			if (::hx::IsNull( file1 )) {
HXLINE( 101)				file1 = HX_("",00,00,00,00);
            			}
HXDLIN( 101)			path = (HX_("assets/",4c,2a,dc,36) + file1);
            		}
...
HXLINE( 116)				HX_VARI(  ::Dynamic,anim) = _g1->__get(_g);
HXDLIN( 116)				_g = (_g + 1);
...
void DialogueCharacter_obj::playAnim(::String animName,::hx::Null< bool >  __o_playIdle){
            	...
            	HX_STACK_ARG(playIdle,"playIdle")
HXLINE( 124)
HXLINE( 125)		HX_VARI( ::String,leAnim) = animName;
...
HXLINE( 127)			HX_VARI( ::Array< ::String >,arrayAnims) = ::Array_obj< ::String >::__new(0);
HXLINE( 128)			{
HXLINE( 128)				HX_VARI(  ::Dynamic,anim) = this->dialogueAnimations->iterator();
HXDLIN( 128)				while(( (bool)(anim->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 128)					HX_VARI_NAME(  ::Dynamic,anim1,"anim") = anim->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
...
HXLINE( 137)				_hx_tmp2 = (( (::String)(this->dialogueAnimations->get(leAnim)->__Field(HX_("loop_name",46,3d,8f,96),::hx::paccDynamic)) ).length < 1);
            			}
            			else {
HXLINE( 137)				_hx_tmp2 = true;
            			}
HXDLIN( 137)			if (!(_hx_tmp2)) {
HXLINE( 139)				::String _hx_tmp3 = ( (::String)(this->dialogueAnimations->get(leAnim)->__Field(HX_("loop_name",46,3d,8f,96),::hx::paccDynamic)) );
HXLINE( 136)				_hx_tmp1 = ::hx::IsEq( _hx_tmp3,this->dialogueAnimations->get(leAnim)->__Field(HX_("idle_name",96,be,e2,c5),::hx::paccDynamic) );
            			}
            			else {
...
HXLINE( 142)		::String _hx_tmp4;
HXDLIN( 142)		if (playIdle) {
HXLINE( 142)			_hx_tmp4 = (leAnim + ::DialogueCharacter_obj::IDLE_SUFFIX);
            		}
            		else {
HXLINE( 142)			_hx_tmp4 = leAnim;
            		}
HXDLIN( 142)		this->animation->play(_hx_tmp4,false,null(),null());
HXLINE( 144)		if (this->dialogueAnimations->exists(leAnim)) {
HXLINE( 145)			HX_VARI_NAME(  ::Dynamic,anim2,"anim") = this->dialogueAnimations->get(leAnim);
HXLINE( 146)			if (playIdle) {
HXLINE( 147)				 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN( 147)				Float y = ( (Float)( ::Dynamic(anim2->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic))->__GetItem(1)) );
HXDLIN( 147)				this1->set_x(( (Float)( ::Dynamic(anim2->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic))->__GetItem(0)) ));
HXDLIN( 147)				this1->set_y(y);
            			}
            			else {
HXLINE( 150)				 ::flixel::math::FlxBasePoint this2 = this->offset;
HXDLIN( 150)				Float y1 = ( (Float)( ::Dynamic(anim2->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic))->__GetItem(1)) );
HXDLIN( 150)				this2->set_x(( (Float)( ::Dynamic(anim2->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic))->__GetItem(0)) ));
HXDLIN( 150)				this2->set_y(y1);
            			}
            		}
            		else {
HXLINE( 154)			{
HXLINE( 154)				 ::flixel::math::FlxBasePoint this3 = this->offset;
HXDLIN( 154)				this3->set_x(( (Float)(0) ));
HXDLIN( 154)				this3->set_y(( (Float)(0) ));
            			}
HXLINE( 155)			::String _hx_tmp5;
HXDLIN( 155)			if (playIdle) {
HXLINE( 155)				_hx_tmp5 = HX_("idle anim",9d,46,16,77);
            			}
            			else {
HXLINE( 155)				_hx_tmp5 = HX_("loop anim",4d,c5,c2,47);
            			}
HXDLIN( 155)			::haxe::Log_obj::trace((((HX_("Offsets not found! Dialogue character is badly formatted, anim: ",ce,cc,78,b6) + leAnim) + HX_(", ",74,26,00,00)) + _hx_tmp5),::hx::SourceInfo(HX_("source/DialogueBoxPsych.hx",c2,b0,33,e8),155,HX_("DialogueCharacter",51,eb,23,69),HX_("playAnim",25,ea,84,30)));
            		}
            	}
