...
void DiscordClient_obj::onError(int _code,::String _message){
            	...
            	HX_STACK_ARG(_message,"_message")
HXLINE(  54)
...
HXLINE(  63)
HXLINE(  64)		HX_VARI(  ::sys::thread::_Thread::HaxeThread,DiscordDaemon) = ::sys::thread::_Thread::HaxeThread_obj::create( ::Dynamic(new _hx_Closure_0()),false);
...
HXLINE(  73)
HXLINE(  74)		HX_VAR( Float,startTimestamp);
