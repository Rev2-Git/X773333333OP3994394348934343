...
HXLINE(  23)		HX_VARI(  ::flixel::FlxSprite,bg) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
...
HXLINE(  34)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(  34)				_this->set_x(((( (Float)(_hx_tmp1) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  34)			bool _hx_tmp2;
HXDLIN(  34)			if ((axes != 16)) {
HXLINE(  34)				_hx_tmp2 = (axes == 17);
            			}
            			else {
HXLINE(  34)				_hx_tmp2 = true;
            			}
HXDLIN(  34)			if (_hx_tmp2) {
HXLINE(  34)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(  34)				_this->set_y(((( (Float)(_hx_tmp3) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  41)			HX_VARI( bool,back) = ::PlayerSettings_obj::player1->controls->_back->check();
...
HXDLIN(  49)					_hx_tmp1->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
...
HXLINE(  56)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN(  56)					_hx_tmp2->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
