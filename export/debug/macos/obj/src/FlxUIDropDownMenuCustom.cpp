...
HXDLIN( 182)			HX_VARI(  ::openfl::geom::Rectangle,rect1) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,rect,this->header->background->get_height());
...
HXLINE( 188)					_g = (_g + 1);
HXDLIN( 188)					HX_VARI( int,i) = (_g - 1);
HXLINE( 190)					HX_VARI(  ::flixel::addons::ui::StrNameLabel,data) = DataList->__get(i).StaticCast<  ::flixel::addons::ui::StrNameLabel >();
...
HXDLIN( 197)				while((_g2 < ButtonList->length)){
HXLINE( 197)					HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = ButtonList->__get(_g2).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXDLIN( 197)					_g2 = (_g2 + 1);
HXLINE( 199)					this->list->push(btn);
HXLINE( 200)					Float _hx_tmp1 = this->header->background->get_width();
HXDLIN( 200)					btn->resize(_hx_tmp1,this->header->background->get_height());
HXLINE( 201)					btn->set_x(( (Float)(1) ));
            				}
            			}
            		}
HXLINE( 204)		this->updateButtonPositions();
HXLINE( 206)		 ::flixel::addons::ui::FlxUI9SliceSprite _hx_tmp2 = this->dropPanel;
HXDLIN( 206)		Float _hx_tmp3 = this->header->background->get_width();
HXDLIN( 206)		_hx_tmp2->resize(_hx_tmp3,this->getPanelHeight());
HXLINE( 207)		this->dropPanel->set_visible(false);
HXLINE( 208)		this->add(this->dropPanel);
HXLINE( 210)		{
HXLINE( 210)			int _g3 = 0;
HXDLIN( 210)			::Array< ::Dynamic> _g4 = this->list;
HXDLIN( 210)			while((_g3 < _g4->length)){
HXLINE( 210)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn1) = _g4->__get(_g3).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXDLIN( 210)				_g3 = (_g3 + 1);
HXLINE( 212)				this->add(btn1);
HXLINE( 213)				btn1->set_visible(false);
            			}
            		}
...
HXLINE(  70)		HX_VARI( int,i) = 0;
HXLINE(  71)		{
HXLINE(  71)			int _g = 0;
HXDLIN(  71)			::Array< ::Dynamic> _g1 = this->list;
HXDLIN(  71)			while((_g < _g1->length)){
HXLINE(  71)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXDLIN(  71)				_g = (_g + 1);
...
HXLINE(  75)					HX_VARI(  ::flixel::addons::ui::FlxUIButton,item) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HXLINE( 104)		HX_VARI( int,i) = 0;
HXLINE( 105)		{
HXLINE( 105)			int _g = 0;
HXDLIN( 105)			::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 105)			while((_g < _g1->length)){
HXLINE( 105)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXDLIN( 105)				_g = (_g + 1);
HXLINE( 107)				if ((( ( ::flixel::text::FlxText)(btn->label) )->text == str)) {
HXLINE( 109)					HX_VARI(  ::flixel::addons::ui::FlxUIButton,item) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUIDropDownMenuCustom_obj,set_params,return )
 ...
 ::FlxUIDropDownMenuDropDirection FlxUIDropDownMenuCustom_obj::set_dropDirection( ::FlxUIDropDownMenuDropDirection dropDirection){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(dropDirection,"dropDirection")
HXLINE( 145)
...
void FlxUIDropDownMenuCustom_obj::updateButtonPositions(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 222)
HXLINE( 223)		HX_VARI( Float,buttonHeight) = this->header->background->get_height();
...
HXLINE( 228)			 ::flixel::addons::ui::FlxUI9SliceSprite fh2 = this->dropPanel;
HXDLIN( 228)			fh2->set_y((fh2->y + buttonHeight));
            		}
HXLINE( 230)		HX_VARI( Float,offset) = this->dropPanel->y;
HXLINE( 231)		{
HXLINE( 231)			int _g = 0;
...
HXLINE( 232)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,button) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HXDLIN( 237)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 239)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIButton,button1,"button") = this->list->__get(i1).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXLINE( 240)				if (::hx::IsNotNull( button1 )) {
HXLINE( 241)					button1->set_y(offset);
...
HXLINE( 248)
HXLINE( 249)		HX_VARI( bool,vDropPanel) = this->dropPanel->visible;
HXLINE( 250)		HX_VARI( ::Array< bool >,vButtons) = ::Array_obj< bool >::__new(0);
HXLINE( 251)		{
HXLINE( 251)			int _g = 0;
HXDLIN( 251)			int _g1 = this->list->length;
HXDLIN( 251)			while((_g < _g1)){
HXLINE( 251)				_g = (_g + 1);
HXDLIN( 251)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 264)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 266)				if (::hx::IsNotNull( this->list->__get(i1).StaticCast<  ::flixel::addons::ui::FlxUIButton >() )) {
HXLINE( 268)					this->list->__get(i1).StaticCast<  ::flixel::addons::ui::FlxUIButton >()->set_visible(vButtons->__get(i1));
            				}
            			}
            		}
...
void FlxUIDropDownMenuCustom_obj::setData(::Array< ::Dynamic> DataList){
            	...
            	HX_STACK_ARG(DataList,"DataList")
HXLINE( 294)
HXLINE( 295)		HX_VARI( int,i) = 0;
HXLINE( 297)		if (::hx::IsNotNull( DataList )) {
HXLINE( 299)			{
HXLINE( 299)				int _g = 0;
HXDLIN( 299)				while((_g < DataList->length)){
HXLINE( 299)					HX_VARI(  ::flixel::addons::ui::StrNameLabel,data) = DataList->__get(_g).StaticCast<  ::flixel::addons::ui::StrNameLabel >();
HXDLIN( 299)					_g = (_g + 1);
HXLINE( 301)					HX_VARI( bool,recycled) = false;
HXLINE( 302)					if (::hx::IsNotNull( this->list )) {
HXLINE( 304)						if ((i <= (this->list->length - 1))) {
HXLINE( 306)							HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HXLINE( 321)						HX_VARI(  ::flixel::addons::ui::FlxUIButton,t) = this->makeListButton(i,data->label,data->name);
...
HXLINE( 332)				int _g1 = DataList->length;
HXDLIN( 332)				int _g2 = this->list->length;
HXDLIN( 332)				while((_g1 < _g2)){
HXLINE( 332)					_g1 = (_g1 + 1);
HXDLIN( 332)					HX_VARI( int,j) = (_g1 - 1);
HXLINE( 334)					HX_VARI(  ::flixel::addons::ui::FlxUIButton,b) = this->list->pop().StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUIDropDownMenuCustom_obj,selectSomething,(void))
 ...
 ::flixel::addons::ui::FlxUIButton FlxUIDropDownMenuCustom_obj::makeListButton(int i,::String Label,::String Name){
            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::FlxUIDropDownMenuCustom,_g,int,i1) HXARGC(0)
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_5585202bf1be20f8_361_makeListButton)
HXLINE( 361)
HXLINE( 361)			_g->onClickItem(i1);
            		}
            	...
            	HX_STACK_ARG(Name,"Name")
HXLINE( 358)
HXLINE( 359)		HX_VARI(  ::flixel::addons::ui::FlxUIButton,t) =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,Label,null(),null(),null(),null());
HXLINE( 360)		t->broadcastToFlxUI = false;
HXLINE( 361)		 ::FlxUIDropDownMenuCustom _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 361)		int i1 = i;
...
HXLINE( 379)				HX_VARI(  ::flixel::math::FlxBasePoint,offset) = _g2->__get(_g1).StaticCast<  ::flixel::math::FlxBasePoint >();
...
HXLINE( 391)
HXLINE( 392)		HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = this->getBtnByIndex(i);
...
void FlxUIDropDownMenuCustom_obj::changeLabelById(::String name,::String NewLabel){
            	...
            	HX_STACK_ARG(NewLabel,"NewLabel")
HXLINE( 400)
HXLINE( 401)		HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = this->getBtnById(name);
...
HXLINE( 419)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXDLIN( 419)				_g = (_g + 1);
...
HXDLIN( 437)					_hx_tmp1 = _this->keyManager->checkStatusUnsafe(38,_this->status);
            				}
            				else {
...
HXDLIN( 443)						_hx_tmp2 = _this1->keyManager->checkStatusUnsafe(40,_this1->status);
            					}
            					else {
...
HXLINE( 451)				_hx_tmp3 = !(this->mouseOverlapping());
            			}
            			else {
...
HXDLIN( 461)		HX_VARI_NAME(  ::flixel::math::FlxBasePoint,mousePoint1,"mousePoint") = mousePoint->getScreenPosition(this->get_camera(),null());
HXLINE( 462)		HX_VARI(  ::flixel::math::FlxBasePoint,objPoint) = this->getScreenPosition(null(),this->get_camera());
...
HXLINE( 464)			Float mousePoint2 = mousePoint1->x;
HXDLIN( 464)			Float objPoint1 = objPoint->x;
HXLINE( 463)			_hx_tmp1 = (mousePoint2 < (objPoint1 + this->get_width()));
            		}
            		else {
HXLINE( 463)			_hx_tmp1 = false;
            		}
HXDLIN( 463)		if (_hx_tmp1) {
HXLINE( 464)			Float mousePoint3 = mousePoint1->y;
HXDLIN( 464)			Float objPoint2 = objPoint->y;
HXLINE( 463)			_hx_tmp = (mousePoint3 < (objPoint2 + this->get_height()));
            		}
            		else {
...
HXLINE( 484)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,button) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXDLIN( 484)				_g = (_g + 1);
...
void FlxUIDropDownMenuCustom_obj::onClickItem(int i){
            	...
            	HX_STACK_ARG(i,"i")
HXLINE( 505)
HXLINE( 506)		HX_VARI(  ::flixel::addons::ui::FlxUIButton,item) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HXLINE( 529)
HXLINE( 530)		HX_VARI( ::Array< ::Dynamic>,strIdArray) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 531)		{
HXLINE( 531)			int _g = 0;
...
HXLINE( 533)				HX_VARI( ::String,ID) = StringArray->__get(i);
