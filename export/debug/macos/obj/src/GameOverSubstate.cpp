...
void GameOverSubstate_obj::__construct(Float x,Float y,Float camX,Float camY){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(camX,"camX")
            	HX_STACK_ARG(camY,"camY")
HXLINE(  13)
...
HXDLIN(  58)		this->camFollow =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,x1,this->boyfriend->getGraphicMidpoint(null())->y);
...
HXLINE(  64)		{
HXLINE(  64)			 ::flixel::math::FlxBasePoint this1 = ::flixel::FlxG_obj::camera->scroll;
...
HXLINE(  81)			HX_VARI( Float,lerpVal) = ::Math_obj::max(( (Float)(0) ),::Math_obj::min(( (Float)(1) ),(elapsed * ((Float)0.6))));
...
HXLINE( 107)			_hx_tmp1 = (this->boyfriend->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14));
            		}
            		else {
...
HXLINE( 109)				_hx_tmp2 = !(this->isFollowingAlready);
            			}
            			else {
...
HXLINE( 116)				_hx_tmp3 = !(this->playingDeathSound);
            			}
            			else {
...
HXLINE( 123)					HX_VARI( ::Array< int >,exclude) = ::Array_obj< int >::__new(0);
HXLINE( 126)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp4 = ::flixel::FlxG_obj::sound;
HXDLIN( 126)					_hx_tmp4->play(::Paths_obj::sound((HX_("jeffGameover/jeffGameover-",3e,03,48,86) + ::flixel::FlxG_obj::random->_hx_int(1,25,exclude)),null()),1,false,null(),true, ::Dynamic(new _hx_Closure_0(_gthis)));
            				}
            				else {
