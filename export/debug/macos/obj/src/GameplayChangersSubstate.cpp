...
HXLINE( 114)		HX_VARI(  ::flixel::FlxSprite,bg) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
...
HXLINE( 132)				HX_VARI(  ::Alphabet,optionText) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(200) ),( (Float)(360) ),( (::String)(this->optionsArray->__get(i)->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) ),true);
...
HXDLIN( 143)					HX_VARI(  ::CheckboxThingie,checkbox1) =  ::CheckboxThingie_obj::__alloc( HX_CTX ,checkbox,optionText1,::hx::IsEq( this->optionsArray->__get(i)->__Field(HX_("getValue",fb,8e,8f,91),::hx::paccDynamic)(),true ));
...
HXDLIN( 151)					HX_VARI(  ::AttachedText,valueText1) =  ::AttachedText_obj::__alloc( HX_CTX ,valueText,optionText->get_width(),-72,true,((Float)0.8));
...
void GameplayChangersSubstate_obj::getOptions(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  41)
HXLINE(  42)		HX_VARI(  ::GameplayOption,goption) =  ::GameplayOption_obj::__alloc( HX_CTX ,HX_("Scroll Type",ad,1f,97,3f),HX_("scrolltype",47,55,ef,1f),HX_("string",d1,28,30,11),HX_("multiplicative",96,7a,3f,fa),::Array_obj< ::String >::fromData( _hx_array_data_2403ea08_3,2));
HXLINE(  43)		this->optionsArray->push(goption);
HXLINE(  45)		HX_VARI(  ::GameplayOption,option) =  ::GameplayOption_obj::__alloc( HX_CTX ,HX_("Scroll Speed",34,bf,42,cb),HX_("scrollspeed",5a,70,19,38),HX_("float",9c,c5,96,02),1,null());
...
HXLINE(  63)		HX_VARI_NAME(  ::GameplayOption,option1,"option") =  ::GameplayOption_obj::__alloc( HX_CTX ,HX_("Playback Rate",05,cb,36,2d),HX_("songspeed",92,6f,b6,1d),HX_("float",9c,c5,96,02),1,null());
...
HXLINE(  73)		HX_VARI_NAME(  ::GameplayOption,option2,"option") =  ::GameplayOption_obj::__alloc( HX_CTX ,HX_("Health Gain Multiplier",1e,c6,e7,2f),HX_("healthgain",1b,97,1b,16),HX_("float",9c,c5,96,02),1,null());
...
HXLINE(  81)		HX_VARI_NAME(  ::GameplayOption,option3,"option") =  ::GameplayOption_obj::__alloc( HX_CTX ,HX_("Health Loss Multiplier",3a,7f,8e,c0),HX_("healthloss",7f,50,74,19),HX_("float",9c,c5,96,02),1,null());
...
HXLINE(  89)		HX_VARI_NAME(  ::GameplayOption,option4,"option") =  ::GameplayOption_obj::__alloc( HX_CTX ,HX_("Instakill on Miss",76,d5,a0,bc),HX_("instakill",f9,72,23,49),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  90)		this->optionsArray->push(option4);
HXLINE(  92)		HX_VARI_NAME(  ::GameplayOption,option5,"option") =  ::GameplayOption_obj::__alloc( HX_CTX ,HX_("Practice Mode",e8,58,72,66),HX_("practice",bb,00,e7,a0),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  93)		this->optionsArray->push(option5);
HXLINE(  95)		HX_VARI_NAME(  ::GameplayOption,option6,"option") =  ::GameplayOption_obj::__alloc( HX_CTX ,HX_("Botplay",5b,23,fb,2e),HX_("botplay",7b,fb,a9,61),HX_("bool",2a,84,1b,41),false,null());
...
HXLINE( 101)				HX_VARI(  ::Dynamic,i) = _g1->__get(_g);
HXDLIN( 101)				_g = (_g + 1);
HXLINE( 103)				HX_VARI(  ::GameplayOption,opt) = ( ( ::GameplayOption)(i) );
...
HXLINE( 187)			HX_VARI( bool,usesCheckbox) = true;
...
HXDLIN( 197)					_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
HXLINE( 198)					 ::GameplayOption _hx_tmp2 = this->curOption;
...
HXDLIN( 198)					_hx_tmp2->setValue(_hx_tmp3);
HXLINE( 199)					this->curOption->change();
HXLINE( 200)					this->reloadCheckboxes();
            				}
            			}
            			else {
HXLINE( 203)				bool _hx_tmp4;
HXDLIN( 203)				if (!(::PlayerSettings_obj::player1->controls->_ui_left->check())) {
HXLINE( 203)					_hx_tmp4 = ::PlayerSettings_obj::player1->controls->_ui_right->check();
            				}
            				else {
HXLINE( 203)					_hx_tmp4 = true;
            				}
HXDLIN( 203)				if (_hx_tmp4) {
HXLINE( 204)					HX_VAR( bool,pressed);
...
HXLINE( 205)					bool _hx_tmp5;
HXDLIN( 205)					if (!((this->holdTime > ((Float)0.5)))) {
HXLINE( 205)						_hx_tmp5 = pressed;
            					}
            					else {
HXLINE( 205)						_hx_tmp5 = true;
            					}
HXDLIN( 205)					if (_hx_tmp5) {
HXLINE( 206)						if (pressed) {
HXLINE( 207)							HX_VARI(  ::Dynamic,add) = null();
...
HXLINE( 231)								HX_VARI( int,num) = this->curOption->curOption;
...
HXLINE( 246)									HX_VARI(  ::GameplayOption,oOption) = this->getOptionByName(HX_("Scroll Speed",34,bf,42,cb));
...
HXLINE( 267)							 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp6 = ::flixel::FlxG_obj::sound;
HXDLIN( 267)							_hx_tmp6->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            						}
            						else {
HXLINE( 268)							if ((this->curOption->get_type() != HX_("string",d1,28,30,11))) {
HXLINE( 269)								 ::Dynamic _hx_tmp7 = this->curOption->minValue;
HXDLIN( 269)								 ::Dynamic _hx_tmp8 = this->curOption->maxValue;
HXDLIN( 269)								Float _hx_tmp9 = this->holdValue;
HXDLIN( 269)								Float _hx_tmp10 = (this->curOption->scrollSpeed * elapsed);
HXDLIN( 269)								int _hx_tmp11;
HXDLIN( 269)								if (::PlayerSettings_obj::player1->controls->_ui_left->check()) {
HXLINE( 269)									_hx_tmp11 = -1;
            								}
            								else {
HXLINE( 269)									_hx_tmp11 = 1;
            								}
HXDLIN( 269)								this->holdValue = ::Math_obj::max(( (Float)(_hx_tmp7) ),::Math_obj::min(( (Float)(_hx_tmp8) ),(_hx_tmp9 + (_hx_tmp10 * ( (Float)(_hx_tmp11) )))));
...
HXLINE( 277)									HX_VARI( Float,blah) = ::Math_obj::max(( (Float)(this->curOption->minValue) ),::Math_obj::min(( (Float)(this->curOption->maxValue) ),(( (Float)((this->holdValue + this->curOption->changeValue)) ) - ::hx::Mod(this->holdValue,this->curOption->changeValue))));
HXLINE( 278)									 ::GameplayOption _hx_tmp12 = this->curOption;
HXDLIN( 278)									_hx_tmp12->setValue(::flixel::math::FlxMath_obj::roundDecimal(blah,this->curOption->decimals));
...
HXLINE( 286)						 ::GameplayChangersSubstate _hx_tmp13 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 286)						_hx_tmp13->holdTime = (_hx_tmp13->holdTime + elapsed);
            					}
            				}
            				else {
HXLINE( 288)					bool _hx_tmp14;
HXDLIN( 288)					if (!(::PlayerSettings_obj::player1->controls->_ui_leftR->check())) {
HXLINE( 288)						_hx_tmp14 = ::PlayerSettings_obj::player1->controls->_ui_rightR->check();
            					}
            					else {
HXLINE( 288)						_hx_tmp14 = true;
            					}
...
HXLINE( 295)						_g = (_g + 1);
HXDLIN( 295)						HX_VARI( int,i) = (_g - 1);
HXLINE( 297)						HX_VARI(  ::GameplayOption,leOption) = ( ( ::GameplayOption)(this->optionsArray->__get(i)) );
...
HXLINE( 320)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp15 = ::flixel::FlxG_obj::sound;
HXDLIN( 320)				_hx_tmp15->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 321)				this->reloadCheckboxes();
            			}
            		}
HXLINE( 325)		if ((this->nextAccept > 0)) {
HXLINE( 326)			 ::GameplayChangersSubstate _hx_tmp16 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 326)			_hx_tmp16->nextAccept = (_hx_tmp16->nextAccept - 1);
            		}
...
HXLINE( 331)
HXLINE( 332)		HX_VARI( ::String,text) = option->displayFormat;
HXLINE( 333)		HX_VARI(  ::Dynamic,val) = option->getValue();
HXLINE( 334)		if ((option->get_type() == HX_("percent",c5,aa,da,78))) {
HXLINE( 334)			val = (val * 100);
            		}
HXLINE( 335)		HX_VARI(  ::Dynamic,def) = option->defaultValue;
...
HXLINE( 355)		HX_VARI( int,bullShit) = 0;
HXLINE( 357)		{
HXLINE( 357)			int _g = 0;
HXDLIN( 357)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 357)			while((_g < _g1->length)){
HXLINE( 357)				HX_VARI(  ::Alphabet,item) = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 357)				_g = (_g + 1);
...
HXDLIN( 366)			HX_VARI(  ::flixel::group::FlxTypedGroupIterator,text) =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,this->grpTexts->members,filter);
HXDLIN( 366)			while(text->hasNext()){
HXLINE( 366)				HX_VARI_NAME(  ::AttachedText,text1,"text") = text->next().StaticCast<  ::AttachedText >();
...
HXDLIN( 377)		HX_VARI(  ::flixel::group::FlxTypedGroupIterator,checkbox) =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,this->checkboxGroup->members,filter);
HXDLIN( 377)		while(checkbox->hasNext()){
HXDLIN( 377)			HX_VARI_NAME(  ::CheckboxThingie,checkbox1,"checkbox") = checkbox->next().StaticCast<  ::CheckboxThingie >();
