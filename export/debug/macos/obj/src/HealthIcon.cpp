...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_23_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",23,0xf7836789)
...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_44_changeIcon,"HealthIcon","changeIcon",0xd785ca82,"HealthIcon.changeIcon","HealthIcon.hx",44,0xf7836789)
static const int _hx_array_data_f8f9be55_5[] = {
	(int)0,(int)1,
};
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_68_updateHitbox,"HealthIcon","updateHitbox",0x4656523a,"HealthIcon.updateHitbox","HealthIcon.hx",68,0xf7836789)
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_75_getCharacter,"HealthIcon","getCharacter",0x409335ec,"HealthIcon.getCharacter","HealthIcon.hx",75,0xf7836789)
...
HXLINE(   8)
HXLINE(  42)		this->iconOffsets = ::Array_obj< Float >::fromData( _hx_array_data_f8f9be55_1,2);
HXLINE(  30)		this->isOldIcon = false;
HXLINE(  12)		this->_hx_char = HX_("",00,00,00,00);
HXLINE(  11)		this->isPlayer = false;
HXLINE(  16)		super::__construct(null(),null(),null());
HXLINE(  17)		this->isPlayer = isPlayer;
HXLINE(  18)		this->changeIcon(_hx_char);
HXLINE(  19)		{
HXLINE(  19)			 ::flixel::math::FlxBasePoint this1 = this->scrollFactor;
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_23_update)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE(  23)
HXLINE(  24)		this->super::update(elapsed);
HXLINE(  26)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(  27)			this->setPosition((this->sprTracker->x - ( (Float)(150) )),(this->sprTracker->y - ( (Float)(30) )));
            		}
            	}
...
void HealthIcon_obj::swapOldIcon(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  33)
HXLINE(  34)		this->isOldIcon = !(this->isOldIcon);
HXLINE(  36)		if (this->isOldIcon) {
HXLINE(  37)			this->changeIcon(HX_("bf-old",5e,ba,eb,07));
            		}
            		else {
HXLINE(  39)			this->changeIcon(::PlayState_obj::instance->boyfriend->healthIcon);
            		}
            	}
...
void HealthIcon_obj::changeIcon(::String _hx_char){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_44_changeIcon)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_hx_char,"char")
HXLINE(  44)
HXDLIN(  44)		if ((this->_hx_char != _hx_char)) {
HXLINE(  45)			HX_VARI( ::String,name) = (HX_("icons/",15,dc,d6,45) + _hx_char);
HXLINE(  46)			::String key = ((HX_("images/",77,50,74,c1) + name) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  46)			bool _hx_tmp;
HXDLIN(  46)			bool _hx_tmp1;
HXDLIN(  46)			::String key1 = ((::Paths_obj::currentModDirectory + HX_("/",2f,00,00,00)) + key);
HXDLIN(  46)			if (::hx::IsNull( key1 )) {
HXLINE(  46)				key1 = HX_("",00,00,00,00);
            			}
HXDLIN(  46)			if (!(::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key1)))) {
HXLINE(  46)				::String key2 = key;
HXDLIN(  46)				if (::hx::IsNull( key2 )) {
HXLINE(  46)					key2 = HX_("",00,00,00,00);
            				}
HXDLIN(  46)				_hx_tmp1 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key2));
            			}
            			else {
...
HXLINE(  46)				if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  46)					_hx_tmp = true;
            				}
            				else {
...
HXLINE(  46)				name = (HX_("icons/icon-",5f,da,21,72) + _hx_char);
            			}
HXLINE(  47)			::String key3 = ((HX_("images/",77,50,74,c1) + name) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  47)			bool _hx_tmp2;
HXDLIN(  47)			bool _hx_tmp3;
HXDLIN(  47)			::String key4 = ((::Paths_obj::currentModDirectory + HX_("/",2f,00,00,00)) + key3);
HXDLIN(  47)			if (::hx::IsNull( key4 )) {
HXLINE(  47)				key4 = HX_("",00,00,00,00);
            			}
HXDLIN(  47)			if (!(::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key4)))) {
HXLINE(  47)				::String key5 = key3;
HXDLIN(  47)				if (::hx::IsNull( key5 )) {
HXLINE(  47)					key5 = HX_("",00,00,00,00);
            				}
HXDLIN(  47)				_hx_tmp3 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key5));
            			}
            			else {
...
HXLINE(  47)				if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key3,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  47)					_hx_tmp2 = true;
            				}
            				else {
...
HXLINE(  47)				name = HX_("icons/icon-face",7c,aa,dd,e7);
            			}
HXLINE(  48)			::String library = null();
HXDLIN(  48)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(name,library);
HXDLIN(  48)			HX_VARI(  ::Dynamic,file) = returnAsset;
HXLINE(  50)			this->loadGraphic(file,null(),null(),null(),null(),null());
HXLINE(  51)			int _hx_tmp4 = ::Math_obj::floor((this->get_width() / ( (Float)(2) )));
HXDLIN(  51)			this->loadGraphic(file,true,_hx_tmp4,::Math_obj::floor(this->get_height()),null(),null());
HXLINE(  52)			this->iconOffsets[0] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(2) ));
HXLINE(  53)			this->iconOffsets[1] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(2) ));
HXLINE(  54)			this->updateHitbox();
HXLINE(  56)			this->animation->add(_hx_char,::Array_obj< int >::fromData( _hx_array_data_f8f9be55_5,2),0,false,this->isPlayer,null());
HXLINE(  57)			this->animation->play(_hx_char,null(),null(),null());
HXLINE(  58)			this->_hx_char = _hx_char;
HXLINE(  60)			this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  61)			if (::StringTools_obj::endsWith(_hx_char,HX_("-pixel",39,03,b3,c0))) {
...
void HealthIcon_obj::updateHitbox(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_68_updateHitbox)
            	HX_STACK_THIS(this)
HXLINE(  68)
HXLINE(  69)		this->super::updateHitbox();
HXLINE(  70)		this->offset->set_x(this->iconOffsets->__get(0));
HXLINE(  71)		this->offset->set_y(this->iconOffsets->__get(1));
            	}


::String HealthIcon_obj::getCharacter(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_75_getCharacter)
            	HX_STACK_THIS(this)
HXLINE(  75)
HXDLIN(  75)		return this->_hx_char;
            	}
