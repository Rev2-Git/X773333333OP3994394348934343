...
HXLINE(  21)
HXLINE(  22)		HX_VARI( ::String,daSong) = ::Highscore_obj::formatSong(song,diff);
...
void Highscore_obj::resetWeek(::String week,::hx::Null< int >  __o_diff){
            	...
            	HX_STACK_ARG(diff,"diff")
HXLINE(  28)
HXLINE(  29)		HX_VARI( ::String,daWeek) = ::Highscore_obj::formatSong(week,diff);
...
HXLINE(  40)		HX_VARI( Float,tempMult) = ( (Float)(1) );
HXLINE(  41)		{
HXLINE(  41)			int _g = 0;
HXDLIN(  41)			int _g1 = decimals;
HXDLIN(  41)			while((_g < _g1)){
HXLINE(  41)				_g = (_g + 1);
HXDLIN(  41)				HX_VARI( int,i) = (_g - 1);
HXLINE(  43)				tempMult = (tempMult * ( (Float)(10) ));
            			}
            		}
HXLINE(  45)		HX_VARI( Float,newValue) = ( (Float)(::Math_obj::floor((value * tempMult))) );
...
void Highscore_obj::saveScore(::String song,::hx::Null< int >  __o_score, ::Dynamic __o_diff, ::Dynamic __o_rating){
            	...
            	HX_STACK_ARG(diff,"diff")
            	HX_STACK_ARG(rating,"rating")
HXLINE(  50)
HXLINE(  51)		HX_VARI( ::String,daSong) = ::Highscore_obj::formatSong(song,( (int)(diff) ));
...
void Highscore_obj::saveWeekScore(::String week,::hx::Null< int >  __o_score, ::Dynamic __o_diff){
            	...
            	HX_STACK_ARG(diff,"diff")
HXLINE(  66)
HXLINE(  67)		HX_VARI( ::String,daWeek) = ::Highscore_obj::formatSong(week,( (int)(diff) ));
...
int Highscore_obj::getScore(::String song,int diff){
            	...
            	HX_STACK_ARG(diff,"diff")
HXLINE( 110)
HXLINE( 111)		HX_VARI( ::String,daSong) = ::Highscore_obj::formatSong(song,diff);
...
Float Highscore_obj::getRating(::String song,int diff){
            	...
            	HX_STACK_ARG(diff,"diff")
HXLINE( 119)
HXLINE( 120)		HX_VARI( ::String,daSong) = ::Highscore_obj::formatSong(song,diff);
...
int Highscore_obj::getWeekScore(::String week,int diff){
            	...
            	HX_STACK_ARG(diff,"diff")
HXLINE( 128)
HXLINE( 129)		HX_VARI( ::String,daWeek) = ::Highscore_obj::formatSong(week,diff);
