...
HXLINE( 125)
HXLINE( 126)		{
HXLINE( 126)			HX_VARI(  ::Dynamic,x) = it->__Field(HX_("iterator",ee,49,9a,93),::hx::paccDynamic)();
HXDLIN( 126)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 126)				HX_VARI_NAME(  ::Dynamic,x1,"x") = x->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
