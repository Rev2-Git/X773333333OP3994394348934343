...
void LoadingState_obj::__construct( ::flixel::FlxState target,bool stopMusic,::String directory){
            	...
            	HX_STACK_ARG(stopMusic,"stopMusic")
...
HXLINE(  67)			HX_VARI(  ::Dynamic,introComplete) = _gthis->callbacks->add(HX_("introComplete",45,d3,4c,b2));
...
HXLINE(  78)			HX_VARI( Float,fadeTime) = ((Float)0.5);
...
HXLINE(  47)		HX_VARI(  ::flixel::FlxSprite,bg) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-3473587,null(),null());
...
HXLINE(  55)				int _hx_tmp2 = ::flixel::FlxG_obj::width;
HXDLIN(  55)				_this->set_x(((( (Float)(_hx_tmp2) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  55)			bool _hx_tmp3;
HXDLIN(  55)			if ((axes != 16)) {
HXLINE(  55)				_hx_tmp3 = (axes == 17);
            			}
            			else {
HXLINE(  55)				_hx_tmp3 = true;
            			}
HXDLIN(  55)			if (_hx_tmp3) {
HXLINE(  55)				int _hx_tmp4 = ::flixel::FlxG_obj::height;
HXDLIN(  55)				_this->set_y(((( (Float)(_hx_tmp4) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  89)			HX_VARI(  ::lime::utils::AssetLibrary,library) = ::openfl::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  90)			HX_VARI( ::String,symbolPath) = ( (::String)(path.split(HX_(":",3a,00,00,00))->pop()) );
HXLINE(  95)			HX_VARI(  ::Dynamic,callback) = this->callbacks->add((HX_("song:",c5,36,c7,80) + path));
...
HXLINE( 106)				HX_STACK_DO_THROW((HX_("Missing library: ",07,45,01,4f) + library));
            			}
HXLINE( 108)			HX_VARI(  ::Dynamic,callback) = this->callbacks->add((HX_("library:",df,f4,b1,42) + library));
...
HXLINE( 120)			 ::flixel::FlxSprite _hx_tmp3 = this->funkay;
HXDLIN( 120)			_hx_tmp3->setGraphicSize(::Std_obj::_hx_int((this->funkay->get_width() + 60)),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoadingState_obj,loadAndSwitchState,(void))
 ...
 ::flixel::FlxState LoadingState_obj::getNextState( ::flixel::FlxState target,::hx::Null< bool >  __o_stopMusic){
            	...
            	HX_STACK_ARG(stopMusic,"stopMusic")
HXLINE( 154)
HXLINE( 155)		HX_VARI( ::String,directory) = HX_("shared",a5,5e,2b,1d);
HXLINE( 156)		HX_VARI( ::String,weekDir) = ::StageData_obj::forceNextDirectory;
...
HXLINE( 243)			HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
...
HXLINE( 199)
HXLINE( 200)		HX_VARI( ::String,id) = HX_("songs",fe,36,c7,80);
HXLINE( 201)		HX_VARI(  ::lime::app::Promise_lime_utils_AssetLibrary,promise) =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
HXLINE( 203)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::Assets_obj::getLibrary(id);
HXLINE( 205)		if (::hx::IsNotNull( library )) {
HXLINE( 207)			return ::lime::app::Future_obj::withValue(library);
            		}
HXLINE( 210)		HX_VARI( ::String,path) = id;
HXLINE( 211)		HX_VARI( ::String,rootPath) = null();
HXLINE( 214)		HX_VARI(  ::haxe::ds::StringMap,libraryPaths) = ::lime::utils::Assets_obj::libraryPaths;
