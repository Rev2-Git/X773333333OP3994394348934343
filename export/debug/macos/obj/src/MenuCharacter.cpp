...
HXLINE(  43)		HX_VARI( bool,dontPlayAnim) = false;
HXLINE(  44)		{
...
HXLINE(  53)			HX_VARI( ::String,characterPath) = ((HX_("images/menucharacters/",6f,fa,bf,a6) + character) + HX_(".json",56,f1,d6,c2));
HXLINE(  54)			HX_VARI( ::String,rawJson) = null();
HXLINE(  57)			HX_VARI( ::String,path) = ::Paths_obj::modFolders(characterPath);
...
HXLINE(  75)			HX_VARI(  ::Dynamic,charFile) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
...
HXLINE(  79)			HX_VARI( ::String,confirmAnim) = ( (::String)(charFile->__Field(HX_("confirm_anim",f0,e4,4f,7c),::hx::paccDynamic)) );
...
HXLINE(  53)				HX_VARI_NAME( ::String,characterPath1,"characterPath") = ((HX_("images/menucharacters/",6f,fa,bf,a6) + character) + HX_(".json",56,f1,d6,c2));
HXLINE(  54)				HX_VARI_NAME( ::String,rawJson1,"rawJson") = null();
HXLINE(  57)				HX_VARI_NAME( ::String,path1,"path") = ::Paths_obj::modFolders(characterPath1);
...
HXLINE(  75)				HX_VARI_NAME(  ::Dynamic,charFile1,"charFile") =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson1)->doParse();
...
HXLINE(  79)				HX_VARI_NAME( ::String,confirmAnim1,"confirmAnim") = ( (::String)(charFile1->__Field(HX_("confirm_anim",f0,e4,4f,7c),::hx::paccDynamic)) );
