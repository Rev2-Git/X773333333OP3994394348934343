...
HXDLIN( 730)		HX_VARI( ::String,path) = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 731)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 732)			HX_VARI( ::String,rawJson) = ::sys::io::File_obj::getContent(path);
...
HXLINE( 734)				HX_VARI(  ::Dynamic,stuff) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 736)				HX_VARI( ::Array< int >,colors) = ( (::Array< int >)(::Reflect_obj::getProperty(stuff,HX_("color",63,71,5c,4a))) );
HXLINE( 737)				HX_VARI( ::String,description) = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("description",fc,08,1d,5f))) );
HXLINE( 738)				HX_VARI( ::String,name) = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("name",4b,72,ff,48))) );
HXLINE( 739)				HX_VARI( bool,restart) = ( (bool)(::Reflect_obj::getProperty(stuff,HX_("restart",cf,c7,a5,6a))) );
HXLINE( 741)				bool _hx_tmp1;
HXDLIN( 741)				if (::hx::IsNotNull( name )) {
HXLINE( 741)					_hx_tmp1 = (name.length > 0);
            				}
            				else {
...
HXLINE( 745)					_hx_tmp2 = (description.length > 0);
            				}
            				else {
...
HXLINE( 757)				bool _hx_tmp3;
HXDLIN( 757)				if (::hx::IsNotNull( colors )) {
HXLINE( 757)					_hx_tmp3 = (colors->length > 2);
            				}
            				else {
