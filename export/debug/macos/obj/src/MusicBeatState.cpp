...
HXLINE(  37)		HX_VARI( bool,skip) = ::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransOut;
...
HXLINE(  47)
HXLINE(  49)		HX_VARI( int,oldStep) = this->curStep;
...
HXLINE(  79)			HX_VARI( Float,beats) = ( (Float)(this->getBeatsOnSection()) );
...
HXLINE(  89)		HX_VARI( int,lastSection) = this->curSection;
...
void MusicBeatState_obj::updateCurStep(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 113)
HXLINE( 114)		HX_VARI(  ::Dynamic,lastChange) = ::Conductor_obj::getBPMFromSeconds(::Conductor_obj::songPosition);
HXLINE( 116)		HX_VARI( Float,shit) = (((::Conductor_obj::songPosition - ( (Float)(::ClientPrefs_obj::noteOffset) )) - ( (Float)(lastChange->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic)) )) / ( (Float)(lastChange->__Field(HX_("stepCrochet",48,d7,ff,e6),::hx::paccDynamic)) ));
...
HX_DEFINE_DYNAMIC_FUNC0(MusicBeatState_obj,sectionHit,(void))
 ...
 ::Dynamic MusicBeatState_obj::getBeatsOnSection(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 171)
HXLINE( 172)		HX_VARI(  ::Dynamic,val) = 4;
...
HXLINE( 121)
HXLINE( 123)		HX_VARI(  ::Dynamic,curState) = ::flixel::FlxG_obj::game->_state;
HXLINE( 124)		HX_VARI(  ::MusicBeatState,leState) = ( ( ::MusicBeatState)(curState) );
...
HXLINE( 148)
HXLINE( 149)		HX_VARI(  ::Dynamic,curState) = ::flixel::FlxG_obj::game->_state;
HXLINE( 150)		HX_VARI(  ::MusicBeatState,leState) = ( ( ::MusicBeatState)(curState) );
