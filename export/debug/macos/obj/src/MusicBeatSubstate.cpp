...
HXLINE(  30)
HXLINE(  32)		HX_VARI( int,oldStep) = this->curStep;
...
void MusicBeatSubstate_obj::updateCurStep(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  51)
HXLINE(  52)		HX_VARI(  ::Dynamic,lastChange) = ::Conductor_obj::getBPMFromSeconds(::Conductor_obj::songPosition);
HXLINE(  54)		HX_VARI( Float,shit) = (((::Conductor_obj::songPosition - ( (Float)(::ClientPrefs_obj::noteOffset) )) - ( (Float)(lastChange->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic)) )) / ( (Float)(lastChange->__Field(HX_("stepCrochet",48,d7,ff,e6),::hx::paccDynamic)) ));
