...
void Note_obj::__construct(Float strumTime,int noteData, ::Note prevNote, ::Dynamic __o_sustainNote, ::Dynamic __o_inEditor){
            	...
            	HX_STACK_ARG(noteData,"noteData")
            	HX_STACK_ARG(prevNote,"prevNote")
            	HX_STACK_ARG(sustainNote,"sustainNote")
            	HX_STACK_ARG(inEditor,"inEditor")
HXLINE(  20)
...
HXLINE( 179)			 ::Note _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 179)			_hx_tmp1->strumTime = (_hx_tmp1->strumTime + ::ClientPrefs_obj::noteOffset);
            		}
...
HXLINE( 189)				_hx_tmp3 = (noteData > -1);
            			}
            			else {
HXLINE( 189)				_hx_tmp3 = false;
            			}
HXDLIN( 189)			if (_hx_tmp3) {
HXLINE( 189)				_hx_tmp2 = (noteData < 4);
            			}
            			else {
HXLINE( 189)				_hx_tmp2 = false;
            			}
HXDLIN( 189)			if (_hx_tmp2) {
HXLINE( 190)				HX_VARI( ::String,animToPlay) = HX_("",00,00,00,00);
...
HXLINE( 201)			_hx_tmp4 = ::hx::IsNotNull( prevNote );
            		}
            		else {
...
HXLINE( 208)			 ::Note _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 208)			Float _hx_tmp6 = _hx_tmp5->offsetX;
HXDLIN( 208)			_hx_tmp5->offsetX = (_hx_tmp6 + (this->get_width() / ( (Float)(2) )));
...
HXLINE( 215)			 ::Note _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 215)			Float _hx_tmp8 = _hx_tmp7->offsetX;
HXDLIN( 215)			_hx_tmp7->offsetX = (_hx_tmp8 - (this->get_width() / ( (Float)(2) )));
HXLINE( 217)			if (::PlayState_obj::isPixelStage) {
HXLINE( 218)				 ::Note _hx_tmp9 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 218)				_hx_tmp9->offsetX = (_hx_tmp9->offsetX + 30);
            			}
...
HXLINE( 256)		HX_VARI( ::String,skin) = texture;
...
HXLINE( 264)		HX_VARI( ::String,animName) = null();
HXLINE( 265)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE( 266)			animName = this->animation->_curAnim->name;
            		}
HXLINE( 269)		HX_VARI( ::Array< ::String >,arraySkin) = skin.split(HX_("/",2f,00,00,00));
HXLINE( 270)		arraySkin[(arraySkin->length - 1)] = ((prefix + arraySkin->__get((arraySkin->length - 1))) + suffix);
HXLINE( 272)		HX_VARI( Float,lastScaleY) = this->scale->y;
HXLINE( 273)		HX_VARI( ::String,blahblah) = arraySkin->join(HX_("/",2f,00,00,00));
...
HXDLIN( 280)				int _hx_tmp1 = ::Math_obj::floor(this->get_width());
HXDLIN( 280)				this->loadGraphic(returnAsset1,true,_hx_tmp1,::Math_obj::floor(this->get_height()),null(),null());
            			}
            			else {
HXLINE( 282)				::String library2 = null();
HXDLIN( 282)				 ::flixel::graphics::FlxGraphic returnAsset2 = ::Paths_obj::returnGraphic((HX_("pixelUI/",95,50,4f,7e) + blahblah),library2);
HXDLIN( 282)				this->loadGraphic(returnAsset2,null(),null(),null(),null(),null());
HXLINE( 283)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 284)				this->set_height((this->get_height() / ( (Float)(5) )));
HXLINE( 285)				::String library3 = null();
HXDLIN( 285)				 ::flixel::graphics::FlxGraphic returnAsset3 = ::Paths_obj::returnGraphic((HX_("pixelUI/",95,50,4f,7e) + blahblah),library3);
HXDLIN( 285)				int _hx_tmp2 = ::Math_obj::floor(this->get_width());
HXDLIN( 285)				this->loadGraphic(returnAsset3,true,_hx_tmp2,::Math_obj::floor(this->get_height()),null(),null());
            			}
HXLINE( 287)			Float _hx_tmp3 = this->get_width();
HXDLIN( 287)			this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp3 * ::PlayState_obj::daPixelZoom)),null());
HXLINE( 288)			this->loadPixelNoteAnims();
HXLINE( 289)			this->set_antialiasing(false);
HXLINE( 291)			if (this->isSustainNote) {
HXLINE( 292)				 ::Note _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 292)				_hx_tmp4->offsetX = (_hx_tmp4->offsetX + this->lastNoteOffsetXForPixelAutoAdjusting);
HXLINE( 293)				Float _hx_tmp5 = (this->get_width() - ( (Float)(7) ));
HXDLIN( 293)				this->lastNoteOffsetXForPixelAutoAdjusting = (_hx_tmp5 * (::PlayState_obj::daPixelZoom / ( (Float)(2) )));
HXLINE( 294)				 ::Note _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 294)				_hx_tmp6->offsetX = (_hx_tmp6->offsetX - this->lastNoteOffsetXForPixelAutoAdjusting);
            			}
            		}
            		else {
HXLINE( 304)			::String library4 = null();
...
HXDLIN( 304)			 ::Dynamic _hx_tmp7;
HXDLIN( 304)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 304)				_hx_tmp7 = imageLoaded;
            			}
            			else {
HXLINE( 304)				 ::flixel::graphics::FlxGraphic returnAsset4 = ::Paths_obj::returnGraphic(blahblah,library4);
HXDLIN( 304)				_hx_tmp7 = returnAsset4;
            			}
HXDLIN( 304)			::String _hx_tmp8;
HXDLIN( 304)			if (xmlExists) {
HXLINE( 304)				_hx_tmp8 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE( 304)				_hx_tmp8 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library4);
            			}
HXDLIN( 304)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp7,_hx_tmp8));
...
HXLINE( 367)					_hx_tmp3 = this->prevNote->wasGoodHit;
            				}
            				else {
HXLINE( 367)					_hx_tmp3 = false;
            				}
HXDLIN( 367)				if (!(_hx_tmp3)) {
HXLINE( 367)					_hx_tmp2 = (this->strumTime <= ::Conductor_obj::songPosition);
            				}
            				else {
...
HXLINE( 372)			_hx_tmp4 = !(this->inEditor);
            		}
            		else {
