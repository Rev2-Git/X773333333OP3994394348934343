...
HX_LOCAL_STACK_FRAME(_hx_pos_fc43ca8ee61f3046_65_loadAnims,"NoteSplash","loadAnims",0x63686ba7,"NoteSplash.loadAnims","NoteSplash.hx",65,0x3ec9e545)
HX_LOCAL_STACK_FRAME(_hx_pos_fc43ca8ee61f3046_75_update,"NoteSplash","update",0x2e98cebe,"NoteSplash.update","NoteSplash.hx",75,0x3ec9e545)
...
HXLINE(  16)		HX_VARI( ::String,skin) = HX_("noteSplashes",a7,57,29,8d);
...
void NoteSplash_obj::setupNoteSplash(Float x,Float y,::hx::Null< int >  __o_note,::String texture,::hx::Null< Float >  __o_hueColor,::hx::Null< Float >  __o_satColor,::hx::Null< Float >  __o_brtColor){
            	...
            	HX_STACK_ARG(hueColor,"hueColor")
            	HX_STACK_ARG(satColor,"satColor")
            	HX_STACK_ARG(brtColor,"brtColor")
HXLINE(  28)
...
HXLINE(  33)			::String _hx_switch_0 = ::ClientPrefs_obj::baseGameUI;
...
HXLINE(  38)				texture = HX_("noteSplashesPsych",14,a4,a2,4c);
HXDLIN(  38)				goto _hx_goto_1;
            			}
            			_hx_goto_1:;
HXLINE(  41)			bool _hx_tmp;
HXDLIN(  41)			if (::hx::IsNotNull( ::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic) )) {
HXLINE(  41)				_hx_tmp = (( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) ).length > 0);
            			}
            			else {
HXLINE(  41)				_hx_tmp = false;
            			}
HXDLIN(  41)			if (_hx_tmp) {
HXLINE(  41)				texture = ( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) );
            			}
            		}
HXLINE(  44)		if ((this->textureLoaded != texture)) {
HXLINE(  45)			this->loadAnims(texture);
            		}
HXLINE(  47)		this->colorSwap->set_hue(hueColor);
HXLINE(  48)		this->colorSwap->set_saturation(satColor);
HXLINE(  49)		this->colorSwap->set_brightness(brtColor);
HXLINE(  50)		::String _hx_switch_1 = ::ClientPrefs_obj::baseGameUI;
            		if (  (_hx_switch_1==HX_("Friday Night Funkin",7a,b7,3d,fb)) ){
HXLINE(  53)			 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN(  53)			this1->set_x(( (Float)(-25) ));
HXDLIN(  53)			this1->set_y(( (Float)(-25) ));
HXDLIN(  53)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_1==HX_("Psych Engine",47,a4,90,86)) ){
HXLINE(  55)			 ::flixel::math::FlxBasePoint this2 = this->offset;
HXDLIN(  55)			this2->set_x(( (Float)(10) ));
HXDLIN(  55)			this2->set_y(( (Float)(10) ));
HXDLIN(  55)			goto _hx_goto_2;
            		}
            		_hx_goto_2:;
HXLINE(  60)		HX_VARI( int,animNum) = ::flixel::FlxG_obj::random->_hx_int(1,2,null());
HXLINE(  61)		this->animation->play((((HX_("note",f2,17,0a,49) + note) + HX_("-",2d,00,00,00)) + animNum),true,null(),null());
HXLINE(  62)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE(  62)			 ::flixel::animation::FlxAnimation _hx_tmp1 = this->animation->_curAnim;
HXDLIN(  62)			_hx_tmp1->set_frameRate(( (Float)((24 + ::flixel::FlxG_obj::random->_hx_int(-2,2,null()))) ));
            		}
            	}
...
void NoteSplash_obj::loadAnims(::String skin){
            	HX_STACKFRAME(&_hx_pos_fc43ca8ee61f3046_65_loadAnims)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(skin,"skin")
HXLINE(  65)
HXLINE(  66)		::String library = null();
HXDLIN(  66)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(skin,null());
HXDLIN(  66)		bool xmlExists = false;
HXDLIN(  66)		if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE(  66)			xmlExists = true;
            		}
HXDLIN(  66)		 ::Dynamic _hx_tmp;
HXDLIN(  66)		if (::hx::IsNotNull( imageLoaded )) {
HXLINE(  66)			_hx_tmp = imageLoaded;
            		}
            		else {
HXLINE(  66)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(skin,library);
HXDLIN(  66)			_hx_tmp = returnAsset;
            		}
HXDLIN(  66)		::String _hx_tmp1;
HXDLIN(  66)		if (xmlExists) {
HXLINE(  66)			_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  66)			_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(  66)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE(  67)		{
HXLINE(  67)			{
HXLINE(  68)				this->animation->addByPrefix((HX_("note1-",4e,a3,b5,31) + 1),(HX_("note splash blue ",bb,a1,1a,b9) + 1),24,false,null(),null());
HXLINE(  69)				this->animation->addByPrefix((HX_("note2-",2d,a4,b5,31) + 1),(HX_("note splash green ",e8,04,d0,a7) + 1),24,false,null(),null());
HXLINE(  70)				this->animation->addByPrefix((HX_("note0-",6f,a2,b5,31) + 1),(HX_("note splash purple ",19,23,01,5b) + 1),24,false,null(),null());
HXLINE(  71)				this->animation->addByPrefix((HX_("note3-",0c,a5,b5,31) + 1),(HX_("note splash red ",da,d5,64,cd) + 1),24,false,null(),null());
            			}
HXLINE(  67)			{
HXLINE(  68)				this->animation->addByPrefix((HX_("note1-",4e,a3,b5,31) + 2),(HX_("note splash blue ",bb,a1,1a,b9) + 2),24,false,null(),null());
HXLINE(  69)				this->animation->addByPrefix((HX_("note2-",2d,a4,b5,31) + 2),(HX_("note splash green ",e8,04,d0,a7) + 2),24,false,null(),null());
HXLINE(  70)				this->animation->addByPrefix((HX_("note0-",6f,a2,b5,31) + 2),(HX_("note splash purple ",19,23,01,5b) + 2),24,false,null(),null());
HXLINE(  71)				this->animation->addByPrefix((HX_("note3-",0c,a5,b5,31) + 2),(HX_("note splash red ",da,d5,64,cd) + 2),24,false,null(),null());
            			}
            		}
            	}
...
void NoteSplash_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_fc43ca8ee61f3046_75_update)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE(  75)
HXLINE(  76)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE(  76)			if (this->animation->_curAnim->finished) {
HXLINE(  76)				this->kill();
            			}
            		}
