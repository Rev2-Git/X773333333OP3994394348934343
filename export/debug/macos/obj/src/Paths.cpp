...
HXLINE(  65)
HXLINE(  67)		{
HXLINE(  67)			HX_VARI(  ::Dynamic,key) = ::Paths_obj::currentTrackedAssets->keys();
HXDLIN(  67)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  67)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(  72)					HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(::Paths_obj::currentTrackedAssets->get(key1)) );
...
void Paths_obj::clearStoredMemory( ::Dynamic __o_cleanUnused){
            	...
            	HX_STACK_ARG(cleanUnused,"cleanUnused")
HXLINE(  88)
HXLINE(  91)		{
HXLINE(  91)			HX_VARI(  ::Dynamic,key) = ::flixel::FlxG_obj::bitmap->_cache->keys();
...
HXLINE(  93)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key1)) );
...
HXLINE( 102)		{
HXLINE( 102)			HX_VARI_NAME(  ::Dynamic,key2,"key") = ::Paths_obj::currentTrackedSounds->keys();
...
HXLINE( 129)			HX_VARI( ::String,levelPath) = HX_("",00,00,00,00);
...
::String Paths_obj::getLibraryPathForce(::String file,::String library){
            	...
            	HX_STACK_ARG(library,"library")
HXLINE( 150)
HXLINE( 151)		HX_VARI( ::String,returnPath) = (((((HX_("",00,00,00,00) + library) + HX_(":assets/",52,05,4a,2c)) + library) + HX_("/",2f,00,00,00)) + file);
...
::String Paths_obj::video(::String key){
            	...
            	HX_STACK_ARG(key,"key")
HXLINE( 194)
HXLINE( 196)		HX_VARI( ::String,file) = ::Paths_obj::modFolders((((HX_("videos/",97,cd,86,fd) + key) + HX_(".",2e,00,00,00)) + HX_("mp4",71,17,53,00)));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,video,return )
 ...
 ::openfl::media::Sound Paths_obj::sound(::String key,::String library){
            	...
            	HX_STACK_ARG(library,"library")
HXLINE( 205)
HXLINE( 206)		HX_VARI(  ::openfl::media::Sound,sound) = ::Paths_obj::returnSound(HX_("sounds",c4,a8,2e,32),key,library);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Paths_obj,soundRandom,return )
 ...
 ::openfl::media::Sound Paths_obj::music(::String key,::String library){
            	...
            	HX_STACK_ARG(library,"library")
HXLINE( 216)
HXLINE( 217)		HX_VARI(  ::openfl::media::Sound,file) = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),key,library);
...
HXDLIN( 226)		HX_VARI( ::String,songKey) = ((HX_("",00,00,00,00) + hideChars->split(path)->join(HX_("",00,00,00,00)).toLowerCase()) + HX_("/Voices",10,18,4f,34));
HXLINE( 227)		HX_VARI(  ::openfl::media::Sound,voices) = ::Paths_obj::returnSound(HX_("songs",fe,36,c7,80),songKey,null());
...
HXDLIN( 237)		HX_VARI( ::String,songKey) = ((HX_("",00,00,00,00) + hideChars->split(path)->join(HX_("",00,00,00,00)).toLowerCase()) + HX_("/Inst",95,b3,69,40));
HXLINE( 238)		HX_VARI(  ::openfl::media::Sound,inst) = ::Paths_obj::returnSound(HX_("songs",fe,36,c7,80),songKey,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,inst,return )
 ...
 ::flixel::graphics::FlxGraphic Paths_obj::image(::String key,::String library){
            	...
            	HX_STACK_ARG(library,"library")
HXLINE( 244)
HXLINE( 246)		HX_VARI(  ::flixel::graphics::FlxGraphic,returnAsset) = ::Paths_obj::returnGraphic(key,library);
...
::String Paths_obj::getTextFromFile(::String key, ::Dynamic __o_ignoreMods){
            	...
            	HX_STACK_ARG(key,"key")
            	HX_STACK_ARG(ignoreMods,"ignoreMods")
HXLINE( 251)
...
HXLINE( 259)			::String file1 = key;
HXDLIN( 259)			if (::hx::IsNull( file1 )) {
HXLINE( 259)				file1 = HX_("",00,00,00,00);
            			}
HXDLIN( 259)			return ::sys::io::File_obj::getContent((HX_("assets/",4c,2a,dc,36) + file1));
            		}
HXLINE( 261)		if (::hx::IsNotNull( ::Paths_obj::currentLevel )) {
HXLINE( 263)			HX_VARI( ::String,levelPath) = HX_("",00,00,00,00);
...
HXLINE( 270)			::String returnPath1 = ((((HX_("shared",a5,5e,2b,1d) + HX_(":assets/",52,05,4a,2c)) + HX_("shared",a5,5e,2b,1d)) + HX_("/",2f,00,00,00)) + key);
HXDLIN( 270)			levelPath = returnPath1;
...
::String Paths_obj::font(::String key){
            	...
            	HX_STACK_ARG(key,"key")
HXLINE( 279)
HXLINE( 281)		HX_VARI( ::String,file) = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + key));
...
HXLINE( 292)			::String key2 = key;
HXDLIN( 292)			if (::hx::IsNull( key2 )) {
HXLINE( 292)				key2 = HX_("",00,00,00,00);
            			}
HXDLIN( 292)			_hx_tmp = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key2));
            		}
            		else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Paths_obj,fileExists,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames Paths_obj::getSparrowAtlas(::String key,::String library){
            	...
            	HX_STACK_ARG(library,"library")
HXLINE( 304)
HXLINE( 306)		HX_VARI(  ::flixel::graphics::FlxGraphic,imageLoaded) = ::Paths_obj::returnGraphic(key,null());
HXLINE( 307)		HX_VARI( bool,xmlExists) = false;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Paths_obj,getSparrowAtlas,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames Paths_obj::getPackerAtlas(::String key,::String library){
            	...
            	HX_STACK_ARG(library,"library")
HXLINE( 320)
HXLINE( 322)		HX_VARI(  ::flixel::graphics::FlxGraphic,imageLoaded) = ::Paths_obj::returnGraphic(key,null());
HXLINE( 323)		HX_VARI( bool,txtExists) = false;
...
HXLINE( 334)
HXLINE( 335)		HX_VARI(  ::EReg,invalidChars) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\;:<>#]",7e,4d,88,67),HX_("",00,00,00,00));
HXLINE( 336)		HX_VARI(  ::EReg,hideChars) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[.,'\"%?!]",ca,d9,c0,ac),HX_("",00,00,00,00));
HXLINE( 338)		HX_VARI_NAME( ::String,path1,"path") = invalidChars->split(::StringTools_obj::replace(path,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)))->join(HX_("-",2d,00,00,00));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,formatToSongPath,return )
 ...
 ::flixel::graphics::FlxGraphic Paths_obj::returnGraphic(::String key,::String library){
            	...
            	HX_STACK_ARG(library,"library")
HXLINE( 344)
HXLINE( 346)		HX_VARI( ::String,modKey) = ::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)));
HXLINE( 347)		if (::sys::FileSystem_obj::exists(modKey)) {
HXLINE( 348)			if (!(::Paths_obj::currentTrackedAssets->exists(modKey))) {
HXLINE( 349)				HX_VARI(  ::openfl::display::BitmapData,newBitmap) = ::openfl::display::BitmapData_obj::fromFile(modKey);
HXLINE( 350)				HX_VARI(  ::flixel::graphics::FlxGraphic,newGraphic) = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(newBitmap,false,modKey,null());
...
HXLINE( 359)		HX_VARI( ::String,path) = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
...
HXLINE( 363)				HX_VARI_NAME(  ::flixel::graphics::FlxGraphic,newGraphic1,"newGraphic") = ::flixel::FlxG_obj::bitmap->add(path,false,path);
HXLINE( 364)				newGraphic1->persist = true;
HXLINE( 365)				::Paths_obj::currentTrackedAssets->set(path,newGraphic1);
            			}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Paths_obj,returnGraphic,return )
 ...
 ::openfl::media::Sound Paths_obj::returnSound(::String path,::String key,::String library){
            	...
            	HX_STACK_ARG(library,"library")
HXLINE( 375)
HXLINE( 377)		HX_VARI( ::String,file) = ::Paths_obj::modFolders(((((path + HX_("/",2f,00,00,00)) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
...
HXLINE( 387)		HX_VARI( ::String,gottenPath) = ::Paths_obj::getPath((((((HX_("",00,00,00,00) + path) + HX_("/",2f,00,00,00)) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("SOUND",af,c4,ba,fe),library);
...
HXLINE( 392)			::Dynamic this2 = ::Paths_obj::currentTrackedSounds;
HXDLIN( 392)			( ( ::haxe::ds::StringMap)(this2) )->set(gottenPath,::openfl::media::Sound_obj::fromFile((HX_("./",41,28,00,00) + gottenPath)));
            		}
...
HXDLIN( 454)			HX_VARI( ::String,fileToCheck) = (HX_("mods/",9e,2f,58,0c) + key1);
...
HXLINE( 460)				HX_VARI( ::String,mod) = _g1->__get(_g);
HXDLIN( 460)				_g = (_g + 1);
HXLINE( 461)				::String key2 = ((mod + HX_("/",2f,00,00,00)) + key);
HXDLIN( 461)				if (::hx::IsNull( key2 )) {
HXLINE( 461)					key2 = HX_("",00,00,00,00);
            				}
HXDLIN( 461)				HX_VARI_NAME( ::String,fileToCheck1,"fileToCheck") = (HX_("mods/",9e,2f,58,0c) + key2);
HXLINE( 462)				if (::sys::FileSystem_obj::exists(fileToCheck1)) {
HXLINE( 463)					return fileToCheck1;
            				}
            			}
            		}
...
HXLINE( 477)		HX_VARI( ::String,path) = HX_("modsList.txt",f1,ca,08,ac);
HXLINE( 478)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 480)			HX_VARI( ::Array< ::String >,list) = ::CoolUtil_obj::coolTextFile(path);
HXLINE( 481)			{
HXLINE( 481)				int _g = 0;
HXDLIN( 481)				while((_g < list->length)){
HXLINE( 481)					HX_VARI( ::String,i) = list->__get(_g);
HXDLIN( 481)					_g = (_g + 1);
HXLINE( 483)					HX_VARI( ::Array< ::String >,dat) = i.split(HX_("|",7c,00,00,00));
HXLINE( 484)					if ((dat->__get(1) == HX_("1",31,00,00,00))) {
HXLINE( 486)						HX_VARI( ::String,folder) = dat->__get(0);
HXLINE( 487)						::String key = (folder + HX_("/pack.json",ce,a9,3a,e3));
HXDLIN( 487)						if (::hx::IsNull( key )) {
HXLINE( 487)							key = HX_("",00,00,00,00);
            						}
HXDLIN( 487)						HX_VARI_NAME( ::String,path1,"path") = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 488)						if (::sys::FileSystem_obj::exists(path1)) {
HXLINE( 489)							try {
            								HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 490)								HX_VARI( ::String,rawJson) = ::sys::io::File_obj::getContent(path1);
...
HXLINE( 492)									HX_VARI(  ::Dynamic,stuff) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 493)									HX_VARI( bool,global) = ( (bool)(::Reflect_obj::getProperty(stuff,HX_("runsGlobally",98,2d,b5,06))) );
...
HXDLIN( 496)									HX_VARI(  ::Dynamic,e) = _g1;
...
HXLINE( 506)
HXLINE( 507)		HX_VARI( ::Array< ::String >,list) = ::Array_obj< ::String >::__new(0);
HXLINE( 508)		HX_VARI( ::String,modsFolder) = HX_("mods/",9e,2f,58,0c);
...
HXLINE( 510)				HX_VARI( ::String,folder) = _g1->__get(_g);
HXDLIN( 510)				_g = (_g + 1);
HXLINE( 511)				HX_VARI( ::String,path) = ::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,modsFolder)->init(1,folder));
