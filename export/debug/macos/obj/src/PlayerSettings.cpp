...
HXLINE( 126)		HX_VARI( int,numGamepads) = ::flixel::FlxG_obj::gamepads->get_numActiveGamepads();
HXLINE( 127)		if ((numGamepads > 0)) {
HXLINE( 129)			HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = ::flixel::FlxG_obj::gamepads->_activeGamepads->__get(0).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
...
HXLINE( 144)			HX_VARI_NAME(  ::flixel::input::gamepad::FlxGamepad,gamepad1,"gamepad") = ::flixel::FlxG_obj::gamepads->_activeGamepads->__get(1).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
