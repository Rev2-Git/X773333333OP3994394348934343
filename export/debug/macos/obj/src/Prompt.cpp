...
HXLINE(  47)			_gthis->close();
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(promptText,"promptText")
            	HX_STACK_ARG(defaultSelected,"defaultSelected")
            	HX_STACK_ARG(okCallback,"okCallback")
            	HX_STACK_ARG(cancelCallback,"cancelCallback")
            	HX_STACK_ARG(acceptOnDefault,"acceptOnDefault")
            	HX_STACK_ARG(option1,"option1")
            	HX_STACK_ARG(option2,"option2")
HXLINE(  17)
...
HXLINE(  39)		HX_VARI( ::String,op1) = HX_("OK",1c,45,00,00);
HXLINE(  40)		HX_VARI( ::String,op2) = HX_("CANCEL",7a,99,b6,6a);
...
HXLINE(  74)					int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(  74)					_this->set_x(((( (Float)(_hx_tmp1) ) - _this->get_width()) / ( (Float)(2) )));
            				}
...
HXLINE(  74)					int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(  74)					_this->set_y(((( (Float)(_hx_tmp3) ) - _this->get_height()) / ( (Float)(2) )));
            				}
            			}
HXLINE(  75)			{
...
HXDLIN(  76)					_this1->set_x(((( (Float)(_hx_tmp5) ) - _this1->get_width()) / ( (Float)(2) )));
            				}
...
HXDLIN(  76)					_this1->set_y(((( (Float)(_hx_tmp7) ) - _this1->get_height()) / ( (Float)(2) )));
            				}
            			}
...
HXDLIN(  83)			HX_VARI_NAME(  ::flixel::text::FlxText,textshit1,"textshit") =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,textshit,this->panel->y,300,this->theText,16,null());
...
HXLINE(  86)					_hx_tmp8 = (axes2 == 17);
            				}
            				else {
HXLINE(  86)					_hx_tmp8 = true;
            				}
HXDLIN(  86)				if (_hx_tmp8) {
HXLINE(  86)					int _hx_tmp9 = ::flixel::FlxG_obj::width;
HXDLIN(  86)					textshit1->set_x(((( (Float)(_hx_tmp9) ) - textshit1->get_width()) / ( (Float)(2) )));
            				}
HXDLIN(  86)				bool _hx_tmp10;
HXDLIN(  86)				if ((axes2 != 16)) {
HXLINE(  86)					_hx_tmp10 = (axes2 == 17);
            				}
            				else {
HXLINE(  86)					_hx_tmp10 = true;
            				}
HXDLIN(  86)				if (_hx_tmp10) {
HXLINE(  86)					int _hx_tmp11 = ::flixel::FlxG_obj::height;
HXDLIN(  86)					textshit1->set_y(((( (Float)(_hx_tmp11) ) - textshit1->get_height()) / ( (Float)(2) )));
            				}
            			}
HXLINE(  87)			{
HXLINE(  87)				 ::flixel::ui::FlxButton _this2 = this->buttonAccept;
HXDLIN(  87)				int axes3 = 17;
HXDLIN(  87)				bool _hx_tmp12;
HXDLIN(  87)				if ((axes3 != 1)) {
HXLINE(  87)					_hx_tmp12 = (axes3 == 17);
            				}
            				else {
HXLINE(  87)					_hx_tmp12 = true;
            				}
HXDLIN(  87)				if (_hx_tmp12) {
HXLINE(  87)					int _hx_tmp13 = ::flixel::FlxG_obj::width;
HXDLIN(  87)					_this2->set_x(((( (Float)(_hx_tmp13) ) - _this2->get_width()) / ( (Float)(2) )));
            				}
HXDLIN(  87)				bool _hx_tmp14;
HXDLIN(  87)				if ((axes3 != 16)) {
HXLINE(  87)					_hx_tmp14 = (axes3 == 17);
            				}
            				else {
HXLINE(  87)					_hx_tmp14 = true;
            				}
HXDLIN(  87)				if (_hx_tmp14) {
HXLINE(  87)					int _hx_tmp15 = ::flixel::FlxG_obj::height;
HXDLIN(  87)					_this2->set_y(((( (Float)(_hx_tmp15) ) - _this2->get_height()) / ( (Float)(2) )));
            				}
            			}
HXLINE(  88)			{
HXLINE(  88)				 ::flixel::ui::FlxButton _this3 = this->buttonNo;
HXDLIN(  88)				int axes4 = 17;
HXDLIN(  88)				bool _hx_tmp16;
HXDLIN(  88)				if ((axes4 != 1)) {
HXLINE(  88)					_hx_tmp16 = (axes4 == 17);
            				}
            				else {
HXLINE(  88)					_hx_tmp16 = true;
            				}
HXDLIN(  88)				if (_hx_tmp16) {
HXLINE(  88)					int _hx_tmp17 = ::flixel::FlxG_obj::width;
HXDLIN(  88)					_this3->set_x(((( (Float)(_hx_tmp17) ) - _this3->get_width()) / ( (Float)(2) )));
            				}
HXDLIN(  88)				bool _hx_tmp18;
HXDLIN(  88)				if ((axes4 != 16)) {
HXLINE(  88)					_hx_tmp18 = (axes4 == 17);
            				}
            				else {
HXLINE(  88)					_hx_tmp18 = true;
            				}
HXDLIN(  88)				if (_hx_tmp18) {
HXLINE(  88)					int _hx_tmp19 = ::flixel::FlxG_obj::height;
HXDLIN(  88)					_this3->set_y(((( (Float)(_hx_tmp19) ) - _this3->get_height()) / ( (Float)(2) )));
            				}
            			}
...
HXLINE(  90)			 ::flixel::ui::FlxButton _hx_tmp20 = this->buttonAccept;
HXDLIN(  90)			Float _hx_tmp21 = this->panel->y;
HXDLIN(  90)			_hx_tmp20->set_y(((_hx_tmp21 + this->panel->get_height()) - ( (Float)(30) )));
...
HXLINE(  92)			 ::flixel::ui::FlxButton _hx_tmp22 = this->buttonNo;
HXDLIN(  92)			Float _hx_tmp23 = this->panel->y;
HXDLIN(  92)			_hx_tmp22->set_y(((_hx_tmp23 + this->panel->get_height()) - ( (Float)(30) )));
HXLINE(  93)			{
...
HXDLIN( 154)		HX_VARI_NAME( Float,antiX1,"antiX") = (antiX - ( (Float)(this->cornerSize) ));
HXLINE( 155)		HX_VAR( Float,antiY);
HXDLIN( 155)		if (flipY) {
