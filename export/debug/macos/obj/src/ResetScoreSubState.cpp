...
HXLINE(  30)		HX_VARI( ::String,name) = song;
HXLINE(  31)		if ((week > -1)) {
...
HXLINE(  41)		HX_VAR( Float,tooLong);
...
HXLINE(  42)		HX_VARI(  ::Alphabet,text) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(180) ),HX_("Reset the score of",c5,93,fa,2d),true);
HXLINE(  43)		{
...
HXDLIN(  43)				text->set_x(((( (Float)(_hx_tmp1) ) - text->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  43)				text->set_y(((( (Float)(_hx_tmp3) ) - text->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  44)		this->alphabetArray->push(text);
HXLINE(  45)		text->set_alpha(( (Float)(0) ));
HXLINE(  46)		this->add(text);
HXLINE(  47)		HX_VARI(  ::Alphabet,text1) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(text->y + 90),name,true);
HXLINE(  48)		text1->set_scaleX(tooLong);
HXLINE(  49)		{
HXLINE(  49)			int axes1 = 1;
HXDLIN(  49)			bool _hx_tmp4;
HXDLIN(  49)			if ((axes1 != 1)) {
HXLINE(  49)				_hx_tmp4 = (axes1 == 17);
            			}
            			else {
HXLINE(  49)				_hx_tmp4 = true;
            			}
HXDLIN(  49)			if (_hx_tmp4) {
HXLINE(  49)				int _hx_tmp5 = ::flixel::FlxG_obj::width;
HXDLIN(  49)				text1->set_x(((( (Float)(_hx_tmp5) ) - text1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  49)			bool _hx_tmp6;
HXDLIN(  49)			if ((axes1 != 16)) {
HXLINE(  49)				_hx_tmp6 = (axes1 == 17);
            			}
            			else {
HXLINE(  49)				_hx_tmp6 = true;
            			}
HXDLIN(  49)			if (_hx_tmp6) {
HXLINE(  49)				int _hx_tmp7 = ::flixel::FlxG_obj::height;
HXDLIN(  49)				text1->set_y(((( (Float)(_hx_tmp7) ) - text1->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  50)		if ((week == -1)) {
...
HXLINE(  56)			 ::HealthIcon _hx_tmp8 = this->icon;
HXDLIN(  56)			_hx_tmp8->setGraphicSize(::Std_obj::_hx_int((this->icon->get_width() * tooLong)),null());
HXLINE(  57)			this->icon->updateHitbox();
HXLINE(  58)			 ::HealthIcon _hx_tmp9 = this->icon;
HXDLIN(  58)			Float text2 = text1->x;
HXDLIN(  58)			Float _hx_tmp10 = ((text2 - this->icon->get_width()) + (( (Float)(10) ) * tooLong));
HXDLIN(  58)			_hx_tmp9->setPosition(_hx_tmp10,(text1->y - ( (Float)(30) )));
...
HXLINE(  64)				_hx_tmp11 = (axes2 == 17);
            			}
            			else {
HXLINE(  64)				_hx_tmp11 = true;
            			}
HXDLIN(  64)			if (_hx_tmp11) {
HXLINE(  64)				int _hx_tmp12 = ::flixel::FlxG_obj::width;
HXDLIN(  64)				_this->set_x(((( (Float)(_hx_tmp12) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  64)			bool _hx_tmp13;
HXDLIN(  64)			if ((axes2 != 16)) {
HXLINE(  64)				_hx_tmp13 = (axes2 == 17);
            			}
            			else {
HXLINE(  64)				_hx_tmp13 = true;
            			}
HXDLIN(  64)			if (_hx_tmp13) {
HXLINE(  64)				int _hx_tmp14 = ::flixel::FlxG_obj::height;
HXDLIN(  64)				_this->set_y(((( (Float)(_hx_tmp14) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  68)				_hx_tmp15 = (axes3 == 17);
            			}
            			else {
HXLINE(  68)				_hx_tmp15 = true;
            			}
HXDLIN(  68)			if (_hx_tmp15) {
HXLINE(  68)				int _hx_tmp16 = ::flixel::FlxG_obj::width;
HXDLIN(  68)				_this1->set_x(((( (Float)(_hx_tmp16) ) - _this1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  68)			bool _hx_tmp17;
HXDLIN(  68)			if ((axes3 != 16)) {
HXLINE(  68)				_hx_tmp17 = (axes3 == 17);
            			}
            			else {
HXLINE(  68)				_hx_tmp17 = true;
            			}
HXDLIN(  68)			if (_hx_tmp17) {
HXLINE(  68)				int _hx_tmp18 = ::flixel::FlxG_obj::height;
HXDLIN(  68)				_this1->set_y(((( (Float)(_hx_tmp18) ) - _this1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  79)				_g = (_g + 1);
HXDLIN(  79)				HX_VARI( int,i) = (_g - 1);
HXLINE(  80)				HX_VARI(  ::Alphabet,spr) = this->alphabetArray->__get(i).StaticCast<  ::Alphabet >();
HXLINE(  81)				spr->set_alpha((spr->alpha + (elapsed * ((Float)2.5))));
            			}
            		}
HXLINE(  83)		if ((this->week == -1)) {
HXLINE(  83)			 ::HealthIcon fh1 = this->icon;
HXDLIN(  83)			fh1->set_alpha((fh1->alpha + (elapsed * ((Float)2.5))));
            		}
...
HXLINE(  86)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN(  86)			_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),1,null(),null(),null(),null());
HXLINE(  87)			this->onYes = !(this->onYes);
HXLINE(  88)			this->updateOptions();
            		}
HXLINE(  90)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE(  91)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN(  91)			_hx_tmp2->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
...
HXLINE( 101)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN( 101)				_hx_tmp3->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
...
void ResetScoreSubState_obj::updateOptions(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 107)
HXLINE( 108)		HX_VARI( ::Array< Float >,scales) = ::Array_obj< Float >::fromData( _hx_array_data_9ecb92b4_4,2);
HXLINE( 109)		HX_VARI( ::Array< Float >,alphas) = ::Array_obj< Float >::fromData( _hx_array_data_9ecb92b4_5,2);
HXLINE( 110)		HX_VAR( int,confirmInt);
