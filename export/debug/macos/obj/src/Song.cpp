...
void Song_obj::onLoadJson( ::Dynamic songJson){
            	...
            	HX_STACK_ARG(songJson,"songJson")
HXLINE(  50)
...
HXLINE(  60)					_g = (_g + 1);
HXDLIN(  60)					HX_VARI( int,secNum) = (_g - 1);
HXLINE(  62)					HX_VARI(  ::Dynamic,sec) =  ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(secNum);
HXLINE(  64)					HX_VARI( int,i) = 0;
HXLINE(  65)					HX_VARI( ::cpp::VirtualArray,notes) = ( (::cpp::VirtualArray)(sec->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) );
HXLINE(  66)					HX_VARI( int,len) = notes->get_length();
HXLINE(  67)					while((i < len)){
HXLINE(  69)						HX_VARI( ::cpp::VirtualArray,note) = ( (::cpp::VirtualArray)(notes->__get(i)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,onLoadJson,(void))
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	...
            	HX_STACK_ARG(jsonInput,"jsonInput")
            	HX_STACK_ARG(folder,"folder")
HXLINE(  90)
HXLINE(  91)		HX_VARI( ::String,rawJson) = null();
...
HXDLIN(  93)		HX_VARI( ::String,formattedFolder) = hideChars->split(path)->join(HX_("",00,00,00,00)).toLowerCase();
...
HXDLIN(  94)		HX_VARI( ::String,formattedSong) = hideChars1->split(path1)->join(HX_("",00,00,00,00)).toLowerCase();
HXLINE(  96)		HX_VARI( ::String,moddyFile) = ::Paths_obj::modFolders(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)));
...
HXLINE( 132)		HX_VARI(  ::Dynamic,songJson) = ::Song_obj::parseJSONshit(rawJson);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	...
            	HX_STACK_ARG(rawJson,"rawJson")
HXLINE( 139)
HXLINE( 140)		HX_VARI(  ::Dynamic,swagShit) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
