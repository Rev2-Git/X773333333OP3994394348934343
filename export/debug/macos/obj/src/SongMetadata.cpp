...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_534_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",534,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_534_new)
            	HX_STACK_THIS(this)
...
HXLINE( 534)
HXLINE( 540)		this->folder = HX_("",00,00,00,00);
HXLINE( 539)		this->color = -7179779;
HXLINE( 538)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 537)		this->week = 0;
HXLINE( 536)		this->songName = HX_("",00,00,00,00);
HXLINE( 544)		this->songName = song;
HXLINE( 545)		this->week = week;
HXLINE( 546)		this->songCharacter = songCharacter;
HXLINE( 547)		this->color = color;
HXLINE( 548)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 549)		if (::hx::IsNull( this->folder )) {
HXLINE( 549)			this->folder = HX_("",00,00,00,00);
            		}
            	}
