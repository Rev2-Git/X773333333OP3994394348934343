...
HXLINE(  33)
HXLINE(  34)		HX_VARI( ::String,stage) = HX_("",00,00,00,00);
...
HXLINE(  63)		HX_VARI(  ::Dynamic,stageFile) = ::StageData_obj::getStageFile(stage);
...
HXLINE(  71)
HXLINE(  72)		HX_VARI( ::String,rawJson) = null();
...
HXDLIN(  73)		HX_VARI( ::String,path) = (HX_("assets/",4c,2a,dc,36) + file);
HXLINE(  76)		HX_VARI( ::String,modPath) = ::Paths_obj::modFolders(((HX_("stages/",9a,7a,ca,2d) + stage) + HX_(".json",56,f1,d6,c2)));
