...
HX_LOCAL_STACK_FRAME(_hx_pos_451d99b3fc57d4a2_137_update,"StrumNote","update",0x7186005c,"StrumNote.update","StrumNote.hx",137,0x345a6fe3)
HX_LOCAL_STACK_FRAME(_hx_pos_451d99b3fc57d4a2_154_playAnim,"StrumNote","playAnim",0x17d6df38,"StrumNote.playAnim","StrumNote.hx",154,0x345a6fe3)
...
HXLINE(  37)		HX_VARI( ::String,skin) = HX_("NOTE_assets",70,3c,09,f7);
...
void StrumNote_obj::reloadNote(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  45)
HXLINE(  46)		HX_VARI( ::String,lastAnim) = null();
...
HXDLIN(  85)			::String library2 = null();
...
HXDLIN(  85)			 ::Dynamic _hx_tmp2;
HXDLIN(  85)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE(  85)				_hx_tmp2 = imageLoaded;
            			}
            			else {
HXLINE(  85)				 ::flixel::graphics::FlxGraphic returnAsset2 = ::Paths_obj::returnGraphic(key,library2);
HXDLIN(  85)				_hx_tmp2 = returnAsset2;
            			}
HXDLIN(  85)			::String _hx_tmp3;
HXDLIN(  85)			if (xmlExists) {
HXLINE(  85)				_hx_tmp3 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE(  85)				_hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2);
            			}
HXDLIN(  85)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp2,_hx_tmp3));
...
HXLINE( 125)		if ((::ClientPrefs_obj::baseGameUI == HX_("Friday Night Funkin",7a,b7,3d,fb))) {
HXLINE( 127)			this->set_x((this->x + 5));
            		}
            		else {
HXLINE( 131)			this->set_x((this->x + 50));
            		}
HXLINE( 133)		this->set_x((this->x + ((( (Float)(::flixel::FlxG_obj::width) ) / ( (Float)(2) )) * ( (Float)(this->player) ))));
HXLINE( 134)		this->ID = this->noteData;
            	}
...
void StrumNote_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_451d99b3fc57d4a2_137_update)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE( 137)
HXLINE( 138)		if ((this->resetAnim > 0)) {
HXLINE( 139)			 ::StrumNote _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 139)			_hx_tmp->resetAnim = (_hx_tmp->resetAnim - elapsed);
HXLINE( 140)			if ((this->resetAnim <= 0)) {
HXLINE( 141)				this->playAnim(HX_("static",ae,dc,fb,05),null());
HXLINE( 142)				this->resetAnim = ( (Float)(0) );
            			}
            		}
HXLINE( 146)		bool _hx_tmp1;
HXDLIN( 146)		if ((this->animation->_curAnim->name == HX_("confirm",00,9d,39,10))) {
HXLINE( 146)			_hx_tmp1 = !(::PlayState_obj::isPixelStage);
            		}
            		else {
HXLINE( 146)			_hx_tmp1 = false;
            		}
HXDLIN( 146)		if (_hx_tmp1) {
HXLINE( 147)			 ::flixel::math::FlxBasePoint this1 = this->origin;
HXDLIN( 147)			Float y = (( (Float)(this->frameHeight) ) * ((Float)0.5));
HXDLIN( 147)			this1->set_x((( (Float)(this->frameWidth) ) * ((Float)0.5)));
...
void StrumNote_obj::playAnim(::String anim, ::Dynamic __o_force){
            	...
            	HX_STACKFRAME(&_hx_pos_451d99b3fc57d4a2_154_playAnim)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(anim,"anim")
            	HX_STACK_ARG(force,"force")
HXLINE( 154)
HXLINE( 155)		this->animation->play(anim,force,null(),null());
HXLINE( 156)		this->centerOffsets(null());
HXLINE( 157)		{
HXLINE( 157)			 ::flixel::math::FlxBasePoint this1 = this->origin;
HXDLIN( 157)			Float y = (( (Float)(this->frameHeight) ) * ((Float)0.5));
HXDLIN( 157)			this1->set_x((( (Float)(this->frameWidth) ) * ((Float)0.5)));
HXDLIN( 157)			this1->set_y(y);
            		}
HXLINE( 158)		bool _hx_tmp;
HXDLIN( 158)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE( 158)			_hx_tmp = (this->animation->_curAnim->name == HX_("static",ae,dc,fb,05));
            		}
            		else {
HXLINE( 158)			_hx_tmp = true;
            		}
HXDLIN( 158)		if (_hx_tmp) {
HXLINE( 159)			this->colorSwap->set_hue(( (Float)(0) ));
HXLINE( 160)			this->colorSwap->set_saturation(( (Float)(0) ));
HXLINE( 161)			this->colorSwap->set_brightness(( (Float)(0) ));
            		}
            		else {
HXLINE( 163)			bool _hx_tmp1;
HXDLIN( 163)			if ((this->noteData > -1)) {
HXLINE( 163)				_hx_tmp1 = (this->noteData < ::ClientPrefs_obj::arrowHSV->length);
            			}
            			else {
HXLINE( 163)				_hx_tmp1 = false;
            			}
HXDLIN( 163)			if (_hx_tmp1) {
HXLINE( 165)				this->colorSwap->set_hue((( (Float)(::ClientPrefs_obj::arrowHSV->__get(this->noteData).StaticCast< ::Array< int > >()->__get(0)) ) / ( (Float)(360) )));
HXLINE( 166)				this->colorSwap->set_saturation((( (Float)(::ClientPrefs_obj::arrowHSV->__get(this->noteData).StaticCast< ::Array< int > >()->__get(1)) ) / ( (Float)(100) )));
HXLINE( 167)				this->colorSwap->set_brightness((( (Float)(::ClientPrefs_obj::arrowHSV->__get(this->noteData).StaticCast< ::Array< int > >()->__get(2)) ) / ( (Float)(100) )));
            			}
HXLINE( 170)			bool _hx_tmp2;
HXDLIN( 170)			if ((this->animation->_curAnim->name == HX_("confirm",00,9d,39,10))) {
HXLINE( 170)				_hx_tmp2 = !(::PlayState_obj::isPixelStage);
            			}
            			else {
HXLINE( 170)				_hx_tmp2 = false;
            			}
HXDLIN( 170)			if (_hx_tmp2) {
HXLINE( 171)				 ::flixel::math::FlxBasePoint this2 = this->origin;
HXDLIN( 171)				Float y1 = (( (Float)(this->frameHeight) ) * ((Float)0.5));
HXDLIN( 171)				this2->set_x((( (Float)(this->frameWidth) ) * ((Float)0.5)));
HXDLIN( 171)				this2->set_y(y1);
            			}
            		}
            	}
