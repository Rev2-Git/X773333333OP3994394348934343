...
HXLINE(  43)			HX_VARI( bool,playedSound) = false;
...
HXLINE(  48)					_hx_tmp2 = (this->sound != HX_("",00,00,00,00));
            				}
            				else {
...
HXLINE(  48)						_hx_tmp1 = (::hx::Mod(this->_curLetter,2) == 0);
            					}
            					else {
...
HXLINE(  50)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN(  50)					 ::openfl::media::Sound _hx_tmp4 = ::Paths_obj::sound(this->sound,null());
HXDLIN(  50)					_hx_tmp3->play(_hx_tmp4,this->volume,null(),null(),null(),null());
            				}
...
void TypedAlphabet_obj::showCharacterUpTo(int upTo){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(upTo,"upTo")
HXLINE(  70)
HXLINE(  71)		HX_VARI( int,start) = this->_curLetter;
...
HXLINE(  86)				HX_VARI(  ::AlphaCharacter,letter) = _g1->__get(_g).StaticCast<  ::AlphaCharacter >();
HXDLIN(  86)				_g = (_g + 1);
