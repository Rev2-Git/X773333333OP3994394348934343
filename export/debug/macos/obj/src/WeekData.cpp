...
HXLINE(  52)
HXLINE(  53)		HX_VARI(  ::Dynamic,weekFile) =  ::Dynamic(::hx::Anon_obj::Create(12)
...
void WeekData_obj::reloadWeekFiles( ::Dynamic __o_isStoryMode){
            	...
            	HX_STACK_ARG(isStoryMode,"isStoryMode")
HXLINE(  89)
HXLINE(  90)		::WeekData_obj::weeksList = ::Array_obj< ::String >::__new(0);
HXLINE(  91)		::WeekData_obj::weeksLoaded->clear();
HXLINE(  93)		HX_VARI( ::Array< ::String >,disabledMods) = ::Array_obj< ::String >::__new(0);
HXLINE(  94)		HX_VARI( ::String,modsListPath) = HX_("modsList.txt",f1,ca,08,ac);
HXLINE(  95)		HX_VARI( ::Array< ::String >,directories) = ::Array_obj< ::String >::fromData( _hx_array_data_0344a85e_12,2);
HXLINE(  96)		HX_VARI( int,originalLength) = directories->length;
HXLINE(  97)		if (::sys::FileSystem_obj::exists(modsListPath)) {
HXLINE(  99)			HX_VARI( ::Array< ::String >,stuff) = ::CoolUtil_obj::coolTextFile(modsListPath);
HXLINE( 100)			{
HXLINE( 100)				int _g = 0;
HXDLIN( 100)				int _g1 = stuff->length;
HXDLIN( 100)				while((_g < _g1)){
HXLINE( 100)					_g = (_g + 1);
HXDLIN( 100)					HX_VARI( int,i) = (_g - 1);
HXLINE( 102)					HX_VARI( ::Array< ::String >,splitName) = ::StringTools_obj::trim(stuff->__get(i)).split(HX_("|",7c,00,00,00));
HXLINE( 103)					if ((splitName->__get(1) == HX_("0",30,00,00,00))) {
HXLINE( 105)						disabledMods->push(splitName->__get(0));
            					}
            					else {
HXLINE( 109)						HX_VARI( ::String,path) = ::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,HX_("mods/",9e,2f,58,0c))->init(1,splitName->__get(0)));
...
HXLINE( 120)		HX_VARI( ::Array< ::String >,modsDirectories) = ::Paths_obj::getModDirectories();
HXLINE( 121)		{
HXLINE( 121)			int _g2 = 0;
HXDLIN( 121)			while((_g2 < modsDirectories->length)){
HXLINE( 121)				HX_VARI( ::String,folder) = modsDirectories->__get(_g2);
HXDLIN( 121)				_g2 = (_g2 + 1);
HXLINE( 123)				HX_VARI( ::String,pathThing) = (::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,HX_("mods/",9e,2f,58,0c))->init(1,folder)) + HX_("/",2f,00,00,00));
HXLINE( 124)				bool _hx_tmp3;
HXDLIN( 124)				if (!(disabledMods->contains(folder))) {
HXLINE( 124)					_hx_tmp3 = !(directories->contains(pathThing));
            				}
            				else {
...
HXDLIN( 135)		HX_VARI( ::Array< ::String >,sexList) = ::CoolUtil_obj::coolTextFile((HX_("assets/",4c,2a,dc,36) + file));
HXLINE( 136)		{
HXLINE( 136)			int _g3 = 0;
HXDLIN( 136)			int _g4 = sexList->length;
HXDLIN( 136)			while((_g3 < _g4)){
HXLINE( 136)				_g3 = (_g3 + 1);
HXDLIN( 136)				HX_VARI_NAME( int,i1,"i") = (_g3 - 1);
HXLINE( 137)				{
HXLINE( 137)					int _g5 = 0;
HXDLIN( 137)					int _g6 = directories->length;
HXDLIN( 137)					while((_g5 < _g6)){
HXLINE( 137)						_g5 = (_g5 + 1);
HXDLIN( 137)						HX_VARI( int,j) = (_g5 - 1);
HXLINE( 138)						HX_VARI( ::String,fileToCheck) = (((directories->__get(j) + HX_("weeks/",50,a9,04,ff)) + sexList->__get(i1)) + HX_(".json",56,f1,d6,c2));
HXLINE( 139)						if (!(::WeekData_obj::weeksLoaded->exists(sexList->__get(i1)))) {
HXLINE( 140)							HX_VARI(  ::Dynamic,week) = ::WeekData_obj::getWeekFile(fileToCheck);
HXLINE( 141)							if (::hx::IsNotNull( week )) {
HXLINE( 142)								HX_VARI(  ::WeekData,weekFile) =  ::WeekData_obj::__alloc( HX_CTX ,week,sexList->__get(i1));
...
HXLINE( 150)										_hx_tmp5 = true;
            									}
HXDLIN( 150)									if (!(_hx_tmp5)) {
HXLINE( 150)										if (!(( (bool)(isStoryMode) ))) {
HXLINE( 150)											_hx_tmp4 = !(weekFile->hideFreeplay);
            										}
            										else {
...
HXLINE( 151)									::WeekData_obj::weeksLoaded->set(sexList->__get(i1),weekFile);
HXLINE( 152)									::WeekData_obj::weeksList->push(sexList->__get(i1));
            								}
            							}
            						}
            					}
...
HXLINE( 160)		{
HXLINE( 160)			int _g7 = 0;
HXDLIN( 160)			int _g8 = directories->length;
HXDLIN( 160)			while((_g7 < _g8)){
HXLINE( 160)				_g7 = (_g7 + 1);
HXDLIN( 160)				HX_VARI_NAME( int,i2,"i") = (_g7 - 1);
HXLINE( 161)				HX_VARI( ::String,directory) = (directories->__get(i2) + HX_("weeks/",50,a9,04,ff));
HXLINE( 162)				if (::sys::FileSystem_obj::exists(directory)) {
HXLINE( 163)					HX_VARI( ::Array< ::String >,listOfWeeks) = ::CoolUtil_obj::coolTextFile((directory + HX_("weekList.txt",74,12,92,5d)));
HXLINE( 164)					{
HXLINE( 164)						int _g9 = 0;
HXDLIN( 164)						while((_g9 < listOfWeeks->length)){
HXLINE( 164)							HX_VARI( ::String,daWeek) = listOfWeeks->__get(_g9);
HXDLIN( 164)							_g9 = (_g9 + 1);
HXLINE( 166)							HX_VARI_NAME( ::String,path1,"path") = ((directory + daWeek) + HX_(".json",56,f1,d6,c2));
HXLINE( 167)							if (::sys::FileSystem_obj::exists(path1)) {
HXLINE( 169)								::WeekData_obj::addWeek(daWeek,path1,directories->__get(i2),i2,originalLength);
            							}
            						}
            					}
HXLINE( 173)					{
HXLINE( 173)						int _g10 = 0;
HXDLIN( 173)						::Array< ::String > _g11 = ::sys::FileSystem_obj::readDirectory(directory);
HXDLIN( 173)						while((_g10 < _g11->length)){
HXLINE( 173)							HX_VARI_NAME( ::String,file1,"file") = _g11->__get(_g10);
HXDLIN( 173)							_g10 = (_g10 + 1);
HXLINE( 175)							HX_VARI_NAME( ::String,path2,"path") = ::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,directory)->init(1,file1));
HXLINE( 176)							bool _hx_tmp6;
HXDLIN( 176)							if (!(::sys::FileSystem_obj::isDirectory(path2))) {
HXLINE( 176)								_hx_tmp6 = ::StringTools_obj::endsWith(file1,HX_(".json",56,f1,d6,c2));
            							}
            							else {
HXLINE( 176)								_hx_tmp6 = false;
            							}
HXDLIN( 176)							if (_hx_tmp6) {
HXLINE( 178)								::String _hx_tmp7 = file1.substr(0,(file1.length - 5));
HXDLIN( 178)								::WeekData_obj::addWeek(_hx_tmp7,path2,directories->__get(i2),i2,originalLength);
            							}
            						}
            					}
            				}
...
void WeekData_obj::addWeek(::String weekToCheck,::String path,::String directory,int i,int originalLength){
            	...
            	HX_STACK_ARG(weekToCheck,"weekToCheck")
            	HX_STACK_ARG(path,"path")
            	HX_STACK_ARG(directory,"directory")
            	HX_STACK_ARG(i,"i")
            	HX_STACK_ARG(originalLength,"originalLength")
HXLINE( 188)
HXDLIN( 188)		if (!(::WeekData_obj::weeksLoaded->exists(weekToCheck))) {
HXLINE( 190)			HX_VARI(  ::Dynamic,week) = ::WeekData_obj::getWeekFile(path);
HXLINE( 191)			if (::hx::IsNotNull( week )) {
HXLINE( 193)				HX_VARI(  ::WeekData,weekFile) =  ::WeekData_obj::__alloc( HX_CTX ,week,weekToCheck);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(WeekData_obj,addWeek,(void))
 ...
 ::Dynamic WeekData_obj::getWeekFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 209)
HXLINE( 210)		HX_VARI( ::String,rawJson) = null();
...
HXLINE( 253)			HX_VARI( ::Array< ::String >,list) = ::CoolUtil_obj::listFromString(::sys::io::File_obj::getContent(HX_("modsList.txt",f1,ca,08,ac)));
HXLINE( 254)			HX_VARI( bool,foundTheTop) = false;
HXLINE( 255)			{
HXLINE( 255)				int _g = 0;
HXDLIN( 255)				while((_g < list->length)){
HXLINE( 255)					HX_VARI( ::String,i) = list->__get(_g);
HXDLIN( 255)					_g = (_g + 1);
HXLINE( 257)					HX_VARI( ::Array< ::String >,dat) = i.split(HX_("|",7c,00,00,00));
