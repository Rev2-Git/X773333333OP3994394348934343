...
HX_DEFINE_STACK_FRAME(_hx_pos_f9bd248e8c37eaa1_956_new,"__ASSET__OPENFL__assets_fonts_pixel_otf","new",0xd7ddf5a3,"__ASSET__OPENFL__assets_fonts_pixel_otf.new","ManifestResources.hx",956,0xf77aa668)

void __ASSET__OPENFL__assets_fonts_pixel_otf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f9bd248e8c37eaa1_956_new)
            	HX_STACK_THIS(this)
HXLINE( 956)
HXDLIN( 956)		this->_hx___fontPath = (::ManifestResources_obj::rootPath + HX_("assets/fonts/pixel.otf",a2,d3,8e,91));
HXDLIN( 956)		this->name = HX_("Pixel Arial 11 Bold",ae,17,c6,45);
HXDLIN( 956)		super::__construct(null());
            	}
