...
HX_DEFINE_STACK_FRAME(_hx_pos_a412f7bc953955ad_926_new,"__ASSET__assets_fonts_vcr_ttf","new",0xbb14ed97,"__ASSET__assets_fonts_vcr_ttf.new","ManifestResources.hx",926,0xf77aa668)

void __ASSET__assets_fonts_vcr_ttf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_a412f7bc953955ad_926_new)
            	HX_STACK_THIS(this)
HXLINE( 926)
HXDLIN( 926)		this->_hx___fontPath = (::ManifestResources_obj::rootPath + HX_("assets/fonts/vcr.ttf",46,38,26,7e));
HXDLIN( 926)		this->name = HX_("VCR OSD Mono",be,44,e4,b8);
HXDLIN( 926)		super::__construct(null());
            	}
