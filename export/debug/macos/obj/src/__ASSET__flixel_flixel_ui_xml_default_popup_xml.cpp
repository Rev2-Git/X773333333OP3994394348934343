...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ac29e94b65edc3_919_boot,"__ASSET__flixel_flixel_ui_xml_default_popup_xml","boot",0x10043a9d,"__ASSET__flixel_flixel_ui_xml_default_popup_xml.boot","ManifestResources.hx",919,0xf77aa668)
...
HXLINE(  34)
HXLINE(  35)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::resourceName);
...
{
{
            	HX_STACKFRAME(&_hx_pos_b2ac29e94b65edc3_919_boot)
HXDLIN( 919)		resourceName = HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_default_popup_xml",4a,b4,43,80);
            	}
}
