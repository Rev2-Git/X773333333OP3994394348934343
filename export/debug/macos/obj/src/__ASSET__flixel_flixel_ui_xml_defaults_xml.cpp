...
HX_LOCAL_STACK_FRAME(_hx_pos_f4cb54353879e95e_921_boot,"__ASSET__flixel_flixel_ui_xml_defaults_xml","boot",0xb3f88dd3,"__ASSET__flixel_flixel_ui_xml_defaults_xml.boot","ManifestResources.hx",921,0xf77aa668)
...
HXLINE(  34)
HXLINE(  35)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_xml_defaults_xml_obj::resourceName);
...
{
{
            	HX_STACKFRAME(&_hx_pos_f4cb54353879e95e_921_boot)
HXDLIN( 921)		resourceName = HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_defaults_xml",66,61,52,48);
            	}
}
