...
bool AtlasFrameMaker_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::FlxFramesCollection AtlasFrameMaker_obj::construct(::String key,::Array< ::String > _excludeArray, ::Dynamic __o_noAntialiasing){
            	...
            	HX_STACK_ARG(_excludeArray,"_excludeArray")
            	HX_STACK_ARG(noAntialiasing,"noAntialiasing")
HXLINE(  41)
HXLINE(  46)		HX_VARI( ::Array< ::Dynamic>,frameArray) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE(  48)			::String key3 = key1;
HXDLIN(  48)			if (::hx::IsNull( key3 )) {
HXLINE(  48)				key3 = HX_("",00,00,00,00);
            			}
HXDLIN(  48)			_hx_tmp1 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key3));
            		}
            		else {
...
HXLINE(  55)		HX_VARI(  ::Dynamic,animationData) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::Paths_obj::getTextFromFile(((HX_("images/",77,50,74,c1) + key) + HX_("/Animation.json",61,fc,54,44)),null()))->doParse();
HXLINE(  56)		HX_VARI(  ::Dynamic,atlasData) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::StringTools_obj::replace(::Paths_obj::getTextFromFile(((HX_("images/",77,50,74,c1) + key) + HX_("/spritemap.json",ae,2e,a7,76)),null()),HX_W(u"\ufeff",fe53,00b5),HX_("",00,00,00,00)))->doParse();
...
HXDLIN(  58)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = returnAsset;
HXLINE(  59)		HX_VARI(  ::animateatlas::displayobject::SpriteAnimationLibrary,ss) =  ::animateatlas::displayobject::SpriteAnimationLibrary_obj::__alloc( HX_CTX ,animationData,atlasData,graphic->bitmap);
HXLINE(  60)		HX_VARI(  ::animateatlas::displayobject::SpriteMovieClip,t) = ss->createAnimation(( (bool)(noAntialiasing) ),null());
...
HXLINE(  45)		HX_VARI(  ::flixel::graphics::frames::FlxFramesCollection,frameCollection) =  ::flixel::graphics::frames::FlxFramesCollection_obj::__alloc( HX_CTX ,graphic,::flixel::graphics::frames::FlxFrameCollectionType_obj::IMAGE_dyn(),null());
HXLINE(  69)		{
HXLINE(  69)			int _g = 0;
HXDLIN(  69)			while((_g < _excludeArray->length)){
HXLINE(  69)				HX_VARI( ::String,x) = _excludeArray->__get(_g);
HXDLIN(  69)				_g = (_g + 1);
...
HXLINE(  74)				HX_VARI_NAME( ::Array< ::Dynamic>,x1,"x") = frameArray->__get(_g1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(  74)				_g1 = (_g1 + 1);
HXLINE(  76)				{
HXLINE(  76)					int _g2 = 0;
HXDLIN(  76)					while((_g2 < x1->length)){
HXLINE(  76)						HX_VARI(  ::flixel::graphics::frames::FlxFrame,y) = x1->__get(_g2).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN(  76)						_g2 = (_g2 + 1);
...
HXLINE(  85)
HXLINE(  86)		HX_VARI(  ::openfl::geom::Rectangle,sizeInfo) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,null(),null());
HXLINE(  87)		t->set_currentLabel(animation);
HXLINE(  88)		HX_VARI( ::Array< ::Dynamic>,bitMapArray) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  89)		HX_VARI( ::Array< ::Dynamic>,daFramez) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  90)		HX_VARI( bool,firstPass) = true;
HXLINE(  91)		HX_VARI(  ::flixel::math::FlxBasePoint,frameSize) =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0);
HXLINE(  93)		{
HXLINE(  93)			int _g = t->getFrame(animation);
HXDLIN(  93)			int _g1 = t->get_numFrames();
HXDLIN(  93)			while((_g < _g1)){
HXLINE(  93)				_g = (_g + 1);
HXDLIN(  93)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN(  99)					HX_VARI_NAME(  ::openfl::display::BitmapData,bitmapShit1,"bitmapShit") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapShit,::Std_obj::_hx_int((sizeInfo->height + sizeInfo->y)),true,0);
...
HXDLIN( 112)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 114)				HX_VARI(  ::flixel::graphics::FlxGraphic,b) = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitMapArray->__get(i1).StaticCast<  ::openfl::display::BitmapData >(),null(),null(),null());
HXLINE( 115)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,theFrame) =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,b,null(),null(),null());
HXLINE( 116)				theFrame->parent = b;
HXLINE( 117)				theFrame->name = (animation + i1);
HXLINE( 118)				{
HXLINE( 118)					 ::flixel::math::FlxBasePoint this1 = theFrame->sourceSize;
HXDLIN( 118)					Float y1 = frameSize->y;
HXDLIN( 118)					this1->set_x(frameSize->x);
HXDLIN( 118)					this1->set_y(y1);
            				}
HXLINE( 119)				theFrame->set_frame( ::flixel::math::FlxRect_obj::__alloc( HX_CTX ,0,0,bitMapArray->__get(i1).StaticCast<  ::openfl::display::BitmapData >()->width,bitMapArray->__get(i1).StaticCast<  ::openfl::display::BitmapData >()->height));
