...
HXLINE(  72)
HXLINE(  73)		HX_VARI( ::Array< ::String >,out) = ::Array_obj< ::String >::__new();
HXLINE(  75)		{
HXLINE(  75)			HX_VARI(  ::Dynamic,name) = this->_symbolData->keys();
HXDLIN(  75)			while(( (bool)(name->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  75)				HX_VARI_NAME( ::String,name1,"name") = ( (::String)(name->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HX_DEFINE_DYNAMIC_FUNC1(SpriteAnimationLibrary_obj,hasSymbol,return )
 ...
 ::animateatlas::displayobject::SpriteSymbol SpriteAnimationLibrary_obj::getSymbol(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 109)
HXLINE( 110)		HX_VARI( ::Array< ::Dynamic>,pool) = this->getSymbolPool(name);
HXLINE( 111)		if ((pool->length == 0)) {
HXLINE( 112)			 ::Dynamic symbol = this->getSymbolData(name);
HXDLIN( 112)			HX_VARI_NAME(  ::animateatlas::displayobject::SpriteSymbol,symbol1,"symbol") =  ::animateatlas::displayobject::SpriteSymbol_obj::__alloc( HX_CTX ,symbol,::hx::ObjectPtr<OBJ_>(this),this->_texture);
...
HXLINE( 122)		HX_VARI( ::Array< ::Dynamic>,pool) = this->getSymbolPool(symbol->get_symbolName());
...
::Array< ::Dynamic> SpriteAnimationLibrary_obj::getSymbolPool(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 127)
HXLINE( 128)		HX_VARI( ::Array< ::Dynamic>,pool) = ( (::Array< ::Dynamic>)(this->_symbolPool->get(name)) );
...
void SpriteAnimationLibrary_obj::parseAnimationData( ::Dynamic data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 138)
HXLINE( 139)		HX_VARI(  ::Dynamic,metaData) = data->__Field(HX_("metadata",6f,e7,19,40),::hx::paccDynamic);
...
HXLINE( 150)		HX_VARI( ::Array< ::Dynamic>,symbols) = ( (::Array< ::Dynamic>)( ::Dynamic(data->__Field(HX_("SYMBOL_DICTIONARY",5d,08,42,4b),::hx::paccDynamic))->__Field(HX_("Symbols",fb,e5,6c,e0),::hx::paccDynamic)) );
HXLINE( 151)		{
HXLINE( 151)			int _g = 0;
HXDLIN( 151)			while((_g < symbols->length)){
HXLINE( 151)				HX_VARI(  ::Dynamic,symbolData) = symbols->__get(_g);
HXDLIN( 151)				_g = (_g + 1);
HXLINE( 152)				{
...
HXLINE( 156)		HX_VARI(  ::Dynamic,defaultSymbolData) = this->preprocessSymbolData(data->__Field(HX_("ANIMATION",e4,5e,8d,46),::hx::paccDynamic));
...
HX_DEFINE_DYNAMIC_FUNC1(SpriteAnimationLibrary_obj,parseAnimationData,(void))
 ...
 ::Dynamic SpriteAnimationLibrary_obj::preprocessSymbolData( ::Dynamic symbolData){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(symbolData,"symbolData")
HXLINE( 169)
HXLINE( 170)		HX_VARI(  ::Dynamic,timeLineData) = symbolData->__Field(HX_("TIMELINE",81,fe,c0,56),::hx::paccDynamic);
HXLINE( 171)		HX_VARI( ::Array< ::Dynamic>,layerDates) = ( (::Array< ::Dynamic>)(timeLineData->__Field(HX_("LAYERS",82,c1,33,0b),::hx::paccDynamic)) );
...
HXLINE( 184)				HX_VARI(  ::Dynamic,layerData) = layerDates->__get(_g);
HXDLIN( 184)				_g = (_g + 1);
HXLINE( 185)				HX_VARI( ::Array< ::Dynamic>,frames) = ( (::Array< ::Dynamic>)(layerData->__Field(HX_("Frames",c6,23,1a,e1),::hx::paccDynamic)) );
HXLINE( 187)				{
HXLINE( 187)					int _g1 = 0;
HXDLIN( 187)					while((_g1 < frames->length)){
HXLINE( 187)						HX_VARI(  ::Dynamic,frame) = frames->__get(_g1);
HXDLIN( 187)						_g1 = (_g1 + 1);
HXLINE( 188)						HX_VARI( ::Array< ::Dynamic>,elements) = ( (::Array< ::Dynamic>)(frame->__Field(HX_("elements",37,36,c4,83),::hx::paccDynamic)) );
HXLINE( 189)						{
HXLINE( 189)							int _g2 = 0;
HXDLIN( 189)							int _g3 = elements->length;
HXDLIN( 189)							while((_g2 < _g3)){
HXLINE( 189)								_g2 = (_g2 + 1);
HXDLIN( 189)								HX_VARI( int,e) = (_g2 - 1);
HXLINE( 190)								HX_VARI(  ::Dynamic,element) = elements->__get(e);
...
HXLINE( 218)				HX_VARI(  ::Dynamic,s) = _g1->__get(_g);
HXDLIN( 218)				_g = (_g + 1);
