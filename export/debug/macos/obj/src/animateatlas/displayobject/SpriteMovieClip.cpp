...
void SpriteMovieClip_obj::update(int dt){
            	...
            	HX_STACK_ARG(dt,"dt")
HXLINE(  30)
HXLINE(  32)		HX_VARI( Float,frameDuration) = (( (Float)(1000) ) / this->get_framerate());
...
HXLINE(  36)			 ::animateatlas::displayobject::SpriteMovieClip _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  36)			_hx_tmp1->frameElapsed = (_hx_tmp1->frameElapsed - frameDuration);
HXLINE(  37)			this->symbol->nextFrame();
            		}
HXLINE(  39)		while((this->frameElapsed < -(frameDuration))){
HXLINE(  40)			 ::animateatlas::displayobject::SpriteMovieClip _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  40)			_hx_tmp2->frameElapsed = (_hx_tmp2->frameElapsed + frameDuration);
