...
HXLINE(  75)				HX_VARI(  ::Dynamic,layer) = _g1->__get(_g);
HXDLIN(  75)				_g = (_g + 1);
HXLINE(  76)				if (::hx::IsNotNull( layer->__Field(HX_("FrameMap",8f,a0,a2,f6),::hx::paccDynamic) )) {
HXLINE(  77)					return;
            				}
HXLINE(  79)				HX_VARI(  ::haxe::ds::IntMap,map) =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  81)				{
HXLINE(  81)					int _g2 = 0;
HXDLIN(  81)					int _g3 = ( (::Array< ::Dynamic>)(layer->__Field(HX_("Frames",c6,23,1a,e1),::hx::paccDynamic)) )->length;
HXDLIN(  81)					while((_g2 < _g3)){
HXLINE(  81)						_g2 = (_g2 + 1);
HXDLIN(  81)						HX_VARI( int,i) = (_g2 - 1);
HXLINE(  82)						HX_VARI(  ::Dynamic,frame) =  ::Dynamic(layer->__Field(HX_("Frames",c6,23,1a,e1),::hx::paccDynamic))->__GetItem(i);
HXLINE(  83)						{
HXLINE(  83)							int _g4 = 0;
HXDLIN(  83)							int _g5 = ( (int)(frame->__Field(HX_("duration",54,0f,8e,14),::hx::paccDynamic)) );
HXDLIN(  83)							while((_g4 < _g5)){
HXLINE(  83)								_g4 = (_g4 + 1);
HXDLIN(  83)								HX_VARI( int,j) = (_g4 - 1);
...
HXLINE( 122)				_g = (_g + 1);
HXDLIN( 122)				HX_VARI( int,l) = (_g - 1);
HXLINE( 123)				HX_VARI(  ::openfl::display::Sprite,layer) = this->getLayer(l);
HXLINE( 124)				HX_VARI( int,numElements) = layer->get_numChildren();
HXLINE( 126)				{
HXLINE( 126)					int _g2 = 0;
HXDLIN( 126)					int _g3 = numElements;
HXDLIN( 126)					while((_g2 < _g3)){
HXLINE( 126)						_g2 = (_g2 + 1);
HXDLIN( 126)						HX_VARI( int,e) = (_g2 - 1);
...
HXLINE( 141)
HXLINE( 142)		HX_VARI(  ::openfl::display::Sprite,layer) = this->getLayer(layerIndex);
HXLINE( 143)		HX_VARI(  ::Dynamic,frameData) = this->getFrameData(layerIndex,this->_currentFrame);
HXLINE( 144)		HX_VAR( ::Array< ::Dynamic>,elements);
...
HXLINE( 145)		HX_VAR( int,numElements);
...
HXLINE( 146)				_g = (_g + 1);
HXDLIN( 146)				HX_VARI( int,i) = (_g - 1);
HXLINE( 147)				HX_VARI(  ::Dynamic,elementData) = elements->__get(i)->__Field(HX_("SYMBOL_Instance",bc,4c,fe,3f),::hx::paccDynamic);
HXLINE( 149)				if (::hx::IsNull( elementData )) {
HXLINE( 150)					continue;
            				}
HXLINE( 154)				HX_VAR(  ::animateatlas::displayobject::SpriteSymbol,oldSymbol);
...
HXLINE( 159)				HX_VARI(  ::animateatlas::displayobject::SpriteSymbol,newSymbol) = null();
HXLINE( 161)				HX_VARI( ::String,symbolName) = ( (::String)(elementData->__Field(HX_("SYMBOL_name",d2,13,ee,07),::hx::paccDynamic)) );
...
HXLINE( 190)					HX_VARI( int,firstFrame) = ( (int)(elementData->__Field(HX_("firstFrame",dd,c1,61,44),::hx::paccDynamic)) );
HXLINE( 191)					HX_VARI( int,frameAge) = ::Std_obj::_hx_int(( (Float)((this->_currentFrame - ( (int)(frameData->__Field(HX_("index",12,9b,14,be),::hx::paccDynamic)) ))) ));
...
HXLINE( 204)		HX_VARI( int,numObsoleteSymbols) = (layer->get_numChildren() - numElements);
HXLINE( 206)		{
HXLINE( 206)			int _g3 = 0;
HXDLIN( 206)			int _g4 = numObsoleteSymbols;
HXDLIN( 206)			while((_g3 < _g4)){
HXLINE( 206)				_g3 = (_g3 + 1);
HXDLIN( 206)				HX_VARI_NAME( int,i1,"i") = (_g3 - 1);
HXLINE( 207)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 208)					HX_VARI_NAME(  ::animateatlas::displayobject::SpriteSymbol,oldSymbol1,"oldSymbol") = ::hx::TCast<  ::animateatlas::displayobject::SpriteSymbol >::cast(layer->removeChildAt(numElements));
HXLINE( 209)					if (::hx::IsNotNull( oldSymbol1 )) {
HXLINE( 210)						this->_library->putSymbol(oldSymbol1);
            					}
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
...
HXLINE( 225)				_g = (_g + 1);
HXDLIN( 225)				HX_VARI( int,i) = (_g - 1);
HXLINE( 226)				HX_VARI(  ::openfl::display::Sprite,layer) =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
...
HXLINE( 237)			HX_VARI(  ::Dynamic,spriteData) = this->_library->getSpriteData(( (::String)((data->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic) + HX_("",00,00,00,00))) ));
...
HXLINE( 245)				HX_VARI(  ::openfl::display::BitmapData,clippedTexture) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,( (int)(spriteData->__Field(HX_("w",77,00,00,00),::hx::paccDynamic)) ),( (int)(spriteData->__Field(HX_("h",68,00,00,00),::hx::paccDynamic)) ),null(),null());
...
void SpriteSymbol_obj::setFilterData( ::Dynamic data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 271)
HXLINE( 272)		HX_VAR(  ::openfl::filters::BlurFilter,blur);
HXLINE( 273)		HX_VAR(  ::openfl::filters::GlowFilter,glow);
...
HXLINE( 307)			Float _hx_tmp6 = ::animateatlas::displayobject::SpriteSymbol_obj::sMatrix->b;
HXDLIN( 307)			_hx_tmp4 = (_hx_tmp6 != this->get_transform()->get_matrix()->b);
            		}
            		else {
HXLINE( 307)			_hx_tmp4 = true;
            		}
HXDLIN( 307)		if (!(_hx_tmp4)) {
HXLINE( 307)			Float _hx_tmp7 = ::animateatlas::displayobject::SpriteSymbol_obj::sMatrix->c;
HXDLIN( 307)			_hx_tmp3 = (_hx_tmp7 != this->get_transform()->get_matrix()->c);
            		}
            		else {
HXLINE( 307)			_hx_tmp3 = true;
            		}
HXDLIN( 307)		if (!(_hx_tmp3)) {
HXLINE( 307)			Float _hx_tmp8 = ::animateatlas::displayobject::SpriteSymbol_obj::sMatrix->d;
HXDLIN( 307)			_hx_tmp2 = (_hx_tmp8 != this->get_transform()->get_matrix()->d);
            		}
            		else {
HXLINE( 307)			_hx_tmp2 = true;
            		}
HXDLIN( 307)		if (!(_hx_tmp2)) {
HXLINE( 308)			Float _hx_tmp9 = ::animateatlas::displayobject::SpriteSymbol_obj::sMatrix->tx;
HXLINE( 307)			_hx_tmp1 = (_hx_tmp9 != this->get_transform()->get_matrix()->tx);
            		}
            		else {
HXLINE( 307)			_hx_tmp1 = true;
            		}
HXDLIN( 307)		if (!(_hx_tmp1)) {
HXLINE( 308)			Float _hx_tmp10 = ::animateatlas::displayobject::SpriteSymbol_obj::sMatrix->ty;
HXLINE( 307)			_hx_tmp = (_hx_tmp10 != this->get_transform()->get_matrix()->ty);
            		}
            		else {
HXLINE( 307)			_hx_tmp = true;
            		}
HXDLIN( 307)		if (_hx_tmp) {
HXLINE( 309)			 ::openfl::geom::Transform _hx_tmp11 = this->get_transform();
HXDLIN( 309)			_hx_tmp11->set_matrix(::animateatlas::displayobject::SpriteSymbol_obj::sMatrix->clone());
            		}
            	}
...
void SpriteSymbol_obj::setColor( ::Dynamic data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 312)
HXLINE( 313)		HX_VARI(  ::openfl::geom::ColorTransform,newTransform) =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
...
int SpriteSymbol_obj::getNumFrames(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 343)
HXLINE( 344)		HX_VARI( int,numFrames) = 0;
HXLINE( 346)		{
HXLINE( 346)			int _g = 0;
HXDLIN( 346)			int _g1 = this->_numLayers;
HXDLIN( 346)			while((_g < _g1)){
HXLINE( 346)				_g = (_g + 1);
HXDLIN( 346)				HX_VARI( int,i) = (_g - 1);
HXLINE( 347)				HX_VARI(  ::Dynamic,layer) = this->getLayerData(i);
HXLINE( 348)				HX_VAR( ::Array< ::Dynamic>,frameDates);
...
HXLINE( 349)				HX_VAR( int,numFrameDates);
...
HXLINE( 350)				HX_VAR( int,layerNumFrames);
...
HXDLIN( 352)					int _g3 = numFrameDates;
HXDLIN( 352)					while((_g2 < _g3)){
HXLINE( 352)						_g2 = (_g2 + 1);
HXDLIN( 352)						HX_VARI( int,j) = (_g2 - 1);
...
::Array< ::Dynamic> SpriteSymbol_obj::_getFrameLabels(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 364)
HXLINE( 365)		HX_VARI( ::Array< ::Dynamic>,labels) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 367)		{
HXLINE( 367)			int _g = 0;
HXDLIN( 367)			int _g1 = this->_numLayers;
HXDLIN( 367)			while((_g < _g1)){
HXLINE( 367)				_g = (_g + 1);
HXDLIN( 367)				HX_VARI( int,i) = (_g - 1);
HXLINE( 368)				HX_VARI(  ::Dynamic,layer) = this->getLayerData(i);
HXLINE( 369)				HX_VAR( ::Array< ::Dynamic>,frameDates);
...
HXLINE( 370)				HX_VAR( int,numFrameDates);
...
HXDLIN( 372)					int _g3 = numFrameDates;
HXDLIN( 372)					while((_g2 < _g3)){
HXLINE( 372)						_g2 = (_g2 + 1);
HXDLIN( 372)						HX_VARI( int,j) = (_g2 - 1);
HXLINE( 373)						HX_VARI(  ::Dynamic,frameData) = frameDates->__get(j);
...
int SpriteSymbol_obj::sortLabels( ::openfl::display::FrameLabel i1, ::openfl::display::FrameLabel i2){
            	...
            	HX_STACK_ARG(i2,"i2")
HXLINE( 389)
HXLINE( 390)		HX_VARI( int,f1) = i1->frame;
HXLINE( 391)		HX_VARI( int,f2) = i2->frame;
HXLINE( 392)		if ((f1 < f2)) {
HXLINE( 393)			return -1;
            		}
            		else {
...
::String SpriteSymbol_obj::getNextLabel(::String afterLabel){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(afterLabel,"afterLabel")
HXLINE( 410)
HXLINE( 411)		HX_VARI( int,numLabels) = this->_frameLabels->length;
...
HXDLIN( 412)		HX_VARI_NAME( int,startFrame1,"startFrame") = this->getFrame(startFrame);
HXLINE( 414)		{
HXLINE( 414)			int _g = 0;
...
HXLINE( 415)				HX_VARI(  ::openfl::display::FrameLabel,label) = this->_frameLabels->__get(i).StaticCast<  ::openfl::display::FrameLabel >();
...
::String SpriteSymbol_obj::get_currentLabel(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 424)
HXLINE( 425)		HX_VARI( int,numLabels) = this->_frameLabels->length;
HXLINE( 426)		HX_VAR(  ::openfl::display::FrameLabel,highestLabel);
...
HXLINE( 428)				_g = (_g + 1);
HXDLIN( 428)				HX_VARI( int,i) = (_g - 1);
HXLINE( 429)				HX_VARI(  ::openfl::display::FrameLabel,label) = this->_frameLabels->__get(i).StaticCast<  ::openfl::display::FrameLabel >();
...
HXLINE( 441)
HXLINE( 442)		HX_VARI( int,numLabels) = this->_frameLabels->length;
HXLINE( 443)		{
HXLINE( 443)			int _g = 0;
HXDLIN( 443)			int _g1 = numLabels;
HXDLIN( 443)			while((_g < _g1)){
HXLINE( 443)				_g = (_g + 1);
HXDLIN( 443)				HX_VARI( int,i) = (_g - 1);
HXLINE( 444)				HX_VARI(  ::openfl::display::FrameLabel,frameLabel) = this->_frameLabels->__get(i).StaticCast<  ::openfl::display::FrameLabel >();
...
HXLINE( 517)
HXLINE( 518)		HX_VARI(  ::Dynamic,layer) = this->getLayerData(layerIndex);
