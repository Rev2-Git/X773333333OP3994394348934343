...
HXLINE(  53)		HX_VARI(  ::Dynamic,result) = luaL_dofile(this->lua,script);
HXLINE(  54)		HX_VARI( ::String,resultStr) = linc::lua::tostring(this->lua,( (int)(result) ));
...
HXLINE(  90)
HXLINE(  91)				HX_VARI( ::Array< ::String >,killMe) = variable.split(HX_(".",2e,00,00,00));
HXLINE(  92)				if ((killMe->length > 1)) {
HXLINE(  93)					HX_VARI(  ::Dynamic,coverMeInPiss) = ::Reflect_obj::getProperty(::editors::EditorPlayState_obj::instance,killMe->__get(0));
HXLINE(  95)					{
HXLINE(  95)						int _g = 1;
...
HXLINE( 102)
HXLINE( 103)				HX_VARI( ::Array< ::String >,killMe) = variable.split(HX_(".",2e,00,00,00));
HXLINE( 104)				if ((killMe->length > 1)) {
HXLINE( 105)					HX_VARI(  ::Dynamic,coverMeInPiss) = ::Reflect_obj::getProperty(::editors::EditorPlayState_obj::instance,killMe->__get(0));
HXLINE( 107)					{
HXLINE( 107)						int _g = 1;
HXDLIN( 107)						int _g1 = (killMe->length - 1);
HXDLIN( 107)						while((_g < _g1)){
HXLINE( 107)							_g = (_g + 1);
HXDLIN( 107)							HX_VARI( int,i) = (_g - 1);
...
HXLINE( 119)				HX_VARI(  ::Dynamic,leArray) = ::Reflect_obj::getProperty(::editors::EditorPlayState_obj::instance,obj)->__GetItem(index);
...
HXLINE( 133)				HX_VARI(  ::Dynamic,leArray) = ::Reflect_obj::getProperty(::editors::EditorPlayState_obj::instance,obj)->__GetItem(index);
...
HXLINE( 143)					HX_VARI(  ::Dynamic,sex) =  ::Dynamic(::Reflect_obj::getProperty(::editors::EditorPlayState_obj::instance,obj)->__Field(HX_("members",d9,2c,70,1a),::hx::paccDynamic))->__GetItem(index);
...
HXLINE( 159)		{
            		...
            		int y = __o_y.Default(0);
            				...
            				HX_STACK_ARG(y,"y")
HXLINE( 159)
HXLINE( 160)				HX_VARI(  ::flixel::FlxSprite,poop) = ( ( ::flixel::FlxSprite)(::Reflect_obj::getProperty(::editors::EditorPlayState_obj::instance,obj)) );
...
HXLINE( 167)		{
            			...
            			void _hx_run(::String obj,Float x,Float y){
            				...
            				HX_STACK_ARG(y,"y")
HXLINE( 167)
HXLINE( 168)				HX_VARI(  ::flixel::FlxSprite,poop) = ( ( ::flixel::FlxSprite)(::Reflect_obj::getProperty(::editors::EditorPlayState_obj::instance,obj)) );
...
HXLINE( 175)		{
            			...
            			void _hx_run(::String obj){
            				...
            				HX_STACK_ARG(obj,"obj")
HXLINE( 175)
HXLINE( 176)				HX_VARI(  ::flixel::FlxSprite,poop) = ( ( ::flixel::FlxSprite)(::Reflect_obj::getProperty(::editors::EditorPlayState_obj::instance,obj)) );
...
HXLINE( 197)				HX_VARI(  ::Dynamic,arg) = args->__get(_g);
HXDLIN( 197)				_g = (_g + 1);
HXLINE( 198)				::llua::Convert_obj::toLua(this->lua,arg);
            			}
            		}
HXLINE( 201)		HX_VARI(  ::Dynamic,result) = lua_pcall(this->lua,args->get_length(),1,0);
...
HXLINE( 207)				HX_VARI( ::String,error) = linc::lua::tostring(this->lua,-1);
...
HXLINE( 214)					ret = ::llua::Convert_obj::toHaxeObj(l,v);
            				...
            				default:{
HXLINE( 214)					ret = null();
HXDLIN( 214)					if (::llua::Convert_obj::enableUnsupportedTraces) {
HXLINE( 214)						::haxe::Log_obj::trace((HX_("return value not supported\n",48,41,fb,c8) + v),::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),127,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            					}
            				}
            			}
HXDLIN( 214)			HX_VARI(  ::Dynamic,conv) = ret;
...
bool EditorLua_obj::resultIsAllowed( cpp::Reference<lua_State> leLua, ::Dynamic leResult){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(leLua,"leLua")
            	HX_STACK_ARG(leResult,"leResult")
HXLINE( 222)
...
bool EditorLua_obj::getBool(::String variable){
            	...
            	HX_STACK_ARG(variable,"variable")
HXLINE( 243)
HXLINE( 244)		HX_VARI( ::String,result) = null();
