...
HXDLIN(  46)		HX_VARI_NAME(  ::flixel::FlxSprite,bg1,"bg") = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE(  47)		{
...
HXLINE(  56)				HX_VARI(  ::Alphabet,leText) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(90) ),( (Float)(320) ),this->options->__get(i),true);
...
HXLINE(  64)		HX_VARI(  ::flixel::FlxSprite,textBG) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(::flixel::FlxG_obj::height - 42),null())->makeGraphic(::flixel::FlxG_obj::width,42,-16777216,null(),null());
...
HXLINE(  73)				HX_VARI( ::String,folder) = _g3->__get(_g2);
HXDLIN(  73)				_g2 = (_g2 + 1);
HXLINE(  75)				this->directories->push(folder);
            			}
            		}
HXLINE(  78)		HX_VARI( int,found) = this->directories->indexOf(::Paths_obj::currentModDirectory,null());
...
HXLINE( 136)		HX_VARI( int,bullShit) = 0;
HXLINE( 137)		{
HXLINE( 137)			int _g = 0;
HXDLIN( 137)			::Array< ::Dynamic> _g1 = this->grpTexts->members;
HXDLIN( 137)			while((_g < _g1->length)){
HXLINE( 137)				HX_VARI(  ::Alphabet,item) = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 137)				_g = (_g + 1);
