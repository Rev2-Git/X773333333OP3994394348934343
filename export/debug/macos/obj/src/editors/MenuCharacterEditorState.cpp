...
HXLINE(  57)		{
HXLINE(  58)			{
HXLINE(  59)				HX_VARI(  ::MenuCharacter,weekCharacterThing) =  ::MenuCharacter_obj::__alloc( HX_CTX ,((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.25)) - ( (Float)(150) )),this->defaultCharacters->__get(0));
...
HXLINE(  58)			{
HXLINE(  59)				HX_VARI_NAME(  ::MenuCharacter,weekCharacterThing1,"weekCharacterThing") =  ::MenuCharacter_obj::__alloc( HX_CTX ,(((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.25)) * ( (Float)(2) )) - ( (Float)(150) )),this->defaultCharacters->__get(1));
...
HXLINE(  58)			{
HXLINE(  59)				HX_VARI_NAME(  ::MenuCharacter,weekCharacterThing2,"weekCharacterThing") =  ::MenuCharacter_obj::__alloc( HX_CTX ,(((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.25)) * ( (Float)(3) )) - ( (Float)(150) )),this->defaultCharacters->__get(2));
...
HXLINE(  73)		HX_VARI(  ::flixel::text::FlxText,tipText) =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,540,::flixel::FlxG_obj::width,HX_("Arrow Keys - Change Offset (Hold shift for 10x speed)\n\t\t\t\nSpace - Play \"Start Press\" animation (Boyfriend Character Type)",67,59,5a,b5),16,null());
...
HXLINE(  91)		HX_VARI( ::Array< ::Dynamic>,tabs) = ::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 102)		HX_VARI_NAME( ::Array< ::Dynamic>,tabs1,"tabs") = ::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 113)		HX_VARI(  ::flixel::ui::FlxButton,loadButton) =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,0,480,HX_("Load Character",2f,51,49,37), ::Dynamic(new _hx_Closure_0(_gthis)));
HXLINE( 116)		{
...
HXLINE( 116)				int _hx_tmp7 = ::flixel::FlxG_obj::width;
HXDLIN( 116)				loadButton->set_x(((( (Float)(_hx_tmp7) ) - loadButton->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 116)			bool _hx_tmp8;
HXDLIN( 116)			if ((axes != 16)) {
HXLINE( 116)				_hx_tmp8 = (axes == 17);
            			}
            			else {
HXLINE( 116)				_hx_tmp8 = true;
            			}
HXDLIN( 116)			if (_hx_tmp8) {
HXLINE( 116)				int _hx_tmp9 = ::flixel::FlxG_obj::height;
HXDLIN( 116)				loadButton->set_y(((( (Float)(_hx_tmp9) ) - loadButton->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 117)		loadButton->set_x((loadButton->x - ( (Float)(60) )));
HXLINE( 118)		this->add(loadButton);
HXLINE( 120)		HX_VARI(  ::flixel::ui::FlxButton,saveButton) =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,0,480,HX_("Save Character",06,25,12,9f), ::Dynamic(new _hx_Closure_1(_gthis)));
HXLINE( 123)		{
HXLINE( 123)			int axes1 = 1;
HXDLIN( 123)			bool _hx_tmp10;
HXDLIN( 123)			if ((axes1 != 1)) {
HXLINE( 123)				_hx_tmp10 = (axes1 == 17);
            			}
            			else {
HXLINE( 123)				_hx_tmp10 = true;
            			}
HXDLIN( 123)			if (_hx_tmp10) {
HXLINE( 123)				int _hx_tmp11 = ::flixel::FlxG_obj::width;
HXDLIN( 123)				saveButton->set_x(((( (Float)(_hx_tmp11) ) - saveButton->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 123)			bool _hx_tmp12;
HXDLIN( 123)			if ((axes1 != 16)) {
HXLINE( 123)				_hx_tmp12 = (axes1 == 17);
            			}
            			else {
HXLINE( 123)				_hx_tmp12 = true;
            			}
HXDLIN( 123)			if (_hx_tmp12) {
HXLINE( 123)				int _hx_tmp13 = ::flixel::FlxG_obj::height;
HXDLIN( 123)				saveButton->set_y(((( (Float)(_hx_tmp13) ) - saveButton->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 133)		HX_VARI(  ::flixel::addons::ui::FlxUI,tab_group) =  ::flixel::addons::ui::FlxUI_obj::__alloc( HX_CTX ,null(),this->UI_typebox,null(),null(),null(),null());
...
HXLINE( 169)		HX_VARI(  ::flixel::addons::ui::FlxUI,tab_group) =  ::flixel::addons::ui::FlxUI_obj::__alloc( HX_CTX ,null(),this->UI_mainbox,null(),null(),null(),null());
...
HXLINE( 186)		HX_VARI(  ::flixel::ui::FlxButton,reloadImageButton) =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,140,(this->confirmInputText->y + 30),HX_("Reload Char",fd,9c,14,46), ::Dynamic(new _hx_Closure_1(_gthis)));
...
HXLINE( 192)		HX_VARI(  ::flixel::text::FlxText,confirmDescText) =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,10,(this->confirmInputText->y - ( (Float)(18) )),0,HX_("Start Press animation on the .XML:",f8,8c,5f,fb),null(),null());
...
HXLINE( 224)		{
HXLINE( 224)			{
HXLINE( 225)				HX_VARI_NAME(  ::MenuCharacter,_hx_char,"char") = Dynamic( this->grpWeekCharacters->members->__get(0)).StaticCast<  ::MenuCharacter >();
...
HXLINE( 224)			{
HXLINE( 225)				HX_VARI_NAME(  ::MenuCharacter,char1,"char") = Dynamic( this->grpWeekCharacters->members->__get(1)).StaticCast<  ::MenuCharacter >();
...
HXLINE( 224)			{
HXLINE( 225)				HX_VARI_NAME(  ::MenuCharacter,char2,"char") = Dynamic( this->grpWeekCharacters->members->__get(2)).StaticCast<  ::MenuCharacter >();
...
void MenuCharacterEditorState_obj::reloadSelectedCharacter(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 233)
HXLINE( 234)		HX_VARI_NAME(  ::MenuCharacter,_hx_char,"char") = Dynamic( this->grpWeekCharacters->members->__get(this->curTypeSelected)).StaticCast<  ::MenuCharacter >();
...
HXLINE( 262)				_hx_tmp1 = ::Std_obj::isOfType(sender,::hx::ClassOf< ::flixel::addons::ui::FlxUINumericStepper >());
            			}
            			else {
...
HXLINE( 270)
HXLINE( 271)		HX_VARI( bool,blockInput) = false;
HXLINE( 272)		{
HXLINE( 272)			int _g = 0;
HXDLIN( 272)			::Array< ::Dynamic> _g1 = this->blockPressWhileTypingOn;
HXDLIN( 272)			while((_g < _g1->length)){
HXLINE( 272)				HX_VARI(  ::flixel::addons::ui::FlxUIInputText,inputText) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIInputText >();
HXDLIN( 272)				_g = (_g + 1);
...
HXDLIN( 288)			if (_this1->keyManager->checkStatusUnsafe(27,_this1->status)) {
...
HXLINE( 293)			HX_VARI( int,shiftMult) = 1;
HXLINE( 294)			 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 294)			if (_this2->keyManager->checkStatusUnsafe(16,_this2->status)) {
...
HXDLIN( 296)			if (_this3->keyManager->checkStatusUnsafe(37,_this3->status)) {
...
HXDLIN( 297)				base[_hx_tmp1] = (base->__get(_hx_tmp1) + shiftMult);
...
HXDLIN( 300)			if (_this4->keyManager->checkStatusUnsafe(39,_this4->status)) {
HXLINE( 301)				::Array< int > base1 = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 301)				int _hx_tmp2 = 0;
HXDLIN( 301)				base1[_hx_tmp2] = (base1->__get(_hx_tmp2) - shiftMult);
...
HXDLIN( 304)			if (_this5->keyManager->checkStatusUnsafe(38,_this5->status)) {
HXLINE( 305)				::Array< int > base2 = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 305)				int _hx_tmp3 = 1;
HXDLIN( 305)				base2[_hx_tmp3] = (base2->__get(_hx_tmp3) + shiftMult);
HXLINE( 306)				this->updateOffset();
            			}
HXLINE( 308)			 ::flixel::input::keyboard::FlxKeyList _this6 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 308)			if (_this6->keyManager->checkStatusUnsafe(40,_this6->status)) {
HXLINE( 309)				::Array< int > base3 = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 309)				int _hx_tmp4 = 1;
HXDLIN( 309)				base3[_hx_tmp4] = (base3->__get(_hx_tmp4) - shiftMult);
HXLINE( 310)				this->updateOffset();
            			}
HXLINE( 313)			bool _hx_tmp5;
HXDLIN( 313)			 ::flixel::input::keyboard::FlxKeyList _this7 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 313)			if (_this7->keyManager->checkStatusUnsafe(32,_this7->status)) {
HXLINE( 313)				_hx_tmp5 = (this->curTypeSelected == 1);
            			}
            			else {
...
HXLINE( 318)		HX_VARI_NAME(  ::MenuCharacter,_hx_char,"char") = Dynamic( this->grpWeekCharacters->members->__get(1)).StaticCast<  ::MenuCharacter >();
HXLINE( 319)		bool _hx_tmp6;
HXDLIN( 319)		bool _hx_tmp7;
HXDLIN( 319)		if (::hx::IsNotNull( _hx_char->animation->_curAnim )) {
HXLINE( 319)			_hx_tmp7 = (_hx_char->animation->_curAnim->name == HX_("confirm",00,9d,39,10));
            		}
            		else {
HXLINE( 319)			_hx_tmp7 = false;
            		}
HXDLIN( 319)		if (_hx_tmp7) {
HXLINE( 319)			_hx_tmp6 = _hx_char->animation->_curAnim->finished;
            		}
            		else {
...
void MenuCharacterEditorState_obj::updateOffset(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 326)
HXLINE( 327)		HX_VARI_NAME(  ::MenuCharacter,_hx_char,"char") = Dynamic( this->grpWeekCharacters->members->__get(this->curTypeSelected)).StaticCast<  ::MenuCharacter >();
HXLINE( 328)		{
...
void MenuCharacterEditorState_obj::loadCharacter(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 333)
HXLINE( 334)		HX_VARI(  ::openfl::net::FileFilter,jsonFilter) =  ::openfl::net::FileFilter_obj::__alloc( HX_CTX ,HX_("JSON",28,0a,29,31),HX_("json",28,42,68,46),null());
...
HXLINE( 349)		HX_VARI( ::String,fullPath) = null();
...
HXLINE( 354)			HX_VARI( ::String,rawJson) = ::sys::io::File_obj::getContent(fullPath);
HXLINE( 355)			if (::hx::IsNotNull( rawJson )) {
HXLINE( 356)				HX_VARI(  ::Dynamic,loadedChar) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
...
HXDLIN( 359)					HX_VARI_NAME( ::String,cutName1,"cutName") = cutName.substr(0,(this->_file->get_name().length - 5));
...
HXDLIN( 404)		HX_VARI( ::String,data) = ::haxe::format::JsonPrinter_obj::print(this->characterFile,replacer,HX_("\t",09,00,00,00));
HXLINE( 405)		if ((data.length > 0)) {
HXLINE( 407)			HX_VARI( ::Array< ::String >,splittedImage) = ::StringTools_obj::trim(this->imageInputText->text).split(HX_("_",5f,00,00,00));
HXLINE( 408)			HX_VARI( ::String,characterName) = ::StringTools_obj::replace(splittedImage->__get((splittedImage->length - 1)).toLowerCase(),HX_(" ",20,00,00,00),HX_("",00,00,00,00));
...
HXLINE( 424)		::flixel::FlxG_obj::log->advanced(HX_("Successfully saved file.",c0,0d,09,f4),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,null());
            	}
...
HXLINE( 447)		::flixel::FlxG_obj::log->advanced(HX_("Problem saving file",41,4c,cd,8e),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            	}
