...
void WeekEditorState_obj::__construct( ::Dynamic weekFile){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(weekFile,"weekFile")
HXLINE(  38)
...
HXDLIN(  62)		HX_VARI_NAME(  ::flixel::graphics::frames::FlxAtlasFrames,ui_tex2,"ui_tex") = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(ui_tex,ui_tex1);
HXLINE(  63)		HX_VARI(  ::flixel::FlxSprite,bgYellow) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,56,null())->makeGraphic(::flixel::FlxG_obj::width,386,-405679,null(),null());
...
HXLINE(  72)		HX_VARI(  ::flixel::FlxSprite,blackBarThingie) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,56,-16777216,null(),null());
...
HXLINE(  90)		HX_VARI( ::Array< ::String >,charArray) = ( (::Array< ::String >)(this->weekFile->__Field(HX_("weekCharacters",be,b5,7f,1d),::hx::paccDynamic)) );
HXLINE(  91)		{
HXLINE(  92)			{
HXLINE(  93)				HX_VARI(  ::MenuCharacter,weekCharacterThing) =  ::MenuCharacter_obj::__alloc( HX_CTX ,((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.25)) - ( (Float)(150) )),charArray->__get(0));
...
HXLINE(  92)			{
HXLINE(  93)				HX_VARI_NAME(  ::MenuCharacter,weekCharacterThing1,"weekCharacterThing") =  ::MenuCharacter_obj::__alloc( HX_CTX ,(((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.25)) * ( (Float)(2) )) - ( (Float)(150) )),charArray->__get(1));
...
HXLINE(  92)			{
HXLINE(  93)				HX_VARI_NAME(  ::MenuCharacter,weekCharacterThing2,"weekCharacterThing") =  ::MenuCharacter_obj::__alloc( HX_CTX ,(((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.25)) * ( (Float)(3) )) - ( (Float)(150) )),charArray->__get(2));
...
HXDLIN( 102)		HX_VARI_NAME(  ::flixel::FlxSprite,tracksSprite1,"tracksSprite") = tracksSprite->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
...
HXLINE( 124)		HX_VARI( ::Array< ::Dynamic>,tabs) = ::Array_obj< ::Dynamic>::__new(2)->init(0, ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 139)		HX_VARI(  ::flixel::ui::FlxButton,loadWeekButton) =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,0,650,HX_("Load Week",2e,d8,7d,d0), ::Dynamic(new _hx_Closure_0()));
HXLINE( 142)		{
...
HXLINE( 142)				int _hx_tmp5 = ::flixel::FlxG_obj::width;
HXDLIN( 142)				loadWeekButton->set_x(((( (Float)(_hx_tmp5) ) - loadWeekButton->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 142)			bool _hx_tmp6;
HXDLIN( 142)			if ((axes != 16)) {
HXLINE( 142)				_hx_tmp6 = (axes == 17);
            			}
            			else {
HXLINE( 142)				_hx_tmp6 = true;
            			}
HXDLIN( 142)			if (_hx_tmp6) {
HXLINE( 142)				int _hx_tmp7 = ::flixel::FlxG_obj::height;
HXDLIN( 142)				loadWeekButton->set_y(((( (Float)(_hx_tmp7) ) - loadWeekButton->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 143)		loadWeekButton->set_x((loadWeekButton->x - ( (Float)(120) )));
HXLINE( 144)		this->add(loadWeekButton);
HXLINE( 146)		HX_VARI(  ::flixel::ui::FlxButton,freeplayButton) =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,0,650,HX_("Freeplay",c0,4c,38,fc), ::Dynamic(new _hx_Closure_1(_gthis)));
HXLINE( 150)		{
HXLINE( 150)			int axes1 = 1;
HXDLIN( 150)			bool _hx_tmp8;
HXDLIN( 150)			if ((axes1 != 1)) {
HXLINE( 150)				_hx_tmp8 = (axes1 == 17);
            			}
            			else {
HXLINE( 150)				_hx_tmp8 = true;
            			}
HXDLIN( 150)			if (_hx_tmp8) {
HXLINE( 150)				int _hx_tmp9 = ::flixel::FlxG_obj::width;
HXDLIN( 150)				freeplayButton->set_x(((( (Float)(_hx_tmp9) ) - freeplayButton->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 150)			bool _hx_tmp10;
HXDLIN( 150)			if ((axes1 != 16)) {
HXLINE( 150)				_hx_tmp10 = (axes1 == 17);
            			}
            			else {
HXLINE( 150)				_hx_tmp10 = true;
            			}
HXDLIN( 150)			if (_hx_tmp10) {
HXLINE( 150)				int _hx_tmp11 = ::flixel::FlxG_obj::height;
HXDLIN( 150)				freeplayButton->set_y(((( (Float)(_hx_tmp11) ) - freeplayButton->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 151)		this->add(freeplayButton);
HXLINE( 153)		HX_VARI(  ::flixel::ui::FlxButton,saveWeekButton) =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,0,650,HX_("Save Week",b7,93,f3,43), ::Dynamic(new _hx_Closure_2(_gthis)));
HXLINE( 156)		{
HXLINE( 156)			int axes2 = 1;
HXDLIN( 156)			bool _hx_tmp12;
HXDLIN( 156)			if ((axes2 != 1)) {
HXLINE( 156)				_hx_tmp12 = (axes2 == 17);
            			}
            			else {
HXLINE( 156)				_hx_tmp12 = true;
            			}
HXDLIN( 156)			if (_hx_tmp12) {
HXLINE( 156)				int _hx_tmp13 = ::flixel::FlxG_obj::width;
HXDLIN( 156)				saveWeekButton->set_x(((( (Float)(_hx_tmp13) ) - saveWeekButton->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 156)			bool _hx_tmp14;
HXDLIN( 156)			if ((axes2 != 16)) {
HXLINE( 156)				_hx_tmp14 = (axes2 == 17);
            			}
            			else {
HXLINE( 156)				_hx_tmp14 = true;
            			}
HXDLIN( 156)			if (_hx_tmp14) {
HXLINE( 156)				int _hx_tmp15 = ::flixel::FlxG_obj::height;
HXDLIN( 156)				saveWeekButton->set_y(((( (Float)(_hx_tmp15) ) - saveWeekButton->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 176)		HX_VARI(  ::flixel::addons::ui::FlxUI,tab_group) =  ::flixel::addons::ui::FlxUI_obj::__alloc( HX_CTX ,null(),this->UI_box,null(),null(),null(),null());
...
HXLINE( 235)		HX_VARI(  ::flixel::addons::ui::FlxUI,tab_group) =  ::flixel::addons::ui::FlxUI_obj::__alloc( HX_CTX ,null(),this->UI_box,null(),null(),null(),null());
...
void WeekEditorState_obj::reloadAllShit(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 270)
HXLINE( 271)		HX_VARI( ::String,weekString) = ( (::String)( ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(0)->__GetItem(0)) );
HXLINE( 272)		{
HXLINE( 272)			int _g = 1;
...
HXLINE( 309)		HX_VARI( ::Array< ::String >,stringThing) = ::Array_obj< ::String >::__new(0);
HXLINE( 310)		{
...
HXDLIN( 310)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 311)				stringThing->push( ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i1)->__GetItem(0));
            			}
            		}
...
HXDLIN( 315)				HX_VARI_NAME( int,i2,"i") = (_g4 - 1);
HXLINE( 317)				 ::flixel::text::FlxText fh = this->txtTracklist;
HXDLIN( 317)				fh->set_text((fh->text + (stringThing->__get(i2) + HX_("\n",0a,00,00,00))));
            			}
            		}
...
HXLINE( 322)				int _hx_tmp2 = ::flixel::FlxG_obj::width;
HXDLIN( 322)				_this->set_x(((( (Float)(_hx_tmp2) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 322)			bool _hx_tmp3;
HXDLIN( 322)			if ((axes != 16)) {
HXLINE( 322)				_hx_tmp3 = (axes == 17);
            			}
            			else {
HXLINE( 322)				_hx_tmp3 = true;
            			}
HXDLIN( 322)			if (_hx_tmp3) {
HXLINE( 322)				int _hx_tmp4 = ::flixel::FlxG_obj::height;
HXDLIN( 322)				_this->set_y(((( (Float)(_hx_tmp4) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 323)		 ::flixel::text::FlxText fh1 = this->txtTracklist;
HXDLIN( 323)		fh1->set_x((fh1->x - (( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.35))));
HXLINE( 325)		 ::flixel::text::FlxText _hx_tmp5 = this->txtWeekTitle;
HXDLIN( 325)		_hx_tmp5->set_text(( (::String)(this->weekFile->__Field(HX_("storyName",e0,50,20,29),::hx::paccDynamic)) ).toUpperCase());
HXLINE( 326)		 ::flixel::text::FlxText _hx_tmp6 = this->txtWeekTitle;
HXDLIN( 326)		int _hx_tmp7 = ::flixel::FlxG_obj::width;
HXDLIN( 326)		_hx_tmp6->set_x((( (Float)(_hx_tmp7) ) - (this->txtWeekTitle->get_width() + 10)));
            	}
...
HXLINE( 331)		HX_VARI( ::String,assetName) = ( (::String)(this->weekFile->__Field(HX_("weekBackground",02,f1,ce,ed),::hx::paccDynamic)) );
HXLINE( 333)		HX_VARI( bool,isMissing) = true;
...
HXLINE( 335)				_hx_tmp1 = ::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(((HX_("images/menubackgrounds/menu_",80,93,47,d3) + assetName) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),null()),HX_("IMAGE",3b,57,57,3b));
            			}
            			else {
HXLINE( 335)				_hx_tmp1 = true;
            			}
HXDLIN( 335)			if (_hx_tmp1) {
HXLINE( 337)				 ::flixel::FlxSprite _hx_tmp2 = this->bgSprite;
...
HXDLIN( 337)				_hx_tmp2->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXLINE( 350)		HX_VARI( ::String,assetName) = ::StringTools_obj::trim(this->weekFileInputText->text);
HXLINE( 352)		HX_VARI( bool,isMissing) = true;
...
HXLINE( 354)				_hx_tmp1 = ::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(((HX_("images/storymenu/",d2,44,94,b2) + assetName) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),null()),HX_("IMAGE",3b,57,57,3b));
            			}
            			else {
HXLINE( 354)				_hx_tmp1 = true;
            			}
HXDLIN( 354)			if (_hx_tmp1) {
HXLINE( 356)				 ::MenuItem _hx_tmp2 = this->weekThing;
...
HXDLIN( 356)				_hx_tmp2->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXLINE( 379)					_hx_tmp2 = ::hx::IsInstanceEq( sender,this->boyfriendInputText );
            				}
            				else {
HXLINE( 379)					_hx_tmp2 = true;
            				}
HXDLIN( 379)				if (!(_hx_tmp2)) {
HXLINE( 379)					_hx_tmp1 = ::hx::IsInstanceEq( sender,this->girlfriendInputText );
            				}
            				else {
...
HXLINE( 393)									HX_VARI( ::Array< ::String >,splittedText) = ::StringTools_obj::trim(this->songsInputText->text).split(HX_(",",2c,00,00,00));
HXLINE( 394)									{
HXLINE( 394)										int _g = 0;
HXDLIN( 394)										int _g1 = splittedText->length;
HXDLIN( 394)										while((_g < _g1)){
HXLINE( 394)											_g = (_g + 1);
HXDLIN( 394)											HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 402)											HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 403)											if ((i1 >= ( (::cpp::VirtualArray)(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic)) )->get_length())) {
HXLINE( 404)												( (::cpp::VirtualArray)(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic)) )->push(::cpp::VirtualArray_obj::__new(3)->init(0,splittedText->__get(i1))->init(1,HX_("dad",47,36,4c,00))->init(2,::cpp::VirtualArray_obj::__new(3)->init(0,146)->init(1,113)->init(2,253)));
            											}
            											else {
HXLINE( 406)												 ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i1)->__SetItem(0,splittedText->__get(i1));
HXLINE( 407)												bool _hx_tmp3;
HXDLIN( 407)												if (::hx::IsNotNull(  ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i1)->__GetItem(1) )) {
HXLINE( 407)													_hx_tmp3 = ( (bool)( ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i1)->__GetItem(1)) );
            												}
            												else {
HXLINE( 407)													_hx_tmp3 = true;
            												}
HXDLIN( 407)												if (_hx_tmp3) {
HXLINE( 408)													 ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i1)->__SetItem(1,HX_("dad",47,36,4c,00));
HXLINE( 409)													 ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i1)->__SetItem(2,::Array_obj< int >::fromData( _hx_array_data_735a5328_23,3));
            												}
            											}
            										}
            									}
...
HXLINE( 431)		HX_VARI( bool,blockInput) = false;
HXLINE( 432)		{
HXLINE( 432)			int _g = 0;
HXDLIN( 432)			::Array< ::Dynamic> _g1 = this->blockPressWhileTypingOn;
HXDLIN( 432)			while((_g < _g1->length)){
HXLINE( 432)				HX_VARI(  ::flixel::addons::ui::FlxUIInputText,inputText) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIInputText >();
HXDLIN( 432)				_g = (_g + 1);
...
HXLINE( 448)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 448)			if (_this1->keyManager->checkStatusUnsafe(27,_this1->status)) {
...
HXLINE( 461)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN( 461)				_this->set_x(((( (Float)(_hx_tmp1) ) - _this->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE( 461)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN( 461)				_this->set_y(((( (Float)(_hx_tmp3) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 462)		 ::flixel::FlxSprite _hx_tmp4 = this->lock;
HXDLIN( 462)		Float _hx_tmp5 = (this->weekThing->get_width() + 10);
HXDLIN( 462)		_hx_tmp4->set_x((_hx_tmp5 + this->weekThing->x));
            	}
...
HXLINE( 466)
HXLINE( 467)		HX_VARI(  ::openfl::net::FileFilter,jsonFilter) =  ::openfl::net::FileFilter_obj::__alloc( HX_CTX ,HX_("JSON",28,0a,29,31),HX_("json",28,42,68,46),null());
...
HXLINE( 484)		HX_VARI( ::String,fullPath) = null();
...
HXLINE( 489)			HX_VARI( ::String,rawJson) = ::sys::io::File_obj::getContent(fullPath);
...
HXDLIN( 494)					HX_VARI_NAME( ::String,cutName1,"cutName") = cutName.substr(0,(::editors::WeekEditorState_obj::_file->get_name().length - 5));
...
HXDLIN( 537)		HX_VARI( ::String,data) = ::haxe::format::JsonPrinter_obj::print(weekFile,replacer,HX_("\t",09,00,00,00));
...
HXLINE( 554)		::flixel::FlxG_obj::log->advanced(HX_("Successfully saved file.",c0,0d,09,f4),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,null());
            	}
...
HXLINE( 577)		::flixel::FlxG_obj::log->advanced(HX_("Problem saving file",41,4c,cd,8e),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            	}
