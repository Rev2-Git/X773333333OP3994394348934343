...
HXLINE( 496)
HXLINE( 497)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = ::flixel::FlxG_obj::bitmap->add(Graphic,Unique,Key);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxSprite_obj,loadGraphic,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::loadRotatedGraphic( ::Dynamic Graphic,::hx::Null< int >  __o_Rotations,::hx::Null< int >  __o_Frame,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE( 539)
HXLINE( 540)		HX_VARI(  ::flixel::graphics::FlxGraphic,brushGraphic) = ::flixel::FlxG_obj::bitmap->add(Graphic,false,Key);
HXLINE( 541)		if (::hx::IsNull( brushGraphic )) {
HXLINE( 542)			return ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 544)		HX_VARI(  ::openfl::display::BitmapData,brush) = brushGraphic->bitmap;
HXLINE( 545)		HX_VARI( ::String,key) = brushGraphic->key;
HXLINE( 547)		if ((Frame >= 0)) {
HXLINE( 550)			HX_VARI( int,brushSize) = brush->height;
HXLINE( 551)			HX_VARI( int,framesNum) = ::Std_obj::_hx_int((( (Float)(brush->width) ) / ( (Float)(brushSize) )));
...
HXLINE( 555)			HX_VARI(  ::openfl::display::BitmapData,full) = brush;
...
HXLINE( 564)		HX_VARI(  ::flixel::graphics::FlxGraphic,tempGraph) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXLINE( 565)		if (::hx::IsNull( tempGraph )) {
HXLINE( 567)			HX_VARI(  ::openfl::display::BitmapData,bitmap) = ::flixel::util::FlxBitmapDataUtil_obj::generateRotations(brush,Rotations,AntiAliasing,AutoBuffer);
HXLINE( 568)			tempGraph = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitmap,false,key,null());
            		}
HXLINE( 571)		HX_VAR( int,max);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxSprite_obj,loadRotatedGraphic,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::loadRotatedFrame( ::flixel::graphics::frames::FlxFrame Frame,::hx::Null< int >  __o_Rotations,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer){
            	...
            	HX_STACK_ARG(AutoBuffer,"AutoBuffer")
HXLINE( 600)
HXLINE( 601)		HX_VARI( ::String,key) = Frame->parent->key;
...
HXLINE( 607)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HX_DEFINE_DYNAMIC_FUNC4(FlxSprite_obj,loadRotatedFrame,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o_Color,::hx::Null< bool >  __o_Unique,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE( 635)
HXLINE( 636)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = ::flixel::FlxG_obj::bitmap->create(Width,Height,Color,Unique,Key);
...
HXLINE( 703)		HX_VARI( Float,newScaleX) = (( (Float)(Width) ) / ( (Float)(this->frameWidth) ));
HXLINE( 704)		HX_VARI( Float,newScaleY) = (( (Float)(Height) ) / ( (Float)(this->frameHeight) ));
HXLINE( 705)		{
...
HXLINE( 785)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 785)				_g = (_g + 1);
HXLINE( 787)				bool _hx_tmp1;
HXDLIN( 787)				bool _hx_tmp2;
HXDLIN( 787)				if (camera->visible) {
HXLINE( 787)					_hx_tmp2 = !(camera->exists);
            				}
            				else {
HXLINE( 787)					_hx_tmp2 = true;
            				}
HXDLIN( 787)				if (!(_hx_tmp2)) {
HXLINE( 787)					_hx_tmp1 = !(this->isOnScreen(camera));
            				}
            				else {
...
HXLINE( 796)				::flixel::FlxBasic_obj::visibleCount++;
            			}
            		}
HXLINE( 801)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 802)			this->drawDebug();
            		}
            	}
...
HXLINE( 811)			 ::flixel::math::FlxBasePoint this2 = this->_point;
HXDLIN( 811)			this2->set_x(( (Float)(::Math_obj::floor(this2->x)) ));
HXDLIN( 811)			this2->set_y(( (Float)(::Math_obj::floor(this2->y)) ));
            		}
HXLINE( 813)		{
HXLINE( 813)			 ::flixel::math::FlxBasePoint this3 = this->_point;
...
HXDLIN( 813)			p->x = this3->x;
HXDLIN( 813)			p->y = this3->y;
            		}
...
HXLINE( 858)			HX_STACK_DO_THROW(HX_("Cannot stamp to or from a FlxSprite with no graphics.",72,0b,d4,aa));
            		}
HXLINE( 860)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) = Brush->framePixels;
...
HXLINE( 882)			HX_VARI(  ::Dynamic,brushBlend) = Brush->blend;
...
HXLINE( 951)
HXLINE( 952)		HX_VARI( ::Array< ::Dynamic>,positions) = ::flixel::util::FlxBitmapDataUtil_obj::replaceColor(this->graphic->bitmap,Color,NewColor,FetchPositions,null());
...
bool FlxSprite_obj::pixelsOverlapPoint( ::flixel::math::FlxBasePoint worldPoint,::hx::Null< int >  __o_mask, ::flixel::FlxCamera camera){
            	...
            	HX_STACK_ARG(camera,"camera")
HXLINE(1009)
HXLINE(1010)		HX_VARI(  ::Dynamic,pixelColor) = this->getPixelAt(worldPoint,null());
...
HXLINE(1035)			HX_VARI(  ::openfl::display::BitmapData,frameData) = this->updateFramePixels();
HXLINE(1036)			int _hx_tmp3 = ::Std_obj::_hx_int(this->_point->x);
HXDLIN(1036)			return frameData->getPixel32(_hx_tmp3,::Std_obj::_hx_int(this->_point->y));
            		}
...
HXLINE(1058)			HX_VARI(  ::openfl::display::BitmapData,frameData) = this->updateFramePixels();
HXLINE(1059)			int _hx_tmp3 = ::Std_obj::_hx_int(this->_point->x);
HXDLIN(1059)			return frameData->getPixel32(_hx_tmp3,::Std_obj::_hx_int(this->_point->y));
            		}
...
HXDLIN(1079)		HX_VARI(  ::flixel::math::FlxBasePoint,screenPoint) = point1;
...
HXDLIN(1167)		HX_VAR_NAME( bool,doFlipX1,"doFlipX");
...
HXDLIN(1168)		HX_VAR_NAME( bool,doFlipY1,"doFlipY");
...
bool FlxSprite_obj::isSimpleRenderBlit( ::flixel::FlxCamera camera){
            	...
            	HX_STACK_ARG(camera,"camera")
HXLINE(1246)
HXLINE(1247)		HX_VAR( bool,result);
...
HXLINE(1325)			HX_VARI(  ::haxe::ds::StringMap,animations) = this->animation->_animations;
HXLINE(1326)			HX_VARI( bool,reverse) = false;
HXLINE(1327)			HX_VARI( int,index) = 0;
HXLINE(1328)			HX_VARI( int,frameIndex) = this->animation->frameIndex;
HXLINE(1329)			HX_VARI( ::String,currName) = null();
...
HXLINE(1364)
HXLINE(1365)		HX_VARI( ::String,key) = ::flixel::FlxG_obj::bitmap->findKeyForBitmap(Pixels);
...
int FlxSprite_obj::set_facing(int Direction){
            	...
            	HX_STACK_ARG(Direction,"Direction")
HXLINE(1419)
HXLINE(1420)		HX_VARI(  ::Dynamic,flip) = this->_facingFlip->get(Direction);
...
Float FlxSprite_obj::set_angle(Float Value){
            	...
            	HX_STACK_ARG(Value,"Value")
HXLINE(1456)
HXLINE(1457)		HX_VARI( bool,newAngle) = (this->angle != Value);
HXLINE(1458)		HX_VARI( Float,ret) = this->super::set_angle(Value);
...
HXLINE(1472)			HX_VARI( Float,radians) = (this->angle * (::Math_obj::PI / ( (Float)(180) )));
...
HX_DEFINE_DYNAMIC_FUNC1(FlxSprite_obj,set_blend,return )
 ...
 ::flixel::graphics::FlxGraphic FlxSprite_obj::set_graphic( ::flixel::graphics::FlxGraphic Value){
            	...
            	HX_STACK_ARG(Value,"Value")
HXLINE(1491)
HXLINE(1492)		HX_VARI(  ::flixel::graphics::FlxGraphic,oldGraphic) = this->graphic;
...
HXLINE(1564)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1564)			_hx_tmp1 = true;
            		}
HXDLIN(1564)		this->dirty = _hx_tmp1;
...
HXLINE(1575)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1575)			_hx_tmp1 = true;
            		}
HXDLIN(1575)		this->dirty = _hx_tmp1;
...
bool FlxSprite_obj::checkFlipX(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1612)
HXLINE(1613)		HX_VARI( bool,doFlipX) = (this->flipX != this->_frame->flipX);
...
bool FlxSprite_obj::checkFlipY(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1623)
HXLINE(1624)		HX_VARI( bool,doFlipY) = (this->flipY != this->_frame->flipY);
