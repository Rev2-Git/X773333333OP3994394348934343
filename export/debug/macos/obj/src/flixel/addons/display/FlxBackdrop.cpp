...
HXLINE( 100)
HXLINE( 101)		HX_VARI(  ::flixel::graphics::FlxGraphic,tileGraphic) = ::flixel::FlxG_obj::bitmap->add(Graphic,null(),null());
HXLINE( 102)		this->setTileFrame(tileGraphic->get_imageFrame()->get_frame());
HXLINE( 104)		HX_VARI( int,w) = ::Std_obj::_hx_int((this->_tileFrame->sourceSize->x + this->_spaceX));
HXLINE( 105)		HX_VARI( int,h) = ::Std_obj::_hx_int((this->_tileFrame->sourceSize->y + this->_spaceY));
...
HXLINE( 119)		HX_VARI( int,w) = ::Std_obj::_hx_int((this->_tileFrame->sourceSize->x + this->_spaceX));
HXLINE( 120)		HX_VARI( int,h) = ::Std_obj::_hx_int((this->_tileFrame->sourceSize->y + this->_spaceY));
...
void FlxBackdrop_obj::draw(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 131)
HXLINE( 132)		HX_VAR( bool,isColored);
...
HXLINE( 133)		HX_VAR( bool,hasColorOffsets);
...
HXLINE( 135)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 135)				_g = (_g + 1);
...
HXLINE( 140)				HX_VARI( Float,ssw) = (( (Float)(this->_scrollW) ) * ::Math_obj::abs(this->scale->x));
HXLINE( 141)				HX_VARI( Float,ssh) = (( (Float)(this->_scrollH) ) * ::Math_obj::abs(this->scale->y));
...
HXLINE( 162)						 ::openfl::geom::Point fh1 = this->_ppoint;
HXDLIN( 162)						fh1->y = (fh1->y - ssh);
            					}
            				}
            				else {
...
HXLINE( 186)					HX_VARI(  ::flixel::graphics::tile::FlxDrawQuadsItem,drawItem) = camera->startQuadBatch(this->_tileFrame->parent,isColored,hasColorOffsets,null(),null(),null());
HXLINE( 188)					this->_tileFrame->prepareMatrix(this->_matrix,null(),null(),null());
HXLINE( 190)					HX_VARI( Float,scaleX) = this->scale->x;
HXLINE( 191)					HX_VARI( Float,scaleY) = this->scale->y;
...
HXLINE( 201)					HX_VARI( Float,tx) = this->_matrix->tx;
HXLINE( 202)					HX_VARI( Float,ty) = this->_matrix->ty;
HXLINE( 204)					{
HXLINE( 204)						int _g2 = 0;
HXDLIN( 204)						int _g3 = this->_numTiles;
HXDLIN( 204)						while((_g2 < _g3)){
HXLINE( 204)							_g2 = (_g2 + 1);
HXDLIN( 204)							HX_VARI( int,j) = (_g2 - 1);
HXLINE( 206)							HX_VARI( Float,currTileX) = this->_tileInfo->__get((j * 2));
HXLINE( 207)							HX_VARI( Float,currTileY) = this->_tileInfo->__get(((j * 2) + 1));
...
void FlxBackdrop_obj::regenGraphic(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 219)
HXLINE( 220)		HX_VARI( Float,sx) = ::Math_obj::abs(this->scale->x);
HXLINE( 221)		HX_VARI( Float,sy) = ::Math_obj::abs(this->scale->y);
HXLINE( 223)		HX_VARI( int,ssw) = ::Std_obj::_hx_int((( (Float)(this->_scrollW) ) * sx));
HXLINE( 224)		HX_VARI( int,ssh) = ::Std_obj::_hx_int((( (Float)(this->_scrollH) ) * sy));
HXLINE( 226)		HX_VARI( int,w) = ssw;
HXLINE( 227)		HX_VARI( int,h) = ssh;
HXLINE( 229)		HX_VARI(  ::openfl::display::BitmapData,frameBitmap) = null();
...
HXLINE( 279)				 ::openfl::geom::Point fh1 = this->_ppoint;
HXDLIN( 279)				fh1->x = (fh1->x + ssw);
            			}
HXLINE( 281)			if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 283)				this->_matrix->tx = ( (Float)(0) );
HXLINE( 284)				 ::flixel::math::FlxMatrix fh2 = this->_matrix;
HXDLIN( 284)				fh2->ty = (fh2->ty + ssh);
            			}
HXLINE( 287)			this->_ppoint->x = ( (Float)(0) );
HXLINE( 288)			 ::openfl::geom::Point fh3 = this->_ppoint;
HXDLIN( 288)			fh3->y = (fh3->y + ssh);
            		}
...
HXLINE( 320)				 ::flixel::graphics::FlxGraphic fh1 = Frame->parent;
HXDLIN( 320)				fh1->set_useCount((fh1->get_useCount() + 1));
            			}
            		}
