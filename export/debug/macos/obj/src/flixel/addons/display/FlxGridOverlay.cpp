...
bool FlxGridOverlay_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::FlxSprite FlxGridOverlay_obj::create(int CellWidth,int CellHeight,::hx::Null< int >  __o_Width,::hx::Null< int >  __o_Height,::hx::Null< bool >  __o_Alternate,::hx::Null< int >  __o_Color1,::hx::Null< int >  __o_Color2){
            	...
            	HX_STACK_ARG(CellWidth,"CellWidth")
            	HX_STACK_ARG(CellHeight,"CellHeight")
...
HXLINE(  52)		HX_VARI(  ::openfl::display::BitmapData,grid) = ::flixel::addons::display::FlxGridOverlay_obj::createGrid(CellWidth,CellHeight,Width,Height,Alternate,Color1,Color2);
HXLINE(  54)		HX_VARI(  ::flixel::FlxSprite,output) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXLINE(  97)		HX_VARI(  ::openfl::display::BitmapData,grid) = ::flixel::addons::display::FlxGridOverlay_obj::createGrid(CellWidth,CellHeight,Width,Height,Alternate,Color1,Color2);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC8(FlxGridOverlay_obj,overlay,return )
 ...
 ::openfl::display::BitmapData FlxGridOverlay_obj::createGrid(int CellWidth,int CellHeight,int Width,int Height,bool Alternate,int Color1,int Color2){
            	...
            	HX_STACK_ARG(Color2,"Color2")
HXLINE( 103)
HXLINE( 105)		HX_VARI( int,rowColor) = Color1;
HXLINE( 106)		HX_VARI( int,lastColor) = Color1;
HXLINE( 107)		HX_VARI(  ::openfl::display::BitmapData,grid) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,Width,Height,true,null());
HXLINE( 110)		HX_VARI( int,y) = 0;
