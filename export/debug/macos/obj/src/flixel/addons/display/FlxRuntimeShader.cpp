...
HXLINE( 216)			HX_VARI( ::String,s) = this->processVertexSource(::flixel::addons::display::FlxRuntimeShader_obj::DEFAULT_VERTEX_SOURCE);
HXLINE( 217)			this->set_glVertexSource(s);
            		}
            		else {
HXLINE( 221)			HX_VARI( ::String,s1) = this->processVertexSource(vertexSource);
HXLINE( 222)			this->set_glVertexSource(s1);
            		}
HXLINE( 225)		{
...
HXLINE( 239)
HXLINE( 240)		HX_VARI( ::String,result) = ::StringTools_obj::replace(input,::flixel::addons::display::FlxRuntimeShader_obj::PRAGMA_HEADER,::flixel::addons::display::FlxRuntimeShader_obj::BASE_FRAGMENT_HEADER);
...
::String FlxRuntimeShader_obj::processVertexSource(::String input){
            	...
            	HX_STACK_ARG(input,"input")
HXLINE( 249)
HXLINE( 250)		HX_VARI( ::String,result) = ::StringTools_obj::replace(input,::flixel::addons::display::FlxRuntimeShader_obj::PRAGMA_HEADER,::flixel::addons::display::FlxRuntimeShader_obj::BASE_VERTEX_HEADER);
...
HXLINE( 293)			HX_VARI( ::String,precisionHeaders) = this->buildPrecisionHeaders();
HXLINE( 294)			HX_VARI( ::String,versionHeader) = ((HX_("#version ",2b,a9,b9,ad) + this->_glslVersion) + HX_("\n",0a,00,00,00));
HXLINE( 296)			HX_VARI( ::String,vertex) = ::StringTools_obj::replace(this->get_glVertexSource(),::flixel::addons::display::FlxRuntimeShader_obj::PRAGMA_PRECISION,precisionHeaders);
HXLINE( 297)			vertex = ::StringTools_obj::replace(vertex,::flixel::addons::display::FlxRuntimeShader_obj::PRAGMA_VERSION,versionHeader);
HXLINE( 298)			HX_VARI( ::String,fragment) = ::StringTools_obj::replace(this->get_glFragmentSource(),::flixel::addons::display::FlxRuntimeShader_obj::PRAGMA_PRECISION,precisionHeaders);
...
HXLINE( 301)			HX_VARI( ::String,id) = (vertex + fragment);
...
HXLINE( 318)						HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 318)						_g = (_g + 1);
...
HXLINE( 326)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 334)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 334)						_g4 = (_g4 + 1);
HXLINE( 335)						if (parameter1->_hx___isUniform) {
HXLINE( 336)							parameter1->index = gl->getUniformLocation(this->glProgram,parameter1->name);
            						}
            						else {
HXLINE( 338)							parameter1->index = gl->getAttribLocation(this->glProgram,parameter1->name);
            						}
            					}
            				}
HXLINE( 342)				{
...
HXLINE( 342)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 342)						_g6 = (_g6 + 1);
HXLINE( 343)						if (parameter2->_hx___isUniform) {
HXLINE( 344)							parameter2->index = gl->getUniformLocation(this->glProgram,parameter2->name);
            						}
            						else {
HXLINE( 346)							parameter2->index = gl->getAttribLocation(this->glProgram,parameter2->name);
            						}
            					}
            				}
            			}
...
HXLINE( 369)
HXLINE( 370)		HX_VAR(  ::Dynamic,position);
HXLINE( 371)		HX_VAR( ::String,name);
HXLINE( 372)		HX_VAR( ::String,type);
HXLINE( 374)		HX_VAR(  ::EReg,regex);
...
HXLINE( 378)		HX_VARI( int,lastMatch) = 0;
...
HXLINE( 389)			HX_VARI( bool,isUniform) = (storageType == HX_("uniform",34,41,64,b5));
HXLINE( 391)			if (::StringTools_obj::startsWith(type,HX_("sampler",08,c5,c9,83))) {
HXLINE( 392)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) =  ::openfl::display::ShaderInput_openfl_display_BitmapData_obj::__alloc( HX_CTX );
...
HXLINE( 407)					_hx_tmp1 = ::hx::IsNull( ::Reflect_obj::field(this->_hx___data,name) );
            				}
            				else {
HXLINE( 407)					_hx_tmp1 = true;
            				}
HXDLIN( 407)				if (_hx_tmp1) {
HXLINE( 408)					HX_VAR(  ::Dynamic,parameterType);
...
HXLINE( 434)						length = 1;
            					...
            					_hx_goto_13:;
HXLINE( 444)					HX_VAR( int,arrayLength);
...
HXLINE( 455)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) =  ::openfl::display::ShaderParameter_Bool_obj::__alloc( HX_CTX );
...
HXLINE( 470)							_hx_tmp2 = this->thisHasField(name);
            						}
            						else {
...
HXLINE( 473)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter1,"parameter") =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
HXLINE( 474)						parameter1->set_name(name);
HXLINE( 475)						parameter1->type = parameterType;
HXLINE( 476)						parameter1->_hx___arrayLength = arrayLength;
HXLINE( 477)						parameter1->_hx___isInt = true;
HXLINE( 478)						parameter1->_hx___isUniform = isUniform;
HXLINE( 479)						parameter1->__length = length;
HXLINE( 480)						this->_hx___paramInt->push(parameter1);
HXLINE( 481)						::Reflect_obj::setField(this->_hx___data,name,parameter1);
HXLINE( 482)						bool _hx_tmp3;
HXDLIN( 482)						if (this->_hx___isGenerated) {
HXLINE( 482)							_hx_tmp3 = this->thisHasField(name);
            						}
            						else {
HXLINE( 482)							_hx_tmp3 = false;
            						}
HXDLIN( 482)						if (_hx_tmp3) {
HXLINE( 482)							::Reflect_obj::setProperty(::hx::ObjectPtr<OBJ_>(this),name,parameter1);
            						}
HXLINE( 472)						goto _hx_goto_16;
            					}
            					/* default */{
HXLINE( 485)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter2,"parameter") =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
HXLINE( 486)						parameter2->set_name(name);
HXLINE( 487)						parameter2->type = parameterType;
HXLINE( 488)						parameter2->_hx___arrayLength = arrayLength;
...
HXDLIN( 490)									_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 490)									_this->copyFromArray(array,null());
HXDLIN( 490)									this1 = _this;
            								}
            								else {
HXLINE( 490)									if (::hx::IsNotNull( vector )) {
HXLINE( 490)										 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 490)										::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 490)										_this1->byteOffset = 0;
HXDLIN( 490)										_this1->length = array1->get_length();
HXDLIN( 490)										_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 490)										_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 490)										_this1->copyFromArray(array1,null());
HXDLIN( 490)										this1 = _this1;
            									}
            									else {
HXLINE( 490)										if (::hx::IsNotNull( view )) {
HXLINE( 490)											 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 490)											int elementSize = _this2->bytesPerElement;
HXDLIN( 490)											if ((view->type == _this2->type)) {
HXLINE( 490)												int srcLength1 = srcData->length;
HXDLIN( 490)												int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 490)												_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 490)												_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            											}
            											else {
HXLINE( 490)												HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            											}
HXDLIN( 490)											_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 490)											_this2->byteOffset = 0;
HXDLIN( 490)											_this2->length = srcLength;
HXDLIN( 490)											this1 = _this2;
            										}
            										else {
HXLINE( 490)											if (::hx::IsNotNull( buffer )) {
HXLINE( 490)												 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 490)												int in_byteOffset = 0;
HXDLIN( 490)												if ((in_byteOffset < 0)) {
HXLINE( 490)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 490)												if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 490)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 490)												int bufferByteLength = buffer->length;
HXDLIN( 490)												int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 490)													if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 490)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
...
HXLINE( 490)													newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 490)													int newRange = (in_byteOffset + newByteLength);
HXDLIN( 490)													if ((newRange > bufferByteLength)) {
HXLINE( 490)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
            												}
HXDLIN( 490)												_this3->buffer = buffer;
HXDLIN( 490)												_this3->byteOffset = in_byteOffset;
HXDLIN( 490)												_this3->byteLength = newByteLength;
HXDLIN( 490)												_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 490)												this1 = _this3;
            											}
            											else {
HXLINE( 490)												HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            											}
            										}
            									}
            								}
            							}
HXDLIN( 490)							parameter2->_hx___uniformMatrix = this1;
            						}
HXLINE( 492)						parameter2->_hx___isFloat = true;
HXLINE( 493)						parameter2->_hx___isUniform = isUniform;
HXLINE( 494)						parameter2->__length = length;
HXLINE( 495)						this->_hx___paramFloat->push(parameter2);
...
HXLINE( 512)						::Reflect_obj::setField(this->_hx___data,name,parameter2);
HXLINE( 513)						bool _hx_tmp4;
HXDLIN( 513)						if (this->_hx___isGenerated) {
HXLINE( 513)							_hx_tmp4 = this->thisHasField(name);
            						}
            						else {
HXLINE( 513)							_hx_tmp4 = false;
            						}
HXDLIN( 513)						if (_hx_tmp4) {
HXLINE( 513)							::Reflect_obj::setProperty(::hx::ObjectPtr<OBJ_>(this),name,parameter2);
            						}
            					}
            					_hx_goto_16:;
            				}
...
HXLINE( 527)
HXLINE( 528)		HX_VARI(  ::openfl::display::ShaderParameter_Float,prop) = ( ( ::openfl::display::ShaderParameter_Float)(::Reflect_obj::field(this->get_data(),name)) );
...
void FlxRuntimeShader_obj::setFloatArray(::String name,::Array< Float > value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 544)
HXLINE( 545)		HX_VARI(  ::openfl::display::ShaderParameter_Float,prop) = ( ( ::openfl::display::ShaderParameter_Float)(::Reflect_obj::field(this->get_data(),name)) );
...
void FlxRuntimeShader_obj::setInt(::String name,int value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 560)
HXLINE( 561)		HX_VARI(  ::openfl::display::ShaderParameter_Int,prop) = ( ( ::openfl::display::ShaderParameter_Int)(::Reflect_obj::field(this->get_data(),name)) );
...
void FlxRuntimeShader_obj::setIntArray(::String name,::Array< int > value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 576)
HXLINE( 577)		HX_VARI(  ::openfl::display::ShaderParameter_Int,prop) = ( ( ::openfl::display::ShaderParameter_Int)(::Reflect_obj::field(this->get_data(),name)) );
...
void FlxRuntimeShader_obj::setBool(::String name,bool value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 592)
HXLINE( 593)		HX_VARI(  ::openfl::display::ShaderParameter_Bool,prop) = ( ( ::openfl::display::ShaderParameter_Bool)(::Reflect_obj::field(this->get_data(),name)) );
...
void FlxRuntimeShader_obj::setBoolArray(::String name,::Array< bool > value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 608)
HXLINE( 609)		HX_VARI(  ::openfl::display::ShaderParameter_Bool,prop) = ( ( ::openfl::display::ShaderParameter_Bool)(::Reflect_obj::field(this->get_data(),name)) );
...
void FlxRuntimeShader_obj::setSampler2D(::String name, ::openfl::display::BitmapData value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 624)
HXLINE( 625)		HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,prop) = ( ( ::openfl::display::ShaderInput_openfl_display_BitmapData)(::Reflect_obj::field(this->get_data(),name)) );
...
HX_DEFINE_DYNAMIC_FUNC2(FlxRuntimeShader_obj,setSampler2D,(void))
 ...
 ::Dynamic FlxRuntimeShader_obj::getFloat(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 639)
HXLINE( 640)		HX_VARI(  ::openfl::display::ShaderParameter_Float,prop) = ( ( ::openfl::display::ShaderParameter_Float)(::Reflect_obj::field(this->get_data(),name)) );
...
::Array< Float > FlxRuntimeShader_obj::getFloatArray(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 654)
HXLINE( 655)		HX_VARI(  ::openfl::display::ShaderParameter_Float,prop) = ( ( ::openfl::display::ShaderParameter_Float)(::Reflect_obj::field(this->get_data(),name)) );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxRuntimeShader_obj,getFloatArray,return )
 ...
 ::Dynamic FlxRuntimeShader_obj::getInt(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 669)
HXLINE( 670)		HX_VARI(  ::openfl::display::ShaderParameter_Int,prop) = ( ( ::openfl::display::ShaderParameter_Int)(::Reflect_obj::field(this->get_data(),name)) );
...
::Array< int > FlxRuntimeShader_obj::getIntArray(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 684)
HXLINE( 685)		HX_VARI(  ::openfl::display::ShaderParameter_Int,prop) = ( ( ::openfl::display::ShaderParameter_Int)(::Reflect_obj::field(this->get_data(),name)) );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxRuntimeShader_obj,getIntArray,return )
 ...
 ::Dynamic FlxRuntimeShader_obj::getBool(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 699)
HXLINE( 700)		HX_VARI(  ::openfl::display::ShaderParameter_Bool,prop) = ( ( ::openfl::display::ShaderParameter_Bool)(::Reflect_obj::field(this->get_data(),name)) );
...
::Array< bool > FlxRuntimeShader_obj::getBoolArray(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 714)
HXLINE( 715)		HX_VARI(  ::openfl::display::ShaderParameter_Bool,prop) = ( ( ::openfl::display::ShaderParameter_Bool)(::Reflect_obj::field(this->get_data(),name)) );
