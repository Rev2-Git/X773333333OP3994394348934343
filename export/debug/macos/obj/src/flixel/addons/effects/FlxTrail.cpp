...
HXLINE( 157)			HX_VARI(  ::flixel::math::FlxBasePoint,spritePosition) = null();
...
HXLINE( 179)				HX_VARI(  ::flixel::math::FlxBasePoint,spriteScale) = null();
...
HXLINE( 186)					 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 203)			HX_VAR(  ::flixel::FlxSprite,trailSprite);
HXLINE( 205)			{
HXLINE( 205)				int _g = 0;
HXDLIN( 205)				int _g1 = this->_recentPositions->length;
HXDLIN( 205)				while((_g < _g1)){
HXLINE( 205)					_g = (_g + 1);
HXDLIN( 205)					HX_VARI( int,i) = (_g - 1);
...
HXLINE( 287)				HX_VARI(  ::flixel::FlxSprite,trailSprite) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,null());
