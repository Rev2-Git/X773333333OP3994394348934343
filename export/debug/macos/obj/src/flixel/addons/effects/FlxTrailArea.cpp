...
void FlxTrailArea_obj::__construct(::hx::Null< int >  __o_X,::hx::Null< int >  __o_Y,::hx::Null< int >  __o_Width,::hx::Null< int >  __o_Height,::hx::Null< Float >  __o_AlphaMultiplier,::hx::Null< int >  __o_Delay,::hx::Null< bool >  __o_SimpleRender,::hx::Null< bool >  __o_Antialiasing, ::Dynamic TrailBlendMode){
            	...
            	HX_STACK_ARG(SimpleRender,"SimpleRender")
...
HXLINE( 181)			HX_VARI(  ::openfl::geom::ColorTransform,cTrans) =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,this->redMultiplier,this->greenMultiplier,this->blueMultiplier,this->alphaMultiplier,this->redOffset,this->greenOffset,this->blueOffset,this->alphaOffset);
...
HXLINE( 185)					HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 185)					_g = (_g + 1);
HXLINE( 187)					if (member->exists) {
HXLINE( 189)						HX_VARI( Float,finalX) = ((member->x - this->x) - member->offset->x);
HXLINE( 190)						HX_VARI( Float,finalY) = ((member->y - this->y) - member->offset->y);
...
HXLINE( 200)							HX_VAR( bool,rotated);
