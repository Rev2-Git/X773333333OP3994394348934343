...
HXLINE( 249)
HXLINE( 250)		HX_VARI( int,prop1) = ( (int)(::Reflect_obj::getProperty(Item1,::flixel::addons::plugin::FlxMouseControl_obj::sortIndex)) );
HXLINE( 251)		HX_VARI( int,prop2) = ( (int)(::Reflect_obj::getProperty(Item2,::flixel::addons::plugin::FlxMouseControl_obj::sortIndex)) );
