...
void FlxTypeText_obj::insertBreakLines(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 241)
HXLINE( 242)		HX_VARI( ::String,saveText) = this->text;
HXLINE( 244)		HX_VARI( int,last) = this->_finalText.length;
HXLINE( 245)		HX_VARI( int,n0) = 0;
HXLINE( 246)		HX_VARI( int,n1) = 0;
...
HXDLIN( 258)			HX_VARI_NAME( ::String,nextText1,"nextText") = (nextText + this->_finalText.substr((last + 1),this->_finalText.length));
...
HXLINE( 356)					HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN( 356)					_g = (_g + 1);
...
HXLINE( 464)							HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN( 464)							_g = (_g + 1);
...
HXLINE( 488)			HX_VARI( bool,isBreakLine) = ((this->prefix + this->_finalText).charAt(::flixel::addons::text::FlxTypeText_obj::helperString.length) == HX_("\n",0a,00,00,00));
