...
void FlxTransitionSprite_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,Float Delay, ::Dynamic Graphic,::hx::Null< int >  __o_GraphicWidth,::hx::Null< int >  __o_GraphicHeight,::hx::Null< int >  __o_FrameRate){
            	...
            	HX_STACK_ARG(GraphicWidth,"GraphicWidth")
            	HX_STACK_ARG(GraphicHeight,"GraphicHeight")
...
HXLINE(  52)		HX_VARI( ::Array< int >,inArray) = ::Array_obj< int >::__new(0);
HXLINE(  53)		HX_VARI( ::Array< int >,outArray) = ::Array_obj< int >::__new(0);
HXLINE(  54)		{
HXLINE(  54)			int _g = 1;
