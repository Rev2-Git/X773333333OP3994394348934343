...
HXLINE( 125)			HX_VARI(  ::flixel::addons::transition::Transition,_trans) = this->createTransition(this->transIn);
...
void FlxTransitionableState_obj::transitionOut( ::Dynamic OnExit){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(OnExit,"OnExit")
HXLINE( 139)
HXLINE( 140)		this->_onExit = OnExit;
HXLINE( 141)		if (this->get_hasTransOut()) {
HXLINE( 143)			HX_VARI(  ::flixel::addons::transition::Transition,_trans) = this->createTransition(this->transOut);
