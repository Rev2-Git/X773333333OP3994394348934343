...
void TransitionFade_obj::start(int NewStatus){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(NewStatus,"NewStatus")
HXLINE(  49)
...
HXDLIN(  70)			goto _hx_goto_3;
            		...
            		_hx_goto_3:;
HXLINE(  73)		HX_VARI(  ::Dynamic,Values) =  ::Dynamic(::hx::Anon_obj::Create(0));
...
HXLINE( 151)
HXLINE( 152)		HX_VARI(  ::flixel::FlxSprite,s) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,region->x,region->y,null());
HXLINE( 153)		HX_VARI( Float,locX) = ( (Float)(0) );
HXLINE( 154)		HX_VARI( Float,locY) = ( (Float)(0) );
HXLINE( 155)		HX_VARI( int,angle) = 0;
HXLINE( 156)		HX_VARI(  ::openfl::display::BitmapData,pixels) = null();
...
HXDLIN( 169)				HX_VARI_NAME(  ::openfl::display::BitmapData,gvert1,"gvert") = ::flixel::util::FlxGradient_obj::createGradientBitmapData(1,gvert,::Array_obj< int >::__new(2)->init(0,this->_data->color)->init(1,0),1,angle,null());
...
HXDLIN( 182)					HX_VARI_NAME(  ::openfl::display::BitmapData,ghorz1,"ghorz") = ::flixel::util::FlxGradient_obj::createGradientBitmapData(ghorz,1,::Array_obj< int >::__new(2)->init(0,this->_data->color)->init(1,0),1,angle,null());
...
HX_DEFINE_DYNAMIC_FUNC3(TransitionFade_obj,makeSprite,return )
 ...
 ::openfl::display::BitmapData TransitionFade_obj::getGradient(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 200)
HXLINE( 202)		HX_VARI(  ::flixel::addons::transition::_TransitionFade::GraphicDiagonalGradient,rawBmp) =  ::flixel::addons::transition::_TransitionFade::GraphicDiagonalGradient_obj::__alloc( HX_CTX ,0,0,null(),null());
HXLINE( 203)		HX_VARI(  ::openfl::display::BitmapData,gdiag) = ( ( ::openfl::display::BitmapData)(rawBmp) );
HXLINE( 204)		HX_VARI(  ::openfl::display::BitmapData,gdiag_scaled) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(::flixel::FlxG_obj::width * 2),(::flixel::FlxG_obj::height * 2),true,null());
HXLINE( 205)		HX_VARI(  ::openfl::geom::Matrix,m) =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXLINE( 208)		HX_VARI( int,theColor) = this->_data->color;
HXLINE( 209)		HX_VARI(  ::openfl::display::BitmapData,final_pixels) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(::flixel::FlxG_obj::width * 3),(::flixel::FlxG_obj::height * 3),true,theColor);
