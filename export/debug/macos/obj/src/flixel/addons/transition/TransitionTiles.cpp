...
HXLINE(  23)		HX_VARI( Float,delay) = ( (Float)(0) );
...
HXLINE(  30)		HX_VARI(  ::flixel::math::FlxRect,region) = data->region;
HXLINE(  32)		HX_VARI( int,tilesX) = ::Math_obj::ceil((region->width / ( (Float)(data->tileData->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) )));
HXLINE(  33)		HX_VARI( int,tilesY) = ::Math_obj::ceil((region->height / ( (Float)(data->tileData->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) )));
HXLINE(  35)		HX_VAR( int,maxTiles);
...
HXLINE(  37)		HX_VARI( Float,dTime) = (data->duration / ( (Float)(maxTiles) ));
HXLINE(  39)		HX_VARI( Float,xDelay) = (dTime * ::Math_obj::abs(data->direction->x));
HXLINE(  40)		HX_VARI( Float,yDelay) = (dTime * ::Math_obj::abs(data->direction->y));
HXLINE(  42)		HX_VARI( int,addX) = ( (int)(data->tileData->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) );
HXLINE(  43)		HX_VARI( int,addY) = ( (int)(data->tileData->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) );
HXLINE(  45)		HX_VARI( int,tx) = 0;
HXLINE(  46)		HX_VARI( int,ty) = 0;
HXLINE(  48)		HX_VARI( int,startX) = ::Std_obj::_hx_int(region->x);
HXLINE(  49)		HX_VARI( int,startY) = ::Std_obj::_hx_int(region->y);
...
HXLINE(  64)				_g = (_g + 1);
HXDLIN(  64)				HX_VARI( int,iy) = (_g - 1);
HXLINE(  66)				{
HXLINE(  66)					int _g2 = 0;
HXDLIN(  66)					int _g3 = tilesX;
HXDLIN(  66)					while((_g2 < _g3)){
HXLINE(  66)						_g2 = (_g2 + 1);
HXDLIN(  66)						HX_VARI( int,ix) = (_g2 - 1);
HXLINE(  68)						HX_VARI( int,frameRate) = 40;
...
HXLINE(  73)						HX_VARI(  ::flixel::addons::transition::FlxTransitionSprite,ts) =  ::flixel::addons::transition::FlxTransitionSprite_obj::__alloc( HX_CTX ,tx,ty,delay, ::Dynamic(data->tileData->__Field(HX_("asset",f0,69,39,26),::hx::paccDynamic)),data->tileData->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic),data->tileData->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic),frameRate);
...
HXLINE( 119)			HX_VARI( bool,allDone) = true;
HXLINE( 120)			{
HXLINE( 120)				int _g = 0;
HXDLIN( 120)				::Array< ::Dynamic> _g1 = this->_grpSprites->group->members;
HXDLIN( 120)				while((_g < _g1->length)){
HXLINE( 120)					HX_VARI(  ::flixel::addons::transition::FlxTransitionSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::addons::transition::FlxTransitionSprite >();
HXDLIN( 120)					_g = (_g + 1);
