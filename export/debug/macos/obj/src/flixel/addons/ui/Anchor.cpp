...
void Anchor_obj::__construct(Float XOff,Float YOff,::String XSide,::String YSide,::String XFlush,::String YFlush){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(XOff,"XOff")
            	HX_STACK_ARG(YOff,"YOff")
            	HX_STACK_ARG(XSide,"XSide")
            	HX_STACK_ARG(YSide,"YSide")
            	HX_STACK_ARG(XFlush,"XFlush")
            	HX_STACK_ARG(YFlush,"YFlush")
HXLINE(  22)
...
HXLINE(  34)
HXLINE(  35)		HX_VARI( Float,destX) = ( (Float)(0) );
HXLINE(  36)		HX_VARI( Float,destY) = ( (Float)(0) );
...
HX_DEFINE_DYNAMIC_FUNC2(Anchor_obj,anchorThing,(void))
 ...
 ::flixel::addons::ui::Anchor Anchor_obj::getFlipped(bool FlipX,bool FlipY, ::flixel::addons::ui::Anchor AnchorObject){
            	...
            	HX_STACK_ARG(AnchorObject,"AnchorObject")
HXLINE(  71)
HXLINE(  72)		HX_VAR( Float,xoff);
HXDLIN(  72)		if (FlipX) {
...
HXLINE(  78)		HX_VAR( ::String,xflush);
HXDLIN(  78)		if (FlipX) {
...
HXLINE(  79)		HX_VAR( ::String,yflush);
HXDLIN(  79)		if (FlipY) {
