...
HXLINE(  33)
HXLINE(  34)		HX_VARI( ::String,border_str) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("border",ec,4c,1a,64),null(),null());
HXLINE(  35)		HX_VARI(  ::flixel::text::FlxTextBorderStyle,border_style) = ::flixel::text::FlxTextBorderStyle_obj::NONE_dyn();
HXLINE(  36)		HX_VARI( int,border_color) = ( (int)(::flixel::addons::ui::U_obj::xml_color(data,HX_("border_color",90,7e,e8,6e),true,0)) );
HXLINE(  37)		HX_VARI( Float,border_size) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("border_size",34,18,b0,f8),1);
HXLINE(  38)		HX_VARI( Float,border_quality) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("border_quality",2c,77,d7,ad),0);
HXLINE(  40)		HX_VARI(  ::flixel::addons::ui::BorderDef,borderDef) =  ::flixel::addons::ui::BorderDef_obj::__alloc( HX_CTX ,border_style,border_color,border_size,border_quality);
