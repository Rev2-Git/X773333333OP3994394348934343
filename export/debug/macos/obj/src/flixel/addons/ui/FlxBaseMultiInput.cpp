...
HXLINE( 108)				HX_VARI( int,i) = _g1->__get(_g);
HXDLIN( 108)				_g = (_g + 1);
...
HXLINE( 118)				HX_VARI_NAME( int,i1,"i") = _g3->__get(_g2);
...
bool FlxBaseMultiInput_obj::passCombosAndForbiddens(::hx::Null< bool >  __o_comboValue,::hx::Null< bool >  __o_forbiddenValue){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(comboValue,"comboValue")
            	HX_STACK_ARG(forbiddenValue,"forbiddenValue")
HXLINE( 133)
HXLINE( 135)		HX_VAR( bool,passCombos);
...
HXLINE( 137)		HX_VAR( bool,passForbiddens);
