...
void FlxButtonPlus_obj::updateButton(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 197)
HXLINE( 198)		HX_VARI( int,prevStatus) = this->_status;
HXLINE( 199)		HX_VARI( bool,offAll) = true;
HXLINE( 201)		{
HXLINE( 201)			int _g = 0;
HXDLIN( 201)			::Array< ::Dynamic> _g1 = this->buttonNormal->get_cameras();
HXDLIN( 201)			while((_g < _g1->length)){
HXLINE( 201)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 201)				_g = (_g + 1);
...
HXLINE( 303)		HX_VARI( Float,w) = this->buttonNormal->get_width();
HXLINE( 304)		HX_VARI( Float,h) = this->buttonNormal->get_height();
HXLINE( 309)		HX_VAR( int,colA);
HXLINE( 310)		HX_VAR( int,colRGB);
HXLINE( 312)		HX_VARI( ::String,normalKey) = ((((HX_("Gradient: ",b6,cc,a6,9a) + w) + HX_(" x ",c8,b0,18,00)) + h) + HX_(", colors: [",51,72,4d,6c));
HXLINE( 314)		{
HXLINE( 314)			int _g = 0;
HXDLIN( 314)			::Array< int > _g1 = this->offColor;
HXDLIN( 314)			while((_g < _g1->length)){
HXLINE( 314)				HX_VARI( int,col) = _g1->__get(_g);
HXDLIN( 314)				_g = (_g + 1);
...
HXDLIN( 326)			HX_VARI_NAME(  ::flixel::graphics::FlxGraphic,normalGraphics2,"normalGraphics") = normalGraphics->create(normalGraphics1,::Std_obj::_hx_int(h),0,false,normalKey);
...
HXDLIN( 331)		_hx_tmp2->set_pixels(( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(normalKey)) )->bitmap);
            	}
...
HXLINE( 342)		HX_VARI( Float,w) = this->buttonHighlight->get_width();
HXLINE( 343)		HX_VARI( Float,h) = this->buttonHighlight->get_height();
HXLINE( 348)		HX_VAR( int,colA);
HXLINE( 349)		HX_VAR( int,colRGB);
HXLINE( 351)		HX_VARI( ::String,highlightKey) = ((((HX_("Gradient: ",b6,cc,a6,9a) + w) + HX_(" x ",c8,b0,18,00)) + h) + HX_(", colors: [",51,72,4d,6c));
HXLINE( 353)		{
HXLINE( 353)			int _g = 0;
HXDLIN( 353)			::Array< int > _g1 = this->onColor;
HXDLIN( 353)			while((_g < _g1->length)){
HXLINE( 353)				HX_VARI( int,col) = _g1->__get(_g);
HXDLIN( 353)				_g = (_g + 1);
...
HXDLIN( 365)			HX_VARI_NAME(  ::flixel::graphics::FlxGraphic,highlightGraphics2,"highlightGraphics") = highlightGraphics->create(highlightGraphics1,::Std_obj::_hx_int(h),0,false,highlightKey);
...
HXDLIN( 370)		_hx_tmp2->set_pixels(( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(highlightKey)) )->bitmap);
            	}
