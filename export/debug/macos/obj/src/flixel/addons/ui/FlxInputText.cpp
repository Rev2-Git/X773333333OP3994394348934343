...
HXLINE( 313)			HX_VARI( bool,hadFocus) = this->hasFocus;
...
HXLINE( 324)					_hx_tmp1 = ::hx::IsNotNull( this->focusLost );
            				}
            				else {
...
HXDLIN( 333)		HX_VARI_NAME(  ::flixel::math::FlxBasePoint,mousePoint1,"mousePoint") = mousePoint->getScreenPosition(this->get_camera(),null());
HXLINE( 334)		HX_VARI(  ::flixel::math::FlxBasePoint,objPoint) = this->getScreenPosition(null(),this->get_camera());
...
HXLINE( 336)			Float mousePoint2 = mousePoint1->x;
HXDLIN( 336)			Float objPoint1 = objPoint->x;
HXLINE( 335)			_hx_tmp1 = (mousePoint2 < (objPoint1 + this->get_width()));
            		}
            		else {
HXLINE( 335)			_hx_tmp1 = false;
            		}
HXDLIN( 335)		if (_hx_tmp1) {
HXLINE( 336)			Float mousePoint3 = mousePoint1->y;
HXDLIN( 336)			Float objPoint2 = objPoint->y;
HXLINE( 335)			_hx_tmp = (mousePoint3 < (objPoint2 + this->get_height()));
            		}
            		else {
...
void FlxInputText_obj::onKeyDown( ::openfl::events::KeyboardEvent e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 347)
HXLINE( 348)		HX_VARI( int,key) = e->keyCode;
...
HXLINE( 375)				HX_VARI( ::String,newText) = this->filter(::lime::_hx_system::Clipboard_obj::get_text());
HXLINE( 377)				bool _hx_tmp2;
HXDLIN( 377)				if ((newText.length > 0)) {
HXLINE( 377)					if ((this->maxLength != 0)) {
HXLINE( 377)						_hx_tmp2 = ((this->text.length + newText.length) < this->maxLength);
            					}
            					else {
...
HXLINE( 391)				_hx_tmp3 = e->commandKey;
            			}
            			else {
...
HXDLIN( 407)			bool _hx_tmp6;
HXDLIN( 407)			if ((key != 16)) {
HXLINE( 407)				_hx_tmp6 = (key == 17);
            			}
            			else {
HXLINE( 407)				_hx_tmp6 = true;
            			}
HXDLIN( 407)			if (!(_hx_tmp6)) {
HXLINE( 407)				_hx_tmp5 = (key == 220);
            			}
            			else {
HXLINE( 407)				_hx_tmp5 = true;
            			}
HXDLIN( 407)			if (!(_hx_tmp5)) {
HXLINE( 407)				_hx_tmp4 = (key == 27);
            			}
            			else {
...
HXLINE( 447)										::String _hx_tmp7 = this->text.substring(0,this->caretIndex);
HXDLIN( 447)										this->set_text((_hx_tmp7 + this->text.substring((this->caretIndex + 1),null())));
...
HXLINE( 454)											_hx_tmp8 = (this->caretIndex < this->text.length);
            										}
            										else {
HXLINE( 454)											_hx_tmp8 = false;
            										}
HXDLIN( 454)										if (_hx_tmp8) {
HXLINE( 456)											::String _hx_tmp9 = this->text.substring(0,this->caretIndex);
HXDLIN( 456)											this->set_text((_hx_tmp9 + this->text.substring((this->caretIndex + 1),null())));
...
HXLINE( 472)											HX_VARI_NAME( ::String,newText1,"newText") = this->filter(::String::fromCharCode(e->charCode));
HXLINE( 474)											bool _hx_tmp10;
HXDLIN( 474)											if ((newText1.length > 0)) {
HXLINE( 474)												if ((this->maxLength != 0)) {
HXLINE( 474)													_hx_tmp10 = ((this->text.length + newText1.length) < this->maxLength);
            												}
            												else {
...
HXLINE( 476)												this->set_text(this->insertSubstring(this->text,newText1,this->caretIndex));
...
HXDLIN( 521)		HX_VARI(  ::flixel::math::FlxBasePoint,hit) = point;
...
HXLINE( 532)			HX_VARI(  ::openfl::geom::Rectangle,r) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
...
HXLINE( 539)				 ::flixel::math::FlxRect _this1 = this->_charBoundaries->__get(charIndex).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 539)				 ::openfl::geom::Rectangle FlashRect1 = r;
HXDLIN( 539)				if (::hx::IsNull( FlashRect1 )) {
HXLINE( 539)					FlashRect1 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            				}
HXDLIN( 539)				FlashRect1->x = _this1->x;
HXDLIN( 539)				FlashRect1->y = _this1->y;
HXDLIN( 539)				FlashRect1->width = _this1->width;
HXDLIN( 539)				FlashRect1->height = _this1->height;
            			}
HXLINE( 541)			return r;
            		}
...
HXLINE( 554)		HX_VARI( ::String,return_text) = this->super::set_text(Text);
HXLINE( 556)		if (::hx::IsNull( this->textField )) {
HXLINE( 558)			return return_text;
            		}
HXLINE( 561)		HX_VARI( int,numChars) = Text.length;
HXLINE( 562)		this->prepareCharBoundaries(numChars);
HXLINE( 563)		this->textField->set_text(HX_("",00,00,00,00));
HXLINE( 564)		HX_VARI( Float,textH) = ( (Float)(0) );
HXLINE( 565)		HX_VARI( Float,textW) = ( (Float)(0) );
HXLINE( 566)		HX_VARI( Float,lastW) = ( (Float)(0) );
HXLINE( 571)		HX_VARI( Float,magicX) = ( (Float)(2) );
HXLINE( 572)		HX_VARI( Float,magicY) = ( (Float)(2) );
HXLINE( 574)		{
HXLINE( 574)			int _g = 0;
...
HXLINE( 603)			Float _hx_tmp1 = this->textField->get_textWidth();
HXDLIN( 603)			if ((_hx_tmp1 <= this->textField->get_width())) {
...
HXLINE( 608)					Float X2 = (X - this->textField->get_width());
HXDLIN( 608)					X = (X2 + this->textField->get_textWidth());
...
HXLINE( 621)				HX_VARI(  ::flixel::math::FlxRect,r) = _g1->__get(_g).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 621)				_g = (_g + 1);
HXLINE( 623)				bool _hx_tmp2;
HXDLIN( 623)				if ((X >= r->x)) {
HXLINE( 623)					_hx_tmp2 = (X <= (r->x + r->width));
            				}
            				else {
...
HXLINE( 632)			_hx_tmp3 = (this->_charBoundaries->length > 0);
            		}
            		else {
...
HXLINE( 653)			HX_VARI( int,diff) = (this->_charBoundaries->length - numChars);
HXLINE( 654)			{
HXLINE( 654)				int _g = 0;
HXDLIN( 654)				int _g1 = diff;
HXDLIN( 654)				while((_g < _g1)){
HXLINE( 654)					_g = (_g + 1);
HXDLIN( 654)					HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 660)			int _g3 = numChars;
HXDLIN( 660)			while((_g2 < _g3)){
HXLINE( 660)				_g2 = (_g2 + 1);
HXDLIN( 660)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 662)				if (((this->_charBoundaries->length - 1) < i1)) {
...
void FlxInputText_obj::onSetTextCheck(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 673)
HXLINE( 675)		HX_VARI(  ::openfl::geom::Rectangle,boundary) = null();
...
HXLINE( 689)			HX_VARI( int,diffW) = 0;
...
HXLINE( 694)				Float _hx_tmp2 = boundary->get_left();
HXDLIN( 694)				if ((_hx_tmp2 < this->lastScroll)) {
...
HXLINE( 738)				 ::flixel::FlxSprite _hx_tmp5 = this->backgroundSprite;
HXDLIN( 738)				int _hx_tmp6 = ::Std_obj::_hx_int(this->get_width());
HXDLIN( 738)				int _hx_tmp7 = ::Std_obj::_hx_int(this->get_height());
HXDLIN( 738)				_hx_tmp5->makeGraphic(_hx_tmp6,_hx_tmp7,this->backgroundColor,null(),null());
...
HXLINE( 753)			HX_VARI( int,cw) = this->caretWidth;
HXLINE( 754)			HX_VARI( int,ch) = ::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) ));
HXLINE( 757)			HX_VARI( int,borderC) = (-16777216 | (this->borderColor & 16777215));
HXLINE( 758)			HX_VARI( int,caretC) = (-16777216 | (this->caretColor & 16777215));
...
HXDLIN( 761)			HX_VARI_NAME( ::String,caretKey1,"caretKey") = (((caretKey + this->borderSize) + HX_(",",2c,00,00,00)) + borderC);
...
HXDLIN( 774)					HX_VARI_NAME(  ::openfl::geom::Rectangle,r3,"r") =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,r,r1,r2,::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) )));
...
HXLINE( 778)					{
HXLINE( 778)						 ::flixel::math::FlxBasePoint this2 = this->caret->offset;
HXDLIN( 778)						this2->set_x(this->caret->offset->set_y(( (Float)(0) )));
            					}
            				}
            				break;
...
HXLINE( 785)					Float r4 = this->borderSize;
HXDLIN( 785)					Float r5 = this->borderSize;
HXDLIN( 785)					int r6 = this->caretWidth;
HXDLIN( 785)					HX_VARI_NAME(  ::openfl::geom::Rectangle,r7,"r") =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,r4,r5,r6,::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) )));
HXLINE( 786)					this->caret->get_pixels()->fillRect(r7,caretC);
HXLINE( 788)					{
HXLINE( 788)						 ::flixel::math::FlxBasePoint this3 = this->caret->offset;
HXDLIN( 788)						this3->set_x(this->caret->offset->set_y(this->borderSize));
            					}
            				}
            				break;
            			}
...
HXLINE( 823)			HX_VAR(  ::EReg,pattern);
...
HXLINE( 849)		HX_VARI(  ::Dynamic,namedValue) =  ::Dynamic(::hx::Anon_obj::Create(2)
...
::String FlxInputText_obj::getAlignStr(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 909)
HXLINE( 910)		HX_VARI( ::String,alignStr) = HX_("left",07,08,b0,47);
...
HXLINE( 919)
HXLINE( 920)		HX_VARI( Float,offx) = ( (Float)(0) );
HXLINE( 922)		HX_VARI( ::String,alignStr) = this->getAlignStr();
...
HXLINE( 931)			goto _hx_goto_32;
            		...
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 927)			Float offx3 = (this->textField->get_width() - ( (Float)(2) ));
HXDLIN( 927)			offx = ((offx3 - this->textField->get_textWidth()) - ( (Float)(2) ));
...
HXLINE( 953)			HX_VARI(  ::openfl::geom::Rectangle,boundaries) = null();
...
HXLINE( 971)					 ::flixel::FlxSprite _hx_tmp4 = this->caret;
HXDLIN( 971)					Float _hx_tmp5 = (offx + boundaries->get_right());
HXDLIN( 971)					_hx_tmp4->set_x((_hx_tmp5 + this->x));
HXLINE( 972)					 ::flixel::FlxSprite _hx_tmp6 = this->caret;
HXDLIN( 972)					Float _hx_tmp7 = boundaries->get_top();
HXDLIN( 972)					_hx_tmp6->set_y((_hx_tmp7 + this->y));
            				}
            				else {
...
HXLINE( 989)		bool _hx_tmp8;
HXDLIN( 989)		if ((this->lines == 1)) {
HXLINE( 989)			Float _hx_tmp9 = this->caret->x;
HXDLIN( 989)			Float _hx_tmp10 = (_hx_tmp9 + this->caret->get_width());
HXDLIN( 989)			Float _hx_tmp11 = this->x;
HXDLIN( 989)			_hx_tmp8 = (_hx_tmp10 > (_hx_tmp11 + this->get_width()));
            		}
            		else {
HXLINE( 989)			_hx_tmp8 = false;
            		}
HXDLIN( 989)		if (_hx_tmp8) {
HXLINE( 991)			 ::flixel::FlxSprite _hx_tmp12 = this->caret;
HXDLIN( 991)			Float _hx_tmp13 = this->x;
HXDLIN( 991)			_hx_tmp12->set_x(((_hx_tmp13 + this->get_width()) - ( (Float)(2) )));
            		}
