...
void FlxMultiGamepadAnalogStick_obj::__construct( ::flixel::input::gamepad::FlxGamepad Gamepad, ::Dynamic Input,::Array< int > Combos,::Array< int > Forbiddens){
            	...
            	HX_STACK_ARG(Combos,"Combos")
            	HX_STACK_ARG(Forbiddens,"Forbiddens")
HXLINE(  16)
...
HXLINE(  61)		HX_VARI( Float,dz) = this->gamepad->get_deadZone();
...
HXLINE( 132)		HX_VARI( bool,value) = false;
HXLINE( 133)		HX_VARI( Float,dz) = this->gamepad->get_deadZone();
