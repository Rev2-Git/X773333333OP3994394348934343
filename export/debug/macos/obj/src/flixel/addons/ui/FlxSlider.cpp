...
void FlxSlider_obj::__construct( ::Dynamic Object,::String VarString,::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< Float >  __o_MinValue,::hx::Null< Float >  __o_MaxValue,::hx::Null< int >  __o_Width,::hx::Null< int >  __o_Height,::hx::Null< int >  __o_Thickness,::hx::Null< int >  __o_Color,::hx::Null< int >  __o_HandleColor){
            	...
            	HX_STACK_ARG(HandleColor,"HandleColor")
HXLINE(  19)
...
HXDLIN( 230)		HX_VARI_NAME( ::String,colorKey6,"colorKey") = (colorKey5 + this->_thickness);
...
HXLINE( 245)		HX_VARI( Float,textOffset) = ((this->_height + this->offset->y) + 3);
...
HXDLIN( 436)		HX_VARI_NAME( Float,pos3,"pos") = (pos + (pos2 * ((this->value - this->minValue) / (this->maxValue - this->minValue))));
...
HXDLIN( 453)		HX_VARI_NAME( Float,pos2,"pos") = (pos / (( (Float)(pos1) ) - this->handle->get_width()));
