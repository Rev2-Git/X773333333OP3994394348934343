...
HXLINE( 346)		this->liveFilePath = liveFilePath_;
...
HXLINE( 359)			{
HXLINE( 359)				HX_VARI(  ::Dynamic,key) = uiVars_->keys();
HXDLIN( 359)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 359)					HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 361)					{
...
HXDLIN( 135)			HX_VARI(  ::flixel::FlxSprite,fs) = list->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 135)			_g = (_g + 1);
HXLINE( 137)			if (::Std_obj::isOfType(fs,::hx::ClassOf< ::flixel::addons::ui::FlxUIGroup >())) {
HXLINE( 139)				HX_VARI(  ::flixel::addons::ui::FlxUIGroup,g) = ::hx::TCast<  ::flixel::addons::ui::FlxUIGroup >::cast(fs);
HXLINE( 140)				this->_tongueSet(g->group->members,tongue);
            			}
            			else {
HXLINE( 142)				if (::Std_obj::isOfType(fs,::hx::ClassOf< ::flixel::addons::ui::FlxUI >())) {
HXLINE( 144)					HX_VARI(  ::flixel::addons::ui::FlxUI,fu) = ::hx::TCast<  ::flixel::addons::ui::FlxUI >::cast(fs);
...
HXLINE( 306)				HX_VARI(  ::Dynamic,key) = this->_asset_index->keys();
HXDLIN( 306)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 306)					HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 308)					HX_VARI( ::Dynamic,thing) = this->_asset_index->get(key1);
HXLINE( 309)					if (::Std_obj::isOfType(thing,::hx::ClassOf< ::flixel::addons::ui::FlxUI >())) {
HXLINE( 311)						HX_VARI(  ::flixel::addons::ui::FlxUI,fui) = ( ( ::flixel::addons::ui::FlxUI)(thing) );
...
HXLINE( 376)				HX_VARI(  ::flixel::FlxSprite,asset) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 376)				_g = (_g + 1);
...
HXLINE( 387)			HX_VARI( bool,skip) = false;
HXLINE( 388)			if (::Std_obj::isOfType(asset,::hx::ClassOf< ::flixel::addons::ui::FlxUIDropDownMenu >())) {
HXLINE( 390)				HX_VARI(  ::flixel::addons::ui::FlxUIDropDownMenu,ddasset) = ( ( ::flixel::addons::ui::FlxUIDropDownMenu)(asset) );
HXLINE( 391)				if (::hx::IsInstanceEq( ddasset,butNotThisOne )) {
HXLINE( 393)					skip = true;
            				}
            			}
HXLINE( 396)			if (!(skip)) {
HXLINE( 398)				HX_VARI( ::Dynamic,ibtn) = asset;
...
HXLINE( 404)				HX_VARI(  ::flixel::addons::ui::FlxUIGroup,g) = ( ( ::flixel::addons::ui::FlxUIGroup)(asset) );
HXLINE( 405)				{
HXLINE( 405)					int _g = 0;
HXDLIN( 405)					::Array< ::Dynamic> _g1 = g->group->members;
HXDLIN( 405)					while((_g < _g1->length)){
HXLINE( 405)						HX_VARI(  ::flixel::FlxSprite,groupAsset) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 405)						_g = (_g + 1);
...
HXLINE( 423)				HX_VARI(  ::flixel::FlxSprite,asset) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 423)				_g = (_g + 1);
...
HXLINE( 457)
HXLINE( 458)		HX_VARI( ::Dynamic,thing) = this->getAsset(key,false);
HXLINE( 459)		if (::hx::IsNull( thing )) {
HXLINE( 461)			HX_VARI(  ::flixel::addons::ui::FlxUIGroup,group) = this->getGroup(key,false);
...
HXLINE( 477)
HXLINE( 478)		HX_VARI(  ::flixel::addons::ui::FlxUIGroup,group) = this->getGroup(key,false);
...
void FlxUI_obj::showAsset(::String key,bool Show, ::Dynamic Active){
            	...
            	HX_STACK_ARG(Active,"Active")
HXLINE( 494)
HXLINE( 495)		HX_VARI( ::Dynamic,asset) = this->getAsset(key,false);
...
HXLINE( 517)
HXLINE( 518)		HX_VARI( ::Dynamic,asset) = this->getAsset(key,false);
...
HXLINE( 554)		HX_VARI(  ::flixel::addons::ui::FlxUIGroup,g) = this->getGroup(group_name,recursive);
...
HXLINE( 577)
HXLINE( 579)		HX_VARI( ::Dynamic,original) = this->getAsset(key,false);
...
HXLINE( 628)			{
HXLINE( 628)				HX_VARI(  ::Dynamic,key) = this->_group_index->keys();
HXDLIN( 628)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 628)					HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 636)			{
HXLINE( 636)				HX_VARI_NAME(  ::Dynamic,key2,"key") = this->_asset_index->keys();
HXDLIN( 636)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 636)					HX_VARI_NAME( ::String,key3,"key") = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 644)			{
HXLINE( 644)				HX_VARI_NAME(  ::Dynamic,key4,"key") = this->_tag_index->keys();
HXDLIN( 644)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 644)					HX_VARI_NAME( ::String,key5,"key") = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 653)			{
HXLINE( 653)				HX_VARI_NAME(  ::Dynamic,key6,"key") = this->_definition_index->keys();
HXDLIN( 653)				while(( (bool)(key6->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 653)					HX_VARI_NAME( ::String,key7,"key") = ( (::String)(key6->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 661)			{
HXLINE( 661)				HX_VARI_NAME(  ::Dynamic,key8,"key") = this->_variable_index->keys();
HXDLIN( 661)				while(( (bool)(key8->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 661)					HX_VARI_NAME( ::String,key9,"key") = ( (::String)(key8->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 669)			{
HXLINE( 669)				HX_VARI_NAME(  ::Dynamic,key10,"key") = this->_mode_index->keys();
HXDLIN( 669)				while(( (bool)(key10->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 669)					HX_VARI_NAME( ::String,key11,"key") = ( (::String)(key10->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 680)					HX_VARI( ::Array< ::Dynamic>,arr) = _g1->__get(_g).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 680)					_g = (_g + 1);
...
HXLINE( 719)				HX_VARI(  ::flixel::addons::ui::FlxUIRegion,screenRegion) =  ::flixel::addons::ui::FlxUIRegion_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,::flixel::FlxG_obj::height);
...
HXLINE( 727)						HX_VARI(  ::Xml,screenNode) = ::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("screen_override",bf,10,cc,3e));
...
HXLINE( 741)					HX_VARI(  ::Xml,inj_data) = ::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("inject",91,4a,ea,97));
HXLINE( 742)					HX_VARI( ::String,inj_name) = ::flixel::addons::ui::U_obj::xml_name(inj_data);
HXLINE( 743)					HX_VARI(  ::Xml,payload) = ( ( ::Xml)(::flixel::addons::ui::U_obj::xml(inj_name,HX_("xml",d7,6d,5b,00),false,null())) );
HXLINE( 744)					if (::hx::IsNotNull( payload )) {
HXLINE( 746)						HX_VARI(  ::Xml,parent) = inj_data->parent;
HXLINE( 747)						HX_VARI( int,i) = 0;
HXLINE( 748)						{
HXLINE( 748)							int _g = 0;
HXDLIN( 748)							::Array< ::Dynamic> _g1 = parent->children;
HXDLIN( 748)							while((_g < _g1->length)){
HXLINE( 748)								HX_VARI(  ::Xml,child) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN( 748)								_g = (_g + 1);
...
HXLINE( 759)							HX_VARI( int,j) = 0;
HXLINE( 760)							{
HXLINE( 760)								HX_VARI(  ::Dynamic,e) = payload->elements();
HXDLIN( 760)								while(( (bool)(e->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 760)									HX_VARI_NAME(  ::Xml,e1,"e") = ( ( ::Xml)(e->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 773)					HX_VARI(  ::Xml,inc_data) = _g3->__get(_g2).StaticCast<  ::Xml >();
HXDLIN( 773)					_g2 = (_g2 + 1);
HXLINE( 775)					HX_VARI( ::String,inc_name) = ::flixel::addons::ui::U_obj::xml_name(inc_data);
HXLINE( 777)					HX_VARI(  ::Xml,liveFile) = null();
HXLINE( 780)					bool _hx_tmp;
HXDLIN( 780)					if (::hx::IsNotNull( this->liveFilePath )) {
HXLINE( 780)						_hx_tmp = (this->liveFilePath != HX_("",00,00,00,00));
            					}
            					else {
...
HXLINE( 784)							liveFile = ::flixel::addons::ui::U_obj::readAccess(::flixel::addons::ui::U_obj::fixSlash(((this->liveFilePath + inc_name) + HX_(".xml",69,3e,c3,1e))));
            						} catch( ::Dynamic _hx_e) {
            							if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            								HX_STACK_BEGIN_CATCH
            								::String msg1 = _hx_e;
HXLINE( 788)								{
HXLINE( 788)									 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 788)									_this1->advanced(msg1,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            								}
HXLINE( 789)								liveFile = null();
            							}
...
HXLINE( 782)								if (::Std_obj::isOfType(_g4->value,::hx::ClassOf< ::String >())) {
HXLINE( 786)									HX_VARI_NAME( ::String,msg1,"msg") = ( (::String)(_g4->value) );
HXLINE( 787)									{
HXLINE( 788)										{
HXLINE( 788)											 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 788)											_this1->advanced(msg1,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
HXLINE( 782)									HX_STACK_DO_THROW(_g4);
            								}
            							}
            							else {
...
HXLINE( 794)					HX_VARI(  ::Xml,inc_xml) = null();
...
HXLINE( 806)						{
HXLINE( 806)							int _g5 = 0;
HXDLIN( 806)							::Array< ::Dynamic> _g6 = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(inc_xml,HX_("definition",93,d5,0d,ec));
HXDLIN( 806)							while((_g5 < _g6->length)){
HXLINE( 806)								HX_VARI(  ::Xml,def_data) = _g6->__get(_g5).StaticCast<  ::Xml >();
HXDLIN( 806)								_g5 = (_g5 + 1);
HXLINE( 809)								HX_VARI( ::String,def_name) = (HX_("include:",12,65,27,66) + ::flixel::addons::ui::U_obj::xml_name(def_data));
...
HXLINE( 826)							int _g7 = 0;
HXDLIN( 826)							::Array< ::Dynamic> _g8 = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(inc_xml,HX_("default",c1,d8,c3,9b));
HXDLIN( 826)							while((_g7 < _g8->length)){
HXLINE( 826)								HX_VARI(  ::Xml,defaultNode) = _g8->__get(_g7).StaticCast<  ::Xml >();
HXDLIN( 826)								_g7 = (_g7 + 1);
HXLINE( 828)								if (this->_loadTest(defaultNode)) {
HXLINE( 830)									HX_VARI( ::String,defaultName) = ::flixel::addons::ui::U_obj::xml_name(defaultNode);
...
HXLINE( 852)				int _g9 = 0;
HXDLIN( 852)				::Array< ::Dynamic> _g10 = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(data,HX_("definition",93,d5,0d,ec));
HXDLIN( 852)				while((_g9 < _g10->length)){
HXLINE( 852)					HX_VARI_NAME(  ::Xml,def_data1,"def_data") = _g10->__get(_g9).StaticCast<  ::Xml >();
HXDLIN( 852)					_g9 = (_g9 + 1);
HXLINE( 854)					if (this->_loadTest(def_data1)) {
HXLINE( 856)						HX_VARI_NAME( ::String,def_name1,"def_name") = ::flixel::addons::ui::U_obj::xml_name(def_data1);
HXLINE( 857)						HX_VARI( ::String,error) = HX_("",00,00,00,00);
...
HXLINE( 882)				int _g11 = 0;
HXDLIN( 882)				::Array< ::Dynamic> _g12 = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(data,HX_("default",c1,d8,c3,9b));
HXDLIN( 882)				while((_g11 < _g12->length)){
HXLINE( 882)					HX_VARI_NAME(  ::Xml,defaultNode1,"defaultNode") = _g12->__get(_g11).StaticCast<  ::Xml >();
HXDLIN( 882)					_g11 = (_g11 + 1);
HXLINE( 884)					if (this->_loadTest(defaultNode1)) {
HXLINE( 886)						HX_VARI_NAME( ::String,defaultName1,"defaultName") = ::flixel::addons::ui::U_obj::xml_name(defaultNode1);
...
HXLINE( 898)				int _g13 = 0;
HXDLIN( 898)				::Array< ::Dynamic> _g14 = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(data,HX_("variable",3c,12,0d,69));
HXDLIN( 898)				while((_g13 < _g14->length)){
HXLINE( 898)					HX_VARI(  ::Xml,var_data) = _g14->__get(_g13).StaticCast<  ::Xml >();
HXDLIN( 898)					_g13 = (_g13 + 1);
HXLINE( 900)					if (this->_loadTest(var_data)) {
HXLINE( 902)						HX_VARI( ::String,var_name) = ::flixel::addons::ui::U_obj::xml_name(var_data);
HXLINE( 903)						HX_VARI( ::String,var_value) = ::flixel::addons::ui::U_obj::xml_str(var_data,HX_("value",71,7f,b8,31),null(),null());
...
HXLINE( 915)				int _g15 = 0;
HXDLIN( 915)				::Array< ::Dynamic> _g16 = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(data,HX_("mode",63,d3,60,48));
HXDLIN( 915)				while((_g15 < _g16->length)){
HXLINE( 915)					HX_VARI(  ::Xml,mode_data) = _g16->__get(_g15).StaticCast<  ::Xml >();
HXDLIN( 915)					_g15 = (_g15 + 1);
HXLINE( 917)					if (this->_loadTest(mode_data)) {
HXLINE( 919)						HX_VARI(  ::Xml,mode_data2) = this->applyNodeConditionals(mode_data);
HXLINE( 920)						HX_VARI( ::String,mode_name) = ::flixel::addons::ui::U_obj::xml_name(mode_data);
...
HXLINE( 933)				int _g17 = 0;
HXDLIN( 933)				::Array< ::Dynamic> _g18 = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(data,HX_("group",3f,b3,f4,99));
HXDLIN( 933)				while((_g17 < _g18->length)){
HXLINE( 933)					HX_VARI(  ::Xml,group_data) = _g18->__get(_g17).StaticCast<  ::Xml >();
HXDLIN( 933)					_g17 = (_g17 + 1);
HXLINE( 935)					if (this->_loadTest(group_data)) {
HXLINE( 938)						HX_VARI( ::String,name) = ::flixel::addons::ui::U_obj::xml_name(group_data);
HXLINE( 939)						HX_VARI( ::String,custom) = ::flixel::addons::ui::U_obj::xml_str(group_data,HX_("custom",b1,87,92,3f),null(),null());
HXLINE( 941)						HX_VARI(  ::flixel::addons::ui::FlxUIGroup,tempGroup) = null();
HXLINE( 944)						if ((custom != HX_("",00,00,00,00))) {
HXLINE( 946)							HX_VARI(  ::Dynamic,result) = ::flixel::addons::ui::interfaces::IEventGetter_obj::getRequest(this->_ptr,HX_("ui_get_group:",2f,b3,b6,b7),::hx::ObjectPtr<OBJ_>(this),custom,null());
HXLINE( 947)							bool _hx_tmp1;
HXDLIN( 947)							if (::hx::IsNotNull( result )) {
HXLINE( 947)								_hx_tmp1 = ::Std_obj::isOfType(result,::hx::ClassOf< ::flixel::addons::ui::FlxUIGroup >());
            							}
            							else {
...
HXLINE( 968)				HX_VARI(  ::Dynamic,node) = data->elements();
HXDLIN( 968)				while(( (bool)(node->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 968)					HX_VARI_NAME(  ::Xml,node1,"node") = ( ( ::Xml)(node->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
void FlxUI_obj::_loadPointSize( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 988)
HXLINE( 989)		HX_VARI( Float,ptx) = this->_loadWidth(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("point_size",50,66,f5,4b)),((Float)-1.0),HX_("x",78,00,00,00),null());
HXLINE( 990)		HX_VARI( Float,pty) = this->_loadHeight(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("point_size",50,66,f5,4b)),((Float)-1.0),HX_("y",79,00,00,00),null());
...
HXDLIN(1012)		HX_VARI( ::String,type) = node->nodeName;
...
HXDLIN(1014)		HX_VARI(  ::Xml,obj) = node;
...
HXLINE(1024)					HX_VARI(  ::Dynamic,subNode) = node->elements();
HXDLIN(1024)					while(( (bool)(subNode->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1024)						HX_VARI_NAME(  ::Xml,subNode1,"subNode") = ( ( ::Xml)(subNode->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1034)		HX_VARI( ::String,group_name) = HX_("",00,00,00,00);
HXLINE(1035)		HX_VARI(  ::flixel::addons::ui::FlxUIGroup,tempGroup) = null();
HXLINE(1037)		HX_VARI( ::String,thing_name) = ::flixel::addons::ui::U_obj::xml_name(obj);
...
HXLINE(1046)		HX_VARI( ::Dynamic,thing) = this->_loadThing(type,obj);
...
HXLINE(1059)				HX_VARI( ::String,thing_tags) = ::flixel::addons::ui::U_obj::xml_str(obj,HX_("tags",d9,b4,f6,4c),null(),null());
HXLINE(1060)				if ((thing_tags != HX_("",00,00,00,00))) {
HXLINE(1062)					HX_VARI( ::Array< ::String >,tagArr) = thing_tags.split(HX_(",",2c,00,00,00));
...
HXDLIN(1084)			HX_VARI( ::String,tag) = arr->__get(_g);
HXDLIN(1084)			_g = (_g + 1);
HXLINE(1086)			HX_VARI( ::Array< ::String >,list) = null();
...
HXLINE(1103)			HX_VARI( bool,isVis) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("visible",72,78,24,a3),true);
HXLINE(1104)			HX_VARI( bool,isActive) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("active",c6,41,46,16),true);
HXLINE(1105)			HX_VARI( int,numID) = ::flixel::addons::ui::U_obj::xml_i(data,HX_("num_id",74,43,78,a1),null());
...
HXLINE(1112)				HX_VARI( Float,alpha) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("alpha",5e,a7,96,21),((Float)1.0));
HXLINE(1113)				HX_VARI(  ::flixel::FlxSprite,s) = ( ( ::flixel::FlxSprite)(thing) );
...
HXLINE(1125)			HX_VARI(  ::Dynamic,node) = data->elements();
HXDLIN(1125)			while(( (bool)(node->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1125)				HX_VARI_NAME(  ::Xml,node1,"node") = ( ( ::Xml)(node->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1133)				HX_VARI(  ::Xml,mode_node) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(1133)				_g = (_g + 1);
HXLINE(1135)				HX_VARI( bool,is_default) = ::flixel::addons::ui::U_obj::xml_bool(mode_node,HX_("is_default",2c,88,79,76),null());
HXLINE(1136)				if (is_default) {
HXLINE(1138)					HX_VARI( ::String,mode_name) = ::flixel::addons::ui::U_obj::xml_name(mode_node);
...
HXLINE(1147)					HX_VARI_NAME(  ::Xml,data1,"data") = _g3->__get(_g2).StaticCast<  ::Xml >();
...
HXLINE(1163)
HXLINE(1164)		HX_VARI(  ::flixel::addons::ui::FlxUIGroup,group) = this->getAssetGroup(null(),thing);
...
void FlxUI_obj::sendToFront(::String name,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1198)
HXLINE(1199)		HX_VARI( ::Dynamic,thing) = this->getAsset(name,recursive);
...
void FlxUI_obj::sendToBack(::String name,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1210)
HXLINE(1211)		HX_VARI( ::Dynamic,thing) = this->getAsset(name,recursive);
...
HXLINE(1240)		HX_VARI(  ::Xml,mode) = this->getMode(mode_name,null());
HXLINE(1241)		this->_curr_mode = mode_name;
HXLINE(1242)		HX_VARI( ::String,name) = HX_("",00,00,00,00);
HXLINE(1243)		HX_VAR( ::Dynamic,thing);
HXLINE(1244)		if ((target_name == HX_("",00,00,00,00))) {
HXLINE(1246)			if (::hx::IsNotNull( mode )) {
HXLINE(1248)				HX_VAR(  ::Xml,xml);
HXLINE(1249)				{
HXLINE(1249)					HX_VARI(  ::Dynamic,node) = mode->elements();
HXDLIN(1249)					while(( (bool)(node->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1249)						HX_VARI_NAME(  ::Xml,node1,"node") = ( ( ::Xml)(node->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1251)						HX_VARI(  ::Xml,node2) = this->applyNodeConditionals(node1);
...
HXDLIN(1254)						HX_VARI( ::String,nodeName) = xml->nodeName;
HXLINE(1257)						HX_VAR(  ::Dynamic,activeStatus);
...
HXLINE(1289)			HX_VARI( ::Dynamic,target) = this->getAsset(target_name,null());
...
HXLINE(1292)				HX_VARI(  ::flixel::addons::ui::FlxUI,targetUI) = ::hx::TCast<  ::flixel::addons::ui::FlxUI >::cast(target);
...
HXLINE(1302)			HX_VARI( ::Array< ::String >,names) = name.split(HX_(",",2c,00,00,00));
HXLINE(1303)			{
HXLINE(1303)				int _g = 0;
HXDLIN(1303)				while((_g < names->length)){
HXLINE(1303)					HX_VARI( ::String,each_name) = names->__get(_g);
HXDLIN(1303)					_g = (_g + 1);
HXLINE(1305)					HX_VARI( ::Dynamic,thing) = this->getAsset(each_name,null());
...
HXLINE(1316)						HX_VARI(  ::flixel::addons::ui::FlxUIGroup,group) = this->getGroup(each_name,null());
...
HXLINE(1332)				HX_VARI_NAME( ::Dynamic,thing1,"thing") = this->getAsset(name,null());
...
HXLINE(1343)					HX_VARI_NAME(  ::flixel::addons::ui::FlxUIGroup,group1,"group") = this->getGroup(name,null());
...
HXLINE(1356)				HX_VARI(  ::Dynamic,asset_name) = this->_asset_index->keys();
HXDLIN(1356)				while(( (bool)(asset_name->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1356)					HX_VARI_NAME( ::String,asset_name1,"asset_name") = ( (::String)(asset_name->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HX_DEFINE_DYNAMIC_FUNC3(FlxUI_obj,showThing,(void))
 ...
 ::flixel::addons::ui::FlxUIGroup FlxUI_obj::getGroup(::String key,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1369)
HXLINE(1370)		HX_VARI(  ::flixel::addons::ui::FlxUIGroup,tempGroup) = ( ( ::flixel::addons::ui::FlxUIGroup)(this->_group_index->get(key)) );
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUI_obj,getGroup,return )
 ...
 ::flixel::text::FlxText FlxUI_obj::getFlxText(::String key,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1379)
HXLINE(1380)		HX_VARI( ::Dynamic,asset) = this->getAsset(key,recursive);
...
::Array< ::Dynamic> FlxUI_obj::getAllAssets(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1392)
HXLINE(1393)		HX_VARI( ::Array< ::Dynamic>,arr) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1394)		{
HXLINE(1394)			HX_VARI(  ::Dynamic,key) = this->_asset_index->keys();
HXDLIN(1394)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1394)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
::Array< ::String > FlxUI_obj::getAssetKeys(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1402)
HXLINE(1403)		HX_VARI( ::Array< ::String >,arr) = ::Array_obj< ::String >::__new(0);
HXLINE(1404)		{
HXLINE(1404)			HX_VARI(  ::Dynamic,key) = this->_asset_index->keys();
HXDLIN(1404)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1404)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
::Dynamic FlxUI_obj::getAsset(::String key,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1425)
HXLINE(1426)		HX_VARI( ::Dynamic,asset) = this->_asset_index->get(key);
...
HXLINE(1438)			HX_VARI( ::Array< ::String >,list) = ( (::Array< ::String >)(this->_tag_index->get(tag)) );
...
HXLINE(1441)			HX_VARI( ::Array< ::Dynamic>,arr) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1442)			{
HXLINE(1442)				int _g = 0;
HXDLIN(1442)				while((_g < list->length)){
HXLINE(1442)					HX_VARI( ::String,key) = list->__get(_g);
HXDLIN(1442)					_g = (_g + 1);
HXLINE(1444)					HX_VARI( ::Dynamic,widget) = this->getAsset(key,null());
...
HXLINE(1470)		{
HXLINE(1470)			HX_VARI_NAME(  ::Dynamic,key1,"key") = this->_group_index->keys();
HXDLIN(1470)			while(( (bool)(key1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1470)				HX_VARI_NAME( ::String,key2,"key") = ( (::String)(key1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1472)				HX_VARI(  ::flixel::addons::ui::FlxUIGroup,g) = ( ( ::flixel::addons::ui::FlxUIGroup)(this->_group_index->get(key2)) );
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUI_obj,getAssetGroup,return )
 ...
 ::Xml FlxUI_obj::getMode(::String key,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1483)
HXLINE(1484)		HX_VARI(  ::Xml,mode) = ( ( ::Xml)(this->_mode_index->get(key)) );
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUI_obj,getMode,return )
 ...
 ::flixel::addons::ui::ButtonLabelStyle FlxUI_obj::getLabelStyleFromDefinition(::String key,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1493)
HXLINE(1494)		HX_VARI(  ::Xml,definition) = this->getDefinition(key,recursive);
HXLINE(1495)		if (::hx::IsNotNull( definition )) {
HXLINE(1497)			HX_VARI(  ::flixel::addons::ui::FontDef,fontDef) = this->_loadFontDef(definition);
HXLINE(1498)			HX_VARI( ::String,align) = ::flixel::addons::ui::U_obj::xml_str(definition,HX_("align",c5,56,91,21),null(),null());
HXLINE(1499)			if ((align == HX_("",00,00,00,00))) {
HXLINE(1501)				align = null();
            			}
HXLINE(1503)			HX_VARI( int,color) = this->_loadColor(definition,null(),null());
HXLINE(1504)			HX_VARI(  ::flixel::addons::ui::BorderDef,border) = this->_loadBorder(definition);
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUI_obj,getLabelStyleFromDefinition,return )
 ...
 ::flixel::addons::ui::ButtonLabelStyle FlxUI_obj::getLabelStyleFromData( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(1511)
HXLINE(1512)		HX_VARI(  ::flixel::addons::ui::FontDef,fontDef) = this->_loadFontDef(data);
HXLINE(1513)		HX_VARI( ::String,align) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("align",c5,56,91,21),null(),null());
HXLINE(1514)		if ((align == HX_("",00,00,00,00))) {
HXLINE(1516)			align = null();
            		}
HXLINE(1518)		HX_VARI( int,color) = this->_loadColor(data,null(),null());
HXLINE(1519)		HX_VARI(  ::flixel::addons::ui::BorderDef,border) = this->_loadBorder(data);
...
bool FlxUI_obj::checkVariable(::String key,::String otherValue,::String type,::String __o_op,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1524)
HXLINE(1525)		HX_VARI( ::String,variable) = this->getVariable(key,recursive);
...
::String FlxUI_obj::getVariable(::String key,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1542)
HXLINE(1543)		HX_VARI( ::String,variable) = this->_variable_index->get_string(key);
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUI_obj,getVariable,return )
 ...
 ::Xml FlxUI_obj::getDefinition(::String key,::hx::Null< bool >  __o_recursive){
            	...
            	HX_STACK_ARG(recursive,"recursive")
HXLINE(1552)
HXLINE(1553)		HX_VARI(  ::Xml,definition) = ( ( ::Xml)(this->_definition_index->get(key)) );
...
HXLINE(1657)			HX_VARI(  ::Dynamic,key) = this->_group_index->keys();
HXDLIN(1657)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1657)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1659)				HX_VARI(  ::flixel::addons::ui::FlxUIGroup,tempGroup) = ( ( ::flixel::addons::ui::FlxUIGroup)(this->_group_index->get(key1)) );
HXLINE(1660)				if (::hx::IsNotNull( tempGroup->group->members )) {
HXLINE(1662)					HX_VARI( int,i) = 0;
HXLINE(1663)					{
HXLINE(1663)						int _g = 0;
HXDLIN(1663)						::Array< ::Dynamic> _g1 = tempGroup->group->members;
HXDLIN(1663)						while((_g < _g1->length)){
HXLINE(1663)							HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(1663)							_g = (_g + 1);
...
HXLINE(1690)			HX_VARI_NAME( int,i1,"i") = 0;
HXLINE(1691)			{
HXLINE(1691)				int _g2 = 0;
HXDLIN(1691)				::Array< ::Dynamic> _g3 = this->group->members;
HXDLIN(1691)				while((_g2 < _g3->length)){
HXLINE(1691)					HX_VARI_NAME(  ::flixel::FlxSprite,member1,"member") = _g3->__get(_g2).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE(1745)
HXLINE(1748)		HX_VARI( ::String,nodeValue) = HX_("",00,00,00,00);
...
HXLINE(1761)		HX_VARI( bool,haxedef) = false;
...
HXLINE(1773)				HX_VARI(  ::Xml,cNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(1773)				_g = (_g + 1);
HXLINE(1775)				HX_VARI( ::String,cname) = ::flixel::addons::ui::U_obj::xml_name(cNode);
...
HXLINE(1790)							HX_VARI(  ::Xml,change) = _g3->__get(_g2).StaticCast<  ::Xml >();
HXDLIN(1790)							_g2 = (_g2 + 1);
HXLINE(1792)							{
HXLINE(1792)								HX_VARI(  ::Dynamic,att) = change->attributes();
HXDLIN(1792)								while(( (bool)(att->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1792)									HX_VARI_NAME( ::String,att1,"att") = ( (::String)(att->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1794)									HX_VARI( ::String,value) = change->get(att1);
...
HXDLIN(1818)		HX_VARI( ::String,nodeName) = _this->nodeName;
HXLINE(1819)		HX_VARI(  ::Xml,defaultDef) = this->getDefinition((HX_("default:",59,d0,99,af) + nodeName),null());
HXLINE(1824)		HX_VARI(  ::Xml,info) = null();
...
HXLINE(1835)		HX_VARI( ::String,use_def) = ::flixel::addons::ui::U_obj::xml_str(info,HX_("use_def",8d,da,e9,62),true,null());
HXLINE(1836)		HX_VARI(  ::Xml,definition) = null();
...
HXLINE(1857)			HX_VARI(  ::Dynamic,tt) = this->_loadTooltipData(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("tooltip",03,ad,8c,6a)));
HXLINE(1858)			HX_VARI( ::Dynamic,state) = ::flixel::addons::ui::FlxUI_obj::getLeafUIState();
HXLINE(1860)			if (::Std_obj::isOfType(thing,::hx::ClassOf< ::flixel::addons::ui::FlxUICheckBox >())) {
HXLINE(1862)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,check) = ( ( ::flixel::addons::ui::FlxUICheckBox)(thing) );
...
HXLINE(1873)
HXLINE(1874)		HX_VARI(  ::Dynamic,tt) =  ::Dynamic(::hx::Anon_obj::Create(4)
...
HXLINE(1903)		HX_VARI(  ::Xml,defaultDef) = this->getDefinition(HX_("default:tooltip",ca,89,56,af),null());
...
HXLINE(1911)			HX_VARI( ::String,defStr) = ::flixel::addons::ui::U_obj::xml_str(tNode,HX_("use_def",8d,da,e9,62),true,null());
HXLINE(1912)			HX_VARI(  ::Xml,def) = this->getDefinition(defStr,null());
...
HXLINE(1951)		HX_VARI( int,padAll) = ::Std_obj::_hx_int(this->_loadHeight(node,-1,HX_("pad_all",f5,34,29,cd),null()));
...
void FlxUI_obj::_loadTooltipText( ::Xml node,::String fieldName, ::Dynamic tt){
            	...
            	HX_STACK_ARG(tt,"tt")
HXLINE(1966)
HXLINE(1967)		HX_VAR( ::String,nodeName);
...
HXLINE(1968)		HX_VARI( ::String,text) = this->_loadString(node,fieldName);
HXLINE(1970)		Float x = this->_loadWidth(node,( (Float)(0) ),HX_("x",78,00,00,00),null());
HXDLIN(1970)		HX_VARI(  ::flixel::math::FlxBasePoint,offset) =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,x,this->_loadHeight(node,( (Float)(0) ),HX_("y",79,00,00,00),null()));
HXLINE(1972)		if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(node,HX_("use_def",8d,da,e9,62))) {
HXLINE(1974)			HX_VARI( ::String,use_def) = ::flixel::addons::ui::U_obj::xml_str(node,HX_("use_def",8d,da,e9,62),true,null());
HXLINE(1975)			HX_VARI(  ::Xml,the_def) = this->getDefinition(use_def,null());
HXLINE(1976)			if (::hx::IsNotNull( the_def )) {
HXLINE(1978)				node = ::flixel::addons::ui::FlxUI_obj::consolidateData(node,the_def,null());
            			}
            		}
HXLINE(1982)		HX_VARI(  ::flixel::addons::ui::BorderDef,border) = this->_loadBorder(node);
HXLINE(1983)		HX_VARI(  ::flixel::addons::ui::FontDef,format) = this->_loadFontDef(node);
HXLINE(1984)		HX_VARI(  ::Dynamic,color) = ::flixel::addons::ui::U_obj::xml_color(node,HX_("color",63,71,5c,4a),true,-16777216);
HXLINE(1985)		format->format->color = color;
HXLINE(1987)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_loadWidth(node,-1,HX_("width",06,b6,62,ca),null()));
...
HX_DEFINE_DYNAMIC_FUNC3(FlxUI_obj,_loadTooltipText,(void))
 ...
 ::flixel::addons::ui::Anchor FlxUI_obj::_loadAnchor( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(2015)
HXLINE(2016)		HX_VARI( Float,xOff) = this->_loadWidth(data,( (Float)(0) ),HX_("x",78,00,00,00),null());
HXLINE(2017)		HX_VARI( Float,yOff) = this->_loadHeight(data,( (Float)(0) ),HX_("y",79,00,00,00),null());
HXLINE(2018)		if (::haxe::xml::_Access::HasNodeAccess_Impl__obj::resolve(data,HX_("anchor",75,3a,71,60))) {
HXLINE(2020)			HX_VARI( ::String,xSide) = ::flixel::addons::ui::U_obj::xml_str(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("anchor",75,3a,71,60)),HX_("x",78,00,00,00),true,HX_("right",dc,0b,64,e9));
HXLINE(2021)			HX_VARI( ::String,ySide) = ::flixel::addons::ui::U_obj::xml_str(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("anchor",75,3a,71,60)),HX_("y",79,00,00,00),true,HX_("top",95,66,58,00));
HXLINE(2022)			HX_VARI( ::String,xFlush) = ::flixel::addons::ui::U_obj::xml_str(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("anchor",75,3a,71,60)),HX_("x-flush",ef,49,ba,7e),true,HX_("left",07,08,b0,47));
HXLINE(2023)			HX_VARI( ::String,yFlush) = ::flixel::addons::ui::U_obj::xml_str(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("anchor",75,3a,71,60)),HX_("y-flush",b0,c0,4f,a8),true,HX_("top",95,66,58,00));
...
::Dynamic FlxUI_obj::_loadThing(::String type, ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(2030)
HXLINE(2031)		HX_VARI(  ::Xml,info) = this->_loadThingGetInfo(data);
...
HXLINE(2094)			HX_VARI( ::Dynamic,thing) = this->getAsset(this->name,null());
...
HXDLIN(2075)			goto _hx_goto_107;
            		...
            		/* default */{
HXLINE(2103)			HX_VARI( ::Dynamic,result) = ::flixel::addons::ui::interfaces::IEventGetter_obj::getRequest(this->_ptr,(HX_("ui_get:",ef,47,3b,f4) + type),::hx::ObjectPtr<OBJ_>(this),info,::cpp::VirtualArray_obj::__new(1)->init(0,data));
...
HXLINE(2136)
HXLINE(2137)		HX_VARI( ::String,ws) = ::flixel::addons::ui::U_obj::xml_str(data,str,true,::Std_obj::string(default_));
HXLINE(2138)		HX_VARI(  ::flixel::addons::ui::Rounding,round) = this->getRound(data,defaultRound);
...
Float FlxUI_obj::_loadHeight( ::Xml data,::hx::Null< Float >  __o_default_,::String __o_str,::String __o_defaultRound){
            	...
            	HX_STACK_ARG(defaultRound,"defaultRound")
HXLINE(2143)
HXLINE(2144)		HX_VARI( ::String,hs) = ::flixel::addons::ui::U_obj::xml_str(data,str,true,::Std_obj::string(default_));
HXLINE(2145)		HX_VARI(  ::flixel::addons::ui::Rounding,round) = this->getRound(data,defaultRound);
...
HX_DEFINE_DYNAMIC_FUNC4(FlxUI_obj,_loadHeight,return )
 ...
 ::flixel::math::FlxBasePoint FlxUI_obj::_loadCompass( ::Xml data,::String __o_str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(2150)
HXLINE(2151)		HX_VARI( ::String,cs) = ::flixel::addons::ui::U_obj::xml_str(data,str,true,HX_("nw",49,60,00,00));
...
HXDLIN(2152)		HX_VARI(  ::flixel::math::FlxBasePoint,fp) = point;
...
void FlxUI_obj::_changeParamsThing( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(2187)
HXLINE(2188)		HX_VARI( ::String,name) = ::flixel::addons::ui::U_obj::xml_name(data);
HXLINE(2189)		HX_VARI( ::Dynamic,thing) = this->getAsset(name,null());
...
HXLINE(2200)		HX_VARI( ::Dynamic,ihp) = thing;
...
void FlxUI_obj::_changeThing( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(2205)
HXLINE(2206)		HX_VARI( ::String,name) = ::flixel::addons::ui::U_obj::xml_name(data);
HXLINE(2207)		HX_VARI( ::Dynamic,thing) = this->getAsset(name,null());
HXLINE(2208)		if (::hx::IsNull( thing )) {
HXLINE(2210)			return;
            		}
HXLINE(2213)		HX_VARI( Float,new_width) = ( (Float)(-1) );
HXLINE(2214)		HX_VARI( Float,new_height) = ( (Float)(-1) );
HXLINE(2216)		HX_VARI( ::String,context) = HX_("",00,00,00,00);
HXLINE(2217)		HX_VARI( ::String,code) = HX_("",00,00,00,00);
HXLINE(2219)		{
HXLINE(2219)			HX_VARI(  ::Dynamic,attribute) = data->attributes();
HXDLIN(2219)			while(( (bool)(attribute->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2219)				HX_VARI_NAME( ::String,attribute1,"attribute") = ( (::String)(attribute->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(2233)					HX_VARI( ::String,label) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("label",f4,0d,af,6f),null(),null());
...
HXLINE(2239)						HX_VARI( ::Dynamic,b) = thing;
...
HXLINE(2226)						HX_VARI( ::String,text) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("text",ad,cc,f9,4c),null(),null());
HXLINE(2227)						context = ::flixel::addons::ui::U_obj::xml_str(data,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(2228)						HX_VARI(  ::flixel::addons::ui::FlxUIText,t) = ( ( ::flixel::addons::ui::FlxUIText)(thing) );
...
HXLINE(2250)			HX_VARI( ::Dynamic,ir) = thing;
...
HXLINE(2269)				HX_VARI( ::Dynamic,ihp) = thing;
...
HXLINE(2279)				HX_VARI(  ::Xml,objectNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(2279)				_g = (_g + 1);
HXLINE(2281)				HX_VARI( ::Array< ::String >,objects) = ::flixel::addons::ui::U_obj::xml_str(objectNode,HX_("value",71,7f,b8,31),true,HX_("",00,00,00,00)).split(HX_(",",2c,00,00,00));
HXLINE(2283)				HX_VARI( ::String,axis) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("axis",a1,1c,79,40),true,null());
...
HXLINE(2290)				HX_VARI( Float,spacing) = ( (Float)(-1) );
...
HXLINE(2300)				HX_VARI( bool,resize) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("resize",f4,59,7b,08),null());
HXLINE(2302)				HX_VARI( bool,grow) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("grow",13,dc,6b,44),true);
HXLINE(2303)				HX_VARI( bool,shrink) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("shrink",c9,32,61,28),true);
HXLINE(2305)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(-1,-1);
HXDLIN(2305)				point->_inPool = false;
HXDLIN(2305)				HX_VARI(  ::flixel::math::FlxBasePoint,bounds) = point;
HXLINE(2307)				HX_VARI( ::String,boundsError) = HX_("",00,00,00,00);
...
HXLINE(2342)						HX_VARI( ::String,object) = objects->__get(_g2);
HXDLIN(2342)						_g2 = (_g2 + 1);
HXLINE(2344)						HX_VARI( ::Dynamic,thing) = this->getAsset(object,null());
...
HXLINE(2369)
HXLINE(2370)		HX_VARI( Float,total_spacing) = ( (Float)(0) );
HXLINE(2371)		HX_VARI( Float,total_size) = ( (Float)(0) );
HXLINE(2373)		HX_VARI( Float,bound_range) = (bounds->y - bounds->x);
HXLINE(2375)		HX_VARI( Float,spaces) = ( (Float)((objects->length - 1)) );
HXLINE(2376)		HX_VARI( Float,space_size) = ( (Float)(0) );
HXLINE(2377)		HX_VARI( Float,object_size) = ( (Float)(0) );
HXLINE(2379)		HX_VARI( ::String,size_prop) = HX_("width",06,b6,62,ca);
HXLINE(2380)		HX_VARI( ::String,pos_prop) = HX_("x",78,00,00,00);
...
HXLINE(2388)				HX_VARI( ::String,nameStr) = objects->__get(_g);
HXDLIN(2388)				_g = (_g + 1);
HXLINE(2390)				HX_VARI( ::Dynamic,widget) = this->getAsset(nameStr,null());
HXLINE(2391)				if (::hx::IsNotNull( widget )) {
HXLINE(2393)					HX_VARI( Float,theval) = ( (Float)(0) );
...
HXLINE(2421)		HX_VARI( Float,last_pos) = bounds->x;
HXLINE(2422)		{
HXLINE(2422)			int _g1 = 0;
HXDLIN(2422)			while((_g1 < objects->length)){
HXLINE(2422)				HX_VARI_NAME( ::String,nameStr1,"nameStr") = objects->__get(_g1);
HXDLIN(2422)				_g1 = (_g1 + 1);
HXLINE(2424)				HX_VARI_NAME( ::Dynamic,widget1,"widget") = this->getAsset(nameStr1,null());
HXLINE(2425)				if (::hx::IsNotNull( widget1 )) {
HXLINE(2427)					HX_VARI( Float,pos) = last_pos;
...
HXLINE(2443)							HX_VARI( bool,allow) = true;
HXLINE(2444)							HX_VARI( ::Dynamic,widgetr) = widget1;
...
bool FlxUI_obj::_checkFailure( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(2492)
HXLINE(2493)		HX_VARI( ::String,target) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("target",51,f3,ec,86),true,null());
HXLINE(2494)		HX_VARI( ::String,property) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("property",55,48,38,ac),true,null());
HXLINE(2495)		HX_VARI( ::String,compare) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("compare",a5,18,69,83),true,null());
HXLINE(2496)		HX_VARI( ::String,value) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("value",71,7f,b8,31),true,null());
HXLINE(2498)		HX_VARI( ::Dynamic,thing) = this->getAsset(target,null());
HXLINE(2500)		if (::hx::IsNull( thing )) {
HXLINE(2502)			return false;
            		}
HXLINE(2505)		HX_VARI( Float,prop_f) = ( (Float)(0) );
HXLINE(2506)		HX_VARI( Float,val_f) = ( (Float)(0) );
HXLINE(2508)		HX_VARI( Float,p) = ::flixel::addons::ui::U_obj::perc_to_float(value);
...
HXLINE(2540)		HX_VARI( bool,return_val) = false;
...
void FlxUI_obj::_resizeThing(::Dynamic fo_r, ::Dynamic bounds){
            	...
            	HX_STACK_ARG(bounds,"bounds")
HXLINE(2586)
HXLINE(2587)		HX_VARI( bool,do_resize) = false;
HXLINE(2588)		HX_VARI( Float,ww) = ::flixel::addons::ui::interfaces::IResizable_obj::get_width(fo_r);
HXLINE(2589)		HX_VARI( Float,hh) = ::flixel::addons::ui::interfaces::IResizable_obj::get_height(fo_r);
...
HXLINE(2627)					HX_VARI(  ::Dynamic,subNode) = data->elements();
HXDLIN(2627)					while(( (bool)(subNode->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2627)						HX_VARI_NAME(  ::Xml,subNode1,"subNode") = ( ( ::Xml)(subNode->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN(2629)						HX_VARI( ::String,nodeType) = subNode1->nodeName.toLowerCase();
...
HXLINE(2642)		HX_VARI( ::String,name) = ::flixel::addons::ui::U_obj::xml_name(data);
HXLINE(2644)		HX_VARI( ::Dynamic,thing) = this->getAsset(name,null());
HXLINE(2645)		HX_VARI( bool,isGroup) = (type == HX_("group",3f,b3,f4,99));
...
HXLINE(2679)			HX_VARI( ::String,use_def) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("use_def",8d,da,e9,62),true,null());
HXLINE(2680)			HX_VARI(  ::Xml,definition) = null();
...
HXLINE(2688)				HX_VARI(  ::Dynamic,ww) = this->_getDataSize(HX_("w",77,00,00,00),::flixel::addons::ui::U_obj::xml_str(data,HX_("width",06,b6,62,ca),null(),null()),null());
HXLINE(2689)				HX_VARI(  ::Dynamic,hh) = this->_getDataSize(HX_("h",68,00,00,00),::flixel::addons::ui::U_obj::xml_str(data,HX_("height",e7,07,4c,02),null(),null()),null());
...
HXLINE(2699)				HX_VARI(  ::Dynamic,bounds) = this->calcMaxMinSize(data,null(),null());
...
HXLINE(2736)		HX_VARI( ::String,send_to) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("send_to",52,6b,a5,a8),true,HX_("",00,00,00,00));
...
HXLINE(2750)			HX_VARI(  ::flixel::addons::ui::FlxUI,fui_thing) = ( ( ::flixel::addons::ui::FlxUI)(thing) );
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUI_obj,_postLoadThing,(void))
 ...
 ::flixel::addons::ui::FlxUITileTest FlxUI_obj::_loadTileTest( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(2759)
HXLINE(2760)		HX_VARI( int,tiles_w) = ::flixel::addons::ui::U_obj::xml_i(data,HX_("tiles_w",fd,7b,93,45),2);
HXLINE(2761)		HX_VARI( int,tiles_h) = ::flixel::addons::ui::U_obj::xml_i(data,HX_("tiles_h",ee,7b,93,45),2);
HXLINE(2762)		HX_VARI( Float,w) = this->_loadWidth(data,null(),null(),null());
HXLINE(2763)		HX_VARI( Float,h) = this->_loadHeight(data,null(),null(),null());
HXLINE(2765)		HX_VARI(  ::Dynamic,bounds) = this->calcMaxMinSize(data,null(),null());
...
HXLINE(2782)		HX_VARI( int,tileWidth) = ::Std_obj::_hx_int((w / ( (Float)(tiles_w) )));
HXLINE(2783)		HX_VARI( int,tileHeight) = ::Std_obj::_hx_int((h / ( (Float)(tiles_h) )));
...
HXLINE(2794)		HX_VARI( Float,totalw) = ( (Float)((tileWidth * tiles_w)) );
HXLINE(2795)		HX_VARI( Float,totalh) = ( (Float)((tileHeight * tiles_h)) );
...
HXLINE(2824)		HX_VARI( int,color1) = ( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(::flixel::addons::ui::U_obj::xml_str(data,HX_("color1",6e,c5,86,c6),true,HX_("0x808080",30,ad,e5,63)))) );
HXLINE(2825)		HX_VARI( int,color2) = ( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(::flixel::addons::ui::U_obj::xml_str(data,HX_("color2",6f,c5,86,c6),true,HX_("0xc4c4c4",5b,de,47,ff)))) );
HXLINE(2827)		HX_VARI( int,baseTileSize) = ::flixel::addons::ui::U_obj::xml_i(data,HX_("base_tile_size",c4,2d,3d,a8),-1);
HXLINE(2828)		HX_VARI( bool,floorToEven) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("floor_to_even",eb,3e,ec,20),false);
HXLINE(2830)		HX_VARI(  ::flixel::addons::ui::FlxUITileTest,ftt) =  ::flixel::addons::ui::FlxUITileTest_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),tileWidth,tileHeight,tiles_w,tiles_h,color1,color2,floorToEven);
...
HXLINE(2836)
HXLINE(2837)		HX_VARI( ::String,string) = ::flixel::addons::ui::U_obj::xml_str(data,attributeName,null(),null());
HXLINE(2838)		HX_VARI( ::String,context) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(2839)		HX_VARI( ::String,code) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("code",2d,b1,c4,41),true,HX_("",00,00,00,00));
...
::Dynamic FlxUI_obj::_loadText( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(2845)
HXLINE(2846)		HX_VARI( ::String,text) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("text",ad,cc,f9,4c),null(),null());
HXLINE(2847)		HX_VARI( ::String,context) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(2848)		HX_VARI( ::String,code) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("code",2d,b1,c4,41),true,HX_("",00,00,00,00));
HXLINE(2849)		text = this->getText(text,context,true,code);
HXLINE(2851)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_loadWidth(data,100,null(),null()));
HXLINE(2852)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_loadHeight(data,-1,null(),null()));
HXLINE(2854)		HX_VARI( ::String,the_font) = this->_loadFontFace(data);
HXLINE(2856)		HX_VARI( bool,input) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("input",0a,c4,1d,be),null());
...
HXLINE(2862)		HX_VARI( ::String,align) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("align",c5,56,91,21),null(),null());
HXLINE(2863)		if ((align == HX_("",00,00,00,00))) {
HXLINE(2865)			align = null();
            		}
HXLINE(2867)		HX_VARI( int,size) = ::Std_obj::_hx_int(this->_loadHeight(data,8,HX_("size",c1,a0,53,4c),HX_("floor",cc,d1,96,02)));
HXLINE(2869)		HX_VARI( int,color) = this->_loadColor(data,null(),null());
HXLINE(2871)		HX_VARI(  ::flixel::addons::ui::BorderDef,border) = this->_loadBorder(data);
HXLINE(2874)		HX_VARI(  ::flixel::addons::ui::FlxUIText,ftu) =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,0,0,W,text,size,null());
...
HXLINE(2873)		HX_VARI( ::Dynamic,ft) = ftu;
...
HXDLIN(2882)			HX_VARI_NAME( ::cpp::VirtualArray,params1,"params") = params;
HXLINE(2883)			HX_VARI( ::Dynamic,ihp) = ft;
...
HXLINE(2891)				HX_VARI( ::Dynamic,r) = ft;
...
::Dynamic FlxUI_obj::_loadInputText( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(2904)
HXLINE(2905)		HX_VARI( ::String,text) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("text",ad,cc,f9,4c),null(),null());
HXLINE(2906)		HX_VARI( ::String,context) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(2907)		HX_VARI( ::String,code) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("code",2d,b1,c4,41),true,HX_("",00,00,00,00));
HXLINE(2908)		text = this->getText(text,context,true,code);
HXLINE(2910)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_loadWidth(data,100,null(),null()));
HXLINE(2911)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_loadHeight(data,-1,null(),null()));
HXLINE(2913)		HX_VARI( ::String,the_font) = this->_loadFontFace(data);
HXLINE(2915)		HX_VARI( ::String,align) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("align",c5,56,91,21),null(),null());
HXLINE(2916)		if ((align == HX_("",00,00,00,00))) {
HXLINE(2918)			align = null();
            		}
HXLINE(2920)		HX_VARI( int,size) = ::Std_obj::_hx_int(this->_loadHeight(data,8,HX_("size",c1,a0,53,4c),null()));
HXLINE(2921)		HX_VARI( int,color) = this->_loadColor(data,null(),null());
HXLINE(2923)		HX_VARI(  ::flixel::addons::ui::BorderDef,border) = this->_loadBorder(data);
...
HXDLIN(2925)		HX_VARI( int,backgroundColor) = ( (int)(return_val) );
HXLINE(2926)		HX_VARI( bool,passwordMode) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("password_mode",47,aa,e5,09),null());
HXLINE(2929)		HX_VARI(  ::flixel::addons::ui::FlxUIInputText,fti) =  ::flixel::addons::ui::FlxUIInputText_obj::__alloc( HX_CTX ,0,0,W,text,size,color,backgroundColor,null());
HXLINE(2930)		fti->set_passwordMode(passwordMode);
HXLINE(2932)		HX_VARI( ::String,force_case) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("force_case",c4,b4,72,f8),true,HX_("",00,00,00,00));
HXLINE(2933)		HX_VAR( int,forceCase);
...
HXLINE(2943)			forceCase = 0;
            		...
            		_hx_goto_151:;
HXLINE(2946)		HX_VARI( ::String,filter) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("filter",b8,1f,35,85),true,HX_("",00,00,00,00));
HXLINE(2947)		HX_VAR( int,filterMode);
...
HXLINE(2928)		HX_VARI( ::Dynamic,ft) = fti;
...
HXDLIN(2976)			HX_VARI_NAME( ::cpp::VirtualArray,params1,"params") = params;
HXLINE(2977)			HX_VARI( ::Dynamic,ihp) = ft;
...
HXLINE(2985)				HX_VARI( ::Dynamic,r) = ft;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,_loadInputText,return )
 ...
 ::flixel::addons::ui::FlxUIRadioGroup FlxUI_obj::_loadRadioGroup( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(3069)
HXLINE(3070)		HX_VARI(  ::flixel::addons::ui::FlxUIRadioGroup,frg) = null();
HXLINE(3072)		HX_VARI( ::String,dot_src) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("dot_src",ee,a6,9d,a9),true,null());
HXLINE(3073)		HX_VARI( ::String,radio_src) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("radio_src",60,96,16,fe),true,null());
HXLINE(3075)		HX_VARI( ::Array< ::String >,labels) = ::Array_obj< ::String >::__new();
HXLINE(3076)		HX_VARI( ::Array< ::String >,names) = ::Array_obj< ::String >::__new();
HXLINE(3078)		HX_VARI( int,W) = ( (int)(this->_loadWidth(data,11,HX_("radio_width",82,7c,59,e9),null())) );
HXLINE(3079)		HX_VARI( int,H) = ( (int)(this->_loadHeight(data,11,HX_("radio_height",eb,ed,42,fb),null())) );
HXLINE(3081)		HX_VARI( int,scrollH) = ( (int)(this->_loadHeight(data,0,HX_("height",e7,07,4c,02),null())) );
HXLINE(3082)		HX_VARI( int,scrollW) = ( (int)(this->_loadHeight(data,0,HX_("width",06,b6,62,ca),null())) );
HXLINE(3084)		HX_VARI( int,labelW) = ( (int)(this->_loadWidth(data,100,HX_("label_width",3b,fa,b5,dc),null())) );
HXLINE(3086)		{
...
HXLINE(3086)				HX_VARI(  ::Xml,radioNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(3086)				_g = (_g + 1);
HXLINE(3088)				HX_VARI( ::String,name) = ::flixel::addons::ui::U_obj::xml_name(radioNode);
HXLINE(3089)				HX_VARI( ::String,label) = ::flixel::addons::ui::U_obj::xml_str(radioNode,HX_("label",f4,0d,af,6f),null(),null());
HXLINE(3091)				HX_VARI( ::String,context) = ::flixel::addons::ui::U_obj::xml_str(radioNode,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(3092)				HX_VARI( ::String,code) = ::flixel::addons::ui::U_obj::xml_str(radioNode,HX_("code",2d,b1,c4,41),true,HX_("",00,00,00,00));
...
HXLINE(3102)		HX_VARI( Float,y_space) = this->_loadHeight(data,25,HX_("y_space",40,f5,f2,24),null());
...
HXDLIN(3104)		HX_VARI_NAME( ::cpp::VirtualArray,params1,"params") = params;
HXLINE(3112)		HX_VARI(  ::Dynamic,radio_asset) = null();
...
HXLINE(3132)		HX_VARI(  ::Dynamic,dot_asset) = null();
...
HXLINE(3155)		HX_VARI(  ::flixel::math::FlxBasePoint,prevOffset) = null();
HXLINE(3156)		HX_VARI(  ::flixel::math::FlxBasePoint,nextOffset) = null();
...
HXLINE(3160)				HX_VARI(  ::Xml,btnNode) = _g7->__get(_g6).StaticCast<  ::Xml >();
HXDLIN(3160)				_g6 = (_g6 + 1);
HXLINE(3162)				HX_VARI_NAME( ::String,name1,"name") = ::flixel::addons::ui::U_obj::xml_name(btnNode);
...
HXDLIN(3169)						 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y1);
...
HXLINE(3182)		HX_VARI( int,text_x) = ::Std_obj::_hx_int(this->_loadWidth(data,0,HX_("text_x",26,65,88,d8),null()));
HXLINE(3183)		HX_VARI( int,text_y) = ::Std_obj::_hx_int(this->_loadHeight(data,0,HX_("text_y",27,65,88,d8),null()));
HXLINE(3185)		HX_VARI( ::Array< ::Dynamic>,radios) = frg->getRadios();
HXLINE(3186)		HX_VARI_NAME( int,i1,"i") = 0;
HXLINE(3187)		HX_VARI( bool,styleSet) = false;
HXLINE(3189)		HX_VARI(  ::Dynamic,radioList) = data->elementsNamed(HX_("radio",fb,10,18,e4));
HXLINE(3190)		HX_VARI_NAME(  ::Xml,radioNode1,"radioNode") = null();
HXLINE(3192)		{
HXLINE(3192)			int _g8 = 0;
HXDLIN(3192)			int _g9 = radios->length;
HXDLIN(3192)			while((_g8 < _g9)){
HXLINE(3192)				_g8 = (_g8 + 1);
HXDLIN(3192)				HX_VARI( int,k) = (_g8 - 1);
HXLINE(3194)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,fo) = radios->__get(((radios->length - 1) - k)).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
...
HXLINE(3200)						HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,fc) = fo;
HXLINE(3201)						HX_VARI(  ::flixel::text::FlxText,t) = this->formatButtonText(data,fc);
...
HXLINE(3204)							HX_VARI(  ::flixel::addons::ui::FontDef,fd) = ::flixel::addons::ui::FontDef_obj::copyFromFlxText(t);
HXLINE(3205)							HX_VARI(  ::flixel::addons::ui::BorderDef,bd) =  ::flixel::addons::ui::BorderDef_obj::__alloc( HX_CTX ,t->borderStyle,t->borderColor,t->borderSize,t->borderQuality);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,_loadRadioGroup,return )
 ...
 ::flixel::addons::ui::FlxUICheckBox FlxUI_obj::_loadCheckBox( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(3235)
HXLINE(3236)		HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,fc) = null();
HXLINE(3238)		HX_VARI( ::String,label) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("label",f4,0d,af,6f),null(),null());
HXLINE(3239)		HX_VARI( ::String,context) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(3240)		HX_VARI( ::String,code) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("code",2d,b1,c4,41),true,HX_("",00,00,00,00));
HXLINE(3242)		HX_VARI( bool,checked) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("checked",27,b3,24,13),false);
HXLINE(3244)		label = this->getText(label,context,true,code);
HXLINE(3246)		HX_VARI( int,labelW) = ( (int)(this->_loadWidth(data,100,HX_("label_width",3b,fa,b5,dc),null())) );
HXLINE(3248)		HX_VARI( ::String,check_src) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("check_src",ad,88,29,a8),true,null());
HXLINE(3249)		HX_VARI( ::String,box_src) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("box_src",70,0b,0d,a4),true,null());
...
HXDLIN(3251)		HX_VARI_NAME( ::cpp::VirtualArray,params1,"params") = params;
HXLINE(3253)		HX_VARI(  ::Dynamic,box_asset) = null();
HXLINE(3254)		HX_VARI(  ::Dynamic,check_asset) = null();
...
HXLINE(3305)		HX_VARI( int,text_x) = ::Std_obj::_hx_int(this->_loadWidth(data,0,HX_("text_x",26,65,88,d8),null()));
HXLINE(3306)		HX_VARI( int,text_y) = ::Std_obj::_hx_int(this->_loadHeight(data,0,HX_("text_y",27,65,88,d8),null()));
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,_loadCheckBox,return )
 ...
 ::flixel::addons::ui::FlxUIDropDownMenu FlxUI_obj::_loadDropDownMenu( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(3319)
HXLINE(3343)		HX_VARI(  ::flixel::addons::ui::FlxUIDropDownMenu,fud) = null();
HXLINE(3345)		HX_VARI( ::String,label) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("label",f4,0d,af,6f),null(),null());
HXLINE(3346)		HX_VARI( ::String,context) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(3347)		HX_VARI( ::String,code) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("code",2d,b1,c4,41),true,HX_("",00,00,00,00));
HXLINE(3348)		label = this->getText(label,context,true,code);
HXLINE(3350)		HX_VARI( ::String,back_def) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("back_def",6d,f8,3d,17),true,null());
HXLINE(3351)		HX_VARI( ::String,panel_def) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("panel_def",ca,cb,5d,a4),true,null());
HXLINE(3352)		HX_VARI( ::String,button_def) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("button_def",b8,c1,34,be),true,null());
HXLINE(3353)		HX_VARI( ::String,label_def) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("label_def",ba,96,96,65),true,null());
HXLINE(3355)		HX_VARI(  ::flixel::FlxSprite,back_asset) = null();
HXLINE(3356)		HX_VARI(  ::flixel::addons::ui::FlxUI9SliceSprite,panel_asset) = null();
HXLINE(3357)		HX_VARI(  ::flixel::addons::ui::FlxUISpriteButton,button_asset) = null();
HXLINE(3358)		HX_VARI(  ::flixel::addons::ui::FlxUIText,label_asset) = null();
...
HXLINE(3400)		HX_VARI( ::Array< ::Dynamic>,asset_list) = null();
HXLINE(3401)		HX_VARI( ::Array< ::Dynamic>,data_list) = null();
...
HXLINE(3405)				HX_VARI(  ::Xml,dataNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(3405)				_g = (_g + 1);
...
HXDLIN(3411)				HX_VARI_NAME(  ::flixel::addons::ui::StrNameLabel,namel1,"namel") =  ::flixel::addons::ui::StrNameLabel_obj::__alloc( HX_CTX ,namel,::flixel::addons::ui::U_obj::xml_str(dataNode,HX_("label",f4,0d,af,6f),null(),null()));
...
HXLINE(3417)					HX_VARI(  ::Xml,assetNode) = _g3->__get(_g2).StaticCast<  ::Xml >();
HXDLIN(3417)					_g2 = (_g2 + 1);
HXLINE(3419)					if (::hx::IsNull( asset_list )) {
HXLINE(3421)						asset_list = ::Array_obj< ::Dynamic>::__new();
            					}
HXLINE(3423)					HX_VARI( ::String,def_name) = ::flixel::addons::ui::U_obj::xml_str(assetNode,HX_("def",c5,39,4c,00),true,null());
HXLINE(3424)					HX_VARI( ::String,name) = ::flixel::addons::ui::U_obj::xml_name(assetNode);
HXLINE(3425)					HX_VARI(  ::flixel::addons::ui::FlxUIButton,asset) = null();
HXLINE(3427)					try {
            						HX_STACK_CATCHABLE( ::openfl::errors::Error, 0);
...
HXLINE(3448)		HX_VARI(  ::flixel::addons::ui::FlxUIDropDownHeader,header) =  ::flixel::addons::ui::FlxUIDropDownHeader_obj::__alloc( HX_CTX ,120,back_asset,label_asset,button_asset);
...
bool FlxUI_obj::_loadTest( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(3455)
HXLINE(3456)		HX_VARI( bool,result) = true;
...
HXLINE(3489)				HX_VARI(  ::Xml,node) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(3489)				_g = (_g + 1);
...
bool FlxUI_obj::_loadTestSub( ::Xml node){
            	...
            	HX_STACK_ARG(node,"node")
HXLINE(3505)
HXLINE(3506)		HX_VARI( bool,matchValue) = ::flixel::addons::ui::U_obj::xml_bool(node,HX_("is",ea,5b,00,00),true);
HXLINE(3507)		HX_VARI( bool,match) = matchValue;
HXLINE(3510)		HX_VARI( Float,aspect_ratio) = ::flixel::addons::ui::U_obj::xml_f(node,HX_("aspect_ratio",24,04,8d,fd),-1);
HXLINE(3511)		if ((aspect_ratio != -1)) {
HXLINE(3513)			match = true;
HXLINE(3514)			HX_VARI( Float,screen_ratio) = (::hx::TCast< Float >::cast(::flixel::FlxG_obj::width) / ::hx::TCast< Float >::cast(::flixel::FlxG_obj::height));
HXLINE(3515)			HX_VARI( Float,diff) = ::Math_obj::abs((screen_ratio - aspect_ratio));
HXLINE(3516)			if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(node,HX_("tolerance",0d,3d,7c,33))) {
HXLINE(3518)				HX_VARI( Float,tolerance) = ::flixel::addons::ui::U_obj::xml_f(node,HX_("tolerance",0d,3d,7c,33),((Float)0.1));
...
HXLINE(3526)					HX_VARI( Float,tolerance_minus) = ::flixel::addons::ui::U_obj::xml_f(node,HX_("tolerance_minus",7e,cc,ae,b6),-1);
HXLINE(3527)					HX_VARI( Float,tolerance_plus) = ::flixel::addons::ui::U_obj::xml_f(node,HX_("tolerance_plus",0c,af,15,a0),-1);
...
HXLINE(3550)		HX_VARI(  ::flixel::math::FlxBasePoint,resolution) = ::flixel::addons::ui::U_obj::xml_pt(node,HX_("resolution",2c,35,49,6d),null());
HXLINE(3551)		if (::hx::IsNotNull( resolution )) {
HXLINE(3553)			match = true;
HXLINE(3554)			HX_VARI(  ::flixel::math::FlxBasePoint,toleranceRes) = ::flixel::addons::ui::U_obj::xml_pt(node,HX_("tolerance",0d,3d,7c,33),null());
HXLINE(3555)			if (::hx::IsNull( toleranceRes )) {
HXLINE(3557)				toleranceRes =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0);
            			}
HXLINE(3559)			HX_VARI( Float,diffX) = ::Math_obj::abs((resolution->x - ( (Float)(::flixel::FlxG_obj::width) )));
HXLINE(3560)			HX_VARI( Float,diffY) = ::Math_obj::abs((resolution->y - ( (Float)(::flixel::FlxG_obj::height) )));
...
HXLINE(3572)		HX_VARI( ::String,haxeDef) = ::flixel::addons::ui::U_obj::xml_str(node,HX_("haxedef",5f,a1,7a,08),true,HX_("",00,00,00,00));
HXLINE(3573)		HX_VARI( bool,haxeVal) = ::flixel::addons::ui::U_obj::xml_bool(node,HX_("value",71,7f,b8,31),true);
HXLINE(3575)		if ((haxeDef != HX_("",00,00,00,00))) {
HXLINE(3577)			match = true;
HXLINE(3578)			HX_VARI( bool,defValue) = ::flixel::addons::ui::U_obj::checkHaxedef(haxeDef);
HXLINE(3579)			match = (defValue == haxeVal);
HXLINE(3580)			if ((match != matchValue)) {
HXLINE(3582)				return false;
            			}
            		}
HXLINE(3587)		HX_VARI( ::String,variable) = ::flixel::addons::ui::U_obj::xml_str(node,HX_("variable",3c,12,0d,69),false,HX_("",00,00,00,00));
HXLINE(3588)		HX_VARI( ::String,variableType) = ::flixel::addons::ui::U_obj::xml_str(node,HX_("type",ba,f2,08,4d),true,HX_("string",d1,28,30,11));
HXLINE(3589)		if ((variable != HX_("",00,00,00,00))) {
HXLINE(3591)			match = true;
HXLINE(3592)			HX_VARI(  ::Dynamic,varData) = this->parseVarValue(variable);
...
HXLINE(3606)
HXLINE(3607)		HX_VARI( ::Array< ::String >,arr) = ::Array_obj< ::String >::fromData( _hx_array_data_e9110855_177,8);
HXLINE(3608)		HX_VAR( ::Array< ::String >,temp);
HXLINE(3609)		{
HXLINE(3609)			int _g = 0;
HXDLIN(3609)			while((_g < arr->length)){
HXLINE(3609)				HX_VARI( ::String,op) = arr->__get(_g);
HXDLIN(3609)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,parseVarValue,return )
 ...
 ::flixel::addons::ui::FlxUI FlxUI_obj::_loadLayout( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(3624)
HXLINE(3625)		HX_VARI( ::String,name) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("name",4b,72,ff,48),true,null());
HXLINE(3626)		HX_VARI( Float,X) = this->_loadWidth(data,( (Float)(0) ),HX_("x",78,00,00,00),null());
HXLINE(3627)		HX_VARI( Float,Y) = this->_loadHeight(data,( (Float)(0) ),HX_("y",79,00,00,00),null());
HXLINE(3628)		HX_VARI(  ::flixel::addons::ui::FlxUI,_ui) = this->createUI(data);
...
HXLINE(3655)				HX_VARI( ::String,key) = _g1->__get(_g);
HXDLIN(3655)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,createUI,return )
 ...
 ::flixel::addons::ui::FlxUITabMenu FlxUI_obj::_loadTabMenu( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(3669)
HXLINE(3670)		HX_VARI( ::String,back_def_str) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("back_def",6d,f8,3d,17),null(),null());
HXLINE(3671)		HX_VARI(  ::Xml,back_def) = this->getDefinition(back_def_str,null());
...
HXLINE(3678)		HX_VARI( ::String,back_type) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("back_type",12,07,9e,49),true,HX_("chrome",7a,f9,af,c2));
HXLINE(3680)		HX_VAR(  ::flixel::FlxSprite,backSprite);
...
HXLINE(3680)			backSprite = this->_load9SliceSprite(back_def,HX_("tab_menu",09,73,e1,d6));
            		...
            		_hx_goto_184:;
HXLINE(3687)		HX_VARI(  ::Xml,tab_def) = null();
HXLINE(3689)		HX_VARI( bool,stretch_tabs) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("stretch_tabs",38,9c,fc,5c),false);
HXLINE(3691)		HX_VARI( ::String,stackToggled) = HX_("front",a9,18,8e,06);
HXLINE(3692)		HX_VARI( ::String,stackUntoggled) = HX_("back",27,da,10,41);
...
HXLINE(3700)		HX_VARI( ::String,tab_spacing_str) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("spacing",83,33,bb,91),true,HX_("",00,00,00,00));
HXLINE(3701)		HX_VARI(  ::Dynamic,tab_spacing) = null();
...
HXLINE(3708)		HX_VARI( Float,tab_x) = this->_loadWidth(data,0,HX_("tab_x",ce,ac,e3,0a),null());
HXLINE(3709)		HX_VARI( Float,tab_y) = this->_loadHeight(data,0,HX_("tab_y",cf,ac,e3,0a),null());
...
HXDLIN(3710)		HX_VARI(  ::flixel::math::FlxBasePoint,tab_offset) = point;
HXLINE(3712)		HX_VARI( ::String,tab_def_str) = HX_("",00,00,00,00);
...
HXLINE(3716)					HX_VARI(  ::Xml,tabNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(3716)					_g = (_g + 1);
HXLINE(3718)					HX_VARI( ::String,temp) = ::flixel::addons::ui::U_obj::xml_str(tabNode,HX_("use_def",8d,da,e9,62),null(),null());
...
HXLINE(3734)		HX_VARI( ::Array< ::Dynamic>,list_tabs) = ::Array_obj< ::Dynamic>::__new();
HXLINE(3736)		HX_VARI( ::String,name) = HX_("",00,00,00,00);
...
HXLINE(3740)				HX_VARI(  ::Xml,tab_node) = _g3->__get(_g2).StaticCast<  ::Xml >();
HXDLIN(3740)				_g2 = (_g2 + 1);
HXLINE(3742)				name = ::flixel::addons::ui::U_obj::xml_name(tab_node);
HXLINE(3744)				if ((name != HX_("",00,00,00,00))) {
HXLINE(3746)					HX_VARI( ::String,label) = ::flixel::addons::ui::U_obj::xml_str(tab_node,HX_("label",f4,0d,af,6f),null(),null());
HXLINE(3747)					HX_VARI( ::String,context) = ::flixel::addons::ui::U_obj::xml_str(tab_node,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(3748)					HX_VARI( ::String,code) = ::flixel::addons::ui::U_obj::xml_str(tab_node,HX_("code",2d,b1,c4,41),true,HX_("",00,00,00,00));
HXLINE(3749)					label = this->getText(label,context,true,code);
HXLINE(3751)					label = this->getText(label,context,true,code);
HXLINE(3753)					HX_VARI(  ::Xml,tab_info) = ::flixel::addons::ui::FlxUI_obj::consolidateData(tab_node,tab_def,null());
HXLINE(3754)					HX_VARI( ::Dynamic,tab) = this->_loadButton(tab_info,true,true,HX_("tab_menu",09,73,e1,d6));
...
HXLINE(3766)					HX_VARI( ::Dynamic,t) = list_tabs->__get(_g4);
HXDLIN(3766)					_g4 = (_g4 + 1);
HXLINE(3768)					if (::Std_obj::isOfType(t,::hx::ClassOf< ::flixel::addons::ui::FlxUITypedButton >())) {
HXLINE(3770)						HX_VARI(  ::flixel::addons::ui::FlxUITypedButton,tb) = ( ( ::flixel::addons::ui::FlxUITypedButton)(t) );
...
HXLINE(3774)							HX_VARI(  ::flixel::addons::ui::FlxUIText,labelText) = ( ( ::flixel::addons::ui::FlxUIText)(tb->label) );
HXLINE(3775)							{
...
HXLINE(3788)		HX_VARI( ::Array< ::String >,tab_stacking) = ::Array_obj< ::String >::__new(2)->init(0,stackToggled)->init(1,stackUntoggled);
HXLINE(3790)		HX_VARI(  ::flixel::addons::ui::FlxUITabMenu,fg) =  ::flixel::addons::ui::FlxUITabMenu_obj::__alloc( HX_CTX ,backSprite,list_tabs,null(),tab_offset,stretch_tabs,tab_spacing,tab_stacking);
...
HXLINE(3794)				HX_VARI(  ::Xml,group_node) = _g6->__get(_g5).StaticCast<  ::Xml >();
HXDLIN(3794)				_g5 = (_g5 + 1);
HXLINE(3796)				name = ::flixel::addons::ui::U_obj::xml_name(group_node);
HXLINE(3797)				HX_VARI(  ::flixel::addons::ui::FlxUI,_ui) =  ::flixel::addons::ui::FlxUI_obj::__alloc( HX_CTX ,group_node,fg,::hx::ObjectPtr<OBJ_>(this),this->_ptr_tongue,null(),null());
...
HXLINE(3813)
HXLINE(3824)		HX_VARI( Float,stepSize) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("step",4c,e7,5b,4c),1);
HXLINE(3825)		HX_VARI( Float,defaultValue) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("value",71,7f,b8,31),0);
HXLINE(3826)		HX_VARI( Float,min) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("min",92,11,53,00),0);
HXLINE(3827)		HX_VARI( Float,max) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("max",a4,0a,53,00),10);
HXLINE(3828)		HX_VARI( int,decimals) = ::flixel::addons::ui::U_obj::xml_i(data,HX_("decimals",c2,4a,6a,12),0);
HXLINE(3829)		HX_VARI( bool,percent) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("percent",c5,aa,da,78),null());
HXLINE(3830)		HX_VARI( ::String,stack) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("stack",48,67,0b,84),true,HX_("",00,00,00,00));
...
HXLINE(3836)		HX_VAR( int,stacking);
...
HXLINE(3845)			stacking = 1;
            		...
            		_hx_goto_190:;
HXLINE(3848)		HX_VARI(  ::flixel::text::FlxText,theText) = null();
HXLINE(3849)		HX_VARI(  ::flixel::addons::ui::FlxUITypedButton,buttPlus) = null();
HXLINE(3850)		HX_VARI(  ::flixel::addons::ui::FlxUITypedButton,buttMinus) = null();
...
HXLINE(3865)		HX_VARI(  ::flixel::addons::ui::FlxUINumericStepper,ns) =  ::flixel::addons::ui::FlxUINumericStepper_obj::__alloc( HX_CTX ,0,0,stepSize,defaultValue,min,max,decimals,stacking,theText,buttPlus,buttMinus,percent);
...
HXDLIN(3870)			HX_VARI_NAME( ::cpp::VirtualArray,params1,"params") = params;
...
HXLINE(3878)
HXLINE(3879)		HX_VARI( ::String,str) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("resize_ratio_x",79,e8,30,0e),true,null());
...
HXLINE(3886)				HX_VARI( Float,resize_ratio) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("resize_ratio",40,c5,84,8f),-1);
...
HXLINE(3907)
HXLINE(3908)		HX_VARI( ::Dynamic,fb) = null();
HXLINE(3909)		HX_VARI( int,color) = this->_loadColor(data,null(),null());
HXLINE(3910)		HX_VARI( Float,resize_ratio) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("resize_ratio",40,c5,84,8f),-1);
HXLINE(3911)		HX_VARI(  ::flixel::math::FlxBasePoint,resize_point) = this->_loadCompass(data,HX_("resize_point",85,44,f0,71));
HXLINE(3912)		HX_VARI( bool,resize_label) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("resize_label",29,9e,0f,1b),false);
HXLINE(3914)		HX_VARI( ::String,label) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("label",f4,0d,af,6f),null(),null());
HXLINE(3916)		HX_VARI(  ::flixel::addons::ui::FlxUISprite,sprite) = null();
HXLINE(3917)		HX_VARI(  ::flixel::addons::ui::FlxUISprite,toggleSprite) = null();
...
HXLINE(3920)				HX_VARI(  ::Xml,spriteNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(3920)				_g = (_g + 1);
HXLINE(3922)				HX_VAR( bool,forToggle);
...
HXLINE(3934)		HX_VARI( ::String,context) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("context",ef,95,77,19),true,HX_("ui",54,66,00,00));
HXLINE(3935)		HX_VARI( ::String,code) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("code",2d,b1,c4,41),true,HX_("",00,00,00,00));
HXLINE(3937)		label = this->getText(label,context,true,code);
HXLINE(3939)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_loadWidth(data,0,HX_("width",06,b6,62,ca),null()));
HXLINE(3940)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_loadHeight(data,0,HX_("height",e7,07,4c,02),null()));
...
HXDLIN(3942)		HX_VARI_NAME( ::cpp::VirtualArray,params1,"params") = params;
HXLINE(3944)		if (::hx::IsNull( sprite )) {
HXLINE(3946)			HX_VARI( bool,useDefaultGraphic) = (::haxe::xml::_Access::HasNodeAccess_Impl__obj::resolve(data,HX_("graphic",a8,5a,07,74)) == false);
HXLINE(3947)			fb =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,label,null(),useDefaultGraphic,false,color);
HXLINE(3948)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,fuib) = ( ( ::flixel::addons::ui::FlxUIButton)(fb) );
HXLINE(3949)			fuib->_autoCleanup = false;
            		}
            		else {
HXLINE(3953)			HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,tempGroup) = null();
HXLINE(3954)			if ((label != HX_("",00,00,00,00))) {
HXLINE(3958)				HX_VARI(  ::flixel::addons::ui::FlxUIText,labelTxt) =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,0,0,80,label,8,null());
...
HXLINE(3987)			HX_VARI( bool,blank) = ::flixel::addons::ui::U_obj::xml_bool(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("graphic",a8,5a,07,74)),HX_("blank",54,df,f1,b4),null());
...
HXLINE(4000)				HX_VARI( ::cpp::VirtualArray,graphic_names) = null();
HXLINE(4001)				HX_VARI( ::Array< ::Dynamic>,slice9_names) = null();
HXLINE(4002)				HX_VARI( ::Array< int >,frames) = null();
...
HXLINE(4016)				HX_VARI( int,src_w) = ::flixel::addons::ui::U_obj::xml_i(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("graphic",a8,5a,07,74)),HX_("src_w",1c,7b,ba,82),0);
HXLINE(4017)				HX_VARI( int,src_h) = ::flixel::addons::ui::U_obj::xml_i(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("graphic",a8,5a,07,74)),HX_("src_h",0d,7b,ba,82),0);
...
HXDLIN(4018)					goto _hx_goto_200;
            				...
            				_hx_goto_200:;
HXDLIN(4018)				HX_VARI_NAME( int,tile1,"tile") = tile;
HXLINE(4021)				HX_VARI( ::String,frame_str) = ::flixel::addons::ui::U_obj::xml_str(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("graphic",a8,5a,07,74)),HX_("frames",a6,af,85,ac),true,null());
HXLINE(4022)				if ((frame_str != HX_("",00,00,00,00))) {
HXLINE(4024)					frames = ::Array_obj< int >::__new();
HXLINE(4025)					HX_VARI( ::Array< ::String >,arr) = frame_str.split(HX_(",",2c,00,00,00));
HXLINE(4026)					{
HXLINE(4026)						int _g6 = 0;
HXDLIN(4026)						while((_g6 < arr->length)){
HXLINE(4026)							HX_VARI( ::String,numstr) = arr->__get(_g6);
...
HXLINE(4032)						HX_VARI(  ::Xml,graphicNode) = _g8->__get(_g7).StaticCast<  ::Xml >();
HXDLIN(4032)						_g7 = (_g7 + 1);
HXLINE(4034)						HX_VARI( ::String,graphic_name) = ::flixel::addons::ui::U_obj::xml_name(graphicNode);
HXLINE(4035)						HX_VARI( ::String,image) = ::flixel::addons::ui::U_obj::xml_str(graphicNode,HX_("image",5b,1f,69,bd),null(),null());
HXLINE(4036)						HX_VARI( ::Array< int >,slice9) = ::flixel::util::FlxStringUtil_obj::toIntArray(::flixel::addons::ui::U_obj::xml_str(graphicNode,HX_("slice9",a7,03,04,70),null(),null()));
...
HXLINE(4039)						HX_VARI( bool,toggleState) = ::flixel::addons::ui::U_obj::xml_bool(graphicNode,HX_("toggle",94,bf,43,8f),null());
...
HXLINE(4042)						HX_VARI( ::String,igfx) = ::flixel::addons::ui::U_obj::gfx(image,null(),null(),null(),null(),null());
HXLINE(4044)						::String _hx_switch_3 = graphic_name;
            						if (  (_hx_switch_3==HX_("all",21,f9,49,00)) ){
HXLINE(4107)							HX_VAR( int,tilesTall);
...
HXLINE(4109)							HX_VARI(  ::openfl::display::BitmapData,temp) = null();
HXLINE(4112)							if ((src_h != 0)) {
HXLINE(4114)								HX_VARI_NAME(  ::openfl::display::BitmapData,temp1,"temp") = ::flixel::addons::ui::U_obj::getBmp(igfx);
...
HXLINE(4171)				HX_VARI_NAME( ::cpp::VirtualArray,graphic_names1,"graphic_names") = ::cpp::VirtualArray_obj::__new(6)->init(0,HX_("flixel/flixel-ui/img/tab_back.png",d5,c5,cd,aa))->init(1,HX_("flixel/flixel-ui/img/tab_back.png",d5,c5,cd,aa))->init(2,HX_("flixel/flixel-ui/img/tab_back.png",d5,c5,cd,aa))->init(3,HX_("flixel/flixel-ui/img/tab.png",27,2e,82,04))->init(4,HX_("flixel/flixel-ui/img/tab.png",27,2e,82,04))->init(5,HX_("flixel/flixel-ui/img/tab.png",27,2e,82,04));
HXLINE(4179)				HX_VARI( ::Array< int >,slice9_tab) = ::flixel::util::FlxStringUtil_obj::toIntArray(HX_("6,6,11,11",c0,1f,fa,07));
HXLINE(4180)				HX_VARI_NAME( ::Array< ::Dynamic>,slice9_names1,"slice9_names") = ::Array_obj< ::Dynamic>::__new(6)->init(0,slice9_tab)->init(1,slice9_tab)->init(2,slice9_tab)->init(3,slice9_tab)->init(4,slice9_tab)->init(5,slice9_tab);
HXLINE(4183)				if (::Std_obj::isOfType(fb,::hx::ClassOf< ::flixel::addons::ui::FlxUIButton >())) {
HXLINE(4185)					HX_VARI(  ::flixel::addons::ui::FlxUIButton,fbui) = ( ( ::flixel::addons::ui::FlxUIButton)(fb) );
...
HXLINE(4190)						HX_VARI(  ::flixel::addons::ui::FlxUISpriteButton,fbuis) = ( ( ::flixel::addons::ui::FlxUISpriteButton)(fb) );
...
HXLINE(4248)		HX_VARI( int,text_x) = 0;
HXLINE(4249)		HX_VARI( int,text_y) = 0;
...
HXLINE(4269)			HX_VARI(  ::flixel::addons::ui::FlxUISpriteButton,fbs) = ( ( ::flixel::addons::ui::FlxUISpriteButton)(fb) );
HXLINE(4270)			if (::Std_obj::isOfType(fbs->label,::hx::ClassOf< ::flixel::group::FlxTypedSpriteGroup >())) {
HXLINE(4272)				HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,g) = ( ( ::flixel::group::FlxTypedSpriteGroup)(fbs->label) );
HXLINE(4273)				{
HXLINE(4273)					int _g9 = 0;
HXDLIN(4273)					::Array< ::Dynamic> _g10 = g->group->members;
HXDLIN(4273)					while((_g9 < _g10->length)){
HXLINE(4273)						HX_VARI_NAME(  ::flixel::FlxSprite,sprite1,"sprite") = _g10->__get(_g9).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE(4297)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,fbu) = ( ( ::flixel::addons::ui::FlxUIButton)(fb) );
...
HXLINE(4310)			HX_VARI(  ::flixel::addons::ui::FlxUITypedButton,fuitb) = ( ( ::flixel::addons::ui::FlxUITypedButton)(fb) );
...
HXLINE(4313)					HX_VARI( ::String,key) = _g12->__get(_g11);
...
HX_DEFINE_DYNAMIC_FUNC4(FlxUI_obj,_loadButton,return )
 ...
 ::flixel::addons::ui::FlxUIRegion FlxUI_obj::_loadRegion( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(4333)
HXLINE(4334)		HX_VARI(  ::Dynamic,bounds) = this->calcMaxMinSize(data,null(),null());
HXLINE(4336)		HX_VARI( int,w) = ::Std_obj::_hx_int(this->_loadWidth(data,null(),null(),null()));
HXLINE(4337)		HX_VARI( int,h) = ::Std_obj::_hx_int(this->_loadHeight(data,null(),null(),null()));
HXLINE(4339)		if (::hx::IsNotNull( bounds )) {
HXLINE(4341)			HX_VARI(  ::openfl::geom::Point,pt) = ::flixel::addons::ui::U_obj::conformToBounds( ::openfl::geom::Point_obj::__alloc( HX_CTX ,w,h),bounds);
HXLINE(4342)			w = ::Std_obj::_hx_int(pt->x);
HXLINE(4343)			h = ::Std_obj::_hx_int(pt->y);
            		}
HXLINE(4346)		HX_VARI( bool,vis) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("visible",72,78,24,a3),true);
HXLINE(4347)		HX_VARI(  ::flixel::addons::ui::FlxUIRegion,reg) =  ::flixel::addons::ui::FlxUIRegion_obj::__alloc( HX_CTX ,0,0,w,h);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,_loadRegion,return )
 ...
 ::flixel::addons::ui::FlxUI9SliceSprite FlxUI_obj::_load9SliceSprite( ::Xml data,::String __o_load_code){
            	...
            	HX_STACK_ARG(load_code,"load_code")
HXLINE(4353)
HXLINE(4354)		HX_VARI( ::String,src) = HX_("",00,00,00,00);
HXLINE(4355)		HX_VARI(  ::flixel::addons::ui::FlxUI9SliceSprite,f9s) = null();
HXLINE(4357)		HX_VARI(  ::flixel::math::FlxBasePoint,resize) = this->getResizeRatio(data,null());
HXLINE(4358)		HX_VARI( int,color) = this->_loadColor(data,null(),null());
HXLINE(4359)		HX_VARI( Float,resize_ratio) = resize->x;
HXLINE(4360)		HX_VARI(  ::flixel::math::FlxBasePoint,resize_point) = this->_loadCompass(data,HX_("resize_point",85,44,f0,71));
HXLINE(4361)		HX_VARI( int,resize_ratio_axis) = ::Std_obj::_hx_int(resize->y);
HXLINE(4363)		HX_VARI(  ::Dynamic,bounds) = this->calcMaxMinSize(data,null(),null());
...
HXDLIN(4371)		src = str;
HXLINE(4373)		HX_VARI( bool,hasScaledSrc) = ::haxe::xml::_Access::HasNodeAccess_Impl__obj::resolve(data,HX_("scale_src",6f,c7,bc,37));
HXLINE(4374)		if (hasScaledSrc) {
HXLINE(4378)			HX_VARI( ::String,origSrc) = src;
...
HXLINE(4401)		HX_VARI( int,rect_w) = ::Std_obj::_hx_int(this->_loadWidth(data,null(),null(),null()));
HXLINE(4402)		HX_VARI( int,rect_h) = ::Std_obj::_hx_int(this->_loadHeight(data,null(),null(),null()));
...
HXLINE(4429)		HX_VARI(  ::openfl::geom::Rectangle,rc) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,rect_w,rect_h);
HXLINE(4431)		HX_VARI( ::Array< int >,slice9) = ::flixel::util::FlxStringUtil_obj::toIntArray(::flixel::addons::ui::U_obj::xml_str(data,HX_("slice9",a7,03,04,70),null(),null()));
HXLINE(4433)		HX_VARI( ::String,srcId) = HX_("",00,00,00,00);
HXLINE(4434)		HX_VARI(  ::Dynamic,srcGraphic) = src;
...
HXLINE(4444)		HX_VARI( bool,smooth) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("smooth",2e,08,6b,07),false);
...
HXDLIN(4446)			goto _hx_goto_209;
            		...
            		_hx_goto_209:;
HXDLIN(4446)		HX_VARI_NAME( int,tile1,"tile") = tile;
...
HXDLIN(4456)		HX_VARI( ::String,origSrc) = str;
HXLINE(4458)		if ((src == origSrc)) {
HXLINE(4459)			return slice9;
            		}
HXLINE(4461)		HX_VAR(  ::openfl::display::BitmapData,srcAsset);
...
HXLINE(4466)		HX_VARI(  ::openfl::display::BitmapData,origAsset) = ::openfl::utils::Assets_obj::getBitmapData(origSrc,false);
HXLINE(4467)		HX_VARI( Float,srcScaleFactorX) = (( (Float)(srcAsset->width) ) / ( (Float)(origAsset->width) ));
HXLINE(4468)		HX_VARI( Float,srcScaleFactorY) = (( (Float)(srcAsset->height) ) / ( (Float)(origAsset->height) ));
...
HXLINE(4481)			HX_VARI( int,widthDiff) = (origAsset->width - slice9->__get(2));
HXLINE(4482)			HX_VARI( int,heightDiff) = (origAsset->height - slice9->__get(3));
...
int FlxUI_obj::_loadTileRule( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(4494)
HXLINE(4495)		HX_VARI( ::String,tileStr) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("tile",2e,cb,fc,4c),true,HX_("",00,00,00,00));
HXLINE(4496)		HX_VARI( int,tile) = 0;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,_loadTileRule,return )
 ...
 ::flixel::addons::ui::FlxUISprite FlxUI_obj::_loadBox( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(4510)
HXLINE(4511)		HX_VARI(  ::flixel::addons::ui::FlxUISprite,fs) = null();
HXLINE(4513)		HX_VARI( int,thickness) = ::Std_obj::_hx_int(this->_loadWidth(data,1,HX_("thickness",74,f1,66,5a),null()));
HXLINE(4515)		HX_VARI(  ::Dynamic,bounds) = this->calcMaxMinSize(data,null(),null());
...
HXLINE(4533)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_loadWidth(data,null(),null(),null()));
HXLINE(4534)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_loadHeight(data,null(),null(),null()));
...
HXLINE(4556)		HX_VARI( ::String,cstr) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("color",63,71,5c,4a),true,HX_("0xff000000",88,79,02,3f));
HXLINE(4557)		HX_VARI( int,C) = 0;
...
HXLINE(4563)		HX_VARI( ::String,key) = ((((((W + HX_("x",78,00,00,00)) + H) + HX_(":",3a,00,00,00)) + C) + HX_(":",3a,00,00,00)) + thickness);
...
HXLINE(4572)			HX_VARI(  ::openfl::geom::Rectangle,r) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,thickness,thickness,(W - (thickness * 2)),(H - (thickness * 2)));
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,_loadBox,return )
 ...
 ::flixel::addons::ui::FlxUILine FlxUI_obj::_loadLine( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(4580)
HXLINE(4581)		HX_VARI( ::String,axis) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("axis",a1,1c,79,40),true,HX_("horizontal",e4,fc,c3,15));
HXLINE(4582)		HX_VARI( int,thickness) = ::Std_obj::_hx_int(this->_loadWidth(data,-1,HX_("thickness",74,f1,66,5a),null()));
HXLINE(4584)		HX_VARI(  ::Dynamic,bounds) = this->calcMaxMinSize(data,null(),null());
...
HXLINE(4606)			goto _hx_goto_215;
            		...
            		_hx_goto_215:;
HXLINE(4611)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_loadWidth(data,null(),null(),null()));
HXLINE(4612)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_loadHeight(data,null(),null(),null()));
...
HXLINE(4634)		HX_VARI( ::String,cstr) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("color",63,71,5c,4a),true,HX_("0xff000000",88,79,02,3f));
HXLINE(4635)		HX_VARI( int,C) = 0;
...
HXLINE(4641)		HX_VAR(  ::flixel::addons::ui::LineAxis,lineAxis);
...
HXLINE(4642)		HX_VAR( Float,lineLength);
...
HXLINE(4643)		HX_VAR( Float,lineThickness);
...
HXLINE(4645)		HX_VARI(  ::flixel::addons::ui::FlxUILine,fl) =  ::flixel::addons::ui::FlxUILine_obj::__alloc( HX_CTX ,0,0,lineAxis,lineLength,lineThickness,C);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,_loadLine,return )
 ...
 ::flixel::addons::ui::FlxUIBar FlxUI_obj::_loadBar( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(4651)
HXLINE(4652)		HX_VARI(  ::flixel::addons::ui::FlxUIBar,fb) = null();
HXLINE(4654)		HX_VARI(  ::Dynamic,style) =  ::Dynamic(::hx::Anon_obj::Create(9)
...
HXLINE(4669)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_loadWidth(data,-1,null(),null()));
HXLINE(4670)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_loadHeight(data,-1,null(),null()));
HXLINE(4672)		HX_VARI( ::String,direction) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("fill_direction",43,0e,7d,b3),true,null());
HXLINE(4673)		HX_VARI(  ::flixel::ui::FlxBarFillDirection,fillDir) = ::flixel::ui::FlxBarFillDirection_obj::TOP_TO_BOTTOM_dyn();
...
HXLINE(4694)			fillDir = ::flixel::ui::FlxBarFillDirection_obj::LEFT_TO_RIGHT_dyn();
            		...
            		_hx_goto_217:;
HXLINE(4697)		HX_VARI( ::String,parentRefStr) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("parent_ref",7e,00,5b,f3),true,null());
HXLINE(4698)		HX_VAR( ::Dynamic,parentRef);
...
HXLINE(4699)		HX_VARI( ::String,variableName) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("variable",3c,12,0d,69),null(),null());
HXLINE(4701)		HX_VARI( Float,value) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("value",71,7f,b8,31),-1);
HXLINE(4703)		HX_VARI( Float,min) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("min",92,11,53,00),0);
HXLINE(4704)		HX_VARI( Float,max) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("max",a4,0a,53,00),100);
...
HXLINE(4712)		HX_VARI( bool,showBorder) = ::hx::IsNotNull( style->__Field(HX_("borderColor",d7,3c,d5,d6),::hx::paccDynamic) );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUI_obj,_loadBar,return )
 ...
 ::flixel::addons::ui::FlxUISprite FlxUI_obj::_loadSprite( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(4762)
HXLINE(4763)		HX_VARI( ::String,src) = HX_("",00,00,00,00);
HXLINE(4764)		HX_VARI(  ::flixel::addons::ui::FlxUISprite,fs) = null();
HXLINE(4766)		src = this->loadScaledSrc(data,null(),null(),null(),null());
HXLINE(4768)		HX_VARI(  ::Dynamic,bounds) = this->calcMaxMinSize(data,null(),null());
HXLINE(4776)		HX_VARI(  ::flixel::math::FlxBasePoint,resize) = this->getResizeRatio(data,-1);
HXLINE(4778)		HX_VARI( Float,resize_ratio) = resize->x;
HXLINE(4779)		HX_VARI( int,resize_ratio_axis) = ::Std_obj::_hx_int(resize->y);
HXLINE(4780)		HX_VARI(  ::flixel::math::FlxBasePoint,resize_point) = this->_loadCompass(data,HX_("resize_point",85,44,f0,71));
HXLINE(4782)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_loadWidth(data,-1,null(),null()));
HXLINE(4783)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_loadHeight(data,-1,null(),null()));
...
HXLINE(4840)				HX_VARI( bool,smooth) = this->loadSmooth(data,true);
...
HXLINE(4846)			HX_VARI( ::String,cstr) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("color",63,71,5c,4a),null(),null());
HXLINE(4847)			HX_VARI( int,C) = 0;
...
HXLINE(4864)
HXLINE(4865)		HX_VAR( ::String,defaultStr);
...
HXLINE(4866)		HX_VARI( ::String,smoothStr) = ::flixel::addons::ui::U_obj::xml_str(scaleNode,HX_("smooth",2e,08,6b,07),true,defaultStr);
...
HXLINE(4880)
HXLINE(4881)		HX_VARI( ::String,src) = ::flixel::addons::ui::U_obj::xml_str(data,attName,null(),null());
...
HXLINE(4884)				HX_VARI(  ::Xml,scaleNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(4884)				_g = (_g + 1);
HXLINE(4886)				HX_VARI( Float,ratio) = ::flixel::addons::ui::U_obj::xml_f(scaleNode,HX_("screen_ratio",b8,10,95,88),-1);
HXLINE(4887)				HX_VARI( Float,tolerance) = ::flixel::addons::ui::U_obj::xml_f(scaleNode,HX_("tolerance",0d,3d,7c,33),((Float)0.1));
HXLINE(4888)				HX_VARI( Float,actualRatio) = (( (Float)(::flixel::FlxG_obj::width) ) / ( (Float)(::flixel::FlxG_obj::height) ));
...
HXLINE(4893)					HX_VARI( ::String,suffix) = ::flixel::addons::ui::U_obj::xml_str(scaleNode,HX_("suffix",d1,e2,a5,9c),null(),null());
HXLINE(4894)					HX_VARI( ::String,srcSuffix) = (src + suffix);
HXLINE(4895)					HX_VARI(  ::openfl::display::BitmapData,testAsset) = null();
HXLINE(4896)					HX_VARI( Float,scale_) = ( (Float)(-1) );
HXLINE(4897)					HX_VARI( bool,smooth) = this->loadSmooth(scaleNode,true);
HXLINE(4899)					HX_VARI( Float,to_height) = this->_loadHeight(scaleNode,-1,HX_("to_height",6b,29,06,d3),null());
HXLINE(4901)					if ((to_height != -1)) {
HXLINE(4903)						HX_VARI_NAME(  ::openfl::display::BitmapData,testAsset1,"testAsset") = ::flixel::addons::ui::U_obj::getBmp(::flixel::addons::ui::U_obj::gfx(src,null(),null(),null(),null(),null()));
...
HXLINE(4918)					HX_VAR( Float,scale_x);
...
HXLINE(4919)					HX_VAR( Float,scale_y);
...
HXLINE(4921)					HX_VARI( Float,sw) = ( (Float)(0) );
HXLINE(4922)					HX_VARI( Float,sh) = ( (Float)(0) );
...
HXLINE(4955)							HX_VARI_NAME( ::String,str4,"str") = ::flixel::addons::ui::U_obj::scaleAndStoreTileset(str,scale_y,str1,str2,str3,::Std_obj::_hx_int((sh / ( (Float)(tilesTall) ))),smooth);
HXLINE(4957)							this->addToScaledAssets(str4);
HXLINE(4958)							return str4;
            						}
            						else {
HXLINE(4962)							HX_VARI_NAME( ::String,str5,"str") = ::flixel::addons::ui::U_obj::loadScaledImage(srcSuffix,sw,sh,smooth);
...
HXDLIN(5018)			goto _hx_goto_225;
            		...
            		/* default */{
HXLINE(5022)			HX_VARI( Float,perc) = ::flixel::addons::ui::U_obj::perc_to_float(str);
...
HXLINE(5036)				HX_VARI(  ::EReg,r) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[\\w]+\\.[\\w]+",ee,da,86,47),HX_("",00,00,00,00));
HXLINE(5038)				if (r->match(str)) {
HXLINE(5040)					HX_VARI( ::String,wh) = HX_("",00,00,00,00);
...
HXLINE(5049)					HX_VARI( Float,assetValue) = this->_getStretch(1,wh,str);
...
HXLINE(5058)
HXLINE(5059)		HX_VARI( ::String,roundStr) = ::flixel::addons::ui::U_obj::xml_str(node,HX_("round",4e,f8,65,ed),true,defaultStr);
...
HXLINE(5089)
HXLINE(5090)		HX_VARI( Float,min_w) = ( (Float)(0) );
HXLINE(5091)		HX_VARI( Float,min_h) = ( (Float)(0) );
HXLINE(5092)		HX_VARI( Float,max_w) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(5093)		HX_VARI( Float,max_h) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(5094)		HX_VARI( Float,temp_min_w) = ( (Float)(0) );
HXLINE(5095)		HX_VARI( Float,temp_min_h) = ( (Float)(0) );
HXLINE(5096)		HX_VARI( Float,temp_max_w) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(5097)		HX_VARI( Float,temp_max_h) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(5099)		HX_VARI(  ::flixel::addons::ui::Rounding,round) = ::flixel::addons::ui::Rounding_obj::None_dyn();
...
HXLINE(5103)				HX_VARI(  ::Xml,exactNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(5103)				_g = (_g + 1);
HXLINE(5105)				HX_VARI( ::String,exact_w_str) = ::flixel::addons::ui::U_obj::xml_str(exactNode,HX_("width",06,b6,62,ca),null(),null());
HXLINE(5106)				HX_VARI( ::String,exact_h_str) = ::flixel::addons::ui::U_obj::xml_str(exactNode,HX_("height",e7,07,4c,02),null(),null());
...
HXLINE(5117)					HX_VARI(  ::Xml,minNode) = _g3->__get(_g2).StaticCast<  ::Xml >();
HXDLIN(5117)					_g2 = (_g2 + 1);
HXLINE(5119)					HX_VARI( ::String,min_w_str) = ::flixel::addons::ui::U_obj::xml_str(minNode,HX_("width",06,b6,62,ca),null(),null());
HXLINE(5120)					HX_VARI( ::String,min_h_str) = ::flixel::addons::ui::U_obj::xml_str(minNode,HX_("height",e7,07,4c,02),null(),null());
...
HXLINE(5136)						HX_VARI(  ::Xml,maxNode) = _g5->__get(_g4).StaticCast<  ::Xml >();
HXDLIN(5136)						_g4 = (_g4 + 1);
HXLINE(5138)						HX_VARI( ::String,max_w_str) = ::flixel::addons::ui::U_obj::xml_str(maxNode,HX_("width",06,b6,62,ca),null(),null());
HXLINE(5139)						HX_VARI( ::String,max_h_str) = ::flixel::addons::ui::U_obj::xml_str(maxNode,HX_("height",e7,07,4c,02),null(),null());
...
HXLINE(5206)		HX_VARI( Float,percf) = ::flixel::addons::ui::U_obj::perc_to_float(str);
...
HXLINE(5224)				HX_VARI( ::Array< ::String >,arr) = str.split(HX_(",",2c,00,00,00));
HXLINE(5225)				HX_VARI( Float,stretch_0) = this->_getStretch(0,target,arr->__get(0));
HXLINE(5226)				HX_VARI( Float,stretch_1) = this->_getStretch(1,target,arr->__get(1));
...
HXLINE(5239)					HX_VARI( Float,assetValue) = this->_getStretch(1,target,str);
HXLINE(5240)					return assetValue;
            				}
            				else {
HXLINE(5244)					HX_VARI(  ::EReg,r) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[\\w]+\\.[\\w]+",ee,da,86,47),HX_("",00,00,00,00));
HXLINE(5245)					if (r->match(str)) {
HXLINE(5247)						HX_VARI_NAME( Float,assetValue1,"assetValue") = this->_getStretch(1,target,str);
HXLINE(5248)						return assetValue1;
            					}
            				}
            			}
HXLINE(5252)			HX_VARI( ::String,ptStr) = HX_("",00,00,00,00);
...
HXLINE(5261)				HX_VARI( Float,tempNum) = ::Std_obj::parseFloat(ptStr);
...
::cpp::VirtualArray FlxUI_obj::_getOperation(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(5283)
HXLINE(5284)		HX_VARI( ::Array< ::String >,list) = ::Array_obj< ::String >::fromData( _hx_array_data_e9110855_239,5);
HXLINE(5286)		HX_VARI( ::String,op) = HX_("",00,00,00,00);
HXLINE(5287)		HX_VARI( Float,besti) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(5289)		{
HXLINE(5289)			int _g = 0;
HXDLIN(5289)			while((_g < list->length)){
HXLINE(5289)				HX_VARI( ::String,item) = list->__get(_g);
HXDLIN(5289)				_g = (_g + 1);
HXLINE(5291)				HX_VARI( int,i) = str.indexOf(item,null());
HXLINE(5292)				if ((i != -1)) {
...
HXLINE(5302)		HX_VARI( bool,hasPoint) = false;
HXLINE(5304)		if ((op != HX_("",00,00,00,00))) {
HXLINE(5306)			if ((str.indexOf(op,null()) != -1)) {
HXLINE(5308)				HX_VARI( int,opindex) = str.indexOf(op,null());
HXLINE(5310)				if ((opindex != (str.length - 1))) {
HXLINE(5312)					HX_VARI( ::String,firstBit) = str.substr(0,opindex);
HXLINE(5313)					HX_VARI( ::String,secondBit) = str.substr((opindex + 1),(str.length - (opindex + 1)));
HXLINE(5315)					HX_VARI( Float,f) = ( (Float)(0) );
HXLINE(5318)					HX_VARI( int,ptIndex) = secondBit.indexOf(HX_("pt",04,62,00,00),null());
...
HXLINE(5321)						HX_VARI( ::String,sansPt) = ::StringTools_obj::replace(secondBit,HX_("pt",04,62,00,00),HX_("",00,00,00,00));
...
Float FlxUI_obj::_getStretch(int index,::String target,::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(5368)
HXLINE(5369)		HX_VARI( ::cpp::VirtualArray,arr) = null();
HXLINE(5371)		HX_VARI( ::String,op) = HX_("",00,00,00,00);
HXLINE(5372)		HX_VARI( Float,operand) = ( (Float)(0) );
HXLINE(5373)		HX_VARI( bool,hasPoint) = false;
...
HXLINE(5398)		HX_VARI( Float,return_val) = this->getAssetProperty(index,target,str);
...
Float FlxUI_obj::getAssetProperty(int index,::String target,::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(5409)
HXLINE(5410)		HX_VARI( ::String,prop) = HX_("",00,00,00,00);
HXLINE(5412)		if ((str.indexOf(HX_(".",2e,00,00,00),null()) != -1)) {
HXLINE(5414)			HX_VARI( ::Array< ::String >,arr) = null();
HXLINE(5415)			arr = str.split(HX_(".",2e,00,00,00));
HXLINE(5416)			str = arr->__get(0);
HXLINE(5417)			prop = arr->__get(1);
            		}
HXLINE(5420)		HX_VARI( ::Dynamic,other) = this->getAsset(str,null());
HXLINE(5422)		HX_VARI( Float,return_val) = ( (Float)(0) );
...
HXLINE(5532)					HX_VARI(  ::Xml,lNode) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(5532)					_g = (_g + 1);
HXLINE(5534)					HX_VARI( ::String,ids) = ::flixel::addons::ui::U_obj::xml_str(lNode,HX_("ids",38,04,50,00),null(),null());
HXLINE(5535)					HX_VARI( ::Array< ::String >,arr) = ids.split(HX_(",",2c,00,00,00));
...
HXLINE(5538)						HX_VARI( ::Array< ::Dynamic>,list) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(5539)						{
HXLINE(5539)							int _g2 = 0;
HXDLIN(5539)							while((_g2 < arr->length)){
HXLINE(5539)								HX_VARI( ::String,str) = arr->__get(_g2);
HXDLIN(5539)								_g2 = (_g2 + 1);
HXLINE(5541)								HX_VARI( ::Dynamic,widget) = this->getAsset(str,null());
...
void FlxUI_obj::_loadPosition( ::Xml data,::Dynamic thing){
            	...
            	HX_STACK_ARG(thing,"thing")
HXLINE(5554)
HXLINE(5555)		HX_VARI( Float,X) = this->_loadWidth(data,( (Float)(0) ),HX_("x",78,00,00,00),null());
HXLINE(5556)		HX_VARI( Float,Y) = this->_loadHeight(data,( (Float)(0) ),HX_("y",79,00,00,00),null());
HXLINE(5561)		HX_VARI( bool,ctrX) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("center_x",4e,58,50,8f),null());
HXLINE(5562)		HX_VARI( bool,ctrY) = ::flixel::addons::ui::U_obj::xml_bool(data,HX_("center_y",4f,58,50,8f),null());
HXLINE(5564)		HX_VARI( ::String,center_on) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("center_on",89,e4,fc,d6),null(),null());
HXLINE(5565)		HX_VARI( ::String,center_on_x) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("center_on_x",02,2c,66,3b),null(),null());
HXLINE(5566)		HX_VARI( ::String,center_on_y) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("center_on_y",03,2c,66,3b),null(),null());
HXLINE(5568)		HX_VARI( ::String,anchor_x_str) = HX_("",00,00,00,00);
HXLINE(5569)		HX_VARI( ::String,anchor_y_str) = HX_("",00,00,00,00);
HXLINE(5570)		HX_VARI( Float,anchor_x) = ( (Float)(0) );
HXLINE(5571)		HX_VARI( Float,anchor_y) = ( (Float)(0) );
HXLINE(5572)		HX_VARI( ::String,anchor_x_flush) = HX_("",00,00,00,00);
HXLINE(5573)		HX_VARI( ::String,anchor_y_flush) = HX_("",00,00,00,00);
...
HXLINE(5580)			HX_VARI(  ::flixel::addons::ui::Rounding,rounding) = this->getRound(::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("anchor",75,3a,71,60)),null());
...
HXLINE(5631)			HX_VARI( ::Dynamic,other) = this->getAsset(center_on,null());
...
HXLINE(5641)				HX_VARI_NAME( ::Dynamic,other1,"other") = this->getAsset(center_on_x,null());
...
HXLINE(5649)				HX_VARI_NAME( ::Dynamic,other2,"other") = this->getAsset(center_on_y,null());
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUI_obj,_loadPosition,(void))
 ...
 ::flixel::addons::ui::BorderDef FlxUI_obj::_loadBorder( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(5662)
HXLINE(5663)		HX_VARI(  ::flixel::addons::ui::BorderDef,borderDef) = ::flixel::addons::ui::BorderDef_obj::fromXML(data);
HXLINE(5665)		HX_VARI(  ::flixel::addons::ui::Rounding,round) = this->getRound(data,HX_("floor",cc,d1,96,02));
HXLINE(5666)		HX_VARI( Float,dataSize) = this->_getDataSize(HX_("h",68,00,00,00),::flixel::addons::ui::U_obj::xml_str(data,HX_("border_size",34,18,b0,f8),null(),null()),1);
HXLINE(5667)		HX_VARI( int,border_size) = ::Std_obj::_hx_int(this->doRound(dataSize,round));
...
HXLINE(5675)
HXLINE(5676)		HX_VARI( ::String,colorStr) = ::flixel::addons::ui::U_obj::xml_str(data,colorName,null(),null());
...
HXLINE(5681)		HX_VARI( int,color) = _default;
...
HX_DEFINE_DYNAMIC_FUNC3(FlxUI_obj,_loadColor,return )
 ...
 ::flixel::addons::ui::FontDef FlxUI_obj::_loadFontDef( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(5690)
HXLINE(5691)		HX_VARI(  ::flixel::addons::ui::FontDef,fd) = ::flixel::addons::ui::FontDef_obj::fromXML(data);
HXLINE(5692)		HX_VARI( int,fontSize) = ::Std_obj::_hx_int(this->_loadHeight(data,8,HX_("size",c1,a0,53,4c),null()));
...
::String FlxUI_obj::_loadFontFace( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(5699)
HXLINE(5700)		HX_VARI( ::String,fontFace) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("font",cf,5d,c0,43),null(),null());
HXLINE(5701)		HX_VARI( ::String,fontStyle) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("style",31,a5,1d,84),null(),null());
HXLINE(5702)		HX_VARI( ::String,the_font) = null();
...
HXLINE(5720)
HXLINE(5721)		HX_VARI( ::String,str) = HX_("",00,00,00,00);
...
HXLINE(5825)			HX_VARI(  ::Xml,textNode) = ::haxe::xml::_Access::NodeAccess_Impl__obj::resolve(data,HX_("text",ad,cc,f9,4c));
HXLINE(5826)			HX_VARI( ::String,use_def) = ::flixel::addons::ui::U_obj::xml_str(textNode,HX_("use_def",8d,da,e9,62),true,null());
HXLINE(5827)			HX_VARI(  ::Xml,text_def) = null();
HXLINE(5829)			if ((use_def != HX_("",00,00,00,00))) {
HXLINE(5831)				text_def = this->getDefinition(use_def,null());
            			}
HXLINE(5834)			HX_VARI(  ::Xml,info) = ::flixel::addons::ui::FlxUI_obj::consolidateData(textNode,text_def,null());
HXLINE(5836)			HX_VARI( ::String,the_font) = this->_loadFontFace(info);
HXLINE(5837)			HX_VARI( int,size) = ::Std_obj::_hx_int(this->_loadHeight(info,8,HX_("size",c1,a0,53,4c),HX_("floor",cc,d1,96,02)));
HXLINE(5838)			HX_VARI( int,color) = this->_loadColor(info,null(),null());
HXLINE(5840)			HX_VARI( Float,labelWidth) = ::flixel::addons::ui::U_obj::xml_f(info,HX_("width",06,b6,62,ca),null());
HXLINE(5842)			HX_VARI(  ::flixel::addons::ui::BorderDef,border) = this->_loadBorder(info);
HXLINE(5844)			HX_VARI( ::String,align) = ::flixel::addons::ui::U_obj::xml_str(info,HX_("align",c5,56,91,21),true,null());
HXLINE(5845)			if ((align == HX_("",00,00,00,00))) {
HXLINE(5847)				align = null();
            			}
HXLINE(5850)			HX_VARI(  ::flixel::text::FlxText,the_label) = null();
HXLINE(5851)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,fb) = null();
HXLINE(5852)			HX_VARI(  ::flixel::addons::ui::FlxUISpriteButton,fsb) = null();
HXLINE(5853)			HX_VARI( ::Dynamic,ifb) = null();
...
HXLINE(5865)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,cb) = ( ( ::flixel::addons::ui::FlxUICheckBox)(button) );
...
HXLINE(5886)								HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,fsg) = ( ( ::flixel::group::FlxTypedSpriteGroup)(fsb->label) );
HXLINE(5887)								{
HXLINE(5887)									int _g = 0;
HXDLIN(5887)									::Array< ::Dynamic> _g1 = fsg->group->members;
HXDLIN(5887)									while((_g < _g1->length)){
HXLINE(5887)										HX_VARI(  ::flixel::FlxSprite,fs) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(5887)										_g = (_g + 1);
...
HXLINE(5927)					HX_VARI(  ::flixel::addons::ui::FlxUIText,ftu) = ( ( ::flixel::addons::ui::FlxUIText)(the_label) );
...
HXLINE(5941)					HX_VARI(  ::Xml,textColorNode) = _g3->__get(_g2).StaticCast<  ::Xml >();
HXDLIN(5941)					_g2 = (_g2 + 1);
HXLINE(5943)					HX_VARI_NAME( int,color1,"color") = this->_loadColor(textColorNode,null(),null());
HXLINE(5944)					HX_VARI( bool,vis) = ::flixel::addons::ui::U_obj::xml_bool(textColorNode,HX_("visible",72,78,24,a3),true);
HXLINE(5945)					HX_VARI( ::String,state_name) = ::flixel::addons::ui::U_obj::xml_name(textColorNode);
HXLINE(5946)					HX_VARI( bool,toggle) = ::flixel::addons::ui::U_obj::xml_bool(textColorNode,HX_("toggle",94,bf,43,8f),null());
...
void FlxUI_obj::event(::String name,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params){
            	...
            	HX_STACK_ARG(params,"params")
HXLINE( 159)
HXLINE( 160)		HX_VARI( ::Dynamic,currState) = ::flixel::addons::ui::FlxUI_obj::getLeafUIState();
...
HXDLIN( 181)		HX_VARI_NAME( ::Dynamic,t1,"t") = t;
...
HXDLIN( 198)		HX_VARI_NAME( ::Dynamic,t1,"t") = t;
...
HXDLIN( 216)		HX_VARI_NAME( ::Dynamic,t1,"t") = t;
...
HXLINE( 226)
HXLINE( 227)		HX_VARI( ::Dynamic,currState) = ::flixel::addons::ui::FlxUI_obj::getLeafUIState();
HXLINE( 228)		HX_VARI( ::Dynamic,tongue) =  ::Dynamic(currState->__Field(HX_("_tongue",63,57,5b,02),::hx::paccDynamic));
...
void FlxUI_obj::forceFocus(bool b,::Dynamic thing){
            	...
            	HX_STACK_ARG(thing,"thing")
HXLINE( 242)
HXLINE( 243)		HX_VARI( ::Dynamic,currState) = ::flixel::addons::ui::FlxUI_obj::getLeafUIState();
...
HXLINE( 255)
HXLINE( 256)		HX_VARI(  ::flixel::FlxState,state) = ::flixel::FlxG_obj::game->_state;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxUI_obj,getLeafUIState,return )
 ...
 ::Dynamic FlxUI_obj::request(::String name,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params){
            	...
            	HX_STACK_ARG(params,"params")
HXLINE( 280)
HXLINE( 281)		HX_VARI( ::Dynamic,currState) = ::flixel::addons::ui::FlxUI_obj::getLeafUIState();
...
HXLINE(3015)			HX_VARI(  ::Xml,new_data) = ::Xml_obj::parse(::haxe::xml::Printer_obj::print(definition,null()))->firstElement();
HXLINE(3017)			{
HXLINE(3017)				HX_VARI(  ::Dynamic,att) = data->attributes();
HXDLIN(3017)				while(( (bool)(att->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(3017)					HX_VARI_NAME( ::String,att1,"att") = ( (::String)(att->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(3019)					HX_VARI( ::String,val) = ::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(data,att1);
...
HXLINE(3034)			{
HXLINE(3034)				HX_VARI(  ::Dynamic,element) = data->elements();
HXDLIN(3034)				while(( (bool)(element->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(3034)					HX_VARI_NAME(  ::Xml,element1,"element") = ( ( ::Xml)(element->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN(3036)					HX_VARI( ::String,nodeName) = element1->nodeName;
HXLINE(3037)					HX_VARI( bool,notCombine) = !(combineUniqueChildren);
HXLINE(3038)					if (combineUniqueChildren) {
HXLINE(3040)						HX_VARI(  ::Dynamic,new_els) = new_data->elementsNamed(nodeName);
HXLINE(3041)						HX_VARI(  ::Xml,new_el) = ( ( ::Xml)(new_els->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(3047)							HX_VARI_NAME(  ::Dynamic,att2,"att") = element1->attributes();
HXDLIN(3047)							while(( (bool)(att2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(3047)								HX_VARI_NAME( ::String,att3,"att") = ( (::String)(att2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(4324)
HXLINE(4325)		HX_VARI(  ::openfl::display::BitmapData,b1) = ::openfl::utils::Assets_obj::getBitmapData(::flixel::addons::ui::U_obj::gfx(source,null(),null(),null(),null(),null()),null());
...
HXDLIN(4326)		HX_VARI(  ::openfl::geom::Rectangle,r) = rect;
HXLINE(4327)		int b2 = ::Std_obj::_hx_int(r->width);
HXDLIN(4327)		HX_VARI_NAME(  ::openfl::display::BitmapData,b21,"b2") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,b2,::Std_obj::_hx_int(r->height),true,16777215);
...
::cpp::VirtualArray FlxUI_obj::getParams( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(5757)
HXLINE(5758)		HX_VARI( ::cpp::VirtualArray,params) = null();
...
HXLINE(5763)					HX_VARI(  ::Xml,param) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN(5763)					_g = (_g + 1);
...
HXLINE(5767)						HX_VARI( ::String,type) = ::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(param,HX_("type",ba,f2,08,4d));
HXLINE(5768)						type = type.toLowerCase();
HXLINE(5769)						HX_VARI( ::String,valueStr) = ::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(param,HX_("value",71,7f,b8,31));
HXLINE(5770)						HX_VARI(  ::Dynamic,value) = valueStr;
HXLINE(5771)						HX_VARI( int,sort) = ::flixel::addons::ui::U_obj::xml_i(param,HX_("sort",5e,27,58,4c),-1);
HXLINE(5772)						::String _hx_switch_0 = type;
            						if (  (_hx_switch_0==HX_("bool",2a,84,1b,41)) ||  (_hx_switch_0==HX_("boolean",a8,ea,fe,7d)) ){
HXLINE(5783)							HX_VARI( ::String,str) = ::String(valueStr);
...
HXDLIN(5804)					HX_VARI( int,i) = (_g2 - 1);
