...
HXLINE( 109)					HX_VARI(  ::flixel::graphics::FlxGraphic,fg) = ( ( ::flixel::graphics::FlxGraphic)(Graphic) );
...
HXLINE( 123)			HX_VARI(  ::flixel::math::FlxBasePoint,pt) = ::flixel::addons::ui::U_obj::applyResize(this->resize_ratio,this->resize_ratio_axis,Rect->width,Rect->height,null());
...
HXLINE( 150)		HX_VARI( Float,old_width) = this->get_width();
HXLINE( 151)		HX_VARI( Float,old_height) = this->get_height();
HXLINE( 153)		HX_VARI(  ::flixel::math::FlxBasePoint,pt) = ::flixel::addons::ui::U_obj::applyResize(this->resize_ratio,this->resize_ratio_axis,w,h,null());
HXLINE( 155)		w = pt->x;
HXLINE( 156)		h = pt->y;
HXLINE( 158)		HX_VARI( int,iw) = ::Std_obj::_hx_int(pt->x);
HXLINE( 159)		HX_VARI( int,ih) = ::Std_obj::_hx_int(pt->y);
...
HXDLIN( 167)		HX_VARI_NAME( ::String,key3,"key") = (key2 + ::Std_obj::string(this->_smooth));
...
HXDLIN( 178)			HX_VARI_NAME(  ::openfl::display::BitmapData,bmpCanvas1,"bmpCanvas") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bmpCanvas,::Std_obj::_hx_int(h),null(),null());
...
HXLINE( 184)			HX_VARI( ::String,oldID) = this->paintScale9_id;
HXLINE( 187)			HX_VARI( ::String,newID) = ::flixel::addons::ui::FlxUI9SliceSprite_obj::makePaintScale9Id(this->_asset_id,this->_slice9,::flixel::addons::ui::FlxUI9SliceSprite_obj::_staticFlxRect);
...
HXLINE( 196)				HX_VARI(  ::Dynamic,sectionCounter) = ::flixel::addons::ui::FlxUI9SliceSprite_obj::cacheCounter->get(this->paintScale9_id);
...
HXLINE( 205)		HX_VARI( Float,diff_w) = (this->get_width() - old_width);
HXLINE( 206)		HX_VARI( Float,diff_h) = (this->get_height() - old_height);
HXLINE( 208)		if (::hx::IsNotNull( this->resize_point )) {
HXLINE( 210)			HX_VARI( Float,delta_x) = (diff_w * this->resize_point->x);
HXLINE( 211)			HX_VARI( Float,delta_y) = (diff_h * this->resize_point->y);
...
HXLINE( 223)			HX_VARI(  ::Dynamic,oldCounter) = ::flixel::addons::ui::FlxUI9SliceSprite_obj::cacheCounter->get(id);
...
void FlxUI9SliceSprite_obj::purgeSections(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 235)
HXLINE( 237)		HX_VARI(  ::Dynamic,counter) = ::flixel::addons::ui::FlxUI9SliceSprite_obj::cacheCounter->get(id);
...
HXLINE( 243)					HX_VARI( ::String,key) = _g1->__get(_g);
HXDLIN( 243)					_g = (_g + 1);
...
HXLINE( 255)
HXLINE( 256)		HX_VARI( ::Array< ::String >,coords) = str.split(HX_(",",2c,00,00,00));
HXLINE( 257)		HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
...
HXLINE( 260)			HX_VARI( int,x_) = ( (int)(::Std_obj::parseInt(coords->__get(0))) );
HXLINE( 261)			HX_VARI( int,y_) = ( (int)(::Std_obj::parseInt(coords->__get(1))) );
HXLINE( 262)			HX_VARI( int,w_) = ( (int)(::Std_obj::parseInt(coords->__get(2))) );
HXLINE( 263)			HX_VARI( int,h_) = ( (int)(::Std_obj::parseInt(coords->__get(3))) );
...
::Array< int > FlxUI9SliceSprite_obj::getRectIntsFromString(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE( 270)
HXLINE( 271)		HX_VARI( ::Array< ::String >,coords) = str.split(HX_(",",2c,00,00,00));
...
HXLINE( 274)			HX_VARI( int,x1) = ( (int)(::Std_obj::parseInt(coords->__get(0))) );
HXLINE( 275)			HX_VARI( int,y1) = ( (int)(::Std_obj::parseInt(coords->__get(1))) );
HXLINE( 276)			HX_VARI( int,x2) = ( (int)(::Std_obj::parseInt(coords->__get(2))) );
HXLINE( 277)			HX_VARI( int,y2) = ( (int)(::Std_obj::parseInt(coords->__get(3))) );
...
HXLINE( 303)			HX_VAR( int,w);
HXLINE( 304)			HX_VAR( int,h);
HXLINE( 305)			if (::hx::IsNull( raw )) {
HXLINE( 307)				HX_VARI(  ::openfl::display::BitmapData,assetBmp) = ::flixel::addons::ui::U_obj::getBmp(assetID);
HXLINE( 308)				if (::hx::IsNotNull( assetBmp )) {
HXLINE( 310)					w = assetBmp->width;
HXLINE( 311)					h = assetBmp->height;
            				}
            				else {
HXLINE( 315)					HX_VARI(  ::flixel::graphics::FlxGraphic,assetFlx) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(assetID)) );
...
HXLINE( 326)			HX_VARI( int,x1) = scale9->__get(0);
HXLINE( 327)			HX_VARI( int,y1) = scale9->__get(1);
HXLINE( 328)			HX_VARI( int,x2) = scale9->__get(2);
HXLINE( 329)			HX_VARI( int,y2) = scale9->__get(3);
...
HXLINE( 363)			HX_VARI( ::String,uniqueID) = ::flixel::addons::ui::FlxUI9SliceSprite_obj::makePaintScale9Id(assetID,scale9,rc);
HXLINE( 366)			HX_VARI(  ::Dynamic,sectionCounter) = ::flixel::addons::ui::FlxUI9SliceSprite_obj::cacheCounter->get(uniqueID);
...
HXLINE( 373)						_g = (_g + 1);
HXDLIN( 373)						HX_VARI( int,i) = (_g - 1);
HXLINE( 375)						HX_VAR_NAME(  ::flixel::math::FlxRect,rect9,"rect");
...
HXLINE( 388)						HX_VARI( ::String,cacheId) = (((((((((assetID + HX_("_",5f,00,00,00)) + rect9->x) + HX_("_",5f,00,00,00)) + rect9->y) + HX_("_",5f,00,00,00)) + rect9->width) + HX_("_",5f,00,00,00)) + rect9->height) + HX_("_",5f,00,00,00));
...
HXLINE( 415)		HX_VARI(  ::flixel::math::FlxRect,tl) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("top.left",80,54,c1,7e))) );
...
HXLINE( 422)		HX_VARI(  ::flixel::math::FlxRect,tr) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("top.right",43,a9,75,e1))) );
...
HXLINE( 429)		HX_VARI(  ::flixel::math::FlxRect,t) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("top",95,66,58,00))) );
...
HXLINE( 437)		HX_VARI(  ::flixel::math::FlxRect,bl) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("bottom.left",6a,dc,81,96))) );
...
HXLINE( 444)		HX_VARI(  ::flixel::math::FlxRect,br) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("bottom.right",19,0e,2c,92))) );
...
HXLINE( 451)		HX_VARI(  ::flixel::math::FlxRect,b) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("bottom",eb,e6,78,65))) );
...
HXLINE( 459)		HX_VARI(  ::flixel::math::FlxRect,l) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("left",07,08,b0,47))) );
...
HXLINE( 466)		HX_VARI(  ::flixel::math::FlxRect,r) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("right",dc,0b,64,e9))) );
...
HXLINE( 473)		HX_VARI(  ::flixel::math::FlxRect,m) = ( ( ::flixel::math::FlxRect)(sourceRects->get(HX_("middle",55,d3,5e,4c))) );
...
HXLINE( 506)		HX_VARI(  ::openfl::display::BitmapData,section) = null();
HXLINE( 507)		HX_VARI( ::String,cacheId) = null();
...
HXLINE( 520)			HX_VARI( int,fillcolor) = 16777215;
...
HXDLIN( 555)		HX_VARI_NAME(  ::openfl::display::BitmapData,final_pixels1,"final_pixels") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,final_pixels,::Std_obj::_hx_int(dst->height),true,0);
