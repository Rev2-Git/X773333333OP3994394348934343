...
void *FlxUIBar_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::FlxSprite FlxUIBar_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  43)
HXLINE(  44)		HX_VARI( int,w) = ::Std_obj::_hx_int(this->get_width());
HXLINE(  45)		HX_VARI( int,h) = ::Std_obj::_hx_int(this->get_height());
HXLINE(  46)		HX_VAR( bool,showBorder);
...
HXLINE(  52)		HX_VARI(  ::flixel::addons::ui::FlxUIBar,b) =  ::flixel::addons::ui::FlxUIBar_obj::__alloc( HX_CTX ,this->x,this->y,this->fillDirection,w,h,this->parent,this->parentVariable,this->min,this->max,showBorder);
...
HXLINE(  81)		HX_VARI( bool,showBorder) = ::hx::IsNotNull( this->style->__Field(HX_("borderColor",d7,3c,d5,d6),::hx::paccDynamic) );
HXLINE(  83)		HX_VAR(  ::Dynamic,ec);
...
HXLINE(  94)			HX_VAR( ::Array< int >,ecs);
...
HXLINE(  95)			HX_VAR( ::Array< int >,fcs);
...
HXLINE(  96)			HX_VAR(  ::Dynamic,chunk);
...
HXLINE(  97)			HX_VAR(  ::Dynamic,gradRot);
