...
void FlxUIButton_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::String Label, ::Dynamic OnClick, ::Dynamic __o_LoadDefaultGraphics, ::Dynamic __o_LoadBlank, ::Dynamic __o_Color){
            	...
            	HX_STACK_ARG(LoadDefaultGraphics,"LoadDefaultGraphics")
            	HX_STACK_ARG(LoadBlank,"LoadBlank")
...
HXDLIN( 130)		HX_VARI_NAME(  ::flixel::addons::ui::FlxUIButton,newButton1,"newButton") =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,newButton,this->onUp->callback,false,null(),null());
...
HXLINE( 141)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,fuib) = ( ( ::flixel::addons::ui::FlxUIButton)(other) );
...
HXLINE( 151)			HX_VARI(  ::flixel::addons::ui::FlxUIText,t) = ( ( ::flixel::addons::ui::FlxUIText)(fuib->label) );
HXLINE( 153)			HX_VARI(  ::openfl::text::TextFormat,tf) = t->textField->get_defaultTextFormat();
HXLINE( 155)			if ((t->_font.indexOf(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,null()) == -1)) {
HXLINE( 157)				HX_VARI(  ::flixel::addons::ui::FontDef,fd) = ::flixel::addons::ui::FontDef_obj::copyFromFlxText(t);
HXLINE( 158)				fd->apply(null(),( ( ::flixel::text::FlxText)(this->label) ));
            			}
            			else {
HXLINE( 162)				HX_VARI( ::String,flxAlign) = ::flixel::text::_FlxText::FlxTextAlign_Impl__obj::fromOpenFL(tf->align);
...
HXLINE( 194)		HX_VARI(  ::openfl::display::BitmapData,newBmp) = this->_noIconGraphicsBkup->clone();
HXLINE( 197)		HX_VARI( ::String,key) = ((this->graphic->key + HX_(",icon:",f5,82,8b,4e)) + icon->graphic->key);
HXLINE( 198)		HX_VARI(  ::flixel::graphics::FlxGraphic,newGraphic) = ::flixel::FlxG_obj::bitmap->add(newBmp,false,key);
...
HXLINE( 203)		HX_VARI( int,sx) = X;
HXLINE( 204)		HX_VARI( int,sy) = Y;
