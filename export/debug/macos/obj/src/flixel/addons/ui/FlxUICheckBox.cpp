...
HXLINE(  57)		HX_VARI(  ::Dynamic,nb) =  ::Dynamic(::hx::Anon_obj::Create(2)
...
int FlxUICheckBox_obj::set_color(int _tmp_Value){
            	...
            	HX_STACK_THIS(this)
HXLINE(  63)
HXLINE(  64)		HX_VARI( int,Value) = _tmp_Value;
...
HXLINE( 262)					HX_VARI(  ::flixel::addons::ui::FlxUIText,ftu) = ( ( ::flixel::addons::ui::FlxUIText)(this->button->label) );
