...
HXDLIN(  33)		this->super::destroy();
 ...
 ::Dynamic FlxUIGroup_obj::add( ::Dynamic _tmp_Object){
            	...
            	HX_STACK_THIS(this)
HXLINE(  37)
HXLINE(  38)		HX_VARI(  ::flixel::FlxSprite,Object) = ( ( ::flixel::FlxSprite)(_tmp_Object) );
HXDLIN(  38)		HX_VARI(  ::flixel::FlxSprite,obj) = ( ( ::flixel::FlxSprite)(this->super::add(Object)) );
...
HXLINE(  47)
HXLINE(  48)		HX_VARI(  ::flixel::FlxSprite,Object) = ( ( ::flixel::FlxSprite)(_tmp_Object) );
HXDLIN(  48)		HX_VARI(  ::flixel::FlxSprite,obj) = ( ( ::flixel::FlxSprite)(this->super::remove(Object,Splice)) );
...
HXDLIN(  58)			HX_VARI(  ::flixel::FlxSprite,obj) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  58)			_g = (_g + 1);
...
HXLINE(  69)				HX_VARI(  ::flixel::FlxSprite,obj) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  69)				_g = (_g + 1);
...
HXLINE(  87)			HX_VARI( Float,left) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(  88)			HX_VARI( Float,right) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(  89)			HX_VARI( Float,top) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(  90)			HX_VARI( Float,bottom) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(  91)			{
HXLINE(  91)				int _g = 0;
HXDLIN(  91)				::Array< ::Dynamic> _g1 = this->group->members;
HXDLIN(  91)				while((_g < _g1->length)){
HXLINE(  91)					HX_VARI(  ::flixel::FlxSprite,fb) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  91)					_g = (_g + 1);
HXLINE(  93)					if (::hx::IsNotNull( fb )) {
HXLINE(  95)						if (::Std_obj::isOfType(fb,::hx::ClassOf< ::flixel::addons::ui::interfaces::IFlxUIWidget >())) {
HXLINE(  97)							HX_VARI(  ::flixel::FlxSprite,flui) = fb;
...
HXLINE( 117)								HX_VARI(  ::flixel::FlxSprite,flxi) = fb;
...
void FlxUIGroup_obj::floorAll(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 157)
HXLINE( 158)		HX_VARI(  ::flixel::FlxSprite,fs) = null();
HXLINE( 159)		{
HXLINE( 159)			int _g = 0;
HXDLIN( 159)			::Array< ::Dynamic> _g1 = this->group->members;
HXDLIN( 159)			while((_g < _g1->length)){
HXLINE( 159)				HX_VARI(  ::flixel::FlxSprite,fb) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 159)				_g = (_g + 1);
HXLINE( 161)				fs = fb;
