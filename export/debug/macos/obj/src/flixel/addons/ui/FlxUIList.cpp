...
HXLINE(  88)				HX_VARI( ::Dynamic,widget) = Widgets->__get(_g);
HXDLIN(  88)				_g = (_g + 1);
...
HXDLIN( 102)			int i = -1;
HXDLIN( 102)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,pButton) =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,HX_(" ",20,00,00,00), ::Dynamic(new _hx_Closure_0(_g1,i)),null(),null(),null());
...
HXLINE( 127)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,fuib) = ( ( ::flixel::addons::ui::FlxUIButton)(this->prevButton) );
...
HXLINE( 132)				HX_VARI(  ::flixel::addons::ui::FlxUISpriteButton,fusb) = ( ( ::flixel::addons::ui::FlxUISpriteButton)(this->prevButton) );
...
HXDLIN( 139)			int i3 = 1;
HXDLIN( 139)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,nButton) =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,HX_(" ",20,00,00,00), ::Dynamic(new _hx_Closure_3(_g4,i3)),null(),null(),null());
...
HXLINE( 163)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,fuib1) = ( ( ::flixel::addons::ui::FlxUIButton)(this->nextButton) );
...
HXLINE( 168)				HX_VARI(  ::flixel::addons::ui::FlxUISpriteButton,fusb1) = ( ( ::flixel::addons::ui::FlxUISpriteButton)(this->nextButton) );
...
HXLINE( 179)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
...
void FlxUIList_obj::setSize(Float W,Float H){
            	...
            	HX_STACK_ARG(H,"H")
HXLINE( 197)
HXLINE( 198)		HX_VARI( bool,flip) = false;
...
HXLINE( 210)		this->refreshList();
 ...
 ::Dynamic FlxUIList_obj::add( ::Dynamic _tmp_Object){
            	...
            	HX_STACK_THIS(this)
HXLINE( 214)
HXLINE( 215)		HX_VARI(  ::flixel::FlxSprite,Object) = ( ( ::flixel::FlxSprite)(_tmp_Object) );
...
::String FlxUIList_obj::getMoreString(int i){
            	...
            	HX_STACK_ARG(i,"i")
HXLINE( 229)
HXLINE( 230)		HX_VARI( ::String,newString) = this->moreString;
...
HXLINE( 269)		HX_VARI( Float,XX) = ( (Float)(0) );
HXLINE( 270)		HX_VARI( Float,YY) = ( (Float)(0) );
HXLINE( 272)		HX_VARI( int,i) = 0;
HXLINE( 273)		HX_VARI( bool,inBounds) = true;
...
HXLINE( 295)		HX_VARI( int,highestIndex) = 0;
HXLINE( 297)		{
HXLINE( 297)			int _g = 0;
HXDLIN( 297)			::Array< ::Dynamic> _g1 = this->group->members;
HXDLIN( 297)			while((_g < _g1->length)){
HXLINE( 297)				HX_VARI(  ::flixel::FlxSprite,widget) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 297)				_g = (_g + 1);
...
HXLINE( 337)		HX_VAR(  ::flixel::addons::ui::FlxUIButton,fuibutton);
