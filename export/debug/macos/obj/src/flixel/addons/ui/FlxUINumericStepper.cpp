...
void FlxUINumericStepper_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< Float >  __o_StepSize,::hx::Null< Float >  __o_DefaultValue,::hx::Null< Float >  __o_Min,::hx::Null< Float >  __o_Max,::hx::Null< int >  __o_Decimals,::hx::Null< int >  __o_Stack, ::flixel::text::FlxText TextField, ::flixel::addons::ui::FlxUITypedButton ButtonPlus, ::flixel::addons::ui::FlxUITypedButton ButtonMinus,::hx::Null< bool >  __o_IsPercent){
            	...
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
            	HX_STACK_ARG(StepSize,"StepSize")
...
HXLINE( 219)			HX_VARI(  ::flixel::addons::ui::FlxUIInputText,fuit) = ( ( ::flixel::addons::ui::FlxUIInputText)(this->text_field) );
...
HXLINE( 232)		HX_VARI( int,btnSize) = (1 + ( (int)(TextField->get_height()) ));
...
int FlxUINumericStepper_obj::set_color(int _tmp_Value){
            	...
            	HX_STACK_THIS(this)
HXLINE(  54)
HXLINE(  55)		HX_VARI( int,Value) = _tmp_Value;
...
HXLINE(  60)			HX_VARI(  ::flixel::addons::ui::FlxInputText,fit) = ( ( ::flixel::addons::ui::FlxInputText)(this->text_field) );
...
HXLINE( 103)			HX_VARI( Float,displayValue) = this->value;
...
HXLINE( 138)		HX_VARI( int,btnSize) = 10;
HXLINE( 139)		HX_VARI( int,offsetX) = 0;
HXLINE( 140)		HX_VARI( int,offsetY) = 0;
...
HXLINE( 181)
HXLINE( 182)		HX_VARI( Float,tens) = ::Math_obj::pow(( (Float)(10) ),( (Float)(digits) ));
...
HXLINE( 272)		HX_VARI( int,numDecimals) = 0;
HXLINE( 273)		{
HXLINE( 273)			int _g = 0;
...
HXLINE( 275)				HX_VARI_NAME( ::String,_hx_char,"char") = text.charAt(i);
HXLINE( 276)				if ((_hx_char == HX_(".",2e,00,00,00))) {
HXLINE( 278)					numDecimals = (numDecimals + 1);
            				}
            			}
            		}
HXLINE( 282)		HX_VAR( bool,justAddedDecimal);
