...
void FlxUIPopup_obj::quickSetup(::String title,::String body,::Array< ::String > button_labels){
            	...
            	HX_STACK_ARG(button_labels,"button_labels")
HXLINE( 171)
...
void FlxUIPopup_obj::getEvent(::String id,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray eventParams){
            	...
            	HX_STACK_ARG(eventParams,"eventParams")
HXLINE( 175)
...
HXLINE( 191)			HX_VARI( ::String,str) = HX_("",00,00,00,00);
...
HXLINE( 199)				HX_VARI( int,buttonAmount) = ::Std_obj::_hx_int(( (Float)(eventParams->__get(0)) ));
...
HXLINE( 253)			HX_VARI(  ::flixel::addons::ui::FlxUIText,text_title) = ( ( ::flixel::addons::ui::FlxUIText)(this->_ui->getAsset(HX_("title",98,15,3b,10),null())) );
...
HXLINE( 258)			HX_VARI(  ::flixel::addons::ui::FlxUIText,text_body) = ( ( ::flixel::addons::ui::FlxUIText)(this->_ui->getAsset(HX_("body",a2,7a,1b,41),null())) );
...
void FlxUIPopup_obj::_doQuickSetupButtons(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 270)
HXLINE( 271)		HX_VARI( ::Array< ::String >,arr) = ::Array_obj< ::String >::fromData( _hx_array_data_ca4a1d97_28,3);
...
HXLINE( 284)				HX_VARI( ::String,btn) = arr->__get(_g);
HXDLIN( 284)				_g = (_g + 1);
HXLINE( 286)				HX_VAR( ::Dynamic,the_btn);
...
HXLINE( 292)						HX_VARI( ::String,btnlabel) = ( (::String)( ::Dynamic(this->_quickSetupParams->__Field(HX_("button_labels",ec,d9,01,09),::hx::paccDynamic))->__GetItem(i)) );
HXLINE( 293)						HX_VARI( ::String,newlabel) = btnlabel;
