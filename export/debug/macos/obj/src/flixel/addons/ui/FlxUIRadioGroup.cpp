...
HXLINE(  54)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,fcb) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN(  54)				_g = (_g + 1);
...
HXLINE( 165)			HX_VARI(  ::flixel::FlxSprite,fs) = ( ( ::flixel::FlxSprite)(this->_box_asset) );
HXLINE( 166)			this->_box_asset = fs->graphic->key;
            		}
HXLINE( 169)		if (::Std_obj::isOfType(this->_dot_asset,::hx::ClassOf< ::flixel::FlxSprite >())) {
HXLINE( 171)			HX_VARI_NAME(  ::flixel::FlxSprite,fs1,"fs") = ( ( ::flixel::FlxSprite)(this->_dot_asset) );
...
HXLINE( 175)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,c) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN( 175)				_g = (_g + 1);
...
HXLINE( 206)		HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,c) = this->_list_radios->__get(i).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
...
HXDLIN( 225)			HX_VARI(  ::flixel::FlxSprite,fo) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 225)			_g = (_g + 1);
...
HXLINE( 235)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,c) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN( 235)				_g = (_g + 1);
...
HXLINE( 283)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,c) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN( 283)				_g = (_g + 1);
...
HXLINE( 298)		HX_VARI( int,j) = 0;
HXLINE( 299)		{
HXLINE( 299)			int _g = 0;
HXDLIN( 299)			::Array< ::Dynamic> _g1 = this->_list_radios;
HXDLIN( 299)			while((_g < _g1->length)){
HXLINE( 299)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,c) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN( 299)				_g = (_g + 1);
...
HXLINE( 321)
HXLINE( 322)		HX_VARI( int,i) = 0;
HXLINE( 323)		this->_selected = -1;
HXLINE( 324)		{
HXLINE( 324)			int _g = 0;
HXDLIN( 324)			::Array< ::Dynamic> _g1 = this->_list_radios;
HXDLIN( 324)			while((_g < _g1->length)){
HXLINE( 324)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,c) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN( 324)				_g = (_g + 1);
...
::String FlxUIRadioGroup_obj::set_selectedId(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE( 347)
HXLINE( 348)		HX_VARI( int,i) = 0;
HXLINE( 349)		this->_selected = -1;
HXLINE( 350)		{
HXLINE( 350)			int _g = 0;
HXDLIN( 350)			::Array< ::Dynamic> _g1 = this->_list_radios;
HXDLIN( 350)			while((_g < _g1->length)){
HXLINE( 350)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,c) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN( 350)				_g = (_g + 1);
...
void FlxUIRadioGroup_obj::_refreshRadios(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 422)
HXLINE( 423)		HX_VARI( Float,xx) = this->x;
HXLINE( 424)		HX_VARI( Float,yy) = this->y;
HXLINE( 425)		HX_VARI( int,i) = 0;
HXLINE( 427)		HX_VARI( Float,maxX) = ( (Float)(0) );
HXLINE( 428)		HX_VARI( Float,maxY) = ( (Float)(0) );
HXLINE( 430)		this->_list->_skipRefresh = true;
HXLINE( 432)		{
HXLINE( 432)			int _g = 0;
HXDLIN( 432)			::Array< ::String > _g1 = this->_ids;
HXDLIN( 432)			while((_g < _g1->length)){
HXLINE( 432)				HX_VARI( ::String,id) = _g1->__get(_g);
HXDLIN( 432)				_g = (_g + 1);
HXLINE( 434)				HX_VARI( ::String,label) = HX_("",00,00,00,00);
...
HXLINE( 443)				HX_VAR(  ::flixel::addons::ui::FlxUICheckBox,c);
...
void FlxUIRadioGroup_obj::updateActives(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 527)
HXLINE( 528)		HX_VARI( int,i) = 0;
HXLINE( 529)		{
HXLINE( 529)			int _g = 0;
HXDLIN( 529)			::Array< ::Dynamic> _g1 = this->_list_radios;
HXDLIN( 529)			while((_g < _g1->length)){
HXLINE( 529)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,r) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN( 529)				_g = (_g + 1);
...
HXLINE( 549)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = this->_list_radios->__get(0).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >()->button;
HXLINE( 550)			HX_VARI(  ::flixel::text::FlxText,t) = ( ( ::flixel::text::FlxText)(btn->label) );
HXLINE( 551)			HX_VARI(  ::flixel::addons::ui::FontDef,fd) = ::flixel::addons::ui::FontDef_obj::copyFromFlxText(t);
HXLINE( 552)			HX_VARI(  ::flixel::addons::ui::BorderDef,bd) =  ::flixel::addons::ui::BorderDef_obj::__alloc( HX_CTX ,t->borderStyle,t->borderColor,t->borderSize,t->borderQuality);
HXLINE( 553)			::String cs = ::flixel::text::_FlxText::FlxTextAlign_Impl__obj::fromOpenFL(t->_defaultFormat->align);
HXDLIN( 553)			HX_VARI_NAME(  ::flixel::addons::ui::CheckStyle,cs1,"cs") =  ::flixel::addons::ui::CheckStyle_obj::__alloc( HX_CTX ,16777215,fd,cs,t->color,bd);
...
HXLINE( 571)		HX_VARI( int,i) = 0;
HXLINE( 572)		{
HXLINE( 572)			int _g = 0;
HXDLIN( 572)			::Array< ::Dynamic> _g1 = this->_list_radios;
HXDLIN( 572)			while((_g < _g1->length)){
HXLINE( 572)				HX_VARI(  ::flixel::addons::ui::FlxUICheckBox,c) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUICheckBox >();
HXDLIN( 572)				_g = (_g + 1);
