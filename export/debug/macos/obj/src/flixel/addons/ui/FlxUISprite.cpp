...
void FlxUISprite_obj::resize(Float w,Float h){
            	...
            	HX_STACK_ARG(h,"h")
HXLINE(  69)
HXLINE(  70)		HX_VARI( Float,old_width) = this->get_width();
HXLINE(  71)		HX_VARI( Float,old_height) = this->get_height();
HXLINE(  73)		if ((this->resize_ratio > 0)) {
HXLINE(  75)			HX_VARI( Float,effective_ratio) = (w / h);
...
HXLINE(  91)			HX_VARI( ::String,newKey) = ::flixel::addons::ui::U_obj::loadScaledImage(this->_originalKey,w,h,null());
...
HXLINE(  98)		HX_VARI( Float,diff_w) = (this->get_width() - old_width);
HXLINE(  99)		HX_VARI( Float,diff_h) = (this->get_height() - old_height);
HXLINE( 101)		if (::hx::IsNotNull( this->resize_point )) {
HXLINE( 103)			HX_VARI( Float,delta_x) = (diff_w * this->resize_point->x);
HXLINE( 104)			HX_VARI( Float,delta_y) = (diff_h * this->resize_point->y);
...
HXLINE( 129)
HXLINE( 130)		HX_VARI(  ::flixel::FlxSprite,sprite) = this->super::loadGraphic(Graphic,Animated,Width,Height,Unique,Key);
