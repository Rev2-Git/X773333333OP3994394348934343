...
HXLINE(  53)				HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,g) = ( ( ::flixel::group::FlxTypedSpriteGroup)(this->label) );
HXLINE(  54)				{
HXLINE(  54)					int _g = 0;
HXDLIN(  54)					::Array< ::Dynamic> _g1 = g->group->members;
HXDLIN(  54)					while((_g < _g1->length)){
HXLINE(  54)						HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  54)						_g = (_g + 1);
HXLINE(  56)						sprite->set_x((-(sprite->get_width()) / ( (Float)(2) )));
HXLINE(  57)						sprite->set_y((-(sprite->get_height()) / ( (Float)(2) )));
            					}
            				}
HXLINE(  62)				HX_VARI( Float,W) = g->get_width();
HXLINE(  63)				HX_VARI( Float,H) = g->get_height();
HXLINE(  65)				{
HXLINE(  65)					int _g2 = 0;
HXDLIN(  65)					::Array< ::Dynamic> _g3 = g->group->members;
HXDLIN(  65)					while((_g2 < _g3->length)){
HXLINE(  65)						HX_VARI_NAME(  ::flixel::FlxSprite,sprite1,"sprite") = _g3->__get(_g2).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  65)						_g2 = (_g2 + 1);
