...
HX_LOCAL_STACK_FRAME(_hx_pos_060bddf2a47172f7_84_set_reload_ui_on_asset_change,"flixel.addons.ui.FlxUIState","set_reload_ui_on_asset_change",0xa225ec2b,"flixel.addons.ui.FlxUIState.set_reload_ui_on_asset_change","flixel/addons/ui/FlxUIState.hx",84,0xa272d441)
...
HX_LOCAL_STACK_FRAME(_hx_pos_060bddf2a47172f7_67_boot,"flixel.addons.ui.FlxUIState","boot",0x9679c864,"flixel.addons.ui.FlxUIState.boot","flixel/addons/ui/FlxUIState.hx",67,0xa272d441)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE(  57)		this->_liveFilePath = HX_("",00,00,00,00);
...
bool FlxUIState_obj::set_reload_ui_on_asset_change(bool b){
            	HX_STACKFRAME(&_hx_pos_060bddf2a47172f7_84_set_reload_ui_on_asset_change)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b,"b")
HXLINE(  84)
HXLINE(  86)		if (b) {
HXLINE(  87)			::openfl::utils::Assets_obj::addEventListener(HX_("change",70,91,72,b7),this->reloadUI_dyn(),null(),null(),null());
            		}
            		else {
HXLINE(  89)			::openfl::utils::Assets_obj::removeEventListener(HX_("change",70,91,72,b7),this->reloadUI_dyn(),null());
            		}
HXLINE(  90)		return (this->reload_ui_on_asset_change = b);
            	}
...
HXDLIN( 102)		if (::hx::IsNotNull( ::flixel::addons::ui::FlxUIState_obj::static_liveFilePath )) {
HXLINE( 102)			_hx_tmp = (::flixel::addons::ui::FlxUIState_obj::static_liveFilePath != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 102)			_hx_tmp = false;
            		}
HXDLIN( 102)		if (_hx_tmp) {
HXLINE( 104)			this->_liveFilePath = ::flixel::addons::ui::FlxUIState_obj::static_liveFilePath;
            		}
...
HXLINE( 117)		HX_VARI(  ::Xml,liveFile) = null();
HXLINE( 120)		bool _hx_tmp1;
HXDLIN( 120)		if (::hx::IsNotNull( this->_liveFilePath )) {
HXLINE( 120)			_hx_tmp1 = (this->_liveFilePath != HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 124)				liveFile = ::flixel::addons::ui::U_obj::readAccess(::flixel::addons::ui::U_obj::fixSlash((this->_liveFilePath + this->_xml_id)));
HXLINE( 125)				 ::Dynamic _hx_tmp2 = ::haxe::Log_obj::trace;
HXDLIN( 125)				::String _hx_tmp3 = (HX_("liveFile = ",db,e2,06,d5) + ::Std_obj::string(liveFile));
HXDLIN( 125)				_hx_tmp2(_hx_tmp3,::hx::SourceInfo(HX_("flixel/addons/ui/FlxUIState.hx",41,d4,72,a2),125,HX_("flixel.addons.ui.FlxUIState",7c,89,c0,87),HX_("create",fc,66,0f,7c)));
            			} catch( ::Dynamic _hx_e) {
            				if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            					HX_STACK_BEGIN_CATCH
            					::String msg1 = _hx_e;
HXLINE( 129)					{
HXLINE( 129)						 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 129)						_this1->advanced(msg1,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            					}
HXLINE( 130)					::haxe::Log_obj::trace(msg1,::hx::SourceInfo(HX_("flixel/addons/ui/FlxUIState.hx",41,d4,72,a2),130,HX_("flixel.addons.ui.FlxUIState",7c,89,c0,87),HX_("create",fc,66,0f,7c)));
HXLINE( 131)					liveFile = null();
            				}
...
HXLINE( 122)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::String >())) {
HXLINE( 127)						HX_VARI_NAME( ::String,msg1,"msg") = ( (::String)(_g->value) );
HXLINE( 128)						{
HXLINE( 129)							{
HXLINE( 129)								 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 129)								_this1->advanced(msg1,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
HXLINE( 134)		this->_ui = this->createUI(null(),::hx::ObjectPtr<OBJ_>(this),null(),this->_tongue,this->_liveFilePath);
...
HXLINE( 145)			_hx_tmp4 = (this->_xml_id != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 145)			_hx_tmp4 = false;
            		}
HXDLIN( 145)		if (_hx_tmp4) {
HXLINE( 147)			HX_VARI(  ::Xml,data) = null();
HXLINE( 148)			HX_VARI( ::String,errorMsg) = HX_("",00,00,00,00);
...
HXLINE( 152)						if (::Std_obj::isOfType(_g1->value,::hx::ClassOf< ::String >())) {
HXLINE( 156)							HX_VARI_NAME( ::String,msg21,"msg2") = ( (::String)(_g1->value) );
HXLINE( 158)							errorMsg = msg21;
            						}
            						else {
HXLINE( 152)							HX_STACK_DO_THROW(_g1);
            						}
            					}
            					else {
            						HX_STACK_DO_THROW(_hx_e);
...
HXLINE( 164)						data = ( ( ::Xml)(::flixel::addons::ui::U_obj::xml(this->_xml_id,HX_("xml",d7,6d,5b,00),true,HX_("",00,00,00,00))) );
            						...
            						if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            							HX_STACK_BEGIN_CATCH
            							::String msg221 = _hx_e;
HXLINE( 168)							errorMsg = (errorMsg + (HX_(", ",74,26,00,00) + msg221));
            						}
            						else if (_hx_e.IsClass<  ::haxe::ValueException >() ){
            							HX_STACK_BEGIN_CATCH
...
HXLINE( 162)							if (::Std_obj::isOfType(_g2->value,::hx::ClassOf< ::String >())) {
HXLINE( 166)								HX_VARI_NAME( ::String,msg221,"msg22") = ( (::String)(_g2->value) );
HXLINE( 168)								errorMsg = (errorMsg + (HX_(", ",74,26,00,00) + msg221));
            							}
            							else {
HXLINE( 162)								HX_STACK_DO_THROW(_g2);
            							}
            						}
            						else {
            							HX_STACK_DO_THROW(_hx_e);
...
HXLINE( 195)			_hx_tmp5 = ::hx::IsNotNull( this->_ui );
            		}
            		else {
...
HXLINE( 241)			{
HXLINE( 241)				HX_VARI(  ::Dynamic,key) = this->_ui_vars->keys();
HXDLIN( 241)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 241)					HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 391)
HXLINE( 392)		HX_VARI(  ::flixel::addons::ui::FlxUI,flxui) =  ::flixel::addons::ui::FlxUI_obj::__alloc( HX_CTX ,data,ptr,superIndex_,tongue_,liveFilePath_,this->_ui_vars);
...
HXLINE( 416)		HX_VARI(  ::Xml,data) = ( ( ::Xml)(::flixel::addons::ui::U_obj::xml(this->_xml_id,null(),null(),null())) );
...
void FlxUIState_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("_liveFilePath",2c,08,44,93));
	...
	outFields->push(HX_("reload_ui_on_asset_change",ba,de,31,01));
...
static ::hx::StorageInfo FlxUIState_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(FlxUIState_obj,_liveFilePath),HX_("_liveFilePath",2c,08,44,93)},
	...
	{::hx::fsBool,(int)offsetof(FlxUIState_obj,reload_ui_on_asset_change),HX_("reload_ui_on_asset_change",ba,de,31,01)},
...
static ::hx::StaticInfo FlxUIState_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsString,(void *) &FlxUIState_obj::static_liveFilePath,HX_("static_liveFilePath",be,56,dd,71)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static ::String FlxUIState_obj_sMemberFields[] = {
	...
	HX_("set_reload_ui_on_asset_change",9d,ca,48,ab),
...
static ::String FlxUIState_obj_sStaticFields[] = {
	...
	HX_("static_liveFilePath",be,56,dd,71),
	::String(null())
};
...
{
            	HX_STACKFRAME(&_hx_pos_060bddf2a47172f7_67_boot)
HXDLIN(  67)		static_liveFilePath = HX_("",00,00,00,00);
            	}
}
