...
HXLINE(  66)					HX_VARI(  ::flixel::FlxSprite,w) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  66)					_g = (_g + 1);
HXLINE(  68)					{
...
HXLINE( 115)			HX_VARI(  ::Xml,data) = ( ( ::Xml)(::flixel::addons::ui::U_obj::xml(this->_xml_id,null(),null(),null())) );
...
HXLINE( 121)			if (::hx::IsNull( data )) {
HXLINE( 124)				::flixel::FlxG_obj::log->advanced(((HX_("FlxUISubstate: Could not load _xml_id \"",b3,e5,1e,eb) + this->_xml_id) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            			}
            			else {
...
HXLINE( 277)		HX_VARI(  ::Xml,data) = ( ( ::Xml)(::flixel::addons::ui::U_obj::xml(this->_xml_id,null(),null(),null())) );
