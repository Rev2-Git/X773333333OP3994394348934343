...
HXLINE( 163)						HX_VARI(  ::Dynamic,tdata) = tab_names_and_labels_->__get(_g);
HXDLIN( 163)						_g = (_g + 1);
HXLINE( 166)						HX_VARI(  ::flixel::addons::ui::FlxUIButton,fb) =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,( (::String)(tdata->__Field(HX_("label",f4,0d,af,6f),::hx::paccDynamic)) ),null(),null(),null(),null());
...
HXLINE( 182)						HX_VARI( ::cpp::VirtualArray,graphic_names) = ::cpp::VirtualArray_obj::__new(6)->init(0,HX_("flixel/flixel-ui/img/tab_back.png",d5,c5,cd,aa))->init(1,HX_("flixel/flixel-ui/img/tab_back.png",d5,c5,cd,aa))->init(2,HX_("flixel/flixel-ui/img/tab_back.png",d5,c5,cd,aa))->init(3,HX_("flixel/flixel-ui/img/tab.png",27,2e,82,04))->init(4,HX_("flixel/flixel-ui/img/tab.png",27,2e,82,04))->init(5,HX_("flixel/flixel-ui/img/tab.png",27,2e,82,04));
HXLINE( 190)						HX_VARI( ::Array< int >,slice9tab) = ::flixel::util::FlxStringUtil_obj::toIntArray(HX_("6,6,11,11",c0,1f,fa,07));
HXLINE( 191)						HX_VARI( ::Array< ::Dynamic>,slice9_names) = ::Array_obj< ::Dynamic>::__new(6)->init(0,slice9tab)->init(1,slice9tab)->init(2,slice9tab)->init(3,slice9tab)->init(4,slice9tab)->init(5,slice9tab);
...
HXLINE( 208)		HX_VARI( int,i) = 0;
HXLINE( 209)		HX_VARI(  ::flixel::addons::ui::FlxUITypedButton,tab) = null();
HXLINE( 210)		{
...
HXLINE( 210)				HX_VARI( ::Dynamic,t) = _g2->__get(_g1);
...
HXLINE(  57)				HX_VARI( ::Dynamic,tab) = _g1->__get(_g);
HXDLIN(  57)				_g = (_g + 1);
HXLINE(  59)				HX_VARI(  ::flixel::addons::ui::FlxUITypedButton,tabtyped) = ( ( ::flixel::addons::ui::FlxUITypedButton)(tab) );
...
HXLINE(  62)				HX_VARI(  ::flixel::addons::ui::FlxUIGroup,group) = _g3->__get(_g2).StaticCast<  ::flixel::addons::ui::FlxUIGroup >();
HXDLIN(  62)				_g2 = (_g2 + 1);
HXLINE(  64)				{
HXLINE(  64)					int _g4 = 0;
HXDLIN(  64)					::Array< ::Dynamic> _g5 = group->group->members;
HXDLIN(  64)					while((_g4 < _g5->length)){
HXLINE(  64)						HX_VARI(  ::flixel::FlxSprite,sprite) = _g5->__get(_g4).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  64)						_g4 = (_g4 + 1);
HXLINE(  66)						if (::Std_obj::isOfType(sprite,::hx::ClassOf< ::flixel::addons::ui::interfaces::IFlxUIClickable >())) {
HXLINE(  68)							HX_VARI( ::Dynamic,widget) = sprite;
...
Float FlxUITabMenu_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  83)
HXLINE(  84)		HX_VARI( ::Dynamic,fbt) = this->getFirstTab();
...
HXLINE(  99)			HX_VARI(  ::flixel::addons::ui::FlxUITypedButton,fbt) = ( ( ::flixel::addons::ui::FlxUITypedButton)(this->getFirstTab()) );
...
HXLINE( 237)				HX_VARI( ::Dynamic,tab) = _g1->__get(_g);
HXDLIN( 237)				_g = (_g + 1);
...
HXLINE( 259)				HX_VARI(  ::flixel::addons::ui::FlxUIGroup,tabGroup) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIGroup >();
HXDLIN( 259)				_g = (_g + 1);
...
HXLINE( 283)
HXLINE( 284)		HX_VARI( int,i) = this->group->members->indexOf(this->_back,null());
HXLINE( 285)		if ((i != -1)) {
HXLINE( 287)			HX_VARI(  ::flixel::FlxSprite,oldBack) = this->_back;
HXLINE( 288)			if (::Std_obj::isOfType(newBack,::hx::ClassOf< ::flixel::addons::ui::interfaces::IResizable >())) {
HXLINE( 290)				HX_VARI( ::Dynamic,ir) = newBack;
...
HXLINE( 333)		HX_VARI( ::Dynamic,tab) = this->getTab(name,null());
HXLINE( 334)		HX_VAR( ::cpp::VirtualArray,params);
...
void FlxUITabMenu_obj::stackTabs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 342)
HXLINE( 343)		HX_VARI( Float,_backx) = this->_back->x;
HXLINE( 344)		HX_VARI( Float,_backy) = this->_back->y;
HXLINE( 346)		this->group->remove(this->_back,true).StaticCast<  ::flixel::FlxSprite >();
HXLINE( 348)		HX_VARI(  ::flixel::addons::ui::FlxUITypedButton,tab) = null();
HXLINE( 349)		{
HXLINE( 349)			int _g = 0;
HXDLIN( 349)			::Array< ::Dynamic> _g1 = this->_tabs;
HXDLIN( 349)			while((_g < _g1->length)){
HXLINE( 349)				HX_VARI( ::Dynamic,t) = _g1->__get(_g);
HXDLIN( 349)				_g = (_g + 1);
...
HXLINE( 360)				HX_VARI_NAME( ::Dynamic,t1,"t") = _g3->__get(_g2);
...
HXLINE( 370)				HX_VARI(  ::flixel::addons::ui::FlxUIGroup,group) = _g5->__get(_g4).StaticCast<  ::flixel::addons::ui::FlxUIGroup >();
HXDLIN( 370)				_g4 = (_g4 + 1);
HXLINE( 372)				HX_VARI( Float,tempX) = group->x;
HXLINE( 373)				HX_VARI( Float,tempY) = group->y;
...
HXLINE( 389)		HX_VARI( int,i) = 0;
HXLINE( 390)		{
HXLINE( 390)			int _g = 0;
HXDLIN( 390)			::Array< ::Dynamic> _g1 = this->_tabs;
HXDLIN( 390)			while((_g < _g1->length)){
HXLINE( 390)				HX_VARI( ::Dynamic,tab) = _g1->__get(_g);
HXDLIN( 390)				_g = (_g + 1);
...
HXLINE( 437)			HX_VARI( ::Dynamic,_tab) = this->_tabs->__get(i);
HXLINE( 438)			HX_VARI( ::String,name) = ( (::String)(_tab->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
...
HXDLIN( 449)			HX_VARI(  ::flixel::addons::ui::FlxUIGroup,group) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIGroup >();
HXDLIN( 449)			_g = (_g + 1);
...
::Dynamic FlxUITabMenu_obj::getFirstTab(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 463)
HXLINE( 464)		HX_VARI( ::Dynamic,_the_tab) = null();
...
void FlxUITabMenu_obj::distributeTabs(::hx::Null< Float >  __o_W){
            	...
            	HX_STACK_ARG(W,"W")
HXLINE( 473)
HXLINE( 474)		HX_VARI( Float,xx) = ( (Float)(0) );
HXLINE( 476)		HX_VARI( Float,tab_width) = ( (Float)(0) );
HXLINE( 478)		if ((W == -1)) {
HXLINE( 480)			W = this->_back->get_width();
            		}
HXLINE( 483)		HX_VARI( Float,diff_size) = ( (Float)(0) );
...
HXDLIN( 487)			HX_VARI_NAME( Float,tot_size1,"tot_size") = ( (Float)((tot_size * this->_tabs->length)) );
HXLINE( 488)			if ((tot_size1 < W)) {
HXLINE( 490)				diff_size = (W - tot_size1);
            			}
            		}
HXLINE( 494)		this->_tabs->sort(this->sortTabs_dyn());
HXLINE( 496)		HX_VARI( int,i) = 0;
HXLINE( 497)		HX_VARI( Float,firstHeight) = ( (Float)(0) );
HXLINE( 499)		HX_VAR(  ::flixel::addons::ui::FlxUITypedButton,tab);
HXLINE( 500)		{
HXLINE( 500)			int _g = 0;
HXDLIN( 500)			::Array< ::Dynamic> _g1 = this->_tabs;
HXDLIN( 500)			while((_g < _g1->length)){
HXLINE( 500)				HX_VARI( ::Dynamic,t) = _g1->__get(_g);
HXDLIN( 500)				_g = (_g + 1);
...
HXLINE( 515)					HX_VARI( Float,theHeight) = tab->get_height();
HXLINE( 516)					if ((i != 0)) {
