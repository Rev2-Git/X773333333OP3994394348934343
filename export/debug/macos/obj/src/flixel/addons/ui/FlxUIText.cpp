...
HXLINE(  46)		HX_VARI( int,old_size) = ::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) ));
HXLINE(  47)		Float diff = this->get_height();
HXDLIN(  47)		HX_VARI_NAME( Float,diff1,"diff") = (diff - ( (Float)(this->graphic->bitmap->height) ));
HXLINE(  58)		HX_VARI( int,failsafe) = 0;
HXLINE(  60)		HX_VARI( int,numLines) = this->textField->get_numLines();
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUIText_obj,set_params,return )
 ...
 ::flixel::FlxSprite FlxUIText_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 117)
HXLINE( 118)		HX_VARI(  ::flixel::addons::ui::FlxUIText,newText) =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 119)		newText->set_width(this->get_width());
HXLINE( 120)		newText->set_height(this->get_height());
HXLINE( 122)		HX_VARI( ::String,theFont) = this->_font;
