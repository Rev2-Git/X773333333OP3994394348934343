...
void FlxUITileTest_obj::makeTiles(int tileWidth,int tileHeight,int tilesWide,int tilesTall,::hx::Null< int >  __o_color1,::hx::Null< int >  __o_color2){
            	...
            	HX_STACK_ARG(color2,"color2")
HXLINE(  57)
HXLINE(  58)		HX_VARI(  ::flixel::math::FlxBasePoint,size) = this->constrain(( (Float)((tileWidth * this->_tilesWide)) ),( (Float)((tileHeight * this->_tilesTall)) ));
...
HXLINE(  65)		HX_VARI(  ::openfl::display::BitmapData,canvas) = this->get_pixels();
HXLINE(  67)		HX_VARI( int,j) = 0;
HXLINE(  68)		{
HXLINE(  68)			int _g = 0;
HXDLIN(  68)			int _g1 = tilesWide;
HXDLIN(  68)			while((_g < _g1)){
HXLINE(  68)				_g = (_g + 1);
HXDLIN(  68)				HX_VARI( int,ix) = (_g - 1);
HXLINE(  70)				{
HXLINE(  70)					int _g2 = 0;
HXDLIN(  70)					int _g3 = tilesTall;
HXDLIN(  70)					while((_g2 < _g3)){
HXLINE(  70)						_g2 = (_g2 + 1);
HXDLIN(  70)						HX_VARI( int,iy) = (_g2 - 1);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxUITileTest_obj,makeTiles,(void))
 ...
 ::flixel::math::FlxBasePoint FlxUITileTest_obj::constrain(Float w,Float h){
            	...
            	HX_STACK_ARG(h,"h")
HXLINE(  90)
HXLINE(  91)		HX_VARI( int,tileWidth) = ::Std_obj::_hx_int((w / ( (Float)(this->_tilesWide) )));
HXLINE(  92)		HX_VARI( int,tileHeight) = ::Std_obj::_hx_int((h / ( (Float)(this->_tilesTall) )));
