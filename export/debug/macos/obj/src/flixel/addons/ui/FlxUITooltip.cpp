...
void FlxUITooltip_obj::show( ::flixel::FlxObject obj,::String __o_Title,::String __o_Body,::hx::Null< bool >  __o_AutoSizeVertical,::hx::Null< bool >  __o_AutoSizeHorizontal,::hx::Null< bool >  __o_ShowArrow){
            	...
            	HX_STACK_ARG(ShowArrow,"ShowArrow")
HXLINE(  44)
...
HXLINE(  96)		HX_VARI( int,titleHeight) = ::Std_obj::_hx_int((this->_titleText->textField->get_textHeight() + 4));
...
HXLINE( 109)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_bkg->get_width());
HXLINE( 110)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_bkg->get_height());
HXLINE( 112)		if (AutoSizeHorizontal) {
HXLINE( 114)			HX_VAR( Float,tw);
...
HXLINE( 145)		HX_VARI( int,oldOffX) = ::Std_obj::_hx_int(this->_anchorArrow->x->offset);
HXLINE( 146)		HX_VARI( int,oldOffY) = ::Std_obj::_hx_int(this->_anchorArrow->y->offset);
...
HXLINE( 161)			HX_VARI( int,xx) = ::Std_obj::_hx_int(::Math_obj::abs(this->_arrow->x));
...
HXLINE( 169)			HX_VARI( int,yy) = ::Std_obj::_hx_int(::Math_obj::abs(this->_arrow->y));
...
HXLINE( 181)			HX_VARI( int,tempH) = (H - ( (int)((this->style->__Field(HX_("topPadding",bc,47,4b,3c),::hx::paccDynamic) + this->style->__Field(HX_("bottomPadding",26,1e,2d,2b),::hx::paccDynamic))) ));
HXLINE( 182)			HX_VARI( int,titleOnlyOffset) = ::Std_obj::_hx_int((( (Float)((tempH - titleHeight)) ) / ( (Float)(2) )));
...
HXLINE( 235)		HX_VARI( Float,minY) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 236)		HX_VARI( Float,maxY) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 238)		{
HXLINE( 238)			int _g = 0;
HXDLIN( 238)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 238)			while((_g < _g1->length)){
HXLINE( 238)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 238)				_g = (_g + 1);
...
HXLINE( 244)				HX_VARI( Float,minMemberY) = member->y;
HXLINE( 245)				HX_VARI( Float,maxMemberY) = (minMemberY + member->get_height());
...
void FlxUITooltip_obj::refresh(int Width,int Height,::String Title,::String Body, ::flixel::addons::ui::Anchor Anchor_, ::Dynamic Style){
            	...
            	HX_STACK_ARG(Style,"Style")
HXLINE( 305)
HXLINE( 307)		HX_VARI( bool,newBkg) = ::hx::IsNull( this->_bkg );
HXLINE( 308)		HX_VARI( bool,newArrow) = ::hx::IsNull( this->_arrow );
HXLINE( 309)		HX_VARI( bool,newTitle) = ::hx::IsNull( this->_titleText );
HXLINE( 310)		HX_VARI( bool,newBody) = ::hx::IsNull( this->_bodyText );
...
HXLINE( 349)		HX_VARI(  ::flixel::graphics::FlxGraphic,test) = ::flixel::FlxG_obj::bitmap->add( ::Dynamic(Style->__Field(HX_("arrow",c9,79,8f,25),::hx::paccDynamic)),null(),null());
...
void FlxUITooltip_obj::refreshBkg(int Width,int Height, ::Dynamic Style){
            	...
            	HX_STACK_ARG(Style,"Style")
HXLINE( 398)
HXLINE( 400)		HX_VARI( ::String,key) = this->getStyleKey(Width,Height,Style);
HXLINE( 401)		if (::hx::IsNull( ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) ) )) {
HXLINE( 403)			HX_VARI(  ::openfl::display::BitmapData,pix) = null();
...
HXLINE( 430)		HX_VAR( ::String,animName);
...
HXLINE( 432)		HX_VARI( ::String,key) = ( (::String)((((((((HX_("arrowBkg:",65,32,bc,fc) + this->style->__Field(HX_("background",ee,93,1d,26),::hx::paccDynamic)) + HX_(",",2c,00,00,00)) + this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) + HX_(",",2c,00,00,00)) + this->style->__Field(HX_("borderColor",d7,3c,d5,d6),::hx::paccDynamic)) + HX_(",",2c,00,00,00)) + animName)) );
HXLINE( 434)		if (::hx::IsNull( ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) ) )) {
HXLINE( 436)			HX_VARI(  ::Dynamic,bs) = this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic);
...
HXLINE( 442)			HX_VARI( int,W) = ::Std_obj::_hx_int((this->_arrow->get_width() + bs));
HXLINE( 443)			HX_VARI( int,H) = ::Std_obj::_hx_int((this->_arrow->get_height() + bs));
HXLINE( 445)			HX_VARI(  ::openfl::display::BitmapData,bd) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,W,H,true,0);
HXLINE( 446)			::flixel::FlxG_obj::bitmap->add(bd,false,key);
HXLINE( 447)			b->loadGraphic(key,null(),null(),null(),null(),null());
HXLINE( 449)			HX_VARI( int,oldColor) = this->_arrow->color;
HXLINE( 451)			this->_arrow->set_color(( (int)(this->style->__Field(HX_("borderColor",d7,3c,d5,d6),::hx::paccDynamic)) ));
HXLINE( 453)			HX_VARI(  ::openfl::geom::Matrix,m) =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXLINE( 475)
HXLINE( 477)		HX_VAR( bool,touchHorz);
...
HXLINE( 478)		HX_VAR( bool,touchVert);
...
HXLINE( 480)		HX_VAR( bool,matchHorz);
...
HXLINE( 481)		HX_VAR( bool,matchVert);
...
HXLINE( 483)		HX_VAR( bool,touchBoth);
...
HXLINE( 484)		HX_VAR( bool,matchBoth);
...
HXLINE( 486)		HX_VARI( int,off) = ( (int)(this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxUITooltip_obj,styleFix,return )
 ...
 ::Dynamic FlxUITooltip_obj::cloneStyle( ::Dynamic s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 763)
HXLINE( 764)		HX_VAR(  ::flixel::addons::ui::FontDef,tf);
...
HXLINE( 765)		HX_VAR(  ::flixel::addons::ui::FontDef,bf);
...
HXLINE( 777)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 767)		HX_VARI_NAME(  ::Dynamic,obj2,"obj") =  ::Dynamic(::hx::Anon_obj::Create(18)
