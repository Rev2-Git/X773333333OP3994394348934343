...
void FlxUITooltipManager_obj::init(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  72)
HXLINE(  73)		HX_VAR(  ::flixel::addons::ui::FlxUI,ui);
...
HXLINE(  83)			HX_VARI(  ::Dynamic,tt) = ui->_loadTooltipData(null());
...
HXLINE( 108)			HX_VARI(  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry,entry) = this->list->pop().StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >();
...
HXLINE( 143)			HX_VARI( int,i) = this->findObj(( ( ::flixel::FlxObject)(thing) ));
HXLINE( 144)			if ((i != -1)) {
HXLINE( 145)				return (i == this->current);
            			}
HXLINE( 147)			if (checkChildren) {
HXLINE( 149)				HX_VARI(  ::flixel::addons::ui::FlxUIGroup,fuig) = ( ( ::flixel::addons::ui::FlxUIGroup)(thing) );
HXLINE( 150)				{
HXLINE( 150)					int _g = 0;
HXDLIN( 150)					::Array< ::Dynamic> _g1 = fuig->group->members;
HXDLIN( 150)					while((_g < _g1->length)){
HXLINE( 150)						HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 150)						_g = (_g + 1);
...
HXLINE( 161)				HX_VARI_NAME( int,i1,"i") = this->findBtn(thing);
HXLINE( 162)				if ((i1 == -1)) {
...
HXLINE( 168)					HX_VARI_NAME( int,i2,"i") = this->findObj(( ( ::flixel::FlxObject)(thing) ));
HXLINE( 169)					if ((i2 == -1)) {
...
void FlxUITooltipManager_obj::stickyTooltipFor( ::flixel::FlxObject thing,::hx::Null< bool >  __o_sticky){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(thing,"thing")
            	HX_STACK_ARG(sticky,"sticky")
HXLINE( 183)
HXLINE( 184)		HX_VARI( int,i) = this->findThing(thing);
HXLINE( 185)		if ((i != -1)) {
...
HXLINE( 198)
HXLINE( 199)		HX_VARI( int,i) = this->findThing(thing);
HXLINE( 200)		if ((i != -1)) {
...
HXLINE( 223)
HXLINE( 224)		HX_VARI( int,i) = this->findThing(thing);
...
HXLINE( 227)			HX_VARI(  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry,entry) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >();
...
HXLINE( 249)		HX_VARI( ::Dynamic,btn) = null();
...
HXLINE( 273)			if ((i == -1)) {
HXLINE( 278)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,b) =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,HX_("",00,00,00,00),null(),false,true,null());
...
void FlxUITooltipManager_obj::remove( ::flixel::FlxObject thing){
            	...
            	HX_STACK_ARG(thing,"thing")
HXLINE( 325)
HXLINE( 326)		HX_VARI( ::Dynamic,btn) = null();
HXLINE( 327)		HX_VARI( int,i) = -1;
...
HXLINE( 343)			HX_VARI(  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry,entry) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >();
...
HXDLIN( 352)			_g = (_g + 1);
HXDLIN( 352)			HX_VARI( int,i) = (_g - 1);
HXLINE( 354)			HX_VARI( ::Dynamic,btn) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->btn;
HXLINE( 355)			HX_VARI(  ::flixel::FlxObject,obj) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->obj;
...
HXLINE( 441)				HX_VARI(  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >();
HXDLIN( 441)				_g = (_g + 1);
...
HXLINE( 505)		HX_VARI( ::Dynamic,btn) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->btn;
...
HXLINE( 514)			HX_VARI( Float,deltaX) = (( (Float)(btn->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) ) - this->lastPosition->x);
HXLINE( 515)			HX_VARI( Float,deltaY) = (( (Float)(btn->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) ) - this->lastPosition->y);
...
HXLINE( 527)		HX_VARI(  ::Dynamic,data) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->data;
...
HXLINE( 535)		HX_VARI( bool,autoSizeVertical) = true;
HXLINE( 536)		HX_VARI( bool,autoSizeHorizontal) = true;
