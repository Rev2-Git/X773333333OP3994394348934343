...
HXLINE( 243)		HX_VARI(  ::flixel::math::FlxBasePoint,ctPt) = other->getCenterLabelOffset();
HXLINE( 244)		this->setCenterLabelOffset(ctPt->x,ctPt->y);
HXLINE( 246)		HX_VARI( int,i) = 0;
HXLINE( 247)		{
HXLINE( 247)			int _g = 0;
HXDLIN( 247)			::Array< ::Dynamic> _g1 = other->labelOffsets;
HXDLIN( 247)			while((_g < _g1->length)){
HXLINE( 247)				HX_VARI(  ::flixel::math::FlxBasePoint,flxPt) = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 247)				_g = (_g + 1);
...
HXLINE( 255)				HX_VARI( Float,alpha) = _g3->__get(_g2);
...
HXDLIN( 267)			HX_VARI(  ::flixel::math::FlxBasePoint,labelOffset) = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 267)			_g = (_g + 1);
HXLINE( 269)			{
...
HXLINE( 290)			HX_VARI(  ::flixel::FlxSprite,theLabel) = this->fetchAndShowCorrectLabel();
...
void FlxUITypedButton_obj::doResize(Float W,Float H,::hx::Null< bool >  __o_Redraw){
            	...
            	HX_STACK_ARG(W,"W")
            	HX_STACK_ARG(H,"H")
            	HX_STACK_ARG(Redraw,"Redraw")
HXLINE( 338)
HXLINE( 339)		HX_VARI( Float,old_width) = this->get_width();
HXLINE( 340)		HX_VARI( Float,old_height) = this->get_height();
HXLINE( 342)		HX_VARI( Float,label_diffx) = ( (Float)(0) );
HXLINE( 343)		HX_VARI( Float,label_diffy) = ( (Float)(0) );
...
HXLINE( 369)					HX_VAR(  ::openfl::display::BitmapData,upB);
...
HXLINE( 392)				HX_VARI( Float,targetW) = (W - label_diffx);
HXLINE( 393)				HX_VARI( Float,targetH) = (H - label_diffy);
HXLINE( 394)				HX_VARI( ::Dynamic,ir) = this->label;
HXLINE( 395)				::flixel::addons::ui::interfaces::IResizable_obj::resize(ir,targetW,targetH);
            			}
            		}
HXLINE( 399)		this->autoCenterLabel();
HXLINE( 401)		HX_VARI( Float,diff_w) = (this->get_width() - old_width);
HXLINE( 402)		HX_VARI( Float,diff_h) = (this->get_height() - old_height);
HXLINE( 404)		if (::hx::IsNotNull( this->resize_point )) {
HXLINE( 406)			HX_VARI( Float,delta_x) = (diff_w * this->resize_point->x);
HXLINE( 407)			HX_VARI( Float,delta_y) = (diff_h * this->resize_point->y);
...
HXLINE( 429)		HX_VARI( ::String,key) = HX_("",00,00,00,00);
...
HXDLIN( 457)				HX_VARI_NAME(  ::openfl::display::BitmapData,pixels2,"pixels") = this->assembleButtonFrames(pixels,pixels1,this->getBmp(assets->__get(2)));
...
HXDLIN( 487)					HX_VARI_NAME(  ::openfl::display::BitmapData,pixels_normal2,"pixels_normal") = this->assembleButtonFrames(pixels_normal,pixels_normal1,this->getBmp(assets->__get(2)));
...
HXDLIN( 488)					HX_VARI_NAME(  ::openfl::display::BitmapData,pixels_toggle2,"pixels_toggle") = this->assembleButtonFrames(pixels_toggle,pixels_toggle1,this->getBmp(assets->__get(5)));
HXLINE( 489)					HX_VARI_NAME(  ::openfl::display::BitmapData,pixels3,"pixels") = this->combineToggleBitmaps(pixels_normal2,pixels_toggle2);
...
HXLINE( 514)		HX_VARI(  ::openfl::display::BitmapData,upB) = null();
HXLINE( 515)		HX_VARI(  ::openfl::display::BitmapData,overB) = null();
HXLINE( 516)		HX_VARI(  ::openfl::display::BitmapData,downB) = null();
HXLINE( 518)		HX_VARI(  ::openfl::display::BitmapData,bd) = null();
...
HXLINE( 533)		HX_VARI(  ::Dynamic,normalGraphic) = key;
...
HXLINE( 541)			HX_VARI(  ::openfl::display::BitmapData,normalPixels) = this->assembleButtonFrames(upB,overB,downB);
...
HXLINE( 547)			HX_VARI(  ::openfl::display::BitmapData,togglePixels) = this->assembleButtonFrames(upB,overB,downB);
HXLINE( 548)			HX_VARI(  ::openfl::display::BitmapData,combinedPixels) = this->combineToggleBitmaps(normalPixels,togglePixels);
...
HXLINE( 598)		HX_VARI( ::String,key) = HX_("",00,00,00,00);
HXLINE( 600)		HX_VARI( ::Array< ::Dynamic>,arr_bmpData) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 601)		HX_VARI( ::Array< ::Dynamic>,arr_flx9) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 618)			HX_VARI( int,max_index) = 2;
...
HXLINE( 657)		HX_VARI(  ::flixel::math::FlxBasePoint,pt) = ::flixel::addons::ui::U_obj::applyResize(this->resize_ratio,this->resize_ratio_axis,( (Float)(W) ),( (Float)(H) ),null());
HXLINE( 658)		W = ::Std_obj::_hx_int(pt->x);
HXLINE( 659)		H = ::Std_obj::_hx_int(pt->y);
HXLINE( 661)		if (::hx::IsNull( assets )) {
HXLINE( 663)			HX_VAR(  ::openfl::display::BitmapData,temp);
...
HXLINE( 705)		HX_VARI( ::String,midKey) = key;
...
HXLINE( 712)			HX_VARI(  ::openfl::display::BitmapData,all) = this->getBmp(assets->__get(0));
HXLINE( 714)			HX_VARI( ::String,keySuffix) = HX_("_all",22,3e,15,3f);
...
HXLINE( 721)			HX_VARI( bool,multiFrame) = (all->height > this->_src_h);
...
HXDLIN( 742)						HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXDLIN( 752)							HX_VARI_NAME( int,i2,"i") = (_g4 - 1);
...
HXDLIN( 759)							HX_VARI_NAME( int,i3,"i") = (_g6 - 1);
...
HXDLIN( 828)							HX_VARI_NAME( int,i4,"i") = (_g8 - 1);
...
HXDLIN( 851)							HX_VARI_NAME( int,i5,"i") = (_g10 - 1);
...
HXLINE( 878)		HX_VARI(  ::openfl::display::BitmapData,normalPixels) = null();
...
HXLINE( 888)			HX_VARI_NAME(  ::openfl::display::BitmapData,normalPixels1,"normalPixels") = this->assembleButtonFrames(arr_bmpData->__get(frame_indeces->__get(0)).StaticCast<  ::openfl::display::BitmapData >(),arr_bmpData->__get(frame_indeces->__get(1)).StaticCast<  ::openfl::display::BitmapData >(),arr_bmpData->__get(frame_indeces->__get(2)).StaticCast<  ::openfl::display::BitmapData >());
HXLINE( 890)			HX_VARI(  ::openfl::display::BitmapData,togglePixels) = this->assembleButtonFrames(arr_bmpData->__get(frame_indeces->__get(3)).StaticCast<  ::openfl::display::BitmapData >(),arr_bmpData->__get(frame_indeces->__get(4)).StaticCast<  ::openfl::display::BitmapData >(),arr_bmpData->__get(frame_indeces->__get(5)).StaticCast<  ::openfl::display::BitmapData >());
HXLINE( 892)			HX_VARI(  ::openfl::display::BitmapData,combinedPixels) = this->combineToggleBitmaps(normalPixels1,togglePixels);
...
HXDLIN( 903)				HX_VARI_NAME( int,i6,"i") = (_g12 - 1);
...
HXLINE( 930)			HX_VARI( Float,offX) = ( (Float)(0) );
HXLINE( 931)			HX_VARI( Float,offY) = ( (Float)(0) );
...
HXLINE( 937)				HX_VARI(  ::flixel::addons::ui::FlxUIText,tlabel) = ( ( ::flixel::addons::ui::FlxUIText)(this->label) );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUITypedButton_obj,forceStateHandler,(void))
 ...
 ::openfl::display::BitmapData FlxUITypedButton_obj::grabButtonFrame( ::openfl::display::BitmapData all_frames,int button_state,::hx::Null< bool >  __o_for_toggle,::hx::Null< int >  __o_src_w,::hx::Null< int >  __o_src_h,::String key){
            	...
            	HX_STACK_ARG(key,"key")
HXLINE( 991)
HXLINE( 992)		HX_VARI( int,h) = src_h;
HXLINE( 993)		if ((h == 0)) {
...
HXLINE(1004)		HX_VARI( int,w) = src_w;
HXLINE(1005)		if ((w == 0)) {
...
HXLINE(1017)			HX_VARI( int,framesHigh) = ::Std_obj::_hx_int((( (Float)(all_frames->height) ) / ( (Float)(h) )));
...
HXLINE(1035)		HX_VARI( ::String,frameKey) = (((((((((key + HX_("{x:",fd,bd,5d,00)) + this->_flashRect->x) + HX_("y:",a1,69,00,00)) + this->_flashRect->y) + HX_("w:",e3,67,00,00)) + this->_flashRect->width) + HX_("h:",d2,5a,00,00)) + this->_flashRect->height) + HX_("}",7d,00,00,00));
...
HXLINE(1044)		HX_VARI(  ::openfl::display::BitmapData,pixels) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,w,h,null(),null());
...
HXLINE(1058)
HXLINE(1059)		HX_VARI(  ::openfl::display::BitmapData,combined) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,normal->width,(normal->height + toggle->height),null(),null());
...
HXLINE(1074)
HXLINE(1075)		HX_VAR(  ::openfl::display::BitmapData,pixels);
...
HXLINE(1135)				HX_VARI( ::String,key) = _g1->__get(_g);
HXDLIN(1135)				_g = (_g + 1);
...
HXLINE(1175)			HX_VARI(  ::flixel::FlxSprite,theLabel) = this->fetchAndShowCorrectLabel();
...
HXLINE(1177)			HX_VAR(  ::Dynamic,thecol);
...
HXLINE(1194)			HX_VARI(  ::flixel::FlxSprite,theLabel) = this->fetchAndShowCorrectLabel();
...
HXLINE(1196)			HX_VAR(  ::Dynamic,thecol);
...
HXLINE(1214)			HX_VARI(  ::flixel::FlxSprite,theLabel) = this->fetchAndShowCorrectLabel();
...
HXLINE(1216)			HX_VAR(  ::Dynamic,thecol);
...
HXLINE(1234)			HX_VARI(  ::flixel::FlxSprite,theLabel) = this->fetchAndShowCorrectLabel();
...
HXLINE(1236)			HX_VAR(  ::Dynamic,thecol);
