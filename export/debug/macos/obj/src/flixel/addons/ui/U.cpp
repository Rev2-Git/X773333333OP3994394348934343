...
::String U_obj::xml_name( ::Xml data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(  75)
HXLINE(  76)		HX_VARI( ::String,name) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("name",4b,72,ff,48),true,HX_("",00,00,00,00));
...
HXLINE(  91)
HXLINE(  92)		HX_VARI(  ::Dynamic,col) = null();
HXLINE(  93)		HX_VARI( ::String,str) = ::flixel::addons::ui::U_obj::xml_str(data,att,true,null());
...
::Array< int > U_obj::xml_iArray( ::Xml data,::String att){
            	...
            	HX_STACK_ARG(att,"att")
HXLINE( 106)
HXLINE( 107)		HX_VARI( ::Array< ::String >,arr) = ::flixel::addons::ui::U_obj::xml_strArray(data,att,null(),null());
HXLINE( 108)		HX_VARI( ::Array< int >,ints) = null();
...
::Array< Float > U_obj::xml_fArray( ::Xml data,::String att){
            	...
            	HX_STACK_ARG(att,"att")
HXLINE( 121)
HXLINE( 122)		HX_VARI( ::Array< ::String >,arr) = ::flixel::addons::ui::U_obj::xml_strArray(data,att,null(),null());
HXLINE( 123)		HX_VARI( ::Array< Float >,fs) = null();
...
HXLINE( 136)
HXLINE( 137)		HX_VARI( ::String,str) = ::flixel::addons::ui::U_obj::xml_str(data,att,lowerCase,null());
HXLINE( 138)		if ((str != HX_("",00,00,00,00))) {
HXLINE( 140)			HX_VARI( ::Array< ::String >,arr) = str.split(HX_(",",2c,00,00,00));
...
::Array< int > U_obj::xml_colorArray( ::Xml data,::String att,::hx::Null< bool >  __o_cast32Bit){
            	...
            	HX_STACK_ARG(cast32Bit,"cast32Bit")
HXLINE( 151)
HXLINE( 152)		HX_VARI( ::Array< ::String >,arr) = ::flixel::addons::ui::U_obj::xml_strArray(data,att,null(),null());
HXLINE( 153)		HX_VARI( ::Array< int >,cols) = null();
...
HXLINE( 175)			HX_VARI(  ::EReg,r) =  ::EReg_obj::__alloc( HX_CTX ,HX_("([0-9]+)?(\\.)?([0-9]*)?",69,52,2d,64),HX_("",00,00,00,00));
HXLINE( 176)			if (r->match(str)) {
HXLINE( 178)				HX_VARI(  ::Dynamic,match) = r->matchedPos();
...
HXLINE( 181)					HX_VARI( Float,perc_float) = ::Std_obj::parseFloat(str);
...
HXLINE( 194)		HX_VARI(  ::EReg,r) =  ::EReg_obj::__alloc( HX_CTX ,HX_("-?([0-9]+)?(\\.)?([0-9]*)?",37,d9,6d,5d),HX_("",00,00,00,00));
HXLINE( 195)		if (r->match(str)) {
HXLINE( 197)			HX_VARI(  ::Dynamic,p) = r->matchedPos();
...
bool U_obj::isStrInt(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE( 207)
HXLINE( 208)		HX_VARI(  ::EReg,r) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[0-9]+",8f,d9,9f,23),HX_("",00,00,00,00));
HXLINE( 209)		if (r->match(str)) {
HXLINE( 211)			HX_VARI(  ::Dynamic,p) = r->matchedPos();
...
bool U_obj::isStrFloat(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE( 221)
HXLINE( 222)		HX_VARI(  ::EReg,r) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[0-9]+\\.[0-9]+",f0,b3,16,fc),HX_("",00,00,00,00));
HXLINE( 223)		if (r->match(str)) {
HXLINE( 225)			HX_VARI(  ::Dynamic,p) = r->matchedPos();
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(U_obj,boolify,return )
 ...
 ::flixel::math::FlxBasePoint U_obj::pointify(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE( 300)
HXLINE( 301)		HX_VARI(  ::flixel::math::FlxBasePoint,pt) = null();
HXLINE( 302)		if (::hx::IsNotNull( str )) {
HXLINE( 304)			HX_VARI( ::Array< ::String >,arr) = ::Array_obj< ::String >::fromData( _hx_array_data_ef400604_21,5);
HXLINE( 305)			{
HXLINE( 305)				int _g = 0;
HXDLIN( 305)				while((_g < arr->length)){
HXLINE( 305)					HX_VARI( ::String,thing) = arr->__get(_g);
HXDLIN( 305)					_g = (_g + 1);
...
HXLINE( 404)			HX_VARI( bool,ba) = ::flixel::addons::ui::U_obj::boolify(variable);
HXLINE( 405)			HX_VARI( bool,bb) = ::flixel::addons::ui::U_obj::boolify(otherValue);
...
HXLINE( 377)			HX_VARI( Float,fa) = ::Std_obj::parseFloat(variable);
HXLINE( 378)			HX_VARI( Float,fb) = ::Std_obj::parseFloat(otherValue);
...
HXLINE( 350)			HX_VARI( int,ia) = ( (int)(::Std_obj::parseInt(variable)) );
HXLINE( 351)			HX_VARI( int,ib) = ( (int)(::Std_obj::parseInt(otherValue)) );
...
HXLINE( 429)			HX_VARI( ::String,str) = data->get(att);
...
HXLINE( 441)
HXLINE( 442)		HX_VARI( ::String,str) = HX_("",00,00,00,00);
...
HXLINE( 462)								HX_VARI_NAME( ::String,msg1,"msg") = ( (::String)(_g->value) );
HXLINE( 464)								{
HXLINE( 464)									 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 464)									_this1->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg1),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            								}
...
HXLINE( 527)
HXLINE( 528)		HX_VARI( Float,f) = ( (Float)(i) );
HXLINE( 529)		HX_VARI( ::String,str) = HX_("",00,00,00,00);
HXLINE( 530)		HX_VARI( int,num_digits) = 0;
...
HXLINE( 544)				_g = (_g + 1);
HXDLIN( 544)				HX_VARI( int,temp) = (_g - 1);
...
HXLINE( 578)
HXLINE( 579)		HX_VARI(  ::Dynamic,return_val) = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(str);
...
HXLINE( 620)
HXLINE( 621)		HX_VARI( int,length) = hex_str.length;
HXLINE( 622)		HX_VARI( int,place_mult) = 1;
HXLINE( 623)		HX_VARI( int,sum) = 0;
HXLINE( 624)		HX_VARI( int,i) = (length - 1);
HXLINE( 625)		while((i >= 0)){
HXLINE( 627)			HX_VARI( ::String,char_hex) = hex_str.substr(i,1);
HXLINE( 628)			HX_VAR( int,char_int);
...
HXLINE( 656)			HX_VARI( Float,effective_ratio) = (w / h);
...
HXLINE( 669)		HX_VARI( int,iw) = ::Std_obj::_hx_int(w);
HXLINE( 670)		if ((iw < 1)) {
HXLINE( 672)			w = ( (Float)(1) );
            		}
HXLINE( 674)		HX_VARI( int,ih) = ::Std_obj::_hx_int(h);
HXLINE( 675)		if ((ih < 1)) {
...
HXLINE( 713)		HX_VARI( Float,a1) = (( (Float)(1) ) - amt);
HXLINE( 715)		HX_VARI( int,c1r) = ((hex1 >> 16) & 255);
HXLINE( 716)		HX_VARI( int,c1g) = ((hex1 >> 8) & 255);
HXLINE( 717)		HX_VARI( int,c1b) = (hex1 & 255);
HXLINE( 719)		HX_VARI( int,c2r) = ((hex2 >> 16) & 255);
HXLINE( 720)		HX_VARI( int,c2g) = ((hex2 >> 8) & 255);
HXLINE( 721)		HX_VARI( int,c2b) = (hex2 & 255);
HXLINE( 723)		HX_VARI( int,c3r) = ::Std_obj::_hx_int(((( (Float)(c1r) ) * a1) + (( (Float)(c2r) ) * amt)));
HXLINE( 724)		HX_VARI( int,c3g) = ::Std_obj::_hx_int(((( (Float)(c1g) ) * a1) + (( (Float)(c2g) ) * amt)));
HXLINE( 725)		HX_VARI( int,c3b) = ::Std_obj::_hx_int(((( (Float)(c1b) ) * a1) + (( (Float)(c2b) ) * amt)));
...
HXLINE( 787)			HX_VARI( ::String,content) = ::sys::io::File_obj::getContent(path);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(U_obj,readXml,return )
 ...
 ::Xml U_obj::readAccess(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 794)
HXLINE( 795)		HX_VARI(  ::Xml,xml) = ::flixel::addons::ui::U_obj::readXml(path);
...
::String U_obj::fixSlash(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 804)
HXLINE( 805)		HX_VARI( ::String,goodSlash) = HX_("/",2f,00,00,00);
HXLINE( 806)		HX_VAR( ::String,badSlash);
...
HXLINE( 840)
HXLINE( 841)		HX_VARI(  ::Xml,xml) = data;
HXLINE( 843)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 845)			::sys::FileSystem_obj::deleteFile(path);
            		}
HXLINE( 848)		HX_VARI( ::String,xmlString) = HX_("",00,00,00,00);
HXLINE( 850)		HX_VARI(  ::sys::io::FileOutput,fout) = ::sys::io::File_obj::write(path,false);
...
HXLINE( 873)
HXLINE( 874)		HX_VARI( ::String,id) = str;
...
HXLINE( 883)
HXLINE( 884)		HX_VARI( ::String,json_str) = ::openfl::utils::Assets_obj::getText((((dir + str) + HX_(".",2e,00,00,00)) + extension));
...
HXLINE( 887)			HX_VARI(  ::Dynamic,the_json) =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,json_str)->doParse();
...
HXLINE( 899)			HX_VARI(  ::Dynamic,thing) = ::Reflect_obj::field(object,field);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(U_obj,field,return )
 ...
 ::Dynamic U_obj::xml(::String id,::String __o_extension,::hx::Null< bool >  __o_getAccess,::String __o_dir){
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(extension,"extension")
            	HX_STACK_ARG(getAccess,"getAccess")
            	HX_STACK_ARG(dir,"dir")
HXLINE( 910)
...
HXLINE( 917)		HX_VARI( ::String,thePath) = (((dir + id) + HX_(".",2e,00,00,00)) + extension);
HXLINE( 919)		HX_VARI( bool,exists) = ::openfl::utils::Assets_obj::exists(thePath,HX_("TEXT",ad,94,ba,37));
HXLINE( 921)		if (!(exists)) {
HXLINE( 923)			return null();
            		}
HXLINE( 926)		HX_VARI( ::String,str) = ::openfl::utils::Assets_obj::getText((((dir + id) + HX_(".",2e,00,00,00)) + extension));
HXLINE( 927)		if (::hx::IsNull( str )) {
HXLINE( 929)			return null();
            		}
HXLINE( 931)		HX_VARI(  ::Xml,the_xml) = ::Xml_obj::parse(str);
...
HXLINE( 953)		HX_VARI( int,i) = (array->get_length() - 1);
...
HXLINE( 971)		HX_VARI( int,i) = (array->get_length() - 1);
...
HXLINE( 993)				HX_VARI( ::Dynamic,idstr) =  ::hx::interface_check(thing,0xd4fe2fcd);
...
HXLINE( 999)					HX_VARI(  ::flixel::FlxBasic,fb) = ::hx::TCast<  ::flixel::FlxBasic >::cast(thing);
...
::String U_obj::font(::String str,::String __o_style,::String __o_extension){
            	...
            	HX_STACK_ARG(extension,"extension")
HXLINE(1025)
HXLINE(1026)		HX_VARI( ::String,ostr) = str;
...
HXLINE(1037)		HX_VARI( bool,exists) = ::openfl::utils::Assets_obj::exists(str,HX_("FONT",cf,25,81,2e));
...
HXLINE(1040)			HX_VARI( ::String,alt) = ::flixel::addons::ui::U_obj::font(ostr,style,HX_(".otf",33,70,bc,1e));
...
HXLINE(1054)		HX_VARI( ::String,suffix) = HX_("",00,00,00,00);
...
HXLINE(1105)
HXLINE(1106)		HX_VARI( ::String,str) = null();
...
HXLINE(1113)				HX_VARI(  ::flixel::graphics::FlxGraphic,fg) = ( ( ::flixel::graphics::FlxGraphic)(asset) );
HXLINE(1114)				str = fg->key;
            			}
            			else {
HXLINE(1116)				if (::Std_obj::isOfType(asset,::hx::ClassOf< ::openfl::display::BitmapData >())) {
HXLINE(1118)					HX_VARI(  ::openfl::display::BitmapData,bmp) = ( ( ::openfl::display::BitmapData)(asset) );
HXLINE(1119)					return bmp;
            				}
            			}
            		}
HXLINE(1121)		if (::hx::IsNotNull( ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(str)) ) )) {
HXLINE(1123)			HX_VARI(  ::flixel::graphics::FlxGraphic,cg) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(str)) );
...
HXLINE(1202)			HX_VARI( bool,val) = true;
...
HXLINE(1245)		HX_VARI( ::cpp::VirtualArray,arr) = ::cpp::VirtualArray_obj::__new();
...
HXLINE(1250)				HX_VARI(  ::Dynamic,thing) = src->__get(_g);
HXDLIN(1250)				_g = (_g + 1);
...
HXLINE(1263)		HX_VARI( ::Array< ::Dynamic>,arrarr) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1264)		{
HXLINE(1264)			int _g = 0;
HXDLIN(1264)			while((_g < src->length)){
HXLINE(1264)				HX_VARI( ::Array< int >,arri) = src->__get(_g).StaticCast< ::Array< int > >();
HXDLIN(1264)				_g = (_g + 1);
HXLINE(1266)				HX_VARI( ::Array< int >,temp) = ::Array_obj< int >::__new(0);
HXLINE(1267)				{
HXLINE(1267)					int _g1 = 0;
HXDLIN(1267)					while((_g1 < arri->length)){
HXLINE(1267)						HX_VARI( int,i) = arri->__get(_g1);
...
HXLINE(1282)		HX_VARI( ::Array< int >,arr) = ::Array_obj< int >::__new();
HXLINE(1283)		{
HXLINE(1283)			int _g = 0;
HXDLIN(1283)			while((_g < src->length)){
HXLINE(1283)				HX_VARI( int,thing) = src->__get(_g);
HXDLIN(1283)				_g = (_g + 1);
...
HXLINE(1296)		HX_VARI( ::Array< ::String >,arr) = ::Array_obj< ::String >::__new();
HXLINE(1297)		{
HXLINE(1297)			int _g = 0;
HXDLIN(1297)			while((_g < src->length)){
HXLINE(1297)				HX_VARI( ::String,thing) = src->__get(_g);
HXDLIN(1297)				_g = (_g + 1);
...
::String U_obj::FU_(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(1305)
HXLINE(1306)		HX_VARI( ::Array< ::String >,arr) = str.split(HX_(" ",20,00,00,00));
HXLINE(1307)		HX_VARI_NAME( ::String,str1,"str") = HX_("",00,00,00,00);
HXLINE(1308)		{
HXLINE(1308)			int _g = 0;
HXDLIN(1308)			int _g1 = arr->length;
HXDLIN(1308)			while((_g < _g1)){
HXLINE(1308)				_g = (_g + 1);
HXDLIN(1308)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1363)
HXLINE(1364)		HX_VARI(  ::openfl::display::BitmapData,orig) = ::openfl::utils::Assets_obj::getBitmapData(orig_id,false);
...
HXLINE(1377)		HX_VARI( int,widthInTiles) = ::Std_obj::_hx_int((( (Float)(orig->width) ) / ( (Float)(origW) )));
HXLINE(1378)		HX_VARI( int,heightInTiles) = ::Std_obj::_hx_int((( (Float)(orig->height) ) / ( (Float)(origH) )));
HXLINE(1381)		if ((W == -1)) {
...
HXDLIN(1393)			HX_VARI_NAME(  ::openfl::display::BitmapData,scaled1,"scaled") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,scaled,::Std_obj::_hx_int(( (Float)((H * heightInTiles)) )),true,0);
HXLINE(1394)			HX_VARI(  ::openfl::geom::Rectangle,rect) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE(1395)			HX_VARI(  ::openfl::geom::Point,pt) =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXLINE(1396)			HX_VARI(  ::openfl::geom::Matrix,matrix) =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXLINE(1398)					_g = (_g + 1);
HXDLIN(1398)					HX_VARI( int,tiley) = (_g - 1);
HXLINE(1400)					{
HXLINE(1400)						int _g2 = 0;
HXDLIN(1400)						int _g3 = widthInTiles;
HXDLIN(1400)						while((_g2 < _g3)){
HXLINE(1400)							_g2 = (_g2 + 1);
HXDLIN(1400)							HX_VARI( int,tilex) = (_g2 - 1);
HXLINE(1402)							HX_VARI(  ::openfl::display::BitmapData,tile) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,origW,origH,true,0);
...
HXLINE(1407)							HX_VARI(  ::openfl::display::BitmapData,scaleTile) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,W,H,true,0);
...
::String U_obj::scaleAndStoreTileset(::String orig_id,Float scale,int OrigW,int OrigH,::hx::Null< int >  __o_TileW,::hx::Null< int >  __o_TileH,::hx::Null< bool >  __o_Smooth){
            	...
            	HX_STACK_ARG(Smooth,"Smooth")
HXLINE(1434)
HXLINE(1435)		HX_VARI( ::String,assetKey) = ((orig_id + HX_("_x",39,53,00,00)) + scale);
HXLINE(1437)		if ((::hx::IsNotNull( ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(assetKey)) ) ) == false)) {
HXLINE(1439)			HX_VARI(  ::openfl::display::BitmapData,bmp) = ::flixel::addons::ui::U_obj::scaleTileBmp(orig_id,scale,OrigW,OrigH,TileW,TileH,Smooth);
...
::String U_obj::loadScaledImage(::String src,Float W,Float H,::hx::Null< bool >  __o_smooth){
            	...
            	HX_STACK_ARG(smooth,"smooth")
HXLINE(1454)
HXLINE(1455)		HX_VARI( ::String,bmpSrc) = ::flixel::addons::ui::U_obj::gfx(src,null(),null(),null(),null(),null());
HXLINE(1456)		HX_VARI(  ::openfl::display::BitmapData,testBmp) = ::openfl::utils::Assets_obj::getBitmapData(bmpSrc,false);
...
HXLINE(1469)			HX_VARI( Float,diff) = (::Math_obj::abs((W - ( (Float)(testBmp->width) ))) + ::Math_obj::abs((H - ( (Float)(testBmp->height) ))));
HXLINE(1472)			if ((diff > ((Float)0.01))) {
HXLINE(1474)				::String scaleKey = (((bmpSrc + HX_("_",5f,00,00,00)) + ::Std_obj::_hx_int(W)) + HX_("x",78,00,00,00));
HXDLIN(1474)				HX_VARI_NAME( ::String,scaleKey1,"scaleKey") = (scaleKey + ::Std_obj::_hx_int(H));
HXLINE(1477)				if (::hx::IsNull( ::flixel::FlxG_obj::bitmap->_cache->get(scaleKey1) )) {
HXLINE(1479)					int scaledBmp = ::Std_obj::_hx_int(W);
HXDLIN(1479)					HX_VARI_NAME(  ::openfl::display::BitmapData,scaledBmp1,"scaledBmp") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,scaledBmp,::Std_obj::_hx_int(H),true,0);
HXLINE(1481)					HX_VARI(  ::openfl::geom::Matrix,m) = ::flixel::addons::ui::U_obj::getMatrix();
...
HXLINE(1500)
HXLINE(1501)		HX_VARI( ::String,bmpSrc) = ::flixel::addons::ui::U_obj::gfx(src,null(),null(),null(),null(),null());
HXLINE(1502)		HX_VARI(  ::openfl::display::BitmapData,testBmp) = null();
HXLINE(1504)		if (!(checkFlxBitmap)) {
HXLINE(1506)			testBmp = ::openfl::utils::Assets_obj::getBitmapData(bmpSrc,false);
            		}
            		else {
HXLINE(1510)			HX_VARI(  ::flixel::graphics::FlxGraphic,flximg) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(bmpSrc)) );
...
HXLINE(1514)		HX_VAR( Float,ratio);
...
HXLINE(1527)
HXLINE(1528)		HX_VARI( ::String,bmpSrc) = ::flixel::addons::ui::U_obj::gfx(src,null(),null(),null(),null(),null());
HXLINE(1530)		HX_VARI(  ::openfl::display::BitmapData,testBmp) = null();
...
HXLINE(1542)			HX_VARI(  ::flixel::graphics::FlxGraphic,flximg) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(bmpSrc)) );
...
HXLINE(1556)				HX_VARI( ::String,scaleKey) = ((bmpSrc + HX_("_ScaleX",4d,70,31,df)) + Scale);
...
HXDLIN(1561)					HX_VARI_NAME(  ::openfl::display::BitmapData,scaledBmp1,"scaledBmp") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,scaledBmp,::Std_obj::_hx_int((( (Float)(testBmp->height) ) * Scale)),true,0);
HXLINE(1564)					HX_VARI(  ::openfl::geom::Matrix,m) = ::flixel::addons::ui::U_obj::getMatrix();
...
HXLINE(1572)						HX_VARI(  ::openfl::display::BitmapData,black) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,scaledBmp1->width,scaledBmp1->height,true,-16777216);
...
HXLINE(1578)						HX_VARI(  ::openfl::display::BitmapData,temp) = scaledBmp1;
...
HXLINE(1605)		HX_VARI( ::String,prefix) = HX_("",00,00,00,00);
...
::Array< int > U_obj::bmpToArrayIntLayer(int color_index, ::openfl::display::BitmapData bd){
            	...
            	HX_STACK_ARG(bd,"bd")
HXLINE(1660)
HXLINE(1662)		HX_VAR( int,p);
HXLINE(1663)		HX_VARI( ::Array< int >,arr) = ::Array_obj< int >::__new(0);
HXLINE(1664)		HX_VARI( int,w) = bd->width;
HXLINE(1665)		HX_VARI( int,h) = bd->height;
HXLINE(1666)		{
HXLINE(1666)			int _g = 0;
HXDLIN(1666)			int _g1 = h;
HXDLIN(1666)			while((_g < _g1)){
HXLINE(1666)				_g = (_g + 1);
HXDLIN(1666)				HX_VARI( int,r) = (_g - 1);
HXLINE(1668)				{
HXLINE(1668)					int _g2 = 0;
HXDLIN(1668)					int _g3 = w;
HXDLIN(1668)					while((_g2 < _g3)){
HXLINE(1668)						_g2 = (_g2 + 1);
HXDLIN(1668)						HX_VARI( int,c) = (_g2 - 1);
...
::String U_obj::bmpToCSVLayer(int color_index, ::openfl::display::BitmapData bd){
            	...
            	HX_STACK_ARG(bd,"bd")
HXLINE(1698)
HXLINE(1700)		HX_VAR( int,p);
HXLINE(1701)		HX_VARI( ::String,csv) = HX_("",00,00,00,00);
HXLINE(1702)		HX_VARI( int,w) = bd->width;
HXLINE(1703)		HX_VARI( int,h) = bd->height;
HXLINE(1704)		{
HXLINE(1704)			int _g = 0;
HXDLIN(1704)			int _g1 = h;
HXDLIN(1704)			while((_g < _g1)){
HXLINE(1704)				_g = (_g + 1);
HXDLIN(1704)				HX_VARI( int,r) = (_g - 1);
HXLINE(1706)				{
HXLINE(1706)					int _g2 = 0;
HXDLIN(1706)					int _g3 = w;
HXDLIN(1706)					while((_g2 < _g3)){
HXLINE(1706)						_g2 = (_g2 + 1);
HXDLIN(1706)						HX_VARI( int,c) = (_g2 - 1);
...
::String U_obj::get_gfx(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(1738)
HXLINE(1739)		HX_VARI( ::String,return_str) = HX_("",00,00,00,00);
HXLINE(1741)		HX_VARI( ::String,suffix) = HX_("",00,00,00,00);
...
::String U_obj::sfx(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(1781)
HXLINE(1782)		HX_VARI( ::String,extension) = HX_("",00,00,00,00);
...
::Array< int > U_obj::intStr_to_arr(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(1802)
HXLINE(1803)		HX_VARI( ::Array< ::String >,arr) = str.split(HX_(",",2c,00,00,00));
HXLINE(1804)		HX_VARI( ::Array< int >,str_arr) = ::Array_obj< int >::__new();
HXLINE(1805)		{
HXLINE(1805)			int _g = 0;
HXDLIN(1805)			while((_g < arr->length)){
HXLINE(1805)				HX_VARI( ::String,s) = arr->__get(_g);
HXDLIN(1805)				_g = (_g + 1);
HXLINE(1807)				if ((s.indexOf(HX_("-",2d,00,00,00),null()) == -1)) {
HXLINE(1809)					str_arr->push(::Std_obj::parseInt(s));
            				}
            				else {
HXLINE(1813)					HX_VARI( ::Array< ::String >,range) = str.split(HX_("-",2d,00,00,00));
HXLINE(1814)					HX_VARI( int,lo) = -1;
HXLINE(1815)					HX_VARI( int,hi) = -1;
...
HXDLIN(1822)								HX_VARI( int,i) = (_g1 - 1);
...
::Array< ::String > U_obj::intStr_to_arrStr(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(1839)
HXLINE(1840)		HX_VARI( ::Array< ::String >,arr) = str.split(HX_(",",2c,00,00,00));
HXLINE(1841)		HX_VARI( ::Array< ::String >,str_arr) = ::Array_obj< ::String >::__new();
HXLINE(1842)		{
HXLINE(1842)			int _g = 0;
HXDLIN(1842)			while((_g < arr->length)){
HXLINE(1842)				HX_VARI( ::String,s) = arr->__get(_g);
HXDLIN(1842)				_g = (_g + 1);
HXLINE(1844)				if ((s.indexOf(HX_("-",2d,00,00,00),null()) == -1)) {
HXLINE(1846)					str_arr->push(::Std_obj::string(::Std_obj::parseInt(s)));
            				}
            				else {
HXLINE(1850)					HX_VARI( ::Array< ::String >,range) = str.split(HX_("-",2d,00,00,00));
HXLINE(1851)					HX_VARI( int,lo) = -1;
HXLINE(1852)					HX_VARI( int,hi) = -1;
...
HXDLIN(1859)								HX_VARI( int,i) = (_g1 - 1);
...
::String U_obj::dirStr(int XX,int YY){
            	...
            	HX_STACK_ARG(YY,"YY")
HXLINE(1871)
HXLINE(1872)		HX_VARI( ::String,str) = HX_("",00,00,00,00);
HXLINE(1873)		if ((XX == 0)) {
HXLINE(1875)			if ((YY == -1)) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(U_obj,dirStr,return )
 ...
 ::flixel::math::FlxBasePoint U_obj::obj_direction( ::flixel::FlxObject a, ::flixel::FlxObject b){
            	...
            	HX_STACK_ARG(b,"b")
HXLINE(1926)
HXLINE(1927)		HX_VARI( Float,dx) = (a->x - b->x);
HXLINE(1928)		HX_VARI( Float,dy) = (a->y - b->y);
...
HXDLIN(1930)		HX_VARI(  ::flixel::math::FlxBasePoint,ipt) = point;
...
bool U_obj::circle_test(Float x1,Float y1,Float r1,Float x2,Float y2,Float r2){
            	...
            	HX_STACK_ARG(r2,"r2")
HXLINE(1935)
HXLINE(1936)		HX_VARI( Float,dx) = (x1 - x2);
HXLINE(1937)		HX_VARI( Float,dy) = (y1 - y2);
HXLINE(1938)		HX_VARI( Float,d2) = ((dx * dx) + (dy * dy));
HXLINE(1939)		HX_VARI( Float,dr2) = ((r1 * r1) + (r2 * r2));
...
bool U_obj::point_circle_test(Float x,Float y,Float cx,Float cy,Float r){
            	...
            	HX_STACK_ARG(r,"r")
HXLINE(1944)
HXLINE(1945)		HX_VARI( Float,dx) = (x - cx);
HXLINE(1946)		HX_VARI( Float,dy) = (y - cy);
HXLINE(1947)		HX_VARI( Float,d2) = ((dx * dx) + (dy * dy));
...
HXLINE(1952)
HXLINE(1953)		HX_VARI( Float,extra) = (a->get_width() * multA);
HXLINE(1954)		HX_VARI( Float,diff) = ((extra - a->get_width()) / ( (Float)(2) ));
HXLINE(1956)		HX_VARI( Float,ax1) = (a->x - diff);
HXLINE(1957)		Float a1 = a->x;
HXDLIN(1957)		HX_VARI( Float,ax2) = ((a1 + a->get_width()) + diff);
HXLINE(1959)		extra = (a->get_height() * multA);
HXLINE(1960)		diff = ((extra - a->get_height()) / ( (Float)(2) ));
HXLINE(1962)		HX_VARI( Float,ay1) = (a->y - diff);
HXLINE(1963)		Float a2 = a->y;
HXDLIN(1963)		HX_VARI( Float,ay2) = ((a2 + a->get_height()) + diff);
HXLINE(1965)		extra = (b->get_width() * multB);
HXLINE(1966)		diff = ((extra - b->get_width()) / ( (Float)(2) ));
HXLINE(1968)		HX_VARI( Float,bx1) = (b->x - diff);
HXLINE(1969)		Float b1 = b->x;
HXDLIN(1969)		HX_VARI( Float,bx2) = ((b1 + b->get_width()) + diff);
HXLINE(1971)		extra = (b->get_height() * multB);
HXLINE(1972)		diff = ((extra - b->get_height()) / ( (Float)(2) ));
HXLINE(1974)		HX_VARI( Float,by1) = (b->y - diff);
HXLINE(1975)		Float b2 = b->y;
HXDLIN(1975)		HX_VARI( Float,by2) = ((b2 + b->get_height()) + diff);
...
bool U_obj::aabb_test( ::flixel::FlxObject a, ::flixel::FlxObject b){
            	...
            	HX_STACK_ARG(b,"b")
HXLINE(1982)
HXLINE(1983)		HX_VARI( Float,ax1) = a->x;
HXLINE(1984)		Float a1 = a->x;
HXDLIN(1984)		HX_VARI( Float,ax2) = (a1 + a->get_width());
HXLINE(1986)		HX_VARI( Float,ay1) = a->y;
HXLINE(1987)		Float a2 = a->y;
HXDLIN(1987)		HX_VARI( Float,ay2) = (a2 + a->get_height());
HXLINE(1989)		HX_VARI( Float,bx1) = b->x;
HXLINE(1990)		Float b1 = b->x;
HXDLIN(1990)		HX_VARI( Float,bx2) = (b1 + b->get_width());
HXLINE(1992)		HX_VARI( Float,by1) = b->y;
HXLINE(1993)		Float b2 = b->y;
HXDLIN(1993)		HX_VARI( Float,by2) = (b2 + b->get_height());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(U_obj,aabb_test,return )
 ...
 ::openfl::geom::Point U_obj::bitStringDimensions(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(2003)
HXLINE(2004)		HX_VARI(  ::openfl::geom::Point,pt) =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,0,0);
HXLINE(2005)		HX_VARI( ::Array< ::String >,arr) = str.split(HX_("\n",0a,00,00,00));
...
::Array< int > U_obj::splitBitString(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE(2021)
HXLINE(2022)		HX_VARI( ::Array< int >,result) = ::Array_obj< int >::__new();
HXLINE(2023)		HX_VARI( ::Array< ::String >,arr) = str.split(HX_("\n",0a,00,00,00));
HXLINE(2024)		HX_VARI( int,i) = 0;
HXLINE(2025)		while((i < arr->length)){
HXLINE(2027)			HX_VARI( int,len) = arr->__get(i).length;
HXLINE(2028)			HX_VARI( int,j) = 0;
HXLINE(2029)			while((j < len)){
HXLINE(2031)				HX_VARI_NAME( ::String,_hx_char,"char") = arr->__get(i).charAt(j);
HXLINE(2032)				HX_VARI( int,num) = ( (int)(::Std_obj::parseInt(_hx_char)) );
...
HXLINE(2182)
HXLINE(2183)		HX_VARI( ::String,s) = ::haxe::xml::Printer_obj::print(_xml,null());
HXLINE(2185)		HX_VARI(  ::EReg,r) =  ::EReg_obj::__alloc( HX_CTX ,HX_(">[^`<]*<",12,f9,4b,a6),HX_("g",67,00,00,00));
...
HXLINE(2189)		HX_VARI( ::Array< ::String >,split) = r->split(s);
HXLINE(2192)		s = HX_("",00,00,00,00);
HXLINE(2193)		HX_VARI( int,childDepht) = 0;
HXLINE(2194)		HX_VARI( ::String,whiteSpace) = HX_("\t",09,00,00,00);
HXLINE(2196)		{
HXLINE(2196)			int _g = 0;
HXDLIN(2196)			while((_g < split->length)){
HXLINE(2196)				HX_VARI( ::String,str) = split->__get(_g);
HXDLIN(2196)				_g = (_g + 1);
HXLINE(2198)				{
...
HXDLIN(2198)						HX_VARI( int,i) = (_g1 - 1);
...
HXLINE(2256)				HX_VARI(  ::flixel::addons::ui::FlxUISpriteButton,fuisb) = ( ( ::flixel::addons::ui::FlxUISpriteButton)(btn) );
...
HXLINE(2261)					HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,g) = ( ( ::flixel::group::FlxTypedSpriteGroup)(fuisb->label) );
...
HXLINE(2264)							HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(2264)							_g = (_g + 1);
