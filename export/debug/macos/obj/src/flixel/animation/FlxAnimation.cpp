...
HXLINE( 133)		HX_VARI( int,maxFrameIndex) = (this->frames->length - 1);
...
HXLINE( 195)				_hx_tmp3 = !(this->finished);
            			}
            			else {
...
HXLINE( 197)			 ::flixel::animation::FlxAnimation _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 197)			_hx_tmp4->_frameTimer = (_hx_tmp4->_frameTimer - this->delay);
HXLINE( 198)			if (this->reversed) {
HXLINE( 200)				bool _hx_tmp5;
HXDLIN( 200)				if (this->looped) {
HXLINE( 200)					_hx_tmp5 = (this->curFrame == this->loopPoint);
            				}
            				else {
...
HXLINE( 207)					_hx_tmp6 = (this->curFrame == (this->frames->length - 1));
            				}
            				else {
...
int FlxAnimation_obj::set_curFrame(int Frame){
            	...
            	HX_STACK_ARG(Frame,"Frame")
HXLINE( 230)
HXLINE( 231)		HX_VARI( int,maxFrameIndex) = (this->frames->length - 1);
HXLINE( 232)		HX_VAR( int,tempFrame);
...
HXLINE( 239)				int _hx_tmp1;
HXDLIN( 239)				if (this->reversed) {
HXLINE( 239)					_hx_tmp1 = 0;
            				}
            				else {
HXLINE( 239)					_hx_tmp1 = maxFrameIndex;
            				}
HXDLIN( 239)				this->curFrame = _hx_tmp1;
            			}
            			else {
...
HXLINE( 251)			_hx_tmp2 = ::hx::IsNotNull( this->parent );
            		}
            		else {
