...
HXLINE(  97)			HX_VARI( Float,e) = elapsed;
...
HXLINE( 167)			HX_VAR(  ::flixel::animation::FlxAnimation,anim);
HXLINE( 168)			{
HXLINE( 168)				HX_VARI(  ::Dynamic,key) = this->_animations->keys();
HXDLIN( 168)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 168)					HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 193)
HXLINE( 195)		HX_VARI( ::Array< int >,framesToAdd) = Frames;
HXLINE( 196)		HX_VARI( int,numFrames) = (framesToAdd->length - 1);
HXLINE( 197)		HX_VARI( int,i) = numFrames;
...
HXLINE( 216)			HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,framesToAdd,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::remove(::String Name){
            	...
            	HX_STACK_ARG(Name,"Name")
HXLINE( 227)
HXLINE( 228)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 250)			::flixel::FlxG_obj::log->advanced(((HX_("No animation called \"",ba,9e,0f,3e) + Name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 251)			return;
            		}
HXLINE( 255)		HX_VARI( int,numFrames) = (Frames->length - 1);
HXLINE( 256)		HX_VARI( int,i) = numFrames;
...
HXLINE( 282)			HX_VARI( ::Array< int >,indices) = ::Array_obj< int >::__new();
HXLINE( 283)			this->byNamesHelper(indices,FrameNames);
HXLINE( 285)			if ((indices->length > 0)) {
HXLINE( 287)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,indices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByNames(::String Name,::Array< ::String > FrameNames){
            	...
            	HX_STACK_ARG(FrameNames,"FrameNames")
HXLINE( 302)
HXLINE( 303)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
HXLINE( 304)		if (::hx::IsNull( anim )) {
HXLINE( 306)			::flixel::FlxG_obj::log->advanced(((HX_("No animation called \"",ba,9e,0f,3e) + Name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 307)			return;
            		}
...
HXLINE( 334)			HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 336)			this->byStringIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 338)			if ((frameIndices->length > 0)) {
HXLINE( 340)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByStringIndices(::String Name,::String Prefix,::Array< ::String > Indices,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 358)
HXLINE( 359)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
HXLINE( 360)		if (::hx::IsNull( anim )) {
HXLINE( 362)			::flixel::FlxG_obj::log->advanced(((HX_("No animation called \"",ba,9e,0f,3e) + Name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 363)			return;
            		}
...
HXLINE( 390)			HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 392)			this->byIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 394)			if ((frameIndices->length > 0)) {
HXLINE( 396)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByIndices(::String Name,::String Prefix,::Array< int > Indices,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 415)
HXLINE( 416)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
HXLINE( 417)		if (::hx::IsNull( anim )) {
HXLINE( 419)			::flixel::FlxG_obj::log->advanced(((HX_("No animation called \"",ba,9e,0f,3e) + Name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 420)			return;
            		}
...
int FlxAnimationController_obj::findSpriteFrame(::String Prefix,int Index,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 437)
HXLINE( 438)		HX_VARI( int,numFrames) = this->_sprite->numFrames;
HXLINE( 439)		HX_VARI( ::Array< ::Dynamic>,flxFrames) = this->_sprite->frames->frames;
HXLINE( 440)		{
HXLINE( 440)			int _g = 0;
HXDLIN( 440)			int _g1 = numFrames;
HXDLIN( 440)			while((_g < _g1)){
HXLINE( 440)				_g = (_g + 1);
HXDLIN( 440)				HX_VARI( int,i) = (_g - 1);
HXLINE( 442)				HX_VARI( ::String,name) = flxFrames->__get(i).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
...
HXLINE( 445)					HX_VARI(  ::Dynamic,index) = ::Std_obj::parseInt(name.substring(Prefix.length,(name.length - Postfix.length)));
HXLINE( 446)					bool _hx_tmp1;
HXDLIN( 446)					if (::hx::IsNotNull( index )) {
HXLINE( 446)						_hx_tmp1 = ::hx::IsEq( index,Index );
            					}
            					else {
...
HXLINE( 470)			HX_VARI( ::Array< ::Dynamic>,animFrames) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 471)			this->findByPrefix(animFrames,Prefix);
HXLINE( 473)			if ((animFrames->length > 0)) {
HXLINE( 475)				HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 476)				this->byPrefixHelper(frameIndices,animFrames,Prefix);
HXLINE( 478)				if ((frameIndices->length > 0)) {
HXLINE( 480)					HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByPrefix(::String Name,::String Prefix){
            	...
            	HX_STACK_ARG(Prefix,"Prefix")
HXLINE( 498)
HXLINE( 499)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
HXLINE( 500)		if (::hx::IsNull( anim )) {
HXLINE( 502)			::flixel::FlxG_obj::log->advanced(((HX_("No animation called \"",ba,9e,0f,3e) + Name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 503)			return;
            		}
HXLINE( 506)		if (::hx::IsNotNull( this->_sprite->frames )) {
HXLINE( 508)			HX_VARI( ::Array< ::Dynamic>,animFrames) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 542)			::flixel::FlxG_obj::log->advanced(((HX_("No animation called \"",ba,9e,0f,3e) + AnimName) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 543)			return;
            		}
HXLINE( 546)		HX_VARI( bool,oldFlipX) = false;
HXLINE( 547)		HX_VARI( bool,oldFlipY) = false;
...
HXDLIN( 673)			HX_VARI( ::String,frameName) = FrameNames->__get(_g);
HXDLIN( 673)			_g = (_g + 1);
HXLINE( 675)			if (this->_sprite->frames->framesHash->exists(frameName)) {
HXLINE( 677)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frameToAdd) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(frameName)) );
...
HXDLIN( 685)			HX_VARI( ::String,index) = Indices->__get(_g);
HXDLIN( 685)			_g = (_g + 1);
HXLINE( 687)			HX_VARI( ::String,name) = ((Prefix + index) + Postfix);
HXLINE( 688)			if (this->_sprite->frames->framesHash->exists(name)) {
HXLINE( 690)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frameToAdd) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(name)) );
...
HXDLIN( 698)			HX_VARI( int,index) = Indices->__get(_g);
HXDLIN( 698)			_g = (_g + 1);
HXLINE( 700)			HX_VARI( int,indexToAdd) = this->findSpriteFrame(Prefix,index,Postfix);
...
void FlxAnimationController_obj::byPrefixHelper(::Array< int > AddTo,::Array< ::Dynamic> AnimFrames,::String Prefix){
            	...
            	HX_STACK_ARG(Prefix,"Prefix")
HXLINE( 709)
HXLINE( 710)		HX_VARI( ::String,name) = AnimFrames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
HXLINE( 711)		HX_VARI( int,postIndex) = name.indexOf(HX_(".",2e,00,00,00),Prefix.length);
...
HXDLIN( 712)		HX_VARI_NAME( ::String,postFix1,"postFix") = name.substring(postFix,name.length);
...
HXLINE( 715)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,animFrame) = AnimFrames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 715)				_g = (_g + 1);
...
HXDLIN( 723)			HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 723)			_g = (_g + 1);
...
HXLINE( 760)			HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(Value)) );
...
::String FlxAnimationController_obj::get_name(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 771)
HXLINE( 772)		HX_VARI( ::String,animName) = null();
...
bool FlxAnimationController_obj::get_paused(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 809)
HXLINE( 810)		HX_VARI( bool,paused) = false;
...
bool FlxAnimationController_obj::get_finished(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 835)
HXLINE( 836)		HX_VARI( bool,finished) = true;
