...
void FlxGraphic_obj::undump(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 431)
HXLINE( 432)		HX_VARI(  ::openfl::display::BitmapData,newBitmap) = this->getBitmapFromSystem();
...
HXLINE( 461)		HX_VARI( bool,dumped) = this->isDumped;
...
HXLINE( 489)		HX_VAR( ::Array< ::Dynamic>,collections);
HXLINE( 490)		{
HXLINE( 490)			int _g = 0;
HXDLIN( 490)			::Array< ::Dynamic> _g1 = this->frameCollectionTypes;
HXDLIN( 490)			while((_g < _g1->length)){
HXLINE( 490)				HX_VARI(  ::flixel::graphics::frames::FlxFrameCollectionType,collectionType) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrameCollectionType >();
HXDLIN( 490)				_g = (_g + 1);
...
HXDLIN( 509)			HX_VARI_NAME( ::cpp::VirtualArray,collections1,"collections") = collections;
...
HXLINE( 521)
HXLINE( 522)		HX_VARI( ::cpp::VirtualArray,collections) = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
...
HXLINE( 539)
HXLINE( 540)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),null(),null(),null());
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getEmptyFrame,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::getBitmapFromSystem(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 575)
HXLINE( 576)		HX_VARI(  ::openfl::display::BitmapData,newBitmap) = null();
...
HXLINE( 580)					::flixel::FlxG_obj::log->advanced(((HX_("Could not find a BitmapData asset with ID '",5f,79,a9,21) + id) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
HXDLIN( 580)					newBitmap = null();
            				}
            			}
            		}
