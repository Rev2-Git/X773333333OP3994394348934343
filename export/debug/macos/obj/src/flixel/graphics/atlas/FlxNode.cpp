...
HXDLIN( 122)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = ( ( ::flixel::graphics::frames::FlxFrame)(_this->framesHash->get(this->key)) );
...
HXDLIN( 143)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = ( ( ::flixel::graphics::frames::FlxFrame)(_this->framesHash->get(this->key)) );
