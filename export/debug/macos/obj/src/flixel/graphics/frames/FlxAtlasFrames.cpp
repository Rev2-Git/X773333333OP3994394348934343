...
HXDLIN( 406)			this1->set_x((this1->x + point2->x));
HXDLIN( 406)			this1->set_y((this1->y + y));
            		}
...
HXDLIN( 406)			this2->set_x((this2->x + border->x));
HXDLIN( 406)			this2->set_y((this2->y + y1));
            		}
HXDLIN( 406)		if (border->_weak) {
HXLINE( 406)			border->put();
            		}
HXDLIN( 406)		HX_VARI(  ::flixel::math::FlxBasePoint,resultBorder) = this2;
HXLINE( 407)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,atlasFrames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(this->parent,resultBorder);
...
HXLINE( 413)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 413)				_g = (_g + 1);
...
HXLINE(  72)				HX_VARI(  ::Dynamic,frame) = _g1->__get(_g);
HXDLIN(  72)				_g = (_g + 1);
...
HXLINE(  80)				HX_VARI( ::String,frameName) = _g3->__get(_g2);
HXDLIN(  80)				_g2 = (_g2 + 1);
...
HXLINE(  97)
HXLINE(  98)		HX_VARI( bool,rotated) = ( (bool)(FrameData->__Field(HX_("rotated",a9,49,1d,f1),::hx::paccDynamic)) );
HXLINE(  99)		HX_VARI( ::String,name) = FrameName;
...
HXDLIN( 100)		HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point;
...
HXDLIN( 101)		HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point1;
HXLINE( 102)		HX_VARI( int,angle) = 0;
HXLINE( 103)		HX_VARI(  ::flixel::math::FlxRect,frameRect) = null();
...
HXLINE( 112)			Float X1 = ( (Float)( ::Dynamic(FrameData->__Field(HX_("frame",2d,78,83,06),::hx::paccDynamic))->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
HXDLIN( 112)			Float Y1 = ( (Float)( ::Dynamic(FrameData->__Field(HX_("frame",2d,78,83,06),::hx::paccDynamic))->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
...
HXDLIN( 112)			_this1->x = X1;
HXDLIN( 112)			_this1->y = Y1;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxAtlasFrames_obj,texturePackerHelper,(void))
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromLibGdx( ::Dynamic source,::String description){
            	...
            	HX_STACK_ARG(description,"description")
HXLINE( 128)
HXLINE( 129)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(source,null(),null());
HXLINE( 130)		if (::hx::IsNull( graphic )) {
HXLINE( 131)			return null();
            		}
HXLINE( 134)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,frames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
...
HXLINE( 146)		HX_VARI( ::String,pack) = ::StringTools_obj::trim(description);
HXLINE( 147)		HX_VARI( ::Array< ::String >,lines) = pack.split(HX_("\n",0a,00,00,00));
HXLINE( 150)		HX_VAR( int,repeatLine);
...
HXLINE( 153)		HX_VARI( int,numElementsPerImage) = 7;
HXLINE( 154)		HX_VARI( int,numImages) = ::Std_obj::_hx_int((( (Float)(lines->length) ) / ( (Float)(numElementsPerImage) )));
HXLINE( 156)		{
HXLINE( 156)			int _g = 0;
...
HXLINE( 158)				HX_VARI( int,curIndex) = (i * numElementsPerImage);
HXLINE( 160)				curIndex = (curIndex + 1);
HXDLIN( 160)				HX_VARI( ::String,name) = lines->__get((curIndex - 1));
HXLINE( 161)				curIndex = (curIndex + 1);
HXDLIN( 161)				HX_VARI( bool,rotated) = (lines->__get((curIndex - 1)).indexOf(HX_("true",4e,a7,03,4d),null()) >= 0);
HXLINE( 162)				HX_VAR( int,angle);
...
HXDLIN( 164)				HX_VARI( ::String,tempString) = lines->__get((curIndex - 1));
HXLINE( 165)				HX_VARI(  ::Dynamic,size) = ::flixel::graphics::frames::FlxAtlasFrames_obj::getDimensions(tempString);
HXLINE( 167)				HX_VARI( int,imageX) = ( (int)(size->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
HXLINE( 168)				HX_VARI( int,imageY) = ( (int)(size->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
...
HXLINE( 173)				HX_VARI( int,imageWidth) = ( (int)(size->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
HXLINE( 174)				HX_VARI( int,imageHeight) = ( (int)(size->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
...
HXDLIN( 176)				HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
...
HXDLIN( 181)				HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point;
...
HXLINE( 187)				HX_VARI(  ::Dynamic,index) = ::Std_obj::parseInt(tempString.split(HX_(":",3a,00,00,00))->__get(1));
...
HXDLIN( 196)				HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point1;
...
HXLINE( 207)
HXLINE( 208)		HX_VARI( int,colonPosition) = line.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 209)		HX_VARI( int,comaPosition) = line.indexOf(HX_(",",2c,00,00,00),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxAtlasFrames_obj,getDimensions,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromSparrow( ::Dynamic Source,::String Description){
            	...
            	HX_STACK_ARG(Description,"Description")
HXLINE( 228)
HXLINE( 229)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(Source,null(),null());
...
HXLINE( 248)				HX_VARI(  ::Xml,texture) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN( 248)				_g = (_g + 1);
HXLINE( 250)				HX_VARI( ::String,name) = ::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("name",4b,72,ff,48));
HXLINE( 251)				HX_VARI( bool,trimmed) = ::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(texture,HX_("frameX",8b,af,85,ac));
HXLINE( 252)				HX_VAR( bool,rotated);
...
HXDLIN( 256)				HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
HXLINE( 259)				HX_VAR(  ::openfl::geom::Rectangle,size);
...
HXDLIN( 271)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y);
HXDLIN( 271)				point->_inPool = false;
HXDLIN( 271)				HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point;
HXLINE( 272)				Float x2 = size->width;
HXDLIN( 272)				Float y1 = size->height;
HXDLIN( 272)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x2,y1);
HXDLIN( 272)				point1->_inPool = false;
HXDLIN( 272)				HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point1;
...
HXLINE( 275)					Float y2 = size->width;
HXDLIN( 275)					sourceSize->set_x(size->height);
HXDLIN( 275)					sourceSize->set_y(y2);
            				}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,fromSparrow,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromTexturePackerXml( ::Dynamic Source,::String Description){
            	...
            	HX_STACK_ARG(Description,"Description")
HXLINE( 293)
HXLINE( 294)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(Source,false,null());
HXLINE( 295)		if (::hx::IsNull( graphic )) {
HXLINE( 296)			return null();
            		}
HXLINE( 299)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,frames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
...
HXLINE( 311)		HX_VARI(  ::Xml,xml) = ::Xml_obj::parse(Description);
HXLINE( 313)		{
HXLINE( 313)			HX_VARI(  ::Dynamic,sprite) = xml->firstElement()->elements();
HXDLIN( 313)			while(( (bool)(sprite->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 313)				HX_VARI_NAME(  ::Xml,sprite1,"sprite") = ( ( ::Xml)(sprite->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 315)				HX_VAR( bool,trimmed);
...
HXLINE( 316)				HX_VAR( bool,rotated);
...
HXDLIN( 320)				HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
...
HXDLIN( 321)				HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point1;
HXLINE( 323)				if (trimmed) {
HXLINE( 325)					{
HXLINE( 325)						Float x1 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oX",09,61,00,00)))) );
HXDLIN( 325)						Float y1 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oY",0a,61,00,00)))) );
HXDLIN( 325)						offset->set_x(x1);
HXDLIN( 325)						offset->set_y(y1);
            					}
HXLINE( 326)					{
HXLINE( 326)						Float x2 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oW",08,61,00,00)))) );
HXDLIN( 326)						Float y2 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oH",f9,60,00,00)))) );
HXDLIN( 326)						sourceSize->set_x(x2);
HXDLIN( 326)						sourceSize->set_y(y2);
            					}
            				}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,fromTexturePackerXml,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromSpriteSheetPacker( ::Dynamic Source,::String Description){
            	...
            	HX_STACK_ARG(Description,"Description")
HXLINE( 345)
HXLINE( 346)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(Source,null(),null());
HXLINE( 347)		if (::hx::IsNull( graphic )) {
HXLINE( 348)			return null();
            		}
HXLINE( 351)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,frames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
...
HXLINE( 363)		HX_VARI( ::String,pack) = ::StringTools_obj::trim(Description);
HXLINE( 364)		HX_VARI( ::Array< ::String >,lines) = pack.split(HX_("\n",0a,00,00,00));
HXLINE( 366)		{
HXLINE( 366)			int _g = 0;
HXDLIN( 366)			int _g1 = lines->length;
HXDLIN( 366)			while((_g < _g1)){
HXLINE( 366)				_g = (_g + 1);
HXDLIN( 366)				HX_VARI( int,i) = (_g - 1);
HXLINE( 368)				HX_VARI( ::Array< ::String >,currImageData) = lines->__get(i).split(HX_("=",3d,00,00,00));
HXLINE( 369)				HX_VARI( ::String,name) = ::StringTools_obj::trim(currImageData->__get(0));
HXLINE( 370)				HX_VARI( ::Array< ::String >,currImageRegion) = ::StringTools_obj::trim(currImageData->__get(1)).split(HX_(" ",20,00,00,00));
...
HXDLIN( 372)				HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
...
HXDLIN( 374)				HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point;
...
HXDLIN( 375)				HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point1;
...
HXDLIN( 395)		HX_VARI( ::Array< ::Dynamic>,atlasFrames) = collections;
HXLINE( 397)		{
HXLINE( 397)			int _g = 0;
HXDLIN( 397)			while((_g < atlasFrames->length)){
HXLINE( 397)				HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,atlas) = atlasFrames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxAtlasFrames >();
HXDLIN( 397)				_g = (_g + 1);
