...
HXDLIN( 312)			HX_VARI_NAME(  ::openfl::geom::Rectangle,rect1,"rect") = this->rect;
...
HXDLIN( 356)		HX_VARI_NAME(  ::openfl::geom::Rectangle,rect1,"rect") = this->rect;
...
HXDLIN( 412)		HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point1;
...
HXDLIN( 413)		HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point3;
HXLINE( 415)		{
...
HXDLIN( 481)			HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point2;
...
HXDLIN( 482)			HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point4;
HXLINE( 484)			this->matrix->identity();
HXLINE( 486)			if ((this->angle == -90)) {
HXLINE( 488)				{
HXLINE( 488)					 ::flixel::math::FlxMatrix _this2 = this->matrix;
HXDLIN( 488)					_this2->setTo(-(_this2->b),_this2->a,-(_this2->d),_this2->c,-(_this2->ty),_this2->tx);
            				}
...
HXDLIN( 521)		HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
...
HXDLIN( 560)		HX_VARI(  ::flixel::math::FlxRect,clippedRect) = _this1;
...
HXDLIN( 583)			HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point2;
...
HXDLIN( 584)			HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point4;
HXLINE( 586)			this->matrix->identity();
HXLINE( 588)			if ((this->angle == -90)) {
HXLINE( 590)				{
HXLINE( 590)					 ::flixel::math::FlxMatrix _this2 = this->matrix;
HXDLIN( 590)					_this2->setTo(-(_this2->b),_this2->a,-(_this2->d),_this2->c,-(_this2->ty),_this2->tx);
            				}
