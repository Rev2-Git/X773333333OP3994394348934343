...
HXLINE( 146)			HX_VARI( int,i) = 0;
HXLINE( 147)			HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 165)
HXLINE( 166)		HX_VARI( int,i) = 0;
HXLINE( 167)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
void FlxTypedGroup_obj::draw(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 184)
HXLINE( 185)		HX_VARI( int,i) = 0;
HXLINE( 186)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
HXLINE( 188)		HX_VARI( ::Array< ::Dynamic>,oldDefaultCameras) = ::flixel::FlxCamera_obj::_defaultCameras;
...
HXLINE( 230)		HX_VARI( int,index) = this->getFirstNull();
...
HXLINE( 335)
HXLINE( 336)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HX_DEFINE_DYNAMIC_FUNC4(FlxTypedGroup_obj,recycle,return )
 ...
 ::Dynamic FlxTypedGroup_obj::recycleCreateObject(::hx::Class ObjectClass, ::Dynamic ObjectFactory){
            	...
            	HX_STACK_ARG(ObjectFactory,"ObjectFactory")
HXLINE( 378)
HXLINE( 379)		HX_VARI(  ::Dynamic,object) = null();
...
HXLINE( 401)		HX_VARI( int,index) = this->members->indexOf(Object,null());
...
HXLINE( 429)
HXLINE( 430)		HX_VARI( int,index) = this->members->indexOf(OldObject,null());
...
HX_DEFINE_DYNAMIC_FUNC2(FlxTypedGroup_obj,sort,(void))
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstAvailable(::hx::Class ObjectClass,::hx::Null< bool >  __o_Force){
            	...
            	HX_STACK_ARG(Force,"Force")
HXLINE( 470)
HXLINE( 471)		HX_VARI( int,i) = 0;
HXLINE( 472)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedGroup_obj,getFirstNull,return )
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstExisting(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 518)
HXLINE( 519)		HX_VARI( int,i) = 0;
HXLINE( 520)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedGroup_obj,getFirstExisting,return )
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstAlive(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 540)
HXLINE( 541)		HX_VARI( int,i) = 0;
HXLINE( 542)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedGroup_obj,getFirstAlive,return )
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstDead(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 562)
HXLINE( 563)		HX_VARI( int,i) = 0;
HXLINE( 564)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
int FlxTypedGroup_obj::countLiving(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 583)
HXLINE( 584)		HX_VARI( int,i) = 0;
HXLINE( 585)		HX_VARI( int,count) = -1;
HXLINE( 586)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
int FlxTypedGroup_obj::countDead(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 610)
HXLINE( 611)		HX_VARI( int,i) = 0;
HXLINE( 612)		HX_VARI( int,count) = -1;
HXLINE( 613)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 659)				HX_VARI(  ::Dynamic,member) = _g1->__get(_g);
HXDLIN( 659)				_g = (_g + 1);
...
void FlxTypedGroup_obj::kill(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 674)
HXLINE( 675)		HX_VARI( int,i) = 0;
HXLINE( 676)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
void FlxTypedGroup_obj::revive(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 693)
HXLINE( 694)		HX_VARI( int,i) = 0;
HXLINE( 695)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 723)
HXLINE( 724)		HX_VARI( int,i) = 0;
HXLINE( 725)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 735)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
void FlxTypedGroup_obj::forEachAlive( ::Dynamic Function,::hx::Null< bool >  __o_Recurse){
            	...
            	HX_STACK_ARG(Recurse,"Recurse")
HXLINE( 752)
HXLINE( 753)		HX_VARI( int,i) = 0;
HXLINE( 754)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 764)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
void FlxTypedGroup_obj::forEachDead( ::Dynamic Function,::hx::Null< bool >  __o_Recurse){
            	...
            	HX_STACK_ARG(Recurse,"Recurse")
HXLINE( 781)
HXLINE( 782)		HX_VARI( int,i) = 0;
HXLINE( 783)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 793)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
void FlxTypedGroup_obj::forEachExists( ::Dynamic Function,::hx::Null< bool >  __o_Recurse){
            	...
            	HX_STACK_ARG(Recurse,"Recurse")
HXLINE( 810)
HXLINE( 811)		HX_VARI( int,i) = 0;
HXLINE( 812)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 822)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
void FlxTypedGroup_obj::forEachOfType(::hx::Class ObjectClass, ::Dynamic Function,::hx::Null< bool >  __o_Recurse){
            	...
            	HX_STACK_ARG(Recurse,"Recurse")
HXLINE( 840)
HXLINE( 841)		HX_VARI( int,i) = 0;
HXLINE( 842)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 852)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
HXLINE( 875)		HX_VARI( int,i) = this->maxSize;
HXLINE( 876)		HX_VARI( int,l) = this->length;
HXLINE( 877)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE(  31)
HXLINE(  32)		HX_VARI( bool,result) = false;
HXLINE(  33)		if (::hx::IsNotNull( Group )) {
HXLINE(  35)			HX_VARI( int,i) = 0;
HXLINE(  36)			HX_VARI( int,l) = Group->length;
HXLINE(  37)			HX_VAR(  ::flixel::FlxBasic,basic);
HXLINE(  39)			while((i < l)){
HXLINE(  41)				i = (i + 1);
...
HXLINE(  55)
HXLINE(  56)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = null();
...
HXLINE(  65)					HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,spriteGroup) = ( ( ::flixel::group::FlxTypedSpriteGroup)(ObjectOrGroup) );
