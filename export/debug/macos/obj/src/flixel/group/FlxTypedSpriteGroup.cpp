...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1095_loadGraphicFromSprite,"flixel.group.FlxTypedSpriteGroup","loadGraphicFromSprite",0x6f12dc84,"flixel.group.FlxTypedSpriteGroup.loadGraphicFromSprite","flixel/group/FlxSpriteGroup.hx",1095,0xeb1fa7f3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1118_loadRotatedGraphic,"flixel.group.FlxTypedSpriteGroup","loadRotatedGraphic",0x45e23732,"flixel.group.FlxTypedSpriteGroup.loadRotatedGraphic","flixel/group/FlxSpriteGroup.hx",1118,0xeb1fa7f3)
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1130_makeGraphic,"flixel.group.FlxTypedSpriteGroup","makeGraphic",0x27a1d44d,"flixel.group.FlxTypedSpriteGroup.makeGraphic","flixel/group/FlxSpriteGroup.hx",1130,0xeb1fa7f3)
...
HXLINE( 620)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 620)				_g = (_g + 1);
...
HXLINE( 639)		HX_VARI( int,numProps) = FunctionArray->length;
HXLINE( 640)		if ((numProps > ValueArray->length)) {
HXLINE( 641)			return;
            		}
HXLINE( 643)		HX_VAR(  ::Dynamic,lambda);
HXLINE( 644)		{
HXLINE( 644)			int _g = 0;
HXDLIN( 644)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 644)			while((_g < _g1->length)){
HXLINE( 644)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 644)				_g = (_g + 1);
...
HXDLIN( 648)						HX_VARI( int,i) = (_g2 - 1);
...
HXLINE( 120)		this->super::destroy();
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 129)
HXLINE( 130)		HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,newGroup) =  ::flixel::group::FlxTypedSpriteGroup_obj::__alloc( HX_CTX ,this->x,this->y,this->group->maxSize);
HXLINE( 131)		{
HXLINE( 131)			int _g = 0;
HXDLIN( 131)			::cpp::VirtualArray _g1 = this->group->members;
HXDLIN( 131)			while((_g < _g1->get_length())){
HXLINE( 131)				HX_VARI(  ::Dynamic,sprite) = _g1->__get(_g);
HXDLIN( 131)				_g = (_g + 1);
...
HXLINE( 149)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 149)				_g = (_g + 1);
...
bool FlxTypedSpriteGroup_obj::overlapsPoint( ::flixel::math::FlxBasePoint point,::hx::Null< bool >  __o_InScreenSpace, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 167)
HXLINE( 168)		HX_VARI( bool,result) = false;
HXLINE( 169)		{
HXLINE( 169)			int _g = 0;
HXDLIN( 169)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 169)			while((_g < _g1->length)){
HXLINE( 169)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 169)				_g = (_g + 1);
...
bool FlxTypedSpriteGroup_obj::pixelsOverlapPoint( ::flixel::math::FlxBasePoint point,::hx::Null< int >  __o_Mask, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 190)
HXLINE( 191)		HX_VARI( bool,result) = false;
HXLINE( 192)		{
HXLINE( 192)			int _g = 0;
HXDLIN( 192)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 192)			while((_g < _g1->length)){
HXLINE( 192)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 192)				_g = (_g + 1);
...
HXLINE( 231)
HXLINE( 232)		HX_VARI( int,Color) = _tmp_Color;
HXDLIN( 232)		HX_VARI( int,NewColor) = _tmp_NewColor;
HXDLIN( 232)		HX_VARI( ::Array< ::Dynamic>,positions) = null();
HXLINE( 233)		if (FetchPositions) {
HXLINE( 235)			positions = ::Array_obj< ::Dynamic>::__new();
            		}
HXLINE( 238)		HX_VAR( ::Array< ::Dynamic>,spritePositions);
HXLINE( 239)		{
HXLINE( 239)			int _g = 0;
HXDLIN( 239)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 239)			while((_g < _g1->length)){
HXLINE( 239)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 239)				_g = (_g + 1);
...
void FlxTypedSpriteGroup_obj::preAdd( ::Dynamic Sprite){
            	...
            	HX_STACK_ARG(Sprite,"Sprite")
HXLINE( 288)
HXLINE( 289)		HX_VARI(  ::flixel::FlxSprite,sprite) = ( ( ::flixel::FlxSprite)(Sprite) );
...
HXLINE( 338)
HXLINE( 339)		HX_VARI(  ::flixel::FlxSprite,sprite) = ( ( ::flixel::FlxSprite)(Sprite) );
...
HXLINE( 565)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 565)				_g = (_g + 1);
...
void FlxTypedSpriteGroup_obj::setPosition(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y){
            	...
            	HX_STACK_ARG(Y,"Y")
HXLINE( 594)
HXLINE( 596)		HX_VARI( Float,dx) = (X - this->x);
HXLINE( 597)		HX_VARI( Float,dy) = (Y - this->y);
...
HXLINE( 728)			HX_VAR( Float,factor);
...
int FlxTypedSpriteGroup_obj::set_facing(int _tmp_Value){
            	...
            	HX_STACK_THIS(this)
HXLINE( 738)
HXLINE( 739)		HX_VARI( int,Value) = _tmp_Value;
...
int FlxTypedSpriteGroup_obj::set_color(int _tmp_Value){
            	...
            	HX_STACK_THIS(this)
HXLINE( 780)
HXLINE( 781)		HX_VARI( int,Value) = _tmp_Value;
...
Float FlxTypedSpriteGroup_obj::findMinXHelper(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 835)
HXLINE( 836)		HX_VARI( Float,value) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 837)		{
HXLINE( 837)			int _g = 0;
HXDLIN( 837)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 837)			while((_g < _g1->length)){
HXLINE( 837)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 837)				_g = (_g + 1);
HXLINE( 839)				if (::hx::IsNull( member )) {
HXLINE( 840)					continue;
            				}
HXLINE( 842)				HX_VAR( Float,minX);
...
Float FlxTypedSpriteGroup_obj::findMaxXHelper(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 866)
HXLINE( 867)		HX_VARI( Float,value) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 868)		{
HXLINE( 868)			int _g = 0;
HXDLIN( 868)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 868)			while((_g < _g1->length)){
HXLINE( 868)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 868)				_g = (_g + 1);
HXLINE( 870)				if (::hx::IsNull( member )) {
HXLINE( 871)					continue;
            				}
HXLINE( 873)				HX_VAR( Float,maxX);
...
Float FlxTypedSpriteGroup_obj::findMinYHelper(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 913)
HXLINE( 914)		HX_VARI( Float,value) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 915)		{
HXLINE( 915)			int _g = 0;
HXDLIN( 915)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 915)			while((_g < _g1->length)){
HXLINE( 915)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 915)				_g = (_g + 1);
HXLINE( 917)				if (::hx::IsNull( member )) {
HXLINE( 918)					continue;
            				}
HXLINE( 920)				HX_VAR( Float,minY);
...
Float FlxTypedSpriteGroup_obj::findMaxYHelper(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 944)
HXLINE( 945)		HX_VARI( Float,value) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 946)		{
HXLINE( 946)			int _g = 0;
HXDLIN( 946)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 946)			while((_g < _g1->length)){
HXLINE( 946)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 946)				_g = (_g + 1);
HXLINE( 948)				if (::hx::IsNull( member )) {
HXLINE( 949)					continue;
            				}
HXLINE( 951)				HX_VAR( Float,maxY);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSpriteGroup_obj,scrollFactorCallback,(void))
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadGraphicFromSprite( ::flixel::FlxSprite Sprite){
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1095_loadGraphicFromSprite)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Sprite,"Sprite")
HXLINE(1095)
HXDLIN(1095)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
...
HXDLIN(1107)		return ::hx::ObjectPtr<OBJ_>(this);
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadRotatedGraphic( ::Dynamic Graphic,::hx::Null< int >  __o_Rotations,::hx::Null< int >  __o_Frame,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer,::String Key){
            	...
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1118_loadRotatedGraphic)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Graphic,"Graphic")
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE(1118)
HXDLIN(1118)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
HXDLIN(1118)		return null();
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o__tmp_Color,::hx::Null< bool >  __o_Unique,::String Key){
            		...
            		bool Unique = __o_Unique.Default(false);
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1130_makeGraphic)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
            	HX_STACK_ARG(Unique,"Unique")
            	HX_STACK_ARG(Key,"Key")
HXLINE(1130)
HXDLIN(1130)		HX_VARI( int,Color) = _tmp_Color;
HXDLIN(1130)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
HXDLIN(1130)		return null();
            	}
