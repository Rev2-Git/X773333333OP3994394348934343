...
HXLINE( 406)
HXLINE( 407)		HX_VARI( int,len) = this->inputs->length;
HXLINE( 408)		{
HXLINE( 408)			int _g = 0;
HXDLIN( 408)			int _g1 = len;
HXDLIN( 408)			while((_g < _g1)){
HXLINE( 408)				_g = (_g + 1);
HXDLIN( 408)				HX_VARI( int,i) = (_g - 1);
HXLINE( 410)				HX_VARI( int,j) = ((len - i) - 1);
HXLINE( 411)				HX_VARI(  ::flixel::input::actions::FlxActionInput,input) = this->inputs->__get(j).StaticCast<  ::flixel::input::actions::FlxActionInput >();
...
HXLINE( 451)				_g = (_g + 1);
HXDLIN( 451)				HX_VARI( int,i) = (_g - 1);
HXLINE( 453)				HX_VARI( int,j) = ((len - i) - 1);
HXLINE( 454)				HX_VARI(  ::flixel::input::actions::FlxActionInput,input) = this->inputs->__get(j).StaticCast<  ::flixel::input::actions::FlxActionInput >();
