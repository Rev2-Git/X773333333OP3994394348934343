...
void FlxActionInputDigitalSteam_obj::__construct(int ActionHandle,int Trigger, ::Dynamic __o_DeviceHandle){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ActionHandle,"ActionHandle")
            	HX_STACK_ARG(Trigger,"Trigger")
            	HX_STACK_ARG(DeviceHandle,"DeviceHandle")
HXLINE( 270)
...
HXLINE( 305)		HX_VARI(  ::flixel::input::actions::_FlxSteamController::DigitalActionData,data) = ::flixel::input::actions::FlxSteamController_obj::getDigitalActionData(controllerHandle,this->inputID);
