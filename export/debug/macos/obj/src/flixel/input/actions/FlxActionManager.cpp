...
void FlxActionManager_obj::activateSet(int ActionSet, ::flixel::input::actions::FlxInputDevice Device,int DeviceID){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ActionSet,"ActionSet")
...
bool FlxActionManager_obj::addActions(::Array< ::Dynamic> Actions,::hx::Null< int >  __o_ActionSet){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Actions,"Actions")
            	HX_STACK_ARG(ActionSet,"ActionSet")
HXLINE( 106)
HXLINE( 107)		HX_VARI( bool,success) = true;
HXLINE( 108)		{
HXLINE( 108)			int _g = 0;
HXDLIN( 108)			while((_g < Actions->length)){
HXLINE( 108)				HX_VARI(  ::flixel::input::actions::FlxAction,Action) = Actions->__get(_g).StaticCast<  ::flixel::input::actions::FlxAction >();
HXDLIN( 108)				_g = (_g + 1);
HXLINE( 110)				HX_VARI( bool,result) = this->addAction(Action,null());
...
bool FlxActionManager_obj::addAction( ::flixel::input::actions::FlxAction Action,::hx::Null< int >  __o_ActionSet){
            	...
            	HX_STACK_ARG(ActionSet,"ActionSet")
HXLINE( 124)
HXLINE( 125)		HX_VARI( bool,success) = false;
...
HXLINE( 132)			HX_VARI( int,defaultSetIndex) = this->addSet(this->defaultSet);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxActionManager_obj,getSet,return )
 ...
 ::flixel::input::actions::FlxActionSet FlxActionManager_obj::getSetActivatedForDevice( ::flixel::input::actions::FlxInputDevice device,::hx::Null< int >  __o_deviceID){
            	...
            	HX_STACK_ARG(deviceID,"deviceID")
HXLINE( 226)
HXLINE( 227)		HX_VARI( int,id) = -1;
HXLINE( 228)		HX_VARI( int,index) = -1;
...
HXLINE( 324)		HX_VARI( int,i) = 0;
HXLINE( 325)		HX_VARI( ::Array< ::Dynamic>,actionSets) = ( (::Array< ::Dynamic>)(data->__Field(HX_("actionSets",67,0d,97,57),::hx::paccDynamic)) );
...
HXLINE( 329)				HX_VARI(  ::Dynamic,set) = actionSets->__get(_g);
HXDLIN( 329)				_g = (_g + 1);
...
HXLINE( 350)				HX_VARI(  ::flixel::input::actions::FlxAction,fa) = ( ( ::flixel::input::actions::FlxAction)(value) );
HXLINE( 351)				return fa->name;
            			}
HXLINE( 353)			if (::Std_obj::isOfType(value,::hx::ClassOf< ::flixel::input::actions::FlxActionSet >())) {
HXLINE( 355)				HX_VARI(  ::flixel::input::actions::FlxActionSet,fas) = ( ( ::flixel::input::actions::FlxActionSet)(value) );
...
HXLINE( 363)			return value;
            	...
            	HX_STACK_THIS(this)
HXLINE( 344)
HXLINE( 345)		HX_VARI( ::String,space) = HX_("\t",09,00,00,00);
...
HXLINE( 374)
HXLINE( 375)		HX_VARI( bool,success) = this->sets->remove(Set);
...
bool FlxActionManager_obj::removeAction( ::flixel::input::actions::FlxAction Action,int ActionSet){
            	...
            	HX_STACK_ARG(ActionSet,"ActionSet")
HXLINE( 394)
HXLINE( 395)		HX_VARI( bool,success) = false;
...
HXLINE( 428)			HX_VARI(  ::flixel::input::actions::FlxActionSet,actionSet) = this->getSetActivatedForDevice(::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn(),gamepad->id);
...
HXLINE( 431)				HX_VARI( int,id) = gamepad->id;
HXLINE( 432)				HX_VAR( ::String,model);
...
HXLINE( 464)
HXLINE( 465)		HX_VARI( int,allSetIndex) = this->_hx_register->steamControllerAllSet;
...
HXLINE( 473)			HX_VARI(  ::flixel::input::actions::FlxActionSet,actionSet) = this->getSetActivatedForDevice(::flixel::input::actions::FlxInputDevice_obj::STEAM_CONTROLLER_dyn(),handle);
...
HXLINE( 487)			HX_VARI(  ::flixel::input::actions::FlxActionSet,actionSet) = this->getSetActivatedForDevice(::flixel::input::actions::FlxInputDevice_obj::STEAM_CONTROLLER_dyn(),handle);
