...
void FlxActionSet_obj::__construct(::String Name,::Array< ::Dynamic> DigitalActions,::Array< ::Dynamic> AnalogActions){
            	...
            	HX_STACK_ARG(DigitalActions,"DigitalActions")
            	HX_STACK_ARG(AnalogActions,"AnalogActions")
HXLINE(  26)
...
HXLINE( 177)				HX_VARI(  ::flixel::input::actions::FlxAction,fa) = ( ( ::flixel::input::actions::FlxAction)(value) );
...
HXLINE( 184)			return value;
            	...
            	HX_STACK_THIS(this)
HXLINE( 171)
HXLINE( 172)		HX_VARI( ::String,space) = HX_("\t",09,00,00,00);
...
HXLINE( 215)			HX_VARI(  ::flixel::input::actions::FlxActionDigital,dAction) = ( ( ::flixel::input::actions::FlxActionDigital)(Action) );
...
HXLINE( 223)				HX_VARI(  ::flixel::input::actions::FlxActionAnalog,aAction) = ( ( ::flixel::input::actions::FlxActionAnalog)(Action) );
...
HXLINE( 245)
HXLINE( 246)		HX_VARI( bool,result) = false;
...
HXLINE( 273)				HX_VARI(  ::flixel::input::actions::FlxActionDigital,digitalAction) = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionDigital >();
HXDLIN( 273)				_g = (_g + 1);
...
HXLINE( 277)				HX_VARI(  ::flixel::input::actions::FlxActionAnalog,analogAction) = _g3->__get(_g2).StaticCast<  ::flixel::input::actions::FlxActionAnalog >();
...
void FlxActionSet_obj::attachSteamControllerSub(int Handle,bool Attach, ::flixel::input::actions::FlxInputType InputType,::Array< ::Dynamic> DigitalActions,::Array< ::Dynamic> AnalogActions){
            	...
            	HX_STACK_ARG(Handle,"Handle")
            	HX_STACK_ARG(Attach,"Attach")
            	HX_STACK_ARG(InputType,"InputType")
            	HX_STACK_ARG(DigitalActions,"DigitalActions")
            	HX_STACK_ARG(AnalogActions,"AnalogActions")
HXLINE( 285)
HXLINE( 286)		HX_VAR( int,length);
...
HXLINE( 288)				_g = (_g + 1);
HXDLIN( 288)				HX_VARI( int,i) = (_g - 1);
HXLINE( 290)				HX_VAR(  ::flixel::input::actions::FlxAction,action);
...
HXLINE( 294)					HX_VARI( bool,inputExists) = false;
HXLINE( 295)					HX_VARI(  ::flixel::input::actions::FlxActionInput,theInput) = null();
...
HXLINE( 300)							HX_VARI(  ::flixel::input::actions::FlxActionInput,input) = _g3->__get(_g2).StaticCast<  ::flixel::input::actions::FlxActionInput >();
...
HX_DEFINE_DYNAMIC_FUNC5(FlxActionSet_obj,attachSteamControllerSub,(void))
 ...
 ::flixel::input::actions::FlxActionSet FlxActionSet_obj::fromJson( ::Dynamic Data, ::Dynamic CallbackDigital, ::Dynamic CallbackAnalog){
            	...
            	HX_STACK_ARG(CallbackDigital,"CallbackDigital")
            	HX_STACK_ARG(CallbackAnalog,"CallbackAnalog")
HXLINE( 131)
HXLINE( 132)		HX_VARI( ::Array< ::Dynamic>,digitalActions) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 133)		HX_VARI( ::Array< ::Dynamic>,analogActions) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 140)			HX_VARI( ::cpp::VirtualArray,arrD) = ( (::cpp::VirtualArray)(Data->__Field(HX_("digitalActions",05,8f,e5,5b),::hx::paccDynamic)) );
HXLINE( 141)			{
HXLINE( 141)				int _g = 0;
HXDLIN( 141)				while((_g < arrD->get_length())){
HXLINE( 141)					HX_VARI(  ::Dynamic,d) = arrD->__get(_g);
HXDLIN( 141)					_g = (_g + 1);
HXLINE( 143)					HX_VARI( ::String,dName) = ( (::String)(d) );
HXLINE( 144)					HX_VARI(  ::flixel::input::actions::FlxActionDigital,action) =  ::flixel::input::actions::FlxActionDigital_obj::__alloc( HX_CTX ,dName,CallbackDigital);
...
HXLINE( 151)			HX_VARI( ::cpp::VirtualArray,arrA) = ( (::cpp::VirtualArray)(Data->__Field(HX_("analogActions",ad,7b,59,50),::hx::paccDynamic)) );
HXLINE( 152)			{
HXLINE( 152)				int _g1 = 0;
HXDLIN( 152)				while((_g1 < arrA->get_length())){
HXLINE( 152)					HX_VARI(  ::Dynamic,a) = arrA->__get(_g1);
HXDLIN( 152)					_g1 = (_g1 + 1);
HXLINE( 154)					HX_VARI( ::String,aName) = ( (::String)(a) );
HXLINE( 155)					HX_VARI_NAME(  ::flixel::input::actions::FlxActionAnalog,action1,"action") =  ::flixel::input::actions::FlxActionAnalog_obj::__alloc( HX_CTX ,aName,CallbackAnalog);
HXLINE( 156)					analogActions->push(action1);
            				}
            			}
            		}
HXLINE( 160)		if (::hx::IsNotNull( Data->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic) )) {
HXLINE( 162)			HX_VARI( ::String,name) = ( (::String)(Data->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
HXLINE( 163)			HX_VARI(  ::flixel::input::actions::FlxActionSet,set) =  ::flixel::input::actions::FlxActionSet_obj::__alloc( HX_CTX ,name,digitalActions,analogActions);
