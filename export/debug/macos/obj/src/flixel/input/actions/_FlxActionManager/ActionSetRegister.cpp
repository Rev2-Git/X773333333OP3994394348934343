...
void ActionSetRegister_obj::setActivate(int ActionSet, ::flixel::input::actions::FlxInputDevice Device,::hx::Null< int >  __o_DeviceID,::hx::Null< bool >  __o_DoActivate){
            	...
            	HX_STACK_ARG(Device,"Device")
            	HX_STACK_ARG(DeviceID,"DeviceID")
            	HX_STACK_ARG(DoActivate,"DoActivate")
HXLINE( 636)
...
void ActionSetRegister_obj::updateDigitalActionOrigins( ::flixel::input::actions::FlxActionDigital action,int deviceID,int setHandle){
            	...
            	HX_STACK_ARG(deviceID,"deviceID")
            	HX_STACK_ARG(setHandle,"setHandle")
HXLINE( 756)
            	}
...
HXLINE( 802)
HXLINE( 805)		HX_VARI( int,sum1) = 0;
HXLINE( 806)		HX_VARI( int,sum2) = 0;
HXLINE( 808)		if (::hx::IsNotNull( arr )) {
HXLINE( 810)			int _g = 0;
HXDLIN( 810)			while((_g < arr->length)){
HXLINE( 810)				HX_VARI( int,n) = arr->__get(_g);
HXDLIN( 810)				_g = (_g + 1);
...
void ActionSetRegister_obj::changeSteamControllerActionSet(int controllerHandle,int newSet,::Array< ::Dynamic> sets){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(controllerHandle,"controllerHandle")
            	HX_STACK_ARG(newSet,"newSet")
            	HX_STACK_ARG(sets,"sets")
HXLINE( 854)
HXLINE( 855)		HX_VARI( int,lastSet) = ::flixel::input::actions::FlxSteamController_obj::getCurrentActionSet(controllerHandle);
...
HXLINE( 903)						_g = (_g + 1);
HXDLIN( 903)						HX_VARI( int,i) = (_g - 1);
HXLINE( 905)						HX_VARI( int,gset) = this->gamepadSets->__get(i);
...
HXDLIN( 921)						HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 923)						HX_VARI( int,sset) = this->steamControllerSets->__get(i1);
