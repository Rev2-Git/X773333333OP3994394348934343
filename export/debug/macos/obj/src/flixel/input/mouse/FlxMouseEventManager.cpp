...
HXLINE(  90)		HX_VARI( ::Array< ::Dynamic>,currentOverObjects) = ::Array_obj< ::Dynamic>::__new();
HXLINE(  92)		{
HXLINE(  92)			int _g = 0;
HXDLIN(  92)			::Array< ::Dynamic> _g1 = this->_list;
HXDLIN(  92)			while((_g < _g1->length)){
HXLINE(  92)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = _g1->__get(_g).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN(  92)				_g = (_g + 1);
...
HXLINE( 111)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,over) = _g3->__get(_g2).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 125)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,current) = currentOverObjects->__get(_g4).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 145)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current1,"current") = currentOverObjects->__get(_g5).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 155)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current2,"current") = currentOverObjects->__get(_g6).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 159)						HX_VARI( int,buttonID) = _g8->__get(_g7);
...
HXLINE( 172)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current3,"current") = currentOverObjects->__get(_g9).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 184)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current4,"current") = currentOverObjects->__get(_g10).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 188)						HX_VARI_NAME( int,buttonID1,"buttonID") = _g12->__get(_g11);
...
HXLINE( 209)			HX_VARI( ::Array< ::Dynamic>,previousClickedObjects) = this->_clickList;
...
HXLINE( 216)					HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,down) = _g14->__get(_g13).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 243)		bool _hx_tmp21;
HXDLIN( 243)		if ((this->_downList->length > 0)) {
HXLINE( 243)			 ::flixel::input::mouse::FlxMouseButton _this1 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 243)			bool _hx_tmp22;
HXDLIN( 243)			if ((_this1->current != 1)) {
HXLINE( 243)				_hx_tmp22 = (_this1->current == 2);
            			}
            			else {
HXLINE( 243)				_hx_tmp22 = true;
            			}
HXDLIN( 243)			_hx_tmp21 = !(_hx_tmp22);
            		}
            		else {
...
HXLINE( 252)			int _g15 = 0;
HXDLIN( 252)			while((_g15 < currentOverObjects->length)){
HXLINE( 252)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current5,"current") = currentOverObjects->__get(_g15).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN( 252)				_g15 = (_g15 + 1);
HXLINE( 254)				bool _hx_tmp23;
HXDLIN( 254)				bool _hx_tmp24;
HXDLIN( 254)				if (::hx::IsNotNull( current5->onMouseWheel )) {
HXLINE( 254)					_hx_tmp24 = current5->object->exists;
            				}
            				else {
HXLINE( 254)					_hx_tmp24 = false;
            				}
HXDLIN( 254)				if (_hx_tmp24) {
HXLINE( 254)					_hx_tmp23 = current5->object->visible;
            				}
            				else {
HXLINE( 254)					_hx_tmp23 = false;
            				}
HXDLIN( 254)				if (_hx_tmp23) {
HXLINE( 256)					current5->onMouseWheel(current5->object);
            				}
            			}
            		}
...
HXLINE( 274)			HX_VARI( int,index) = 0;
...
HXLINE( 303)
HXLINE( 304)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) =  ::flixel::input::mouse::FlxMouseEvent_obj::__alloc( HX_CTX ,object,onMouseDown,onMouseUp,onMouseOver,onMouseOut,mouseChildren,mouseEnabled,pixelPerfect,mouseButtons);
...
HXLINE( 333)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = _g1->__get(_g).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN( 333)				_g = (_g + 1);
...
void FlxMouseEventManager_obj::reorder(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 353)
HXLINE( 354)		HX_VARI( ::Array< ::Dynamic>,orderedObjects) = ::Array_obj< ::Dynamic>::__new();
...
void FlxMouseEventManager_obj::setMouseDownCallback( ::Dynamic object, ::Dynamic onMouseDown){
            	...
            	HX_STACK_ARG(onMouseDown,"onMouseDown")
HXLINE( 371)
HXLINE( 372)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseUpCallback( ::Dynamic object, ::Dynamic onMouseUp){
            	...
            	HX_STACK_ARG(onMouseUp,"onMouseUp")
HXLINE( 387)
HXLINE( 388)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
HXLINE( 404)
HXLINE( 405)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
HXLINE( 421)
HXLINE( 422)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseOverCallback( ::Dynamic object, ::Dynamic onMouseOver){
            	...
            	HX_STACK_ARG(onMouseOver,"onMouseOver")
HXLINE( 437)
HXLINE( 438)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseOutCallback( ::Dynamic object, ::Dynamic onMouseOut){
            	...
            	HX_STACK_ARG(onMouseOut,"onMouseOut")
HXLINE( 453)
HXLINE( 454)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
HXLINE( 470)
HXLINE( 471)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
HXLINE( 487)
HXLINE( 488)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setObjectMouseEnabled( ::Dynamic object,bool MouseEnabled){
            	...
            	HX_STACK_ARG(MouseEnabled,"MouseEnabled")
HXLINE( 502)
HXLINE( 503)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
bool FlxMouseEventManager_obj::isObjectMouseEnabled( ::Dynamic object){
            	...
            	HX_STACK_ARG(object,"object")
HXLINE( 515)
HXLINE( 516)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setObjectMouseChildren( ::Dynamic object,bool mouseChildren){
            	...
            	HX_STACK_ARG(mouseChildren,"mouseChildren")
HXLINE( 534)
HXLINE( 535)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
HXLINE( 548)				HX_VARI( int,index) = 0;
...
bool FlxMouseEventManager_obj::isObjectMouseChildren( ::Dynamic object){
            	...
            	HX_STACK_ARG(object,"object")
HXLINE( 562)
HXLINE( 563)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setObjectMouseButtons( ::Dynamic object,::Array< int > mouseButtons){
            	...
            	HX_STACK_ARG(mouseButtons,"mouseButtons")
HXLINE( 579)
HXLINE( 580)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
HXDLIN( 591)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 591)			_g = (_g + 1);
HXLINE( 593)			HX_VARI_NAME(  ::flixel::group::FlxTypedGroup,group1,"group") = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
HXLINE( 594)			if (::hx::IsNotNull( group1 )) {
HXLINE( 596)				this->traverseFlxGroup(group1,orderedObjects);
            			}
HXLINE( 598)			if (::Std_obj::isOfType(basic,::hx::ClassOf< ::flixel::FlxObject >())) {
HXLINE( 600)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(( ( ::flixel::FlxObject)(basic) ),null());
...
HXLINE( 617)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = list->__get(_g).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN( 617)				_g = (_g + 1);
...
HXLINE( 653)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 653)				_g = (_g + 1);
...
HXLINE( 661)					 ::flixel::math::FlxBasePoint point1 = this->_point;
...
HXLINE( 661)						_hx_tmp = event->sprite->pixelsOverlapPoint(point1,1,camera);
            					}
            					else {
HXLINE( 661)						_hx_tmp = event->object->overlapsPoint(point1,true,camera);
            					}
...
HXLINE( 669)						HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = _g3->__get(_g2).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN( 669)						_g2 = (_g2 + 1);
HXLINE( 671)						this->_point = touch->getPositionInCameraView(camera,this->_point);
HXLINE( 672)						 ::flixel::math::FlxBasePoint point2 = this->_point;
HXDLIN( 672)						bool contained3;
HXDLIN( 672)						bool contained4;
HXDLIN( 672)						bool contained5;
HXDLIN( 672)						if (((point2->x + ( (Float)(0) )) > camera->viewMarginX)) {
HXLINE( 672)							contained5 = (point2->x < (( (Float)(camera->width) ) - camera->viewMarginX));
            						}
            						else {
HXLINE( 672)							contained5 = false;
            						}
HXDLIN( 672)						if (contained5) {
HXLINE( 672)							contained4 = ((point2->y + ( (Float)(0) )) > camera->viewMarginY);
            						}
            						else {
HXLINE( 672)							contained4 = false;
            						}
HXDLIN( 672)						if (contained4) {
HXLINE( 672)							contained3 = (point2->y < (( (Float)(camera->height) ) - camera->viewMarginY));
            						}
            						else {
HXLINE( 672)							contained3 = false;
            						}
HXDLIN( 672)						if (point2->_weak) {
HXLINE( 672)							point2->put();
            						}
HXDLIN( 672)						if (contained3) {
HXLINE( 674)							this->_point = touch->getWorldPosition(camera,this->_point);
HXLINE( 676)							 ::flixel::math::FlxBasePoint point3 = this->_point;
HXDLIN( 676)							bool _hx_tmp2;
HXDLIN( 676)							bool _hx_tmp3;
HXDLIN( 676)							if (event->pixelPerfect) {
HXLINE( 676)								_hx_tmp3 = ::hx::IsNotNull( event->sprite );
            							}
            							else {
HXLINE( 676)								_hx_tmp3 = false;
            							}
HXDLIN( 676)							if (_hx_tmp3) {
HXLINE( 676)								_hx_tmp2 = event->sprite->pixelsOverlapPoint(point3,1,camera);
            							}
            							else {
HXLINE( 676)								_hx_tmp2 = event->object->overlapsPoint(point3,true,camera);
            							}
