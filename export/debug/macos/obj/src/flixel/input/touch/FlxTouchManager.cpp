...
HXLINE(  63)				HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = _g1->__get(_g).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN(  63)				_g = (_g + 1);
...
HXLINE(  69)				HX_VARI_NAME(  ::flixel::input::touch::FlxTouch,touch1,"touch") = _g3->__get(_g2).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN(  69)				_g2 = (_g2 + 1);
...
HXLINE(  91)		HX_VARI( int,touchLen) = TouchArray->length;
...
HXLINE(  98)				HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = _g1->__get(_g).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN(  98)				_g = (_g + 1);
...
HXLINE( 122)		HX_VARI( int,touchLen) = TouchArray->length;
...
HXLINE( 128)				HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = _g1->__get(_g).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN( 128)				_g = (_g + 1);
...
HXLINE( 143)
HXLINE( 144)		{
HXLINE( 144)			HX_VARI(  ::Dynamic,key) = this->_touchesCache->keys();
HXDLIN( 144)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 144)				HX_VARI_NAME( int,key1,"key") = ( (int)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 149)				HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = _g1->__get(_g).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN( 149)				_g = (_g + 1);
...
HXLINE( 176)
HXLINE( 177)		HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = ( ( ::flixel::input::touch::FlxTouch)(this->_touchesCache->get(FlashEvent->touchPointID)) );
...
void FlxTouchManager_obj::handleTouchEnd( ::openfl::events::TouchEvent FlashEvent){
            	...
            	HX_STACK_ARG(FlashEvent,"FlashEvent")
HXLINE( 194)
HXLINE( 195)		HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = ( ( ::flixel::input::touch::FlxTouch)(this->_touchesCache->get(FlashEvent->touchPointID)) );
...
void FlxTouchManager_obj::handleTouchMove( ::openfl::events::TouchEvent FlashEvent){
            	...
            	HX_STACK_ARG(FlashEvent,"FlashEvent")
HXLINE( 207)
HXLINE( 208)		HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = ( ( ::flixel::input::touch::FlxTouch)(this->_touchesCache->get(FlashEvent->touchPointID)) );
...
HXLINE( 242)			HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = this->_inactiveTouches->pop().StaticCast<  ::flixel::input::touch::FlxTouch >();
...
void FlxTouchManager_obj::update(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 254)
HXLINE( 255)		HX_VARI( int,i) = (this->list->length - 1);
HXLINE( 256)		HX_VAR(  ::flixel::input::touch::FlxTouch,touch);
