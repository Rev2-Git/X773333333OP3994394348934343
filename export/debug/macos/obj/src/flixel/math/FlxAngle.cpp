...
Float FlxAngle_obj::angleBetweenTouch( ::flixel::FlxObject Object, ::flixel::input::touch::FlxTouch Touch,::hx::Null< bool >  __o_AsDegrees){
            	...
            	HX_STACK_ARG(AsDegrees,"AsDegrees")
HXLINE( 295)
HXLINE( 297)		HX_VARI(  ::flixel::math::FlxBasePoint,p) = Object->getScreenPosition(null(),null());
HXLINE( 299)		HX_VARI( Float,dx) = (( (Float)(Touch->screenX) ) - p->x);
HXLINE( 300)		HX_VARI( Float,dy) = (( (Float)(Touch->screenY) ) - p->y);
HXLINE( 302)		p->put();
