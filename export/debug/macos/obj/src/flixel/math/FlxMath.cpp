...
HXLINE(  65)
HXLINE(  66)		HX_VARI( Float,mult) = ( (Float)(1) );
HXLINE(  67)		{
HXLINE(  67)			int _g = 0;
HXDLIN(  67)			int _g1 = Precision;
HXDLIN(  67)			while((_g < _g1)){
HXLINE(  67)				_g = (_g + 1);
HXDLIN(  67)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(  85)
HXLINE(  86)		HX_VAR( Float,lowerBound);
...
int FlxMath_obj::wrap(int value,int min,int max){
            	...
            	HX_STACK_ARG(max,"max")
HXLINE( 266)
HXLINE( 267)		HX_VARI( int,range) = ((max - min) + 1);
...
HXLINE( 321)
HXLINE( 322)		HX_VARI( Float,dx) = ((SpriteA->x + SpriteA->origin->x) - (SpriteB->x + SpriteB->origin->x));
HXLINE( 323)		HX_VARI( Float,dy) = ((SpriteA->y + SpriteA->origin->y) - (SpriteB->y + SpriteB->origin->y));
...
HXLINE( 338)
HXLINE( 339)		HX_VARI( Float,dx) = ((SpriteA->x + SpriteA->origin->x) - (SpriteB->x + SpriteB->origin->x));
HXLINE( 340)		HX_VARI( Float,dy) = ((SpriteA->y + SpriteA->origin->y) - (SpriteB->y + SpriteB->origin->y));
...
HXLINE( 357)
HXLINE( 358)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - Target->x);
HXLINE( 359)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - Target->y);
...
bool FlxMath_obj::isDistanceToPointWithin( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint Target,Float Distance,::hx::Null< bool >  __o_IncludeEqual){
            	...
            	HX_STACK_ARG(IncludeEqual,"IncludeEqual")
HXLINE( 376)
HXLINE( 377)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - Target->x);
HXLINE( 378)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - Target->y);
...
int FlxMath_obj::distanceToMouse( ::flixel::FlxSprite Sprite){
            	...
            	HX_STACK_ARG(Sprite,"Sprite")
HXLINE( 396)
HXLINE( 397)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - ( (Float)(::flixel::FlxG_obj::mouse->screenX) ));
HXLINE( 398)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - ( (Float)(::flixel::FlxG_obj::mouse->screenY) ));
...
bool FlxMath_obj::isDistanceToMouseWithin( ::flixel::FlxSprite Sprite,Float Distance,::hx::Null< bool >  __o_IncludeEqual){
            	...
            	HX_STACK_ARG(IncludeEqual,"IncludeEqual")
HXLINE( 412)
HXLINE( 413)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - ( (Float)(::flixel::FlxG_obj::mouse->screenX) ));
HXLINE( 414)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - ( (Float)(::flixel::FlxG_obj::mouse->screenY) ));
...
HXLINE( 432)
HXLINE( 433)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - ( (Float)(Touch->screenX) ));
HXLINE( 434)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - ( (Float)(Touch->screenY) ));
...
bool FlxMath_obj::isDistanceToTouchWithin( ::flixel::FlxSprite Sprite, ::flixel::input::touch::FlxTouch Touch,Float Distance,::hx::Null< bool >  __o_IncludeEqual){
            	...
            	HX_STACK_ARG(IncludeEqual,"IncludeEqual")
HXLINE( 448)
HXLINE( 449)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - ( (Float)(Touch->screenX) ));
HXLINE( 450)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - ( (Float)(Touch->screenY) ));
...
int FlxMath_obj::getDecimals(Float n){
            	...
            	HX_STACK_ARG(n,"n")
HXLINE( 463)
HXLINE( 464)		HX_VARI( ::Array< ::String >,helperArray) = ::Std_obj::string(n).split(HX_(".",2e,00,00,00));
HXLINE( 465)		HX_VARI( int,decimals) = 0;
