...
HXLINE( 232)
HXLINE( 233)		HX_VARI( bool,result) = ::flixel::math::FlxMath_obj::pointInFlxRect(Point->x,Point->y,::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC1(FlxRect_obj,containsPoint,return )
 ...
 ::flixel::math::FlxRect FlxRect_obj::_hx_union( ::flixel::math::FlxRect Rect){
            	...
            	HX_STACK_ARG(Rect,"Rect")
HXLINE( 246)
HXLINE( 247)		HX_VARI( Float,minX) = ::Math_obj::min(this->x,Rect->x);
HXLINE( 248)		HX_VARI( Float,minY) = ::Math_obj::min(this->y,Rect->y);
HXLINE( 249)		HX_VARI( Float,maxX) = ::Math_obj::max((this->x + this->width),(Rect->x + Rect->width));
HXLINE( 250)		HX_VARI( Float,maxY) = ::Math_obj::max((this->y + this->height),(Rect->y + Rect->height));
...
HXLINE( 300)
HXLINE( 301)		HX_VARI( Float,minX) = ::Math_obj::min(Point1->x,Point2->x);
HXLINE( 302)		HX_VARI( Float,minY) = ::Math_obj::min(Point1->y,Point2->y);
HXLINE( 304)		HX_VARI( Float,maxX) = ::Math_obj::max(Point1->x,Point2->x);
HXLINE( 305)		HX_VARI( Float,maxY) = ::Math_obj::max(Point1->y,Point2->y);
...
HX_DEFINE_DYNAMIC_FUNC2(FlxRect_obj,fromTwoPoints,return )
 ...
 ::flixel::math::FlxRect FlxRect_obj::unionWithPoint( ::flixel::math::FlxBasePoint Point){
            	...
            	HX_STACK_ARG(Point,"Point")
HXLINE( 320)
HXLINE( 321)		HX_VARI( Float,minX) = ::Math_obj::min(this->x,Point->x);
HXLINE( 322)		HX_VARI( Float,minY) = ::Math_obj::min(this->y,Point->y);
HXLINE( 323)		HX_VARI( Float,maxX) = ::Math_obj::max((this->x + this->width),Point->x);
HXLINE( 324)		HX_VARI( Float,maxY) = ::Math_obj::max((this->y + this->height),Point->y);
...
HXLINE( 365)		HX_VARI( Float,radians) = ((::Math_obj::PI / ( (Float)(180) )) * degrees);
HXLINE( 366)		HX_VARI( Float,cos) = ::Math_obj::cos(radians);
HXLINE( 367)		HX_VARI( Float,sin) = ::Math_obj::sin(radians);
HXLINE( 369)		HX_VARI( Float,left) = -(origin->x);
HXLINE( 370)		HX_VARI( Float,top) = -(origin->y);
HXLINE( 371)		HX_VARI( Float,right) = (-(origin->x) + this->width);
HXLINE( 372)		HX_VARI( Float,bottom) = (-(origin->y) + this->height);
...
HXLINE( 394)		HX_VARI( Float,newHeight) = (::Math_obj::abs((cos * this->height)) + ::Math_obj::abs((sin * this->width)));
...
HXDLIN(  23)		HX_VARI(  ::flixel::math::FlxRect,rect) = _this;
...
HXDLIN(  34)		HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
