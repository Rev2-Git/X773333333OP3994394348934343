...
HXLINE( 287)		HX_VARI( Float,radialMultiplier) = ((Float)1.0);
HXLINE( 290)		if (::hx::IsNotNull( this->_target )) {
HXLINE( 292)			HX_VARI(  ::flixel::math::FlxBasePoint,targetPosition) = this->_target->getPosition(null());
...
HXLINE( 299)				HX_VARI( Float,d) = ((this->x - this->_target->x) / this->_radius);
HXLINE( 300)				Float lowerBound1;
HXDLIN( 300)				if ((d < -1)) {
HXLINE( 300)					lowerBound1 = ( (Float)(-1) );
            				}
            				else {
HXLINE( 300)					lowerBound1 = d;
            				}
HXDLIN( 300)				Float _hx_tmp;
HXDLIN( 300)				if ((lowerBound1 > 1)) {
HXLINE( 300)					_hx_tmp = ( (Float)(1) );
            				}
            				else {
HXLINE( 300)					_hx_tmp = lowerBound1;
            				}
...
HXLINE( 320)			_hx_tmp1 = ::hx::IsGreaterEq( this->_time,this->endTime );
            		}
            		else {
...
HXLINE( 360)						::flixel::FlxG_obj::log->advanced(((HX_("Could not find a Sound asset with an ID of '",6f,0e,1e,66) + EmbeddedSound) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            					}
            				}
            			}
            		}
...
HXLINE( 384)		HX_VARI( ::Array< ::Dynamic>,loadCallback) = ::Array_obj< ::Dynamic>::__new(1)->init(0,null());
...
HXLINE( 716)			HX_VARI(  ::flixel::_hx_system::FlxSoundGroup,oldGroup) = this->group;
