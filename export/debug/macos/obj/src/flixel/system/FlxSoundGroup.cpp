...
HXDLIN(  64)			HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN(  64)			_g = (_g + 1);
...
HXDLIN(  74)			HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN(  74)			_g = (_g + 1);
