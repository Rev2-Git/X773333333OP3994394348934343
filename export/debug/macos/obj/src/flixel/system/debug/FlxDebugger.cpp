...
HXLINE( 136)		HX_VARI(  ::openfl::text::TextField,txt) =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
...
HXLINE( 142)		HX_VARI(  ::openfl::text::TextFormat,format) =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,12,16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 168)		HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,drawDebugButton) = this->addButton(::flixel::util::FlxHorizontalAlign_obj::RIGHT_dyn(), ::flixel::_hx_system::debug::_FlxDebugger::GraphicDrawDebug_obj::__alloc( HX_CTX ,0,0,null(),null()),this->toggleDrawDebug_dyn(),true,null());
...
HXDLIN( 239)			HX_VARI(  ::flixel::_hx_system::debug::Window,window) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 239)			_g = (_g + 1);
...
HXLINE( 266)				 ::flixel::_hx_system::debug::console::Console _hx_tmp9 = this->console;
HXDLIN( 266)				Float _hx_tmp10 = this->log->get_x();
HXDLIN( 266)				Float _hx_tmp11 = ((_hx_tmp10 + this->log->get_width()) + 2);
HXDLIN( 266)				_hx_tmp9->reposition(_hx_tmp11,this->_screen->y);
...
HXLINE( 276)				 ::flixel::_hx_system::debug::log::Log _hx_tmp12 = this->log;
HXDLIN( 276)				Float _hx_tmp13 = this->_screen->y;
HXDLIN( 276)				Float _hx_tmp14 = (_hx_tmp13 - this->log->get_height());
HXDLIN( 276)				_hx_tmp12->reposition(( (Float)(0) ),((_hx_tmp14 - this->console->get_height()) - ((Float)3.)));
HXLINE( 277)				this->watch->resize(((this->_screen->x - ( (Float)(6) )) / ( (Float)(2) )),(this->_screen->y / ( (Float)(2) )));
HXLINE( 278)				 ::flixel::_hx_system::debug::watch::Watch _hx_tmp15 = this->watch;
HXDLIN( 278)				Float _hx_tmp16 = this->_screen->x;
HXDLIN( 278)				Float _hx_tmp17 = this->_screen->y;
HXDLIN( 278)				Float _hx_tmp18 = (_hx_tmp17 - this->watch->get_height());
HXDLIN( 278)				_hx_tmp15->reposition(_hx_tmp16,((_hx_tmp18 - this->console->get_height()) - ((Float)3.)));
...
HXLINE( 286)				 ::flixel::_hx_system::debug::log::Log _hx_tmp19 = this->log;
HXDLIN( 286)				_hx_tmp19->reposition(( (Float)(0) ),((this->console->get_height() + 2) + 15));
HXLINE( 287)				this->watch->resize(((this->_screen->x - ( (Float)(6) )) / ( (Float)(2) )),(this->_screen->y / ( (Float)(4) )));
HXLINE( 288)				 ::flixel::_hx_system::debug::watch::Watch _hx_tmp20 = this->watch;
HXDLIN( 288)				Float _hx_tmp21 = this->_screen->x;
HXDLIN( 288)				_hx_tmp20->reposition(_hx_tmp21,((this->console->get_height() + 2) + 15));
...
HXLINE( 291)				 ::flixel::_hx_system::debug::log::BitmapLog _hx_tmp22 = this->bitmapLog;
HXDLIN( 291)				Float _hx_tmp23 = ((this->console->get_height() + 4) + 15);
HXDLIN( 291)				_hx_tmp22->reposition(( (Float)(0) ),((_hx_tmp23 + (this->_screen->y / ( (Float)(4) ))) + 2));
            			}
            			break;
            			case (int)4: {
HXLINE( 293)				this->console->resize((this->_screen->x - ( (Float)(4) )),( (Float)(35) ));
HXLINE( 294)				this->console->reposition(( (Float)(2) ),this->_screen->y);
HXLINE( 295)				 ::flixel::_hx_system::debug::log::Log _hx_tmp24 = this->log;
HXDLIN( 295)				Float _hx_tmp25 = (this->_screen->x / ( (Float)(3) ));
HXDLIN( 295)				Float _hx_tmp26 = (((this->_screen->y - ( (Float)(15) )) - ((Float)5.)) / ( (Float)(2) ));
HXDLIN( 295)				_hx_tmp24->resize(_hx_tmp25,((_hx_tmp26 - (this->console->get_height() / ( (Float)(2) ))) - ( (Float)(2) )));
HXLINE( 296)				this->log->reposition(( (Float)(0) ),( (Float)(0) ));
HXLINE( 297)				 ::flixel::_hx_system::debug::watch::Watch _hx_tmp27 = this->watch;
HXDLIN( 297)				Float _hx_tmp28 = (this->_screen->x / ( (Float)(3) ));
HXDLIN( 297)				Float _hx_tmp29 = (((this->_screen->y - ( (Float)(15) )) - ((Float)5.)) / ( (Float)(2) ));
HXDLIN( 297)				_hx_tmp27->resize(_hx_tmp28,(_hx_tmp29 - (this->console->get_height() / ( (Float)(2) ))));
HXLINE( 298)				 ::flixel::_hx_system::debug::watch::Watch _hx_tmp30 = this->watch;
HXDLIN( 298)				Float _hx_tmp31 = this->log->get_y();
HXDLIN( 298)				_hx_tmp30->reposition(( (Float)(0) ),((_hx_tmp31 + this->log->get_height()) + 2));
HXLINE( 299)				this->stats->reposition(this->_screen->x,( (Float)(0) ));
HXLINE( 300)				 ::flixel::_hx_system::debug::log::BitmapLog _hx_tmp32 = this->bitmapLog;
HXDLIN( 300)				Float _hx_tmp33 = (this->_screen->x / ( (Float)(3) ));
HXDLIN( 300)				Float _hx_tmp34 = (((this->_screen->y - ( (Float)(15) )) - ((Float)5.)) / ( (Float)(2) ));
HXDLIN( 300)				_hx_tmp32->resize(_hx_tmp33,((_hx_tmp34 - (this->console->get_height() / ( (Float)(2) ))) - ( (Float)(2) )));
...
HXLINE( 305)				 ::flixel::_hx_system::debug::log::Log _hx_tmp35 = this->log;
HXDLIN( 305)				Float _hx_tmp36 = (this->_screen->x / ( (Float)(3) ));
HXDLIN( 305)				Float _hx_tmp37 = (((this->_screen->y - ( (Float)(15) )) - ((Float)5.)) / ( (Float)(2) ));
HXDLIN( 305)				_hx_tmp35->resize(_hx_tmp36,((_hx_tmp37 - (this->console->get_height() / ( (Float)(2) ))) - ( (Float)(2) )));
HXLINE( 306)				this->log->reposition(this->_screen->x,( (Float)(0) ));
HXLINE( 307)				 ::flixel::_hx_system::debug::watch::Watch _hx_tmp38 = this->watch;
HXDLIN( 307)				Float _hx_tmp39 = (this->_screen->x / ( (Float)(3) ));
HXDLIN( 307)				Float _hx_tmp40 = (((this->_screen->y - ( (Float)(15) )) - ((Float)5.)) / ( (Float)(2) ));
HXDLIN( 307)				_hx_tmp38->resize(_hx_tmp39,(_hx_tmp40 - (this->console->get_height() / ( (Float)(2) ))));
HXLINE( 308)				 ::flixel::_hx_system::debug::watch::Watch _hx_tmp41 = this->watch;
HXDLIN( 308)				Float _hx_tmp42 = this->_screen->x;
HXDLIN( 308)				Float _hx_tmp43 = this->log->get_y();
HXDLIN( 308)				_hx_tmp41->reposition(_hx_tmp42,((_hx_tmp43 + this->log->get_height()) + 2));
HXLINE( 309)				this->stats->reposition(( (Float)(0) ),( (Float)(0) ));
HXLINE( 310)				 ::flixel::_hx_system::debug::log::BitmapLog _hx_tmp44 = this->bitmapLog;
HXDLIN( 310)				Float _hx_tmp45 = (this->_screen->x / ( (Float)(3) ));
HXDLIN( 310)				Float _hx_tmp46 = (((this->_screen->y - ( (Float)(15) )) - ((Float)5.)) / ( (Float)(2) ));
HXDLIN( 310)				_hx_tmp44->resize(_hx_tmp45,((_hx_tmp46 - (this->console->get_height() / ( (Float)(2) ))) - ( (Float)(2) )));
...
HXLINE( 342)				HX_VARI(  ::flixel::_hx_system::debug::Window,window) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 342)				_g = (_g + 1);
...
HXLINE( 352)
HXLINE( 353)		HX_VARI( Float,width) = ( (Float)(0) );
HXLINE( 354)		HX_VARI( Float,last) = LeftOffset;
HXLINE( 356)		{
HXLINE( 356)			int _g = 0;
HXDLIN( 356)			int _g1 = Sprites->length;
HXDLIN( 356)			while((_g < _g1)){
HXLINE( 356)				_g = (_g + 1);
HXDLIN( 356)				HX_VARI( int,i) = (_g - 1);
HXLINE( 358)				HX_VARI(  ::openfl::display::Sprite,o) = Sprites->__get(i).StaticCast<  ::flixel::_hx_system::ui::FlxSystemButton >();
...
HXDLIN( 375)		HX_VARI_NAME( Float,offset1,"offset") = (offset - (this->hAlignButtons(( (::Array< ::Dynamic>)(this->_buttons->get(::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn())) ),10,false,null()) * ((Float)0.5)));
...
HXDLIN( 378)		HX_VARI_NAME( Float,offset3,"offset") = (( (Float)(offset2) ) - this->hAlignButtons(( (::Array< ::Dynamic>)(this->_buttons->get(::flixel::util::FlxHorizontalAlign_obj::RIGHT_dyn())) ),10,false,null()));
...
HXLINE( 394)
HXLINE( 395)		HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,button) =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX ,Icon,UpHandler,ToggleMode);
...
void FlxDebugger_obj::addWindowToggleButton( ::flixel::_hx_system::debug::Window window,::hx::Class icon){
            	...
            	HX_STACK_ARG(icon,"icon")
HXLINE( 426)
HXLINE( 427)		HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,button) = this->addButton(::flixel::util::FlxHorizontalAlign_obj::RIGHT_dyn(),( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(icon,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) ),window->toggleVisible_dyn(),true,true);
...
HXLINE( 452)
HXLINE( 453)		HX_VARI(  ::openfl::display::DisplayObject,result) = this->super::addChild(child);
...
void FlxDebugger_obj::openGitHub(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 514)
HXLINE( 515)		HX_VARI( ::String,url) = HX_("https://github.com/HaxeFlixel/flixel",bf,0c,67,11);
