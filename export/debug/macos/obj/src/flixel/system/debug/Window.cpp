...
HXLINE( 206)		HX_VARI(  ::openfl::display::Stage,stage) = ::openfl::Lib_obj::get_current()->stage;
...
void Window_obj::initWindowsSave(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 298)
HXLINE( 299)		HX_VARI( int,maxWindows) = 10;
...
HXDLIN( 300)				HX_VARI( int,_) = (_g1 - 1);
...
void Window_obj::onMouseMove( ::openfl::events::MouseEvent _){
            	...
            	HX_STACK_ARG(_,"_")
HXLINE( 338)
HXLINE( 340)		HX_VAR( Float,mouseX);
...
HXLINE( 341)		HX_VAR( Float,mouseY);
...
void Window_obj::close(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 444)
HXLINE( 445)		this->destroy();
HXLINE( 447)		{
HXLINE( 447)			 ::flixel::_hx_system::debug::FlxDebugger _this = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 447)			if (_this->contains(::hx::ObjectPtr<OBJ_>(this))) {
HXLINE( 447)				_this->removeChild(::hx::ObjectPtr<OBJ_>(this));
            			}
HXDLIN( 447)			{
HXLINE( 447)				::Array< ::Dynamic> array = _this->_windows;
HXDLIN( 447)				int index = array->indexOf(::hx::ObjectPtr<OBJ_>(this),null());
HXDLIN( 447)				if ((index != -1)) {
HXLINE( 447)					array[index] = array->__get((array->length - 1)).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 447)					array->pop().StaticCast<  ::flixel::_hx_system::debug::Window >();
            				}
            			}
            		}
            	}
