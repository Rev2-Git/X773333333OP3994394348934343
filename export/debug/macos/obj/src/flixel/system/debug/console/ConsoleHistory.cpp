...
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_35_getPreviousCommand,"flixel.system.debug.console.ConsoleHistory","getPreviousCommand",0x3aa09670,"flixel.system.debug.console.ConsoleHistory.getPreviousCommand","flixel/system/debug/console/ConsoleHistory.hx",35,0xc796b240)
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_42_getNextCommand,"flixel.system.debug.console.ConsoleHistory","getNextCommand",0x2e4e1f34,"flixel.system.debug.console.ConsoleHistory.getNextCommand","flixel/system/debug/console/ConsoleHistory.hx",42,0xc796b240)
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_49_addCommand,"flixel.system.debug.console.ConsoleHistory","addCommand",0x56eecfbc,"flixel.system.debug.console.ConsoleHistory.addCommand","flixel/system/debug/console/ConsoleHistory.hx",49,0xc796b240)
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_65_clear,"flixel.system.debug.console.ConsoleHistory","clear",0x0d15483b,"flixel.system.debug.console.ConsoleHistory.clear","flixel/system/debug/console/ConsoleHistory.hx",65,0xc796b240)
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_72_get_isEmpty,"flixel.system.debug.console.ConsoleHistory","get_isEmpty",0x5caf4b88,"flixel.system.debug.console.ConsoleHistory.get_isEmpty","flixel/system/debug/console/ConsoleHistory.hx",72,0xc796b240)
...
HXLINE(  15)		 ::flixel::util::FlxSaveStatus _g = ::flixel::FlxG_obj::save->status;
HXDLIN(  15)		bool _hx_tmp;
HXDLIN(  15)		if ((_g->_hx_getIndex() == 1)) {
HXLINE(  15)			::String _g1 = _g->_hx_getString(0);
HXDLIN(  15)			::String _g2 = _g->_hx_getString(1);
...
HXLINE(  17)			if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("history",54,35,47,64),::hx::paccDynamic) )) {
HXLINE(  19)				this->commands = ( (::Array< ::String >)(::flixel::FlxG_obj::save->data->__Field(HX_("history",54,35,47,64),::hx::paccDynamic)) );
HXLINE(  20)				this->index = this->commands->length;
            			}
            			else {
HXLINE(  24)				this->commands = ::Array_obj< ::String >::__new(0);
HXLINE(  25)				::flixel::FlxG_obj::save->data->__SetField(HX_("history",54,35,47,64),this->commands,::hx::paccDynamic);
            			}
            		}
            		else {
HXLINE(  30)			this->commands = ::Array_obj< ::String >::__new(0);
            		}
            	}
...
::String ConsoleHistory_obj::getPreviousCommand(){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_35_getPreviousCommand)
            	HX_STACK_THIS(this)
HXLINE(  35)
HXLINE(  36)		if ((this->index > 0)) {
...
::String ConsoleHistory_obj::getNextCommand(){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_42_getNextCommand)
            	HX_STACK_THIS(this)
HXLINE(  42)
HXLINE(  43)		if ((this->index < this->commands->length)) {
HXLINE(  44)			this->index++;
            		}
HXLINE(  45)		if (::hx::IsNotNull( this->commands->__get(this->index) )) {
HXLINE(  45)			return this->commands->__get(this->index);
            		}
            		else {
...
void ConsoleHistory_obj::addCommand(::String command){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_49_addCommand)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(command,"command")
HXLINE(  49)
HXLINE(  51)		bool _hx_tmp;
HXDLIN(  51)		if (!(this->get_isEmpty())) {
HXLINE(  51)			_hx_tmp = (this->getPreviousCommand() != command);
            		}
            		else {
HXLINE(  51)			_hx_tmp = true;
            		}
HXDLIN(  51)		if (_hx_tmp) {
HXLINE(  53)			this->commands->push(command);
HXLINE(  54)			 ::flixel::util::FlxSaveStatus _g = ::flixel::FlxG_obj::save->status;
HXDLIN(  54)			bool _hx_tmp1;
HXDLIN(  54)			if ((_g->_hx_getIndex() == 1)) {
HXLINE(  54)				::String _g1 = _g->_hx_getString(0);
HXDLIN(  54)				::String _g2 = _g->_hx_getString(1);
...
HXLINE(  55)				::flixel::FlxG_obj::save->flush(null());
            			}
HXLINE(  57)			if ((this->commands->length > 50)) {
HXLINE(  58)				this->commands->shift();
            			}
            		}
HXLINE(  61)		this->index = this->commands->length;
            	}
...
void ConsoleHistory_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_65_clear)
            	HX_STACK_THIS(this)
HXLINE(  65)
HXLINE(  66)		this->commands->removeRange(0,this->commands->length);
HXLINE(  67)		::flixel::FlxG_obj::save->flush(null());
            	}
...
bool ConsoleHistory_obj::get_isEmpty(){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_72_get_isEmpty)
            	HX_STACK_THIS(this)
HXLINE(  72)
HXDLIN(  72)		return (this->commands->length == 0);
            	}
