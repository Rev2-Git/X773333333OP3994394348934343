...
HXLINE( 103)
HXLINE( 104)		HX_VARI( ::Array< ::String >,fields) = ::Array_obj< ::String >::__new(0);
...
HXLINE( 115)		HX_VARI( ::Array< ::String >,filteredFields) = ::Array_obj< ::String >::__new(0);
HXLINE( 116)		{
HXLINE( 116)			int _g = 0;
HXDLIN( 116)			while((_g < fields->length)){
HXLINE( 116)				HX_VARI( ::String,field) = fields->__get(_g);
HXDLIN( 116)				_g = (_g + 1);
...
HXLINE( 121)					HX_VARI( ::String,name) = field.substr(4,null());
...
HXLINE( 134)
HXLINE( 135)		HX_VARI( ::Array< ::String >,underscoreList) = ::Array_obj< ::String >::__new(0);
