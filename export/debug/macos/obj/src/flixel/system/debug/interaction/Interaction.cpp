...
HXLINE( 105)
HXLINE( 111)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE( 112)		HX_VARI( Float,offsetY) = ((Float)0.0);
HXLINE( 116)		if (::hx::IsNotNull( this->activeTool )) {
HXLINE( 118)			HX_VARI(  ::openfl::display::BitmapData,cursorIcon) = this->activeTool->cursor;
...
int Interaction_obj::countToolsWithUIButton(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 192)
HXLINE( 193)		HX_VARI( int,count) = 0;
HXLINE( 194)		{
HXLINE( 194)			int _g = 0;
HXDLIN( 194)			::Array< ::Dynamic> _g1 = this->_tools;
HXDLIN( 194)			while((_g < _g1->length)){
HXLINE( 194)				HX_VARI(  ::flixel::_hx_system::debug::interaction::tools::Tool,tool) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::Tool >();
HXDLIN( 194)				_g = (_g + 1);
...
HXLINE( 218)		HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,button) = tool->button;
HXLINE( 219)		if (::hx::IsNull( button )) {
HXLINE( 220)			return;
            		}
HXLINE( 222)		HX_VARI( int,buttonsPerLine) = 2;
HXLINE( 223)		HX_VARI( int,buttons) = this->countToolsWithUIButton();
HXLINE( 224)		HX_VARI( int,lines) = ::Std_obj::_hx_int(( (Float)(::Math_obj::ceil((( (Float)(buttons) ) / ( (Float)(buttonsPerLine) )))) ));
HXLINE( 225)		HX_VARI( int,slot) = ::Std_obj::_hx_int((( (Float)(buttons) ) / ( (Float)(lines) )));
...
HXLINE( 280)				HX_VARI(  ::flixel::_hx_system::debug::interaction::tools::Tool,tool) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::Tool >();
HXDLIN( 280)				_g = (_g + 1);
...
HXLINE( 296)				HX_VARI(  ::flixel::_hx_system::debug::interaction::tools::Tool,tool) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::Tool >();
HXDLIN( 296)				_g = (_g + 1);
...
void Interaction_obj::drawItemsSelection(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 319)
HXLINE( 320)		HX_VARI(  ::openfl::display::Graphics,gfx) = this->getDebugGraphics();
HXLINE( 321)		if (::hx::IsNull( gfx )) {
HXLINE( 322)			return;
            		}
HXLINE( 324)		{
HXLINE( 324)			 ::Dynamic filter = null();
HXDLIN( 324)			HX_VARI(  ::flixel::group::FlxTypedGroupIterator,member) =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,this->selectedItems->members,filter);
HXDLIN( 324)			while(member->hasNext()){
HXLINE( 324)				HX_VARI_NAME(  ::flixel::FlxObject,member1,"member") = member->next().StaticCast<  ::flixel::FlxObject >();
...
HXLINE( 349)				HX_VARI(  ::flixel::_hx_system::debug::interaction::tools::Tool,tool) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::Tool >();
HXDLIN( 349)				_g = (_g + 1);
...
HXLINE( 375)		HX_VARI(  ::openfl::display::Sprite,sprite) =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
...
HXLINE( 395)				HX_VAR( ::String,cursorInUse);
...
HXLINE( 405)						HX_VARI(  ::openfl::display::DisplayObject,sprite) = this->_customCursor->getChildAt(i);
...
void Interaction_obj::findItemsWithinArea(::Array< ::Dynamic> items,::Array< ::Dynamic> members, ::flixel::math::FlxRect area){
            	...
            	HX_STACK_ARG(area,"area")
HXLINE( 554)
HXLINE( 556)		HX_VARI( int,i) = members->length;
HXLINE( 557)		while(true){
HXLINE( 557)			i = (i - 1);
HXDLIN( 557)			if (!(((i + 1) > 0))) {
HXLINE( 557)				goto _hx_goto_36;
            			}
HXLINE( 559)			HX_VARI(  ::flixel::FlxBasic,member) = members->__get(i).StaticCast<  ::flixel::FlxBasic >();
...
HXLINE( 564)			HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(member);
