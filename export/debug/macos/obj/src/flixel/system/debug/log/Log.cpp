...
HXLINE(  88)			int _g2 = 0;
HXDLIN(  88)			::Array< ::String > _g3 = this->_lines;
HXDLIN(  88)			while((_g2 < _g3->length)){
HXLINE(  88)				HX_VARI( ::String,line) = _g3->__get(_g2);
HXDLIN(  88)				_g2 = (_g2 + 1);
...
HXDLIN( 109)				int _g5 = this->_lines->length;
HXDLIN( 109)				while((_g4 < _g5)){
HXLINE( 109)					_g4 = (_g4 + 1);
HXDLIN( 109)					HX_VARI_NAME( int,i1,"i") = (_g4 - 1);
