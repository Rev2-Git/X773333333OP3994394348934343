...
HXLINE(  21)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(2,15);
...
HXLINE(  46)				HX_VARI( ::String,value) = data->_hx_getString(0);
...
HXLINE(  74)					if ((data->_hx_getIndex() == 1)) {
