...
HXLINE(  80)				HX_VARI(  ::openfl::media::Sound,sound) = ::flixel::_hx_system::FlxAssets_obj::getSound(Style->errorSound);
...
HXLINE( 130)
HXLINE( 131)		HX_VARI( ::cpp::VirtualArray,paramArray) = ::cpp::VirtualArray_obj::__new(1)->init(0,Data);
...
HXLINE( 135)				HX_VARI(  ::Dynamic,i) = _g1->__get(_g);
HXDLIN( 135)				_g = (_g + 1);
