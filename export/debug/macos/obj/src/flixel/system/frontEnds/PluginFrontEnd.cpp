...
HXLINE(  34)				HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  34)				_g = (_g + 1);
...
HXLINE(  55)				HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  55)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC1(PluginFrontEnd_obj,get,return )
 ...
 ::Dynamic PluginFrontEnd_obj::remove( ::Dynamic Plugin){
            	...
            	HX_STACK_ARG(Plugin,"Plugin")
HXLINE(  73)
HXLINE(  75)		HX_VARI( int,i) = (this->list->length - 1);
HXLINE(  77)		while((i >= 0)){
...
bool PluginFrontEnd_obj::removeType(::hx::Class ClassType){
            	...
            	HX_STACK_ARG(ClassType,"ClassType")
HXLINE(  97)
HXLINE(  99)		HX_VARI( bool,results) = false;
HXLINE( 100)		HX_VARI( int,i) = (this->list->length - 1);
...
HXDLIN( 129)			HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 129)			_g = (_g + 1);
...
HXDLIN( 144)			HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 144)			_g = (_g + 1);
