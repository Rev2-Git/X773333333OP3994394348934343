...
HXDLIN( 149)			HX_VARI_NAME(  ::openfl::media::Sound,sound1,"sound") = ::flixel::_hx_system::FlxAssets_obj::getSound(sound);
...
HXLINE( 158)		HX_VARI( int,globalVolume) = ::Math_obj::round((::flixel::FlxG_obj::sound->volume * ( (Float)(10) )));
