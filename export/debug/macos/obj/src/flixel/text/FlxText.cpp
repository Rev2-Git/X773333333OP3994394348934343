...
HXLINE( 245)		HX_VARI(  ::flixel::graphics::atlas::FlxNode,node) = atlas->addNode(this->graphic->bitmap,this->graphic->key);
HXLINE( 246)		HX_VARI( bool,result) = ::hx::IsNotNull( node );
...
HXLINE( 287)		HX_VARI( ::Array< int >,rangeStarts) = ::Array_obj< int >::__new(0);
HXLINE( 288)		HX_VARI( ::Array< int >,rangeEnds) = ::Array_obj< int >::__new(0);
HXLINE( 289)		HX_VARI( ::Array< ::Dynamic>,rulesToApply) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 291)		HX_VARI( int,i) = 0;
HXLINE( 292)		{
HXLINE( 292)			int _g = 0;
HXDLIN( 292)			while((_g < rules->length)){
HXLINE( 292)				HX_VARI(  ::flixel::text::FlxTextFormatMarkerPair,rule) = rules->__get(_g).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >();
HXDLIN( 292)				_g = (_g + 1);
...
HXLINE( 297)				HX_VARI( bool,start) = false;
HXLINE( 298)				HX_VARI( int,markerLength) = ::_UnicodeString::UnicodeString_Impl__obj::get_length(rule->marker);
...
HXDLIN( 304)						HX_VARI( int,charIndex) = (_g1 - 1);
...
HXLINE( 332)				HX_VARI_NAME(  ::flixel::text::FlxTextFormatMarkerPair,rule1,"rule") = rules->__get(_g3).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >();
...
HXDLIN( 336)				HX_VARI_NAME( int,i1,"i") = (_g4 - 1);
HXLINE( 339)				HX_VARI( int,delIndex) = rangeStarts->__get(i1);
HXLINE( 340)				HX_VARI_NAME( int,markerLength1,"markerLength") = ::_UnicodeString::UnicodeString_Impl__obj::get_length(rulesToApply->__get(i1).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >()->marker);
HXLINE( 343)				{
HXLINE( 343)					int _g6 = 0;
HXDLIN( 343)					int _g7 = rangeStarts->length;
HXDLIN( 343)					while((_g6 < _g7)){
HXLINE( 343)						_g6 = (_g6 + 1);
HXDLIN( 343)						HX_VARI( int,j) = (_g6 - 1);
...
HXDLIN( 359)						HX_VARI_NAME( int,j3,"j") = (_g8 - 1);
...
HXDLIN( 376)				HX_VARI_NAME( int,i2,"i") = (_g10 - 1);
...
HX_DEFINE_DYNAMIC_FUNC3(FlxText_obj,addFormat,return )
 ...
 ::flixel::text::FlxText FlxText_obj::removeFormat( ::flixel::text::FlxTextFormat Format, ::Dynamic Start, ::Dynamic End){
            	...
            	HX_STACK_ARG(End,"End")
HXLINE( 407)
HXLINE( 408)		HX_VARI( int,i) = this->_formatRanges->length;
HXLINE( 409)		while(true){
HXLINE( 409)			i = (i - 1);
HXDLIN( 409)			if (!(((i + 1) > 0))) {
HXLINE( 409)				goto _hx_goto_14;
            			}
HXLINE( 411)			HX_VARI(  ::flixel::text::_FlxText::FlxTextFormatRange,formatRange) = this->_formatRanges->__get(i).StaticCast<  ::flixel::text::_FlxText::FlxTextFormatRange >();
...
HXLINE( 417)				HX_VARI(  ::flixel::util::helpers::FlxRange,range) = formatRange->range;
...
HXLINE( 568)			HX_VARI( ::String,ot) = this->textField->get_text();
...
HXLINE( 610)			HX_VARI( ::String,newFontName) = Font;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxText_obj,set_borderQuality,return )
 ...
 ::flixel::graphics::FlxGraphic FlxText_obj::set_graphic( ::flixel::graphics::FlxGraphic Value){
            	...
            	HX_STACK_ARG(Value,"Value")
HXLINE( 736)
HXLINE( 737)		HX_VARI(  ::flixel::graphics::FlxGraphic,oldGraphic) = this->graphic;
HXLINE( 738)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = this->super::set_graphic(Value);
...
HXLINE( 779)		HX_VARI( int,oldWidth) = 0;
HXLINE( 780)		HX_VARI( int,oldHeight) = 4;
HXLINE( 782)		if (::hx::IsNotNull( this->graphic )) {
HXLINE( 784)			oldWidth = this->graphic->width;
HXLINE( 785)			oldHeight = this->graphic->height;
            		}
HXLINE( 788)		HX_VARI( int,newWidth) = ::Math_obj::ceil(this->textField->get_width());
HXLINE( 790)		HX_VARI( int,newHeight) = (::Math_obj::ceil(this->textField->get_textHeight()) + 4);
...
HXLINE( 802)			HX_VARI( ::String,key) = ::flixel::FlxG_obj::bitmap->getUniqueKey(HX_("text",ad,cc,f9,4c));
...
void FlxText_obj::applyBorderStyle(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 927)
HXLINE( 928)		HX_VARI( int,iterations) = ::Std_obj::_hx_int((this->borderSize * this->borderQuality));
HXLINE( 929)		if ((iterations <= 0)) {
HXLINE( 931)			iterations = 1;
            		}
HXLINE( 933)		HX_VARI( Float,delta) = (this->borderSize / ( (Float)(iterations) ));
...
void FlxText_obj::copyTextWithOffset(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE(1009)
HXLINE(1010)		HX_VAR(  ::openfl::display::BitmapData,graphic);
...
HXLINE(1023)				HX_VARI(  ::flixel::text::_FlxText::FlxTextFormatRange,formatRange) = _g1->__get(_g).StaticCast<  ::flixel::text::_FlxText::FlxTextFormatRange >();
HXDLIN(1023)				_g = (_g + 1);
...
HXLINE(1032)					HX_VARI(  ::openfl::text::TextFormat,textFormat) = formatRange->format->format;
...
HX_DEFINE_DYNAMIC_FUNC3(FlxText_obj,copyTextFormat,(void))
 ...
 ::openfl::text::TextFormat FlxText_obj::dtfCopy(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1059)
HXLINE(1060)		HX_VARI(  ::openfl::text::TextFormat,dtf) = this->textField->get_defaultTextFormat();
