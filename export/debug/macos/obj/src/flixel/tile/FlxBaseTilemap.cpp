...
HXLINE( 822)		HX_VARI( int,end) = (tile + range);
HXLINE( 824)		HX_VARI( int,maxIndex) = this->_tileObjects->get_length();
...
HXLINE( 830)				_g = (_g + 1);
HXDLIN( 830)				HX_VARI( int,i) = (_g - 1);
HXLINE( 832)				HX_VARI(  ::Dynamic,tileData) = this->_tileObjects->__get(i);
...
HXLINE( 853)		HX_VARI( int,i) = 0;
HXLINE( 854)		HX_VARI( int,l) = this->_data->length;
HXLINE( 855)		HX_VARI( ::Array< int >,data) = ::Array_obj< int >::__new();
...
HXLINE( 921)
HXLINE( 922)		HX_VARI(  ::flixel::path::FlxTypedPathfinderData,data) = this->computePathData(startIndex,endIndex,diagonalPolicy,stopOnEnd);
...
HXLINE( 964)
HXLINE( 965)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(objectOrGroup);
...
bool FlxBaseTilemap_obj::overlapsAt(Float x,Float y, ::flixel::FlxBasic objectOrGroup,::hx::Null< bool >  __o_inScreenSpace, ::flixel::FlxCamera camera){
            	...
            	HX_STACK_ARG(camera,"camera")
HXLINE(1003)
HXLINE(1004)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(objectOrGroup);
...
HXLINE(1052)
HXLINE(1053)		HX_VARI( int,tileIndex) = this->getTileIndexByCoords(point);
