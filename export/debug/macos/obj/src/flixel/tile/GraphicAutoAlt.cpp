...
HX_LOCAL_STACK_FRAME(_hx_pos_a636967d4712257f_102_boot,"flixel.tile.GraphicAutoAlt","boot",0x108b01e0,"flixel.tile.GraphicAutoAlt.boot","flixel/tile/FlxTilemap.hx",102,0x448feb74)
namespace flixel{
namespace tile{
...
{
{
            	HX_STACKFRAME(&_hx_pos_a636967d4712257f_102_boot)
HXDLIN( 102)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAutoAlt",c6,25,2e,70);
            	}
}
