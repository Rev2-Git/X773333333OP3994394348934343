...
HX_LOCAL_STACK_FRAME(_hx_pos_4cc2402574bdb662_105_boot,"flixel.tile.GraphicAutoFull","boot",0x0e9a6708,"flixel.tile.GraphicAutoFull.boot","flixel/tile/FlxTilemap.hx",105,0x448feb74)
namespace flixel{
namespace tile{
...
{
{
            	HX_STACKFRAME(&_hx_pos_4cc2402574bdb662_105_boot)
HXDLIN( 105)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAutoFull",52,c6,87,bb);
            	}
}
