...
HXDLIN( 356)			HX_VARI_NAME( ::String,emptyKey5,"emptyKey") = (emptyKey + (emptyKey4 + ::StringTools_obj::hex((empty & 255),2)));
...
HXLINE( 362)				HX_VARI(  ::openfl::display::BitmapData,emptyBar) = null();
...
HXDLIN( 409)			HX_VARI_NAME( ::String,filledKey5,"filledKey") = (filledKey + (filledKey4 + ::StringTools_obj::hex((fill & 255),2)));
...
HXLINE( 415)				HX_VARI(  ::openfl::display::BitmapData,filledBar) = null();
...
HXLINE( 485)			HX_VARI( ::String,emptyKey) = ((((HX_("Gradient:",2a,58,e6,6e) + this->barWidth) + HX_("x",78,00,00,00)) + this->barHeight) + HX_(",colors:[",bd,d0,85,cb));
HXLINE( 486)			{
HXLINE( 486)				int _g = 0;
HXDLIN( 486)				while((_g < empty->length)){
HXLINE( 486)					HX_VARI( int,col) = empty->__get(_g);
HXDLIN( 486)					_g = (_g + 1);
...
HXLINE( 499)				HX_VARI(  ::openfl::display::BitmapData,emptyBar) = null();
...
HXLINE( 550)			HX_VARI( ::String,filledKey) = ((((HX_("Gradient:",2a,58,e6,6e) + this->barWidth) + HX_("x",78,00,00,00)) + this->barHeight) + HX_(",colors:[",bd,d0,85,cb));
HXLINE( 551)			{
HXLINE( 551)				int _g = 0;
HXDLIN( 551)				while((_g < fill->length)){
HXLINE( 551)					HX_VARI( int,col) = fill->__get(_g);
HXDLIN( 551)					_g = (_g + 1);
...
HXLINE( 564)				HX_VARI(  ::openfl::display::BitmapData,filledBar) = null();
...
HXLINE( 631)			HX_VARI(  ::flixel::graphics::FlxGraphic,emptyGraphic) = ::flixel::FlxG_obj::bitmap->add(empty,null(),null());
...
HXLINE( 673)			HX_VARI(  ::flixel::graphics::FlxGraphic,filledGraphic) = ::flixel::FlxG_obj::bitmap->add(fill,null(),null());
...
HXDLIN( 753)		HX_VARI_NAME( Float,fraction1,"fraction") = ((fraction - this->min) / this->range);
HXLINE( 754)		HX_VARI( Float,percent) = (fraction1 * ( (Float)(this->_maxPercent) ));
HXLINE( 755)		HX_VAR( Float,maxScale);
...
HXLINE( 756)		HX_VARI( Float,scaleInterval) = (maxScale / ( (Float)(this->numDivisions) ));
HXLINE( 757)		HX_VARI( Float,interval) = ( (Float)(::Math_obj::round((( (Float)(::Std_obj::_hx_int(((fraction1 * maxScale) / scaleInterval))) ) * scaleInterval))) );
...
HXLINE( 854)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 854)				_g = (_g + 1);
...
HXLINE( 876)					 ::flixel::math::FlxBasePoint this3 = this->_point;
HXDLIN( 876)					this3->set_x(( (Float)(::Math_obj::floor(this3->x)) ));
HXDLIN( 876)					this3->set_y(( (Float)(::Math_obj::floor(this3->y)) ));
            				}
