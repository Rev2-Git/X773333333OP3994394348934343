...
HXLINE(  29)				HX_VARI(  ::flixel::math::FlxBasePoint,point) = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN(  29)				_g = (_g + 1);
HXLINE(  30)				{
...
HXLINE(  49)			HX_VARI(  ::flixel::text::FlxText,text) =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,this->frameWidth,Text,null(),null());
...
HXLINE(  53)			HX_VARI(  ::openfl::display::BitmapData,labelBitmap) = text->graphic->bitmap->clone();
HXLINE(  54)			HX_VARI( ::String,labelKey) = text->graphic->key;
...
HXLINE(  60)			HX_VARI(  ::flixel::graphics::FlxGraphic,labelGraphic) = ::flixel::FlxG_obj::bitmap->add(labelBitmap,false,labelKey);
