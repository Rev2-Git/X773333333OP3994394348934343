...
HXLINE(  97)			HX_VARI(  ::openfl::display::BitmapData,testA2) = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->height),true,0,false);
...
HXLINE( 110)			HX_VARI(  ::openfl::display::BitmapData,testB2) = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->height),true,0,false);
...
HXLINE( 126)		HX_VARI(  ::openfl::utils::ByteArrayData,pixelsA) = testA->getPixels(::flixel::util::FlxCollision_obj::flashRect);
HXLINE( 128)		{
...
HXLINE( 129)		HX_VARI(  ::openfl::utils::ByteArrayData,pixelsB) = testB->getPixels(::flixel::util::FlxCollision_obj::flashRect);
HXLINE( 131)		HX_VARI( bool,hit) = false;
HXLINE( 134)		HX_VARI( int,alphaA) = 0;
HXLINE( 135)		HX_VARI( int,alphaB) = 0;
HXLINE( 136)		HX_VARI( int,overlapPixels) = (overlapWidth * overlapHeight);
HXLINE( 137)		HX_VARI( int,alphaIdx) = 0;
HXLINE( 140)		{
HXLINE( 140)			int _g = 0;
HXDLIN( 140)			int _g1 = ::Math_obj::ceil((( (Float)(overlapPixels) ) / ( (Float)(2) )));
HXDLIN( 140)			while((_g < _g1)){
HXLINE( 140)				_g = (_g + 1);
HXDLIN( 140)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 157)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXLINE( 204)		HX_VARI(  ::openfl::display::BitmapData,test) = Target->framePixels;
HXLINE( 206)		HX_VARI( int,pixelAlpha) = ((::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(test->getPixel32(::Math_obj::floor((( (Float)(PointX) ) - Target->x)),::Math_obj::floor((( (Float)(PointY) ) - Target->y)))) >> 24) & 255);
...
HXLINE( 227)
HXLINE( 228)		HX_VARI(  ::flixel::tile::FlxTileblock,left) = null();
HXLINE( 229)		HX_VARI(  ::flixel::tile::FlxTileblock,right) = null();
HXLINE( 230)		HX_VARI(  ::flixel::tile::FlxTileblock,top) = null();
HXLINE( 231)		HX_VARI(  ::flixel::tile::FlxTileblock,bottom) = null();
...
HXLINE( 259)		HX_VARI(  ::flixel::group::FlxTypedGroup,result) =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
...
HXLINE( 286)
HXDLIN( 286)		HX_VARI_NAME( ::Array< ::Dynamic>,result1,"result") = ::Array_obj< ::Dynamic>::__new(1)->init(0,result);
HXLINE( 298)		HX_VARI(  ::Dynamic,getResult) =  ::Dynamic(new _hx_Closure_0(rect,start,end,result1));
HXLINE( 309)		HX_VARI(  ::Dynamic,nullResult) =  ::Dynamic(new _hx_Closure_1(rect,start,end));
...
HXLINE( 339)		HX_VARI( Float,m) = ((start->y - end->y) / (start->x - end->x));
HXLINE( 341)		HX_VARI( Float,b) = (start->y - (m * start->x));
HXLINE( 343)		HX_VARI( Float,leftY) = ((m * rect->x) + b);
HXLINE( 344)		HX_VARI( Float,rightY) = ((m * (rect->x + rect->width)) + b);
