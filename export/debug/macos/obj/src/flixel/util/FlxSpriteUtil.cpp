...
HXLINE(  57)
HXLINE(  58)		HX_VARI(  ::openfl::display::BitmapData,data) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(source);
HXLINE(  59)		HX_VARI(  ::openfl::display::BitmapData,maskData) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(mask);
...
HXLINE(  88)		HX_VARI(  ::openfl::display::BitmapData,data) = sprite->get_pixels()->clone();
...
HXLINE( 172)		HX_VARI(  ::flixel::math::FlxRect,spriteBounds) = sprite->getScreenBounds(null(),camera);
...
HXDLIN( 173)		HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point;
...
HXLINE( 184)			sprite->set_y(((camera->scroll->x + (( (Float)(camera->height) ) - camera->viewMarginY)) + offset->y));
            		}
            		else {
HXLINE( 185)			bool _hx_tmp3;
HXDLIN( 185)			int dir3 = 4096;
HXDLIN( 185)			if (((edges & dir3) == dir3)) {
HXLINE( 185)				_hx_tmp3 = (spriteBounds->y > (camera->scroll->x + (( (Float)(camera->height) ) - camera->viewMarginY)));
            			}
            			else {
...
HXLINE( 208)		HX_VARI(  ::flixel::math::FlxRect,spriteBounds) = sprite->getScreenBounds(null(),camera);
...
HXDLIN( 209)		HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point;
...
HXLINE( 221)				_hx_tmp3 = ((spriteBounds->y + spriteBounds->height) > (camera->scroll->x + (( (Float)(camera->height) ) - camera->viewMarginY)));
            			}
            			else {
HXLINE( 221)				_hx_tmp3 = false;
            			}
HXDLIN( 221)			if (_hx_tmp3) {
HXLINE( 222)				sprite->set_y((((camera->scroll->x + (( (Float)(camera->height) ) - camera->viewMarginY)) + offset->y) - spriteBounds->height));
            			}
            		}
...
HXLINE( 243)
HXLINE( 244)		HX_VARI( Float,prevWidth) = ( (Float)(0) );
HXLINE( 245)		HX_VARI( Float,runningX) = ( (Float)(0) );
...
HXLINE( 260)		HX_VARI( Float,prevHeight) = ( (Float)(0) );
HXLINE( 261)		HX_VARI( Float,runningY) = ( (Float)(0) );
...
HXLINE( 286)		HX_VARI( Float,curX) = ( (Float)(0) );
HXLINE( 287)		HX_VARI( Float,curY) = ( (Float)(0) );
HXLINE( 289)		{
HXLINE( 289)			int _g = 1;
...
HXLINE( 291)				HX_VARI(  ::flixel::FlxObject,object) = objects->__get(i).StaticCast<  ::flixel::FlxObject >();
...
HXLINE( 473)			HX_VARI(  ::flixel::math::FlxBasePoint,midPoint) = sprite->getGraphicMidpoint(null());
HXLINE( 475)			if ((X == -1)) {
...
HXLINE( 485)			HX_VARI( Float,minVal) = ::Math_obj::min(( (Float)(sprite->frameWidth) ),( (Float)(sprite->frameHeight) ));
...
HXLINE( 555)		HX_VARI(  ::flixel::math::FlxBasePoint,p) = Vertices->shift().StaticCast<  ::flixel::math::FlxBasePoint >();
HXLINE( 556)		::flixel::util::FlxSpriteUtil_obj::flashGfx->moveTo(p->x,p->y);
HXLINE( 557)		{
HXLINE( 557)			int _g = 0;
HXDLIN( 557)			while((_g < Vertices->length)){
HXLINE( 557)				HX_VARI_NAME(  ::flixel::math::FlxBasePoint,p1,"p") = Vertices->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 557)				_g = (_g + 1);
...
HXLINE( 633)			HX_VAR(  ::Dynamic,color);
