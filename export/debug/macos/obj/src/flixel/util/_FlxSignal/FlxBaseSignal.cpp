...
HXLINE( 162)
HXLINE( 163)		HX_VARI(  ::flixel::util::_FlxSignal::FlxSignalHandler,handler) = this->getHandler(listener);
...
HXLINE( 184)				HX_VARI(  ::flixel::util::_FlxSignal::FlxSignalHandler,handler) = _g1->__get(_g).StaticCast<  ::flixel::util::_FlxSignal::FlxSignalHandler >();
HXDLIN( 184)				_g = (_g + 1);
