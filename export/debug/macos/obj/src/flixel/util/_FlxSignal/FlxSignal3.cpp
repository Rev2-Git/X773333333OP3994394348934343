...
HXLINE( 284)				HX_VARI(  ::flixel::util::_FlxSignal::FlxSignalHandler,handler) = _g1->__get(_g).StaticCast<  ::flixel::util::_FlxSignal::FlxSignalHandler >();
HXDLIN( 284)				_g = (_g + 1);
...
HXLINE( 294)				HX_VARI_NAME(  ::flixel::util::_FlxSignal::FlxSignalHandler,handler1,"handler") = _g3->__get(_g2).StaticCast<  ::flixel::util::_FlxSignal::FlxSignalHandler >();
