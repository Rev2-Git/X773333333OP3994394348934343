...
HX_LOCAL_STACK_FRAME(_hx_pos_8577865ab46301b9_92_copy,"haxe.ds.StringMap","copy",0x1b20f48f,"haxe.ds.StringMap.copy","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/StringMap.hx",92,0x61d6228c)
...
HX_DEFINE_DYNAMIC_FUNC0(StringMap_obj,keyValueIterator,return )
 ...
 ::haxe::ds::StringMap StringMap_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_8577865ab46301b9_92_copy)
            	HX_STACK_THIS(this)
HXLINE(  92)
HXLINE(  93)		HX_VARI(  ::haxe::ds::StringMap,copied) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  94)		{
HXLINE(  94)			HX_VARI(  ::Dynamic,key) = this->keys();
HXDLIN(  94)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  94)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
