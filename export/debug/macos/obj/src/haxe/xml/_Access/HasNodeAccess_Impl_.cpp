...
HX_LOCAL_STACK_FRAME(_hx_pos_1ee2561b0f1113d4_69_resolve,"haxe.xml._Access.HasNodeAccess_Impl_","resolve",0x5a406854,"haxe.xml._Access.HasNodeAccess_Impl_.resolve","/usr/local/lib/haxe/std/haxe/xml/Access.hx",69,0xb9954a16)
namespace haxe{
namespace xml{
namespace _Access{
...
bool HasNodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_1ee2561b0f1113d4_69_resolve)
