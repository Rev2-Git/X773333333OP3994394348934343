...
HX_LOCAL_STACK_FRAME(_hx_pos_f799e4d0ad84cb3b_27_resolve,"haxe.xml._Access.NodeAccess_Impl_","resolve",0xc66a9d2e,"haxe.xml._Access.NodeAccess_Impl_.resolve","/usr/local/lib/haxe/std/haxe/xml/Access.hx",27,0xb9954a16)
namespace haxe{
namespace xml{
namespace _Access{
...
bool NodeAccess_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Xml NodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_f799e4d0ad84cb3b_27_resolve)
            	HX_STACK_ARG(name,"name")
HXLINE(  27)
HXLINE(  28)		HX_VARI(  ::Xml,x) = ( ( ::Xml)(this1->elementsNamed(name)->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  29)		if (::hx::IsNull( x )) {
HXLINE(  30)			HX_VAR( ::String,xname);
