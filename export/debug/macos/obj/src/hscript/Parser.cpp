...
HXDLIN( 280)				HX_VARI_NAME(  ::Dynamic,e1,"e") = _g->_hx_getObject(2);
...
HXDLIN( 282)				HX_VARI_NAME(  ::Dynamic,e2,"e") = _g->_hx_getObject(2);
...
HXDLIN( 283)				HX_VARI_NAME(  ::Dynamic,e3,"e") = _g->_hx_getObject(2);
...
HXDLIN( 281)				HX_VARI_NAME(  ::Dynamic,e11,"e1") = _g->_hx_getObject(1);
HXDLIN( 281)				HX_VARI_NAME(  ::Dynamic,e21,"e2") = _g->_hx_getObject(2);
...
HXDLIN( 284)				HX_VARI_NAME(  ::Dynamic,e4,"e") = _g->_hx_getObject(1);
...
HXDLIN( 286)				HX_VARI_NAME(  ::Dynamic,e5,"e") = _g->_hx_getObject(2);
...
HXDLIN( 279)				HX_VARI_NAME(  ::Dynamic,e6,"e") = _g->_hx_getObject(1);
HXDLIN( 279)				return this->isBlock(e6);
            			}
            			break;
            			case (int)15: {
HXLINE( 287)				HX_VARI_NAME(  ::Dynamic,e7,"e") = _g->_hx_getObject(0);
...
HXDLIN( 288)				HX_VARI_NAME(  ::Dynamic,e8,"e") = _g->_hx_getObject(3);
...
HXDLIN( 285)				HX_VARI_NAME(  ::Dynamic,e9,"e") = _g->_hx_getObject(1);
...
HXDLIN( 289)				HX_VARI_NAME(  ::Dynamic,e10,"e") = _g->_hx_getObject(2);
...
HXLINE( 294)
HXLINE( 295)		HX_VARI(  ::Dynamic,e) = this->parseExpr();
...
HXLINE( 352)		HX_VARI( int,p1) = this->tokenMin;
...
HXLINE( 356)				HX_VARI_NAME(  ::Dynamic,e1,"e") = this->parseStructure(id);
...
HXLINE( 441)					HX_VARI( int,start) = this->tokenMin;
HXLINE( 442)					HX_VARI_NAME(  ::Dynamic,e3,"e") = this->parseExpr();
...
HXLINE( 366)					HX_VARI(  ::Dynamic,eret) = this->parseExpr();
...
HXLINE( 370)				HX_VARI_NAME(  ::Dynamic,e9,"e") = this->parseExpr();
...
HXDLIN( 471)							HX_VAR_NAME(  ::Dynamic,e22,"e");
...
HXDLIN( 471)							HX_VAR_NAME(  ::Dynamic,e31,"e");
...
HXDLIN( 471)							HX_VAR_NAME(  ::Dynamic,e40,"e");
...
HXLINE( 504)		HX_VARI(  ::Dynamic,eret) = this->parseExpr();
...
HXLINE( 543)					HX_VARI_NAME(  ::Dynamic,e1,"e") = _g1->__get(0);
...
HXLINE( 534)					edef = ::hscript::ExprDef_obj::ECall(edef1,::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)9: {
HXLINE( 541)				HX_VARI(  ::Dynamic,cond) = _g->_hx_getObject(0);
HXDLIN( 541)				HX_VARI_NAME(  ::Dynamic,e11,"e1") = _g->_hx_getObject(1);
HXDLIN( 541)				HX_VARI_NAME(  ::Dynamic,e21,"e2") = _g->_hx_getObject(2);
...
HXLINE( 534)					edef = ::hscript::ExprDef_obj::ECall(edef2,::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)10: {
HXLINE( 537)				HX_VARI_NAME(  ::Dynamic,cond1,"cond") = _g->_hx_getObject(0);
HXDLIN( 537)				HX_VARI_NAME(  ::Dynamic,e22,"e2") = _g->_hx_getObject(1);
HXLINE( 534)				edef = ::hscript::ExprDef_obj::EWhile(cond1,this->mapCompr(tmp,e22));
            			}
            			break;
            			case (int)11: {
HXLINE( 535)				HX_VARI( ::String,v) = _g->_hx_getString(0);
HXDLIN( 535)				HX_VARI(  ::Dynamic,it) = _g->_hx_getObject(1);
HXDLIN( 535)				HX_VARI_NAME(  ::Dynamic,e23,"e2") = _g->_hx_getObject(2);
HXLINE( 534)				edef = ::hscript::ExprDef_obj::EFor(v,it,this->mapCompr(tmp,e23));
            			}
            			break;
            			case (int)24: {
HXLINE( 539)				HX_VARI_NAME(  ::Dynamic,cond2,"cond") = _g->_hx_getObject(0);
HXDLIN( 539)				HX_VARI_NAME(  ::Dynamic,e24,"e2") = _g->_hx_getObject(1);
...
HXDLIN( 557)				HX_VARI(  ::Dynamic,e1) = _g->_hx_getObject(1);
HXDLIN( 557)				HX_VARI(  ::Dynamic,e2) = _g->_hx_getObject(2);
...
HXDLIN( 557)					return  ::Dynamic(::hx::Anon_obj::Create(5)
            			...
            			break;
            			case (int)22: {
HXLINE( 558)				HX_VARI_NAME(  ::Dynamic,e11,"e1") = _g->_hx_getObject(0);
HXDLIN( 558)				HX_VARI_NAME(  ::Dynamic,e21,"e2") = _g->_hx_getObject(1);
HXDLIN( 558)				HX_VARI_NAME(  ::Dynamic,e31,"e3") = _g->_hx_getObject(2);
...
HXDLIN( 567)				HX_VARI_NAME(  ::Dynamic,e21,"e2") = _g->_hx_getObject(1);
HXDLIN( 567)				HX_VARI(  ::Dynamic,e3) = _g->_hx_getObject(2);
...
HXDLIN( 571)						return  ::Dynamic(::hx::Anon_obj::Create(5)
            			...
            			break;
            			case (int)22: {
HXLINE( 572)				HX_VARI_NAME(  ::Dynamic,e22,"e2") = _g->_hx_getObject(0);
HXDLIN( 572)				HX_VARI_NAME(  ::Dynamic,e31,"e3") = _g->_hx_getObject(1);
HXDLIN( 572)				HX_VARI_NAME(  ::Dynamic,e41,"e4") = _g->_hx_getObject(2);
...
HX_DEFINE_DYNAMIC_FUNC3(Parser_obj,makeBinop,return )
 ...
 ::Dynamic Parser_obj::parseStructure(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 582)
HXLINE( 584)		HX_VARI( int,p1) = this->tokenMin;
...
HXLINE( 625)			HX_VARI_NAME(  ::Dynamic,e2,"e") = this->parseExpr();
...
HXLINE( 632)			HX_VARI(  ::Dynamic,econd) = this->parseExpr();
...
HXLINE( 638)			HX_VARI(  ::Dynamic,eiter) = this->parseExpr();
HXLINE( 639)			{
...
HXLINE( 640)			HX_VARI_NAME(  ::Dynamic,e4,"e") = this->parseExpr();
...
HXLINE( 589)			HX_VARI(  ::Dynamic,cond) = this->parseExpr();
HXLINE( 590)			{
...
HXLINE( 591)			HX_VARI_NAME(  ::Dynamic,e11,"e1") = this->parseExpr();
HXLINE( 592)			HX_VARI_NAME(  ::Dynamic,e21,"e2") = null();
...
HXLINE( 660)			HX_VAR_NAME(  ::Dynamic,e10,"e");
...
HXLINE( 697)			HX_VARI_NAME(  ::Dynamic,e13,"e") = this->parseExpr();
HXLINE( 698)			HX_VARI(  ::Dynamic,def) = null();
...
HXLINE( 707)								HX_VARI_NAME(  ::Dynamic,e14,"e") = this->parseExpr();
...
HXLINE( 680)			HX_VARI_NAME(  ::Dynamic,e25,"e") = this->parseExpr();
...
HXLINE( 683)			HX_VARI_NAME(  ::Dynamic,e27,"e") = this->parseExpr();
HXLINE( 684)			{
...
HXLINE( 694)			HX_VARI(  ::Dynamic,ec) = this->parseExpr();
...
HXLINE( 614)			HX_VARI_NAME(  ::Dynamic,e29,"e") = null();
...
HXLINE( 621)			HX_VARI_NAME(  ::Dynamic,econd1,"econd") = this->parseExpr();
HXLINE( 622)			HX_VARI_NAME(  ::Dynamic,e31,"e") = this->parseExpr();
...
HXDLIN( 781)						switch((int)(_g->_hx_getIndex())){
            							case (int)1: {
HXLINE( 782)								HX_VARI( ::String,i) = _g->_hx_getString(0);
HXLINE( 783)								HX_VARI(  ::Dynamic,eret) = this->parseExpr();
...
HXLINE( 783)									HX_VARI_NAME(  ::Dynamic,eret1,"eret") = this->parseExpr();
...
HXDLIN( 785)									HX_VARI(  ::hscript::CType,t) = _g->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXLINE( 786)									HX_VARI_NAME(  ::Dynamic,eret2,"eret") = this->parseExpr();
...
HXDLIN( 803)				return this->parseExprNext(_hx_tmp5);
            			...
            			break;
            			case (int)11: {
HXLINE( 807)				HX_VARI_NAME(  ::Dynamic,e21,"e2") = this->parseExpr();
HXLINE( 808)				{
...
HXDLIN( 809)				return this->parseExprNext(_hx_tmp6);
            			...
            			break;
            			case (int)13: {
HXLINE( 811)				HX_VARI_NAME(  ::Dynamic,e22,"e2") = this->parseExpr();
HXLINE( 812)				{
...
HXLINE( 813)				HX_VARI_NAME(  ::Dynamic,e31,"e3") = this->parseExpr();
...
HXLINE( 947)									HX_VARI(  ::Dynamic,arg) = _g3->__get(_g2);
...
HXLINE( 950)											HX_VARI_NAME(  ::Dynamic,v1,"v") = _g4;
...
HXLINE( 947)							HX_VARI( ::Array< ::Dynamic>,args) = _g1;
...
HXLINE( 972)									return this->parseTypeNext(::hscript::CType_obj::CTParent(t1));
            								...
            								break;
            								case (int)9: {
HXLINE( 963)									HX_VARI_NAME( ::Array< ::Dynamic>,args1,"args") = ::Array_obj< ::Dynamic>::__new(1)->init(0,t1);
HXLINE( 965)									do {
...
HXLINE( 970)									return withReturn(args1);
            								...
            								break;
            								default:{
HXLINE( 973)									HX_VARI_NAME(  ::hscript::Token,t3,"t") = _g5;
...
HXLINE( 947)								HX_VARI_NAME(  ::Dynamic,arg1,"arg") = _g8->__get(_g7);
...
HXLINE( 950)										HX_VARI_NAME(  ::Dynamic,v2,"v") = _g9;
HXLINE( 951)										if (!(this->resumeErrors)) {
...
HXLINE( 947)						HX_VARI_NAME( ::Array< ::Dynamic>,args2,"args") = _g6;
HXLINE( 957)						return withReturn(args2);
            					}
            					break;
            					default:{
HXLINE( 960)						HX_VARI_NAME(  ::hscript::CType,t4,"t") = this->parseType();
...
HXLINE( 972)								return this->parseTypeNext(::hscript::CType_obj::CTParent(t4));
            							...
            							break;
            							case (int)9: {
HXLINE( 963)								HX_VARI_NAME( ::Array< ::Dynamic>,args3,"args") = ::Array_obj< ::Dynamic>::__new(1)->init(0,t4);
HXLINE( 965)								do {
...
HXLINE( 970)								return withReturn(args3);
            							...
            							break;
            							default:{
HXLINE( 973)								HX_VARI_NAME(  ::hscript::Token,t6,"t") = _g10;
...
HXLINE( 989)								HX_VARI_NAME( ::String,name1,"name") = _g11;
HXDLIN( 989)								{
HXLINE( 990)									{
...
HXLINE(1227)				HX_VAR(  ::Dynamic,expr);
...
HXLINE(1271)		HX_VARI( int,p1) = (this->readPos - 1);
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,readString,return )
 ...
 ::hscript::Token Parser_obj::token(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1324)
HXLINE(1326)		HX_VARI(  ::Dynamic,t) = this->tokens->pop();
...
HXLINE(1335)		HX_VARI_NAME(  ::hscript::Token,t1,"t") = this->_token();
...
HXDLIN(1586)		switch((int)(_g->_hx_getIndex())){
            			case (int)1: {
HXLINE(1587)				HX_VARI( ::String,id) = _g->_hx_getString(0);
HXLINE(1588)				return ::hx::IsNotNull( this->preprocValue(id) );
            			}
            			break;
            			case (int)3: {
HXLINE(1591)				HX_VARI_NAME(  ::Dynamic,e1,"e") = _g->_hx_getObject(0);
...
HXLINE(1593)					HX_VARI_NAME(  ::Dynamic,e11,"e1") = _g1;
HXDLIN(1593)					HX_VARI(  ::Dynamic,e2) = _g2;
...
HXLINE(1595)					HX_VARI_NAME(  ::Dynamic,e12,"e1") = _g1;
HXDLIN(1595)					HX_VARI_NAME(  ::Dynamic,e21,"e2") = _g2;
...
HXLINE(1589)					HX_VARI_NAME(  ::Dynamic,e3,"e") = _g->_hx_getObject(2);
...
HXLINE(1628)			goto _hx_goto_107;
            		...
            		if (  (_hx_switch_0==HX_("if",dd,5b,00,00)) ){
HXLINE(1606)			HX_VARI(  ::Dynamic,e) = this->parsePreproCond();
