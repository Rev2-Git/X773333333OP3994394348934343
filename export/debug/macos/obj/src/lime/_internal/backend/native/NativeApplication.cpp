...
HXDLIN( 359)			HX_VARI(  ::lime::ui::Window,window) = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 359)			_g = (_g + 1);
...
HXLINE( 386)							HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = window->context->gl;
...
void NativeApplication_obj::handleSensorEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 411)
HXLINE( 412)		HX_VARI(  ::lime::_hx_system::Sensor,sensor) = ( ( ::lime::_hx_system::Sensor)(::lime::_hx_system::Sensor_obj::sensorByID->get(this->sensorEventInfo->id)) );
...
void NativeApplication_obj::handleTextEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 421)
HXLINE( 422)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->textEventInfo->windowID)) );
...
HXDLIN( 442)		switch((int)(this->touchEventInfo->type)){
            			case (int)0: {
HXLINE( 445)				HX_VARI(  ::lime::ui::Touch,touch) = this->unusedTouchesPool->pop().StaticCast<  ::lime::ui::Touch >();
...
HXLINE( 465)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			...
            			break;
            			case (int)1: {
HXLINE( 468)				HX_VARI_NAME(  ::lime::ui::Touch,touch1,"touch") = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
...
HXLINE( 481)					this->unusedTouchesPool->add(touch1);
            			...
            			break;
            			case (int)2: {
HXLINE( 485)				HX_VARI_NAME(  ::lime::ui::Touch,touch2,"touch") = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
...
void NativeApplication_obj::handleWindowEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 503)
HXLINE( 504)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->windowEventInfo->windowID)) );
...
HXLINE( 573)			HX_VARI( int,currentTime) = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 574)			HX_VARI( bool,foundNull) = false;
HXLINE( 575)			HX_VAR(  ::haxe::Timer,timer);
HXLINE( 577)			{
HXLINE( 577)				int _g = 0;
HXDLIN( 577)				int _g1 = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 577)				while((_g < _g1)){
HXLINE( 577)					_g = (_g + 1);
HXDLIN( 577)					HX_VARI( int,i) = (_g - 1);
