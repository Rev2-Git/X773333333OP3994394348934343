...
HXDLIN( 217)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 217)				_this->copyFromArray(array,null());
HXDLIN( 217)				this1 = _this;
            			}
            			else {
HXLINE( 217)				if (::hx::IsNotNull( vector )) {
HXLINE( 217)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 217)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 217)					_this1->byteOffset = 0;
HXDLIN( 217)					_this1->length = array1->get_length();
HXDLIN( 217)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 217)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 217)					_this1->copyFromArray(array1,null());
HXDLIN( 217)					this1 = _this1;
            				}
            				else {
HXLINE( 217)					if (::hx::IsNotNull( view )) {
HXLINE( 217)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 217)						int elementSize = _this2->bytesPerElement;
HXDLIN( 217)						if ((view->type == _this2->type)) {
HXLINE( 217)							int srcLength1 = srcData->length;
HXDLIN( 217)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 217)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 217)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 217)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 217)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 217)						_this2->byteOffset = 0;
HXDLIN( 217)						_this2->length = srcLength;
HXDLIN( 217)						this1 = _this2;
            					}
            					else {
HXLINE( 217)						if (::hx::IsNotNull( buffer )) {
HXLINE( 217)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 217)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 217)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 217)							int bufferByteLength = buffer->length;
HXDLIN( 217)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 217)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 217)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 217)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 217)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 217)								if ((newRange > bufferByteLength)) {
HXLINE( 217)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 217)							_this3->buffer = buffer;
HXDLIN( 217)							_this3->byteOffset = in_byteOffset;
HXDLIN( 217)							_this3->byteLength = newByteLength;
HXDLIN( 217)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 217)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 217)		HX_VARI_NAME(  ::lime::utils::ArrayBufferView,buffer1,"buffer") = this1;
HXLINE( 218)		HX_VARI( int,read) = 0;
HXDLIN( 218)		HX_VARI( int,total) = 0;
HXDLIN( 218)		HX_VAR( int,readMax);
HXLINE( 220)		{
HXLINE( 220)			int _g = 0;
...
HXLINE( 254)
HXLINE( 256)		HX_VARI(  ::lime::media::vorbis::VorbisFile,vorbisFile) = null();
HXLINE( 257)		HX_VARI( int,position) = 0;
HXLINE( 259)		if (::hx::IsNull( buffers )) {
HXLINE( 261)			HX_VARI( int,buffersProcessed) = ( (int)(::lime::media::openal::AL_obj::getSourcei(this->handle,4118)) );
HXLINE( 263)			if ((buffersProcessed > 0)) {
HXLINE( 265)				vorbisFile = this->parent->buffer->_hx___srcVorbisFile;
HXLINE( 266)				::cpp::Int64 x = vorbisFile->pcmTell();
HXDLIN( 266)				int position1 = _hx_int64_high(x);
HXDLIN( 266)				if ((position1 != (_hx_int64_low(x) >> 31))) {
HXLINE( 266)					HX_STACK_DO_THROW(HX_("Overflow",62,9f,ed,1a));
            				}
...
HXLINE( 280)				::cpp::Int64 x1 = vorbisFile->pcmTell();
HXDLIN( 280)				int position2 = _hx_int64_high(x1);
HXDLIN( 280)				if ((position2 != (_hx_int64_low(x1) >> 31))) {
HXLINE( 280)					HX_STACK_DO_THROW(HX_("Overflow",62,9f,ed,1a));
            				}
HXDLIN( 280)				position = _hx_int64_low(x1);
            			}
HXLINE( 283)			HX_VARI( int,numBuffers) = 0;
HXLINE( 284)			HX_VAR(  ::lime::utils::ArrayBufferView,data);
HXLINE( 286)			{
HXLINE( 286)				int _g = 0;
HXDLIN( 286)				while((_g < buffers->get_length())){
HXLINE( 286)					HX_VARI(  ::Dynamic,buffer) = buffers->__get(_g);
HXDLIN( 286)					_g = (_g + 1);
...
HXDLIN( 376)					HX_VARI_NAME( int,time2,"time") = (time1 - this->parent->offset);
...
HXLINE( 382)					HX_VARI( int,offset) = ( (int)(::lime::media::openal::AL_obj::getSourcei(this->handle,4134)) );
HXLINE( 383)					HX_VARI( Float,ratio) = (( (Float)(offset) ) / ( (Float)(this->dataLength) ));
HXLINE( 384)					HX_VARI( Float,totalSeconds) = (( (Float)(this->samples) ) / ( (Float)(this->parent->buffer->sampleRate) ));
HXLINE( 386)					int time3 = ::Std_obj::_hx_int(((totalSeconds * ratio) * ( (Float)(1000) )));
HXDLIN( 386)					HX_VARI_NAME( int,time4,"time") = (time3 - this->parent->offset);
HXLINE( 389)					if ((time4 < 0)) {
HXLINE( 389)						return 0;
            					}
HXLINE( 390)					return time4;
            				}
            			}
            		}
HXLINE( 394)		return 0;
...
HXLINE( 423)					HX_VARI( Float,secondOffset) = (( (Float)((value + this->parent->offset)) ) / ( (Float)(1000) ));
HXLINE( 424)					HX_VARI( Float,totalSeconds) = (( (Float)(this->samples) ) / ( (Float)(this->parent->buffer->sampleRate) ));
...
HXLINE( 429)					HX_VARI( Float,ratio) = (secondOffset / totalSeconds);
HXLINE( 430)					HX_VARI( int,totalOffset) = ::Std_obj::_hx_int((( (Float)(this->dataLength) ) * ratio));
...
HXDLIN( 443)			HX_VARI_NAME( int,timeRemaining1,"timeRemaining") = ::Std_obj::_hx_int((( (Float)(timeRemaining) ) / this->getPitch()));
...
HXDLIN( 502)			HX_VARI_NAME( int,timeRemaining1,"timeRemaining") = ::Std_obj::_hx_int((( (Float)(timeRemaining) ) / this->getPitch()));
...
HXDLIN( 545)			HX_VARI_NAME( int,timeRemaining1,"timeRemaining") = ::Std_obj::_hx_int((( (Float)((timeRemaining - this->getCurrentTime())) ) / value));
...
HXLINE( 567)			HX_VARI( ::Array< Float >,value) = ::lime::media::openal::AL_obj::getSource3f(this->handle,4100);
