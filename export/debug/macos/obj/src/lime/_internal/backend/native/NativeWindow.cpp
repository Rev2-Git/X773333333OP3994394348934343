...
HXLINE( 325)
HXLINE( 326)		HX_VARI(  ::lime::graphics::ImageBuffer,imageBuffer) = null();
...
HXLINE( 331)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->parent->context->webgl;
HXLINE( 332)			HX_VARI( int,windowWidth) = ::Std_obj::_hx_int((( (Float)(this->parent->_hx___width) ) * this->parent->_hx___scale));
HXLINE( 333)			HX_VARI( int,windowHeight) = ::Std_obj::_hx_int((( (Float)(this->parent->_hx___height) ) * this->parent->_hx___scale));
HXLINE( 335)			HX_VAR( int,x);
HXDLIN( 335)			HX_VAR( int,y);
HXDLIN( 335)			HX_VAR( int,width);
HXDLIN( 335)			HX_VAR( int,height);
...
HXDLIN( 352)			HX_VARI(  ::lime::utils::ArrayBufferView,data) = this1;
HXLINE( 354)			{
...
HXLINE( 358)			HX_VARI( int,rowLength) = (width * 4);
HXLINE( 359)			HX_VARI( int,srcPosition) = ((height - 1) * rowLength);
HXLINE( 360)			HX_VARI( int,destPosition) = 0;
HXLINE( 362)			HX_VARI(  ::haxe::io::Bytes,temp) = ::haxe::io::Bytes_obj::alloc(rowLength);
HXLINE( 363)			HX_VARI_NAME(  ::haxe::io::Bytes,buffer1,"buffer") = data->buffer;
HXLINE( 364)			HX_VARI( int,rows) = ::Std_obj::_hx_int((( (Float)(height) ) / ( (Float)(2) )));
...
HXLINE( 415)			HX_VARI(  ::Dynamic,lock) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_context_lock(::hx::DynamicPtr(this->handle))) );
...
HXLINE( 511)			HX_VARI(  ::Dynamic,data) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_set_display_mode(::hx::DynamicPtr(this->handle),::hx::DynamicPtr(value))) );
