...
bool Image_obj::_hx___fromBytes( ::haxe::io::Bytes bytes, ::Dynamic onload){
            	...
            	HX_STACK_ARG(onload,"onload")
HXLINE(1474)
HXLINE(1499)		HX_VARI(  ::lime::graphics::ImageBuffer,imageBuffer) = null();
...
HXDLIN(1502)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
...
HXDLIN(1502)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
...
HXLINE(1531)
HXLINE(1620)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = null();
...
HXDLIN(1628)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
...
HXDLIN(1628)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
...
HXDLIN(1628)								_this3->buffer = buffer2;
...
HXLINE(1796)			HX_VARI( int,newWidth) = 1;
HXLINE(1797)			HX_VARI( int,newHeight) = 1;
...
HXLINE(1053)		HX_VARI(  ::lime::net::_HTTPRequest_lime_graphics_Image,request) =  ::lime::net::_HTTPRequest_lime_graphics_Image_obj::__alloc( HX_CTX ,null());
...
HXLINE(1714)		HX_VARI( ::String,header) = bytes->getString(0,6,null());
