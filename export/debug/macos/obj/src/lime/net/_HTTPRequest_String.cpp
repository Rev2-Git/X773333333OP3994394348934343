...
HXLINE( 139)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 140)		HX_VARI(  ::lime::app::Future,future) = this->_hx___backend->loadText(this->uri);
