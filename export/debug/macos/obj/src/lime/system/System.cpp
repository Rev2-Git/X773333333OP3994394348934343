...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(System_obj,exit,(void))
 ...
 ::lime::_hx_system::Display System_obj::getDisplay(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 165)
HXLINE( 167)		HX_VARI(  ::Dynamic,displayInfo) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_system_get_display(id)) );
HXLINE( 169)		if (::hx::IsNotNull( displayInfo )) {
HXLINE( 171)			HX_VARI(  ::lime::_hx_system::Display,display) =  ::lime::_hx_system::Display_obj::__alloc( HX_CTX );
...
HXLINE( 200)			HX_VAR(  ::lime::_hx_system::DisplayMode,displayMode);
HXLINE( 205)			HX_VARI( ::cpp::VirtualArray,supportedModes) = ( (::cpp::VirtualArray)(displayInfo->__Field(HX_("supportedModes",a2,a6,b8,b7),::hx::paccDynamic)) );
HXLINE( 207)			{
HXLINE( 207)				int _g = 0;
HXDLIN( 207)				while((_g < supportedModes->get_length())){
HXLINE( 207)					HX_VARI(  ::Dynamic,mode) = supportedModes->__get(_g);
HXDLIN( 207)					_g = (_g + 1);
...
HXLINE( 213)			HX_VARI_NAME(  ::Dynamic,mode1,"mode") = displayInfo->__Field(HX_("currentMode",3c,ac,f2,80),::hx::paccDynamic);
HXLINE( 214)			HX_VARI(  ::lime::_hx_system::DisplayMode,currentMode) =  ::lime::_hx_system::DisplayMode_obj::__alloc( HX_CTX ,( (int)(mode1->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("refreshRate",5b,e2,3f,40),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("pixelFormat",5d,72,1b,6f),::hx::paccDynamic)) ));
HXLINE( 216)			{
HXLINE( 216)				int _g1 = 0;
HXDLIN( 216)				::Array< ::Dynamic> _g2 = display->supportedModes;
HXDLIN( 216)				while((_g1 < _g2->length)){
HXLINE( 216)					HX_VARI_NAME(  ::lime::_hx_system::DisplayMode,mode2,"mode") = _g2->__get(_g1).StaticCast<  ::lime::_hx_system::DisplayMode >();
...
HXLINE( 338)				HX_VARI( ::String,field) = _g1->__get(_g);
HXDLIN( 338)				_g = (_g + 1);
...
HXLINE( 356)			HX_VAR( ::String,path);
HXLINE( 358)			if ((type == 1)) {
HXLINE( 360)				HX_VARI( ::String,company) = HX_("MyCompany",11,c3,2e,cc);
HXLINE( 361)				HX_VARI( ::String,file) = HX_("MyApplication",24,d3,d1,1c);
...
HXLINE( 394)			HX_VARI( ::String,seperator) = HX_("/",2f,00,00,00);
...
HXLINE( 426)
HXLINE( 429)		HX_VARI( ::Array< ::String >,arguments) = ::Sys_obj::args();
HXLINE( 430)		HX_VARI(  ::EReg,stripQuotes) =  ::EReg_obj::__alloc( HX_CTX ,HX_("^['\"](.*)['\"]$",13,22,1b,37),HX_("",00,00,00,00));
HXLINE( 431)		HX_VAR( int,equals);
HXDLIN( 431)		HX_VAR( ::String,argValue);
HXDLIN( 431)		HX_VARI(  ::haxe::ds::StringMap,parameters) = null();
HXLINE( 432)		HX_VARI( ::String,windowParamPrefix) = HX_("--window-",dd,62,c2,0a);
HXLINE( 434)		if (::hx::IsNotNull( arguments )) {
HXLINE( 436)			int _g = 0;
HXDLIN( 436)			while((_g < arguments->length)){
HXLINE( 436)				HX_VARI( ::String,argument) = arguments->__get(_g);
HXDLIN( 436)				_g = (_g + 1);
...
HXLINE( 460)			{
HXLINE( 460)				HX_VARI(  ::Dynamic,parameter) = parameters->keys();
HXDLIN( 460)				while(( (bool)(parameter->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 460)					HX_VARI_NAME( ::String,parameter1,"parameter") = ( (::String)(parameter->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 546)			HX_VARI(  ::sys::io::Process,process) =  ::sys::io::Process_obj::__alloc( HX_CTX ,command,args,null());
HXLINE( 547)			HX_VARI( ::String,value) = ::StringTools_obj::trim(process->_hx_stdout->readLine().toString());
...
HXLINE( 683)			HX_VARI(  ::haxe::io::Bytes,arrayBuffer) = ::haxe::io::Bytes_obj::alloc(2);
...
HXDLIN( 684)			HX_VARI(  ::lime::utils::ArrayBufferView,uint8Array) = this1;
...
HXDLIN( 685)			HX_VARI(  ::lime::utils::ArrayBufferView,uint16array) = this2;
...
HXLINE( 730)			HX_VARI( ::String,name) = ::lime::_hx_system::System_obj::get_platformName();
HXLINE( 731)			HX_VARI( ::String,version) = ::lime::_hx_system::System_obj::get_platformVersion();
