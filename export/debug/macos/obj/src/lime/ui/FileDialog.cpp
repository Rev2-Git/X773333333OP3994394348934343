...
HXLINE( 123)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				...
            				break;
            				case (int)1: {
HXLINE( 130)					HX_VARI(  ::hx::Object *,paths) = ::hx::DynamicPtr(null());
...
HXLINE( 145)					worker->sendComplete(( ( ::Dynamic)(paths) ));
            				...
            				break;
            				case (int)2: {
HXLINE( 170)					HX_VARI_NAME(  ::hx::Object *,path1,"path") = ::hx::DynamicPtr(null());
HXLINE( 178)					path1 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title,filter,defaultPath);
HXLINE( 181)					worker->sendComplete(( ( ::Dynamic)(path1) ));
            				}
            				break;
            				case (int)3: {
HXLINE( 152)					HX_VARI_NAME(  ::hx::Object *,path2,"path") = ::hx::DynamicPtr(null());
HXLINE( 160)					path2 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_directory(title,filter,defaultPath);
...
HXLINE( 187)			switch((int)(type1->__get(0).StaticCast<  ::lime::ui::FileDialogType >()->_hx_getIndex())){
            				case (int)1: {
HXLINE( 208)					HX_VARI( ::Array< ::String >,paths) = ( (::Array< ::String >)(result) );
...
HXLINE( 190)					HX_VARI( ::String,path) = ( (::String)(result) );
...
bool FileDialog_obj::open(::String filter,::String defaultPath,::String title){
            		...
            		void _hx_run( ::Dynamic _){
            			...
            			HX_STACK_ARG(_,"_")
HXLINE( 247)
HXLINE( 252)			HX_VARI(  ::hx::Object *,path) = ::hx::DynamicPtr(null());
...
HXLINE( 269)					HX_VARI(  ::haxe::io::Bytes,data) = ::sys::io::File_obj::getBytes(path);
...
HXLINE( 244)		HX_VARI(  ::lime::_hx_system::BackgroundWorker,worker) =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
...
bool FileDialog_obj::save( ::haxe::io::Bytes data,::String filter,::String defaultPath,::String title,::String __o_type){
            		...
            		void _hx_run( ::Dynamic _){
            			...
            			HX_STACK_ARG(_,"_")
HXLINE( 315)
HXLINE( 320)			HX_VARI(  ::hx::Object *,path) = ::hx::DynamicPtr(null());
...
HXLINE( 312)		HX_VARI(  ::lime::_hx_system::BackgroundWorker,worker) =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
