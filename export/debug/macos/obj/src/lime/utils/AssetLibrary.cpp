...
HXLINE( 627)			HX_VAR(  ::Dynamic,size);
...
HXLINE( 635)				HX_VARI(  ::Dynamic,cache) = this->bytesLoadedCache->get(id);
...
HXLINE( 667)			HX_VAR( ::String,id);
HXDLIN( 667)			HX_VAR(  ::haxe::io::Bytes,data);
HXDLIN( 667)			HX_VAR( ::String,type);
HXLINE( 668)			{
HXLINE( 668)				int _g = 0;
HXDLIN( 668)				::cpp::VirtualArray _g1 = manifest->assets;
HXDLIN( 668)				while((_g < _g1->get_length())){
HXLINE( 668)					HX_VARI(  ::Dynamic,asset) = _g1->__get(_g);
HXDLIN( 668)					_g = (_g + 1);
...
HXLINE( 702)				HX_VARI( ::String,path) = _g3->__get(_g2);
...
void AssetLibrary_obj::_hx___fromManifest( ::lime::utils::AssetManifest manifest){
            	...
            	HX_STACK_ARG(manifest,"manifest")
HXLINE( 711)
HXLINE( 712)		HX_VARI( bool,hasSize) = (manifest->version >= 2);
HXLINE( 713)		HX_VAR( int,size);
HXDLIN( 713)		HX_VAR( ::String,id);
HXDLIN( 713)		HX_VAR( ::Array< ::String >,pathGroup);
HXDLIN( 713)		HX_VAR( ::hx::Class,classRef);
HXLINE( 715)		HX_VARI( ::String,basePath) = manifest->rootPath;
...
HXLINE( 719)				HX_VARI(  ::Dynamic,asset) = _g1->__get(_g);
HXDLIN( 719)				_g = (_g + 1);
...
HXDLIN( 733)							HX_VARI( int,i) = (_g2 - 1);
...
HXLINE( 766)				HX_VARI_NAME(  ::Dynamic,asset1,"asset") = _g5->__get(_g4);
...
HXLINE( 781)		HX_VARI( int,colonIdx) = path.indexOf(HX_(":",3a,00,00,00),null());
...
HXLINE( 784)			HX_VARI( int,lastSlashIdx) = (colonIdx + 3);
HXLINE( 785)			HX_VARI( ::String,httpSection) = path.substr(0,lastSlashIdx);
...
HXLINE( 802)			HX_VARI( ::Array< ::String >,split) = path.split(HX_("/",2f,00,00,00));
HXLINE( 803)			HX_VARI( ::Array< ::String >,newPath) = ::Array_obj< ::String >::__new(0);
HXLINE( 805)			{
HXLINE( 805)				int _g = 0;
HXDLIN( 805)				int _g1 = split->length;
HXDLIN( 805)				while((_g < _g1)){
HXLINE( 805)					_g = (_g + 1);
HXDLIN( 805)					HX_VARI( int,i) = (_g - 1);
...
HXLINE( 843)			HX_VARI( ::Array< ::String >,pathGroup) = ( (::Array< ::String >)(this->pathGroups->get(id)) );
HXLINE( 845)			{
HXLINE( 845)				HX_VARI(  ::Dynamic,otherID) = this->pathGroups->keys();
HXDLIN( 845)				while(( (bool)(otherID->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 845)					HX_VARI_NAME( ::String,otherID1,"otherID") = ( (::String)(otherID->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 849)							HX_VARI( ::String,path) = pathGroup->__get(_g);
HXDLIN( 849)							_g = (_g + 1);
...
HXLINE( 921)			HX_VARI(  ::Dynamic,size) = this->sizes->get(id);
HXLINE( 922)			HX_VAR( Float,percent);
...
HXLINE( 939)				HX_VARI(  ::Dynamic,cache) = this->bytesLoadedCache->get(id);
