...
HXDLIN( 278)			HX_VARI_NAME(  ::lime::graphics::ImageBuffer,buffer1,"buffer") =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,width,height,null(),null());
...
HXLINE( 351)		HX_VARI( bool,needSecondBitmapData) = filter->_hx___needSecondBitmapData;
HXLINE( 352)		HX_VARI( bool,needCopyOfOriginal) = filter->_hx___preserveObject;
HXLINE( 354)		HX_VARI(  ::openfl::display::BitmapData,bitmapData2) = null();
HXLINE( 355)		HX_VARI(  ::openfl::display::BitmapData,bitmapData3) = null();
...
HXLINE( 376)		HX_VARI(  ::openfl::display::BitmapData,lastBitmap) = filter->_hx___applyFilter(bitmapData2,::hx::ObjectPtr<OBJ_>(this),sourceRect,destPoint);
...
HX_DEFINE_DYNAMIC_FUNC4(BitmapData_obj,applyFilter,(void))
 ...
 ::openfl::display::BitmapData BitmapData_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 398)
HXLINE( 400)		HX_VAR(  ::openfl::display::BitmapData,bitmapData);
...
HXLINE( 489)			HX_VARI(  ::lime::utils::ArrayBufferView,bytes) = this->image->get_data();
HXLINE( 490)			HX_VARI(  ::lime::utils::ArrayBufferView,otherBytes) = otherBitmapData->image->get_data();
HXLINE( 491)			HX_VARI( bool,equal) = true;
HXLINE( 493)			{
HXLINE( 493)				int _g = 0;
...
HXLINE( 508)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) = null();
HXLINE( 509)		HX_VAR( bool,foundDifference);
HXDLIN( 509)		HX_VAR( int,pixel);
HXDLIN( 509)		HX_VAR( int,otherPixel);
HXDLIN( 509)		HX_VAR( int,comparePixel);
HXDLIN( 509)		HX_VAR( int,r);
HXDLIN( 509)		HX_VAR( int,g);
HXDLIN( 509)		HX_VAR( int,b);
HXDLIN( 509)		HX_VAR_NAME( int,a1,"a");
HXLINE( 518)		{
HXLINE( 518)			int _g2 = 0;
HXDLIN( 518)			int _g3 = this->height;
HXDLIN( 518)			while((_g2 < _g3)){
HXLINE( 518)				_g2 = (_g2 + 1);
HXDLIN( 518)				HX_VARI( int,y) = (_g2 - 1);
HXLINE( 520)				{
HXLINE( 520)					int _g4 = 0;
HXDLIN( 520)					int _g5 = this->width;
HXDLIN( 520)					while((_g4 < _g5)){
HXLINE( 520)						_g4 = (_g4 + 1);
HXDLIN( 520)						HX_VARI( int,x) = (_g4 - 1);
...
HXLINE( 634)		HX_VAR_NAME(  ::lime::graphics::ImageChannel,sourceChannel1,"sourceChannel");
...
HXLINE( 643)		HX_VAR_NAME(  ::lime::graphics::ImageChannel,destChannel1,"destChannel");
...
HXLINE( 871)		HX_VARI(  ::openfl::geom::Matrix,transform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE( 881)		HX_VARI(  ::openfl::geom::Matrix,clipMatrix) = null();
...
HXLINE( 890)		HX_VARI(  ::openfl::geom::ColorTransform,_colorTransform) =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 907)			HX_VARI(  ::openfl::display::OpenGLRenderer,renderer) =  ::openfl::display::OpenGLRenderer_obj::__alloc( HX_CTX ,::openfl::Lib_obj::get_current()->stage->context3D,::hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 935)				HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 936)				HX_VARI(  ::openfl::geom::Matrix,boundsMatrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 938)				::openfl::display::IBitmapDrawable_obj::_hx___getBounds(source,bounds,boundsMatrix);
HXLINE( 940)				HX_VARI( int,width) = ::Math_obj::ceil(bounds->width);
HXLINE( 941)				HX_VARI( int,height) = ::Math_obj::ceil(bounds->height);
HXLINE( 943)				boundsMatrix->tx = -(bounds->x);
HXLINE( 944)				boundsMatrix->ty = -(bounds->y);
HXLINE( 946)				HX_VARI(  ::openfl::display::BitmapData,copy) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,0);
...
HXLINE( 966)			HX_VARI_NAME(  ::openfl::display::CairoRenderer,renderer1,"renderer") =  ::openfl::display::CairoRenderer_obj::__alloc( HX_CTX , ::lime::graphics::cairo::Cairo_obj::__alloc( HX_CTX ,this->getSurface()));
...
HXLINE(1119)			byteArray =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0);
            		}
HXLINE(1121)		HX_VARI(  ::lime::graphics::Image,image) = this->image;
HXLINE(1123)		if (!(rect->equals(this->rect))) {
HXLINE(1125)			HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(1126)			matrix->tx = ( (Float)(::Math_obj::round(-(rect->x))) );
HXLINE(1127)			matrix->ty = ( (Float)(::Math_obj::round(-(rect->y))) );
HXLINE(1129)			HX_VARI(  ::openfl::display::BitmapData,bitmapData) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,::Math_obj::ceil(rect->width),::Math_obj::ceil(rect->height),true,0);
...
HXLINE(1369)
HXLINE(1370)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXLINE(1389)				HX_VARI( Float,centerX) = scale9Grid->width;
HXLINE(1390)				HX_VARI( Float,centerY) = scale9Grid->height;
...
HXDLIN(1393)					this->_hx___indexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,54,6);
HXLINE(1404)					{
HXLINE(1404)						 ::lime::utils::ArrayBufferView this1 = this->_hx___indexBufferData;
HXDLIN(1404)						 ::__hxcpp_memory_set_ui16(this1->buffer->b,this1->byteOffset,0);
            					}
HXLINE(1405)					{
HXLINE(1405)						 ::lime::utils::ArrayBufferView this2 = this->_hx___indexBufferData;
HXDLIN(1405)						 ::__hxcpp_memory_set_ui16(this2->buffer->b,(this2->byteOffset + 2),1);
            					}
HXLINE(1406)					{
HXLINE(1406)						 ::lime::utils::ArrayBufferView this3 = this->_hx___indexBufferData;
HXDLIN(1406)						 ::__hxcpp_memory_set_ui16(this3->buffer->b,(this3->byteOffset + 4),2);
            					}
HXLINE(1407)					{
HXLINE(1407)						 ::lime::utils::ArrayBufferView this4 = this->_hx___indexBufferData;
HXDLIN(1407)						 ::__hxcpp_memory_set_ui16(this4->buffer->b,(this4->byteOffset + 6),2);
            					}
HXLINE(1408)					{
HXLINE(1408)						 ::lime::utils::ArrayBufferView this5 = this->_hx___indexBufferData;
HXDLIN(1408)						 ::__hxcpp_memory_set_ui16(this5->buffer->b,(this5->byteOffset + 8),1);
            					}
HXLINE(1409)					{
HXLINE(1409)						 ::lime::utils::ArrayBufferView this6 = this->_hx___indexBufferData;
HXDLIN(1409)						 ::__hxcpp_memory_set_ui16(this6->buffer->b,(this6->byteOffset + 10),3);
            					}
HXLINE(1412)					{
HXLINE(1412)						 ::lime::utils::ArrayBufferView this7 = this->_hx___indexBufferData;
HXDLIN(1412)						 ::__hxcpp_memory_set_ui16(this7->buffer->b,(this7->byteOffset + 12),4);
            					}
HXLINE(1413)					{
HXLINE(1413)						 ::lime::utils::ArrayBufferView this8 = this->_hx___indexBufferData;
HXDLIN(1413)						 ::__hxcpp_memory_set_ui16(this8->buffer->b,(this8->byteOffset + 14),0);
            					}
HXLINE(1414)					{
HXLINE(1414)						 ::lime::utils::ArrayBufferView this9 = this->_hx___indexBufferData;
HXDLIN(1414)						 ::__hxcpp_memory_set_ui16(this9->buffer->b,(this9->byteOffset + 16),5);
            					}
HXLINE(1415)					{
HXLINE(1415)						 ::lime::utils::ArrayBufferView this10 = this->_hx___indexBufferData;
HXDLIN(1415)						 ::__hxcpp_memory_set_ui16(this10->buffer->b,(this10->byteOffset + 18),5);
            					}
HXLINE(1416)					{
HXLINE(1416)						 ::lime::utils::ArrayBufferView this11 = this->_hx___indexBufferData;
HXDLIN(1416)						 ::__hxcpp_memory_set_ui16(this11->buffer->b,(this11->byteOffset + 20),0);
            					}
HXLINE(1417)					{
HXLINE(1417)						 ::lime::utils::ArrayBufferView this12 = this->_hx___indexBufferData;
HXDLIN(1417)						 ::__hxcpp_memory_set_ui16(this12->buffer->b,(this12->byteOffset + 22),2);
            					}
HXLINE(1420)					{
HXLINE(1420)						 ::lime::utils::ArrayBufferView this13 = this->_hx___indexBufferData;
HXDLIN(1420)						 ::__hxcpp_memory_set_ui16(this13->buffer->b,(this13->byteOffset + 24),6);
            					}
HXLINE(1421)					{
HXLINE(1421)						 ::lime::utils::ArrayBufferView this14 = this->_hx___indexBufferData;
HXDLIN(1421)						 ::__hxcpp_memory_set_ui16(this14->buffer->b,(this14->byteOffset + 26),4);
            					}
HXLINE(1422)					{
HXLINE(1422)						 ::lime::utils::ArrayBufferView this15 = this->_hx___indexBufferData;
HXDLIN(1422)						 ::__hxcpp_memory_set_ui16(this15->buffer->b,(this15->byteOffset + 28),7);
            					}
HXLINE(1423)					{
HXLINE(1423)						 ::lime::utils::ArrayBufferView this16 = this->_hx___indexBufferData;
HXDLIN(1423)						 ::__hxcpp_memory_set_ui16(this16->buffer->b,(this16->byteOffset + 30),7);
            					}
HXLINE(1424)					{
HXLINE(1424)						 ::lime::utils::ArrayBufferView this17 = this->_hx___indexBufferData;
HXDLIN(1424)						 ::__hxcpp_memory_set_ui16(this17->buffer->b,(this17->byteOffset + 32),4);
            					}
HXLINE(1425)					{
HXLINE(1425)						 ::lime::utils::ArrayBufferView this18 = this->_hx___indexBufferData;
HXDLIN(1425)						 ::__hxcpp_memory_set_ui16(this18->buffer->b,(this18->byteOffset + 34),5);
            					}
HXLINE(1428)					{
HXLINE(1428)						 ::lime::utils::ArrayBufferView this19 = this->_hx___indexBufferData;
HXDLIN(1428)						 ::__hxcpp_memory_set_ui16(this19->buffer->b,(this19->byteOffset + 36),8);
            					}
HXLINE(1429)					{
HXLINE(1429)						 ::lime::utils::ArrayBufferView this20 = this->_hx___indexBufferData;
HXDLIN(1429)						 ::__hxcpp_memory_set_ui16(this20->buffer->b,(this20->byteOffset + 38),9);
            					}
HXLINE(1430)					{
HXLINE(1430)						 ::lime::utils::ArrayBufferView this21 = this->_hx___indexBufferData;
HXDLIN(1430)						 ::__hxcpp_memory_set_ui16(this21->buffer->b,(this21->byteOffset + 40),0);
            					}
HXLINE(1431)					{
HXLINE(1431)						 ::lime::utils::ArrayBufferView this22 = this->_hx___indexBufferData;
HXDLIN(1431)						 ::__hxcpp_memory_set_ui16(this22->buffer->b,(this22->byteOffset + 42),0);
            					}
HXLINE(1432)					{
HXLINE(1432)						 ::lime::utils::ArrayBufferView this23 = this->_hx___indexBufferData;
HXDLIN(1432)						 ::__hxcpp_memory_set_ui16(this23->buffer->b,(this23->byteOffset + 44),9);
            					}
HXLINE(1433)					{
HXLINE(1433)						 ::lime::utils::ArrayBufferView this24 = this->_hx___indexBufferData;
HXDLIN(1433)						 ::__hxcpp_memory_set_ui16(this24->buffer->b,(this24->byteOffset + 46),1);
            					}
HXLINE(1436)					{
HXLINE(1436)						 ::lime::utils::ArrayBufferView this25 = this->_hx___indexBufferData;
HXDLIN(1436)						 ::__hxcpp_memory_set_ui16(this25->buffer->b,(this25->byteOffset + 48),10);
            					}
HXLINE(1437)					{
HXLINE(1437)						 ::lime::utils::ArrayBufferView this26 = this->_hx___indexBufferData;
HXDLIN(1437)						 ::__hxcpp_memory_set_ui16(this26->buffer->b,(this26->byteOffset + 50),8);
            					}
HXLINE(1438)					{
HXLINE(1438)						 ::lime::utils::ArrayBufferView this27 = this->_hx___indexBufferData;
HXDLIN(1438)						 ::__hxcpp_memory_set_ui16(this27->buffer->b,(this27->byteOffset + 52),4);
            					}
HXLINE(1439)					{
HXLINE(1439)						 ::lime::utils::ArrayBufferView this28 = this->_hx___indexBufferData;
HXDLIN(1439)						 ::__hxcpp_memory_set_ui16(this28->buffer->b,(this28->byteOffset + 54),4);
            					}
HXLINE(1440)					{
HXLINE(1440)						 ::lime::utils::ArrayBufferView this29 = this->_hx___indexBufferData;
HXDLIN(1440)						 ::__hxcpp_memory_set_ui16(this29->buffer->b,(this29->byteOffset + 56),8);
            					}
HXLINE(1441)					{
HXLINE(1441)						 ::lime::utils::ArrayBufferView this30 = this->_hx___indexBufferData;
HXDLIN(1441)						 ::__hxcpp_memory_set_ui16(this30->buffer->b,(this30->byteOffset + 58),0);
            					}
HXLINE(1444)					{
HXLINE(1444)						 ::lime::utils::ArrayBufferView this31 = this->_hx___indexBufferData;
HXDLIN(1444)						 ::__hxcpp_memory_set_ui16(this31->buffer->b,(this31->byteOffset + 60),11);
            					}
HXLINE(1445)					{
HXLINE(1445)						 ::lime::utils::ArrayBufferView this32 = this->_hx___indexBufferData;
HXDLIN(1445)						 ::__hxcpp_memory_set_ui16(this32->buffer->b,(this32->byteOffset + 62),10);
            					}
HXLINE(1446)					{
HXLINE(1446)						 ::lime::utils::ArrayBufferView this33 = this->_hx___indexBufferData;
HXDLIN(1446)						 ::__hxcpp_memory_set_ui16(this33->buffer->b,(this33->byteOffset + 64),6);
            					}
HXLINE(1447)					{
HXLINE(1447)						 ::lime::utils::ArrayBufferView this34 = this->_hx___indexBufferData;
HXDLIN(1447)						 ::__hxcpp_memory_set_ui16(this34->buffer->b,(this34->byteOffset + 66),6);
            					}
HXLINE(1448)					{
HXLINE(1448)						 ::lime::utils::ArrayBufferView this35 = this->_hx___indexBufferData;
HXDLIN(1448)						 ::__hxcpp_memory_set_ui16(this35->buffer->b,(this35->byteOffset + 68),10);
            					}
HXLINE(1449)					{
HXLINE(1449)						 ::lime::utils::ArrayBufferView this36 = this->_hx___indexBufferData;
HXDLIN(1449)						 ::__hxcpp_memory_set_ui16(this36->buffer->b,(this36->byteOffset + 70),4);
            					}
HXLINE(1452)					{
HXLINE(1452)						 ::lime::utils::ArrayBufferView this37 = this->_hx___indexBufferData;
HXDLIN(1452)						 ::__hxcpp_memory_set_ui16(this37->buffer->b,(this37->byteOffset + 72),12);
            					}
HXLINE(1453)					{
HXLINE(1453)						 ::lime::utils::ArrayBufferView this38 = this->_hx___indexBufferData;
HXDLIN(1453)						 ::__hxcpp_memory_set_ui16(this38->buffer->b,(this38->byteOffset + 74),13);
            					}
HXLINE(1454)					{
HXLINE(1454)						 ::lime::utils::ArrayBufferView this39 = this->_hx___indexBufferData;
HXDLIN(1454)						 ::__hxcpp_memory_set_ui16(this39->buffer->b,(this39->byteOffset + 76),8);
            					}
HXLINE(1455)					{
HXLINE(1455)						 ::lime::utils::ArrayBufferView this40 = this->_hx___indexBufferData;
HXDLIN(1455)						 ::__hxcpp_memory_set_ui16(this40->buffer->b,(this40->byteOffset + 78),8);
            					}
HXLINE(1456)					{
HXLINE(1456)						 ::lime::utils::ArrayBufferView this41 = this->_hx___indexBufferData;
HXDLIN(1456)						 ::__hxcpp_memory_set_ui16(this41->buffer->b,(this41->byteOffset + 80),13);
            					}
HXLINE(1457)					{
HXLINE(1457)						 ::lime::utils::ArrayBufferView this42 = this->_hx___indexBufferData;
HXDLIN(1457)						 ::__hxcpp_memory_set_ui16(this42->buffer->b,(this42->byteOffset + 82),9);
            					}
HXLINE(1460)					{
HXLINE(1460)						 ::lime::utils::ArrayBufferView this43 = this->_hx___indexBufferData;
HXDLIN(1460)						 ::__hxcpp_memory_set_ui16(this43->buffer->b,(this43->byteOffset + 84),14);
            					}
HXLINE(1461)					{
HXLINE(1461)						 ::lime::utils::ArrayBufferView this44 = this->_hx___indexBufferData;
HXDLIN(1461)						 ::__hxcpp_memory_set_ui16(this44->buffer->b,(this44->byteOffset + 86),12);
            					}
HXLINE(1462)					{
HXLINE(1462)						 ::lime::utils::ArrayBufferView this45 = this->_hx___indexBufferData;
HXDLIN(1462)						 ::__hxcpp_memory_set_ui16(this45->buffer->b,(this45->byteOffset + 88),10);
            					}
HXLINE(1463)					{
HXLINE(1463)						 ::lime::utils::ArrayBufferView this46 = this->_hx___indexBufferData;
HXDLIN(1463)						 ::__hxcpp_memory_set_ui16(this46->buffer->b,(this46->byteOffset + 90),10);
            					}
HXLINE(1464)					{
HXLINE(1464)						 ::lime::utils::ArrayBufferView this47 = this->_hx___indexBufferData;
HXDLIN(1464)						 ::__hxcpp_memory_set_ui16(this47->buffer->b,(this47->byteOffset + 92),12);
            					}
HXLINE(1465)					{
HXLINE(1465)						 ::lime::utils::ArrayBufferView this48 = this->_hx___indexBufferData;
HXDLIN(1465)						 ::__hxcpp_memory_set_ui16(this48->buffer->b,(this48->byteOffset + 94),8);
            					}
HXLINE(1468)					{
HXLINE(1468)						 ::lime::utils::ArrayBufferView this49 = this->_hx___indexBufferData;
HXDLIN(1468)						 ::__hxcpp_memory_set_ui16(this49->buffer->b,(this49->byteOffset + 96),15);
            					}
HXLINE(1469)					{
HXLINE(1469)						 ::lime::utils::ArrayBufferView this50 = this->_hx___indexBufferData;
HXDLIN(1469)						 ::__hxcpp_memory_set_ui16(this50->buffer->b,(this50->byteOffset + 98),14);
            					}
HXLINE(1470)					{
HXLINE(1470)						 ::lime::utils::ArrayBufferView this51 = this->_hx___indexBufferData;
HXDLIN(1470)						 ::__hxcpp_memory_set_ui16(this51->buffer->b,(this51->byteOffset + 100),11);
            					}
HXLINE(1471)					{
HXLINE(1471)						 ::lime::utils::ArrayBufferView this52 = this->_hx___indexBufferData;
HXDLIN(1471)						 ::__hxcpp_memory_set_ui16(this52->buffer->b,(this52->byteOffset + 102),11);
            					}
HXLINE(1472)					{
HXLINE(1472)						 ::lime::utils::ArrayBufferView this53 = this->_hx___indexBufferData;
HXDLIN(1472)						 ::__hxcpp_memory_set_ui16(this53->buffer->b,(this53->byteOffset + 104),14);
            					}
HXLINE(1473)					{
HXLINE(1473)						 ::lime::utils::ArrayBufferView this54 = this->_hx___indexBufferData;
HXDLIN(1473)						 ::__hxcpp_memory_set_ui16(this54->buffer->b,(this54->byteOffset + 106),10);
            					}
...
HXDLIN(1479)						this->_hx___indexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,18,6);
HXLINE(1490)						{
HXLINE(1490)							 ::lime::utils::ArrayBufferView this55 = this->_hx___indexBufferData;
HXDLIN(1490)							 ::__hxcpp_memory_set_ui16(this55->buffer->b,this55->byteOffset,0);
            						}
HXLINE(1491)						{
HXLINE(1491)							 ::lime::utils::ArrayBufferView this56 = this->_hx___indexBufferData;
HXDLIN(1491)							 ::__hxcpp_memory_set_ui16(this56->buffer->b,(this56->byteOffset + 2),1);
            						}
HXLINE(1492)						{
HXLINE(1492)							 ::lime::utils::ArrayBufferView this57 = this->_hx___indexBufferData;
HXDLIN(1492)							 ::__hxcpp_memory_set_ui16(this57->buffer->b,(this57->byteOffset + 4),2);
            						}
HXLINE(1493)						{
HXLINE(1493)							 ::lime::utils::ArrayBufferView this58 = this->_hx___indexBufferData;
HXDLIN(1493)							 ::__hxcpp_memory_set_ui16(this58->buffer->b,(this58->byteOffset + 6),2);
            						}
HXLINE(1494)						{
HXLINE(1494)							 ::lime::utils::ArrayBufferView this59 = this->_hx___indexBufferData;
HXDLIN(1494)							 ::__hxcpp_memory_set_ui16(this59->buffer->b,(this59->byteOffset + 8),1);
            						}
HXLINE(1495)						{
HXLINE(1495)							 ::lime::utils::ArrayBufferView this60 = this->_hx___indexBufferData;
HXDLIN(1495)							 ::__hxcpp_memory_set_ui16(this60->buffer->b,(this60->byteOffset + 10),3);
            						}
HXLINE(1498)						{
HXLINE(1498)							 ::lime::utils::ArrayBufferView this61 = this->_hx___indexBufferData;
HXDLIN(1498)							 ::__hxcpp_memory_set_ui16(this61->buffer->b,(this61->byteOffset + 12),4);
            						}
HXLINE(1499)						{
HXLINE(1499)							 ::lime::utils::ArrayBufferView this62 = this->_hx___indexBufferData;
HXDLIN(1499)							 ::__hxcpp_memory_set_ui16(this62->buffer->b,(this62->byteOffset + 14),5);
            						}
HXLINE(1500)						{
HXLINE(1500)							 ::lime::utils::ArrayBufferView this63 = this->_hx___indexBufferData;
HXDLIN(1500)							 ::__hxcpp_memory_set_ui16(this63->buffer->b,(this63->byteOffset + 16),0);
            						}
HXLINE(1501)						{
HXLINE(1501)							 ::lime::utils::ArrayBufferView this64 = this->_hx___indexBufferData;
HXDLIN(1501)							 ::__hxcpp_memory_set_ui16(this64->buffer->b,(this64->byteOffset + 18),0);
            						}
HXLINE(1502)						{
HXLINE(1502)							 ::lime::utils::ArrayBufferView this65 = this->_hx___indexBufferData;
HXDLIN(1502)							 ::__hxcpp_memory_set_ui16(this65->buffer->b,(this65->byteOffset + 20),5);
            						}
HXLINE(1503)						{
HXLINE(1503)							 ::lime::utils::ArrayBufferView this66 = this->_hx___indexBufferData;
HXDLIN(1503)							 ::__hxcpp_memory_set_ui16(this66->buffer->b,(this66->byteOffset + 22),1);
            						}
HXLINE(1506)						{
HXLINE(1506)							 ::lime::utils::ArrayBufferView this67 = this->_hx___indexBufferData;
HXDLIN(1506)							 ::__hxcpp_memory_set_ui16(this67->buffer->b,(this67->byteOffset + 24),6);
            						}
HXLINE(1507)						{
HXLINE(1507)							 ::lime::utils::ArrayBufferView this68 = this->_hx___indexBufferData;
HXDLIN(1507)							 ::__hxcpp_memory_set_ui16(this68->buffer->b,(this68->byteOffset + 26),7);
            						}
HXLINE(1508)						{
HXLINE(1508)							 ::lime::utils::ArrayBufferView this69 = this->_hx___indexBufferData;
HXDLIN(1508)							 ::__hxcpp_memory_set_ui16(this69->buffer->b,(this69->byteOffset + 28),4);
            						}
HXLINE(1509)						{
HXLINE(1509)							 ::lime::utils::ArrayBufferView this70 = this->_hx___indexBufferData;
HXDLIN(1509)							 ::__hxcpp_memory_set_ui16(this70->buffer->b,(this70->byteOffset + 30),4);
            						}
HXLINE(1510)						{
HXLINE(1510)							 ::lime::utils::ArrayBufferView this71 = this->_hx___indexBufferData;
HXDLIN(1510)							 ::__hxcpp_memory_set_ui16(this71->buffer->b,(this71->byteOffset + 32),7);
            						}
HXLINE(1511)						{
HXLINE(1511)							 ::lime::utils::ArrayBufferView this72 = this->_hx___indexBufferData;
HXDLIN(1511)							 ::__hxcpp_memory_set_ui16(this72->buffer->b,(this72->byteOffset + 34),5);
            						}
...
HXDLIN(1517)							this->_hx___indexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,18,6);
HXLINE(1524)							{
HXLINE(1524)								 ::lime::utils::ArrayBufferView this73 = this->_hx___indexBufferData;
HXDLIN(1524)								 ::__hxcpp_memory_set_ui16(this73->buffer->b,this73->byteOffset,0);
            							}
HXLINE(1525)							{
HXLINE(1525)								 ::lime::utils::ArrayBufferView this74 = this->_hx___indexBufferData;
HXDLIN(1525)								 ::__hxcpp_memory_set_ui16(this74->buffer->b,(this74->byteOffset + 2),1);
            							}
HXLINE(1526)							{
HXLINE(1526)								 ::lime::utils::ArrayBufferView this75 = this->_hx___indexBufferData;
HXDLIN(1526)								 ::__hxcpp_memory_set_ui16(this75->buffer->b,(this75->byteOffset + 4),2);
            							}
HXLINE(1527)							{
HXLINE(1527)								 ::lime::utils::ArrayBufferView this76 = this->_hx___indexBufferData;
HXDLIN(1527)								 ::__hxcpp_memory_set_ui16(this76->buffer->b,(this76->byteOffset + 6),2);
            							}
HXLINE(1528)							{
HXLINE(1528)								 ::lime::utils::ArrayBufferView this77 = this->_hx___indexBufferData;
HXDLIN(1528)								 ::__hxcpp_memory_set_ui16(this77->buffer->b,(this77->byteOffset + 8),1);
            							}
HXLINE(1529)							{
HXLINE(1529)								 ::lime::utils::ArrayBufferView this78 = this->_hx___indexBufferData;
HXDLIN(1529)								 ::__hxcpp_memory_set_ui16(this78->buffer->b,(this78->byteOffset + 10),3);
            							}
HXLINE(1532)							{
HXLINE(1532)								 ::lime::utils::ArrayBufferView this79 = this->_hx___indexBufferData;
HXDLIN(1532)								 ::__hxcpp_memory_set_ui16(this79->buffer->b,(this79->byteOffset + 12),4);
            							}
HXLINE(1533)							{
HXLINE(1533)								 ::lime::utils::ArrayBufferView this80 = this->_hx___indexBufferData;
HXDLIN(1533)								 ::__hxcpp_memory_set_ui16(this80->buffer->b,(this80->byteOffset + 14),0);
            							}
HXLINE(1534)							{
HXLINE(1534)								 ::lime::utils::ArrayBufferView this81 = this->_hx___indexBufferData;
HXDLIN(1534)								 ::__hxcpp_memory_set_ui16(this81->buffer->b,(this81->byteOffset + 16),5);
            							}
HXLINE(1535)							{
HXLINE(1535)								 ::lime::utils::ArrayBufferView this82 = this->_hx___indexBufferData;
HXDLIN(1535)								 ::__hxcpp_memory_set_ui16(this82->buffer->b,(this82->byteOffset + 18),5);
            							}
HXLINE(1536)							{
HXLINE(1536)								 ::lime::utils::ArrayBufferView this83 = this->_hx___indexBufferData;
HXDLIN(1536)								 ::__hxcpp_memory_set_ui16(this83->buffer->b,(this83->byteOffset + 20),0);
            							}
HXLINE(1537)							{
HXLINE(1537)								 ::lime::utils::ArrayBufferView this84 = this->_hx___indexBufferData;
HXDLIN(1537)								 ::__hxcpp_memory_set_ui16(this84->buffer->b,(this84->byteOffset + 22),2);
            							}
HXLINE(1540)							{
HXLINE(1540)								 ::lime::utils::ArrayBufferView this85 = this->_hx___indexBufferData;
HXDLIN(1540)								 ::__hxcpp_memory_set_ui16(this85->buffer->b,(this85->byteOffset + 24),6);
            							}
HXLINE(1541)							{
HXLINE(1541)								 ::lime::utils::ArrayBufferView this86 = this->_hx___indexBufferData;
HXDLIN(1541)								 ::__hxcpp_memory_set_ui16(this86->buffer->b,(this86->byteOffset + 26),4);
            							}
HXLINE(1542)							{
HXLINE(1542)								 ::lime::utils::ArrayBufferView this87 = this->_hx___indexBufferData;
HXDLIN(1542)								 ::__hxcpp_memory_set_ui16(this87->buffer->b,(this87->byteOffset + 28),7);
            							}
HXLINE(1543)							{
HXLINE(1543)								 ::lime::utils::ArrayBufferView this88 = this->_hx___indexBufferData;
HXDLIN(1543)								 ::__hxcpp_memory_set_ui16(this88->buffer->b,(this88->byteOffset + 30),7);
            							}
HXLINE(1544)							{
HXLINE(1544)								 ::lime::utils::ArrayBufferView this89 = this->_hx___indexBufferData;
HXDLIN(1544)								 ::__hxcpp_memory_set_ui16(this89->buffer->b,(this89->byteOffset + 32),4);
            							}
HXLINE(1545)							{
HXLINE(1545)								 ::lime::utils::ArrayBufferView this90 = this->_hx___indexBufferData;
HXDLIN(1545)								 ::__hxcpp_memory_set_ui16(this90->buffer->b,(this90->byteOffset + 34),5);
            							}
...
HXDLIN(1557)				this->_hx___indexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,6,6);
HXLINE(1558)				{
HXLINE(1558)					 ::lime::utils::ArrayBufferView this91 = this->_hx___indexBufferData;
HXDLIN(1558)					 ::__hxcpp_memory_set_ui16(this91->buffer->b,this91->byteOffset,0);
            				}
HXLINE(1559)				{
HXLINE(1559)					 ::lime::utils::ArrayBufferView this92 = this->_hx___indexBufferData;
HXDLIN(1559)					 ::__hxcpp_memory_set_ui16(this92->buffer->b,(this92->byteOffset + 2),1);
            				}
HXLINE(1560)				{
HXLINE(1560)					 ::lime::utils::ArrayBufferView this93 = this->_hx___indexBufferData;
HXDLIN(1560)					 ::__hxcpp_memory_set_ui16(this93->buffer->b,(this93->byteOffset + 4),2);
            				}
HXLINE(1561)				{
HXLINE(1561)					 ::lime::utils::ArrayBufferView this94 = this->_hx___indexBufferData;
HXDLIN(1561)					 ::__hxcpp_memory_set_ui16(this94->buffer->b,(this94->byteOffset + 6),2);
            				}
HXLINE(1562)				{
HXLINE(1562)					 ::lime::utils::ArrayBufferView this95 = this->_hx___indexBufferData;
HXDLIN(1562)					 ::__hxcpp_memory_set_ui16(this95->buffer->b,(this95->byteOffset + 8),1);
            				}
HXLINE(1563)				{
HXLINE(1563)					 ::lime::utils::ArrayBufferView this96 = this->_hx___indexBufferData;
HXDLIN(1563)					 ::__hxcpp_memory_set_ui16(this96->buffer->b,(this96->byteOffset + 10),3);
            				}
...
HXLINE(1583)
HXLINE(1584)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXLINE(1623)			HX_VARI( int,uvWidth) = 1;
HXLINE(1624)			HX_VARI( int,uvHeight) = 1;
...
HXLINE(1662)				HX_VARI( Float,centerX) = scale9Grid->width;
HXLINE(1663)				HX_VARI( Float,centerY) = scale9Grid->height;
...
HXDLIN(1666)					this->_hx___vertexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,224,8);
HXLINE(1668)					HX_VARI( Float,left) = scale9Grid->x;
HXLINE(1669)					HX_VARI( Float,top) = scale9Grid->y;
HXLINE(1670)					HX_VARI( Float,right) = ((( (Float)(this->width) ) - centerX) - left);
HXLINE(1671)					HX_VARI( Float,bottom) = ((( (Float)(this->height) ) - centerY) - top);
HXLINE(1673)					HX_VARI( Float,uvLeft) = (left / ( (Float)(this->width) ));
HXLINE(1674)					HX_VARI( Float,uvTop) = (top / ( (Float)(this->height) ));
HXLINE(1675)					HX_VARI( Float,uvCenterX) = (centerX / ( (Float)(this->width) ));
HXLINE(1676)					HX_VARI( Float,uvCenterY) = (centerY / ( (Float)(this->height) ));
HXLINE(1677)					HX_VARI( Float,uvRight) = (right / ( (Float)(this->width) ));
HXLINE(1678)					HX_VARI( Float,uvBottom) = (bottom / ( (Float)(this->height) ));
HXLINE(1680)					HX_VARI( Float,renderedLeft) = (left / targetObject->get_scaleX());
HXLINE(1681)					HX_VARI( Float,renderedTop) = (top / targetObject->get_scaleY());
HXLINE(1682)					HX_VARI( Float,renderedRight) = (right / targetObject->get_scaleX());
HXLINE(1683)					HX_VARI( Float,renderedBottom) = (bottom / targetObject->get_scaleY());
HXLINE(1684)					Float renderedCenterX = targetObject->get_width();
HXDLIN(1684)					HX_VARI_NAME( Float,renderedCenterX1,"renderedCenterX") = (((renderedCenterX / targetObject->get_scaleX()) - renderedLeft) - renderedRight);
HXLINE(1685)					Float renderedCenterY = targetObject->get_height();
HXDLIN(1685)					HX_VARI_NAME( Float,renderedCenterY1,"renderedCenterY") = (((renderedCenterY / targetObject->get_scaleY()) - renderedTop) - renderedBottom);
HXLINE(1696)					{
HXLINE(1696)						 ::lime::utils::ArrayBufferView this1 = this->_hx___vertexBufferData;
HXDLIN(1696)						 ::__hxcpp_memory_set_float(this1->buffer->b,this1->byteOffset,renderedLeft);
            					}
HXLINE(1697)					{
HXLINE(1697)						 ::lime::utils::ArrayBufferView this2 = this->_hx___vertexBufferData;
HXDLIN(1697)						 ::__hxcpp_memory_set_float(this2->buffer->b,(this2->byteOffset + 4),renderedTop);
            					}
HXLINE(1698)					{
HXLINE(1698)						 ::lime::utils::ArrayBufferView this3 = this->_hx___vertexBufferData;
HXDLIN(1698)						Float val = (( (Float)(uvWidth) ) * uvLeft);
HXDLIN(1698)						 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 12),val);
            					}
HXLINE(1699)					{
HXLINE(1699)						 ::lime::utils::ArrayBufferView this4 = this->_hx___vertexBufferData;
HXDLIN(1699)						Float val1 = (( (Float)(uvHeight) ) * uvTop);
HXDLIN(1699)						 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 16),val1);
            					}
HXLINE(1701)					{
HXLINE(1701)						 ::lime::utils::ArrayBufferView this5 = this->_hx___vertexBufferData;
HXDLIN(1701)						 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 60),renderedTop);
            					}
HXLINE(1702)					{
HXLINE(1702)						 ::lime::utils::ArrayBufferView this6 = this->_hx___vertexBufferData;
HXDLIN(1702)						Float val2 = (( (Float)(uvHeight) ) * uvTop);
HXDLIN(1702)						 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 72),val2);
            					}
HXLINE(1704)					{
HXLINE(1704)						 ::lime::utils::ArrayBufferView this7 = this->_hx___vertexBufferData;
HXDLIN(1704)						 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 112),renderedLeft);
            					}
HXLINE(1705)					{
HXLINE(1705)						 ::lime::utils::ArrayBufferView this8 = this->_hx___vertexBufferData;
HXDLIN(1705)						Float val3 = (( (Float)(uvWidth) ) * uvLeft);
HXDLIN(1705)						 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 124),val3);
            					}
HXLINE(1708)					{
HXLINE(1708)						 ::lime::utils::ArrayBufferView this9 = this->_hx___vertexBufferData;
HXDLIN(1708)						Float val4 = (renderedLeft + renderedCenterX1);
HXDLIN(1708)						 ::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + 224),val4);
            					}
HXLINE(1709)					{
HXLINE(1709)						 ::lime::utils::ArrayBufferView this10 = this->_hx___vertexBufferData;
HXDLIN(1709)						 ::__hxcpp_memory_set_float(this10->buffer->b,(this10->byteOffset + 228),renderedTop);
            					}
HXLINE(1710)					{
...
HXDLIN(1710)						 ::__hxcpp_memory_set_float(this11->buffer->b,(this11->byteOffset + 236),val5);
            					}
HXLINE(1711)					{
HXLINE(1711)						 ::lime::utils::ArrayBufferView this12 = this->_hx___vertexBufferData;
HXDLIN(1711)						Float val6 = (( (Float)(uvHeight) ) * uvTop);
HXDLIN(1711)						 ::__hxcpp_memory_set_float(this12->buffer->b,(this12->byteOffset + 240),val6);
            					}
HXLINE(1713)					{
HXLINE(1713)						 ::lime::utils::ArrayBufferView this13 = this->_hx___vertexBufferData;
HXDLIN(1713)						Float val7 = (renderedLeft + renderedCenterX1);
HXDLIN(1713)						 ::__hxcpp_memory_set_float(this13->buffer->b,(this13->byteOffset + 280),val7);
            					}
HXLINE(1714)					{
...
HXDLIN(1714)						 ::__hxcpp_memory_set_float(this14->buffer->b,(this14->byteOffset + 292),val8);
            					}
HXLINE(1717)					{
HXLINE(1717)						 ::lime::utils::ArrayBufferView this15 = this->_hx___vertexBufferData;
HXDLIN(1717)						Float val9 = ( (Float)(this->width) );
HXDLIN(1717)						 ::__hxcpp_memory_set_float(this15->buffer->b,(this15->byteOffset + 336),val9);
            					}
HXLINE(1718)					{
HXLINE(1718)						 ::lime::utils::ArrayBufferView this16 = this->_hx___vertexBufferData;
HXDLIN(1718)						 ::__hxcpp_memory_set_float(this16->buffer->b,(this16->byteOffset + 340),renderedTop);
            					}
HXLINE(1719)					{
HXLINE(1719)						 ::lime::utils::ArrayBufferView this17 = this->_hx___vertexBufferData;
HXDLIN(1719)						 ::__hxcpp_memory_set_float(this17->buffer->b,(this17->byteOffset + 348),uvWidth);
            					}
HXLINE(1720)					{
HXLINE(1720)						 ::lime::utils::ArrayBufferView this18 = this->_hx___vertexBufferData;
HXDLIN(1720)						Float val10 = (( (Float)(uvHeight) ) * uvTop);
HXDLIN(1720)						 ::__hxcpp_memory_set_float(this18->buffer->b,(this18->byteOffset + 352),val10);
            					}
HXLINE(1722)					{
HXLINE(1722)						 ::lime::utils::ArrayBufferView this19 = this->_hx___vertexBufferData;
HXDLIN(1722)						Float val11 = ( (Float)(this->width) );
HXDLIN(1722)						 ::__hxcpp_memory_set_float(this19->buffer->b,(this19->byteOffset + 392),val11);
            					}
HXLINE(1723)					{
HXLINE(1723)						 ::lime::utils::ArrayBufferView this20 = this->_hx___vertexBufferData;
HXDLIN(1723)						 ::__hxcpp_memory_set_float(this20->buffer->b,(this20->byteOffset + 404),uvWidth);
            					}
HXLINE(1726)					{
HXLINE(1726)						 ::lime::utils::ArrayBufferView this21 = this->_hx___vertexBufferData;
HXDLIN(1726)						 ::__hxcpp_memory_set_float(this21->buffer->b,(this21->byteOffset + 448),renderedLeft);
            					}
HXLINE(1727)					{
...
HXDLIN(1727)						 ::__hxcpp_memory_set_float(this22->buffer->b,(this22->byteOffset + 452),val12);
            					}
HXLINE(1728)					{
HXLINE(1728)						 ::lime::utils::ArrayBufferView this23 = this->_hx___vertexBufferData;
HXDLIN(1728)						Float val13 = (( (Float)(uvWidth) ) * uvLeft);
HXDLIN(1728)						 ::__hxcpp_memory_set_float(this23->buffer->b,(this23->byteOffset + 460),val13);
            					}
HXLINE(1729)					{
...
HXDLIN(1729)						 ::__hxcpp_memory_set_float(this24->buffer->b,(this24->byteOffset + 464),val14);
            					}
HXLINE(1731)					{
HXLINE(1731)						 ::lime::utils::ArrayBufferView this25 = this->_hx___vertexBufferData;
HXDLIN(1731)						Float val15 = (renderedTop + renderedCenterY1);
HXDLIN(1731)						 ::__hxcpp_memory_set_float(this25->buffer->b,(this25->byteOffset + 508),val15);
            					}
HXLINE(1732)					{
...
HXDLIN(1732)						 ::__hxcpp_memory_set_float(this26->buffer->b,(this26->byteOffset + 520),val16);
            					}
HXLINE(1735)					{
HXLINE(1735)						 ::lime::utils::ArrayBufferView this27 = this->_hx___vertexBufferData;
HXDLIN(1735)						Float val17 = (renderedLeft + renderedCenterX1);
HXDLIN(1735)						 ::__hxcpp_memory_set_float(this27->buffer->b,(this27->byteOffset + 560),val17);
            					}
HXLINE(1736)					{
...
HXDLIN(1736)						 ::__hxcpp_memory_set_float(this28->buffer->b,(this28->byteOffset + 564),val18);
            					}
HXLINE(1737)					{
...
HXDLIN(1737)						 ::__hxcpp_memory_set_float(this29->buffer->b,(this29->byteOffset + 572),val19);
            					}
HXLINE(1738)					{
...
HXDLIN(1738)						 ::__hxcpp_memory_set_float(this30->buffer->b,(this30->byteOffset + 576),val20);
            					}
HXLINE(1741)					{
HXLINE(1741)						 ::lime::utils::ArrayBufferView this31 = this->_hx___vertexBufferData;
HXDLIN(1741)						Float val21 = ( (Float)(this->width) );
HXDLIN(1741)						 ::__hxcpp_memory_set_float(this31->buffer->b,(this31->byteOffset + 616),val21);
            					}
HXLINE(1742)					{
...
HXDLIN(1742)						 ::__hxcpp_memory_set_float(this32->buffer->b,(this32->byteOffset + 620),val22);
            					}
HXLINE(1743)					{
HXLINE(1743)						 ::lime::utils::ArrayBufferView this33 = this->_hx___vertexBufferData;
HXDLIN(1743)						 ::__hxcpp_memory_set_float(this33->buffer->b,(this33->byteOffset + 628),uvWidth);
            					}
HXLINE(1744)					{
...
HXDLIN(1744)						 ::__hxcpp_memory_set_float(this34->buffer->b,(this34->byteOffset + 632),val23);
            					}
HXLINE(1747)					{
HXLINE(1747)						 ::lime::utils::ArrayBufferView this35 = this->_hx___vertexBufferData;
HXDLIN(1747)						 ::__hxcpp_memory_set_float(this35->buffer->b,(this35->byteOffset + 672),renderedLeft);
            					}
HXLINE(1748)					{
HXLINE(1748)						 ::lime::utils::ArrayBufferView this36 = this->_hx___vertexBufferData;
HXDLIN(1748)						Float val24 = ( (Float)(this->height) );
HXDLIN(1748)						 ::__hxcpp_memory_set_float(this36->buffer->b,(this36->byteOffset + 676),val24);
            					}
HXLINE(1749)					{
HXLINE(1749)						 ::lime::utils::ArrayBufferView this37 = this->_hx___vertexBufferData;
HXDLIN(1749)						Float val25 = (( (Float)(uvWidth) ) * uvLeft);
HXDLIN(1749)						 ::__hxcpp_memory_set_float(this37->buffer->b,(this37->byteOffset + 684),val25);
            					}
HXLINE(1750)					{
HXLINE(1750)						 ::lime::utils::ArrayBufferView this38 = this->_hx___vertexBufferData;
HXDLIN(1750)						 ::__hxcpp_memory_set_float(this38->buffer->b,(this38->byteOffset + 688),uvHeight);
            					}
HXLINE(1752)					{
HXLINE(1752)						 ::lime::utils::ArrayBufferView this39 = this->_hx___vertexBufferData;
HXDLIN(1752)						Float val26 = ( (Float)(this->height) );
HXDLIN(1752)						 ::__hxcpp_memory_set_float(this39->buffer->b,(this39->byteOffset + 732),val26);
            					}
HXLINE(1753)					{
HXLINE(1753)						 ::lime::utils::ArrayBufferView this40 = this->_hx___vertexBufferData;
HXDLIN(1753)						 ::__hxcpp_memory_set_float(this40->buffer->b,(this40->byteOffset + 744),uvHeight);
            					}
HXLINE(1756)					{
HXLINE(1756)						 ::lime::utils::ArrayBufferView this41 = this->_hx___vertexBufferData;
HXDLIN(1756)						Float val27 = (renderedLeft + renderedCenterX1);
HXDLIN(1756)						 ::__hxcpp_memory_set_float(this41->buffer->b,(this41->byteOffset + 784),val27);
            					}
HXLINE(1757)					{
HXLINE(1757)						 ::lime::utils::ArrayBufferView this42 = this->_hx___vertexBufferData;
HXDLIN(1757)						Float val28 = ( (Float)(this->height) );
HXDLIN(1757)						 ::__hxcpp_memory_set_float(this42->buffer->b,(this42->byteOffset + 788),val28);
            					}
HXLINE(1758)					{
...
HXDLIN(1758)						 ::__hxcpp_memory_set_float(this43->buffer->b,(this43->byteOffset + 796),val29);
            					}
HXLINE(1759)					{
HXLINE(1759)						 ::lime::utils::ArrayBufferView this44 = this->_hx___vertexBufferData;
HXDLIN(1759)						 ::__hxcpp_memory_set_float(this44->buffer->b,(this44->byteOffset + 800),uvHeight);
            					}
HXLINE(1762)					{
HXLINE(1762)						 ::lime::utils::ArrayBufferView this45 = this->_hx___vertexBufferData;
HXDLIN(1762)						Float val30 = ( (Float)(this->width) );
HXDLIN(1762)						 ::__hxcpp_memory_set_float(this45->buffer->b,(this45->byteOffset + 840),val30);
            					}
HXLINE(1763)					{
HXLINE(1763)						 ::lime::utils::ArrayBufferView this46 = this->_hx___vertexBufferData;
HXDLIN(1763)						Float val31 = ( (Float)(this->height) );
HXDLIN(1763)						 ::__hxcpp_memory_set_float(this46->buffer->b,(this46->byteOffset + 844),val31);
            					}
HXLINE(1764)					{
HXLINE(1764)						 ::lime::utils::ArrayBufferView this47 = this->_hx___vertexBufferData;
HXDLIN(1764)						 ::__hxcpp_memory_set_float(this47->buffer->b,(this47->byteOffset + 852),uvWidth);
            					}
HXLINE(1765)					{
HXLINE(1765)						 ::lime::utils::ArrayBufferView this48 = this->_hx___vertexBufferData;
HXDLIN(1765)						 ::__hxcpp_memory_set_float(this48->buffer->b,(this48->byteOffset + 856),uvHeight);
            					}
...
HXDLIN(1771)						this->_hx___vertexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,112,8);
HXLINE(1773)						HX_VARI_NAME( Float,top1,"top") = scale9Grid->y;
HXLINE(1774)						HX_VARI_NAME( Float,bottom1,"bottom") = ((( (Float)(this->height) ) - centerY) - top1);
HXLINE(1776)						HX_VARI_NAME( Float,uvTop1,"uvTop") = (top1 / ( (Float)(this->height) ));
HXLINE(1777)						HX_VARI_NAME( Float,uvCenterY1,"uvCenterY") = (centerY / ( (Float)(this->height) ));
HXLINE(1778)						HX_VARI_NAME( Float,uvBottom1,"uvBottom") = (bottom1 / ( (Float)(this->height) ));
HXLINE(1780)						HX_VARI_NAME( Float,renderedTop1,"renderedTop") = (top1 / targetObject->get_scaleY());
HXLINE(1781)						HX_VARI_NAME( Float,renderedBottom1,"renderedBottom") = (bottom1 / targetObject->get_scaleY());
HXLINE(1782)						Float renderedCenterY2 = targetObject->get_height();
HXDLIN(1782)						HX_VARI_NAME( Float,renderedCenterY3,"renderedCenterY") = (((renderedCenterY2 / targetObject->get_scaleY()) - renderedTop1) - renderedBottom1);
HXLINE(1784)						Float renderedWidth = targetObject->get_width();
HXDLIN(1784)						HX_VARI_NAME( Float,renderedWidth1,"renderedWidth") = (renderedWidth / targetObject->get_scaleX());
HXLINE(1795)						{
HXLINE(1795)							 ::lime::utils::ArrayBufferView this49 = this->_hx___vertexBufferData;
HXDLIN(1795)							 ::__hxcpp_memory_set_float(this49->buffer->b,this49->byteOffset,renderedWidth1);
            						}
HXLINE(1796)						{
HXLINE(1796)							 ::lime::utils::ArrayBufferView this50 = this->_hx___vertexBufferData;
HXDLIN(1796)							 ::__hxcpp_memory_set_float(this50->buffer->b,(this50->byteOffset + 4),renderedTop1);
            						}
HXLINE(1797)						{
HXLINE(1797)							 ::lime::utils::ArrayBufferView this51 = this->_hx___vertexBufferData;
HXDLIN(1797)							 ::__hxcpp_memory_set_float(this51->buffer->b,(this51->byteOffset + 12),uvWidth);
            						}
HXLINE(1798)						{
HXLINE(1798)							 ::lime::utils::ArrayBufferView this52 = this->_hx___vertexBufferData;
HXDLIN(1798)							Float val32 = (( (Float)(uvHeight) ) * uvTop1);
HXDLIN(1798)							 ::__hxcpp_memory_set_float(this52->buffer->b,(this52->byteOffset + 16),val32);
            						}
HXLINE(1800)						{
HXLINE(1800)							 ::lime::utils::ArrayBufferView this53 = this->_hx___vertexBufferData;
HXDLIN(1800)							 ::__hxcpp_memory_set_float(this53->buffer->b,(this53->byteOffset + 60),renderedTop1);
            						}
HXLINE(1801)						{
HXLINE(1801)							 ::lime::utils::ArrayBufferView this54 = this->_hx___vertexBufferData;
HXDLIN(1801)							Float val33 = (( (Float)(uvHeight) ) * uvTop1);
HXDLIN(1801)							 ::__hxcpp_memory_set_float(this54->buffer->b,(this54->byteOffset + 72),val33);
            						}
HXLINE(1803)						{
HXLINE(1803)							 ::lime::utils::ArrayBufferView this55 = this->_hx___vertexBufferData;
HXDLIN(1803)							 ::__hxcpp_memory_set_float(this55->buffer->b,(this55->byteOffset + 112),renderedWidth1);
            						}
HXLINE(1804)						{
HXLINE(1804)							 ::lime::utils::ArrayBufferView this56 = this->_hx___vertexBufferData;
HXDLIN(1804)							 ::__hxcpp_memory_set_float(this56->buffer->b,(this56->byteOffset + 124),uvWidth);
            						}
HXLINE(1807)						{
HXLINE(1807)							 ::lime::utils::ArrayBufferView this57 = this->_hx___vertexBufferData;
HXDLIN(1807)							 ::__hxcpp_memory_set_float(this57->buffer->b,(this57->byteOffset + 224),renderedWidth1);
            						}
HXLINE(1808)						{
HXLINE(1808)							 ::lime::utils::ArrayBufferView this58 = this->_hx___vertexBufferData;
HXDLIN(1808)							Float val34 = (renderedTop1 + renderedCenterY3);
HXDLIN(1808)							 ::__hxcpp_memory_set_float(this58->buffer->b,(this58->byteOffset + 228),val34);
            						}
HXLINE(1809)						{
HXLINE(1809)							 ::lime::utils::ArrayBufferView this59 = this->_hx___vertexBufferData;
HXDLIN(1809)							 ::__hxcpp_memory_set_float(this59->buffer->b,(this59->byteOffset + 236),uvWidth);
            						}
HXLINE(1810)						{
HXLINE(1810)							 ::lime::utils::ArrayBufferView this60 = this->_hx___vertexBufferData;
HXDLIN(1810)							Float val35 = (( (Float)(uvHeight) ) * (uvTop1 + uvCenterY1));
HXDLIN(1810)							 ::__hxcpp_memory_set_float(this60->buffer->b,(this60->byteOffset + 240),val35);
            						}
HXLINE(1812)						{
HXLINE(1812)							 ::lime::utils::ArrayBufferView this61 = this->_hx___vertexBufferData;
HXDLIN(1812)							Float val36 = (renderedTop1 + renderedCenterY3);
HXDLIN(1812)							 ::__hxcpp_memory_set_float(this61->buffer->b,(this61->byteOffset + 284),val36);
            						}
HXLINE(1813)						{
HXLINE(1813)							 ::lime::utils::ArrayBufferView this62 = this->_hx___vertexBufferData;
HXDLIN(1813)							Float val37 = (( (Float)(uvHeight) ) * (uvTop1 + uvCenterY1));
HXDLIN(1813)							 ::__hxcpp_memory_set_float(this62->buffer->b,(this62->byteOffset + 296),val37);
            						}
HXLINE(1816)						{
HXLINE(1816)							 ::lime::utils::ArrayBufferView this63 = this->_hx___vertexBufferData;
HXDLIN(1816)							 ::__hxcpp_memory_set_float(this63->buffer->b,(this63->byteOffset + 336),renderedWidth1);
            						}
HXLINE(1817)						{
HXLINE(1817)							 ::lime::utils::ArrayBufferView this64 = this->_hx___vertexBufferData;
HXDLIN(1817)							Float val38 = ( (Float)(this->height) );
HXDLIN(1817)							 ::__hxcpp_memory_set_float(this64->buffer->b,(this64->byteOffset + 340),val38);
            						}
HXLINE(1818)						{
HXLINE(1818)							 ::lime::utils::ArrayBufferView this65 = this->_hx___vertexBufferData;
HXDLIN(1818)							 ::__hxcpp_memory_set_float(this65->buffer->b,(this65->byteOffset + 348),uvWidth);
            						}
HXLINE(1819)						{
HXLINE(1819)							 ::lime::utils::ArrayBufferView this66 = this->_hx___vertexBufferData;
HXDLIN(1819)							 ::__hxcpp_memory_set_float(this66->buffer->b,(this66->byteOffset + 352),uvHeight);
            						}
HXLINE(1821)						{
HXLINE(1821)							 ::lime::utils::ArrayBufferView this67 = this->_hx___vertexBufferData;
HXDLIN(1821)							Float val39 = ( (Float)(this->height) );
HXDLIN(1821)							 ::__hxcpp_memory_set_float(this67->buffer->b,(this67->byteOffset + 396),val39);
            						}
HXLINE(1822)						{
HXLINE(1822)							 ::lime::utils::ArrayBufferView this68 = this->_hx___vertexBufferData;
HXDLIN(1822)							 ::__hxcpp_memory_set_float(this68->buffer->b,(this68->byteOffset + 408),uvHeight);
            						}
...
HXDLIN(1828)							this->_hx___vertexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,112,8);
HXLINE(1830)							HX_VARI_NAME( Float,left1,"left") = scale9Grid->x;
HXLINE(1831)							HX_VARI_NAME( Float,right1,"right") = ((( (Float)(this->width) ) - centerX) - left1);
HXLINE(1833)							HX_VARI_NAME( Float,uvLeft1,"uvLeft") = (left1 / ( (Float)(this->width) ));
HXLINE(1834)							HX_VARI_NAME( Float,uvCenterX1,"uvCenterX") = (centerX / ( (Float)(this->width) ));
HXLINE(1835)							HX_VARI_NAME( Float,uvRight1,"uvRight") = (right1 / ( (Float)(this->width) ));
HXLINE(1837)							HX_VARI_NAME( Float,renderedLeft1,"renderedLeft") = (left1 / targetObject->get_scaleX());
HXLINE(1838)							HX_VARI_NAME( Float,renderedRight1,"renderedRight") = (right1 / targetObject->get_scaleX());
HXLINE(1839)							Float renderedCenterX2 = targetObject->get_width();
HXDLIN(1839)							HX_VARI_NAME( Float,renderedCenterX3,"renderedCenterX") = (((renderedCenterX2 / targetObject->get_scaleX()) - renderedLeft1) - renderedRight1);
HXLINE(1841)							Float renderedHeight = targetObject->get_height();
HXDLIN(1841)							HX_VARI_NAME( Float,renderedHeight1,"renderedHeight") = (renderedHeight / targetObject->get_scaleY());
HXLINE(1848)							{
HXLINE(1848)								 ::lime::utils::ArrayBufferView this69 = this->_hx___vertexBufferData;
HXDLIN(1848)								 ::__hxcpp_memory_set_float(this69->buffer->b,this69->byteOffset,renderedLeft1);
            							}
HXLINE(1849)							{
HXLINE(1849)								 ::lime::utils::ArrayBufferView this70 = this->_hx___vertexBufferData;
HXDLIN(1849)								 ::__hxcpp_memory_set_float(this70->buffer->b,(this70->byteOffset + 4),renderedHeight1);
            							}
HXLINE(1850)							{
HXLINE(1850)								 ::lime::utils::ArrayBufferView this71 = this->_hx___vertexBufferData;
HXDLIN(1850)								Float val40 = (( (Float)(uvWidth) ) * uvLeft1);
HXDLIN(1850)								 ::__hxcpp_memory_set_float(this71->buffer->b,(this71->byteOffset + 12),val40);
            							}
HXLINE(1851)							{
HXLINE(1851)								 ::lime::utils::ArrayBufferView this72 = this->_hx___vertexBufferData;
HXDLIN(1851)								 ::__hxcpp_memory_set_float(this72->buffer->b,(this72->byteOffset + 16),uvHeight);
            							}
HXLINE(1853)							{
HXLINE(1853)								 ::lime::utils::ArrayBufferView this73 = this->_hx___vertexBufferData;
HXDLIN(1853)								 ::__hxcpp_memory_set_float(this73->buffer->b,(this73->byteOffset + 60),renderedHeight1);
            							}
HXLINE(1854)							{
HXLINE(1854)								 ::lime::utils::ArrayBufferView this74 = this->_hx___vertexBufferData;
HXDLIN(1854)								 ::__hxcpp_memory_set_float(this74->buffer->b,(this74->byteOffset + 72),uvHeight);
            							}
HXLINE(1856)							{
HXLINE(1856)								 ::lime::utils::ArrayBufferView this75 = this->_hx___vertexBufferData;
HXDLIN(1856)								 ::__hxcpp_memory_set_float(this75->buffer->b,(this75->byteOffset + 112),renderedLeft1);
            							}
HXLINE(1857)							{
HXLINE(1857)								 ::lime::utils::ArrayBufferView this76 = this->_hx___vertexBufferData;
HXDLIN(1857)								Float val41 = (( (Float)(uvWidth) ) * uvLeft1);
HXDLIN(1857)								 ::__hxcpp_memory_set_float(this76->buffer->b,(this76->byteOffset + 124),val41);
            							}
HXLINE(1860)							{
HXLINE(1860)								 ::lime::utils::ArrayBufferView this77 = this->_hx___vertexBufferData;
HXDLIN(1860)								Float val42 = (renderedLeft1 + renderedCenterX3);
HXDLIN(1860)								 ::__hxcpp_memory_set_float(this77->buffer->b,(this77->byteOffset + 224),val42);
            							}
HXLINE(1861)							{
HXLINE(1861)								 ::lime::utils::ArrayBufferView this78 = this->_hx___vertexBufferData;
HXDLIN(1861)								 ::__hxcpp_memory_set_float(this78->buffer->b,(this78->byteOffset + 228),renderedHeight1);
            							}
HXLINE(1862)							{
HXLINE(1862)								 ::lime::utils::ArrayBufferView this79 = this->_hx___vertexBufferData;
HXDLIN(1862)								Float val43 = (( (Float)(uvWidth) ) * (uvLeft1 + uvCenterX1));
HXDLIN(1862)								 ::__hxcpp_memory_set_float(this79->buffer->b,(this79->byteOffset + 236),val43);
            							}
HXLINE(1863)							{
HXLINE(1863)								 ::lime::utils::ArrayBufferView this80 = this->_hx___vertexBufferData;
HXDLIN(1863)								 ::__hxcpp_memory_set_float(this80->buffer->b,(this80->byteOffset + 240),uvHeight);
            							}
HXLINE(1865)							{
HXLINE(1865)								 ::lime::utils::ArrayBufferView this81 = this->_hx___vertexBufferData;
HXDLIN(1865)								Float val44 = (renderedLeft1 + renderedCenterX3);
HXDLIN(1865)								 ::__hxcpp_memory_set_float(this81->buffer->b,(this81->byteOffset + 280),val44);
            							}
HXLINE(1866)							{
HXLINE(1866)								 ::lime::utils::ArrayBufferView this82 = this->_hx___vertexBufferData;
HXDLIN(1866)								Float val45 = (( (Float)(uvWidth) ) * (uvLeft1 + uvCenterX1));
HXDLIN(1866)								 ::__hxcpp_memory_set_float(this82->buffer->b,(this82->byteOffset + 292),val45);
            							}
HXLINE(1869)							{
HXLINE(1869)								 ::lime::utils::ArrayBufferView this83 = this->_hx___vertexBufferData;
HXDLIN(1869)								Float val46 = ( (Float)(this->width) );
HXDLIN(1869)								 ::__hxcpp_memory_set_float(this83->buffer->b,(this83->byteOffset + 336),val46);
            							}
HXLINE(1870)							{
HXLINE(1870)								 ::lime::utils::ArrayBufferView this84 = this->_hx___vertexBufferData;
HXDLIN(1870)								 ::__hxcpp_memory_set_float(this84->buffer->b,(this84->byteOffset + 340),renderedHeight1);
            							}
HXLINE(1871)							{
HXLINE(1871)								 ::lime::utils::ArrayBufferView this85 = this->_hx___vertexBufferData;
HXDLIN(1871)								 ::__hxcpp_memory_set_float(this85->buffer->b,(this85->byteOffset + 348),uvWidth);
            							}
HXLINE(1872)							{
HXLINE(1872)								 ::lime::utils::ArrayBufferView this86 = this->_hx___vertexBufferData;
HXDLIN(1872)								 ::__hxcpp_memory_set_float(this86->buffer->b,(this86->byteOffset + 352),uvHeight);
            							}
HXLINE(1874)							{
HXLINE(1874)								 ::lime::utils::ArrayBufferView this87 = this->_hx___vertexBufferData;
HXDLIN(1874)								Float val47 = ( (Float)(this->width) );
HXDLIN(1874)								 ::__hxcpp_memory_set_float(this87->buffer->b,(this87->byteOffset + 392),val47);
            							}
HXLINE(1875)							{
HXLINE(1875)								 ::lime::utils::ArrayBufferView this88 = this->_hx___vertexBufferData;
HXDLIN(1875)								 ::__hxcpp_memory_set_float(this88->buffer->b,(this88->byteOffset + 404),uvWidth);
            							}
...
HXDLIN(1887)				this->_hx___vertexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,56,8);
HXLINE(1889)				{
HXLINE(1889)					 ::lime::utils::ArrayBufferView this89 = this->_hx___vertexBufferData;
HXDLIN(1889)					Float val48 = ( (Float)(this->width) );
HXDLIN(1889)					 ::__hxcpp_memory_set_float(this89->buffer->b,this89->byteOffset,val48);
            				}
HXLINE(1890)				{
HXLINE(1890)					 ::lime::utils::ArrayBufferView this90 = this->_hx___vertexBufferData;
HXDLIN(1890)					Float val49 = ( (Float)(this->height) );
HXDLIN(1890)					 ::__hxcpp_memory_set_float(this90->buffer->b,(this90->byteOffset + 4),val49);
            				}
HXLINE(1891)				{
HXLINE(1891)					 ::lime::utils::ArrayBufferView this91 = this->_hx___vertexBufferData;
HXDLIN(1891)					 ::__hxcpp_memory_set_float(this91->buffer->b,(this91->byteOffset + 12),uvWidth);
            				}
HXLINE(1892)				{
HXLINE(1892)					 ::lime::utils::ArrayBufferView this92 = this->_hx___vertexBufferData;
HXDLIN(1892)					 ::__hxcpp_memory_set_float(this92->buffer->b,(this92->byteOffset + 16),uvHeight);
            				}
HXLINE(1893)				{
HXLINE(1893)					 ::lime::utils::ArrayBufferView this93 = this->_hx___vertexBufferData;
HXDLIN(1893)					Float val50 = ( (Float)(this->height) );
HXDLIN(1893)					 ::__hxcpp_memory_set_float(this93->buffer->b,(this93->byteOffset + 60),val50);
            				}
HXLINE(1894)				{
HXLINE(1894)					 ::lime::utils::ArrayBufferView this94 = this->_hx___vertexBufferData;
HXDLIN(1894)					 ::__hxcpp_memory_set_float(this94->buffer->b,(this94->byteOffset + 72),uvHeight);
            				}
HXLINE(1895)				{
HXLINE(1895)					 ::lime::utils::ArrayBufferView this95 = this->_hx___vertexBufferData;
HXDLIN(1895)					Float val51 = ( (Float)(this->width) );
HXDLIN(1895)					 ::__hxcpp_memory_set_float(this95->buffer->b,(this95->byteOffset + 112),val51);
            				}
HXLINE(1896)				{
HXLINE(1896)					 ::lime::utils::ArrayBufferView this96 = this->_hx___vertexBufferData;
HXDLIN(1896)					 ::__hxcpp_memory_set_float(this96->buffer->b,(this96->byteOffset + 124),uvWidth);
            				}
...
HXLINE(2041)			HX_VARI_NAME( int,color1,"color") = color;
HXLINE(2042)			if (((::hx::UShr(color1,24) & 255) == 0)) {
HXLINE(2042)				color1 = 0;
            			}
            		}
HXLINE(2045)		HX_VARI(  ::lime::math::Rectangle,rect) = this->image->getColorBoundsRect(mask,color,findColor,1);
...
HXDLIN(2131)		HX_VARI_NAME(  ::openfl::utils::ByteArrayData,byteArray1,"byteArray") = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(byteArray->getPixels(rect->_hx___toLimeRectangle(),1));
...
HXLINE(2202)			HX_VARI(  ::lime::graphics::Image,textureImage) = this->image;
...
HX_DEFINE_DYNAMIC_FUNC1(BitmapData_obj,getTexture,return )
 ...
 ::openfl::_Vector::IntVector BitmapData_obj::getVector( ::openfl::geom::Rectangle rect){
            	...
            	HX_STACK_ARG(rect,"rect")
HXLINE(2252)
HXLINE(2253)		HX_VARI(  ::openfl::utils::ByteArrayData,pixels) = this->getPixels(rect);
...
HXDLIN(2254)		HX_VARI_NAME( int,length2,"length") = ::Std_obj::_hx_int((length / length1));
HXLINE(2255)		::Array< int > array = null();
HXDLIN(2255)		HX_VARI(  ::openfl::_Vector::IntVector,result) =  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length2,true,array);
HXLINE(2257)		{
HXLINE(2257)			int _g = 0;
HXDLIN(2257)			int _g1 = length2;
HXDLIN(2257)			while((_g < _g1)){
HXLINE(2257)				_g = (_g + 1);
HXDLIN(2257)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(2275)
HXLINE(2276)		HX_VAR(  ::openfl::geom::Rectangle,rect);
...
HXDLIN(2278)					HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN(2278)					HX_VARI_NAME( int,j1,"j") = (_g4 - 1);
...
HXDLIN(2278)					HX_VARI_NAME( int,j2,"j") = (_g6 - 1);
...
HXDLIN(2278)					HX_VARI_NAME( int,j3,"j") = (_g8 - 1);
HXDLIN(2278)					_g7->push(0);
            				}
            			}
HXDLIN(2278)			_g->push(_g7);
            		}
HXDLIN(2278)		HX_VARI( ::Array< ::Dynamic>,result) = _g;
HXLINE(2280)		{
...
HXDLIN(2280)				HX_VARI( int,i) = (_g9 - 1);
...
HXLINE(2333)			HX_VARI(  ::openfl::geom::Point,secondPoint) = ( ( ::openfl::geom::Point)(secondObject) );
HXLINE(2335)			HX_VARI( int,x) = ::Std_obj::_hx_int((secondPoint->x - firstPoint->x));
HXLINE(2336)			HX_VARI( int,y) = ::Std_obj::_hx_int((secondPoint->y - firstPoint->y));
HXLINE(2338)			if (this->rect->contains(( (Float)(x) ),( (Float)(y) ))) {
HXLINE(2340)				HX_VARI( int,pixel) = this->getPixel32(x,y);
...
HXLINE(2350)				HX_VARI(  ::openfl::display::BitmapData,secondBitmapData) = ( ( ::openfl::display::BitmapData)(secondObject) );
HXLINE(2351)				HX_VAR_NAME( int,x1,"x");
HXDLIN(2351)				HX_VAR_NAME( int,y1,"y");
...
HXLINE(2364)				HX_VARI(  ::openfl::geom::Rectangle,hitRect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE(2389)					HX_VARI(  ::openfl::utils::ByteArrayData,pixels) = this->getPixels(hitRect);
...
HXLINE(2394)					HX_VARI(  ::openfl::utils::ByteArrayData,testPixels) = secondBitmapData->getPixels(hitRect);
HXLINE(2396)					HX_VARI( int,length) = ::Std_obj::_hx_int((hitRect->width * hitRect->height));
HXLINE(2397)					HX_VAR_NAME( int,pixel1,"pixel");
HXDLIN(2397)					HX_VAR( int,testPixel);
HXLINE(2399)					{
HXLINE(2399)						int _g = 0;
HXDLIN(2399)						int _g1 = length;
HXDLIN(2399)						while((_g < _g1)){
HXLINE(2399)							_g = (_g + 1);
HXDLIN(2399)							HX_VARI( int,i) = (_g - 1);
...
HXLINE(2416)					HX_VARI(  ::openfl::geom::Rectangle,secondRectangle) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE(2423)						HX_VARI_NAME(  ::openfl::utils::ByteArrayData,pixels1,"pixels") = this->getPixels(secondRectangle);
...
HXDLIN(2424)						HX_VARI_NAME( int,length3,"length") = ::Std_obj::_hx_int((length1 / length2));
HXLINE(2425)						HX_VAR_NAME( int,pixel2,"pixel");
HXLINE(2427)						{
HXLINE(2427)							int _g2 = 0;
HXDLIN(2427)							int _g3 = length3;
HXDLIN(2427)							while((_g2 < _g3)){
HXLINE(2427)								_g2 = (_g2 + 1);
HXDLIN(2427)								HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXLINE(2606)
HXDLIN(2606)		HX_VARI_NAME( ::Array< int >,randomSeed1,"randomSeed") = ::Array_obj< int >::__new(1)->init(0,randomSeed);
HXLINE(2607)		if (!(this->readable)) {
HXLINE(2607)			return;
            		}
HXLINE(2612)		HX_VARI(  ::Dynamic,func) =  ::Dynamic(new _hx_Closure_0(randomSeed1));
HXLINE(2610)		HX_VARI(  ::Dynamic,rand) = func;
HXLINE(2618)		rand();
HXLINE(2621)		HX_VARI( int,range) = (high - low);
HXLINE(2623)		HX_VARI( bool,redChannel) = ((channelOptions & 1) == 1);
HXLINE(2624)		HX_VARI( bool,greenChannel) = (((channelOptions & 2) >> 1) == 1);
HXLINE(2625)		HX_VARI( bool,blueChannel) = (((channelOptions & 4) >> 2) == 1);
HXLINE(2626)		HX_VARI( bool,alphaChannel) = (((channelOptions & 8) >> 3) == 1);
HXLINE(2628)		{
HXLINE(2628)			int _g = 0;
HXDLIN(2628)			int _g1 = this->height;
HXDLIN(2628)			while((_g < _g1)){
HXLINE(2628)				_g = (_g + 1);
HXDLIN(2628)				HX_VARI( int,y) = (_g - 1);
HXLINE(2630)				{
HXLINE(2630)					int _g2 = 0;
HXDLIN(2630)					int _g3 = this->width;
HXDLIN(2630)					while((_g2 < _g3)){
HXLINE(2630)						_g2 = (_g2 + 1);
HXDLIN(2630)						HX_VARI( int,x) = (_g2 - 1);
HXLINE(2633)						HX_VARI( int,red) = 0;
HXLINE(2634)						HX_VARI( int,blue) = 0;
HXLINE(2635)						HX_VARI( int,green) = 0;
HXLINE(2636)						HX_VARI( int,alpha) = 255;
...
HXLINE(2651)						HX_VARI( int,rgb) = alpha;
...
HXLINE(2703)
HXLINE(2704)		HX_VARI( int,sw) = ::Std_obj::_hx_int(sourceRect->width);
HXLINE(2705)		HX_VARI( int,sh) = ::Std_obj::_hx_int(sourceRect->height);
HXLINE(2707)		HX_VARI(  ::openfl::utils::ByteArrayData,pixels) = sourceBitmapData->getPixels(sourceRect);
HXLINE(2709)		HX_VAR( int,pixelValue);
HXDLIN(2709)		HX_VAR( int,r);
HXDLIN(2709)		HX_VAR( int,g);
HXDLIN(2709)		HX_VAR( int,b);
HXDLIN(2709)		HX_VAR( int,a);
HXDLIN(2709)		HX_VAR( int,color);
HXLINE(2711)		{
HXLINE(2711)			int _g = 0;
HXDLIN(2711)			int _g1 = (sh * sw);
HXDLIN(2711)			while((_g < _g1)){
HXLINE(2711)				_g = (_g + 1);
HXDLIN(2711)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(2727)		HX_VARI(  ::openfl::geom::Rectangle,destRect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE(2803)		HX_VARI(  ::openfl::display::_internal::PerlinNoise,noise) =  ::openfl::display::_internal::PerlinNoise_obj::__alloc( HX_CTX ,randomSeed,numOctaves,channelOptions,grayScale,((Float)0.5),stitch,((Float)0.15));
...
HXLINE(2909)		HX_VARI( Float,length) = ((rect->width * rect->height) * ( (Float)(4) ));
...
HXLINE(2927)
HXLINE(2928)		HX_VARI(  ::openfl::utils::ByteArrayData,byteArray) =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0);
HXLINE(2929)		::openfl::utils::_ByteArray::ByteArray_Impl__obj::set_length(byteArray,(inputVector->get_length() * 4));
HXLINE(2931)		{
HXLINE(2931)			HX_VARI(  ::Dynamic,color) = inputVector->iterator();
HXDLIN(2931)			while(( (bool)(color->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2931)				HX_VARI_NAME( int,color1,"color") = ( (int)(color->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(3025)
HXLINE(3031)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = this->image->buffer->data;
HXLINE(3033)		{
...
HXLINE(3033)				_g = (_g + 1);
HXDLIN(3033)				HX_VARI( int,i) = (_g - 1);
HXLINE(3035)				{
...
HXLINE(3042)
HXLINE(3044)		HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = renderer->cairo;
...
void BitmapData_obj::_hx___drawCanvas(::Dynamic source, ::openfl::display::CanvasRenderer renderer){
            	...
            	HX_STACK_ARG(renderer,"renderer")
HXLINE(3065)
HXLINE(3066)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = this->image->buffer;
...
void BitmapData_obj::_hx___drawGL(::Dynamic source, ::openfl::display::OpenGLRenderer renderer){
            	...
            	HX_STACK_ARG(renderer,"renderer")
HXLINE(3083)
HXLINE(3084)		HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(3086)		HX_VARI(  ::openfl::display3D::textures::TextureBase,cacheRTT) = context->_hx___state->renderToTexture;
HXLINE(3087)		HX_VARI( bool,cacheRTTDepthStencil) = context->_hx___state->renderToTextureDepthStencil;
HXLINE(3088)		HX_VARI( int,cacheRTTAntiAlias) = context->_hx___state->renderToTextureAntiAlias;
HXLINE(3089)		HX_VARI( int,cacheRTTSurfaceSelector) = context->_hx___state->renderToTextureSurfaceSelector;
...
HXLINE(3120)			HX_VARI(  ::openfl::display::OpenGLRenderer,renderer) = ( ( ::openfl::display::OpenGLRenderer)(::openfl::Lib_obj::get_current()->stage->_hx___renderer) );
HXLINE(3121)			HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(3122)			HX_VARI_NAME( int,color1,"color") = color;
HXLINE(3123)			HX_VARI( bool,useScissor) = !(this->rect->equals(rect));
HXLINE(3125)			HX_VARI(  ::openfl::display3D::textures::TextureBase,cacheRTT) = context->_hx___state->renderToTexture;
HXLINE(3126)			HX_VARI( bool,cacheRTTDepthStencil) = context->_hx___state->renderToTextureDepthStencil;
HXLINE(3127)			HX_VARI( int,cacheRTTAntiAlias) = context->_hx___state->renderToTextureAntiAlias;
HXLINE(3128)			HX_VARI( int,cacheRTTSurfaceSelector) = context->_hx___state->renderToTextureSurfaceSelector;
...
HXLINE(3161)
HXLINE(3163)		HX_VARI(  ::lime::graphics::Image,image) = ::lime::graphics::Image_obj::fromBase64(base64,type);
...
HXLINE(3169)
HXLINE(3171)		HX_VARI(  ::lime::graphics::Image,image) = ::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes));
...
HXLINE(3182)
HXLINE(3184)		HX_VARI(  ::lime::graphics::Image,image) = ::lime::graphics::Image_obj::fromFile(path);
...
void BitmapData_obj::_hx___getBounds( ::openfl::geom::Rectangle rect, ::openfl::geom::Matrix matrix){
            	...
            	HX_STACK_ARG(matrix,"matrix")
HXLINE(3216)
HXLINE(3217)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
void BitmapData_obj::_hx___setUVRect( ::openfl::display3D::Context3D context,Float x,Float y,Float width,Float height){
            	...
            	HX_STACK_ARG(height,"height")
HXLINE(3307)
HXLINE(3308)		HX_VARI(  ::openfl::display3D::VertexBuffer3D,buffer) = this->getVertexBuffer(context,null(),null());
...
HXLINE(3312)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXLINE(3319)			HX_VAR( Float,uvWidth);
...
HXLINE(3320)			HX_VAR( Float,uvHeight);
...
int BitmapData_obj::_hx___textureInternalFormat;
 ...
 ::openfl::display::BitmapData BitmapData_obj::fromBase64(::String base64,::String type){
            	...
            	HX_STACK_ARG(type,"type")
HXLINE(1198)
HXLINE(1202)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,0,0,true,0);
HXLINE(1203)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(BitmapData_obj,fromBase64,return )
 ...
 ::openfl::display::BitmapData BitmapData_obj::fromBytes( ::openfl::utils::ByteArrayData bytes, ::openfl::utils::ByteArrayData rawAlpha){
            	...
            	HX_STACK_ARG(rawAlpha,"rawAlpha")
HXLINE(1226)
HXLINE(1230)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,0,0,true,0);
HXLINE(1231)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(BitmapData_obj,fromBytes,return )
 ...
 ::openfl::display::BitmapData BitmapData_obj::fromFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE(1274)
HXLINE(1278)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,0,0,true,0);
...
HXLINE(1299)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,0,0,transparent,0);
...
HXLINE(1320)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,texture->_hx___width,texture->_hx___height,true,0);
 ...
 ::lime::app::Future BitmapData_obj::loadFromBytes( ::openfl::utils::ByteArrayData bytes, ::openfl::utils::ByteArrayData rawAlpha){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::openfl::utils::ByteArrayData,rawAlpha) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::graphics::Image image){
            			...
            			HX_STACK_ARG(image,"image")
HXLINE(2484)
HXLINE(2485)			HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ::openfl::display::BitmapData_obj::fromImage(image,null());
