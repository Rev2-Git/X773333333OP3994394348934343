...
HXLINE(1096)			HX_VARI( ::Array< ::Dynamic>,dispatchers) = ( (::Array< ::Dynamic>)(::openfl::display::DisplayObject_obj::_hx___broadcastEvents->get(type)) );
...
HXLINE(1122)			HX_VARI(  ::openfl::events::MouseEvent,mouseEvent) = ( ( ::openfl::events::MouseEvent)(event) );
...
HXLINE(1128)				HX_VARI(  ::openfl::events::TouchEvent,touchEvent) = ( ( ::openfl::events::TouchEvent)(event) );
...
HXLINE(1163)
HXLINE(1164)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE(1170)			HX_VARI(  ::openfl::geom::Matrix,targetMatrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE(1184)		HX_VARI(  ::openfl::geom::Rectangle,bounds) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
...
HXLINE(1252)			HX_VARI(  ::openfl::geom::Rectangle,currentBounds) = this->getBounds(::hx::ObjectPtr<OBJ_>(this));
HXLINE(1253)			HX_VARI(  ::openfl::geom::Rectangle,targetBounds) = obj->getBounds(::hx::ObjectPtr<OBJ_>(this));
...
HXLINE(1399)			HX_VARI( bool,result) = this->super::_hx___dispatchEvent(event);
...
bool DisplayObject_obj::_hx___dispatchEvent( ::openfl::events::Event event){
            	...
            	HX_STACK_ARG(event,"event")
HXLINE(1415)
HXLINE(1416)		HX_VAR(  ::openfl::display::DisplayObjectContainer,parent);
...
HXLINE(1417)		HX_VARI( bool,result) = this->super::_hx___dispatchEvent(event);
...
HXLINE(1456)				HX_VARI(  ::openfl::_Vector::ObjectVector,stack) = ::openfl::display::DisplayObject_obj::_hx___tempStack->get().StaticCast<  ::openfl::_Vector::ObjectVector >();
HXLINE(1457)				HX_VARI(  ::openfl::display::DisplayObjectContainer,parent) = this->parent;
HXLINE(1458)				HX_VARI( int,i) = 0;
...
HXLINE(1467)						_g = (_g + 1);
HXDLIN(1467)						HX_VARI( int,j) = (_g - 1);
...
HXLINE(1502)			HX_VARI(  ::openfl::geom::Rectangle,extension) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(1504)			{
HXLINE(1504)				int _g = 0;
HXDLIN(1504)				::Array< ::Dynamic> _g1 = this->_hx___filters;
HXDLIN(1504)				while((_g < _g1->length)){
HXLINE(1504)					HX_VARI(  ::openfl::filters::BitmapFilter,filter) = _g1->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN(1504)					_g = (_g + 1);
...
HXLINE(1552)			HX_VARI(  ::openfl::geom::Rectangle,r) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,_hx___getRenderTransform,return )
 ...
 ::openfl::geom::Matrix DisplayObject_obj::_hx___getWorldTransform(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1567)
HXLINE(1568)		HX_VAR( bool,transformDirty);
...
HXLINE(1572)			HX_VARI( ::Array< ::Dynamic>,list) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1573)			HX_VARI(  ::openfl::display::DisplayObject,current) = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE(1590)			HX_VARI( int,i) = list->length;
...
void DisplayObject_obj::_hx___setParentRenderDirty(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1661)
HXLINE(1662)		HX_VAR(  ::openfl::display::DisplayObject,renderParent);
...
HXLINE(1703)
HXLINE(1704)		HX_VAR(  ::openfl::display::DisplayObject,renderParent);
...
HXLINE(1828)
HXLINE(1829)		HX_VARI( bool,overrided) = ::hx::IsNotNull( overrideTransform );
HXLINE(1830)		HX_VAR(  ::openfl::geom::Matrix,local);
...
HXLINE(1842)		HX_VAR(  ::openfl::display::DisplayObject,renderParent);
...
HXLINE(1938)			HX_VARI( ::Array< ::Dynamic>,clonedFilters) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1940)			{
HXLINE(1940)				int _g = 0;
HXDLIN(1940)				while((_g < value->length)){
HXLINE(1940)					HX_VARI(  ::openfl::filters::BitmapFilter,filter) = value->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN(1940)					_g = (_g + 1);
HXLINE(1941)					HX_VARI(  ::openfl::filters::BitmapFilter,clonedFilter) = filter->clone();
...
Float DisplayObject_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1962)
HXLINE(1963)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(1964)		this->_hx___getLocalBounds(rect);
HXLINE(1965)		HX_VARI( Float,height) = rect->height;
...
Float DisplayObject_obj::set_height(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(1971)
HXLINE(1972)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(1973)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
Float DisplayObject_obj::get_mouseX(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2045)
HXLINE(2046)		HX_VAR( Float,mouseX);
...
HXLINE(2047)		HX_VAR( Float,mouseY);
...
Float DisplayObject_obj::get_mouseY(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2053)
HXLINE(2054)		HX_VAR( Float,mouseX);
...
HXLINE(2055)		HX_VAR( Float,mouseY);
...
HXLINE(2090)			HX_VARI( Float,radians) = (this->_hx___rotation * (::Math_obj::PI / ( (Float)(180) )));
...
HXLINE(2153)				HX_VARI( Float,a) = (this->_hx___rotationCosine * value);
HXLINE(2154)				HX_VARI( Float,b) = (this->_hx___rotationSine * value);
...
HXLINE(2187)				HX_VARI( Float,c) = (-(this->_hx___rotationSine) * value);
HXLINE(2188)				HX_VARI( Float,d) = (this->_hx___rotationCosine * value);
...
Float DisplayObject_obj::get_width(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2297)
HXLINE(2298)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2299)		this->_hx___getLocalBounds(rect);
HXLINE(2300)		HX_VARI( Float,width) = rect->width;
...
Float DisplayObject_obj::set_width(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(2306)
HXLINE(2307)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2308)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
