...
HXLINE(  49)		this->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,HX_("_sans",32,a0,5e,ff),12,color,null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
...
void FPS_obj::_hx___enterFrame(int _tmp_deltaTime){
            	...
            	HX_STACK_THIS(this)
HXLINE(  70)
HXLINE(  71)		HX_VARI( Float,deltaTime) = ( (Float)(_tmp_deltaTime) );
...
HXLINE(  79)		HX_VARI( int,currentCount) = this->times->length;
...
HXLINE(  86)			HX_VARI( Float,memoryMegas) = ( (Float)(0) );
HXLINE(  88)			if ((::ClientPrefs_obj::baseGameUI == HX_("Psych Engine",47,a4,90,86))) {
HXLINE(  91)				memoryMegas = ::Math_obj::abs(::flixel::math::FlxMath_obj::roundDecimal((( (Float)(::openfl::_hx_system::System_obj::get_totalMemory()) ) / ( (Float)(1000000) )),1));
HXLINE(  92)				this->set_text((this->get_text() + ((HX_("\nMemory: ",11,56,a9,a3) + memoryMegas) + HX_(" MB",75,8b,18,00))));
            			}
HXLINE(  97)			this->set_textColor(-1);
HXLINE(  98)			bool _hx_tmp1;
HXDLIN(  98)			if (!((memoryMegas > 3000))) {
HXLINE(  98)				_hx_tmp1 = (this->currentFPS <= (( (Float)(::ClientPrefs_obj::framerate) ) / ( (Float)(2) )));
            			}
            			else {
HXLINE(  98)				_hx_tmp1 = true;
            			}
HXDLIN(  98)			if (_hx_tmp1) {
HXLINE( 100)				this->set_textColor(-65536);
            			}
HXLINE( 109)			this->set_text((this->get_text() + HX_("\n",0a,00,00,00)));
            		}
HXLINE( 112)		this->cacheCount = currentCount;
            	}
