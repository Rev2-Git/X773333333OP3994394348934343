...
HXLINE( 272)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
HXDLIN( 272)				_g = (_g + 1);
...
HXLINE( 277)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 282)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 319)
HXLINE( 320)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 322)		HX_VARI(  ::lime::graphics::opengl::GLObject,shader) = gl->createShader(type);
HXLINE( 323)		gl->shaderSource(shader,source);
HXLINE( 324)		gl->compileShader(shader);
HXLINE( 325)		HX_VARI( ::String,shaderInfoLog) = gl->getShaderInfoLog(shader);
HXLINE( 326)		HX_VAR( bool,hasInfoLog);
...
HXLINE( 327)		HX_VARI( int,compileStatus) = ( (int)(gl->getShaderParameter(shader,gl->COMPILE_STATUS)) );
...
HXLINE( 331)			HX_VAR( ::String,message);
...
HXLINE( 343)
HXLINE( 344)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 346)		HX_VARI(  ::lime::graphics::opengl::GLObject,vertexShader) = this->_hx___createGLShader(vertexSource,gl->VERTEX_SHADER);
HXLINE( 347)		HX_VARI(  ::lime::graphics::opengl::GLObject,fragmentShader) = this->_hx___createGLShader(fragmentSource,gl->FRAGMENT_SHADER);
HXLINE( 349)		HX_VARI(  ::lime::graphics::opengl::GLObject,program) = gl->createProgram();
HXLINE( 352)		{
HXLINE( 352)			int _g = 0;
HXDLIN( 352)			::Array< ::Dynamic> _g1 = this->_hx___paramFloat;
HXDLIN( 352)			while((_g < _g1->length)){
HXLINE( 352)				HX_VARI(  ::openfl::display::ShaderParameter_Float,param) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 352)				_g = (_g + 1);
...
HXLINE( 367)			HX_VARI( ::String,message) = HX_("Unable to initialize the shader program",f0,86,8b,39);
...
void Shader_obj::_hx___disableGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 384)
HXLINE( 385)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 387)		HX_VARI( int,textureCount) = 0;
HXLINE( 389)		{
HXLINE( 389)			int _g = 0;
HXDLIN( 389)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 389)			while((_g < _g1->length)){
HXLINE( 389)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 389)				_g = (_g + 1);
...
HXLINE( 396)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 401)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 406)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
void Shader_obj::_hx___enableGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 432)
HXLINE( 433)		HX_VARI( int,textureCount) = 0;
HXLINE( 435)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 437)		{
HXLINE( 437)			int _g = 0;
HXDLIN( 437)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 437)			while((_g < _g1->length)){
HXLINE( 437)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 437)				_g = (_g + 1);
...
HXLINE( 483)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 488)			HX_VARI_NAME( ::String,prefix1,"prefix") = ((HX_("#ifdef GL_ES\n",3d,09,5c,91) + prefix) + HX_("#endif\n\n",75,fd,e5,0e));
HXLINE( 497)			HX_VARI( ::String,vertex) = (prefix1 + this->get_glVertexSource());
HXLINE( 498)			HX_VARI( ::String,fragment) = (prefix1 + this->get_glFragmentSource());
HXLINE( 500)			HX_VARI( ::String,id) = (vertex + fragment);
...
HXLINE( 521)						HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 521)						_g = (_g + 1);
...
HXLINE( 533)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 545)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 557)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 573)
HXLINE( 574)		HX_VARI( int,lastMatch) = 0;
HXDLIN( 574)		HX_VAR(  ::Dynamic,position);
HXDLIN( 574)		HX_VAR(  ::EReg,regex);
HXDLIN( 574)		HX_VAR( ::String,name);
HXDLIN( 574)		HX_VAR( ::String,type);
...
HXLINE( 595)			HX_VARI( bool,isUniform) = (storageType == HX_("uniform",34,41,64,b5));
HXLINE( 597)			if (::StringTools_obj::startsWith(type,HX_("sampler",08,c5,c9,83))) {
HXLINE( 599)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) =  ::openfl::display::ShaderInput_openfl_display_BitmapData_obj::__alloc( HX_CTX );
...
HXLINE( 618)					HX_VAR(  ::Dynamic,parameterType);
...
HXLINE( 644)						length = 1;
            					...
            					_hx_goto_26:;
HXLINE( 654)					HX_VAR( int,arrayLength);
...
HXLINE( 665)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) =  ::openfl::display::ShaderParameter_Bool_obj::__alloc( HX_CTX );
...
HXLINE( 683)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter1,"parameter") =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
...
HXLINE( 682)						goto _hx_goto_29;
            					...
            					/* default */{
HXLINE( 695)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter2,"parameter") =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
...
void Shader_obj::_hx___updateGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 749)
HXLINE( 750)		HX_VARI( int,textureCount) = 0;
HXLINE( 752)		{
HXLINE( 752)			int _g = 0;
HXDLIN( 752)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 752)			while((_g < _g1->length)){
HXLINE( 752)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 752)				_g = (_g + 1);
...
HXLINE( 758)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 763)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 768)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
void Shader_obj::_hx___updateGLFromBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer,int bufferOffset){
            	...
            	HX_STACK_ARG(bufferOffset,"bufferOffset")
HXLINE( 775)
HXLINE( 776)		HX_VARI( int,textureCount) = 0;
HXLINE( 777)		HX_VAR(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input);
HXDLIN( 777)		HX_VAR(  ::openfl::display::BitmapData,inputData);
HXDLIN( 777)		HX_VAR(  ::Dynamic,inputFilter);
HXDLIN( 777)		HX_VAR(  ::Dynamic,inputMipFilter);
HXDLIN( 777)		HX_VAR(  ::Dynamic,inputWrap);
HXLINE( 779)		{
HXLINE( 779)			int _g = 0;
HXDLIN( 779)			int _g1 = shaderBuffer->inputCount;
HXDLIN( 779)			while((_g < _g1)){
HXLINE( 779)				_g = (_g + 1);
HXDLIN( 779)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 794)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 815)		HX_VARI( int,boolIndex) = 0;
HXLINE( 816)		HX_VARI( int,floatIndex) = 0;
HXLINE( 817)		HX_VARI( int,intIndex) = 0;
HXLINE( 819)		HX_VARI( int,boolCount) = shaderBuffer->paramBoolCount;
HXLINE( 820)		HX_VARI( int,floatCount) = shaderBuffer->paramFloatCount;
HXLINE( 821)		HX_VARI(  ::lime::utils::ArrayBufferView,paramData) = shaderBuffer->paramData;
HXLINE( 823)		HX_VAR(  ::openfl::display::ShaderParameter_Bool,boolRef);
HXDLIN( 823)		HX_VAR(  ::openfl::display::ShaderParameter_Float,floatRef);
HXDLIN( 823)		HX_VAR(  ::openfl::display::ShaderParameter_Int,intRef);
HXDLIN( 823)		HX_VAR( bool,hasOverride);
HXLINE( 824)		HX_VARI( ::Array< bool >,overrideBoolValue) = null();
HXDLIN( 824)		HX_VARI( ::Array< Float >,overrideFloatValue) = null();
HXDLIN( 824)		HX_VARI( ::Array< int >,overrideIntValue) = null();
HXLINE( 828)		{
HXLINE( 828)			int _g2 = 0;
HXDLIN( 828)			int _g3 = shaderBuffer->paramCount;
HXDLIN( 828)			while((_g2 < _g3)){
HXLINE( 828)				_g2 = (_g2 + 1);
HXDLIN( 828)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXDLIN( 836)							HX_VARI( int,j) = (_g4 - 1);
...
HXDLIN( 861)								HX_VARI_NAME( int,j1,"j") = (_g6 - 1);
...
HXDLIN( 886)								HX_VARI_NAME( int,j2,"j") = (_g8 - 1);
