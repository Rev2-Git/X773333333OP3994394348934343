...
HXLINE( 357)									HX_VAR(  ::openfl::geom::Rectangle,end);
HXDLIN( 357)									HX_VARI(  ::openfl::geom::Rectangle,start) = textField->getCharBoundaries(selectionStart);
...
HXLINE( 375)										_hx_tmp28 = ::hx::IsNotNull( end );
            									}
            									else {
...
HXLINE( 384)										HX_VARI( ::Array< ::Dynamic>,selectedGylphs) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 386)										selectionStart = (selectionStart - group1->startIndex);
HXLINE( 387)										selectionEnd = (selectionEnd - group1->startIndex);
HXLINE( 388)										{
HXLINE( 388)											int _g8 = selectionStart;
HXDLIN( 388)											int _g9 = selectionEnd;
HXDLIN( 388)											while((_g8 < _g9)){
HXLINE( 388)												_g8 = (_g8 + 1);
HXDLIN( 388)												HX_VARI_NAME( int,i3,"i") = (_g8 - 1);
HXLINE( 389)												selectedGylphs->push(glyphs->__get(i3).StaticCast<  ::lime::graphics::cairo::CairoGlyph >());
            											}
            										}
...
HXLINE( 403)							HX_VARI( int,descent) = ::Math_obj::floor((group1->ascent * ((Float)0.185)));
HXLINE( 404)							HX_VARI_NAME( Float,x1,"x") = ((group1->offsetX + scrollX) - bounds->x);
HXLINE( 405)							HX_VARI_NAME( Float,y1,"y") = ((::Math_obj::ceil((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + descent) + ((Float)0.5));
HXLINE( 406)							cairo->moveTo(x1,y1);
HXLINE( 407)							cairo->lineTo((x1 + group1->width),y1);
...
HXLINE( 414)			bool _hx_tmp29;
HXDLIN( 414)			bool _hx_tmp30;
HXDLIN( 414)			if ((textField->_hx___caretIndex > -1)) {
HXLINE( 414)				_hx_tmp30 = textEngine->selectable;
            			}
            			else {
HXLINE( 414)				_hx_tmp30 = false;
            			}
HXDLIN( 414)			if (_hx_tmp30) {
HXLINE( 414)				_hx_tmp29 = textField->_hx___showCursor;
            			}
            			else {
HXLINE( 414)				_hx_tmp29 = false;
            			}
HXDLIN( 414)			if (_hx_tmp29) {
HXLINE( 416)				Float scrollX1;
HXDLIN( 416)				if (useTextBounds1) {
HXLINE( 416)					scrollX1 = ( (Float)(0) );
            				}
            				else {
HXLINE( 416)					scrollX1 = cursorOffsetX;
            				}
HXDLIN( 416)				HX_VARI_NAME( Float,scrollX2,"scrollX") = (-(textField->get_scrollH()) + scrollX1);
HXLINE( 417)				HX_VARI_NAME( Float,scrollY2,"scrollY") = ((Float)0.0);
HXLINE( 419)				{
HXLINE( 419)					int _g10 = 0;
HXDLIN( 419)					int _g11 = (textField->get_scrollV() - 1);
HXDLIN( 419)					while((_g10 < _g11)){
HXLINE( 419)						_g10 = (_g10 + 1);
HXDLIN( 419)						HX_VARI_NAME( int,i4,"i") = (_g10 - 1);
HXLINE( 421)						scrollY2 = (scrollY2 + textEngine->lineHeights->get(i4));
            					}
            				}
HXLINE( 424)				HX_VARI_NAME(  ::Dynamic,color3,"color") = textField->get_defaultTextFormat()->color;
HXLINE( 425)				HX_VARI_NAME( Float,r3,"r") = (( (Float)(::hx::UShr((( (int)(color3) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 426)				HX_VARI_NAME( Float,g3,"g") = (( (Float)(::hx::UShr((( (int)(color3) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 427)				HX_VARI_NAME( Float,b3,"b") = (( (Float)((( (int)(color3) ) & 255)) ) / ( (Float)(255) ));
HXLINE( 429)				cairo->setSourceRGB(r3,g3,b3);
HXLINE( 431)				cairo->newPath();
HXLINE( 432)				cairo->moveTo((scrollX2 + ((Float)2.5)),(scrollY2 + ((Float)2.5)));
HXLINE( 433)				cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 434)				cairo->lineTo((scrollX2 + ((Float)2.5)),((scrollY2 + ::openfl::text::_internal::TextEngine_obj::getFormatHeight(textField->get_defaultTextFormat())) - ( (Float)(1) )));
...
HXLINE( 454)					_hx_tmp2 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE( 454)					_hx_tmp2 = false;
            				}
HXDLIN( 454)				if (_hx_tmp2) {
HXLINE( 454)					_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXDLIN( 454)						int _hx_tmp3;
HXDLIN( 454)						bool _hx_tmp4;
HXDLIN( 454)						if (renderer->_hx___allowSmoothing) {
HXLINE( 454)							_hx_tmp4 = bitmap->smoothing;
            						}
            						else {
HXLINE( 454)							_hx_tmp4 = false;
            						}
HXDLIN( 454)						if (_hx_tmp4) {
HXLINE( 454)							_hx_tmp3 = 1;
            						}
            						else {
HXLINE( 454)							_hx_tmp3 = 3;
            						}
HXDLIN( 454)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);
