...
HXLINE( 466)
HXLINE( 467)		HX_VARI( Float,max) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 468)		HX_VARI( Float,tmp) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 469)		HX_VARI( int,len) = uvt->get_length();
HXLINE( 471)		{
HXLINE( 471)			int _g = 1;
HXDLIN( 471)			int _g1 = (len + 1);
HXDLIN( 471)			while((_g < _g1)){
HXLINE( 471)				_g = (_g + 1);
HXDLIN( 471)				HX_VARI( int,t) = (_g - 1);
...
HXDLIN( 491)		HX_VARI(  ::openfl::_Vector::FloatVector,result) =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,array,true);
HXLINE( 493)		{
HXLINE( 493)			int _g2 = 1;
HXDLIN( 493)			int _g3 = (len + 1);
HXDLIN( 493)			while((_g2 < _g3)){
HXLINE( 493)				_g2 = (_g2 + 1);
HXDLIN( 493)				HX_VARI_NAME( int,t1,"t") = (_g2 - 1);
