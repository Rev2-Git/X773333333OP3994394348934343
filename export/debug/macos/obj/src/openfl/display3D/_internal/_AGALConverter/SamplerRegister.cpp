...
HXDLIN( 881)		HX_VARI_NAME( ::String,str1,"str") = (str + this->n);
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::display::_internal::SamplerState SamplerRegister_obj::toSamplerState(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 886)
HXLINE( 887)		HX_VAR(  ::Dynamic,wrap);
HXLINE( 888)		HX_VAR(  ::Dynamic,filter);
HXLINE( 889)		HX_VAR(  ::Dynamic,mipfilter);
...
HXLINE( 933)		HX_VARI( bool,ignoreSampler) = ((this->s & 4) == 4);
HXLINE( 934)		HX_VARI( bool,centroid) = ((this->s & 1) == 1);
HXLINE( 935)		HX_VARI( bool,textureAlpha) = (this->t == 2);
HXLINE( 938)		HX_VARI( Float,lodBias) = (( (Float)(((this->b << 24) >> 24)) ) / ((Float)8.0));
...
HXLINE( 864)
HXLINE( 865)		HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::SamplerRegister,sr) =  ::openfl::display3D::_internal::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
