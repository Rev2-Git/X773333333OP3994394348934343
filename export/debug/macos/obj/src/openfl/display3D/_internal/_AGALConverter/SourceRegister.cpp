...
HXLINE( 985)		HX_VAR( bool,fullxyzw);
...
HXLINE( 986)		HX_VARI( ::String,swizzle) = HX_("",00,00,00,00);
...
HXLINE(1010)		HX_VARI( ::String,str) = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1012)		if ((this->d == 0)) {
HXLINE(1015)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1020)			str = (str + this->o);
HXLINE(1021)			HX_VARI( ::String,indexComponent) = HX_("",00,00,00,00);
...
HXDLIN(1033)			HX_VARI_NAME( ::String,indexRegister1,"indexRegister") = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent);
...
HXLINE( 964)
HXLINE( 965)		HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::SourceRegister,sr) =  ::openfl::display3D::_internal::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
