...
bool Event_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event Event_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 766)
HXLINE( 767)		HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable);
...
::String Event_obj::formatToString(::String className,::String p1,::String p2,::String p3,::String p4,::String p5){
            	...
            	HX_STACK_ARG(p5,"p5")
HXLINE( 799)
HXLINE( 800)		HX_VARI( ::Array< ::String >,parameters) = ::Array_obj< ::String >::__new(0);
...
HXLINE( 887)
HXLINE( 890)		HX_VARI( ::String,output) = (HX_("[",5b,00,00,00) + className);
HXLINE( 891)		HX_VARI(  ::Dynamic,arg) = null();
HXLINE( 893)		{
HXLINE( 893)			int _g = 0;
HXDLIN( 893)			while((_g < parameters->length)){
HXLINE( 893)				HX_VARI( ::String,param) = parameters->__get(_g);
HXDLIN( 893)				_g = (_g + 1);
