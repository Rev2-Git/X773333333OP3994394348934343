...
HXLINE( 199)			HX_VARI_NAME( ::Array< ::Dynamic>,list1,"list") = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(type)) );
HXLINE( 201)			{
HXLINE( 201)				int _g = 0;
...
HXLINE( 208)					HX_VARI_NAME(  ::openfl::events::_EventDispatcher::DispatchIterator,iterator1,"iterator") = iterators->__get(_g2).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
...
HXLINE( 304)							HX_VARI(  ::openfl::events::_EventDispatcher::DispatchIterator,iterator) = iterators->__get(_g2).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
...
HXLINE( 395)				HX_VARI_NAME(  ::openfl::events::_EventDispatcher::Listener,listener1,"listener") = listener->next();
