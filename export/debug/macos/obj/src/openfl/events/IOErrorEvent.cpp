...
bool IOErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event IOErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 111)
HXLINE( 112)		HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
