...
bool KeyboardEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event KeyboardEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 186)
HXLINE( 187)		HX_VARI(  ::openfl::events::KeyboardEvent,event) =  ::openfl::events::KeyboardEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
