...
bool TouchEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TouchEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 475)
HXLINE( 476)		HX_VARI(  ::openfl::events::TouchEvent,event) =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->touchPointID,this->isPrimaryTouchPoint,this->localX,this->localY,this->sizeX,this->sizeY,this->pressure,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->commandKey,this->controlKey,null(),null(),null(),null());
...
HXLINE( 501)
HXLINE( 502)		HX_VARI(  ::openfl::events::TouchEvent,evt) =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,0,true,local->x,local->y,1,1,1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
