...
HXDLIN( 188)		HX_VARI_NAME(  ::lime::graphics::Image,finalImage2,"finalImage") = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,null(),null());
...
HXDLIN( 190)		HX_VARI_NAME( Float,elapsed1,"elapsed") = (elapsed - time);
...
HXLINE( 202)			HX_VARI( Float,scale) = ::Math_obj::pow(((Float)0.5),( (Float)((pass >> 1)) ));
...
HXLINE( 208)			HX_VARI_NAME( Float,scale1,"scale") = ::Math_obj::pow(((Float)0.5),( (Float)(((pass - this->_hx___horizontalPasses) >> 1)) ));
