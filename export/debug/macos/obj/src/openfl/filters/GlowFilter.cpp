...
HXLINE( 259)
HXLINE( 263)		HX_VARI( int,r) = ((this->_hx___color >> 16) & 255);
HXLINE( 264)		HX_VARI( int,g) = ((this->_hx___color >> 8) & 255);
HXLINE( 265)		HX_VARI( int,b) = (this->_hx___color & 255);
...
HXDLIN( 267)		HX_VARI_NAME(  ::lime::graphics::Image,finalImage2,"finalImage") = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,this->_hx___strength,null());
...
HXDLIN( 285)		HX_VARI_NAME( int,blurPass1,"blurPass") = (pass - blurPass);
HXLINE( 286)		HX_VARI( int,numBlurPasses) = (this->_hx___horizontalPasses + this->_hx___verticalPasses);
HXLINE( 288)		if ((blurPass1 < numBlurPasses)) {
HXLINE( 290)			HX_VARI(  ::openfl::filters::_GlowFilter::BlurAlphaShader,shader) = ::openfl::filters::GlowFilter_obj::_hx___blurAlphaShader;
HXLINE( 291)			if ((blurPass1 < this->_hx___horizontalPasses)) {
HXLINE( 293)				HX_VARI( Float,scale) = (::Math_obj::pow(((Float)0.5),( (Float)((blurPass1 >> 1)) )) * ((Float)0.5));
HXLINE( 294)				shader->uRadius->value[0] = (this->get_blurX() * scale);
HXLINE( 295)				shader->uRadius->value[1] = ( (Float)(0) );
            			}
            			else {
HXLINE( 299)				HX_VARI_NAME( Float,scale1,"scale") = (::Math_obj::pow(((Float)0.5),( (Float)(((blurPass1 - this->_hx___horizontalPasses) >> 1)) )) * ((Float)0.5));
...
HXLINE( 314)				HX_VARI_NAME(  ::openfl::filters::_GlowFilter::InnerCombineKnockoutShader,shader1,"shader") = ::openfl::filters::GlowFilter_obj::_hx___innerCombineKnockoutShader;
...
HXLINE( 320)			HX_VARI_NAME(  ::openfl::filters::_GlowFilter::InnerCombineShader,shader2,"shader") = ::openfl::filters::GlowFilter_obj::_hx___innerCombineShader;
...
HXLINE( 330)				HX_VARI_NAME(  ::openfl::filters::_GlowFilter::CombineKnockoutShader,shader3,"shader") = ::openfl::filters::GlowFilter_obj::_hx___combineKnockoutShader;
...
HXLINE( 336)			HX_VARI_NAME(  ::openfl::filters::_GlowFilter::CombineShader,shader4,"shader") = ::openfl::filters::GlowFilter_obj::_hx___combineShader;
