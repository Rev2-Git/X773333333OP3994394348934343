...
HXLINE( 483)			HX_VARI(  ::openfl::utils::ByteArrayData,copy) =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,bytesLength);
...
HXLINE( 576)		HX_VAR( int,bitsPerSample);
...
HXLINE( 577)		HX_VAR( int,channels);
...
HXLINE( 578)		HX_VARI( int,bytesLength) = ::Std_obj::_hx_int((( (Float)((samples * channels)) ) * (( (Float)(bitsPerSample) ) / ( (Float)(8) ))));
...
HXLINE( 582)			HX_VARI(  ::openfl::utils::ByteArrayData,copy) =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,bytesLength);
HXLINE( 583)			copy->writeBytes(bytes,bytes->position,bytesLength);
HXLINE( 584)			bytes = copy;
            		}
HXLINE( 588)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
...
HXLINE( 637)		HX_VARI( Float,pan) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + sndTransform->pan);
HXLINE( 639)		if ((pan > 1)) {
...
HXLINE( 642)		HX_VARI( Float,volume) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * sndTransform->volume);
HXLINE( 644)		HX_VARI(  ::lime::media::AudioSource,source) =  ::lime::media::AudioSource_obj::__alloc( HX_CTX ,this->_hx___buffer,null(),null(),null());
...
HXLINE( 650)		HX_VARI(  ::lime::math::Vector4,position) = source->get_position();
...
HXLINE( 677)				HX_VARI( Float,samples) = (( (Float)((this->_hx___buffer->data->length * 8)) ) / ( (Float)((this->_hx___buffer->channels * this->_hx___buffer->bitsPerSample)) ));
...
HXDLIN( 682)					HX_VARI_NAME( int,samples1,"samples") = _hx_int64_low(x);
...
HX_DEFINE_DYNAMIC_FUNC1(Sound_obj,AudioBuffer_onURLLoad,(void))
 ...
 ::openfl::media::Sound Sound_obj::fromAudioBuffer( ::lime::media::AudioBuffer buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 334)
HXLINE( 335)		HX_VARI(  ::openfl::media::Sound,sound) =  ::openfl::media::Sound_obj::__alloc( HX_CTX ,null(),null());
