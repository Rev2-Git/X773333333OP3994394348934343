...
HXLINE( 179)			HX_VARI( Float,pan) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
HXLINE( 181)			if ((pan < -1)) {
...
HXLINE( 184)			HX_VARI( Float,volume) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 186)			if (this->_hx___isValid) {
HXLINE( 189)				this->_hx___source->set_gain(volume);
HXLINE( 191)				HX_VARI(  ::lime::math::Vector4,position) = this->_hx___source->get_position();
