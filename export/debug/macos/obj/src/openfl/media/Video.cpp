...
HXLINE( 284)
HXLINE( 285)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE( 295)
HXLINE( 297)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXDLIN( 303)			this->_hx___indexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,6,6);
HXLINE( 304)			{
HXLINE( 304)				 ::lime::utils::ArrayBufferView this1 = this->_hx___indexBufferData;
HXDLIN( 304)				 ::__hxcpp_memory_set_ui16(this1->buffer->b,this1->byteOffset,0);
            			}
HXLINE( 305)			{
HXLINE( 305)				 ::lime::utils::ArrayBufferView this2 = this->_hx___indexBufferData;
HXDLIN( 305)				 ::__hxcpp_memory_set_ui16(this2->buffer->b,(this2->byteOffset + 2),1);
            			}
HXLINE( 306)			{
HXLINE( 306)				 ::lime::utils::ArrayBufferView this3 = this->_hx___indexBufferData;
HXDLIN( 306)				 ::__hxcpp_memory_set_ui16(this3->buffer->b,(this3->byteOffset + 4),2);
            			}
HXLINE( 307)			{
HXLINE( 307)				 ::lime::utils::ArrayBufferView this4 = this->_hx___indexBufferData;
HXDLIN( 307)				 ::__hxcpp_memory_set_ui16(this4->buffer->b,(this4->byteOffset + 6),2);
            			}
HXLINE( 308)			{
HXLINE( 308)				 ::lime::utils::ArrayBufferView this5 = this->_hx___indexBufferData;
HXDLIN( 308)				 ::__hxcpp_memory_set_ui16(this5->buffer->b,(this5->byteOffset + 8),1);
            			}
HXLINE( 309)			{
HXLINE( 309)				 ::lime::utils::ArrayBufferView this6 = this->_hx___indexBufferData;
HXDLIN( 309)				 ::__hxcpp_memory_set_ui16(this6->buffer->b,(this6->byteOffset + 10),3);
            			}
...
HX_DEFINE_DYNAMIC_FUNC1(Video_obj,_hx___getTexture,return )
 ...
 ::openfl::display3D::VertexBuffer3D Video_obj::_hx___getVertexBuffer( ::openfl::display3D::Context3D context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE( 349)
HXLINE( 351)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXLINE( 372)			HX_VARI( int,uvWidth) = 1;
HXLINE( 373)			HX_VARI( int,uvHeight) = 1;
...
HXDLIN( 376)			this->_hx___vertexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,20,8);
HXLINE( 378)			{
HXLINE( 378)				 ::lime::utils::ArrayBufferView this1 = this->_hx___vertexBufferData;
HXDLIN( 378)				Float val = this->get_width();
HXDLIN( 378)				 ::__hxcpp_memory_set_float(this1->buffer->b,this1->byteOffset,val);
            			}
HXLINE( 379)			{
HXLINE( 379)				 ::lime::utils::ArrayBufferView this2 = this->_hx___vertexBufferData;
HXDLIN( 379)				Float val1 = this->get_height();
HXDLIN( 379)				 ::__hxcpp_memory_set_float(this2->buffer->b,(this2->byteOffset + 4),val1);
            			}
HXLINE( 380)			{
HXLINE( 380)				 ::lime::utils::ArrayBufferView this3 = this->_hx___vertexBufferData;
HXDLIN( 380)				 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 12),uvWidth);
            			}
HXLINE( 381)			{
HXLINE( 381)				 ::lime::utils::ArrayBufferView this4 = this->_hx___vertexBufferData;
HXDLIN( 381)				 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 16),uvHeight);
            			}
HXLINE( 382)			{
HXLINE( 382)				 ::lime::utils::ArrayBufferView this5 = this->_hx___vertexBufferData;
HXDLIN( 382)				Float val2 = this->get_height();
HXDLIN( 382)				 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 24),val2);
            			}
HXLINE( 383)			{
HXLINE( 383)				 ::lime::utils::ArrayBufferView this6 = this->_hx___vertexBufferData;
HXDLIN( 383)				 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 36),uvHeight);
            			}
HXLINE( 384)			{
HXLINE( 384)				 ::lime::utils::ArrayBufferView this7 = this->_hx___vertexBufferData;
HXDLIN( 384)				Float val3 = this->get_width();
HXDLIN( 384)				 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 40),val3);
            			}
HXLINE( 385)			{
HXLINE( 385)				 ::lime::utils::ArrayBufferView this8 = this->_hx___vertexBufferData;
HXDLIN( 385)				 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 52),uvWidth);
            			}
...
bool Video_obj::_hx___hitTestMask(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE( 421)
HXLINE( 422)		HX_VARI(  ::openfl::geom::Point,point) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
HXLINE( 423)		point->setTo(x,y);
HXLINE( 425)		this->_hx___globalToLocal(point,point);
HXLINE( 427)		HX_VAR( bool,hit);
