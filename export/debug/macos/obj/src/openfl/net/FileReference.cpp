...
HXLINE( 572)		HX_VARI( ::String,filter) = null();
HXLINE( 574)		if (::hx::IsNotNull( typeFilter )) {
HXLINE( 576)			HX_VARI( ::Array< ::String >,filters) = ::Array_obj< ::String >::__new(0);
HXLINE( 578)			{
HXLINE( 578)				int _g = 0;
HXDLIN( 578)				while((_g < typeFilter->length)){
HXLINE( 578)					HX_VARI(  ::openfl::net::FileFilter,type) = typeFilter->__get(_g).StaticCast<  ::openfl::net::FileFilter >();
HXDLIN( 578)					_g = (_g + 1);
...
HXLINE( 586)		HX_VARI(  ::lime::ui::FileDialog,openFileDialog) =  ::lime::ui::FileDialog_obj::__alloc( HX_CTX );
...
HXLINE( 834)		HX_VARI(  ::lime::ui::FileDialog,saveFileDialog) =  ::lime::ui::FileDialog_obj::__alloc( HX_CTX );
...
HXLINE(1054)			this->_hx___data =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0);
HXLINE(1055)			{
HXLINE(1055)				 ::openfl::utils::ByteArrayData this1 = this->_hx___data;
HXDLIN(1055)				this1->writeUTFBytes(::Std_obj::string(data));
            			}
            		}
HXLINE(1058)		HX_VARI(  ::lime::ui::FileDialog,saveFileDialog) =  ::lime::ui::FileDialog_obj::__alloc( HX_CTX );
...
HXLINE(1318)
HXLINE(1320)		HX_VARI(  ::Dynamic,fileInfo) = ::sys::FileSystem_obj::stat(path);
...
HXLINE(1376)			this->_hx___data =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0);
HXLINE(1377)			{
HXLINE(1377)				 ::openfl::utils::ByteArrayData this1 = this->_hx___data;
HXDLIN(1377)				this1->writeUTFBytes(::Std_obj::string(this->_hx___urlLoader->data));
            			}
            		}
