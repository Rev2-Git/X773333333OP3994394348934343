...
HXLINE( 288)		HX_VARI(  ::openfl::events::Event,openEvent) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("open",ca,03,b4,49),null(),null());
...
HXLINE( 293)			HX_VARI(  ::lime::net::_HTTPRequest_openfl_utils_ByteArray,httpRequest) =  ::lime::net::_HTTPRequest_openfl_utils_ByteArray_obj::__alloc( HX_CTX ,null());
...
HXLINE( 321)				HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null());
...
void URLLoader_obj::_hx___dispatchStatus(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 329)
HXLINE( 330)		HX_VARI(  ::openfl::events::HTTPStatusEvent,event) =  ::openfl::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,HX_("httpStatus",da,4c,74,0a),false,false,this->_hx___httpRequest->__Field(HX_("responseStatus",93,60,a4,78),::hx::paccDynamic),null());
HXLINE( 331)		event->responseURL = ( (::String)(this->_hx___httpRequest->__Field(HX_("uri",6c,2b,59,00),::hx::paccDynamic)) );
HXLINE( 333)		HX_VARI( ::Array< ::Dynamic>,headers) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 361)				HX_VARI( ::Array< ::String >,fields) = ::Reflect_obj::fields(request->data);
HXLINE( 363)				{
HXLINE( 363)					int _g = 0;
HXDLIN( 363)					while((_g < fields->length)){
HXLINE( 363)						HX_VARI( ::String,field) = fields->__get(_g);
HXDLIN( 363)						_g = (_g + 1);
HXLINE( 365)						{
...
HXDLIN( 382)			::Array< ::Dynamic> _g2 = request->requestHeaders;
HXDLIN( 382)			while((_g1 < _g2->length)){
HXLINE( 382)				HX_VARI(  ::openfl::net::URLRequestHeader,header) = _g2->__get(_g1).StaticCast<  ::openfl::net::URLRequestHeader >();
HXDLIN( 382)				_g1 = (_g1 + 1);
HXLINE( 384)				::Array< ::Dynamic> _hx_tmp1 = ( (::Array< ::Dynamic>)(this->_hx___httpRequest->__Field(HX_("headers",46,52,08,63),::hx::paccDynamic)) );
HXDLIN( 384)				_hx_tmp1->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,header->name,header->value));
            			}
            		}
...
HXLINE( 395)		HX_VARI( ::String,userAgent) = request->userAgent;
...
HXLINE( 412)			HX_VARI(  ::openfl::events::SecurityErrorEvent,event) =  ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,HX_("securityError",e8,28,7c,a2),null(),null(),null(),null());
HXLINE( 413)			event->text = ::Std_obj::string(error);
HXLINE( 414)			this->dispatchEvent(event);
            		}
            		else {
HXLINE( 419)			HX_VARI_NAME(  ::openfl::events::IOErrorEvent,event1,"event") =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
HXLINE( 420)			event1->text = ::Std_obj::string(error);
HXLINE( 421)			this->dispatchEvent(event1);
            		}
            	}
...
HXLINE( 426)
HXLINE( 427)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),null(),null(),null(),null());
