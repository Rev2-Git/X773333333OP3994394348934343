...
HXLINE( 889)		HX_VARI(  ::openfl::geom::Rectangle,rect) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
...
HXLINE( 919)				_g = (_g + 1);
HXDLIN( 919)				HX_VARI( int,i) = (_g - 1);
HXLINE( 921)				y = (y + this->_hx___textEngine->lineHeights->get(i));
            			}
            		}
HXLINE( 924)		{
HXLINE( 924)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN( 924)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 924)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 926)				bool _hx_tmp3;
HXDLIN( 926)				if ((y >= group1->offsetY)) {
HXLINE( 926)					_hx_tmp3 = (y <= (group1->offsetY + group1->height));
            				}
            				else {
HXLINE( 926)					_hx_tmp3 = false;
            				}
HXDLIN( 926)				if (_hx_tmp3) {
HXLINE( 928)					bool _hx_tmp4;
HXDLIN( 928)					if ((x >= group1->offsetX)) {
HXLINE( 928)						_hx_tmp4 = (x <= (group1->offsetX + group1->width));
            					}
            					else {
HXLINE( 928)						_hx_tmp4 = false;
            					}
HXDLIN( 928)					if (_hx_tmp4) {
HXLINE( 930)						HX_VARI( Float,advance) = ((Float)0.0);
HXLINE( 932)						{
HXLINE( 932)							int _g2 = 0;
HXDLIN( 932)							int _g3 = group1->positions->length;
HXDLIN( 932)							while((_g2 < _g3)){
HXLINE( 932)								_g2 = (_g2 + 1);
HXDLIN( 932)								HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 934)								Float advance1;
HXDLIN( 934)								bool advance2;
HXDLIN( 934)								if ((i1 >= 0)) {
HXLINE( 934)									advance2 = (i1 < group1->positions->length);
            								}
            								else {
HXLINE( 934)									advance2 = false;
            								}
HXDLIN( 934)								if (advance2) {
HXLINE( 934)									advance1 = group1->positions->__get(i1).StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
            								}
            								else {
...
HXLINE( 938)									return (group1->startIndex + i1);
            								}
            							}
            						}
...
HXLINE(1014)				_g = (_g + 1);
HXDLIN(1014)				HX_VARI( int,i) = (_g - 1);
HXLINE(1016)				y = (y + this->_hx___textEngine->lineHeights->get(i));
            			}
            		}
HXLINE(1019)		{
HXLINE(1019)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1019)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1019)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1021)				bool _hx_tmp3;
HXDLIN(1021)				if ((y >= group1->offsetY)) {
HXLINE(1021)					_hx_tmp3 = (y <= (group1->offsetY + group1->height));
            				}
            				else {
...
HXLINE(1046)		{
HXLINE(1046)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1046)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1046)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1070)		HX_VARI( int,startIndex) = -1;
HXLINE(1071)		HX_VARI( int,endIndex) = -1;
HXLINE(1073)		{
HXLINE(1073)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1073)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1073)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1101)		HX_VARI( Float,ascender) = this->_hx___textEngine->lineAscents->get(lineIndex);
HXLINE(1102)		HX_VARI( Float,descender) = this->_hx___textEngine->lineDescents->get(lineIndex);
HXLINE(1103)		HX_VARI( Float,leading) = this->_hx___textEngine->lineLeadings->get(lineIndex);
HXLINE(1104)		HX_VARI( Float,lineHeight) = this->_hx___textEngine->lineHeights->get(lineIndex);
HXLINE(1105)		HX_VARI( Float,lineWidth) = this->_hx___textEngine->lineWidths->get(lineIndex);
HXLINE(1109)		HX_VAR( Float,margin);
...
HXLINE(1134)		{
HXLINE(1134)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1134)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1134)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1160)		HX_VARI( int,startIndex) = -1;
HXLINE(1161)		HX_VARI( int,endIndex) = -1;
HXLINE(1163)		{
HXLINE(1163)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1163)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1163)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1197)		HX_VARI( int,startIndex) = this->getFirstCharInParagraph(charIndex);
HXLINE(1199)		if ((charIndex >= this->get_text().length)) {
HXLINE(1199)			return ((this->get_text().length - startIndex) + 1);
            		}
HXLINE(1201)		HX_VARI( int,endIndex) = (this->_hx___textEngine->getLineBreakIndex(charIndex) + 1);
...
HXLINE(1233)
HXLINE(1234)		HX_VARI(  ::openfl::text::TextFormat,format) = null();
...
HXLINE(1244)		{
HXLINE(1244)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->textFormatRanges->iterator();
HXDLIN(1244)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1244)				HX_VARI_NAME(  ::openfl::text::_internal::TextFormatRange,group1,"group") = ( ( ::openfl::text::_internal::TextFormatRange)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
void TextField_obj::setTextFormat( ::openfl::text::TextFormat format,::hx::Null< int >  __o_beginIndex,::hx::Null< int >  __o_endIndex){
            	...
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE(1425)
HXLINE(1426)		HX_VARI( int,max) = this->get_text().length;
HXLINE(1427)		HX_VAR(  ::openfl::text::_internal::TextFormatRange,range);
...
HXLINE(1470)			HX_VARI( int,index) = 0;
HXLINE(1471)			HX_VAR(  ::openfl::text::_internal::TextFormatRange,newRange);
...
void TextField_obj::_hx___caretBeginningOfNextLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1609)
HXLINE(1610)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
HXLINE(1628)			HX_VARI( int,index) = this->getLineOffset(this->getLineIndexOfChar(this->_hx___caretIndex));
...
void TextField_obj::_hx___caretEndOfLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1642)
HXLINE(1643)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
void TextField_obj::_hx___caretNextLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1664)
HXLINE(1665)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
void TextField_obj::_hx___caretPreviousLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1682)
HXLINE(1683)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
HXLINE(1710)			HX_VARI_NAME(  ::openfl::events::MouseEvent,event1,"event") = ( ( ::openfl::events::MouseEvent)(event) );
HXLINE(1711)			Float group = this->get_mouseX();
HXDLIN(1711)			HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = this->_hx___getGroup(group,this->get_mouseY(),true);
HXLINE(1713)			if (::hx::IsNotNull( group1 )) {
HXLINE(1715)				HX_VARI( ::String,url) = group1->format->url;
...
HXLINE(1741)			HX_VARI(  ::openfl::geom::Rectangle,bounds) = this->getBounds(this->stage);
HXLINE(1742)			HX_VARI(  ::lime::math::Rectangle,limeRect) =  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,bounds->x,bounds->y,bounds->width,bounds->height);
...
HXLINE(1788)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE(1804)		{
HXLINE(1804)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1804)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1804)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN(1818)						HX_VAR( Float,lastPosition);
...
HXLINE(1835)		HX_VARI(  ::Dynamic,x) = null();
HXDLIN(1835)		HX_VARI(  ::Dynamic,y) = null();
HXLINE(1837)		{
HXLINE(1837)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1837)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1837)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1843)							_g = (_g + 1);
HXDLIN(1843)							HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1855)							HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE(1857)							y = (y - this->_hx___textEngine->lineHeights->get(i1));
            						}
            					}
...
HXDLIN(1869)		HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = this->_hx___getGroup(group,this->get_mouseY(),true);
...
HXLINE(1889)				_g = (_g + 1);
HXDLIN(1889)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1896)		HX_VARI( bool,firstGroup) = true;
HXLINE(1897)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,group);
HXDLIN(1897)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,nextGroup);
HXLINE(1899)		{
...
HXDLIN(1899)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE(1901)				group = this->_hx___textEngine->layoutGroups->get(i1).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
HXLINE(1903)				if ((i1 < (this->_hx___textEngine->layoutGroups->get_length() - 1))) {
HXLINE(1905)					nextGroup = this->_hx___textEngine->layoutGroups->get((i1 + 1)).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
            				}
            				else {
...
int TextField_obj::_hx___getPosition(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE(1933)
HXLINE(1934)		HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group) = this->_hx___getGroup(x,y,null());
HXLINE(1936)		if (::hx::IsNull( group )) {
HXLINE(1938)			return this->_hx___text.length;
            		}
HXLINE(1941)		HX_VARI( Float,advance) = ((Float)0.0);
HXLINE(1943)		{
HXLINE(1943)			int _g = 0;
HXDLIN(1943)			int _g1 = group->positions->length;
HXDLIN(1943)			while((_g < _g1)){
HXLINE(1943)				_g = (_g + 1);
HXDLIN(1943)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(2009)		HX_VAR( int,startIndex);
...
HXLINE(2010)		HX_VAR( int,endIndex);
...
HXLINE(2018)			HX_VARI( int,cache) = endIndex;
...
HXLINE(2037)				HX_VARI( int,removeLength) = (endIndex - beginIndex);
HXLINE(2038)				HX_VARI( int,maxLength) = ((this->_hx___textEngine->maxChars - this->_hx___text.length) + removeLength);
...
HXLINE(2053)		HX_VARI( int,offset) = (newText.length - (endIndex - beginIndex));
HXLINE(2055)		HX_VARI( int,i) = 0;
HXLINE(2056)		HX_VAR(  ::openfl::text::_internal::TextFormatRange,range);
...
HXLINE(2083)							 ::openfl::text::_internal::TextFormatRange range2 = range;
HXDLIN(2083)							range2->start = (range2->start + offset);
HXLINE(2084)							 ::openfl::text::_internal::TextFormatRange range3 = range;
HXDLIN(2084)							range3->end = (range3->end + offset);
            						}
            						else {
...
HXLINE(2090)								 ::openfl::text::_internal::TextFormatRange range4 = range;
HXDLIN(2090)								range4->end = (range4->end + offset);
            							}
            						}
            					}
            				}
...
HXLINE(2102)						 ::openfl::text::_internal::TextFormatRange range5 = range;
HXDLIN(2102)						range5->start = (range5->start + offset);
HXLINE(2103)						 ::openfl::text::_internal::TextFormatRange range6 = range;
HXDLIN(2103)						range6->end = (range6->end + offset);
            					}
            					else {
...
HXLINE(2108)							 ::openfl::text::_internal::TextFormatRange range7 = range;
HXDLIN(2108)							range7->end = (range7->end + offset);
            						}
            						else {
...
HXDLIN(2113)									::cpp::VirtualArray _g_args = ::cpp::VirtualArray_obj::__new(0);
...
HXLINE(2120)									 ::openfl::text::_internal::TextFormatRange range8 = range;
HXDLIN(2120)									range8->end = (range8->end + offset);
            								}
            								else {
...
HXLINE(2181)		HX_VARI( bool,enableInput) = true;
...
void TextField_obj::_hx___stopTextInput(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2206)
HXLINE(2207)		HX_VARI( bool,disableInput) = true;
...
HXLINE(2219)			HX_VARI( Float,cacheWidth) = this->_hx___textEngine->width;
...
HXLINE(2257)		HX_VARI( int,tempScrollH) = this->get_scrollH();
...
HXLINE(2268)			HX_VARI(  ::openfl::geom::Rectangle,caret) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2269)			HX_VARI( bool,written) = false;
...
HXLINE(2287)				Float caret2 = caret->x;
HXDLIN(2287)				if (!((caret2 > ((tempScrollH + this->get_width()) - ( (Float)(4) ))))) {
...
HXLINE(2298)			HX_VARI( int,lineLength) = this->getLineLength(this->getLineIndexOfChar(this->_hx___caretIndex));
...
HXLINE(2331)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
HXLINE(2345)				HX_VARI( int,i) = lineIndex;
HXDLIN(2345)				HX_VARI( Float,tempHeight) = ((Float)0.0);
...
HXLINE(2461)			HX_VARI( int,length) = this->get_text().length;
HXLINE(2462)			HX_VARI( ::String,mask) = HX_("",00,00,00,00);
HXLINE(2464)			{
HXLINE(2464)				int _g = 0;
HXDLIN(2464)				int _g1 = length;
HXDLIN(2464)				while((_g < _g1)){
HXLINE(2464)					_g = (_g + 1);
HXDLIN(2464)					HX_VARI( int,i) = (_g - 1);
...
HXDLIN(2983)				::cpp::VirtualArray _g_args = ::cpp::VirtualArray_obj::__new(0);
...
HXLINE(2986)		HX_VARI( ::String,utfValue) = value;
HXLINE(2987)		HX_VARI(  ::openfl::text::_internal::TextFormatRange,range) = this->_hx___textEngine->textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
...
HXLINE(3012)		{
HXLINE(3012)			HX_VARI(  ::Dynamic,range) = this->_hx___textEngine->textFormatRanges->iterator();
HXDLIN(3012)			while(( (bool)(range->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(3012)				HX_VARI_NAME(  ::openfl::text::_internal::TextFormatRange,range1,"range") = ( ( ::openfl::text::_internal::TextFormatRange)(range->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN(3145)			HX_VARI_NAME( int,position2,"position") = this->_hx___getPosition(position1,this->get_mouseY());
HXLINE(3147)			if ((position2 != this->_hx___caretIndex)) {
HXLINE(3149)				this->_hx___caretIndex = position2;
HXLINE(3151)				HX_VARI( bool,setDirty) = true;
...
void TextField_obj::stage_onMouseUp( ::openfl::events::MouseEvent event){
            	...
            	HX_STACK_ARG(event,"event")
HXLINE(3174)
HXLINE(3175)		HX_VARI(  ::openfl::display::Stage,stage) = ( ( ::openfl::display::Stage)(event->currentTarget) );
...
HXDLIN(3188)			HX_VARI_NAME( int,upPos2,"upPos") = this->_hx___getPosition(upPos1,this->get_mouseY());
HXLINE(3189)			HX_VARI( int,leftPos) = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(this->_hx___selectionIndex) ),( (Float)(upPos2) )));
HXLINE(3190)			HX_VARI( int,rightPos) = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(this->_hx___selectionIndex) ),( (Float)(upPos2) )));
...
HXLINE(3307)			HX_VARI( ::Array< ::String >,delimiters) = ::Array_obj< ::String >::fromData( _hx_array_data_efd5a8ca_158,13);
HXLINE(3309)			HX_VARI( ::String,txtStr) = this->_hx___text;
HXLINE(3310)			HX_VARI( int,leftPos) = -1;
HXLINE(3311)			HX_VARI( int,rightPos) = txtStr.length;
HXLINE(3312)			HX_VARI( int,pos) = 0;
HXLINE(3313)			HX_VARI( int,startPos) = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(this->_hx___caretIndex) ),( (Float)(1) )));
...
HXLINE(3316)						HX_VARI( ::String,c) = delimiters->__get(_g);
HXDLIN(3316)						_g = (_g + 1);
...
HXLINE(3329)					HX_VARI( bool,setDirty) = true;
...
HXLINE(3568)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3570)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3517)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3547)						HX_VARI(  ::openfl::events::TextEvent,te) =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,::lime::_hx_system::Clipboard_obj::get_text());
...
HXDLIN(3562)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            			...
            			break;
            			case (int)120: {
HXLINE(3528)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3482)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3499)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3448)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3358)					HX_VARI_NAME(  ::openfl::events::TextEvent,te1,"te") =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));
