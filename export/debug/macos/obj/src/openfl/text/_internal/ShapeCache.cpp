...
HXLINE(  68)			HX_VARI_NAME(  ::haxe::ds::StringMap,formatMap1,"formatMap") =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
...
HXLINE(  95)				HX_VARI_NAME(  ::openfl::text::_internal::CacheMeasurement,measurement1,"measurement") =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE(  96)				formatMap->set(hash,measurement1);
            			}
            		}
            		else {
HXLINE( 101)			HX_VARI_NAME(  ::haxe::ds::IntMap,formatMap1,"formatMap") =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 102)			HX_VARI_NAME(  ::openfl::text::_internal::CacheMeasurement,measurement2,"measurement") =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
