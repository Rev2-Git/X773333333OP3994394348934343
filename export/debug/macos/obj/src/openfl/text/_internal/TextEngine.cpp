...
HXLINE( 169)
HXLINE( 170)		HX_VARI(  ::EReg,declinedRange) =  ::EReg_obj::__alloc( HX_CTX ,HX_("\\^([^\\^]+)",d0,bc,3c,14),HX_("gu",2e,5a,00,00));
HXLINE( 171)		HX_VARI( ::Array< ::String >,declined) = ::Array_obj< ::String >::fromData( _hx_array_data_7e808804_3,1);
HXLINE( 173)		HX_VARI( ::Array< bool >,accepting) = ::Array_obj< bool >::fromData( _hx_array_data_7e808804_4,1);
HXLINE( 174)		HX_VARI( ::String,accepted) = declinedRange->map(restrict, ::Dynamic(new _hx_Closure_0(declined,accepting)));
HXLINE( 186)		HX_VARI( ::Array< ::String >,testRegexpParts) = ::Array_obj< ::String >::__new(0);
...
HXLINE( 270)		HX_VARI( Float,x) = this->width;
HXDLIN( 270)		HX_VARI( Float,y) = this->height;
HXLINE( 272)		HX_VARI( int,lastIndex) = (this->layoutGroups->get_length() - 1);
HXLINE( 273)		{
HXLINE( 273)			int _g = 0;
...
HXLINE( 275)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group) = this->layoutGroups->get(i).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE( 556)			::String _hx_tmp1 = this->text;
HXDLIN( 556)			int _hx_tmp2;
HXDLIN( 556)			if ((index > 0)) {
HXLINE( 556)				_hx_tmp2 = this->lineBreaks->get((index - 1));
            			}
            			else {
HXLINE( 556)				_hx_tmp2 = 0;
            			}
HXDLIN( 556)			return _hx_tmp1.substring(_hx_tmp2,this->lineBreaks->get(index));
            		}
...
HXLINE( 564)		HX_VARI( int,index) = -1;
HXLINE( 566)		HX_VARI( int,cr) = -1;
HXDLIN( 566)		HX_VARI( int,lf) = -1;
...
HXLINE( 581)
HXLINE( 582)		{
HXLINE( 582)			HX_VARI(  ::Dynamic,lineBreak) = this->lineBreaks->iterator();
HXDLIN( 582)			while(( (bool)(lineBreak->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 582)				HX_VARI_NAME( int,lineBreak1,"lineBreak") = ( (int)(lineBreak->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 598)		HX_VARI( Float,currentLineAscent) = ((Float)0.0);
HXLINE( 599)		HX_VARI( Float,currentLineDescent) = ((Float)0.0);
HXLINE( 600)		HX_VARI(  ::Dynamic,currentLineLeading) = null();
HXLINE( 601)		HX_VARI( Float,currentLineHeight) = ((Float)0.0);
HXLINE( 602)		HX_VARI( Float,currentLineWidth) = ((Float)0.0);
HXLINE( 603)		HX_VARI( Float,currentTextHeight) = ((Float)0.0);
...
HXLINE( 610)		HX_VARI( int,lastIndex) = (this->layoutGroups->get_length() - 1);
HXLINE( 611)		{
HXLINE( 611)			int _g = 0;
HXDLIN( 611)			int _g1 = this->layoutGroups->get_length();
HXDLIN( 611)			while((_g < _g1)){
HXLINE( 611)				_g = (_g + 1);
HXDLIN( 611)				HX_VARI( int,i) = (_g - 1);
HXLINE( 613)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group) = this->layoutGroups->get(i).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE( 668)			HX_VARI(  ::openfl::text::TextFormat,currentFormat) = this->textField->_hx___textFormat;
HXLINE( 669)			HX_VAR( Float,ascent);
HXDLIN( 669)			HX_VAR( Float,descent);
HXLINE( 671)			HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
...
HXLINE( 669)			HX_VARI(  ::Dynamic,leading) = currentFormat->leading;
HXDLIN( 669)			HX_VARI( int,heightValue) = ::Math_obj::ceil(((ascent + descent) + leading));
...
HXLINE( 716)				 ::openfl::text::_internal::TextEngine _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 716)				_hx_tmp7->textHeight = (_hx_tmp7->textHeight + currentLineLeading);
            			}
            		}
...
HXLINE( 755)		HX_VARI( int,rangeIndex) = -1;
HXLINE( 756)		HX_VARI(  ::openfl::text::_internal::TextFormatRange,formatRange) = null();
HXLINE( 757)		HX_VARI(  ::lime::text::Font,font) = null();
HXLINE( 759)		HX_VARI(  ::openfl::text::TextFormat,currentFormat) = ::openfl::text::TextField_obj::_hx___defaultTextFormat->clone();
HXLINE( 762)		HX_VARI( int,leading) = 0;
HXLINE( 763)		HX_VARI( Float,ascent) = ((Float)0.0);
HXDLIN( 763)		HX_VARI( Float,maxAscent) = ((Float)0.0);
HXLINE( 764)		HX_VARI( Float,descent) = ((Float)0.0);
HXLINE( 767)		HX_VARI(  ::Dynamic,align) = 3;
HXLINE( 768)		HX_VARI( int,blockIndent) = 0;
HXLINE( 769)		HX_VARI( bool,bullet) = false;
HXLINE( 770)		HX_VARI( int,indent) = 0;
HXLINE( 771)		HX_VARI( int,leftMargin) = 0;
HXLINE( 772)		HX_VARI( int,rightMargin) = 0;
HXLINE( 773)		HX_VARI( bool,firstLineOfParagraph) = true;
HXLINE( 775)		HX_VARI(  ::Dynamic,tabStops) = null();
HXLINE( 777)		HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,layoutGroup) = null();
HXDLIN( 777)		HX_VARI( ::Array< ::Dynamic>,positions) = null();
HXLINE( 778)		HX_VARI( Float,widthValue) = ((Float)0.0);
HXDLIN( 778)		HX_VARI( int,heightValue) = 0;
HXDLIN( 778)		HX_VARI( int,maxHeightValue) = 0;
HXLINE( 779)		HX_VARI( int,previousSpaceIndex) = -2;
HXLINE( 780)		HX_VARI( int,previousBreakIndex) = -1;
HXLINE( 781)		HX_VARI( int,spaceIndex) = this->text.indexOf(HX_(" ",20,00,00,00),null());
HXLINE( 782)		HX_VARI( int,breakCount) = 0;
HXLINE( 783)		HX_VAR( int,breakIndex);
...
HXLINE( 785)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE( 786)		HX_VARI( Float,offsetY) = ((Float)0.0);
HXLINE( 787)		HX_VARI( int,textIndex) = 0;
HXLINE( 788)		HX_VARI( int,lineIndex) = 0;
...
HXLINE(1338)				bool _hx_tmp3;
HXDLIN(1338)				if (::hx::IsNotNull( font )) {
HXLINE(1338)					_hx_tmp3 = (font->unitsPerEM != 0);
            				}
            				else {
HXLINE(1338)					_hx_tmp3 = false;
            				}
...
HXLINE(1340)		HX_VAR( bool,wrap);
HXLINE(1341)		HX_VARI( int,maxLoops) = (this->text.length + 1);
HXLINE(1345)		while((textIndex < maxLoops)){
HXLINE(1347)			bool _hx_tmp4;
HXDLIN(1347)			if ((breakIndex > -1)) {
HXLINE(1347)				if ((spaceIndex != -1)) {
HXLINE(1347)					_hx_tmp4 = (breakIndex < spaceIndex);
            				}
            				else {
...
HXLINE(1353)									::String text1 = _gthis->text;
...
HXDLIN(1353)									_gthis->_hx___textLayout->letterSpacing = letterSpacing1;
HXDLIN(1353)									bool _hx_tmp5;
HXDLIN(1353)									if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1353)										_hx_tmp5 = (_gthis->sharpness < 400);
            									}
            									else {
HXLINE(1353)										_hx_tmp5 = true;
            									}
HXDLIN(1353)									_gthis->_hx___textLayout->autoHint = _hx_tmp5;
HXDLIN(1353)									 ::openfl::text::_internal::TextLayout _gthis2 = _gthis->_hx___textLayout;
HXDLIN(1353)									_gthis2->set_text(text1.substring(tempIndex,tempRangeEnd));
...
HXDLIN(1353)										_hx_tmp6 = true;
            									}
            									else {
HXLINE(1353)										_hx_tmp6 = false;
            									}
HXDLIN(1353)									if (!(_hx_tmp6)) {
...
HXLINE(1354)							_hx_tmp7 = _gthis->wordWrap;
            						}
            						else {
...
HXDLIN(1354)								bool _hx_tmp8;
HXDLIN(1354)								if (::hx::IsNotEq( currentCharCode,32 )) {
HXLINE(1354)									_hx_tmp8 = ::hx::IsNotEq( currentCharCode,9 );
            								}
            								else {
HXLINE(1354)									_hx_tmp8 = false;
            								}
HXDLIN(1354)								if (_hx_tmp8) {
HXLINE(1354)									goto _hx_goto_21;
            								}
HXDLIN(1354)								 ::openfl::text::_internal::GlyphPosition position3 = remainingPositions->__get(i).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)								tempWidth = (tempWidth - position3->advance->x);
HXDLIN(1354)								i = (i - 1);
            							}
            							_hx_goto_21:;
HXDLIN(1354)							while(true){
HXLINE(1354)								bool _hx_tmp9;
HXDLIN(1354)								if ((remainingPositions->length > 0)) {
HXLINE(1354)									int _hx_tmp10;
HXDLIN(1354)									if (firstLineOfParagraph) {
HXLINE(1354)										_hx_tmp10 = indent;
            									}
            									else {
HXLINE(1354)										_hx_tmp10 = 0;
            									}
HXDLIN(1354)									_hx_tmp9 = ((offsetX + tempWidth) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp10)) )));
            								}
            								else {
HXLINE(1354)									_hx_tmp9 = false;
            								}
HXDLIN(1354)								if (!(_hx_tmp9)) {
...
HXDLIN(1354)									if (!(((offsetX + positionWidth) < (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp11)) ))))) {
...
HXLINE(1354)										bool _hx_tmp12;
HXDLIN(1354)										if ((i > 1)) {
HXLINE(1354)											int _hx_tmp13;
HXDLIN(1354)											if (firstLineOfParagraph) {
HXLINE(1354)												_hx_tmp13 = indent;
            											}
            											else {
HXLINE(1354)												_hx_tmp13 = 0;
            											}
HXDLIN(1354)											_hx_tmp12 = ((offsetX + positionWidth) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp13)) )));
            										}
            										else {
HXLINE(1354)											_hx_tmp12 = false;
            										}
HXDLIN(1354)										if (!(_hx_tmp12)) {
...
HXLINE(1354)														::String text2 = _gthis->text;
...
HXDLIN(1354)														_gthis->_hx___textLayout->letterSpacing = letterSpacing2;
HXDLIN(1354)														bool positions2;
HXDLIN(1354)														if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)															positions2 = (_gthis->sharpness < 400);
            														}
            														else {
HXLINE(1354)															positions2 = true;
            														}
HXDLIN(1354)														_gthis->_hx___textLayout->autoHint = positions2;
HXDLIN(1354)														 ::openfl::text::_internal::TextLayout _gthis3 = _gthis->_hx___textLayout;
HXDLIN(1354)														_gthis3->set_text(text2.substring(textIndex,endIndex));
...
HXLINE(1354)																 ::openfl::text::_internal::GlyphPosition position4 = positions->__get(_g3).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)																_g3 = (_g3 + 1);
HXDLIN(1354)																width3 = (width3 + position4->advance->x);
            															}
            														}
...
HXLINE(1354)																::String text3 = _gthis->text;
...
HXDLIN(1354)																_gthis->_hx___textLayout->letterSpacing = letterSpacing3;
HXDLIN(1354)																bool _hx_tmp14;
HXDLIN(1354)																if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)																	_hx_tmp14 = (_gthis->sharpness < 400);
            																}
            																else {
HXLINE(1354)																	_hx_tmp14 = true;
            																}
HXDLIN(1354)																_gthis->_hx___textLayout->autoHint = _hx_tmp14;
HXDLIN(1354)																 ::openfl::text::_internal::TextLayout _gthis4 = _gthis->_hx___textLayout;
HXDLIN(1354)																_gthis4->set_text(text3.substring(tempIndex1,tempRangeEnd1));
HXDLIN(1354)																::Array< ::Dynamic> tempPositions1;
HXDLIN(1354)																if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)																	tempPositions1 = _gthis->_hx___textLayout->get_positions();
            																}
            																else {
HXLINE(1354)																	tempPositions1 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																}
...
HXLINE(1354)																		 ::openfl::text::_internal::GlyphPosition position5 = positions->__get(_g4).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)																		_g4 = (_g4 + 1);
HXDLIN(1354)																		width4 = (width4 + position5->advance->x);
            																	}
            																}
...
HXLINE(1354)														::String text4 = _gthis->text;
...
HXDLIN(1354)														_gthis->_hx___textLayout->letterSpacing = letterSpacing4;
HXDLIN(1354)														bool positions3;
HXDLIN(1354)														if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)															positions3 = (_gthis->sharpness < 400);
            														}
            														else {
HXLINE(1354)															positions3 = true;
            														}
HXDLIN(1354)														_gthis->_hx___textLayout->autoHint = positions3;
HXDLIN(1354)														 ::openfl::text::_internal::TextLayout _gthis5 = _gthis->_hx___textLayout;
HXDLIN(1354)														_gthis5->set_text(text4.substring(textIndex,endIndex1));
HXDLIN(1354)														if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)															positions = _gthis->_hx___textLayout->get_positions();
            														}
            														else {
...
HXLINE(1354)																 ::openfl::text::_internal::GlyphPosition position6 = positions->__get(_g5).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)																_g5 = (_g5 + 1);
HXDLIN(1354)																width5 = (width5 + position6->advance->x);
            															}
            														}
...
HXLINE(1354)																::String text5 = _gthis->text;
...
HXDLIN(1354)																_gthis->_hx___textLayout->letterSpacing = letterSpacing5;
HXDLIN(1354)																bool _hx_tmp16;
HXDLIN(1354)																if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)																	_hx_tmp16 = (_gthis->sharpness < 400);
            																}
            																else {
HXLINE(1354)																	_hx_tmp16 = true;
            																}
HXDLIN(1354)																_gthis->_hx___textLayout->autoHint = _hx_tmp16;
HXDLIN(1354)																 ::openfl::text::_internal::TextLayout _gthis6 = _gthis->_hx___textLayout;
HXDLIN(1354)																_gthis6->set_text(text5.substring(tempIndex2,tempRangeEnd2));
HXDLIN(1354)																::Array< ::Dynamic> tempPositions2;
HXDLIN(1354)																if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)																	tempPositions2 = _gthis->_hx___textLayout->get_positions();
            																}
            																else {
HXLINE(1354)																	tempPositions2 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																}
HXDLIN(1354)																positions = positions->concat(tempPositions2);
            															}
HXDLIN(1354)															if ((tempRangeEnd2 != endIndex1)) {
HXLINE(1354)																bool _hx_tmp17;
HXDLIN(1354)																if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1354)																	rangeIndex = (rangeIndex + 1);
HXDLIN(1354)																	formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1354)																	currentFormat->_hx___merge(formatRange->format);
HXDLIN(1354)																	font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1354)																	_hx_tmp17 = true;
            																}
            																else {
HXLINE(1354)																	_hx_tmp17 = false;
            																}
HXDLIN(1354)																if (!(_hx_tmp17)) {
HXLINE(1354)																	::lime::utils::Log_obj::warn(HX_("You found a bug in OpenFL's text code! Please save a copy of your project and contact Joshua Granick (@singmajesty) so we can fix this.",08,e2,e2,42),::hx::SourceInfo(HX_("openfl/text/_internal/TextEngine.hx",39,18,5e,b8),1096,HX_("openfl.text._internal.TextEngine",04,88,80,7e),HX_("getLayoutGroups",54,f8,56,5a)));
...
HXLINE(1354)																		 ::openfl::text::_internal::GlyphPosition position7 = positions->__get(_g6).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)																		_g6 = (_g6 + 1);
HXDLIN(1354)																		width6 = (width6 + position7->advance->x);
            																	}
            																}
...
HXLINE(1354)										::String text6 = _gthis->text;
...
HXDLIN(1354)										_gthis->_hx___textLayout->letterSpacing = letterSpacing6;
HXDLIN(1354)										bool positions4;
HXDLIN(1354)										if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)											positions4 = (_gthis->sharpness < 400);
            										}
            										else {
HXLINE(1354)											positions4 = true;
            										}
HXDLIN(1354)										_gthis->_hx___textLayout->autoHint = positions4;
HXDLIN(1354)										 ::openfl::text::_internal::TextLayout _gthis7 = _gthis->_hx___textLayout;
HXDLIN(1354)										_gthis7->set_text(text6.substring(textIndex,placeIndex));
HXDLIN(1354)										if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)											positions = _gthis->_hx___textLayout->get_positions();
            										}
            										else {
...
HXLINE(1354)												 ::openfl::text::_internal::GlyphPosition position8 = positions->__get(_g7).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)												_g7 = (_g7 + 1);
HXDLIN(1354)												width7 = (width7 + position8->advance->x);
            											}
            										}
HXDLIN(1354)										widthValue = width7;
HXDLIN(1354)										bool _hx_tmp18;
HXDLIN(1354)										if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1354)											_hx_tmp18 = (layoutGroup->startIndex != layoutGroup->endIndex);
            										}
            										else {
HXLINE(1354)											_hx_tmp18 = true;
            										}
...
HXDLIN(1354)										int _hx_tmp19;
HXDLIN(1354)										if (firstLineOfParagraph) {
HXLINE(1354)											_hx_tmp19 = indent;
            										}
            										else {
HXLINE(1354)											_hx_tmp19 = 0;
            										}
HXDLIN(1354)										layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp19)) ));
...
HXLINE(1354)													bool _hx_tmp20;
HXDLIN(1354)													if (::hx::IsNotNull( font )) {
HXLINE(1354)														_hx_tmp20 = (font->unitsPerEM != 0);
            													}
            													else {
HXLINE(1354)														_hx_tmp20 = false;
            													}
HXDLIN(1354)													if (_hx_tmp20) {
...
HXLINE(1354)												::String text7 = _gthis->text;
...
HXDLIN(1354)												_gthis->_hx___textLayout->letterSpacing = letterSpacing7;
HXDLIN(1354)												bool positions5;
HXDLIN(1354)												if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)													positions5 = (_gthis->sharpness < 400);
            												}
            												else {
HXLINE(1354)													positions5 = true;
            												}
HXDLIN(1354)												_gthis->_hx___textLayout->autoHint = positions5;
HXDLIN(1354)												 ::openfl::text::_internal::TextLayout _gthis8 = _gthis->_hx___textLayout;
HXDLIN(1354)												_gthis8->set_text(text7.substring(textIndex,tempRangeEnd3));
HXDLIN(1354)												if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)													positions = _gthis->_hx___textLayout->get_positions();
            												}
            												else {
...
HXLINE(1354)														 ::openfl::text::_internal::GlyphPosition position9 = positions->__get(_g8).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)														_g8 = (_g8 + 1);
HXDLIN(1354)														width8 = (width8 + position9->advance->x);
            													}
            												}
HXDLIN(1354)												widthValue = width8;
HXDLIN(1354)												bool _hx_tmp21;
HXDLIN(1354)												if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1354)													_hx_tmp21 = (layoutGroup->startIndex != layoutGroup->endIndex);
            												}
            												else {
HXLINE(1354)													_hx_tmp21 = true;
            												}
...
HXDLIN(1354)												layoutGroup->positions = positions;
HXDLIN(1354)												int _hx_tmp22;
HXDLIN(1354)												if (firstLineOfParagraph) {
HXLINE(1354)													_hx_tmp22 = indent;
            												}
            												else {
HXLINE(1354)													_hx_tmp22 = 0;
            												}
HXDLIN(1354)												layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp22)) ));
HXDLIN(1354)												layoutGroup->ascent = ascent;
HXDLIN(1354)												layoutGroup->descent = descent;
HXDLIN(1354)												layoutGroup->leading = leading;
HXDLIN(1354)												layoutGroup->lineIndex = lineIndex;
...
HXLINE(1354)													bool _hx_tmp24;
HXDLIN(1354)													if (::hx::IsNotNull( font )) {
HXLINE(1354)														_hx_tmp24 = (font->unitsPerEM != 0);
            													}
            													else {
HXLINE(1354)														_hx_tmp24 = false;
            													}
...
HXDLIN(1354)											if (::hx::IsNotNull( font )) {
HXLINE(1354)												_hx_tmp25 = (font->unitsPerEM != 0);
            											}
            											else {
...
HXLINE(1354)										::String text8 = _gthis->text;
...
HXDLIN(1354)										_gthis->_hx___textLayout->letterSpacing = letterSpacing8;
HXDLIN(1354)										bool positions6;
HXDLIN(1354)										if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)											positions6 = (_gthis->sharpness < 400);
            										}
            										else {
HXLINE(1354)											positions6 = true;
            										}
HXDLIN(1354)										_gthis->_hx___textLayout->autoHint = positions6;
HXDLIN(1354)										 ::openfl::text::_internal::TextLayout _gthis9 = _gthis->_hx___textLayout;
HXDLIN(1354)										_gthis9->set_text(text8.substring(placeIndex,breakIndex));
HXDLIN(1354)										if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)											positions = _gthis->_hx___textLayout->get_positions();
            										}
            										else {
...
HXLINE(1354)												 ::openfl::text::_internal::GlyphPosition position10 = positions->__get(_g9).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)												_g9 = (_g9 + 1);
HXDLIN(1354)												width9 = (width9 + position10->advance->x);
            											}
            										}
...
HXLINE(1354)												::String text9 = _gthis->text;
...
HXDLIN(1354)												_gthis->_hx___textLayout->letterSpacing = letterSpacing9;
HXDLIN(1354)												bool _hx_tmp26;
HXDLIN(1354)												if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)													_hx_tmp26 = (_gthis->sharpness < 400);
            												}
            												else {
HXLINE(1354)													_hx_tmp26 = true;
            												}
HXDLIN(1354)												_gthis->_hx___textLayout->autoHint = _hx_tmp26;
HXDLIN(1354)												 ::openfl::text::_internal::TextLayout _gthis10 = _gthis->_hx___textLayout;
HXDLIN(1354)												_gthis10->set_text(text9.substring(tempIndex3,tempRangeEnd4));
HXDLIN(1354)												::Array< ::Dynamic> tempPositions3;
HXDLIN(1354)												if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)													tempPositions3 = _gthis->_hx___textLayout->get_positions();
            												}
            												else {
HXLINE(1354)													tempPositions3 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            												}
HXDLIN(1354)												positions = positions->concat(tempPositions3);
            											}
HXDLIN(1354)											if ((tempRangeEnd4 != breakIndex)) {
HXLINE(1354)												bool _hx_tmp27;
HXDLIN(1354)												if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1354)													rangeIndex = (rangeIndex + 1);
HXDLIN(1354)													formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1354)													currentFormat->_hx___merge(formatRange->format);
HXDLIN(1354)													font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1354)													_hx_tmp27 = true;
            												}
            												else {
HXLINE(1354)													_hx_tmp27 = false;
            												}
HXDLIN(1354)												if (!(_hx_tmp27)) {
HXLINE(1354)													::lime::utils::Log_obj::warn(HX_("You found a bug in OpenFL's text code! Please save a copy of your project and contact Joshua Granick (@singmajesty) so we can fix this.",08,e2,e2,42),::hx::SourceInfo(HX_("openfl/text/_internal/TextEngine.hx",39,18,5e,b8),1096,HX_("openfl.text._internal.TextEngine",04,88,80,7e),HX_("getLayoutGroups",54,f8,56,5a)));
...
HXLINE(1354)														 ::openfl::text::_internal::GlyphPosition position11 = positions->__get(_g10).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)														_g10 = (_g10 + 1);
HXDLIN(1354)														width10 = (width10 + position11->advance->x);
            													}
            												}
...
HXDLIN(1354)						{
HXLINE(1354)							if ((breakIndex <= formatRange->end)) {
HXLINE(1354)								::String text10 = _gthis->text;
...
HXDLIN(1354)								_gthis->_hx___textLayout->letterSpacing = letterSpacing10;
HXDLIN(1354)								bool positions7;
HXDLIN(1354)								if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)									positions7 = (_gthis->sharpness < 400);
            								}
            								else {
HXLINE(1354)									positions7 = true;
            								}
HXDLIN(1354)								_gthis->_hx___textLayout->autoHint = positions7;
HXDLIN(1354)								 ::openfl::text::_internal::TextLayout _gthis11 = _gthis->_hx___textLayout;
HXDLIN(1354)								_gthis11->set_text(text10.substring(textIndex,breakIndex));
HXDLIN(1354)								if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)									positions = _gthis->_hx___textLayout->get_positions();
            								}
            								else {
...
HXLINE(1354)										 ::openfl::text::_internal::GlyphPosition position12 = positions->__get(_g11).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)										_g11 = (_g11 + 1);
HXDLIN(1354)										width11 = (width11 + position12->advance->x);
            									}
            								}
HXDLIN(1354)								widthValue = width11;
HXDLIN(1354)								bool _hx_tmp28;
HXDLIN(1354)								if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1354)									_hx_tmp28 = (layoutGroup->startIndex != layoutGroup->endIndex);
            								}
            								else {
HXLINE(1354)									_hx_tmp28 = true;
            								}
...
HXDLIN(1354)								layoutGroup->positions = positions;
HXDLIN(1354)								int _hx_tmp29;
HXDLIN(1354)								if (firstLineOfParagraph) {
HXLINE(1354)									_hx_tmp29 = indent;
            								}
            								else {
HXLINE(1354)									_hx_tmp29 = 0;
            								}
HXDLIN(1354)								layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp29)) ));
HXDLIN(1354)								layoutGroup->ascent = ascent;
HXDLIN(1354)								layoutGroup->descent = descent;
HXDLIN(1354)								layoutGroup->leading = leading;
HXDLIN(1354)								layoutGroup->lineIndex = lineIndex;
...
HXLINE(1354)											bool _hx_tmp30;
HXDLIN(1354)											if (::hx::IsNotNull( font )) {
HXLINE(1354)												_hx_tmp30 = (font->unitsPerEM != 0);
            											}
            											else {
HXLINE(1354)												_hx_tmp30 = false;
            											}
HXDLIN(1354)											if (_hx_tmp30) {
HXLINE(1354)												ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1354)												descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            											}
            											else {
...
HXLINE(1354)										::String text11 = _gthis->text;
...
HXDLIN(1354)										_gthis->_hx___textLayout->letterSpacing = letterSpacing11;
HXDLIN(1354)										bool positions8;
HXDLIN(1354)										if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1354)											positions8 = (_gthis->sharpness < 400);
            										}
            										else {
HXLINE(1354)											positions8 = true;
            										}
HXDLIN(1354)										_gthis->_hx___textLayout->autoHint = positions8;
HXDLIN(1354)										 ::openfl::text::_internal::TextLayout _gthis12 = _gthis->_hx___textLayout;
HXDLIN(1354)										_gthis12->set_text(text11.substring(textIndex,tempRangeEnd5));
HXDLIN(1354)										if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1354)											positions = _gthis->_hx___textLayout->get_positions();
            										}
            										else {
...
HXLINE(1354)												 ::openfl::text::_internal::GlyphPosition position13 = positions->__get(_g12).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1354)												_g12 = (_g12 + 1);
HXDLIN(1354)												width12 = (width12 + position13->advance->x);
            											}
            										}
HXDLIN(1354)										widthValue = width12;
HXDLIN(1354)										bool _hx_tmp31;
HXDLIN(1354)										if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1354)											_hx_tmp31 = (layoutGroup->startIndex != layoutGroup->endIndex);
            										}
            										else {
HXLINE(1354)											_hx_tmp31 = true;
            										}
...
HXDLIN(1354)										layoutGroup->positions = positions;
HXDLIN(1354)										int _hx_tmp32;
HXDLIN(1354)										if (firstLineOfParagraph) {
HXLINE(1354)											_hx_tmp32 = indent;
            										}
            										else {
HXLINE(1354)											_hx_tmp32 = 0;
            										}
HXDLIN(1354)										layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp32)) ));
HXDLIN(1354)										layoutGroup->ascent = ascent;
HXDLIN(1354)										layoutGroup->descent = descent;
HXDLIN(1354)										layoutGroup->leading = leading;
HXDLIN(1354)										layoutGroup->lineIndex = lineIndex;
...
HXDLIN(1354)									bool _hx_tmp33;
HXDLIN(1354)									if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1354)										rangeIndex = (rangeIndex + 1);
HXDLIN(1354)										formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1354)										currentFormat->_hx___merge(formatRange->format);
HXDLIN(1354)										font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1354)										_hx_tmp33 = true;
            									}
            									else {
...
HXDLIN(1354)											if (::hx::IsNotNull( font )) {
HXLINE(1354)												_hx_tmp34 = (font->unitsPerEM != 0);
            											}
            											else {
...
HXLINE(1358)					bool _hx_tmp35;
HXDLIN(1358)					if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1358)						_hx_tmp35 = (layoutGroup->startIndex != layoutGroup->endIndex);
            					}
            					else {
HXLINE(1358)						_hx_tmp35 = false;
            					}
HXDLIN(1358)					if (_hx_tmp35) {
...
HXDLIN(1363)							Float _hx_tmp36;
HXDLIN(1363)							bool _hx_tmp37;
HXDLIN(1363)							if ((index >= 0)) {
HXLINE(1363)								_hx_tmp37 = (index < layoutGroup->positions->length);
            							}
            							else {
HXLINE(1363)								_hx_tmp37 = false;
            							}
HXDLIN(1363)							if (_hx_tmp37) {
HXLINE(1363)								_hx_tmp36 = layoutGroup->positions->__get(index).StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
            							}
            							else {
HXLINE(1363)								_hx_tmp36 = ( (Float)(0) );
            							}
HXDLIN(1363)							layoutGroup1->width = (layoutGroup1->width - _hx_tmp36);
            						}
...
HXLINE(1369)							bool _hx_tmp38;
HXDLIN(1369)							if (::hx::IsNotNull( font )) {
HXLINE(1369)								_hx_tmp38 = (font->unitsPerEM != 0);
            							}
            							else {
HXLINE(1369)								_hx_tmp38 = false;
            							}
HXDLIN(1369)							if (_hx_tmp38) {
...
HXDLIN(1369)					int i2 = _gthis->layoutGroups->get_length();
HXDLIN(1369)					while(true){
HXLINE(1369)						i2 = (i2 - 1);
HXDLIN(1369)						if (!((i2 > -1))) {
HXLINE(1369)							goto _hx_goto_41;
            						}
HXDLIN(1369)						 ::openfl::text::_internal::TextLayoutGroup lg1 = _gthis->layoutGroups->get(i2).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE(1375)							bool _hx_tmp39;
HXDLIN(1375)							if (::hx::IsNotNull( font )) {
HXLINE(1375)								_hx_tmp39 = (font->unitsPerEM != 0);
            							}
            							else {
HXLINE(1375)								_hx_tmp39 = false;
            							}
HXDLIN(1375)							if (_hx_tmp39) {
...
HXDLIN(1383)					bool _hx_tmp40 = ::hx::IsNotNull( currentFormat->bullet );
HXDLIN(1383)					bool _hx_tmp41 = ::hx::IsNotNull( currentFormat->tabStops );
            				}
            			}
            			else {
HXLINE(1385)				if ((spaceIndex > -1)) {
HXLINE(1389)					bool _hx_tmp42;
HXDLIN(1389)					if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1389)						_hx_tmp42 = (layoutGroup->startIndex != layoutGroup->endIndex);
            					}
            					else {
HXLINE(1389)						_hx_tmp42 = false;
            					}
HXDLIN(1389)					if (_hx_tmp42) {
HXLINE(1391)						layoutGroup = null();
            					}
HXLINE(1394)					wrap = false;
HXLINE(1396)					while((textIndex < this->text.length)){
HXLINE(1400)						HX_VARI_NAME( int,endIndex2,"endIndex") = -1;
HXLINE(1402)						if ((spaceIndex == -1)) {
HXLINE(1404)							endIndex2 = breakIndex;
            						}
            						else {
HXLINE(1408)							endIndex2 = (spaceIndex + 1);
HXLINE(1410)							bool _hx_tmp43;
HXDLIN(1410)							if ((breakIndex > -1)) {
HXLINE(1410)								_hx_tmp43 = (breakIndex < endIndex2);
            							}
            							else {
HXLINE(1410)								_hx_tmp43 = false;
            							}
HXDLIN(1410)							if (_hx_tmp43) {
...
HXLINE(1421)								::String text12 = _gthis->text;
...
HXDLIN(1421)								_gthis->_hx___textLayout->letterSpacing = letterSpacing12;
HXDLIN(1421)								bool positions9;
HXDLIN(1421)								if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1421)									positions9 = (_gthis->sharpness < 400);
            								}
            								else {
HXLINE(1421)									positions9 = true;
            								}
HXDLIN(1421)								_gthis->_hx___textLayout->autoHint = positions9;
HXDLIN(1421)								 ::openfl::text::_internal::TextLayout _gthis13 = _gthis->_hx___textLayout;
HXDLIN(1421)								_gthis13->set_text(text12.substring(textIndex,endIndex2));
...
HXLINE(1421)										 ::openfl::text::_internal::GlyphPosition position14 = positions->__get(_g13).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1421)										_g13 = (_g13 + 1);
HXDLIN(1421)										width13 = (width13 + position14->advance->x);
            									}
            								}
...
HXLINE(1421)										::String text13 = _gthis->text;
...
HXDLIN(1421)										_gthis->_hx___textLayout->letterSpacing = letterSpacing13;
HXDLIN(1421)										bool _hx_tmp44;
HXDLIN(1421)										if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1421)											_hx_tmp44 = (_gthis->sharpness < 400);
            										}
            										else {
HXLINE(1421)											_hx_tmp44 = true;
            										}
HXDLIN(1421)										_gthis->_hx___textLayout->autoHint = _hx_tmp44;
HXDLIN(1421)										 ::openfl::text::_internal::TextLayout _gthis14 = _gthis->_hx___textLayout;
HXDLIN(1421)										_gthis14->set_text(text13.substring(tempIndex4,tempRangeEnd6));
HXDLIN(1421)										::Array< ::Dynamic> tempPositions4;
HXDLIN(1421)										if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1421)											tempPositions4 = _gthis->_hx___textLayout->get_positions();
            										}
            										else {
HXLINE(1421)											tempPositions4 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            										}
HXDLIN(1421)										positions = positions->concat(tempPositions4);
            									}
HXDLIN(1421)									if ((tempRangeEnd6 != endIndex2)) {
HXLINE(1421)										bool _hx_tmp45;
...
HXDLIN(1421)											_hx_tmp45 = true;
            										}
            										else {
HXLINE(1421)											_hx_tmp45 = false;
            										}
HXDLIN(1421)										if (!(_hx_tmp45)) {
...
HXLINE(1421)												 ::openfl::text::_internal::GlyphPosition position15 = positions->__get(_g14).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1421)												_g14 = (_g14 + 1);
HXDLIN(1421)												width14 = (width14 + position15->advance->x);
            											}
            										}
...
HXLINE(1425)							bool _hx_tmp46;
HXDLIN(1425)							if ((positions->length > 0)) {
HXLINE(1425)								_hx_tmp46 = (textIndex == previousSpaceIndex);
            							}
            							else {
HXLINE(1425)								_hx_tmp46 = false;
            							}
HXDLIN(1425)							if (_hx_tmp46) {
HXLINE(1428)								textIndex = (textIndex + 1);
HXLINE(1430)								HX_VARI( Float,spaceWidth) = positions->shift().StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
HXLINE(1431)								widthValue = (widthValue - spaceWidth);
HXLINE(1432)								offsetX = (offsetX + spaceWidth);
            							}
HXLINE(1435)							bool _hx_tmp47;
HXDLIN(1435)							if ((positions->length > 0)) {
HXLINE(1435)								_hx_tmp47 = (endIndex2 == (spaceIndex + 1));
            							}
            							else {
HXLINE(1435)								_hx_tmp47 = false;
            							}
HXDLIN(1435)							if (_hx_tmp47) {
HXLINE(1438)								endIndex2 = (endIndex2 - 1);
HXLINE(1440)								HX_VARI_NAME( Float,spaceWidth1,"spaceWidth") = positions->pop().StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
HXLINE(1441)								widthValue = (widthValue - spaceWidth1);
            							}
            						}
HXLINE(1445)						if (this->wordWrap) {
HXLINE(1447)							int _hx_tmp48;
HXDLIN(1447)							if (firstLineOfParagraph) {
HXLINE(1447)								_hx_tmp48 = indent;
            							}
            							else {
HXLINE(1447)								_hx_tmp48 = 0;
            							}
HXDLIN(1447)							if (((offsetX + widthValue) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp48)) )))) {
HXLINE(1449)								wrap = true;
HXLINE(1451)								bool _hx_tmp49;
HXDLIN(1451)								if ((positions->length > 0)) {
HXLINE(1451)									_hx_tmp49 = (endIndex2 == (spaceIndex + 1));
            								}
            								else {
HXLINE(1451)									_hx_tmp49 = false;
            								}
HXDLIN(1451)								if (_hx_tmp49) {
HXLINE(1455)									HX_VARI(  ::openfl::text::_internal::GlyphPosition,lastPosition) = positions->__get((positions->length - 1)).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXLINE(1456)									HX_VARI_NAME( Float,spaceWidth2,"spaceWidth") = lastPosition->advance->x;
HXLINE(1458)									int _hx_tmp50;
HXDLIN(1458)									if (firstLineOfParagraph) {
HXLINE(1458)										_hx_tmp50 = indent;
            									}
            									else {
HXLINE(1458)										_hx_tmp50 = 0;
            									}
HXDLIN(1458)									if ((((offsetX + widthValue) - spaceWidth2) <= (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp50)) )))) {
...
HXLINE(1466)						if (wrap) {
HXLINE(1468)							bool _hx_tmp51;
HXDLIN(1468)							if (::hx::IsNotEq( align,2 )) {
HXLINE(1468)								if (::hx::IsNull( layoutGroup )) {
HXLINE(1468)									_hx_tmp51 = (this->layoutGroups->get_length() > 0);
            								}
            								else {
HXLINE(1468)									_hx_tmp51 = true;
            								}
            							}
            							else {
HXLINE(1468)								_hx_tmp51 = false;
            							}
HXDLIN(1468)							if (_hx_tmp51) {
HXLINE(1470)								HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,previous) = layoutGroup;
...
HXDLIN(1477)								Float _hx_tmp52;
HXDLIN(1477)								bool _hx_tmp53;
HXDLIN(1477)								if ((index1 >= 0)) {
HXLINE(1477)									_hx_tmp53 = (index1 < previous->positions->length);
            								}
            								else {
HXLINE(1477)									_hx_tmp53 = false;
            								}
HXDLIN(1477)								if (_hx_tmp53) {
HXLINE(1477)									_hx_tmp52 = previous->positions->__get(index1).StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
            								}
            								else {
HXLINE(1477)									_hx_tmp52 = ( (Float)(0) );
            								}
HXDLIN(1477)								previous1->width = (previous1->width - _hx_tmp52);
HXLINE(1478)								previous->endIndex--;
            							}
HXLINE(1481)							HX_VARI_NAME( int,i3,"i") = (this->layoutGroups->get_length() - 1);
HXLINE(1482)							HX_VARI( int,offsetCount) = 0;
HXLINE(1484)							while((i3 >= 0)){
HXLINE(1486)								layoutGroup = this->layoutGroups->get(i3).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
HXLINE(1488)								bool _hx_tmp54;
HXDLIN(1488)								if ((i3 > 0)) {
HXLINE(1488)									_hx_tmp54 = (layoutGroup->startIndex > previousSpaceIndex);
            								}
            								else {
HXLINE(1488)									_hx_tmp54 = false;
            								}
HXDLIN(1488)								if (_hx_tmp54) {
...
HXLINE(1502)										bool _hx_tmp55;
HXDLIN(1502)										if (::hx::IsNotNull( font )) {
HXLINE(1502)											_hx_tmp55 = (font->unitsPerEM != 0);
            										}
            										else {
HXLINE(1502)											_hx_tmp55 = false;
            										}
HXDLIN(1502)										if (_hx_tmp55) {
...
HXDLIN(1502)								int i4 = _gthis->layoutGroups->get_length();
HXDLIN(1502)								while(true){
HXLINE(1502)									i4 = (i4 - 1);
HXDLIN(1502)									if (!((i4 > -1))) {
HXLINE(1502)										goto _hx_goto_47;
            									}
HXDLIN(1502)									 ::openfl::text::_internal::TextLayoutGroup lg2 = _gthis->layoutGroups->get(i4).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXDLIN(1509)								HX_VARI( Float,bumpX) = ( ( ::openfl::_Vector::ObjectVector)(this2) )->get((this->layoutGroups->get_length() - offsetCount)).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >()->offsetX;
HXLINE(1511)								{
...
HXDLIN(1511)										HX_VARI_NAME( int,i5,"i") = (_g15 - 1);
HXLINE(1513)										layoutGroup = this->layoutGroups->get(i5).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE(1521)							{
HXLINE(1521)								bool _hx_tmp56;
HXDLIN(1521)								if ((_gthis->width >= 4)) {
HXLINE(1521)									_hx_tmp56 = _gthis->wordWrap;
            								}
            								else {
HXLINE(1521)									_hx_tmp56 = false;
            								}
HXDLIN(1521)								if (_hx_tmp56) {
...
HXLINE(1521)											 ::openfl::text::_internal::GlyphPosition position16 = remainingPositions1->__get(_g17).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)											_g17 = (_g17 + 1);
HXDLIN(1521)											width15 = (width15 + position16->advance->x);
            										}
            									}
HXDLIN(1521)									Float tempWidth1 = width15;
HXDLIN(1521)									int i6 = (remainingPositions1->length - 1);
HXDLIN(1521)									while((i6 >= 0)){
HXLINE(1521)										 ::Dynamic currentCharCode1 = _gthis->text.charCodeAt((textIndex + i6));
HXDLIN(1521)										bool _hx_tmp57;
HXDLIN(1521)										if (::hx::IsNotEq( currentCharCode1,32 )) {
HXLINE(1521)											_hx_tmp57 = ::hx::IsNotEq( currentCharCode1,9 );
            										}
            										else {
...
HXDLIN(1521)										 ::openfl::text::_internal::GlyphPosition position17 = remainingPositions1->__get(i6).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)										tempWidth1 = (tempWidth1 - position17->advance->x);
HXDLIN(1521)										i6 = (i6 - 1);
            									}
            									_hx_goto_50:;
HXDLIN(1521)									while(true){
HXLINE(1521)										bool _hx_tmp58;
HXDLIN(1521)										if ((remainingPositions1->length > 0)) {
HXLINE(1521)											int _hx_tmp59;
HXDLIN(1521)											if (firstLineOfParagraph) {
HXLINE(1521)												_hx_tmp59 = indent;
            											}
            											else {
HXLINE(1521)												_hx_tmp59 = 0;
            											}
HXDLIN(1521)											_hx_tmp58 = ((offsetX + tempWidth1) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp59)) )));
            										}
            										else {
HXLINE(1521)											_hx_tmp58 = false;
            										}
HXDLIN(1521)										if (!(_hx_tmp58)) {
HXLINE(1521)											goto _hx_goto_51;
            										}
HXDLIN(1521)										bufferCount1 = 0;
HXDLIN(1521)										i6 = bufferCount1;
HXDLIN(1521)										positionWidth1 = ((Float)0.0);
HXDLIN(1521)										while(true){
HXLINE(1521)											int _hx_tmp60;
HXDLIN(1521)											if (firstLineOfParagraph) {
HXLINE(1521)												_hx_tmp60 = indent;
            											}
            											else {
HXLINE(1521)												_hx_tmp60 = 0;
            											}
HXDLIN(1521)											if (!(((offsetX + positionWidth1) < (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp60)) ))))) {
HXLINE(1521)												goto _hx_goto_52;
            											}
HXDLIN(1521)											currentPosition1 = remainingPositions1->__get(i6).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
...
HXDLIN(1521)												i6 = (i6 + 1);
            										...
            										_hx_goto_52:;
HXDLIN(1521)										if ((i6 == bufferCount1)) {
HXLINE(1521)											i6 = (bufferCount1 + 1);
            										}
            										else {
HXLINE(1521)											while(true){
HXLINE(1521)												bool _hx_tmp61;
HXDLIN(1521)												if ((i6 > 1)) {
HXLINE(1521)													int _hx_tmp62;
HXDLIN(1521)													if (firstLineOfParagraph) {
HXLINE(1521)														_hx_tmp62 = indent;
            													}
            													else {
HXLINE(1521)														_hx_tmp62 = 0;
            													}
HXDLIN(1521)													_hx_tmp61 = ((offsetX + positionWidth1) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp62)) )));
            												}
            												else {
HXLINE(1521)													_hx_tmp61 = false;
            												}
HXDLIN(1521)												if (!(_hx_tmp61)) {
HXLINE(1521)													goto _hx_goto_53;
            												}
HXDLIN(1521)												i6 = (i6 - 1);
HXDLIN(1521)												if (((i6 - bufferCount1) > 0)) {
HXLINE(1521)													{
HXLINE(1521)														int endIndex3 = ((textIndex + i6) - bufferCount1);
...
HXLINE(1521)																::String text14 = _gthis->text;
...
HXDLIN(1521)																_gthis->_hx___textLayout->letterSpacing = letterSpacing14;
HXDLIN(1521)																bool positions10;
HXDLIN(1521)																if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)																	positions10 = (_gthis->sharpness < 400);
            																}
            																else {
HXLINE(1521)																	positions10 = true;
            																}
HXDLIN(1521)																_gthis->_hx___textLayout->autoHint = positions10;
HXDLIN(1521)																 ::openfl::text::_internal::TextLayout _gthis15 = _gthis->_hx___textLayout;
HXDLIN(1521)																_gthis15->set_text(text14.substring(textIndex,endIndex3));
...
HXLINE(1521)																		 ::openfl::text::_internal::GlyphPosition position18 = positions->__get(_g18).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)																		_g18 = (_g18 + 1);
HXDLIN(1521)																		width16 = (width16 + position18->advance->x);
            																	}
            																}
...
HXLINE(1521)																		::String text15 = _gthis->text;
...
HXDLIN(1521)																		_gthis->_hx___textLayout->letterSpacing = letterSpacing15;
HXDLIN(1521)																		bool _hx_tmp63;
HXDLIN(1521)																		if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)																			_hx_tmp63 = (_gthis->sharpness < 400);
            																		}
            																		else {
HXLINE(1521)																			_hx_tmp63 = true;
            																		}
HXDLIN(1521)																		_gthis->_hx___textLayout->autoHint = _hx_tmp63;
HXDLIN(1521)																		 ::openfl::text::_internal::TextLayout _gthis16 = _gthis->_hx___textLayout;
HXDLIN(1521)																		_gthis16->set_text(text15.substring(tempIndex5,tempRangeEnd7));
HXDLIN(1521)																		::Array< ::Dynamic> tempPositions5;
HXDLIN(1521)																		if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)																			tempPositions5 = _gthis->_hx___textLayout->get_positions();
            																		}
            																		else {
HXLINE(1521)																			tempPositions5 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																		}
HXDLIN(1521)																		positions = positions->concat(tempPositions5);
            																	}
HXDLIN(1521)																	if ((tempRangeEnd7 != endIndex3)) {
HXLINE(1521)																		bool _hx_tmp64;
...
HXDLIN(1521)																			_hx_tmp64 = true;
            																		}
            																		else {
HXLINE(1521)																			_hx_tmp64 = false;
            																		}
HXDLIN(1521)																		if (!(_hx_tmp64)) {
...
HXLINE(1521)																				 ::openfl::text::_internal::GlyphPosition position19 = positions->__get(_g19).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)																				_g19 = (_g19 + 1);
HXDLIN(1521)																				width17 = (width17 + position19->advance->x);
            																			}
            																		}
...
HXLINE(1521)																::String text16 = _gthis->text;
...
HXDLIN(1521)																_gthis->_hx___textLayout->letterSpacing = letterSpacing16;
HXDLIN(1521)																bool positions11;
HXDLIN(1521)																if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)																	positions11 = (_gthis->sharpness < 400);
            																}
            																else {
HXLINE(1521)																	positions11 = true;
            																}
HXDLIN(1521)																_gthis->_hx___textLayout->autoHint = positions11;
HXDLIN(1521)																 ::openfl::text::_internal::TextLayout _gthis17 = _gthis->_hx___textLayout;
HXDLIN(1521)																_gthis17->set_text(text16.substring(textIndex,endIndex4));
HXDLIN(1521)																if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)																	positions = _gthis->_hx___textLayout->get_positions();
            																}
            																else {
...
HXLINE(1521)																		 ::openfl::text::_internal::GlyphPosition position20 = positions->__get(_g20).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)																		_g20 = (_g20 + 1);
HXDLIN(1521)																		width18 = (width18 + position20->advance->x);
            																	}
            																}
...
HXLINE(1521)																		::String text17 = _gthis->text;
...
HXDLIN(1521)																		_gthis->_hx___textLayout->letterSpacing = letterSpacing17;
HXDLIN(1521)																		bool _hx_tmp65;
HXDLIN(1521)																		if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)																			_hx_tmp65 = (_gthis->sharpness < 400);
            																		}
            																		else {
HXLINE(1521)																			_hx_tmp65 = true;
            																		}
HXDLIN(1521)																		_gthis->_hx___textLayout->autoHint = _hx_tmp65;
HXDLIN(1521)																		 ::openfl::text::_internal::TextLayout _gthis18 = _gthis->_hx___textLayout;
HXDLIN(1521)																		_gthis18->set_text(text17.substring(tempIndex6,tempRangeEnd8));
HXDLIN(1521)																		::Array< ::Dynamic> tempPositions6;
HXDLIN(1521)																		if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)																			tempPositions6 = _gthis->_hx___textLayout->get_positions();
            																		}
            																		else {
HXLINE(1521)																			tempPositions6 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																		}
HXDLIN(1521)																		positions = positions->concat(tempPositions6);
            																	}
HXDLIN(1521)																	if ((tempRangeEnd8 != endIndex4)) {
HXLINE(1521)																		bool _hx_tmp66;
HXDLIN(1521)																		if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1521)																			rangeIndex = (rangeIndex + 1);
HXDLIN(1521)																			formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1521)																			currentFormat->_hx___merge(formatRange->format);
HXDLIN(1521)																			font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1521)																			_hx_tmp66 = true;
            																		}
            																		else {
HXLINE(1521)																			_hx_tmp66 = false;
            																		}
...
HXLINE(1521)																				 ::openfl::text::_internal::GlyphPosition position21 = positions->__get(_g21).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)																				_g21 = (_g21 + 1);
HXDLIN(1521)																				width19 = (width19 + position21->advance->x);
            																			}
            																		}
...
HXDLIN(1521)										placeIndex1 = ((textIndex + i6) - bufferCount1);
HXDLIN(1521)										{
HXLINE(1521)											if ((placeIndex1 <= formatRange->end)) {
HXLINE(1521)												::String text18 = _gthis->text;
...
HXDLIN(1521)												_gthis->_hx___textLayout->letterSpacing = letterSpacing18;
HXDLIN(1521)												bool positions12;
HXDLIN(1521)												if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)													positions12 = (_gthis->sharpness < 400);
            												}
            												else {
HXLINE(1521)													positions12 = true;
            												}
HXDLIN(1521)												_gthis->_hx___textLayout->autoHint = positions12;
HXDLIN(1521)												 ::openfl::text::_internal::TextLayout _gthis19 = _gthis->_hx___textLayout;
HXDLIN(1521)												_gthis19->set_text(text18.substring(textIndex,placeIndex1));
HXDLIN(1521)												if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)													positions = _gthis->_hx___textLayout->get_positions();
            												}
            												else {
...
HXLINE(1521)														 ::openfl::text::_internal::GlyphPosition position22 = positions->__get(_g22).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)														_g22 = (_g22 + 1);
HXDLIN(1521)														width20 = (width20 + position22->advance->x);
            													}
            												}
HXDLIN(1521)												widthValue = width20;
HXDLIN(1521)												bool _hx_tmp67;
HXDLIN(1521)												if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1521)													_hx_tmp67 = (layoutGroup->startIndex != layoutGroup->endIndex);
            												}
            												else {
HXLINE(1521)													_hx_tmp67 = true;
            												}
HXDLIN(1521)												if (_hx_tmp67) {
...
HXDLIN(1521)												int _hx_tmp68;
HXDLIN(1521)												if (firstLineOfParagraph) {
HXLINE(1521)													_hx_tmp68 = indent;
            												}
            												else {
HXLINE(1521)													_hx_tmp68 = 0;
            												}
HXDLIN(1521)												layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp68)) ));
...
HXLINE(1521)														::String text19 = _gthis->text;
...
HXDLIN(1521)														_gthis->_hx___textLayout->letterSpacing = letterSpacing19;
HXDLIN(1521)														bool positions13;
HXDLIN(1521)														if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)															positions13 = (_gthis->sharpness < 400);
            														}
            														else {
HXLINE(1521)															positions13 = true;
            														}
HXDLIN(1521)														_gthis->_hx___textLayout->autoHint = positions13;
HXDLIN(1521)														 ::openfl::text::_internal::TextLayout _gthis20 = _gthis->_hx___textLayout;
HXDLIN(1521)														_gthis20->set_text(text19.substring(textIndex,tempRangeEnd9));
HXDLIN(1521)														if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)															positions = _gthis->_hx___textLayout->get_positions();
            														}
            														else {
...
HXLINE(1521)																 ::openfl::text::_internal::GlyphPosition position23 = positions->__get(_g23).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)																_g23 = (_g23 + 1);
HXDLIN(1521)																width21 = (width21 + position23->advance->x);
            															}
            														}
HXDLIN(1521)														widthValue = width21;
HXDLIN(1521)														bool _hx_tmp70;
HXDLIN(1521)														if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1521)															_hx_tmp70 = (layoutGroup->startIndex != layoutGroup->endIndex);
            														}
            														else {
HXLINE(1521)															_hx_tmp70 = true;
            														}
...
HXDLIN(1521)														layoutGroup->positions = positions;
HXDLIN(1521)														int _hx_tmp71;
HXDLIN(1521)														if (firstLineOfParagraph) {
HXLINE(1521)															_hx_tmp71 = indent;
            														}
            														else {
HXLINE(1521)															_hx_tmp71 = 0;
            														}
HXDLIN(1521)														layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp71)) ));
HXDLIN(1521)														layoutGroup->ascent = ascent;
HXDLIN(1521)														layoutGroup->descent = descent;
HXDLIN(1521)														layoutGroup->leading = leading;
HXDLIN(1521)														layoutGroup->lineIndex = lineIndex;
...
HXLINE(1521)															bool _hx_tmp73;
HXDLIN(1521)															if (::hx::IsNotNull( font )) {
HXLINE(1521)																_hx_tmp73 = (font->unitsPerEM != 0);
            															}
            															else {
HXLINE(1521)																_hx_tmp73 = false;
            															}
...
HXLINE(1521)													bool _hx_tmp74;
HXDLIN(1521)													if (::hx::IsNotNull( font )) {
HXLINE(1521)														_hx_tmp74 = (font->unitsPerEM != 0);
            													}
            													else {
HXLINE(1521)														_hx_tmp74 = false;
            													}
HXDLIN(1521)													if (_hx_tmp74) {
HXLINE(1521)														ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1521)														descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            													}
            													else {
...
HXDLIN(1521)											int i7 = _gthis->layoutGroups->get_length();
HXDLIN(1521)											while(true){
HXLINE(1521)												i7 = (i7 - 1);
HXDLIN(1521)												if (!((i7 > -1))) {
HXLINE(1521)													goto _hx_goto_63;
            												}
HXDLIN(1521)												 ::openfl::text::_internal::TextLayoutGroup lg3 = _gthis->layoutGroups->get(i7).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE(1521)												::String text20 = _gthis->text;
...
HXDLIN(1521)												_gthis->_hx___textLayout->letterSpacing = letterSpacing20;
HXDLIN(1521)												bool positions14;
HXDLIN(1521)												if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)													positions14 = (_gthis->sharpness < 400);
            												}
            												else {
HXLINE(1521)													positions14 = true;
            												}
HXDLIN(1521)												_gthis->_hx___textLayout->autoHint = positions14;
HXDLIN(1521)												 ::openfl::text::_internal::TextLayout _gthis21 = _gthis->_hx___textLayout;
HXDLIN(1521)												_gthis21->set_text(text20.substring(placeIndex1,endIndex2));
HXDLIN(1521)												if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)													positions = _gthis->_hx___textLayout->get_positions();
            												}
            												else {
...
HXLINE(1521)														 ::openfl::text::_internal::GlyphPosition position24 = positions->__get(_g24).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)														_g24 = (_g24 + 1);
HXDLIN(1521)														width22 = (width22 + position24->advance->x);
            													}
            												}
...
HXLINE(1521)														::String text21 = _gthis->text;
...
HXDLIN(1521)														_gthis->_hx___textLayout->letterSpacing = letterSpacing21;
HXDLIN(1521)														bool _hx_tmp75;
HXDLIN(1521)														if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)															_hx_tmp75 = (_gthis->sharpness < 400);
            														}
            														else {
HXLINE(1521)															_hx_tmp75 = true;
            														}
HXDLIN(1521)														_gthis->_hx___textLayout->autoHint = _hx_tmp75;
HXDLIN(1521)														 ::openfl::text::_internal::TextLayout _gthis22 = _gthis->_hx___textLayout;
HXDLIN(1521)														_gthis22->set_text(text21.substring(tempIndex7,tempRangeEnd10));
HXDLIN(1521)														::Array< ::Dynamic> tempPositions7;
HXDLIN(1521)														if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)															tempPositions7 = _gthis->_hx___textLayout->get_positions();
            														}
            														else {
HXLINE(1521)															tempPositions7 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            														}
HXDLIN(1521)														positions = positions->concat(tempPositions7);
            													}
HXDLIN(1521)													if ((tempRangeEnd10 != endIndex2)) {
HXLINE(1521)														bool _hx_tmp76;
HXDLIN(1521)														if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1521)															rangeIndex = (rangeIndex + 1);
HXDLIN(1521)															formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1521)															currentFormat->_hx___merge(formatRange->format);
HXDLIN(1521)															font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1521)															_hx_tmp76 = true;
            														}
            														else {
HXLINE(1521)															_hx_tmp76 = false;
            														}
...
HXLINE(1521)																 ::openfl::text::_internal::GlyphPosition position25 = positions->__get(_g25).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)																_g25 = (_g25 + 1);
HXDLIN(1521)																width23 = (width23 + position25->advance->x);
            															}
            														}
...
HXDLIN(1521)								{
HXLINE(1521)									if ((endIndex2 <= formatRange->end)) {
HXLINE(1521)										::String text22 = _gthis->text;
...
HXDLIN(1521)										_gthis->_hx___textLayout->letterSpacing = letterSpacing22;
HXDLIN(1521)										bool positions15;
HXDLIN(1521)										if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)											positions15 = (_gthis->sharpness < 400);
            										}
            										else {
HXLINE(1521)											positions15 = true;
            										}
HXDLIN(1521)										_gthis->_hx___textLayout->autoHint = positions15;
HXDLIN(1521)										 ::openfl::text::_internal::TextLayout _gthis23 = _gthis->_hx___textLayout;
HXDLIN(1521)										_gthis23->set_text(text22.substring(textIndex,endIndex2));
HXDLIN(1521)										if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)											positions = _gthis->_hx___textLayout->get_positions();
            										}
            										else {
...
HXLINE(1521)												 ::openfl::text::_internal::GlyphPosition position26 = positions->__get(_g26).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)												_g26 = (_g26 + 1);
HXDLIN(1521)												width24 = (width24 + position26->advance->x);
            											}
            										}
HXDLIN(1521)										widthValue = width24;
HXDLIN(1521)										bool _hx_tmp77;
HXDLIN(1521)										if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1521)											_hx_tmp77 = (layoutGroup->startIndex != layoutGroup->endIndex);
            										}
            										else {
HXLINE(1521)											_hx_tmp77 = true;
            										}
HXDLIN(1521)										if (_hx_tmp77) {
...
HXDLIN(1521)										layoutGroup->positions = positions;
HXDLIN(1521)										int _hx_tmp78;
HXDLIN(1521)										if (firstLineOfParagraph) {
HXLINE(1521)											_hx_tmp78 = indent;
            										}
            										else {
HXLINE(1521)											_hx_tmp78 = 0;
            										}
HXDLIN(1521)										layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp78)) ));
HXDLIN(1521)										layoutGroup->ascent = ascent;
HXDLIN(1521)										layoutGroup->descent = descent;
HXDLIN(1521)										layoutGroup->leading = leading;
HXDLIN(1521)										layoutGroup->lineIndex = lineIndex;
...
HXLINE(1521)												::String text23 = _gthis->text;
...
HXDLIN(1521)												_gthis->_hx___textLayout->letterSpacing = letterSpacing23;
HXDLIN(1521)												bool positions16;
HXDLIN(1521)												if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1521)													positions16 = (_gthis->sharpness < 400);
            												}
            												else {
HXLINE(1521)													positions16 = true;
            												}
HXDLIN(1521)												_gthis->_hx___textLayout->autoHint = positions16;
HXDLIN(1521)												 ::openfl::text::_internal::TextLayout _gthis24 = _gthis->_hx___textLayout;
HXDLIN(1521)												_gthis24->set_text(text23.substring(textIndex,tempRangeEnd11));
HXDLIN(1521)												if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1521)													positions = _gthis->_hx___textLayout->get_positions();
            												}
            												else {
...
HXLINE(1521)														 ::openfl::text::_internal::GlyphPosition position27 = positions->__get(_g27).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1521)														_g27 = (_g27 + 1);
HXDLIN(1521)														width25 = (width25 + position27->advance->x);
            													}
            												}
HXDLIN(1521)												widthValue = width25;
HXDLIN(1521)												bool _hx_tmp80;
HXDLIN(1521)												if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1521)													_hx_tmp80 = (layoutGroup->startIndex != layoutGroup->endIndex);
            												}
            												else {
HXLINE(1521)													_hx_tmp80 = true;
            												}
HXDLIN(1521)												if (_hx_tmp80) {
...
HXDLIN(1521)												layoutGroup->positions = positions;
HXDLIN(1521)												int _hx_tmp81;
HXDLIN(1521)												if (firstLineOfParagraph) {
HXLINE(1521)													_hx_tmp81 = indent;
            												}
            												else {
HXLINE(1521)													_hx_tmp81 = 0;
            												}
HXDLIN(1521)												layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp81)) ));
HXDLIN(1521)												layoutGroup->ascent = ascent;
HXDLIN(1521)												layoutGroup->descent = descent;
HXDLIN(1521)												layoutGroup->leading = leading;
HXDLIN(1521)												layoutGroup->lineIndex = lineIndex;
...
HXDLIN(1521)											bool _hx_tmp82;
HXDLIN(1521)											if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1521)												rangeIndex = (rangeIndex + 1);
HXDLIN(1521)												formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1521)												currentFormat->_hx___merge(formatRange->format);
HXDLIN(1521)												font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1521)												_hx_tmp82 = true;
            											}
            											else {
HXLINE(1521)												_hx_tmp82 = false;
            											}
HXDLIN(1521)											if (!(_hx_tmp82)) {
HXLINE(1521)												::lime::utils::Log_obj::warn(HX_("You found a bug in OpenFL's text code! Please save a copy of your project and contact Joshua Granick (@singmajesty) so we can fix this.",08,e2,e2,42),::hx::SourceInfo(HX_("openfl/text/_internal/TextEngine.hx",39,18,5e,b8),1184,HX_("openfl.text._internal.TextEngine",04,88,80,7e),HX_("getLayoutGroups",54,f8,56,5a)));
...
HXLINE(1521)													bool _hx_tmp83;
HXDLIN(1521)													if (::hx::IsNotNull( font )) {
HXLINE(1521)														_hx_tmp83 = (font->unitsPerEM != 0);
            													}
            													else {
HXLINE(1521)														_hx_tmp83 = false;
            													}
HXDLIN(1521)													if (_hx_tmp83) {
HXLINE(1521)														ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1521)														descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            													}
            													else {
...
HXLINE(1527)							bool _hx_tmp84;
HXDLIN(1527)							bool _hx_tmp85;
HXDLIN(1527)							if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1527)								_hx_tmp85 = (textIndex == spaceIndex);
            							}
            							else {
HXLINE(1527)								_hx_tmp85 = false;
            							}
HXDLIN(1527)							if (_hx_tmp85) {
HXLINE(1527)								_hx_tmp84 = (previousSpaceIndex != (spaceIndex - 1));
            							}
            							else {
HXLINE(1527)								_hx_tmp84 = false;
            							}
HXDLIN(1527)							if (_hx_tmp84) {
...
HXLINE(1540)								bool _hx_tmp86;
HXDLIN(1540)								if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1540)									_hx_tmp86 = ::hx::IsEq( align,2 );
            								}
            								else {
HXLINE(1540)									_hx_tmp86 = true;
            								}
HXDLIN(1540)								if (_hx_tmp86) {
HXLINE(1542)									{
HXLINE(1542)										bool _hx_tmp87;
HXDLIN(1542)										if ((_gthis->width >= 4)) {
HXLINE(1542)											_hx_tmp87 = _gthis->wordWrap;
            										}
            										else {
HXLINE(1542)											_hx_tmp87 = false;
            										}
HXDLIN(1542)										if (_hx_tmp87) {
...
HXLINE(1542)													 ::openfl::text::_internal::GlyphPosition position28 = remainingPositions2->__get(_g28).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)													_g28 = (_g28 + 1);
HXDLIN(1542)													width26 = (width26 + position28->advance->x);
            												}
            											}
HXDLIN(1542)											Float tempWidth2 = width26;
HXDLIN(1542)											int i8 = (remainingPositions2->length - 1);
HXDLIN(1542)											while((i8 >= 0)){
HXLINE(1542)												 ::Dynamic currentCharCode2 = _gthis->text.charCodeAt((textIndex + i8));
HXDLIN(1542)												bool _hx_tmp88;
HXDLIN(1542)												if (::hx::IsNotEq( currentCharCode2,32 )) {
HXLINE(1542)													_hx_tmp88 = ::hx::IsNotEq( currentCharCode2,9 );
            												}
            												else {
...
HXDLIN(1542)												 ::openfl::text::_internal::GlyphPosition position29 = remainingPositions2->__get(i8).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)												tempWidth2 = (tempWidth2 - position29->advance->x);
HXDLIN(1542)												i8 = (i8 - 1);
            											}
            											_hx_goto_71:;
HXDLIN(1542)											while(true){
HXLINE(1542)												bool _hx_tmp89;
HXDLIN(1542)												if ((remainingPositions2->length > 0)) {
HXLINE(1542)													int _hx_tmp90;
HXDLIN(1542)													if (firstLineOfParagraph) {
HXLINE(1542)														_hx_tmp90 = indent;
            													}
            													else {
HXLINE(1542)														_hx_tmp90 = 0;
            													}
HXDLIN(1542)													_hx_tmp89 = ((offsetX + tempWidth2) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp90)) )));
            												}
            												else {
HXLINE(1542)													_hx_tmp89 = false;
            												}
HXDLIN(1542)												if (!(_hx_tmp89)) {
HXLINE(1542)													goto _hx_goto_72;
            												}
HXDLIN(1542)												bufferCount2 = 0;
HXDLIN(1542)												i8 = bufferCount2;
HXDLIN(1542)												positionWidth2 = ((Float)0.0);
HXDLIN(1542)												while(true){
HXLINE(1542)													int _hx_tmp91;
HXDLIN(1542)													if (firstLineOfParagraph) {
HXLINE(1542)														_hx_tmp91 = indent;
            													}
            													else {
HXLINE(1542)														_hx_tmp91 = 0;
            													}
HXDLIN(1542)													if (!(((offsetX + positionWidth2) < (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp91)) ))))) {
HXLINE(1542)														goto _hx_goto_73;
            													}
HXDLIN(1542)													currentPosition2 = remainingPositions2->__get(i8).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
...
HXDLIN(1542)														i8 = (i8 + 1);
            												...
            												_hx_goto_73:;
HXDLIN(1542)												if ((i8 == bufferCount2)) {
HXLINE(1542)													i8 = (bufferCount2 + 1);
            												}
            												else {
HXLINE(1542)													while(true){
HXLINE(1542)														bool _hx_tmp92;
HXDLIN(1542)														if ((i8 > 1)) {
HXLINE(1542)															int _hx_tmp93;
HXDLIN(1542)															if (firstLineOfParagraph) {
HXLINE(1542)																_hx_tmp93 = indent;
            															}
            															else {
HXLINE(1542)																_hx_tmp93 = 0;
            															}
HXDLIN(1542)															_hx_tmp92 = ((offsetX + positionWidth2) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp93)) )));
            														}
            														else {
HXLINE(1542)															_hx_tmp92 = false;
            														}
HXDLIN(1542)														if (!(_hx_tmp92)) {
HXLINE(1542)															goto _hx_goto_74;
            														}
HXDLIN(1542)														i8 = (i8 - 1);
HXDLIN(1542)														if (((i8 - bufferCount2) > 0)) {
HXLINE(1542)															{
HXLINE(1542)																int endIndex5 = ((textIndex + i8) - bufferCount2);
...
HXLINE(1542)																		::String text24 = _gthis->text;
...
HXDLIN(1542)																		_gthis->_hx___textLayout->letterSpacing = letterSpacing24;
HXDLIN(1542)																		bool positions17;
HXDLIN(1542)																		if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)																			positions17 = (_gthis->sharpness < 400);
            																		}
            																		else {
HXLINE(1542)																			positions17 = true;
            																		}
HXDLIN(1542)																		_gthis->_hx___textLayout->autoHint = positions17;
HXDLIN(1542)																		 ::openfl::text::_internal::TextLayout _gthis25 = _gthis->_hx___textLayout;
HXDLIN(1542)																		_gthis25->set_text(text24.substring(textIndex,endIndex5));
...
HXLINE(1542)																				 ::openfl::text::_internal::GlyphPosition position30 = positions->__get(_g29).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																				_g29 = (_g29 + 1);
HXDLIN(1542)																				width27 = (width27 + position30->advance->x);
            																			}
            																		}
...
HXLINE(1542)																				::String text25 = _gthis->text;
...
HXDLIN(1542)																				_gthis->_hx___textLayout->letterSpacing = letterSpacing25;
HXDLIN(1542)																				bool _hx_tmp94;
HXDLIN(1542)																				if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)																					_hx_tmp94 = (_gthis->sharpness < 400);
            																				}
            																				else {
HXLINE(1542)																					_hx_tmp94 = true;
            																				}
HXDLIN(1542)																				_gthis->_hx___textLayout->autoHint = _hx_tmp94;
HXDLIN(1542)																				 ::openfl::text::_internal::TextLayout _gthis26 = _gthis->_hx___textLayout;
HXDLIN(1542)																				_gthis26->set_text(text25.substring(tempIndex8,tempRangeEnd12));
HXDLIN(1542)																				::Array< ::Dynamic> tempPositions8;
HXDLIN(1542)																				if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)																					tempPositions8 = _gthis->_hx___textLayout->get_positions();
            																				}
            																				else {
HXLINE(1542)																					tempPositions8 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																				}
HXDLIN(1542)																				positions = positions->concat(tempPositions8);
            																			}
HXDLIN(1542)																			if ((tempRangeEnd12 != endIndex5)) {
HXLINE(1542)																				bool _hx_tmp95;
...
HXDLIN(1542)																					_hx_tmp95 = true;
            																				}
            																				else {
HXLINE(1542)																					_hx_tmp95 = false;
            																				}
HXDLIN(1542)																				if (!(_hx_tmp95)) {
...
HXLINE(1542)																						 ::openfl::text::_internal::GlyphPosition position31 = positions->__get(_g30).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																						_g30 = (_g30 + 1);
HXDLIN(1542)																						width28 = (width28 + position31->advance->x);
            																					}
            																				}
...
HXLINE(1542)																		::String text26 = _gthis->text;
...
HXDLIN(1542)																		_gthis->_hx___textLayout->letterSpacing = letterSpacing26;
HXDLIN(1542)																		bool positions18;
HXDLIN(1542)																		if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)																			positions18 = (_gthis->sharpness < 400);
            																		}
            																		else {
HXLINE(1542)																			positions18 = true;
            																		}
HXDLIN(1542)																		_gthis->_hx___textLayout->autoHint = positions18;
HXDLIN(1542)																		 ::openfl::text::_internal::TextLayout _gthis27 = _gthis->_hx___textLayout;
HXDLIN(1542)																		_gthis27->set_text(text26.substring(textIndex,endIndex6));
HXDLIN(1542)																		if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)																			positions = _gthis->_hx___textLayout->get_positions();
            																		}
            																		else {
...
HXLINE(1542)																				 ::openfl::text::_internal::GlyphPosition position32 = positions->__get(_g31).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																				_g31 = (_g31 + 1);
HXDLIN(1542)																				width29 = (width29 + position32->advance->x);
            																			}
            																		}
...
HXLINE(1542)																				::String text27 = _gthis->text;
...
HXDLIN(1542)																				_gthis->_hx___textLayout->letterSpacing = letterSpacing27;
HXDLIN(1542)																				bool _hx_tmp96;
HXDLIN(1542)																				if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)																					_hx_tmp96 = (_gthis->sharpness < 400);
            																				}
            																				else {
HXLINE(1542)																					_hx_tmp96 = true;
            																				}
HXDLIN(1542)																				_gthis->_hx___textLayout->autoHint = _hx_tmp96;
HXDLIN(1542)																				 ::openfl::text::_internal::TextLayout _gthis28 = _gthis->_hx___textLayout;
HXDLIN(1542)																				_gthis28->set_text(text27.substring(tempIndex9,tempRangeEnd13));
HXDLIN(1542)																				::Array< ::Dynamic> tempPositions9;
HXDLIN(1542)																				if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)																					tempPositions9 = _gthis->_hx___textLayout->get_positions();
            																				}
            																				else {
HXLINE(1542)																					tempPositions9 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																				}
HXDLIN(1542)																				positions = positions->concat(tempPositions9);
            																			}
HXDLIN(1542)																			if ((tempRangeEnd13 != endIndex6)) {
HXLINE(1542)																				bool _hx_tmp97;
HXDLIN(1542)																				if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1542)																					rangeIndex = (rangeIndex + 1);
HXDLIN(1542)																					formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1542)																					currentFormat->_hx___merge(formatRange->format);
HXDLIN(1542)																					font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1542)																					_hx_tmp97 = true;
            																				}
            																				else {
HXLINE(1542)																					_hx_tmp97 = false;
            																				}
...
HXLINE(1542)																						 ::openfl::text::_internal::GlyphPosition position33 = positions->__get(_g32).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																						_g32 = (_g32 + 1);
HXDLIN(1542)																						width30 = (width30 + position33->advance->x);
            																					}
            																				}
...
HXDLIN(1542)												placeIndex2 = ((textIndex + i8) - bufferCount2);
HXDLIN(1542)												{
HXLINE(1542)													if ((placeIndex2 <= formatRange->end)) {
HXLINE(1542)														::String text28 = _gthis->text;
...
HXDLIN(1542)														_gthis->_hx___textLayout->letterSpacing = letterSpacing28;
HXDLIN(1542)														bool positions19;
HXDLIN(1542)														if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)															positions19 = (_gthis->sharpness < 400);
            														}
            														else {
HXLINE(1542)															positions19 = true;
            														}
HXDLIN(1542)														_gthis->_hx___textLayout->autoHint = positions19;
HXDLIN(1542)														 ::openfl::text::_internal::TextLayout _gthis29 = _gthis->_hx___textLayout;
HXDLIN(1542)														_gthis29->set_text(text28.substring(textIndex,placeIndex2));
HXDLIN(1542)														if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)															positions = _gthis->_hx___textLayout->get_positions();
            														}
            														else {
...
HXLINE(1542)																 ::openfl::text::_internal::GlyphPosition position34 = positions->__get(_g33).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																_g33 = (_g33 + 1);
HXDLIN(1542)																width31 = (width31 + position34->advance->x);
            															}
            														}
HXDLIN(1542)														widthValue = width31;
HXDLIN(1542)														bool _hx_tmp98;
HXDLIN(1542)														if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1542)															_hx_tmp98 = (layoutGroup->startIndex != layoutGroup->endIndex);
            														}
            														else {
HXLINE(1542)															_hx_tmp98 = true;
            														}
HXDLIN(1542)														if (_hx_tmp98) {
...
HXDLIN(1542)														int _hx_tmp99;
HXDLIN(1542)														if (firstLineOfParagraph) {
HXLINE(1542)															_hx_tmp99 = indent;
            														}
            														else {
HXLINE(1542)															_hx_tmp99 = 0;
            														}
HXDLIN(1542)														layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp99)) ));
...
HXLINE(1542)																::String text29 = _gthis->text;
...
HXDLIN(1542)																_gthis->_hx___textLayout->letterSpacing = letterSpacing29;
HXDLIN(1542)																bool positions20;
HXDLIN(1542)																if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)																	positions20 = (_gthis->sharpness < 400);
            																}
            																else {
HXLINE(1542)																	positions20 = true;
            																}
HXDLIN(1542)																_gthis->_hx___textLayout->autoHint = positions20;
HXDLIN(1542)																 ::openfl::text::_internal::TextLayout _gthis30 = _gthis->_hx___textLayout;
HXDLIN(1542)																_gthis30->set_text(text29.substring(textIndex,tempRangeEnd14));
HXDLIN(1542)																if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)																	positions = _gthis->_hx___textLayout->get_positions();
            																}
            																else {
...
HXLINE(1542)																		 ::openfl::text::_internal::GlyphPosition position35 = positions->__get(_g34).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																		_g34 = (_g34 + 1);
HXDLIN(1542)																		width32 = (width32 + position35->advance->x);
            																	}
            																}
HXDLIN(1542)																widthValue = width32;
HXDLIN(1542)																bool _hx_tmp101;
HXDLIN(1542)																if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1542)																	_hx_tmp101 = (layoutGroup->startIndex != layoutGroup->endIndex);
            																}
            																else {
HXLINE(1542)																	_hx_tmp101 = true;
            																}
...
HXDLIN(1542)																layoutGroup->positions = positions;
HXDLIN(1542)																int _hx_tmp102;
HXDLIN(1542)																if (firstLineOfParagraph) {
HXLINE(1542)																	_hx_tmp102 = indent;
            																}
            																else {
HXLINE(1542)																	_hx_tmp102 = 0;
            																}
HXDLIN(1542)																layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp102)) ));
HXDLIN(1542)																layoutGroup->ascent = ascent;
HXDLIN(1542)																layoutGroup->descent = descent;
HXDLIN(1542)																layoutGroup->leading = leading;
HXDLIN(1542)																layoutGroup->lineIndex = lineIndex;
...
HXLINE(1542)																	bool _hx_tmp104;
HXDLIN(1542)																	if (::hx::IsNotNull( font )) {
HXLINE(1542)																		_hx_tmp104 = (font->unitsPerEM != 0);
            																	}
            																	else {
HXLINE(1542)																		_hx_tmp104 = false;
            																	}
...
HXLINE(1542)															bool _hx_tmp105;
HXDLIN(1542)															if (::hx::IsNotNull( font )) {
HXLINE(1542)																_hx_tmp105 = (font->unitsPerEM != 0);
            															}
            															else {
HXLINE(1542)																_hx_tmp105 = false;
            															}
HXDLIN(1542)															if (_hx_tmp105) {
HXLINE(1542)																ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1542)																descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            															}
            															else {
...
HXDLIN(1542)													int i9 = _gthis->layoutGroups->get_length();
HXDLIN(1542)													while(true){
HXLINE(1542)														i9 = (i9 - 1);
HXDLIN(1542)														if (!((i9 > -1))) {
HXLINE(1542)															goto _hx_goto_84;
            														}
HXDLIN(1542)														 ::openfl::text::_internal::TextLayoutGroup lg4 = _gthis->layoutGroups->get(i9).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE(1542)														::String text30 = _gthis->text;
...
HXDLIN(1542)														_gthis->_hx___textLayout->letterSpacing = letterSpacing30;
HXDLIN(1542)														bool positions21;
HXDLIN(1542)														if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)															positions21 = (_gthis->sharpness < 400);
            														}
            														else {
HXLINE(1542)															positions21 = true;
            														}
HXDLIN(1542)														_gthis->_hx___textLayout->autoHint = positions21;
HXDLIN(1542)														 ::openfl::text::_internal::TextLayout _gthis31 = _gthis->_hx___textLayout;
HXDLIN(1542)														_gthis31->set_text(text30.substring(placeIndex2,endIndex2));
HXDLIN(1542)														if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)															positions = _gthis->_hx___textLayout->get_positions();
            														}
            														else {
...
HXLINE(1542)																 ::openfl::text::_internal::GlyphPosition position36 = positions->__get(_g35).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																_g35 = (_g35 + 1);
HXDLIN(1542)																width33 = (width33 + position36->advance->x);
            															}
            														}
...
HXLINE(1542)																::String text31 = _gthis->text;
...
HXDLIN(1542)																_gthis->_hx___textLayout->letterSpacing = letterSpacing31;
HXDLIN(1542)																bool _hx_tmp106;
HXDLIN(1542)																if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)																	_hx_tmp106 = (_gthis->sharpness < 400);
            																}
            																else {
HXLINE(1542)																	_hx_tmp106 = true;
            																}
HXDLIN(1542)																_gthis->_hx___textLayout->autoHint = _hx_tmp106;
HXDLIN(1542)																 ::openfl::text::_internal::TextLayout _gthis32 = _gthis->_hx___textLayout;
HXDLIN(1542)																_gthis32->set_text(text31.substring(tempIndex10,tempRangeEnd15));
HXDLIN(1542)																::Array< ::Dynamic> tempPositions10;
HXDLIN(1542)																if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)																	tempPositions10 = _gthis->_hx___textLayout->get_positions();
            																}
            																else {
HXLINE(1542)																	tempPositions10 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																}
HXDLIN(1542)																positions = positions->concat(tempPositions10);
            															}
HXDLIN(1542)															if ((tempRangeEnd15 != endIndex2)) {
HXLINE(1542)																bool _hx_tmp107;
HXDLIN(1542)																if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1542)																	rangeIndex = (rangeIndex + 1);
HXDLIN(1542)																	formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1542)																	currentFormat->_hx___merge(formatRange->format);
HXDLIN(1542)																	font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1542)																	_hx_tmp107 = true;
            																}
            																else {
HXLINE(1542)																	_hx_tmp107 = false;
            																}
...
HXLINE(1542)																		 ::openfl::text::_internal::GlyphPosition position37 = positions->__get(_g36).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																		_g36 = (_g36 + 1);
HXDLIN(1542)																		width34 = (width34 + position37->advance->x);
            																	}
            																}
...
HXDLIN(1542)										{
HXLINE(1542)											if ((endIndex2 <= formatRange->end)) {
HXLINE(1542)												::String text32 = _gthis->text;
...
HXDLIN(1542)												_gthis->_hx___textLayout->letterSpacing = letterSpacing32;
HXDLIN(1542)												bool positions22;
HXDLIN(1542)												if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)													positions22 = (_gthis->sharpness < 400);
            												}
            												else {
HXLINE(1542)													positions22 = true;
            												}
HXDLIN(1542)												_gthis->_hx___textLayout->autoHint = positions22;
HXDLIN(1542)												 ::openfl::text::_internal::TextLayout _gthis33 = _gthis->_hx___textLayout;
HXDLIN(1542)												_gthis33->set_text(text32.substring(textIndex,endIndex2));
HXDLIN(1542)												if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)													positions = _gthis->_hx___textLayout->get_positions();
            												}
            												else {
...
HXLINE(1542)														 ::openfl::text::_internal::GlyphPosition position38 = positions->__get(_g37).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)														_g37 = (_g37 + 1);
HXDLIN(1542)														width35 = (width35 + position38->advance->x);
            													}
            												}
HXDLIN(1542)												widthValue = width35;
HXDLIN(1542)												bool _hx_tmp108;
HXDLIN(1542)												if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1542)													_hx_tmp108 = (layoutGroup->startIndex != layoutGroup->endIndex);
            												}
            												else {
HXLINE(1542)													_hx_tmp108 = true;
            												}
HXDLIN(1542)												if (_hx_tmp108) {
...
HXDLIN(1542)												layoutGroup->positions = positions;
HXDLIN(1542)												int _hx_tmp109;
HXDLIN(1542)												if (firstLineOfParagraph) {
HXLINE(1542)													_hx_tmp109 = indent;
            												}
            												else {
HXLINE(1542)													_hx_tmp109 = 0;
            												}
HXDLIN(1542)												layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp109)) ));
HXDLIN(1542)												layoutGroup->ascent = ascent;
HXDLIN(1542)												layoutGroup->descent = descent;
HXDLIN(1542)												layoutGroup->leading = leading;
HXDLIN(1542)												layoutGroup->lineIndex = lineIndex;
...
HXLINE(1542)														::String text33 = _gthis->text;
...
HXDLIN(1542)														_gthis->_hx___textLayout->letterSpacing = letterSpacing33;
HXDLIN(1542)														bool positions23;
HXDLIN(1542)														if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1542)															positions23 = (_gthis->sharpness < 400);
            														}
            														else {
HXLINE(1542)															positions23 = true;
            														}
HXDLIN(1542)														_gthis->_hx___textLayout->autoHint = positions23;
HXDLIN(1542)														 ::openfl::text::_internal::TextLayout _gthis34 = _gthis->_hx___textLayout;
HXDLIN(1542)														_gthis34->set_text(text33.substring(textIndex,tempRangeEnd16));
HXDLIN(1542)														if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1542)															positions = _gthis->_hx___textLayout->get_positions();
            														}
            														else {
...
HXLINE(1542)																 ::openfl::text::_internal::GlyphPosition position39 = positions->__get(_g38).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1542)																_g38 = (_g38 + 1);
HXDLIN(1542)																width36 = (width36 + position39->advance->x);
            															}
            														}
HXDLIN(1542)														widthValue = width36;
HXDLIN(1542)														bool _hx_tmp111;
HXDLIN(1542)														if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1542)															_hx_tmp111 = (layoutGroup->startIndex != layoutGroup->endIndex);
            														}
            														else {
HXLINE(1542)															_hx_tmp111 = true;
            														}
HXDLIN(1542)														if (_hx_tmp111) {
...
HXDLIN(1542)														layoutGroup->positions = positions;
HXDLIN(1542)														int _hx_tmp112;
HXDLIN(1542)														if (firstLineOfParagraph) {
HXLINE(1542)															_hx_tmp112 = indent;
            														}
            														else {
HXLINE(1542)															_hx_tmp112 = 0;
            														}
HXDLIN(1542)														layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp112)) ));
HXDLIN(1542)														layoutGroup->ascent = ascent;
HXDLIN(1542)														layoutGroup->descent = descent;
HXDLIN(1542)														layoutGroup->leading = leading;
HXDLIN(1542)														layoutGroup->lineIndex = lineIndex;
...
HXDLIN(1542)													bool _hx_tmp113;
HXDLIN(1542)													if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1542)														rangeIndex = (rangeIndex + 1);
HXDLIN(1542)														formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1542)														currentFormat->_hx___merge(formatRange->format);
HXDLIN(1542)														font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1542)														_hx_tmp113 = true;
            													}
            													else {
HXLINE(1542)														_hx_tmp113 = false;
            													}
HXDLIN(1542)													if (!(_hx_tmp113)) {
HXLINE(1542)														::lime::utils::Log_obj::warn(HX_("You found a bug in OpenFL's text code! Please save a copy of your project and contact Joshua Granick (@singmajesty) so we can fix this.",08,e2,e2,42),::hx::SourceInfo(HX_("openfl/text/_internal/TextEngine.hx",39,18,5e,b8),1184,HX_("openfl.text._internal.TextEngine",04,88,80,7e),HX_("getLayoutGroups",54,f8,56,5a)));
...
HXLINE(1542)															bool _hx_tmp114;
HXDLIN(1542)															if (::hx::IsNotNull( font )) {
HXLINE(1542)																_hx_tmp114 = (font->unitsPerEM != 0);
            															}
            															else {
HXLINE(1542)																_hx_tmp114 = false;
            															}
HXDLIN(1542)															if (_hx_tmp114) {
HXLINE(1542)																ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1542)																descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            															}
            															else {
...
HXLINE(1543)												bool _hx_tmp115;
HXDLIN(1543)												if (::hx::IsNotNull( font )) {
HXLINE(1543)													_hx_tmp115 = (font->unitsPerEM != 0);
            												}
            												else {
HXLINE(1543)													_hx_tmp115 = false;
            												}
HXDLIN(1543)												if (_hx_tmp115) {
...
HXDLIN(1543)										int i10 = _gthis->layoutGroups->get_length();
HXDLIN(1543)										while(true){
HXLINE(1543)											i10 = (i10 - 1);
HXDLIN(1543)											if (!((i10 > -1))) {
HXLINE(1543)												goto _hx_goto_91;
            											}
HXDLIN(1543)											 ::openfl::text::_internal::TextLayoutGroup lg5 = _gthis->layoutGroups->get(i10).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE(1547)									HX_VAR_NAME( int,tempRangeEnd17,"tempRangeEnd");
...
HXDLIN(1551)										_gthis->_hx___textLayout->letterSpacing = letterSpacing34;
HXDLIN(1551)										bool positions24;
HXDLIN(1551)										if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1551)											positions24 = (_gthis->sharpness < 400);
            										}
            										else {
HXLINE(1551)											positions24 = true;
            										}
HXDLIN(1551)										_gthis->_hx___textLayout->autoHint = positions24;
HXDLIN(1551)										 ::openfl::text::_internal::TextLayout _gthis35 = _gthis->_hx___textLayout;
HXDLIN(1551)										_gthis35->set_text(text34.substring(textIndex,tempRangeEnd17));
...
HXLINE(1552)												 ::openfl::text::_internal::GlyphPosition position40 = positions->__get(_g39).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1552)												_g39 = (_g39 + 1);
HXDLIN(1552)												width37 = (width37 + position40->advance->x);
            											}
            										}
...
HXLINE(1565)												bool _hx_tmp116;
HXDLIN(1565)												if (::hx::IsNotNull( font )) {
HXLINE(1565)													_hx_tmp116 = (font->unitsPerEM != 0);
            												}
            												else {
HXLINE(1565)													_hx_tmp116 = false;
            												}
HXDLIN(1565)												if (_hx_tmp116) {
...
HXLINE(1571)												::String text35 = _gthis->text;
...
HXDLIN(1571)												_gthis->_hx___textLayout->letterSpacing = letterSpacing35;
HXDLIN(1571)												bool positions25;
HXDLIN(1571)												if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1571)													positions25 = (_gthis->sharpness < 400);
            												}
            												else {
HXLINE(1571)													positions25 = true;
            												}
HXDLIN(1571)												_gthis->_hx___textLayout->autoHint = positions25;
HXDLIN(1571)												 ::openfl::text::_internal::TextLayout _gthis36 = _gthis->_hx___textLayout;
HXDLIN(1571)												_gthis36->set_text(text35.substring(textIndex,endIndex2));
...
HXLINE(1571)														 ::openfl::text::_internal::GlyphPosition position41 = positions->__get(_g40).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1571)														_g40 = (_g40 + 1);
HXDLIN(1571)														width38 = (width38 + position41->advance->x);
            													}
            												}
HXDLIN(1571)												widthValue = width38;
HXDLIN(1571)												bool _hx_tmp117;
HXDLIN(1571)												if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1571)													_hx_tmp117 = (layoutGroup->startIndex != layoutGroup->endIndex);
            												}
            												else {
...
HXDLIN(1571)													layoutGroup->endIndex = endIndex2;
            												}
HXDLIN(1571)												layoutGroup->positions = positions;
HXDLIN(1571)												int _hx_tmp118;
HXDLIN(1571)												if (firstLineOfParagraph) {
HXLINE(1571)													_hx_tmp118 = indent;
            												}
            												else {
HXLINE(1571)													_hx_tmp118 = 0;
            												}
HXDLIN(1571)												layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp118)) ));
...
HXLINE(1571)															bool _hx_tmp119;
HXDLIN(1571)															if (::hx::IsNotNull( font )) {
HXLINE(1571)																_hx_tmp119 = (font->unitsPerEM != 0);
            															}
            															else {
HXLINE(1571)																_hx_tmp119 = false;
            															}
HXDLIN(1571)															if (_hx_tmp119) {
...
HXLINE(1571)														::String text36 = _gthis->text;
...
HXDLIN(1571)														_gthis->_hx___textLayout->letterSpacing = letterSpacing36;
HXDLIN(1571)														bool positions26;
HXDLIN(1571)														if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1571)															positions26 = (_gthis->sharpness < 400);
            														}
            														else {
HXLINE(1571)															positions26 = true;
            														}
HXDLIN(1571)														_gthis->_hx___textLayout->autoHint = positions26;
HXDLIN(1571)														 ::openfl::text::_internal::TextLayout _gthis37 = _gthis->_hx___textLayout;
HXDLIN(1571)														_gthis37->set_text(text36.substring(textIndex,tempRangeEnd18));
HXDLIN(1571)														if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1571)															positions = _gthis->_hx___textLayout->get_positions();
            														}
            														else {
...
HXLINE(1571)																 ::openfl::text::_internal::GlyphPosition position42 = positions->__get(_g41).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1571)																_g41 = (_g41 + 1);
HXDLIN(1571)																width39 = (width39 + position42->advance->x);
            															}
            														}
HXDLIN(1571)														widthValue = width39;
HXDLIN(1571)														bool _hx_tmp120;
HXDLIN(1571)														if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1571)															_hx_tmp120 = (layoutGroup->startIndex != layoutGroup->endIndex);
            														}
            														else {
HXLINE(1571)															_hx_tmp120 = true;
            														}
HXDLIN(1571)														if (_hx_tmp120) {
...
HXDLIN(1571)														layoutGroup->positions = positions;
HXDLIN(1571)														int _hx_tmp121;
HXDLIN(1571)														if (firstLineOfParagraph) {
HXLINE(1571)															_hx_tmp121 = indent;
            														}
            														else {
HXLINE(1571)															_hx_tmp121 = 0;
            														}
HXDLIN(1571)														layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp121)) ));
HXDLIN(1571)														layoutGroup->ascent = ascent;
HXDLIN(1571)														layoutGroup->descent = descent;
HXDLIN(1571)														layoutGroup->leading = leading;
HXDLIN(1571)														layoutGroup->lineIndex = lineIndex;
...
HXDLIN(1571)													bool _hx_tmp122;
HXDLIN(1571)													if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1571)														rangeIndex = (rangeIndex + 1);
HXDLIN(1571)														formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1571)														currentFormat->_hx___merge(formatRange->format);
HXDLIN(1571)														font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1571)														_hx_tmp122 = true;
            													}
            													else {
HXLINE(1571)														_hx_tmp122 = false;
            													}
HXDLIN(1571)													if (!(_hx_tmp122)) {
...
HXLINE(1571)															bool _hx_tmp123;
HXDLIN(1571)															if (::hx::IsNotNull( font )) {
HXLINE(1571)																_hx_tmp123 = (font->unitsPerEM != 0);
            															}
            															else {
HXLINE(1571)																_hx_tmp123 = false;
            															}
HXDLIN(1571)															if (_hx_tmp123) {
HXLINE(1571)																ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1571)																descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            															}
            															else {
...
HXLINE(1583)													bool _hx_tmp124;
HXDLIN(1583)													if (::hx::IsNotNull( font )) {
HXLINE(1583)														_hx_tmp124 = (font->unitsPerEM != 0);
            													}
            													else {
HXLINE(1583)														_hx_tmp124 = false;
            													}
HXDLIN(1583)													if (_hx_tmp124) {
...
HXDLIN(1583)											int i11 = _gthis->layoutGroups->get_length();
HXDLIN(1583)											while(true){
HXLINE(1583)												i11 = (i11 - 1);
HXDLIN(1583)												if (!((i11 > -1))) {
HXLINE(1583)													goto _hx_goto_96;
            												}
HXDLIN(1583)												 ::openfl::text::_internal::TextLayoutGroup lg6 = _gthis->layoutGroups->get(i11).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE(1595)						HX_VARI( int,nextSpaceIndex) = this->text.indexOf(HX_(" ",20,00,00,00),textIndex);
...
HXLINE(1616)						bool _hx_tmp125;
HXDLIN(1616)						bool _hx_tmp126;
HXDLIN(1616)						bool _hx_tmp127;
HXDLIN(1616)						if ((breakIndex > -1)) {
HXLINE(1616)							_hx_tmp127 = (breakIndex <= textIndex);
            						}
            						else {
HXLINE(1616)							_hx_tmp127 = false;
            						}
HXDLIN(1616)						if (_hx_tmp127) {
HXLINE(1616)							if ((spaceIndex <= breakIndex)) {
HXLINE(1616)								_hx_tmp126 = (spaceIndex == -1);
            							}
            							else {
HXLINE(1616)								_hx_tmp126 = true;
            							}
            						}
            						else {
HXLINE(1616)							_hx_tmp126 = false;
            						}
HXDLIN(1616)						if (!(_hx_tmp126)) {
HXLINE(1616)							_hx_tmp125 = (textIndex > this->text.length);
            						}
            						else {
HXLINE(1616)							_hx_tmp125 = true;
            						}
HXDLIN(1616)						if (_hx_tmp125) {
...
HXLINE(1628)									::String text37 = _gthis->text;
...
HXDLIN(1628)									_gthis->_hx___textLayout->letterSpacing = letterSpacing37;
HXDLIN(1628)									bool positions27;
HXDLIN(1628)									if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1628)										positions27 = (_gthis->sharpness < 400);
            									}
            									else {
HXLINE(1628)										positions27 = true;
            									}
HXDLIN(1628)									_gthis->_hx___textLayout->autoHint = positions27;
HXDLIN(1628)									 ::openfl::text::_internal::TextLayout _gthis38 = _gthis->_hx___textLayout;
HXDLIN(1628)									_gthis38->set_text(text37.substring(textIndex,endIndex7));
...
HXLINE(1628)											 ::openfl::text::_internal::GlyphPosition position43 = positions->__get(_g42).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1628)											_g42 = (_g42 + 1);
HXDLIN(1628)											width40 = (width40 + position43->advance->x);
            										}
            									}
...
HXLINE(1628)											::String text38 = _gthis->text;
...
HXDLIN(1628)											_gthis->_hx___textLayout->letterSpacing = letterSpacing38;
HXDLIN(1628)											bool _hx_tmp128;
HXDLIN(1628)											if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1628)												_hx_tmp128 = (_gthis->sharpness < 400);
            											}
            											else {
HXLINE(1628)												_hx_tmp128 = true;
            											}
HXDLIN(1628)											_gthis->_hx___textLayout->autoHint = _hx_tmp128;
HXDLIN(1628)											 ::openfl::text::_internal::TextLayout _gthis39 = _gthis->_hx___textLayout;
HXDLIN(1628)											_gthis39->set_text(text38.substring(tempIndex11,tempRangeEnd19));
HXDLIN(1628)											::Array< ::Dynamic> tempPositions11;
HXDLIN(1628)											if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1628)												tempPositions11 = _gthis->_hx___textLayout->get_positions();
            											}
            											else {
HXLINE(1628)												tempPositions11 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            											}
HXDLIN(1628)											positions = positions->concat(tempPositions11);
            										}
HXDLIN(1628)										if ((tempRangeEnd19 != endIndex7)) {
HXLINE(1628)											bool _hx_tmp129;
...
HXDLIN(1628)												_hx_tmp129 = true;
            											}
            											else {
HXLINE(1628)												_hx_tmp129 = false;
            											}
HXDLIN(1628)											if (!(_hx_tmp129)) {
...
HXLINE(1628)													 ::openfl::text::_internal::GlyphPosition position44 = positions->__get(_g43).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1628)													_g43 = (_g43 + 1);
HXDLIN(1628)													width41 = (width41 + position44->advance->x);
            												}
            											}
...
HXDLIN(1629)							bool _hx_tmp130;
HXDLIN(1629)							if ((_gthis->width >= 4)) {
HXLINE(1629)								_hx_tmp130 = _gthis->wordWrap;
            							}
            							else {
...
HXLINE(1629)										 ::openfl::text::_internal::GlyphPosition position45 = remainingPositions3->__get(_g44).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)										_g44 = (_g44 + 1);
HXDLIN(1629)										width42 = (width42 + position45->advance->x);
            									}
            								}
HXDLIN(1629)								Float tempWidth3 = width42;
HXDLIN(1629)								int i12 = (remainingPositions3->length - 1);
HXDLIN(1629)								while((i12 >= 0)){
HXLINE(1629)									 ::Dynamic currentCharCode3 = _gthis->text.charCodeAt((textIndex + i12));
HXDLIN(1629)									bool _hx_tmp131;
HXDLIN(1629)									if (::hx::IsNotEq( currentCharCode3,32 )) {
HXLINE(1629)										_hx_tmp131 = ::hx::IsNotEq( currentCharCode3,9 );
            									}
            									else {
HXLINE(1629)										_hx_tmp131 = false;
            									}
HXDLIN(1629)									if (_hx_tmp131) {
HXLINE(1629)										goto _hx_goto_101;
            									}
HXDLIN(1629)									 ::openfl::text::_internal::GlyphPosition position46 = remainingPositions3->__get(i12).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)									tempWidth3 = (tempWidth3 - position46->advance->x);
HXDLIN(1629)									i12 = (i12 - 1);
            								}
            								_hx_goto_101:;
HXDLIN(1629)								while(true){
HXLINE(1629)									bool _hx_tmp132;
HXDLIN(1629)									if ((remainingPositions3->length > 0)) {
HXLINE(1629)										int _hx_tmp133;
HXDLIN(1629)										if (firstLineOfParagraph) {
HXLINE(1629)											_hx_tmp133 = indent;
            										}
            										else {
HXLINE(1629)											_hx_tmp133 = 0;
            										}
HXDLIN(1629)										_hx_tmp132 = ((offsetX + tempWidth3) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp133)) )));
            									}
            									else {
HXLINE(1629)										_hx_tmp132 = false;
            									}
HXDLIN(1629)									if (!(_hx_tmp132)) {
HXLINE(1629)										goto _hx_goto_102;
            									}
HXDLIN(1629)									bufferCount3 = 0;
HXDLIN(1629)									i12 = bufferCount3;
HXDLIN(1629)									positionWidth3 = ((Float)0.0);
HXDLIN(1629)									while(true){
HXLINE(1629)										int _hx_tmp134;
HXDLIN(1629)										if (firstLineOfParagraph) {
HXLINE(1629)											_hx_tmp134 = indent;
            										}
            										else {
HXLINE(1629)											_hx_tmp134 = 0;
            										}
HXDLIN(1629)										if (!(((offsetX + positionWidth3) < (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp134)) ))))) {
HXLINE(1629)											goto _hx_goto_103;
            										}
HXDLIN(1629)										currentPosition3 = remainingPositions3->__get(i12).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
...
HXDLIN(1629)											i12 = (i12 + 1);
            									...
            									_hx_goto_103:;
HXDLIN(1629)									if ((i12 == bufferCount3)) {
HXLINE(1629)										i12 = (bufferCount3 + 1);
            									}
            									else {
HXLINE(1629)										while(true){
HXLINE(1629)											bool _hx_tmp135;
HXDLIN(1629)											if ((i12 > 1)) {
HXLINE(1629)												int _hx_tmp136;
HXDLIN(1629)												if (firstLineOfParagraph) {
HXLINE(1629)													_hx_tmp136 = indent;
            												}
            												else {
HXLINE(1629)													_hx_tmp136 = 0;
            												}
HXDLIN(1629)												_hx_tmp135 = ((offsetX + positionWidth3) > (((_gthis->width - ( (Float)(2) )) - ( (Float)(rightMargin) )) - ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp136)) )));
            											}
            											else {
...
HXDLIN(1629)											i12 = (i12 - 1);
HXDLIN(1629)											if (((i12 - bufferCount3) > 0)) {
HXLINE(1629)												{
HXLINE(1629)													int endIndex9 = ((textIndex + i12) - bufferCount3);
...
HXLINE(1629)															::String text39 = _gthis->text;
...
HXDLIN(1629)															_gthis->_hx___textLayout->letterSpacing = letterSpacing39;
HXDLIN(1629)															bool positions28;
HXDLIN(1629)															if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)																positions28 = (_gthis->sharpness < 400);
            															}
            															else {
HXLINE(1629)																positions28 = true;
            															}
HXDLIN(1629)															_gthis->_hx___textLayout->autoHint = positions28;
HXDLIN(1629)															 ::openfl::text::_internal::TextLayout _gthis40 = _gthis->_hx___textLayout;
HXDLIN(1629)															_gthis40->set_text(text39.substring(textIndex,endIndex9));
...
HXLINE(1629)																	 ::openfl::text::_internal::GlyphPosition position47 = positions->__get(_g45).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)																	_g45 = (_g45 + 1);
HXDLIN(1629)																	width43 = (width43 + position47->advance->x);
            																}
            															}
...
HXLINE(1629)																	::String text40 = _gthis->text;
...
HXDLIN(1629)																	_gthis->_hx___textLayout->letterSpacing = letterSpacing40;
HXDLIN(1629)																	bool _hx_tmp137;
HXDLIN(1629)																	if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)																		_hx_tmp137 = (_gthis->sharpness < 400);
            																	}
            																	else {
HXLINE(1629)																		_hx_tmp137 = true;
            																	}
HXDLIN(1629)																	_gthis->_hx___textLayout->autoHint = _hx_tmp137;
HXDLIN(1629)																	 ::openfl::text::_internal::TextLayout _gthis41 = _gthis->_hx___textLayout;
HXDLIN(1629)																	_gthis41->set_text(text40.substring(tempIndex12,tempRangeEnd20));
HXDLIN(1629)																	::Array< ::Dynamic> tempPositions12;
HXDLIN(1629)																	if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)																		tempPositions12 = _gthis->_hx___textLayout->get_positions();
            																	}
            																	else {
HXLINE(1629)																		tempPositions12 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																	}
...
HXLINE(1629)																			 ::openfl::text::_internal::GlyphPosition position48 = positions->__get(_g46).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)																			_g46 = (_g46 + 1);
HXDLIN(1629)																			width44 = (width44 + position48->advance->x);
            																		}
            																	}
...
HXLINE(1629)															::String text41 = _gthis->text;
...
HXDLIN(1629)															_gthis->_hx___textLayout->letterSpacing = letterSpacing41;
HXDLIN(1629)															bool positions29;
HXDLIN(1629)															if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)																positions29 = (_gthis->sharpness < 400);
            															}
            															else {
HXLINE(1629)																positions29 = true;
            															}
HXDLIN(1629)															_gthis->_hx___textLayout->autoHint = positions29;
HXDLIN(1629)															 ::openfl::text::_internal::TextLayout _gthis42 = _gthis->_hx___textLayout;
HXDLIN(1629)															_gthis42->set_text(text41.substring(textIndex,endIndex10));
HXDLIN(1629)															if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)																positions = _gthis->_hx___textLayout->get_positions();
            															}
            															else {
...
HXLINE(1629)																	 ::openfl::text::_internal::GlyphPosition position49 = positions->__get(_g47).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)																	_g47 = (_g47 + 1);
HXDLIN(1629)																	width45 = (width45 + position49->advance->x);
            																}
            															}
...
HXLINE(1629)																	::String text42 = _gthis->text;
...
HXDLIN(1629)																	_gthis->_hx___textLayout->letterSpacing = letterSpacing42;
HXDLIN(1629)																	bool _hx_tmp139;
HXDLIN(1629)																	if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)																		_hx_tmp139 = (_gthis->sharpness < 400);
            																	}
            																	else {
HXLINE(1629)																		_hx_tmp139 = true;
            																	}
HXDLIN(1629)																	_gthis->_hx___textLayout->autoHint = _hx_tmp139;
HXDLIN(1629)																	 ::openfl::text::_internal::TextLayout _gthis43 = _gthis->_hx___textLayout;
HXDLIN(1629)																	_gthis43->set_text(text42.substring(tempIndex13,tempRangeEnd21));
HXDLIN(1629)																	::Array< ::Dynamic> tempPositions13;
HXDLIN(1629)																	if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)																		tempPositions13 = _gthis->_hx___textLayout->get_positions();
            																	}
            																	else {
HXLINE(1629)																		tempPositions13 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            																	}
HXDLIN(1629)																	positions = positions->concat(tempPositions13);
            																}
HXDLIN(1629)																if ((tempRangeEnd21 != endIndex10)) {
HXLINE(1629)																	bool _hx_tmp140;
HXDLIN(1629)																	if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1629)																		rangeIndex = (rangeIndex + 1);
HXDLIN(1629)																		formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1629)																		currentFormat->_hx___merge(formatRange->format);
HXDLIN(1629)																		font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1629)																		_hx_tmp140 = true;
            																	}
            																	else {
HXLINE(1629)																		_hx_tmp140 = false;
            																	}
HXDLIN(1629)																	if (!(_hx_tmp140)) {
HXLINE(1629)																		::lime::utils::Log_obj::warn(HX_("You found a bug in OpenFL's text code! Please save a copy of your project and contact Joshua Granick (@singmajesty) so we can fix this.",08,e2,e2,42),::hx::SourceInfo(HX_("openfl/text/_internal/TextEngine.hx",39,18,5e,b8),1096,HX_("openfl.text._internal.TextEngine",04,88,80,7e),HX_("getLayoutGroups",54,f8,56,5a)));
...
HXLINE(1629)																			 ::openfl::text::_internal::GlyphPosition position50 = positions->__get(_g48).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)																			_g48 = (_g48 + 1);
HXDLIN(1629)																			width46 = (width46 + position50->advance->x);
            																		}
            																	}
...
HXDLIN(1629)									placeIndex3 = ((textIndex + i12) - bufferCount3);
HXDLIN(1629)									{
HXLINE(1629)										if ((placeIndex3 <= formatRange->end)) {
HXLINE(1629)											::String text43 = _gthis->text;
...
HXDLIN(1629)											_gthis->_hx___textLayout->letterSpacing = letterSpacing43;
HXDLIN(1629)											bool positions30;
HXDLIN(1629)											if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)												positions30 = (_gthis->sharpness < 400);
            											}
            											else {
HXLINE(1629)												positions30 = true;
            											}
HXDLIN(1629)											_gthis->_hx___textLayout->autoHint = positions30;
HXDLIN(1629)											 ::openfl::text::_internal::TextLayout _gthis44 = _gthis->_hx___textLayout;
HXDLIN(1629)											_gthis44->set_text(text43.substring(textIndex,placeIndex3));
HXDLIN(1629)											if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)												positions = _gthis->_hx___textLayout->get_positions();
            											}
            											else {
...
HXLINE(1629)													 ::openfl::text::_internal::GlyphPosition position51 = positions->__get(_g49).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)													_g49 = (_g49 + 1);
HXDLIN(1629)													width47 = (width47 + position51->advance->x);
            												}
            											}
HXDLIN(1629)											widthValue = width47;
HXDLIN(1629)											bool _hx_tmp141;
HXDLIN(1629)											if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1629)												_hx_tmp141 = (layoutGroup->startIndex != layoutGroup->endIndex);
            											}
            											else {
HXLINE(1629)												_hx_tmp141 = true;
            											}
...
HXDLIN(1629)											int _hx_tmp142;
HXDLIN(1629)											if (firstLineOfParagraph) {
HXLINE(1629)												_hx_tmp142 = indent;
            											}
            											else {
HXLINE(1629)												_hx_tmp142 = 0;
            											}
HXDLIN(1629)											layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp142)) ));
...
HXLINE(1629)													::String text44 = _gthis->text;
...
HXDLIN(1629)													_gthis->_hx___textLayout->letterSpacing = letterSpacing44;
HXDLIN(1629)													bool positions31;
HXDLIN(1629)													if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)														positions31 = (_gthis->sharpness < 400);
            													}
            													else {
HXLINE(1629)														positions31 = true;
            													}
HXDLIN(1629)													_gthis->_hx___textLayout->autoHint = positions31;
HXDLIN(1629)													 ::openfl::text::_internal::TextLayout _gthis45 = _gthis->_hx___textLayout;
HXDLIN(1629)													_gthis45->set_text(text44.substring(textIndex,tempRangeEnd22));
HXDLIN(1629)													if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)														positions = _gthis->_hx___textLayout->get_positions();
            													}
            													else {
...
HXLINE(1629)															 ::openfl::text::_internal::GlyphPosition position52 = positions->__get(_g50).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)															_g50 = (_g50 + 1);
HXDLIN(1629)															width48 = (width48 + position52->advance->x);
            														}
            													}
HXDLIN(1629)													widthValue = width48;
HXDLIN(1629)													bool _hx_tmp144;
HXDLIN(1629)													if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1629)														_hx_tmp144 = (layoutGroup->startIndex != layoutGroup->endIndex);
            													}
            													else {
HXLINE(1629)														_hx_tmp144 = true;
            													}
HXDLIN(1629)													if (_hx_tmp144) {
...
HXDLIN(1629)													layoutGroup->positions = positions;
HXDLIN(1629)													int _hx_tmp145;
HXDLIN(1629)													if (firstLineOfParagraph) {
HXLINE(1629)														_hx_tmp145 = indent;
            													}
            													else {
HXLINE(1629)														_hx_tmp145 = 0;
            													}
HXDLIN(1629)													layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp145)) ));
HXDLIN(1629)													layoutGroup->ascent = ascent;
HXDLIN(1629)													layoutGroup->descent = descent;
HXDLIN(1629)													layoutGroup->leading = leading;
HXDLIN(1629)													layoutGroup->lineIndex = lineIndex;
...
HXDLIN(1629)													currentFormat->_hx___merge(formatRange->format);
HXDLIN(1629)													font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1629)													_hx_tmp146 = true;
            												}
            												else {
HXLINE(1629)													_hx_tmp146 = false;
            												}
...
HXLINE(1629)														bool _hx_tmp147;
HXDLIN(1629)														if (::hx::IsNotNull( font )) {
HXLINE(1629)															_hx_tmp147 = (font->unitsPerEM != 0);
            														}
            														else {
HXLINE(1629)															_hx_tmp147 = false;
            														}
HXDLIN(1629)														if (_hx_tmp147) {
HXLINE(1629)															ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1629)															descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            														}
            														else {
...
HXDLIN(1629)										int i13 = _gthis->layoutGroups->get_length();
HXDLIN(1629)										while(true){
HXLINE(1629)											i13 = (i13 - 1);
HXDLIN(1629)											if (!((i13 > -1))) {
HXLINE(1629)												goto _hx_goto_114;
            											}
HXDLIN(1629)											 ::openfl::text::_internal::TextLayoutGroup lg7 = _gthis->layoutGroups->get(i13).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE(1629)											::String text45 = _gthis->text;
...
HXDLIN(1629)											_gthis->_hx___textLayout->letterSpacing = letterSpacing45;
HXDLIN(1629)											bool positions32;
HXDLIN(1629)											if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)												positions32 = (_gthis->sharpness < 400);
            											}
            											else {
HXLINE(1629)												positions32 = true;
            											}
HXDLIN(1629)											_gthis->_hx___textLayout->autoHint = positions32;
HXDLIN(1629)											 ::openfl::text::_internal::TextLayout _gthis46 = _gthis->_hx___textLayout;
HXDLIN(1629)											_gthis46->set_text(text45.substring(placeIndex3,endIndex8));
HXDLIN(1629)											if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)												positions = _gthis->_hx___textLayout->get_positions();
            											}
            											else {
...
HXLINE(1629)													 ::openfl::text::_internal::GlyphPosition position53 = positions->__get(_g51).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)													_g51 = (_g51 + 1);
HXDLIN(1629)													width49 = (width49 + position53->advance->x);
            												}
            											}
...
HXLINE(1629)													::String text46 = _gthis->text;
...
HXDLIN(1629)													_gthis->_hx___textLayout->letterSpacing = letterSpacing46;
HXDLIN(1629)													bool _hx_tmp149;
HXDLIN(1629)													if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)														_hx_tmp149 = (_gthis->sharpness < 400);
            													}
            													else {
HXLINE(1629)														_hx_tmp149 = true;
            													}
HXDLIN(1629)													_gthis->_hx___textLayout->autoHint = _hx_tmp149;
HXDLIN(1629)													 ::openfl::text::_internal::TextLayout _gthis47 = _gthis->_hx___textLayout;
HXDLIN(1629)													_gthis47->set_text(text46.substring(tempIndex14,tempRangeEnd23));
HXDLIN(1629)													::Array< ::Dynamic> tempPositions14;
HXDLIN(1629)													if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)														tempPositions14 = _gthis->_hx___textLayout->get_positions();
            													}
            													else {
HXLINE(1629)														tempPositions14 = _gthis->_hx___shapeCache->cache(formatRange,_gthis->_hx___textLayout);
            													}
HXDLIN(1629)													positions = positions->concat(tempPositions14);
            												}
HXDLIN(1629)												if ((tempRangeEnd23 != endIndex8)) {
HXLINE(1629)													bool _hx_tmp150;
HXDLIN(1629)													if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1629)														rangeIndex = (rangeIndex + 1);
HXDLIN(1629)														formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1629)														currentFormat->_hx___merge(formatRange->format);
HXDLIN(1629)														font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1629)														_hx_tmp150 = true;
            													}
            													else {
HXLINE(1629)														_hx_tmp150 = false;
            													}
HXDLIN(1629)													if (!(_hx_tmp150)) {
HXLINE(1629)														::lime::utils::Log_obj::warn(HX_("You found a bug in OpenFL's text code! Please save a copy of your project and contact Joshua Granick (@singmajesty) so we can fix this.",08,e2,e2,42),::hx::SourceInfo(HX_("openfl/text/_internal/TextEngine.hx",39,18,5e,b8),1096,HX_("openfl.text._internal.TextEngine",04,88,80,7e),HX_("getLayoutGroups",54,f8,56,5a)));
...
HXLINE(1629)															 ::openfl::text::_internal::GlyphPosition position54 = positions->__get(_g52).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)															_g52 = (_g52 + 1);
HXDLIN(1629)															width50 = (width50 + position54->advance->x);
            														}
            													}
...
HXDLIN(1629)							{
HXLINE(1629)								if ((endIndex8 <= formatRange->end)) {
HXLINE(1629)									::String text47 = _gthis->text;
...
HXDLIN(1629)									_gthis->_hx___textLayout->letterSpacing = letterSpacing47;
HXDLIN(1629)									bool positions33;
HXDLIN(1629)									if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)										positions33 = (_gthis->sharpness < 400);
            									}
            									else {
HXLINE(1629)										positions33 = true;
            									}
HXDLIN(1629)									_gthis->_hx___textLayout->autoHint = positions33;
HXDLIN(1629)									 ::openfl::text::_internal::TextLayout _gthis48 = _gthis->_hx___textLayout;
HXDLIN(1629)									_gthis48->set_text(text47.substring(textIndex,endIndex8));
HXDLIN(1629)									if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)										positions = _gthis->_hx___textLayout->get_positions();
            									}
            									else {
...
HXLINE(1629)											 ::openfl::text::_internal::GlyphPosition position55 = positions->__get(_g53).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)											_g53 = (_g53 + 1);
HXDLIN(1629)											width51 = (width51 + position55->advance->x);
            										}
            									}
HXDLIN(1629)									widthValue = width51;
HXDLIN(1629)									bool _hx_tmp151;
HXDLIN(1629)									if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1629)										_hx_tmp151 = (layoutGroup->startIndex != layoutGroup->endIndex);
            									}
            									else {
HXLINE(1629)										_hx_tmp151 = true;
            									}
...
HXDLIN(1629)									layoutGroup->positions = positions;
HXDLIN(1629)									int _hx_tmp152;
HXDLIN(1629)									if (firstLineOfParagraph) {
HXLINE(1629)										_hx_tmp152 = indent;
            									}
            									else {
HXLINE(1629)										_hx_tmp152 = 0;
            									}
HXDLIN(1629)									layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp152)) ));
HXDLIN(1629)									layoutGroup->ascent = ascent;
HXDLIN(1629)									layoutGroup->descent = descent;
HXDLIN(1629)									layoutGroup->leading = leading;
HXDLIN(1629)									layoutGroup->lineIndex = lineIndex;
...
HXLINE(1629)												bool _hx_tmp153;
HXDLIN(1629)												if (::hx::IsNotNull( font )) {
HXLINE(1629)													_hx_tmp153 = (font->unitsPerEM != 0);
            												}
            												else {
HXLINE(1629)													_hx_tmp153 = false;
            												}
HXDLIN(1629)												if (_hx_tmp153) {
HXLINE(1629)													ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1629)													descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            												}
            												else {
...
HXLINE(1629)											::String text48 = _gthis->text;
...
HXDLIN(1629)											_gthis->_hx___textLayout->letterSpacing = letterSpacing48;
HXDLIN(1629)											bool positions34;
HXDLIN(1629)											if (::hx::IsEq( _gthis->antiAliasType,0 )) {
HXLINE(1629)												positions34 = (_gthis->sharpness < 400);
            											}
            											else {
HXLINE(1629)												positions34 = true;
            											}
HXDLIN(1629)											_gthis->_hx___textLayout->autoHint = positions34;
HXDLIN(1629)											 ::openfl::text::_internal::TextLayout _gthis49 = _gthis->_hx___textLayout;
HXDLIN(1629)											_gthis49->set_text(text48.substring(textIndex,tempRangeEnd24));
HXDLIN(1629)											if (::hx::IsEq( currentFormat->align,2 )) {
HXLINE(1629)												positions = _gthis->_hx___textLayout->get_positions();
            											}
            											else {
...
HXLINE(1629)													 ::openfl::text::_internal::GlyphPosition position56 = positions->__get(_g54).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN(1629)													_g54 = (_g54 + 1);
HXDLIN(1629)													width52 = (width52 + position56->advance->x);
            												}
            											}
HXDLIN(1629)											widthValue = width52;
HXDLIN(1629)											bool _hx_tmp154;
HXDLIN(1629)											if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1629)												_hx_tmp154 = (layoutGroup->startIndex != layoutGroup->endIndex);
            											}
            											else {
HXLINE(1629)												_hx_tmp154 = true;
            											}
HXDLIN(1629)											if (_hx_tmp154) {
...
HXDLIN(1629)											layoutGroup->positions = positions;
HXDLIN(1629)											int _hx_tmp155;
HXDLIN(1629)											if (firstLineOfParagraph) {
HXLINE(1629)												_hx_tmp155 = indent;
            											}
            											else {
HXLINE(1629)												_hx_tmp155 = 0;
            											}
HXDLIN(1629)											layoutGroup->offsetX = (offsetX + ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp155)) ));
HXDLIN(1629)											layoutGroup->ascent = ascent;
HXDLIN(1629)											layoutGroup->descent = descent;
HXDLIN(1629)											layoutGroup->leading = leading;
HXDLIN(1629)											layoutGroup->lineIndex = lineIndex;
...
HXDLIN(1629)										bool _hx_tmp156;
HXDLIN(1629)										if ((rangeIndex < (_gthis->textFormatRanges->get_length() - 1))) {
HXLINE(1629)											rangeIndex = (rangeIndex + 1);
HXDLIN(1629)											formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(1629)											currentFormat->_hx___merge(formatRange->format);
HXDLIN(1629)											font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
HXDLIN(1629)											_hx_tmp156 = true;
            										}
            										else {
HXLINE(1629)											_hx_tmp156 = false;
            										}
HXDLIN(1629)										if (!(_hx_tmp156)) {
HXLINE(1629)											::lime::utils::Log_obj::warn(HX_("You found a bug in OpenFL's text code! Please save a copy of your project and contact Joshua Granick (@singmajesty) so we can fix this.",08,e2,e2,42),::hx::SourceInfo(HX_("openfl/text/_internal/TextEngine.hx",39,18,5e,b8),1184,HX_("openfl.text._internal.TextEngine",04,88,80,7e),HX_("getLayoutGroups",54,f8,56,5a)));
...
HXLINE(1629)												bool _hx_tmp157;
HXDLIN(1629)												if (::hx::IsNotNull( font )) {
HXLINE(1629)													_hx_tmp157 = (font->unitsPerEM != 0);
            												}
            												else {
HXLINE(1629)													_hx_tmp157 = false;
            												}
HXDLIN(1629)												if (_hx_tmp157) {
HXLINE(1629)													ascent = ((( (Float)(font->ascender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) ));
HXDLIN(1629)													descent = ::Math_obj::abs(((( (Float)(font->descender) ) / ( (Float)(font->unitsPerEM) )) * ( (Float)(currentFormat->size) )));
            												}
            												else {
...
HXLINE(1631)									bool _hx_tmp158;
HXDLIN(1631)									if (::hx::IsNotNull( font )) {
HXLINE(1631)										_hx_tmp158 = (font->unitsPerEM != 0);
            									}
            									else {
HXLINE(1631)										_hx_tmp158 = false;
            									}
HXDLIN(1631)									if (_hx_tmp158) {
...
HXDLIN(1631)							int i14 = _gthis->layoutGroups->get_length();
HXDLIN(1631)							while(true){
HXLINE(1631)								i14 = (i14 - 1);
HXDLIN(1631)								if (!((i14 > -1))) {
HXLINE(1631)									goto _hx_goto_121;
            								}
HXDLIN(1631)								 ::openfl::text::_internal::TextLayoutGroup lg8 = _gthis->layoutGroups->get(i14).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE(1639)		bool _hx_tmp159;
HXDLIN(1639)		if ((previousBreakIndex == (textIndex - 2))) {
HXLINE(1639)			_hx_tmp159 = (previousBreakIndex > -1);
            		}
            		else {
HXLINE(1639)			_hx_tmp159 = false;
            		}
HXDLIN(1639)		if (_hx_tmp159) {
HXLINE(1641)			{
HXLINE(1641)				int startIndex = (textIndex - 1);
HXDLIN(1641)				int endIndex11 = (textIndex - 1);
HXDLIN(1641)				bool _hx_tmp160;
HXDLIN(1641)				if (::hx::IsNotNull( layoutGroup )) {
HXLINE(1641)					_hx_tmp160 = (layoutGroup->startIndex != layoutGroup->endIndex);
            				}
            				else {
HXLINE(1641)					_hx_tmp160 = true;
            				}
HXDLIN(1641)				if (_hx_tmp160) {
...
HXLINE(1648)			int _hx_tmp161;
HXDLIN(1648)			if (firstLineOfParagraph) {
HXLINE(1648)				_hx_tmp161 = indent;
            			}
            			else {
HXLINE(1648)				_hx_tmp161 = 0;
            			}
HXDLIN(1648)			layoutGroup->offsetX = ( (Float)((((2 + leftMargin) + blockIndent) + _hx_tmp161)) );
...
void TextEngine_obj::setTextAlignment(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1696)
HXLINE(1697)		HX_VARI( int,lineIndex) = -1;
HXLINE(1698)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE(1699)		HX_VARI( Float,totalWidth) = (this->width - ( (Float)(4) ));
HXLINE(1700)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,group);
HXDLIN(1700)		HX_VAR( int,lineLength);
HXLINE(1701)		HX_VARI( bool,lineMeasurementsDirty) = false;
HXLINE(1703)		{
HXLINE(1703)			int _g = 0;
HXDLIN(1703)			int _g1 = this->layoutGroups->get_length();
HXDLIN(1703)			while((_g < _g1)){
HXLINE(1703)				_g = (_g + 1);
HXDLIN(1703)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1739)									HX_VARI( int,j) = (_g2 - 1);
...
HXLINE(1758)								HX_VARI(  ::Dynamic,endChar) = this->text.charCodeAt(group->endIndex);
...
HXLINE(1764)									HX_VARI_NAME( int,j1,"j") = 1;
HXLINE(1765)									do {
...
HXLINE(1857)			HX_VARI( int,ret) = this->lineHeights->get_length();
HXLINE(1859)			HX_VAR( Float,tempHeight);
...
HXDLIN(1861)					HX_VARI( int,i) = (_g1 - 1);
HXLINE(1863)					HX_VARI( Float,lineHeight) = this->lineHeights->get(i);
...
HXLINE(1904)			HX_VARI( int,i) = (this->numLines - 1);
HXDLIN(1904)			HX_VARI( Float,tempHeight) = ((Float)0.0);
HXLINE(1905)			HX_VARI( int,j) = i;
...
HXLINE(1963)		HX_VARI( int,max) = this->get_maxScrollV();
...
HXLINE( 206)				HX_VARI(  ::openfl::text::Font,registeredFont) = _g1->__get(_g).StaticCast<  ::openfl::text::Font >();
HXDLIN( 206)				_g = (_g + 1);
...
HXLINE( 225)		HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::Font_obj::fromFile(name);
...
HXLINE( 239)
HXLINE( 240)		HX_VARI( ::String,fontName) = format->font;
HXLINE( 241)		HX_VARI(  ::Dynamic,bold) = format->bold;
HXLINE( 242)		HX_VARI(  ::Dynamic,italic) = format->italic;
HXLINE( 244)		if (::hx::IsNull( fontName )) {
HXLINE( 244)			fontName = HX_("_serif",be,66,15,76);
            		}
HXLINE( 245)		HX_VARI( ::String,fontNamePrefix) = ::StringTools_obj::replace(::StringTools_obj::replace(fontName,HX_(" Normal",67,be,ac,97),HX_("",00,00,00,00)),HX_(" Regular",1c,be,27,76),HX_("",00,00,00,00));
...
HXLINE( 305)
HXLINE( 306)				HX_VARI(  ::openfl::text::Font,font) = null();
HXLINE( 307)				{
HXLINE( 307)					int _g = 0;
HXDLIN( 307)					while((_g < list->length)){
HXLINE( 307)						HX_VARI( ::String,path) = list->__get(_g);
HXDLIN( 307)						_g = (_g + 1);
...
HXLINE( 302)			HX_VARI( ::String,systemFontDirectory) = ::lime::_hx_system::System_obj::get_fontsDirectory();
HXLINE( 304)			HX_VARI(  ::Dynamic,processFontList) =  ::Dynamic(new _hx_Closure_0());
HXLINE( 328)			HX_VARI(  ::openfl::text::Font,sans) = ( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(9)->init(0,(systemFontDirectory + HX_("/Arial.ttf",0c,14,61,7a)))->init(1,(systemFontDirectory + HX_("/Helvetica.ttf",5a,6c,ff,0c)))->init(2,(systemFontDirectory + HX_("/Cache/Arial.ttf",5f,69,b5,54)))->init(3,(systemFontDirectory + HX_("/Cache/Helvetica.ttf",2d,67,e4,7a)))->init(4,(systemFontDirectory + HX_("/Core/Arial.ttf",ba,c6,65,25)))->init(5,(systemFontDirectory + HX_("/Core/Helvetica.ttf",08,0e,fe,0c)))->init(6,(systemFontDirectory + HX_("/CoreAddition/Arial.ttf",d6,48,2f,75)))->init(7,(systemFontDirectory + HX_("/CoreAddition/Helvetica.ttf",24,ce,e8,ab)))->init(8,HX_("/System/Library/Fonts/Supplemental/Arial.ttf",40,75,29,52)))) );
HXLINE( 339)			HX_VARI(  ::openfl::text::Font,sansBold) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Bold.ttf",f5,90,42,25));
HXLINE( 340)			HX_VARI(  ::openfl::text::Font,sansItalic) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Italic.ttf",e0,1d,06,bf));
HXLINE( 341)			HX_VARI(  ::openfl::text::Font,sansBoldItalic) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Bold Italic.ttf",cb,12,c1,33));
HXLINE( 343)			{
...
HXLINE( 410)		HX_VARI(  ::openfl::text::_internal::_TextEngine::DefaultFontSet,fontSet) = ( ( ::openfl::text::_internal::_TextEngine::DefaultFontSet)(::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts->get(name)) );
...
Float TextEngine_obj::getFormatHeight( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 417)
HXLINE( 418)		HX_VAR( Float,ascent);
HXDLIN( 418)		HX_VAR( Float,descent);
HXLINE( 428)		HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::_internal::TextEngine_obj::getFontInstance(format);
...
HXLINE( 418)		HX_VARI( int,leading) = ( (int)(format->leading) );
...
::String TextEngine_obj::getFont( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 457)
HXLINE( 458)		HX_VARI( ::String,fontName) = format->font;
HXLINE( 459)		HX_VARI(  ::Dynamic,bold) = format->bold;
HXLINE( 460)		HX_VARI(  ::Dynamic,italic) = format->italic;
HXLINE( 462)		if (::hx::IsNull( fontName )) {
HXLINE( 462)			fontName = HX_("_serif",be,66,15,76);
            		}
HXLINE( 463)		HX_VARI( ::String,fontNamePrefix) = ::StringTools_obj::replace(::StringTools_obj::replace(fontName,HX_(" Normal",67,be,ac,97),HX_("",00,00,00,00)),HX_(" Regular",1c,be,27,76),HX_("",00,00,00,00));
...
HXLINE( 471)				_hx_tmp2 = ::openfl::text::Font_obj::_hx___fontByName->exists((fontNamePrefix + HX_(" Bold",c5,3d,c7,98)));
            			}
            			else {
...
HXLINE( 476)				bool _hx_tmp3;
HXDLIN( 476)				if (( (bool)(italic) )) {
HXLINE( 476)					_hx_tmp3 = ::openfl::text::Font_obj::_hx___fontByName->exists((fontNamePrefix + HX_(" Italic",30,7b,a7,6d)));
            				}
            				else {
...
HXLINE( 485)							_hx_tmp4 = ::StringTools_obj::endsWith(fontName,HX_(" Bold",c5,3d,c7,98));
            						}
            						else {
...
HXLINE( 490)					bool _hx_tmp5;
HXDLIN( 490)					if (( (bool)(italic) )) {
HXLINE( 490)						if ((fontName.indexOf(HX_(" Italic ",f0,4e,e4,84),null()) <= -1)) {
HXLINE( 490)							_hx_tmp5 = ::StringTools_obj::endsWith(fontName,HX_(" Italic",30,7b,a7,6d));
            						}
            						else {
HXLINE( 490)							_hx_tmp5 = true;
            						}
            					}
            					else {
HXLINE( 490)						_hx_tmp5 = false;
            					}
HXDLIN( 490)					if (_hx_tmp5) {
HXLINE( 492)						italic = false;
            					}
            				}
            			}
            		}
HXLINE( 496)		HX_VAR( ::String,font);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(TextEngine_obj,getFont,return )
 ...
 ::openfl::text::Font TextEngine_obj::getFontInstance( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 515)
HXLINE( 519)		HX_VARI(  ::openfl::text::Font,instance) = null();
HXLINE( 520)		HX_VARI(  ::Dynamic,fontList) = null();
