...
HXLINE( 635)				HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
...
HXLINE( 647)				promise->error(((HX_("[Assets] Could not load Sound \"",64,be,27,e3) + id) + HX_("\"",22,00,00,00)));
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 620)
HXDLIN( 620)		HX_VARI_NAME( ::Array< ::Dynamic>,useCache1,"useCache") = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 621)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 621)			useCache1[0] = true;
            		}
HXLINE( 625)		HX_VARI(  ::lime::app::Promise_openfl_media_Sound,promise) =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadMusic,return )
 ...
 ::lime::app::Future Assets_obj::loadMovieClip(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 670)
HXLINE( 672)		HX_VARI(  ::lime::app::Promise_openfl_display_MovieClip,promise) =  ::lime::app::Promise_openfl_display_MovieClip_obj::__alloc( HX_CTX );
HXLINE( 674)		HX_VARI( ::String,libraryName) = id.substring(0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 675)		HX_VARI( ::String,symbolName) = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + 1),null());
HXLINE( 676)		HX_VARI(  ::lime::utils::AssetLibrary,limeLibrary) = ::openfl::utils::Assets_obj::getLibrary(libraryName);
HXLINE( 678)		if (::hx::IsNotNull( limeLibrary )) {
HXLINE( 680)			if (::Std_obj::isOfType(limeLibrary,::hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
HXLINE( 682)				HX_VARI(  ::openfl::utils::AssetLibrary,library) = ( ( ::openfl::utils::AssetLibrary)(limeLibrary) );
...
HXLINE( 726)				HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
...
HXLINE( 738)				promise->error(((HX_("[Assets] Could not load Sound \"",64,be,27,e3) + id) + HX_("\"",22,00,00,00)));
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 712)
HXDLIN( 712)		HX_VARI_NAME( ::Array< ::Dynamic>,useCache1,"useCache") = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 713)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 713)			useCache1[0] = true;
            		}
HXLINE( 716)		HX_VARI(  ::lime::app::Promise_openfl_media_Sound,promise) =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadSound,return )
 ...
 ::lime::app::Future Assets_obj::loadText(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 757)
HXLINE( 759)		HX_VARI(  ::lime::app::Future,future) = ::lime::utils::Assets_obj::loadText(id);
...
::hx::Class Assets_obj::resolveEnum(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 799)
HXLINE( 800)		HX_VARI( ::hx::Class,value) = ::Type_obj::resolveEnum(name);
