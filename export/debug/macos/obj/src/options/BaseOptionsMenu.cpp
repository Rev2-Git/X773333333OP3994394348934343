...
HXDLIN(  58)		HX_VARI(  ::flixel::FlxSprite,bg1) = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXLINE(  78)		HX_VARI(  ::Alphabet,titleText) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(75) ),( (Float)(40) ),this->title,true);
...
HXLINE(  85)		 ::flixel::text::FlxText _hx_tmp4 = this->descText;
...
HXLINE(  85)			_hx_tmp5 = file;
            		}
            		else {
HXLINE(  85)			_hx_tmp5 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  85)		_hx_tmp4->setFormat(_hx_tmp5,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  86)		{
...
HXLINE(  90)				_g = (_g + 1);
HXDLIN(  90)				HX_VARI( int,i) = (_g - 1);
HXLINE(  92)				HX_VARI(  ::Alphabet,optionText) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(290) ),( (Float)(260) ),this->optionsArray->__get(i).StaticCast<  ::options::Option >()->name,false);
...
HXDLIN( 100)					HX_VARI(  ::CheckboxThingie,checkbox1) =  ::CheckboxThingie_obj::__alloc( HX_CTX ,checkbox,optionText1,::hx::IsEq( this->optionsArray->__get(i).StaticCast<  ::options::Option >()->getValue(),true ));
...
HXDLIN( 108)					HX_VARI(  ::AttachedText,valueText1) =  ::AttachedText_obj::__alloc( HX_CTX ,valueText,(optionText->get_width() + 80),null(),null(),null());
...
HXLINE( 117)					_hx_tmp6 = ::hx::IsNull( this->boyfriend );
            				}
            				else {
...
HXLINE( 154)			HX_VARI( bool,usesCheckbox) = true;
...
HXLINE( 165)					 ::options::Option _hx_tmp2 = this->curOption;
HXDLIN( 165)					 ::Dynamic _hx_tmp3;
...
HXDLIN( 165)					_hx_tmp2->setValue(_hx_tmp3);
...
HXLINE( 170)					_hx_tmp4 = ::PlayerSettings_obj::player1->controls->_ui_right->check();
            				}
            				else {
HXLINE( 170)					_hx_tmp4 = true;
            				}
HXDLIN( 170)				if (_hx_tmp4) {
HXLINE( 171)					HX_VAR( bool,pressed);
...
HXLINE( 174)							HX_VARI(  ::Dynamic,add) = null();
...
HXLINE( 198)								HX_VARI( int,num) = this->curOption->curOption;
...
HXLINE( 214)							 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp6 = ::flixel::FlxG_obj::sound;
HXDLIN( 214)							_hx_tmp6->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            						}
            						else {
HXLINE( 215)							if ((this->curOption->get_type() != HX_("string",d1,28,30,11))) {
HXLINE( 216)								 ::options::BaseOptionsMenu _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 216)								Float _hx_tmp8 = _hx_tmp7->holdValue;
HXDLIN( 216)								Float _hx_tmp9 = (this->curOption->scrollSpeed * elapsed);
HXDLIN( 216)								int _hx_tmp10;
HXDLIN( 216)								if (::PlayerSettings_obj::player1->controls->_ui_left->check()) {
HXLINE( 216)									_hx_tmp10 = -1;
            								}
            								else {
HXLINE( 216)									_hx_tmp10 = 1;
            								}
HXDLIN( 216)								_hx_tmp7->holdValue = (_hx_tmp8 + (_hx_tmp9 * ( (Float)(_hx_tmp10) )));
...
HXLINE( 226)									 ::options::Option _hx_tmp11 = this->curOption;
HXDLIN( 226)									_hx_tmp11->setValue(::flixel::math::FlxMath_obj::roundDecimal(this->holdValue,this->curOption->decimals));
...
HXLINE( 234)						 ::options::BaseOptionsMenu _hx_tmp12 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 234)						_hx_tmp12->holdTime = (_hx_tmp12->holdTime + elapsed);
            					}
            				}
            				else {
HXLINE( 236)					bool _hx_tmp13;
HXDLIN( 236)					if (!(::PlayerSettings_obj::player1->controls->_ui_leftR->check())) {
HXLINE( 236)						_hx_tmp13 = ::PlayerSettings_obj::player1->controls->_ui_rightR->check();
            					}
            					else {
...
HXLINE( 243)						_g = (_g + 1);
HXDLIN( 243)						HX_VARI( int,i) = (_g - 1);
HXLINE( 245)						HX_VARI(  ::options::Option,leOption) = this->optionsArray->__get(i).StaticCast<  ::options::Option >();
...
HXLINE( 257)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp14 = ::flixel::FlxG_obj::sound;
HXDLIN( 257)				_hx_tmp14->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 258)				this->reloadCheckboxes();
            			}
            		}
HXLINE( 262)		bool _hx_tmp15;
HXDLIN( 262)		if (::hx::IsNotNull( this->boyfriend )) {
HXLINE( 262)			_hx_tmp15 = this->boyfriend->animation->_curAnim->finished;
            		}
            		else {
HXLINE( 262)			_hx_tmp15 = false;
            		}
HXDLIN( 262)		if (_hx_tmp15) {
HXLINE( 263)			this->boyfriend->dance();
            		}
HXLINE( 266)		if ((this->nextAccept > 0)) {
HXLINE( 267)			 ::options::BaseOptionsMenu _hx_tmp16 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 267)			_hx_tmp16->nextAccept = (_hx_tmp16->nextAccept - 1);
            		}
...
void BaseOptionsMenu_obj::updateTextFrom( ::options::Option option){
            	...
            	HX_STACK_ARG(option,"option")
HXLINE( 272)
HXLINE( 273)		HX_VARI( ::String,text) = option->displayFormat;
HXLINE( 274)		HX_VARI(  ::Dynamic,val) = option->getValue();
HXLINE( 275)		if ((option->get_type() == HX_("percent",c5,aa,da,78))) {
HXLINE( 275)			val = (val * 100);
            		}
HXLINE( 276)		HX_VARI(  ::Dynamic,def) = option->defaultValue;
...
HXLINE( 297)				int _hx_tmp2 = ::flixel::FlxG_obj::width;
HXDLIN( 297)				_this->set_x(((( (Float)(_hx_tmp2) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 297)			bool _hx_tmp3;
HXDLIN( 297)			if ((axes != 16)) {
HXLINE( 297)				_hx_tmp3 = (axes == 17);
            			}
            			else {
HXLINE( 297)				_hx_tmp3 = true;
            			}
HXDLIN( 297)			if (_hx_tmp3) {
HXLINE( 297)				int _hx_tmp4 = ::flixel::FlxG_obj::height;
HXDLIN( 297)				_this->set_y(((( (Float)(_hx_tmp4) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 298)		 ::flixel::text::FlxText fh = this->descText;
HXDLIN( 298)		fh->set_y((fh->y + 270));
HXLINE( 300)		HX_VARI( int,bullShit) = 0;
HXLINE( 302)		{
HXLINE( 302)			int _g = 0;
HXDLIN( 302)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 302)			while((_g < _g1->length)){
HXLINE( 302)				HX_VARI(  ::Alphabet,item) = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 302)				_g = (_g + 1);
...
HXDLIN( 311)			HX_VARI(  ::flixel::group::FlxTypedGroupIterator,text) =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,this->grpTexts->members,filter);
HXDLIN( 311)			while(text->hasNext()){
HXLINE( 311)				HX_VARI_NAME(  ::AttachedText,text1,"text") = text->next().StaticCast<  ::AttachedText >();
...
HXLINE( 319)		 ::flixel::FlxSprite _hx_tmp5 = this->descBox;
HXDLIN( 319)		int _hx_tmp6 = ::Std_obj::_hx_int((this->descText->get_width() + 20));
HXDLIN( 319)		_hx_tmp5->setGraphicSize(_hx_tmp6,::Std_obj::_hx_int((this->descText->get_height() + 25)));
...
HXLINE( 327)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp7 = ::flixel::FlxG_obj::sound;
HXDLIN( 327)		_hx_tmp7->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            	}
...
void BaseOptionsMenu_obj::reloadBoyfriend(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 331)
HXLINE( 332)		HX_VARI( bool,wasVisible) = false;
...
HXDLIN( 349)		HX_VARI(  ::flixel::group::FlxTypedGroupIterator,checkbox) =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,this->checkboxGroup->members,filter);
HXDLIN( 349)		while(checkbox->hasNext()){
HXDLIN( 349)			HX_VARI_NAME(  ::CheckboxThingie,checkbox1,"checkbox") = checkbox->next().StaticCast<  ::CheckboxThingie >();
