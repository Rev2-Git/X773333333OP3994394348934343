...
HXDLIN(  74)		HX_VARI(  ::flixel::FlxSprite,bg1) = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXLINE(  76)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(  76)				bg1->set_x(((( (Float)(_hx_tmp1) ) - bg1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  76)			bool _hx_tmp2;
HXDLIN(  76)			if ((axes != 16)) {
HXLINE(  76)				_hx_tmp2 = (axes == 17);
            			}
            			else {
HXLINE(  76)				_hx_tmp2 = true;
            			}
HXDLIN(  76)			if (_hx_tmp2) {
HXLINE(  76)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(  76)				bg1->set_y(((( (Float)(_hx_tmp3) ) - bg1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  86)				_g = (_g + 1);
HXDLIN(  86)				HX_VARI( int,i) = (_g - 1);
HXLINE(  87)				HX_VARI( bool,isCentered) = false;
HXLINE(  88)				HX_VARI( bool,isDefaultKey) = ::hx::IsEq( this->optionShit->__get(i)->__GetItem(0),::options::ControlsSubState_obj::defaultKey );
...
HXDLIN(  93)				HX_VARI(  ::Alphabet,optionText1) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(200) ),( (Float)(300) ),( (::String)(this->optionShit->__get(i)->__GetItem(0)) ),optionText);
...
HXLINE(  96)							_hx_tmp4 = (axes1 == 17);
            						}
            						else {
HXLINE(  96)							_hx_tmp4 = true;
            						}
HXDLIN(  96)						if (_hx_tmp4) {
HXLINE(  96)							int _hx_tmp5 = ::flixel::FlxG_obj::width;
HXDLIN(  96)							optionText1->set_x(((( (Float)(_hx_tmp5) ) - optionText1->get_width()) / ( (Float)(2) )));
            						}
HXDLIN(  96)						bool _hx_tmp6;
HXDLIN(  96)						if ((axes1 != 16)) {
HXLINE(  96)							_hx_tmp6 = (axes1 == 17);
            						}
            						else {
HXLINE(  96)							_hx_tmp6 = true;
            						}
HXDLIN(  96)						if (_hx_tmp6) {
HXLINE(  96)							int _hx_tmp7 = ::flixel::FlxG_obj::height;
HXDLIN(  96)							optionText1->set_y(((( (Float)(_hx_tmp7) ) - optionText1->get_height()) / ( (Float)(2) )));
            						}
            					}
...
HXDLIN( 132)				_hx_tmp1->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
            			}
HXLINE( 135)			bool _hx_tmp2;
HXDLIN( 135)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 135)				_hx_tmp2 = (this->nextAccept <= 0);
            			}
            			else {
...
HXLINE( 140)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN( 140)					_hx_tmp3->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
            				}
            				else {
...
HXDLIN( 149)						_hx_tmp4->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            					}
            				}
            			}
            		}
            		else {
HXLINE( 153)			HX_VARI( int,keyPressed) = ::flixel::FlxG_obj::keys->firstJustPressed();
HXLINE( 154)			if ((keyPressed > -1)) {
HXLINE( 155)				HX_VARI( ::Array< int >,keysArray) = ( (::Array< int >)(::ClientPrefs_obj::keyBinds->get(this->optionShit->__get(::options::ControlsSubState_obj::curSelected)->__GetItem(1))) );
HXLINE( 156)				int _hx_tmp5;
HXDLIN( 156)				if (::options::ControlsSubState_obj::curAlt) {
HXLINE( 156)					_hx_tmp5 = 1;
            				}
            				else {
HXLINE( 156)					_hx_tmp5 = 0;
            				}
HXDLIN( 156)				keysArray[_hx_tmp5] = keyPressed;
HXLINE( 158)				HX_VAR( int,opposite);
...
HXLINE( 165)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp6 = ::flixel::FlxG_obj::sound;
HXDLIN( 165)				_hx_tmp6->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 166)				this->rebindingKey = false;
            			}
HXLINE( 169)			 ::options::ControlsSubState _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 169)			_hx_tmp7->bindingTime = (_hx_tmp7->bindingTime + elapsed);
...
HXLINE( 176)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp8 = ::flixel::FlxG_obj::sound;
HXDLIN( 176)				_hx_tmp8->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
HXLINE( 177)				this->rebindingKey = false;
HXLINE( 178)				this->bindingTime = ( (Float)(0) );
            			}
            		}
HXLINE( 182)		if ((this->nextAccept > 0)) {
HXLINE( 183)			 ::options::ControlsSubState _hx_tmp9 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 183)			_hx_tmp9->nextAccept = (_hx_tmp9->nextAccept - 1);
            		}
...
HXLINE( 204)				::options::ControlsSubState_obj::curSelected = 0;
            		...
            		} while(this->unselectableCheck(::options::ControlsSubState_obj::curSelected,null()));
;
HXLINE( 207)		HX_VARI( int,bullShit) = 0;
HXLINE( 209)		{
HXLINE( 209)			int _g = 0;
HXDLIN( 209)			int _g1 = this->grpInputs->length;
HXDLIN( 209)			while((_g < _g1)){
HXLINE( 209)				_g = (_g + 1);
HXDLIN( 209)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 212)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 213)				this->grpInputsAlt->__get(i1).StaticCast<  ::AttachedText >()->set_alpha(((Float)0.6));
            			}
            		}
HXLINE( 216)		{
...
HXLINE( 216)				HX_VARI(  ::Alphabet,item) = _g5->__get(_g4).StaticCast<  ::Alphabet >();
...
HXLINE( 225)							int _g6 = 0;
HXDLIN( 225)							int _g7 = this->grpInputsAlt->length;
HXDLIN( 225)							while((_g6 < _g7)){
HXLINE( 225)								_g6 = (_g6 + 1);
HXDLIN( 225)								HX_VARI_NAME( int,i2,"i") = (_g6 - 1);
HXLINE( 226)								if (::hx::IsInstanceEq( this->grpInputsAlt->__get(i2).StaticCast<  ::AttachedText >()->sprTracker,item )) {
HXLINE( 227)									this->grpInputsAlt->__get(i2).StaticCast<  ::AttachedText >()->set_alpha(( (Float)(1) ));
...
HXDLIN( 232)							int _g9 = this->grpInputs->length;
HXDLIN( 232)							while((_g8 < _g9)){
HXLINE( 232)								_g8 = (_g8 + 1);
HXDLIN( 232)								HX_VARI_NAME( int,i3,"i") = (_g8 - 1);
HXLINE( 233)								if (::hx::IsInstanceEq( this->grpInputs->__get(i3).StaticCast<  ::AttachedText >()->sprTracker,item )) {
HXLINE( 234)									this->grpInputs->__get(i3).StaticCast<  ::AttachedText >()->set_alpha(( (Float)(1) ));
...
HXLINE( 242)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN( 242)		_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            	}
...
HXDLIN( 256)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 257)				if (::hx::IsInstanceEq( this->grpInputsAlt->__get(i1).StaticCast<  ::AttachedText >()->sprTracker,Dynamic( this->grpOptions->members->__get(::options::ControlsSubState_obj::curSelected)).StaticCast<  ::Alphabet >() )) {
HXLINE( 258)					this->grpInputsAlt->__get(i1).StaticCast<  ::AttachedText >()->set_alpha(((Float)0.6));
HXLINE( 259)					if (::options::ControlsSubState_obj::curAlt) {
HXLINE( 260)						this->grpInputsAlt->__get(i1).StaticCast<  ::AttachedText >()->set_alpha(( (Float)(1) ));
            					}
...
bool ControlsSubState_obj::unselectableCheck(int num, ::Dynamic __o_checkDefaultKey){
            	...
            	HX_STACK_ARG(checkDefaultKey,"checkDefaultKey")
HXLINE( 268)
...
void ControlsSubState_obj::addBindTexts( ::Alphabet optionText,int num){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(optionText,"optionText")
            	HX_STACK_ARG(num,"num")
HXLINE( 275)
HXLINE( 276)		HX_VARI( ::cpp::VirtualArray,keys) = ( (::cpp::VirtualArray)(::ClientPrefs_obj::keyBinds->get(this->optionShit->__get(num)->__GetItem(1))) );
HXLINE( 277)		HX_VARI(  ::AttachedText,text1) =  ::AttachedText_obj::__alloc( HX_CTX ,::InputFormatter_obj::getKeyName(( (int)(keys->__get(0)) )),400,-55,null(),null());
...
HXLINE( 283)		HX_VARI(  ::AttachedText,text2) =  ::AttachedText_obj::__alloc( HX_CTX ,::InputFormatter_obj::getKeyName(( (int)(keys->__get(1)) )),650,-55,null(),null());
...
HXLINE( 292)			HX_VARI(  ::AttachedText,item) = this->grpInputs->__get(0).StaticCast<  ::AttachedText >();
...
HXLINE( 298)			HX_VARI_NAME(  ::AttachedText,item1,"item") = this->grpInputsAlt->__get(0).StaticCast<  ::AttachedText >();
HXLINE( 299)			item1->kill();
HXLINE( 300)			this->grpInputsAlt->remove(item1);
HXLINE( 301)			item1->destroy();
            		}
...
HXLINE( 313)		HX_VARI( int,bullShit) = 0;
HXLINE( 314)		{
HXLINE( 314)			int _g2 = 0;
HXDLIN( 314)			int _g3 = this->grpInputs->length;
HXDLIN( 314)			while((_g2 < _g3)){
HXLINE( 314)				_g2 = (_g2 + 1);
HXDLIN( 314)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 315)				this->grpInputs->__get(i1).StaticCast<  ::AttachedText >()->set_alpha(((Float)0.6));
            			}
            		}
HXLINE( 317)		{
...
HXDLIN( 317)				HX_VARI_NAME( int,i2,"i") = (_g4 - 1);
HXLINE( 318)				this->grpInputsAlt->__get(i2).StaticCast<  ::AttachedText >()->set_alpha(((Float)0.6));
            			}
            		}
HXLINE( 321)		{
...
HXLINE( 321)				HX_VARI_NAME(  ::Alphabet,item2,"item") = _g7->__get(_g6).StaticCast<  ::Alphabet >();
HXDLIN( 321)				_g6 = (_g6 + 1);
HXLINE( 322)				item2->targetY = (bullShit - ::options::ControlsSubState_obj::curSelected);
HXLINE( 323)				bullShit = (bullShit + 1);
HXLINE( 325)				if (!(this->unselectableCheck((bullShit - 1),null()))) {
HXLINE( 326)					item2->set_alpha(((Float)0.6));
HXLINE( 327)					if ((item2->targetY == 0)) {
HXLINE( 328)						item2->set_alpha(( (Float)(1) ));
HXLINE( 329)						if (::options::ControlsSubState_obj::curAlt) {
HXLINE( 330)							int _g8 = 0;
HXDLIN( 330)							int _g9 = this->grpInputsAlt->length;
HXDLIN( 330)							while((_g8 < _g9)){
HXLINE( 330)								_g8 = (_g8 + 1);
HXDLIN( 330)								HX_VARI_NAME( int,i3,"i") = (_g8 - 1);
HXLINE( 331)								if (::hx::IsInstanceEq( this->grpInputsAlt->__get(i3).StaticCast<  ::AttachedText >()->sprTracker,item2 )) {
HXLINE( 332)									this->grpInputsAlt->__get(i3).StaticCast<  ::AttachedText >()->set_alpha(( (Float)(1) ));
            								}
            							}
            						}
            						else {
HXLINE( 336)							int _g10 = 0;
HXDLIN( 336)							int _g11 = this->grpInputs->length;
HXDLIN( 336)							while((_g10 < _g11)){
HXLINE( 336)								_g10 = (_g10 + 1);
HXDLIN( 336)								HX_VARI_NAME( int,i4,"i") = (_g10 - 1);
HXLINE( 337)								if (::hx::IsInstanceEq( this->grpInputs->__get(i4).StaticCast<  ::AttachedText >()->sprTracker,item2 )) {
HXLINE( 338)									this->grpInputs->__get(i4).StaticCast<  ::AttachedText >()->set_alpha(( (Float)(1) ));
            								}
            							}
            						}
            					}
