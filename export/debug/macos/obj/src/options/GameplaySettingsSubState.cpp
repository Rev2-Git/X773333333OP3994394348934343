...
HXLINE(  37)		HX_VARI(  ::options::Option,option) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Controller Mode",67,49,9f,a9),HX_("Check this if you want to play with\na controller instead of using your Keyboard.",a3,4f,07,9e),HX_("controllerMode",1f,16,a7,29),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  42)		this->addOption(option);
HXLINE(  45)		HX_VARI_NAME(  ::options::Option,option1,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Downscroll",0f,4a,85,46),HX_("If checked, notes go Down instead of Up, simple enough.",0d,a5,bc,fc),HX_("downScroll",0f,ba,68,84),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  50)		this->addOption(option1);
HXLINE(  52)		HX_VARI_NAME(  ::options::Option,option2,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Middlescroll",42,a5,d6,f5),HX_("If checked, your notes get centered.",9c,98,94,3e),HX_("middleScroll",42,cd,58,62),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  57)		this->addOption(option2);
HXLINE(  59)		HX_VARI_NAME(  ::options::Option,option3,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Opponent Notes",7e,b9,ec,7e),HX_("If unchecked, opponent notes get hidden.",57,fc,a8,02),HX_("opponentStrums",87,04,01,1c),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  64)		this->addOption(option3);
HXLINE(  66)		HX_VARI_NAME(  ::options::Option,option4,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Ghost Tapping",44,6c,9f,40),HX_("If checked, you won't get misses from pressing keys\nwhile there are no notes able to be hit.",c7,46,2f,fa),HX_("ghostTapping",c6,6a,da,10),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  71)		this->addOption(option4);
HXLINE(  73)		HX_VARI_NAME(  ::options::Option,option5,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Disable Reset Button",bb,b9,2b,75),HX_("If checked, pressing Reset won't do anything.",ee,76,e8,10),HX_("noReset",ce,cd,cb,b9),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  78)		this->addOption(option5);
HXLINE(  80)		HX_VARI_NAME(  ::options::Option,option6,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Hitsound Volume",de,af,92,68),HX_("Funny notes does \"Tick!\" when you hit them.\"",b2,5a,bb,e5),HX_("hitsoundVolume",96,34,9b,8f),HX_("percent",c5,aa,da,78),0,null());
...
HXLINE(  93)		HX_VARI_NAME(  ::options::Option,option7,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Rating Offset",36,6d,0e,f3),HX_("Changes how late/early you have to hit for a \"Sick!\"\nHigher values mean you have to hit later.",98,66,84,c8),HX_("ratingOffset",90,b3,eb,a5),HX_("int",ef,0c,50,00),0,null());
...
HXLINE( 104)		HX_VARI_NAME(  ::options::Option,option8,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Sick! Hit Window",da,75,69,f4),HX_("Changes the amount of time you have\nfor hitting a \"Sick!\" in milliseconds.",70,a1,b8,aa),HX_("sickWindow",4e,b7,93,ed),HX_("int",ef,0c,50,00),45,null());
...
HXLINE( 115)		HX_VARI_NAME(  ::options::Option,option9,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Good Hit Window",40,78,9c,02),HX_("Changes the amount of time you have\nfor hitting a \"Good\" in milliseconds.",6e,11,57,54),HX_("goodWindow",0d,a9,05,67),HX_("int",ef,0c,50,00),90,null());
...
HXLINE( 126)		HX_VARI_NAME(  ::options::Option,option10,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Bad Hit Window",f8,a4,d4,a7),HX_("Changes the amount of time you have\nfor hitting a \"Bad\" in milliseconds.",92,b2,88,fa),HX_("badWindow",95,db,0a,32),HX_("int",ef,0c,50,00),135,null());
...
HXLINE( 137)		HX_VARI_NAME(  ::options::Option,option11,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Safe Frames",19,0a,34,55),HX_("Changes how many frames you have for\nhitting a note earlier or late.",09,48,9a,6e),HX_("safeFrames",d3,18,18,62),HX_("float",9c,c5,96,02),10,null());
