...
HXLINE(  40)		HX_VARI(  ::options::Option,option) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Low Quality",f3,10,75,e8),HX_("If checked, disables some background details,\ndecreases loading times and improves performance.",14,52,02,0c),HX_("lowQuality",8b,52,27,3e),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  45)		this->addOption(option);
HXLINE(  47)		HX_VARI_NAME(  ::options::Option,option1,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Anti-Aliasing",9d,02,6c,80),HX_("If unchecked, disables anti-aliasing, increases performance\nat the cost of sharper visuals.",52,74,f6,10),HX_("globalAntialiasing",f7,9c,ed,4c),HX_("bool",2a,84,1b,41),true,null());
...
HXLINE(  56)		HX_VARI_NAME(  ::options::Option,option2,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Shaders",8e,a9,d7,2c),HX_("If unchecked, disables shaders.\nIt's used for some visual effects, and also CPU intensive for weaker PCs.",64,92,e2,47),HX_("shaders",ae,81,86,5f),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  61)		this->addOption(option2);
HXLINE(  64)		HX_VARI_NAME(  ::options::Option,option3,"option") =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Framerate",6d,c5,1e,f0),HX_("Pretty self explanatory, isn't it?",b4,ed,8b,6f),HX_("framerate",8d,e5,4b,4e),HX_("int",ef,0c,50,00),60,null());
...
HXDLIN(  82)			HX_VARI(  ::flixel::FlxBasic,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  82)			_g = (_g + 1);
HXLINE(  84)			HX_VARI_NAME(  ::Dynamic,sprite1,"sprite") = sprite;
HXLINE(  85)			HX_VARI_NAME(  ::flixel::FlxSprite,sprite2,"sprite") = ( ( ::flixel::FlxSprite)(sprite1) );
