...
HXDLIN(  48)		HX_VARI(  ::flixel::FlxSprite,bg1) = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXLINE(  50)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(  50)				bg1->set_x(((( (Float)(_hx_tmp1) ) - bg1->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE(  50)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(  50)				bg1->set_y(((( (Float)(_hx_tmp3) ) - bg1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  63)				_g = (_g + 1);
HXDLIN(  63)				HX_VARI( int,i) = (_g - 1);
HXLINE(  64)				HX_VARI( Float,yPos) = ( (Float)(((165 * i) + 35)) );
HXLINE(  65)				{
HXLINE(  65)					{
HXLINE(  66)						int optionText = (this->posX + 250);
HXDLIN(  66)						HX_VARI(  ::Alphabet,optionText1) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(optionText) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(0)),true);
HXLINE(  67)						this->grpNumbers->add(optionText1).StaticCast<  ::Alphabet >();
            					}
HXLINE(  65)					{
HXLINE(  66)						int optionText2 = ((this->posX + 225) + 250);
HXDLIN(  66)						HX_VARI(  ::Alphabet,optionText3) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(optionText2) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(1)),true);
HXLINE(  67)						this->grpNumbers->add(optionText3).StaticCast<  ::Alphabet >();
            					}
HXLINE(  65)					{
HXLINE(  66)						int optionText4 = ((this->posX + 450) + 250);
HXDLIN(  66)						HX_VARI(  ::Alphabet,optionText5) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(optionText4) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(2)),true);
HXLINE(  67)						this->grpNumbers->add(optionText5).StaticCast<  ::Alphabet >();
            					}
            				}
HXLINE(  70)				HX_VARI(  ::flixel::FlxSprite,note) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,this->posX,yPos,null());
HXLINE(  71)				::String library1 = null();
...
HXDLIN(  71)				 ::Dynamic _hx_tmp4;
HXDLIN(  71)				if (::hx::IsNotNull( imageLoaded )) {
HXLINE(  71)					_hx_tmp4 = imageLoaded;
            				}
            				else {
HXLINE(  71)					 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(HX_("NOTE_assets",70,3c,09,f7),library1);
HXDLIN(  71)					_hx_tmp4 = returnAsset1;
            				}
HXDLIN(  71)				::String _hx_tmp5;
HXDLIN(  71)				if (xmlExists) {
HXLINE(  71)					_hx_tmp5 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e))));
            				}
            				else {
HXLINE(  71)					_hx_tmp5 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1);
            				}
HXDLIN(  71)				note->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp4,_hx_tmp5));
HXLINE(  72)				HX_VARI( ::Array< ::String >,animations) = ::Array_obj< ::String >::fromData( _hx_array_data_0afa74a2_2,4);
...
HXLINE(  78)				HX_VARI(  ::ColorSwap,newShader) =  ::ColorSwap_obj::__alloc( HX_CTX );
...
HXLINE( 103)						 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN( 103)						_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            					}
            					else {
...
HXLINE( 106)							 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN( 106)							_hx_tmp2->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            						}
            					}
            				}
HXLINE( 108)				bool _hx_tmp3;
HXDLIN( 108)				if (!(::PlayerSettings_obj::player1->controls->_ui_leftR->check())) {
HXLINE( 108)					_hx_tmp3 = ::PlayerSettings_obj::player1->controls->_ui_rightR->check();
            				}
            				else {
...
HXLINE( 110)						_hx_tmp4 = ::PlayerSettings_obj::player1->controls->_ui_right->check();
            					}
            					else {
HXLINE( 110)						_hx_tmp4 = true;
            					}
HXDLIN( 110)					if (_hx_tmp4) {
HXLINE( 111)						 ::options::NotesSubState _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 111)						_hx_tmp5->holdTime = (_hx_tmp5->holdTime + elapsed);
            					}
            				}
            			}
            			else {
HXLINE( 114)				HX_VARI( Float,add) = ( (Float)(90) );
...
HXLINE( 123)				bool _hx_tmp6;
HXDLIN( 123)				if (!(::PlayerSettings_obj::player1->controls->_ui_leftR->check())) {
HXLINE( 123)					_hx_tmp6 = ::PlayerSettings_obj::player1->controls->_ui_rightR->check();
            				}
            				else {
HXLINE( 123)					_hx_tmp6 = true;
            				}
HXDLIN( 123)				if (_hx_tmp6) {
HXLINE( 124)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp7 = ::flixel::FlxG_obj::sound;
HXDLIN( 124)					_hx_tmp7->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
...
HXLINE( 131)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp8 = ::flixel::FlxG_obj::sound;
HXDLIN( 131)				_hx_tmp8->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            			}
HXLINE( 133)			if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
HXLINE( 134)				this->changeSelection(1);
HXLINE( 135)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp9 = ::flixel::FlxG_obj::sound;
HXDLIN( 135)				_hx_tmp9->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            			}
HXLINE( 137)			if (::PlayerSettings_obj::player1->controls->_ui_leftP->check()) {
HXLINE( 138)				this->changeType(-1);
HXLINE( 139)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp10 = ::flixel::FlxG_obj::sound;
HXDLIN( 139)				_hx_tmp10->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            			}
HXLINE( 141)			if (::PlayerSettings_obj::player1->controls->_ui_rightP->check()) {
HXLINE( 142)				this->changeType(1);
HXLINE( 143)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp11 = ::flixel::FlxG_obj::sound;
HXDLIN( 143)				_hx_tmp11->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            			}
...
HXLINE( 149)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp12 = ::flixel::FlxG_obj::sound;
HXDLIN( 149)				_hx_tmp12->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            			}
HXLINE( 151)			bool _hx_tmp13;
HXDLIN( 151)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 151)				_hx_tmp13 = (this->nextAccept <= 0);
            			}
            			else {
HXLINE( 151)				_hx_tmp13 = false;
            			}
HXDLIN( 151)			if (_hx_tmp13) {
HXLINE( 152)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp14 = ::flixel::FlxG_obj::sound;
HXDLIN( 152)				_hx_tmp14->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
...
HXLINE( 156)						HX_VARI(  ::Alphabet,item) = Dynamic( this->grpNumbers->members->__get(i)).StaticCast<  ::Alphabet >();
...
HXDLIN( 162)						HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 163)						HX_VARI_NAME(  ::flixel::FlxSprite,item1,"item") = Dynamic( this->grpNotes->members->__get(i1)).StaticCast<  ::flixel::FlxSprite >();
HXLINE( 164)						item1->set_alpha(( (Float)(0) ));
HXLINE( 165)						if ((::options::NotesSubState_obj::curSelected == i1)) {
HXLINE( 166)							item1->set_alpha(( (Float)(1) ));
            						}
            					}
            				}
...
HXLINE( 174)		bool _hx_tmp15;
HXDLIN( 174)		if (!(::PlayerSettings_obj::player1->controls->_back->check())) {
HXLINE( 174)			if (this->changingNote) {
HXLINE( 174)				_hx_tmp15 = ::PlayerSettings_obj::player1->controls->_accept->check();
            			}
            			else {
HXLINE( 174)				_hx_tmp15 = false;
            			}
            		}
            		else {
HXLINE( 174)			_hx_tmp15 = true;
            		}
HXDLIN( 174)		if (_hx_tmp15) {
...
HXLINE( 181)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp16 = ::flixel::FlxG_obj::sound;
HXDLIN( 181)			_hx_tmp16->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
            		}
HXLINE( 184)		if ((this->nextAccept > 0)) {
HXLINE( 185)			 ::options::NotesSubState _hx_tmp17 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 185)			_hx_tmp17->nextAccept = (_hx_tmp17->nextAccept - 1);
            		}
...
HXLINE( 201)				HX_VARI(  ::Alphabet,item) = Dynamic( this->grpNumbers->members->__get(i)).StaticCast<  ::Alphabet >();
...
HXDLIN( 207)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 208)				HX_VARI_NAME(  ::flixel::FlxSprite,item1,"item") = Dynamic( this->grpNotes->members->__get(i1)).StaticCast<  ::flixel::FlxSprite >();
HXLINE( 209)				item1->set_alpha(((Float)0.6));
HXLINE( 210)				{
HXLINE( 210)					 ::flixel::math::FlxBasePoint this1 = item1->scale;
HXDLIN( 210)					this1->set_x(((Float)0.75));
HXDLIN( 210)					this1->set_y(((Float)0.75));
            				}
HXLINE( 211)				if ((::options::NotesSubState_obj::curSelected == i1)) {
HXLINE( 212)					item1->set_alpha(( (Float)(1) ));
HXLINE( 213)					{
HXLINE( 213)						 ::flixel::math::FlxBasePoint this2 = item1->scale;
HXDLIN( 213)						this2->set_x(( (Float)(1) ));
HXDLIN( 213)						this2->set_y(( (Float)(1) ));
            					}
HXLINE( 214)					this->hsbText->set_y((item1->y - ( (Float)(70) )));
HXLINE( 215)					this->blackBG->set_y((item1->y - ( (Float)(20) )));
            				}
            			}
            		}
...
HXLINE( 231)				_g = (_g + 1);
HXDLIN( 231)				HX_VARI( int,i) = (_g - 1);
HXLINE( 232)				HX_VARI(  ::Alphabet,item) = Dynamic( this->grpNumbers->members->__get(i)).StaticCast<  ::Alphabet >();
...
HXLINE( 249)		HX_VARI(  ::Alphabet,item) = Dynamic( this->grpNumbers->members->__get(((selected * 3) + type))).StaticCast<  ::Alphabet >();
HXLINE( 250)		item->set_text(HX_("0",30,00,00,00));
HXLINE( 252)		HX_VARI( Float,add) = (( (Float)((40 * (item->letters->length - 1))) ) / ( (Float)(2) ));
HXLINE( 253)		{
HXLINE( 253)			int _g = 0;
HXDLIN( 253)			::Array< ::Dynamic> _g1 = item->letters;
HXDLIN( 253)			while((_g < _g1->length)){
HXLINE( 253)				HX_VARI(  ::AlphaCharacter,letter) = _g1->__get(_g).StaticCast<  ::AlphaCharacter >();
HXDLIN( 253)				_g = (_g + 1);
...
HXLINE( 260)		HX_VARI( int,roundedValue) = ::Math_obj::round(this->curValue);
HXLINE( 261)		HX_VARI( Float,max) = ( (Float)(180) );
...
HXLINE( 280)		HX_VARI(  ::Alphabet,item) = Dynamic( this->grpNumbers->members->__get(((::options::NotesSubState_obj::curSelected * 3) + ::options::NotesSubState_obj::typeSelected))).StaticCast<  ::Alphabet >();
HXLINE( 281)		item->set_text(::Std_obj::string(roundedValue));
HXLINE( 283)		HX_VARI( Float,add) = (( (Float)((40 * (item->letters->length - 1))) ) / ( (Float)(2) ));
HXLINE( 284)		{
HXLINE( 284)			int _g = 0;
HXDLIN( 284)			::Array< ::Dynamic> _g1 = item->letters;
HXDLIN( 284)			while((_g < _g1->length)){
HXLINE( 284)				HX_VARI(  ::AlphaCharacter,letter) = _g1->__get(_g).StaticCast<  ::AlphaCharacter >();
HXDLIN( 284)				_g = (_g + 1);
