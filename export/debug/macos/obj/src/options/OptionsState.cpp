...
HXDLIN(  63)		HX_VARI_NAME(  ::flixel::FlxSprite,bg1,"bg") = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXLINE(  76)				HX_VARI(  ::Alphabet,optionText) =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),this->options->__get(i),true);
HXLINE(  77)				{
...
HXLINE( 131)		HX_VARI( int,bullShit) = 0;
HXLINE( 133)		{
HXLINE( 133)			int _g = 0;
HXDLIN( 133)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 133)			while((_g < _g1->length)){
HXLINE( 133)				HX_VARI(  ::Alphabet,item) = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 133)				_g = (_g + 1);
