...
HXLINE(  37)		HX_VARI(  ::options::Option,option) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Note Splashes",83,c7,78,74),HX_("If unchecked, hitting \"Sick!\" notes won't show particles.",eb,88,e6,c4),HX_("noteSplashes",a7,57,29,8d),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  42)		this->addOption(option);
HXLINE(  44)		HX_VARI(  ::options::Option,option1) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Hide HUD",59,3a,04,5d),HX_("If checked, hides most HUD elements.",b8,a1,19,66),HX_("hideHud",15,b9,3c,b7),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  49)		this->addOption(option1);
HXLINE(  51)		HX_VARI(  ::options::Option,option2) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Time Bar:",fa,e7,52,5c),HX_("What should the Time Bar display?",bd,00,f8,02),HX_("timeBarType",a0,5d,bb,01),HX_("string",d1,28,30,11),HX_("Time Left",fa,08,f2,62),::Array_obj< ::String >::fromData( _hx_array_data_f33bd928_1,4));
HXLINE(  57)		this->addOption(option2);
HXLINE(  59)		HX_VARI(  ::options::Option,option3) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Flashing Lights",0b,e4,0d,04),HX_("Uncheck this if you're sensitive to flashing lights!",9e,ed,11,12),HX_("flashing",32,85,e8,99),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  64)		this->addOption(option3);
HXLINE(  66)		HX_VARI(  ::options::Option,option4) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Camera Zooms",45,a6,9b,43),HX_("If unchecked, the camera won't zoom in on a beat hit.",fd,78,13,6b),HX_("camZooms",71,f3,cd,90),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  71)		this->addOption(option4);
HXLINE(  73)		HX_VARI(  ::options::Option,option5) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Score Text Zoom on Hit",da,24,e2,56),HX_("If unchecked, disables the Score text zooming\neverytime you hit a note.",bc,95,97,3e),HX_("scoreZoom",85,53,bc,e0),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  78)		this->addOption(option5);
HXLINE(  80)		HX_VARI(  ::options::Option,option6) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Game HUD:",91,06,6b,e0),HX_("Switch betweens different HUDs from other versions of FNF.",46,7d,a9,82),HX_("baseGameUI",b7,dd,29,29),HX_("string",d1,28,30,11),HX_("Friday Night Funkin",7a,b7,3d,fb),::Array_obj< ::String >::fromData( _hx_array_data_f33bd928_2,2));
HXLINE(  86)		this->addOption(option6);
HXLINE(  88)		HX_VARI(  ::options::Option,option7) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Rating Appearance:",53,3d,09,fb),HX_("Choose where you want your ratings to appear.",be,a8,9e,23),HX_("ratingCams",41,4c,e6,fd),HX_("string",d1,28,30,11),HX_("World",32,06,92,61),::Array_obj< ::String >::fromData( _hx_array_data_f33bd928_3,2));
HXLINE(  94)		this->addOption(option7);
HXLINE(  96)		HX_VARI(  ::options::Option,option8) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Health Bar Transparency",a9,7c,d2,65),HX_("How much transparent should the health bar and icons be.",16,a5,40,f3),HX_("healthBarAlpha",47,c9,a0,80),HX_("percent",c5,aa,da,78),1,null());
...
HXLINE( 109)		HX_VARI(  ::options::Option,option9) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("FPS Counter",85,ef,54,c9),HX_("If unchecked, hides FPS Counter.",17,fc,a1,74),HX_("showFPS",ec,0a,9a,7b),HX_("bool",2a,84,1b,41),true,null());
HXLINE( 114)		this->addOption(option9);
HXLINE( 115)		option9->onChange = this->onChangeFPSCounter_dyn();
HXLINE( 118)		HX_VARI(  ::options::Option,option10) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Pause Screen Song:",9b,6e,16,2a),HX_("What song do you prefer for the Pause Screen?",9a,c8,b3,59),HX_("pauseMusic",cf,6d,d3,e5),HX_("string",d1,28,30,11),HX_("Tea Time",9d,d4,cb,99),::Array_obj< ::String >::fromData( _hx_array_data_f33bd928_4,3));
HXLINE( 124)		this->addOption(option10);
HXLINE( 125)		option10->onChange = this->onChangePauseMusic_dyn();
HXLINE( 136)		HX_VARI(  ::options::Option,option11) =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Combo Stacking",ec,30,59,b7),HX_("If unchecked, Ratings and Combo won't stack, saving on System Memory and making them easier to read",d6,be,78,3a),HX_("comboStacking",08,45,bb,e0),HX_("bool",2a,84,1b,41),true,null());
