...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SlopChan", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SlopChan", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "SlopChan";
		app.meta["name"] = "PROJECT SLOPPYCHAN";
