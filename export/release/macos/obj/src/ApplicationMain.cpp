...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("SlopChan",0c,aa,7f,21),::ApplicationMain_obj::create_dyn());
...
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("SlopChan",0c,aa,7f,21));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("PROJECT SLOPPYCHAN",dc,7c,6f,a7));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("PROJECT SLOPPYCHAN",dc,7c,6f,a7))
