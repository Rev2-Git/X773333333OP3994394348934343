...
HXDLIN(  87)			 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(HX_("achievements/lockedachievement",ba,b8,0b,f8),library1);
HXDLIN(  87)			this->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
            		}
HXLINE(  89)		{
