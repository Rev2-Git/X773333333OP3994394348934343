...
HXLINE(  30)			 ::flixel::animation::FlxAnimationController _hx_tmp2 = this->animation;
HXDLIN(  30)			_hx_tmp2->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("BG fangirls dissuaded",b1,42,22,06),::CoolUtil_obj::numberArray(14,null()),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  31)			 ::flixel::animation::FlxAnimationController _hx_tmp3 = this->animation;
HXDLIN(  31)			_hx_tmp3->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("BG fangirls dissuaded",b1,42,22,06),::CoolUtil_obj::numberArray(30,15),HX_("",00,00,00,00),24,false,null(),null());
            		}
