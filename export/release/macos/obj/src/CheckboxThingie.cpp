...
HXLINE(  47)				_hx_tmp1 = (this->animation->_curAnim->name != HX_("unchecking",73,08,bf,32));
            			}
            			else {
...
HXLINE(  49)				{
HXLINE(  49)					 ::flixel::math::FlxBasePoint this2 = this->offset;
HXDLIN(  49)					this2->set_x(( (Float)(25) ));
HXDLIN(  49)					this2->set_y(( (Float)(28) ));
            				}
            			}
            		}
...
HXLINE(  64)			{
HXLINE(  64)				 ::flixel::math::FlxBasePoint this2 = this->offset;
HXDLIN(  64)				this2->set_x(( (Float)(0) ));
HXDLIN(  64)				this2->set_y(( (Float)(2) ));
            			}
