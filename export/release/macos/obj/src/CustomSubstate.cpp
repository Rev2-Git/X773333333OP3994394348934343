...
HX_DEFINE_STACK_FRAME(_hx_pos_8557063211c1ebb8_3365_new,"CustomSubstate","new",0xac1d5774,"CustomSubstate.new","FunkinLua.hx",3365,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_8557063211c1ebb8_3356_create,"CustomSubstate","create",0xdcec8468,"CustomSubstate.create","FunkinLua.hx",3356,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_8557063211c1ebb8_3372_update,"CustomSubstate","update",0xe7e2a375,"CustomSubstate.update","FunkinLua.hx",3372,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_8557063211c1ebb8_3379_destroy,"CustomSubstate","destroy",0x8522ce0e,"CustomSubstate.destroy","FunkinLua.hx",3379,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_8557063211c1ebb8_3352_boot,"CustomSubstate","boot",0xe5a82e9e,"CustomSubstate.boot","FunkinLua.hx",3352,0x00117937)

void CustomSubstate_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3365_new)
HXLINE(3366)		::CustomSubstate_obj::name = name;
HXLINE(3367)		super::__construct();
HXLINE(3368)		this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
            	}
...
void CustomSubstate_obj::create(){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3356_create)
HXLINE(3357)		::CustomSubstate_obj::instance = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(3359)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateCreate",bd,00,5a,98),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null(),null());
HXLINE(3360)		this->super::create();
HXLINE(3361)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateCreatePost",bd,53,4b,d5),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null(),null());
            	}


void CustomSubstate_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3372_update)
HXLINE(3373)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateUpdate",ca,1f,50,a3),::cpp::VirtualArray_obj::__new(2)->init(0,::CustomSubstate_obj::name)->init(1,elapsed),null(),null(),null());
HXLINE(3374)		this->super::update(elapsed);
HXLINE(3375)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateUpdatePost",4a,7d,72,7b),::cpp::VirtualArray_obj::__new(2)->init(0,::CustomSubstate_obj::name)->init(1,elapsed),null(),null(),null());
            	}


void CustomSubstate_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3379_destroy)
HXLINE(3380)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateDestroy",19,1c,82,c9),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null(),null());
HXLINE(3381)		this->super::destroy();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3352_boot)
HXDLIN(3352)		name = HX_("unnamed",c0,86,15,93);
            	}
}
