...
HX_LOCAL_STACK_FRAME(_hx_pos_8e4589df03e4f3cc_58_getDay,"Date","getDay",0x598d4986,"Date.getDay","/usr/local/lib/haxe/std/cpp/_std/Date.hx",58,0xd1a513ee)
...
int Date_obj::getDay(){
            	HX_STACKFRAME(&_hx_pos_8e4589df03e4f3cc_58_getDay)
