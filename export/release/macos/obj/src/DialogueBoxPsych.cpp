...
HXLINE( 344)					 ::DialogueCharacter char1 = this->arrayCharacters->__get(this->lastCharacter).StaticCast<  ::DialogueCharacter >();
...
HXLINE( 352)						::Array< ::String > checkArray1 = ::Array_obj< ::String >::fromData( _hx_array_data_c9b73088_18,2);
HXLINE( 353)						::String animName1 = this->box->animation->_curAnim->name;
HXLINE( 354)						{
HXLINE( 354)							int _g6 = 0;
HXDLIN( 354)							int _g7 = checkArray1->length;
HXDLIN( 354)							while((_g6 < _g7)){
HXLINE( 354)								_g6 = (_g6 + 1);
HXDLIN( 354)								int j1 = (_g6 - 1);
...
HXDLIN( 364)					int i2 = (_g8 - 1);
HXLINE( 365)					 ::DialogueCharacter char2 = this->arrayCharacters->__get(i2).StaticCast<  ::DialogueCharacter >();
...
HXDLIN( 417)					int i3 = (_g10 - 1);
HXLINE( 418)					 ::DialogueCharacter leChar = this->arrayCharacters->__get(i3).StaticCast<  ::DialogueCharacter >();
...
HXDLIN( 433)						int i4 = (_g12 - 1);
HXLINE( 434)						 ::DialogueCharacter leChar1 = this->arrayCharacters->__get(0).StaticCast<  ::DialogueCharacter >();
