...
HXLINE( 593)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp1 = this->button;
HXDLIN( 593)		Float _hx_tmp2 = this->background->get_height();
HXDLIN( 593)		_hx_tmp1->resize(_hx_tmp2,this->background->get_height());
HXLINE( 594)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp3 = this->button;
HXDLIN( 594)		Float _hx_tmp4 = this->background->x;
HXDLIN( 594)		Float _hx_tmp5 = (_hx_tmp4 + this->background->get_width());
HXDLIN( 594)		_hx_tmp3->set_x((_hx_tmp5 - this->button->get_width()));
