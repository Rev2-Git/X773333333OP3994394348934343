...
HX_DEFINE_STACK_FRAME(_hx_pos_2b7f7cc83b4d0792_3304_new,"ModchartSprite","new",0xbc67fd93,"ModchartSprite.new","FunkinLua.hx",3304,0x00117937)
...
void ModchartSprite_obj::__construct( ::Dynamic __o_x, ::Dynamic __o_y){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_2b7f7cc83b4d0792_3304_new)
HXLINE(3307)		this->animOffsets =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(3306)		this->wasAdded = false;
HXLINE(3312)		super::__construct(x,y,null());
HXLINE(3313)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            	}
