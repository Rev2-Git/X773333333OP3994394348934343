...
HXLINE( 363)				 ::flixel::graphics::FlxGraphic newGraphic1 = ::flixel::FlxG_obj::bitmap->add(path,false,path);
...
HXDLIN( 461)				::String fileToCheck1 = (HX_("mods/",9e,2f,58,0c) + key2);
...
HXDLIN( 487)						::String path1 = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 488)						if (::sys::FileSystem_obj::exists(path1)) {
HXLINE( 489)							try {
            								HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 490)								::String rawJson = ::sys::io::File_obj::getContent(path1);
