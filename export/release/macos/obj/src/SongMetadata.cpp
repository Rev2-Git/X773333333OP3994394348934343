...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_566_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",566,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_566_new)
HXLINE( 572)		this->folder = HX_("",00,00,00,00);
HXLINE( 571)		this->color = -7179779;
HXLINE( 570)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 569)		this->week = 0;
HXLINE( 568)		this->songName = HX_("",00,00,00,00);
HXLINE( 576)		this->songName = song;
HXLINE( 577)		this->week = week;
HXLINE( 578)		this->songCharacter = songCharacter;
HXLINE( 579)		this->color = color;
HXLINE( 580)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 581)		if (::hx::IsNull( this->folder )) {
HXLINE( 581)			this->folder = HX_("",00,00,00,00);
            		}
            	}
