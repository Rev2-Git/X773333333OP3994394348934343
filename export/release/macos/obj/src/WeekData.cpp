...
HXLINE( 121)				::String folder = modsDirectories->__get(_g2);
...
HXDLIN( 136)				int i1 = (_g3 - 1);
HXLINE( 137)				{
HXLINE( 137)					int _g5 = 0;
HXDLIN( 137)					int _g6 = directories->length;
HXDLIN( 137)					while((_g5 < _g6)){
HXLINE( 137)						_g5 = (_g5 + 1);
HXDLIN( 137)						int j = (_g5 - 1);
HXLINE( 138)						::String fileToCheck = (((directories->__get(j) + HX_("weeks/",50,a9,04,ff)) + sexList->__get(i1)) + HX_(".json",56,f1,d6,c2));
...
HXLINE( 142)								 ::WeekData weekFile =  ::WeekData_obj::__alloc( HX_CTX ,week,sexList->__get(i1));
...
HXDLIN( 160)				int i2 = (_g7 - 1);
HXLINE( 161)				::String directory = (directories->__get(i2) + HX_("weeks/",50,a9,04,ff));
...
HXLINE( 164)							::String daWeek = listOfWeeks->__get(_g9);
HXDLIN( 164)							_g9 = (_g9 + 1);
HXLINE( 166)							::String path1 = ((directory + daWeek) + HX_(".json",56,f1,d6,c2));
...
HXLINE( 173)							::String file1 = _g11->__get(_g10);
HXDLIN( 173)							_g10 = (_g10 + 1);
HXLINE( 175)							::String path2 = ::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,directory)->init(1,file1));
