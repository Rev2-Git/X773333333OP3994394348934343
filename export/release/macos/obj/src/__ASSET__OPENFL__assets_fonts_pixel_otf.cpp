...
HX_DEFINE_STACK_FRAME(_hx_pos_f9bd248e8c37eaa1_1296_new,"__ASSET__OPENFL__assets_fonts_pixel_otf","new",0xd7ddf5a3,"__ASSET__OPENFL__assets_fonts_pixel_otf.new","ManifestResources.hx",1296,0xf77aa668)

void __ASSET__OPENFL__assets_fonts_pixel_otf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f9bd248e8c37eaa1_1296_new)
HXDLIN(1296)		this->_hx___fontPath = (::ManifestResources_obj::rootPath + HX_("assets/fonts/pixel.otf",a2,d3,8e,91));
HXDLIN(1296)		this->name = HX_("Pixel Arial 11 Bold",ae,17,c6,45);
HXDLIN(1296)		super::__construct(null());
            	}
