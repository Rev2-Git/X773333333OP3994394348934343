...
HXLINE(  74)				::Array< ::Dynamic> x1 = frameArray->__get(_g1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(  74)				_g1 = (_g1 + 1);
HXLINE(  76)				{
HXLINE(  76)					int _g2 = 0;
HXDLIN(  76)					while((_g2 < x1->length)){
HXLINE(  76)						 ::flixel::graphics::frames::FlxFrame y = x1->__get(_g2).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN(  76)						_g2 = (_g2 + 1);
...
HXLINE(  91)		 ::flixel::math::FlxBasePoint frameSize =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0);
HXLINE(  93)		{
...
HXDLIN( 112)				int i1 = (_g2 - 1);
HXLINE( 114)				 ::flixel::graphics::FlxGraphic b = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitMapArray->__get(i1).StaticCast<  ::openfl::display::BitmapData >(),null(),null(),null());
