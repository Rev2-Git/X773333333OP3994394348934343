...
HXDLIN( 206)				int i1 = (_g3 - 1);
HXLINE( 207)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 208)					 ::animateatlas::displayobject::SpriteSymbol oldSymbol1 = ::hx::TCast<  ::animateatlas::displayobject::SpriteSymbol >::cast(layer->removeChildAt(numElements));
