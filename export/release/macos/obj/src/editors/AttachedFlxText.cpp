...
HX_DEFINE_STACK_FRAME(_hx_pos_d4db2ac25d8e506a_3095_new,"editors.AttachedFlxText","new",0x7b9cbf45,"editors.AttachedFlxText.new","editors/ChartingState.hx",3095,0x5a24859a)
HX_LOCAL_STACK_FRAME(_hx_pos_d4db2ac25d8e506a_3106_update,"editors.AttachedFlxText","update",0x30e33444,"editors.AttachedFlxText.update","editors/ChartingState.hx",3106,0x5a24859a)
namespace editors{
...
void AttachedFlxText_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< Float >  __o_FieldWidth,::String Text,::hx::Null< int >  __o_Size,::hx::Null< bool >  __o_EmbeddedFont){
            	...
            	HX_STACKFRAME(&_hx_pos_d4db2ac25d8e506a_3095_new)
HXLINE(3099)		this->yAdd = ((Float)0);
HXLINE(3098)		this->xAdd = ((Float)0);
HXLINE(3102)		super::__construct(X,Y,FieldWidth,Text,Size,EmbeddedFont);
            	}
...
void AttachedFlxText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_d4db2ac25d8e506a_3106_update)
HXLINE(3107)		this->super::update(elapsed);
HXLINE(3109)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(3110)			this->setPosition((this->sprTracker->x + this->xAdd),(this->sprTracker->y + this->yAdd));
HXLINE(3111)			this->set_angle(this->sprTracker->angle);
HXLINE(3112)			this->set_alpha(this->sprTracker->alpha);
            		}
            	}
