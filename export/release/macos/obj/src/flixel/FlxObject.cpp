...
HXLINE(1056)		{
HXLINE(1056)			 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(1056)			if (_this->_weak) {
HXLINE(1056)				_this->put();
            			}
            		}
...
HXDLIN(1158)		{
HXLINE(1158)			 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(1158)			if (_this->_weak) {
HXLINE(1158)				_this->put();
            			}
            		}
