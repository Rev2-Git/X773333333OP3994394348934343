...
HXDLIN( 809)			{
HXLINE( 809)				 ::flixel::math::FlxBasePoint _this = point;
HXDLIN( 809)				if (_this->_weak) {
HXLINE( 809)					_this->put();
            				}
            			}
            		}
...
HXDLIN( 832)			{
HXLINE( 832)				 ::flixel::math::FlxBasePoint _this1 = point;
HXDLIN( 832)				if (_this1->_weak) {
HXLINE( 832)					_this1->put();
            				}
            			}
            		}
HXLINE( 833)		{
...
HXLINE(1080)		{
HXLINE(1080)			 ::flixel::math::FlxBasePoint _this = worldPoint;
HXDLIN(1080)			if (_this->_weak) {
HXLINE(1080)				_this->put();
            			}
            		}
...
HXDLIN(1098)			{
HXLINE(1098)				 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(1098)				if (_this->_weak) {
HXLINE(1098)					_this->put();
            				}
            			}
            		}
HXLINE(1099)		{
...
HXDLIN(1099)			{
HXLINE(1099)				 ::flixel::math::FlxBasePoint _this1 = point1;
HXDLIN(1099)				if (_this1->_weak) {
HXLINE(1099)					_this1->put();
            				}
            			}
            		}
HXLINE(1100)		{
...
HXDLIN(1102)			{
HXLINE(1102)				 ::flixel::math::FlxBasePoint _this2 = point2;
...
HXLINE(1104)		{
HXLINE(1104)			 ::flixel::math::FlxBasePoint _this3 = worldPoint;
HXDLIN(1104)			if (_this3->_weak) {
HXLINE(1104)				_this3->put();
            			}
            		}
...
HXDLIN(1124)			{
HXLINE(1124)				 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(1124)				if (_this->_weak) {
HXLINE(1124)					_this->put();
            				}
            			}
            		}
HXLINE(1125)		{
...
HXDLIN(1125)			{
HXLINE(1125)				 ::flixel::math::FlxBasePoint _this1 = point1;
HXDLIN(1125)				if (_this1->_weak) {
HXLINE(1125)					_this1->put();
            				}
            			}
            		}
HXLINE(1126)		{
...
HXDLIN(1128)			{
HXLINE(1128)				 ::flixel::math::FlxBasePoint _this2 = point2;
HXDLIN(1128)				if (_this2->_weak) {
HXLINE(1128)					_this2->put();
            				}
            			}
            		}
HXLINE(1130)		{
HXLINE(1130)			 ::flixel::math::FlxBasePoint _this3 = screenPoint;
HXDLIN(1130)			if (_this3->_weak) {
HXLINE(1130)				_this3->put();
            			}
            		}
