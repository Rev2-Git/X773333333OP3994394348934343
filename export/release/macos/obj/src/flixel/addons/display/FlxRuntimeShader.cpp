...
HXLINE( 221)			::String s1 = this->processVertexSource(vertexSource);
...
HXLINE( 334)						 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 342)						 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 473)						 ::openfl::display::ShaderParameter_Int parameter1 =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
...
HXLINE( 472)						goto _hx_goto_16;
            					...
            					/* default */{
HXLINE( 485)						 ::openfl::display::ShaderParameter_Float parameter2 =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
