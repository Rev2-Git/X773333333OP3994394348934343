...
HXDLIN(  85)			this1->set_x((this1->x + point1->x));
HXDLIN(  85)			this1->set_y((this1->y + y));
            		}
HXDLIN(  85)		{
HXDLIN(  85)			 ::flixel::math::FlxBasePoint _this = point1;
HXDLIN(  85)			if (_this->_weak) {
HXDLIN(  85)				_this->put();
            			}
            		}
...
HXLINE( 121)							 ::flixel::math::FlxBasePoint this2 = this->_effectOffset;
...
HXDLIN( 121)								this2->set_x((this2->x + point->x));
HXDLIN( 121)								this2->set_y((this2->y + y));
            							}
HXDLIN( 121)							{
HXLINE( 121)								 ::flixel::math::FlxBasePoint _this = point;
