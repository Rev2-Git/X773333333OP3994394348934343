...
HXLINE( 404)			 ::flixel::addons::text::FlxTypeText _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 404)			_hx_tmp3->_waitTimer = (_hx_tmp3->_waitTimer - elapsed);
...
HXLINE( 414)			_hx_tmp4 = !(this->paused);
            		}
            		else {
HXLINE( 414)			_hx_tmp4 = false;
            		}
HXDLIN( 414)		if (_hx_tmp4) {
HXLINE( 416)			bool _hx_tmp5;
HXDLIN( 416)			if ((this->_length < this->_finalText.length)) {
HXLINE( 416)				_hx_tmp5 = this->_typing;
            			}
            			else {
HXLINE( 416)				_hx_tmp5 = false;
            			}
HXDLIN( 416)			if (_hx_tmp5) {
HXLINE( 418)				 ::flixel::addons::text::FlxTypeText _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 418)				_hx_tmp6->_timer = (_hx_tmp6->_timer + elapsed);
            			}
HXLINE( 421)			bool _hx_tmp7;
HXDLIN( 421)			if ((this->_length > 0)) {
HXLINE( 421)				_hx_tmp7 = this->_erasing;
            			}
            			else {
HXLINE( 421)				_hx_tmp7 = false;
            			}
HXDLIN( 421)			if (_hx_tmp7) {
HXLINE( 423)				 ::flixel::addons::text::FlxTypeText _hx_tmp8 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 423)				_hx_tmp8->_timer = (_hx_tmp8->_timer + elapsed);
            			}
            		}
HXLINE( 429)		bool _hx_tmp9;
HXDLIN( 429)		if (!(this->_typing)) {
HXLINE( 429)			_hx_tmp9 = this->_erasing;
            		}
            		else {
HXLINE( 429)			_hx_tmp9 = true;
            		}
HXDLIN( 429)		if (_hx_tmp9) {
HXLINE( 431)			bool _hx_tmp10;
HXDLIN( 431)			if (this->_typing) {
HXLINE( 431)				_hx_tmp10 = (this->_timer >= this->delay);
            			}
            			else {
HXLINE( 431)				_hx_tmp10 = false;
            			}
HXDLIN( 431)			if (_hx_tmp10) {
HXLINE( 433)				 ::flixel::addons::text::FlxTypeText _hx_tmp11 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 433)				int _hx_tmp12 = _hx_tmp11->_length;
HXDLIN( 433)				_hx_tmp11->_length = (_hx_tmp12 + ::Std_obj::_hx_int((this->_timer / this->delay)));
HXLINE( 434)				if ((this->_length > this->_finalText.length)) {
HXLINE( 435)					this->_length = this->_finalText.length;
            				}
            			}
HXLINE( 438)			bool _hx_tmp13;
HXDLIN( 438)			if (this->_erasing) {
HXLINE( 438)				_hx_tmp13 = (this->_timer >= this->eraseDelay);
            			}
            			else {
HXLINE( 438)				_hx_tmp13 = false;
            			}
HXDLIN( 438)			if (_hx_tmp13) {
HXLINE( 440)				 ::flixel::addons::text::FlxTypeText _hx_tmp14 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 440)				int _hx_tmp15 = _hx_tmp14->_length;
HXDLIN( 440)				_hx_tmp14->_length = (_hx_tmp15 - ::Std_obj::_hx_int((this->_timer / this->eraseDelay)));
HXLINE( 441)				if ((this->_length < 0)) {
HXLINE( 442)					this->_length = 0;
            				}
            			}
HXLINE( 445)			bool _hx_tmp16;
HXDLIN( 445)			bool _hx_tmp17;
HXDLIN( 445)			if (this->_typing) {
HXLINE( 445)				_hx_tmp17 = (this->_timer >= this->delay);
            			}
            			else {
HXLINE( 445)				_hx_tmp17 = false;
            			}
HXDLIN( 445)			if (!(_hx_tmp17)) {
HXLINE( 445)				if (this->_erasing) {
HXLINE( 445)					_hx_tmp16 = (this->_timer >= this->eraseDelay);
            				}
            				else {
HXLINE( 445)					_hx_tmp16 = false;
            				}
            			}
            			else {
HXLINE( 445)				_hx_tmp16 = true;
            			}
HXDLIN( 445)			if (_hx_tmp16) {
...
HXLINE( 460)					 ::flixel::addons::text::FlxTypeText _hx_tmp18 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 460)					_hx_tmp18->_timer = ::hx::Mod(_hx_tmp18->_timer,this->delay);
            				}
HXLINE( 463)				bool _hx_tmp19;
HXDLIN( 463)				if (::hx::IsNotNull( this->sounds )) {
HXLINE( 463)					_hx_tmp19 = !(this->useDefaultSound);
            				}
            				else {
...
HXLINE( 483)		::String _hx_tmp20 = this->prefix;
HXDLIN( 483)		::flixel::addons::text::FlxTypeText_obj::helperString = (_hx_tmp20 + this->_finalText.substr(0,this->_length));
HXLINE( 486)		if (this->showCursor) {
HXLINE( 488)			 ::flixel::addons::text::FlxTypeText _hx_tmp21 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 488)			_hx_tmp21->_cursorTimer = (_hx_tmp21->_cursorTimer + elapsed);
...
HXLINE( 493)			bool _hx_tmp22;
HXDLIN( 493)			if ((this->_cursorTimer > (this->cursorBlinkSpeed / ( (Float)(2) )))) {
HXLINE( 493)				_hx_tmp22 = !(isBreakLine);
            			}
            			else {
HXLINE( 493)				_hx_tmp22 = false;
            			}
HXDLIN( 493)			if (_hx_tmp22) {
HXLINE( 495)				 ::Dynamic _hx_tmp23 = ::hx::ClassOf< ::flixel::addons::text::FlxTypeText >();
HXDLIN( 495)				::String _hx_tmp24 = ::flixel::addons::text::FlxTypeText_obj::helperString;
HXDLIN( 495)				::flixel::addons::text::FlxTypeText_obj::helperString = (_hx_tmp24 + this->cursorCharacter.charAt(0));
            			}
...
HXDLIN( 510)			bool _hx_tmp26;
HXDLIN( 510)			bool _hx_tmp27;
HXDLIN( 510)			if ((this->_length >= this->_finalText.length)) {
HXLINE( 510)				_hx_tmp27 = this->_typing;
            			}
            			else {
HXLINE( 510)				_hx_tmp27 = false;
            			}
HXDLIN( 510)			if (_hx_tmp27) {
HXLINE( 510)				_hx_tmp26 = !(this->_waiting);
            			}
            			else {
HXLINE( 510)				_hx_tmp26 = false;
            			}
HXDLIN( 510)			if (_hx_tmp26) {
HXLINE( 510)				_hx_tmp25 = !(this->_erasing);
            			}
            			else {
...
HXLINE( 516)			bool _hx_tmp28;
HXDLIN( 516)			bool _hx_tmp29;
HXDLIN( 516)			bool _hx_tmp30;
HXDLIN( 516)			if ((this->_length == 0)) {
HXLINE( 516)				_hx_tmp30 = this->_erasing;
            			}
            			else {
HXLINE( 516)				_hx_tmp30 = false;
            			}
HXDLIN( 516)			if (_hx_tmp30) {
HXLINE( 516)				_hx_tmp29 = !(this->_typing);
            			}
            			else {
HXLINE( 516)				_hx_tmp29 = false;
            			}
HXDLIN( 516)			if (_hx_tmp29) {
HXLINE( 516)				_hx_tmp28 = !(this->_waiting);
            			}
            			else {
HXLINE( 516)				_hx_tmp28 = false;
            			}
HXDLIN( 516)			if (_hx_tmp28) {
