...
HXLINE( 472)											::String newText1 = this->filter(::String::fromCharCode(e->charCode));
...
HXDLIN( 785)					 ::openfl::geom::Rectangle r7 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,r4,r5,r6,::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) )));
