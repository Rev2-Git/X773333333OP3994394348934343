...
HXDLIN( 406)		{
HXLINE( 406)			 ::flixel::math::FlxBasePoint _this = point2;
HXDLIN( 406)			if (_this->_weak) {
HXLINE( 406)				_this->put();
            			}
            		}
...
HXDLIN( 406)		{
HXLINE( 406)			 ::flixel::math::FlxBasePoint _this1 = border;
HXDLIN( 406)			if (_this1->_weak) {
HXLINE( 406)				_this1->put();
            			}
            		}
