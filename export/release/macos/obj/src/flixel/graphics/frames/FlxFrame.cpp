...
HXDLIN( 312)			Float x1 = (_this1->x + _this1->width);
HXDLIN( 312)			 ::flixel::math::FlxRect _this2 = this->frame;
HXDLIN( 312)			Float y1 = (_this2->y + _this2->height);
...
HXDLIN( 312)			 ::flixel::math::FlxRect _this3 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 312)			_this3->x = ( (Float)(0) );
HXDLIN( 312)			_this3->y = ( (Float)(0) );
HXDLIN( 312)			_this3->width = ( (Float)(0) );
HXDLIN( 312)			_this3->height = ( (Float)(0) );
HXDLIN( 312)			 ::flixel::math::FlxRect rect = _this3;
HXDLIN( 312)			rect->_inPool = false;
HXDLIN( 312)			 ::flixel::math::FlxRect _this4 = rect;
...
HXDLIN( 312)			{
HXLINE( 312)				 ::flixel::math::FlxBasePoint _this5 = p1;
HXDLIN( 312)				if (_this5->_weak) {
HXLINE( 312)					_this5->put();
            				}
            			}
HXDLIN( 312)			{
HXLINE( 312)				 ::flixel::math::FlxBasePoint _this6 = p2;
HXDLIN( 312)				if (_this6->_weak) {
HXLINE( 312)					_this6->put();
            				}
            			}
...
HXDLIN( 312)			 ::flixel::math::FlxRect flxRect = _this4;
HXDLIN( 312)			{
...
HXDLIN( 356)		{
HXLINE( 356)			 ::flixel::math::FlxBasePoint _this4 = p1;
HXDLIN( 356)			if (_this4->_weak) {
HXLINE( 356)				_this4->put();
            			}
            		}
HXDLIN( 356)		{
HXLINE( 356)			 ::flixel::math::FlxBasePoint _this5 = p2;
HXDLIN( 356)			if (_this5->_weak) {
HXLINE( 356)				_this5->put();
            			}
            		}
...
HXDLIN( 418)		{
HXLINE( 418)			 ::flixel::math::FlxBasePoint _this4 = p1;
HXDLIN( 418)			if (_this4->_weak) {
HXLINE( 418)				_this4->put();
            			}
            		}
HXDLIN( 418)		{
HXLINE( 418)			 ::flixel::math::FlxBasePoint _this5 = p2;
HXDLIN( 418)			if (_this5->_weak) {
HXLINE( 418)				_this5->put();
            			}
            		}
...
HXLINE( 450)			{
HXLINE( 450)				 ::flixel::math::FlxBasePoint this2 = frameToFill->offset;
HXDLIN( 450)				this2->set_x(( (Float)(0) ));
HXDLIN( 450)				this2->set_y(( (Float)(0) ));
            			}
...
HXLINE( 474)			{
HXLINE( 474)				 ::flixel::math::FlxBasePoint this3 = frameToFill->offset;
HXDLIN( 474)				this3->set_x(( (Float)(0) ));
HXDLIN( 474)				this3->set_y(( (Float)(0) ));
            			}
            		}
            		else {
HXLINE( 478)			frameToFill->type = 0;
HXLINE( 479)			{
HXLINE( 479)				 ::flixel::math::FlxBasePoint this4 = frameToFill->offset;
HXDLIN( 479)				Float y1 = frameRect->y;
HXDLIN( 479)				this4->set_x(frameRect->x);
HXDLIN( 479)				this4->set_y(y1);
HXDLIN( 479)				 ::flixel::math::FlxBasePoint this5 = this4;
HXDLIN( 479)				Float y2 = rect->y;
HXDLIN( 479)				this5->set_x((this5->x - rect->x));
HXDLIN( 479)				this5->set_y((this5->y - y2));
HXDLIN( 479)				 ::flixel::math::FlxBasePoint this6 = this5;
HXDLIN( 479)				 ::flixel::math::FlxBasePoint point = this->offset;
HXDLIN( 479)				{
HXLINE( 479)					Float y3 = point->y;
HXDLIN( 479)					this6->set_x((this6->x + point->x));
HXDLIN( 479)					this6->set_y((this6->y + y3));
            				}
HXDLIN( 479)				{
HXLINE( 479)					 ::flixel::math::FlxBasePoint _this2 = point;
HXDLIN( 479)					if (_this2->_weak) {
HXLINE( 479)						_this2->put();
            					}
            				}
            			}
HXLINE( 481)			Float x = frameRect->x;
HXDLIN( 481)			Float y4 = frameRect->y;
HXDLIN( 481)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y4);
...
HXDLIN( 482)			Float y5 = (frameRect->y + frameRect->height);
HXDLIN( 482)			 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y5);
...
HXDLIN( 499)					Float x11 = (((p1->x * matrix->a) + (p1->y * matrix->c)) + matrix->tx);
HXDLIN( 499)					Float y11 = (((p1->x * matrix->b) + (p1->y * matrix->d)) + matrix->ty);
HXDLIN( 499)					{
HXLINE( 499)						p1->set_x(x11);
HXDLIN( 499)						p1->set_y(y11);
            					}
            				}
HXLINE( 500)				{
HXLINE( 500)					 ::openfl::geom::Matrix matrix1 = this->matrix;
HXDLIN( 500)					Float x12 = (((p2->x * matrix1->a) + (p2->y * matrix1->c)) + matrix1->tx);
HXDLIN( 500)					Float y12 = (((p2->x * matrix1->b) + (p2->y * matrix1->d)) + matrix1->ty);
HXDLIN( 500)					{
HXLINE( 500)						p2->set_x(x12);
HXDLIN( 500)						p2->set_y(y12);
            					}
            				}
            			}
HXLINE( 503)			{
...
HXDLIN( 503)				{
HXLINE( 503)					 ::flixel::math::FlxBasePoint _this5 = p1;
HXDLIN( 503)					if (_this5->_weak) {
HXLINE( 503)						_this5->put();
            					}
            				}
HXDLIN( 503)				{
HXLINE( 503)					 ::flixel::math::FlxBasePoint _this6 = p2;
HXDLIN( 503)					if (_this6->_weak) {
HXLINE( 503)						_this6->put();
            					}
            				}
HXDLIN( 503)				{
...
HXDLIN( 549)			{
HXLINE( 549)				 ::flixel::math::FlxBasePoint _this = p;
HXDLIN( 549)				if (_this->_weak) {
HXLINE( 549)					_this->put();
            				}
            			}
            		}
...
HXLINE( 556)			{
HXLINE( 556)				 ::flixel::math::FlxBasePoint this2 = clippedFrame->offset;
HXDLIN( 556)				this2->set_x(( (Float)(0) ));
HXDLIN( 556)				this2->set_y(( (Float)(0) ));
            			}
...
HXLINE( 576)			{
HXLINE( 576)				 ::flixel::math::FlxBasePoint this3 = clippedFrame->offset;
HXDLIN( 576)				this3->set_x(( (Float)(0) ));
HXDLIN( 576)				this3->set_y(( (Float)(0) ));
            			}
            		}
            		else {
HXLINE( 580)			clippedFrame->type = 0;
HXLINE( 581)			{
HXLINE( 581)				 ::flixel::math::FlxBasePoint this4 = clippedFrame->offset;
HXDLIN( 581)				Float y1 = frameRect->y;
HXDLIN( 581)				this4->set_x(frameRect->x);
HXDLIN( 581)				this4->set_y(y1);
HXDLIN( 581)				 ::flixel::math::FlxBasePoint this5 = this4;
HXDLIN( 581)				 ::flixel::math::FlxBasePoint point = this->offset;
HXDLIN( 581)				{
HXLINE( 581)					Float y2 = point->y;
HXDLIN( 581)					this5->set_x((this5->x + point->x));
HXDLIN( 581)					this5->set_y((this5->y + y2));
            				}
HXDLIN( 581)				{
HXLINE( 581)					 ::flixel::math::FlxBasePoint _this3 = point;
HXDLIN( 581)					if (_this3->_weak) {
HXLINE( 581)						_this3->put();
            					}
            				}
            			}
HXLINE( 583)			Float x = frameRect->x;
HXDLIN( 583)			Float y3 = frameRect->y;
HXDLIN( 583)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y3);
...
HXDLIN( 584)			Float y4 = (frameRect->y + frameRect->height);
HXDLIN( 584)			 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y4);
...
HXLINE( 590)				{
HXLINE( 590)					 ::flixel::math::FlxMatrix _this4 = this->matrix;
HXDLIN( 590)					_this4->setTo(-(_this4->b),_this4->a,-(_this4->d),_this4->c,-(_this4->ty),_this4->tx);
            				}
...
HXLINE( 595)					{
HXLINE( 595)						 ::flixel::math::FlxMatrix _this5 = this->matrix;
HXDLIN( 595)						_this5->setTo(_this5->b,-(_this5->a),_this5->d,-(_this5->c),_this5->ty,-(_this5->tx));
            					}
...
HXDLIN( 601)					Float x11 = (((p1->x * matrix->a) + (p1->y * matrix->c)) + matrix->tx);
HXDLIN( 601)					Float y11 = (((p1->x * matrix->b) + (p1->y * matrix->d)) + matrix->ty);
HXDLIN( 601)					{
HXLINE( 601)						p1->set_x(x11);
HXDLIN( 601)						p1->set_y(y11);
            					}
            				}
HXLINE( 602)				{
HXLINE( 602)					 ::openfl::geom::Matrix matrix1 = this->matrix;
HXDLIN( 602)					Float x12 = (((p2->x * matrix1->a) + (p2->y * matrix1->c)) + matrix1->tx);
HXDLIN( 602)					Float y12 = (((p2->x * matrix1->b) + (p2->y * matrix1->d)) + matrix1->ty);
HXDLIN( 602)					{
HXLINE( 602)						p2->set_x(x12);
HXDLIN( 602)						p2->set_y(y12);
            					}
            				}
            			}
HXLINE( 605)			{
...
HXDLIN( 605)				{
HXLINE( 605)					 ::flixel::math::FlxBasePoint _this6 = p1;
HXDLIN( 605)					if (_this6->_weak) {
HXLINE( 605)						_this6->put();
            					}
            				}
HXDLIN( 605)				{
HXLINE( 605)					 ::flixel::math::FlxBasePoint _this7 = p2;
HXDLIN( 605)					if (_this7->_weak) {
HXLINE( 605)						_this7->put();
            					}
            				}
HXDLIN( 605)				{
...
HXDLIN( 634)			{
HXLINE( 634)				 ::flixel::math::FlxBasePoint _this = p;
HXDLIN( 634)				if (_this->_weak) {
HXLINE( 634)					_this->put();
            				}
            			}
            		}
...
HXDLIN( 637)			{
HXLINE( 637)				 ::flixel::math::FlxBasePoint _this1 = p1;
HXDLIN( 637)				if (_this1->_weak) {
HXLINE( 637)					_this1->put();
            				}
            			}
            		}
