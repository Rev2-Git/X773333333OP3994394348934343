...
HXDLIN( 293)			{
HXLINE( 293)				 ::flixel::math::FlxBasePoint _this = p;
HXDLIN( 293)				if (_this->_weak) {
HXLINE( 293)					_this->put();
            				}
            			}
            		}
...
HXDLIN(1053)		{
HXDLIN(1053)			 ::flixel::math::FlxBasePoint _this = Offset;
HXDLIN(1053)			if (_this->_weak) {
HXDLIN(1053)				_this->put();
            			}
            		}
            	}
...
HXDLIN(1056)		{
HXDLIN(1056)			 ::flixel::math::FlxBasePoint _this = Origin;
...
HXDLIN(1059)		{
HXDLIN(1059)			 ::flixel::math::FlxBasePoint _this = Scale;
...
HXDLIN(1062)		{
HXDLIN(1062)			 ::flixel::math::FlxBasePoint _this = ScrollFactor;
