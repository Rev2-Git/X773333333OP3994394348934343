...
HXLINE( 252)				 ::flixel::input::mouse::FlxMouseEvent current5 = currentOverObjects->__get(_g15).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXDLIN( 591)			_g = (_g + 1);
HXLINE( 593)			 ::flixel::group::FlxTypedGroup group1 = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
...
HXDLIN( 672)						{
HXLINE( 672)							 ::flixel::math::FlxBasePoint _this1 = point2;
