...
HXLINE( 360)		{
HXLINE( 360)			 ::flixel::math::FlxBasePoint _this = Target;
HXDLIN( 360)			if (_this->_weak) {
HXLINE( 360)				_this->put();
            			}
            		}
...
HXLINE( 380)		{
HXLINE( 380)			 ::flixel::math::FlxBasePoint _this = Target;
HXDLIN( 380)			if (_this->_weak) {
HXLINE( 380)				_this->put();
            			}
            		}
