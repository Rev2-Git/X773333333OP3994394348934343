...
HXLINE( 307)		{
HXLINE( 307)			 ::flixel::math::FlxBasePoint _this = Point1;
HXDLIN( 307)			if (_this->_weak) {
HXLINE( 307)				_this->put();
            			}
            		}
HXLINE( 308)		{
HXLINE( 308)			 ::flixel::math::FlxBasePoint _this1 = Point2;
HXDLIN( 308)			if (_this1->_weak) {
HXLINE( 308)				_this1->put();
            			}
            		}
...
HXLINE( 326)		{
HXLINE( 326)			 ::flixel::math::FlxBasePoint _this = Point;
HXDLIN( 326)			if (_this->_weak) {
HXLINE( 326)				_this->put();
            			}
            		}
...
HXLINE( 358)			{
HXLINE( 358)				 ::flixel::math::FlxBasePoint _this1 = origin;
HXDLIN( 358)				if (_this1->_weak) {
HXLINE( 358)					_this1->put();
            				}
            			}
...
HXLINE( 398)		{
HXLINE( 398)			 ::flixel::math::FlxBasePoint _this2 = origin;
HXDLIN( 398)			if (_this2->_weak) {
HXLINE( 398)				_this2->put();
            			}
            		}
