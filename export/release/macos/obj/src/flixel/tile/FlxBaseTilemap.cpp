...
HXDLIN(1044)					if (_this->_weak) {
HXLINE(1044)						_this->put();
            					}
            				}
            			}
HXLINE(1045)			{
HXLINE(1045)				 ::flixel::math::FlxBasePoint _this1 = worldPoint;
HXDLIN(1045)				if (_this1->_weak) {
HXLINE(1045)					_this1->put();
            				}
            			}
            		}
