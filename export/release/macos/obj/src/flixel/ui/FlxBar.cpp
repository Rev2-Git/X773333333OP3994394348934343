...
HXDLIN( 861)					{
HXLINE( 861)						 ::flixel::math::FlxBasePoint _this = point;
HXDLIN( 861)						if (_this->_weak) {
HXLINE( 861)							_this->put();
            						}
            					}
            				}
...
HXLINE( 870)					 ::flixel::math::FlxMatrix _this1 = this->_matrix;
HXDLIN( 870)					Float cos = this->_cosAngle;
HXDLIN( 870)					Float sin = this->_sinAngle;
HXDLIN( 870)					Float a1 = ((_this1->a * cos) - (_this1->b * sin));
HXDLIN( 870)					_this1->b = ((_this1->a * sin) + (_this1->b * cos));
HXDLIN( 870)					_this1->a = a1;
HXDLIN( 870)					Float c1 = ((_this1->c * cos) - (_this1->d * sin));
HXDLIN( 870)					_this1->d = ((_this1->c * sin) + (_this1->d * cos));
HXDLIN( 870)					_this1->c = c1;
HXDLIN( 870)					Float tx1 = ((_this1->tx * cos) - (_this1->ty * sin));
HXDLIN( 870)					_this1->ty = ((_this1->tx * sin) + (_this1->ty * cos));
HXDLIN( 870)					_this1->tx = tx1;
            				}
HXLINE( 873)				{
