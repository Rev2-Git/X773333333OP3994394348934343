...
HXLINE( 305)			{
HXLINE( 305)				{
HXLINE( 305)					 ::flixel::math::FlxBasePoint _this = start;
HXDLIN( 305)					if (_this->_weak) {
HXLINE( 305)						_this->put();
            					}
            				}
HXDLIN( 305)				{
HXLINE( 305)					 ::flixel::math::FlxBasePoint _this1 = end;
HXDLIN( 305)					if (_this1->_weak) {
HXLINE( 305)						_this1->put();
            					}
            				}
...
HXLINE( 311)			{
HXLINE( 311)				{
HXLINE( 311)					 ::flixel::math::FlxBasePoint _this = start;
HXDLIN( 311)					if (_this->_weak) {
HXLINE( 311)						_this->put();
            					}
            				}
HXDLIN( 311)				{
HXLINE( 311)					 ::flixel::math::FlxBasePoint _this1 = end;
...
HXDLIN( 316)		{
HXLINE( 316)			 ::flixel::math::FlxBasePoint _this = start;
HXDLIN( 316)			if (_this->_weak) {
HXLINE( 316)				_this->put();
            			}
            		}
