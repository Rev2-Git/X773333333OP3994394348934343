...
HXLINE( 204)					{
HXLINE( 204)						 ::lime::utils::ArrayBufferView _this8 = data;
HXDLIN( 204)						 ::lime::utils::ArrayBufferView view2 = this->paramData;
...
HXLINE( 204)							_this8->buffer->blit((offset * _this8->bytesPerElement),view2->buffer,view2->byteOffset,view2->byteLength);
            						}
            						else {
...
HXLINE( 204)								_this8->copyFromArray(array4,offset);
            							}
            							else {
