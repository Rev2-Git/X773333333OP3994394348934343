...
HXLINE( 298)			 ::AttachedText item1 = this->grpInputsAlt->__get(0).StaticCast<  ::AttachedText >();
...
HXLINE( 321)				 ::Alphabet item2 = _g7->__get(_g6).StaticCast<  ::Alphabet >();
