...
HXLINE( 163)						 ::flixel::FlxSprite item1 = Dynamic( this->grpNotes->members->__get(i1)).StaticCast<  ::flixel::FlxSprite >();
...
HXDLIN( 207)				int i1 = (_g2 - 1);
HXLINE( 208)				 ::flixel::FlxSprite item1 = Dynamic( this->grpNotes->members->__get(i1)).StaticCast<  ::flixel::FlxSprite >();
